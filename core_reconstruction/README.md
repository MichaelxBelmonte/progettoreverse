...
- `analyzer gate cluster support` aperto per middle-value extraction, default `0.01f`, mediana `_allEnergyRelevantRegionRatio` su ratio consecutivi con gap limit `2.0`, `linked-field20 coverage` e field map canonica `_allTonality / _allCentDiffPerMillisecond / _allPitchRangePerNote / _allEnergyRelevantRegionRatio / _allAttackPeakQuality / _allAttackPeakToEnergyRegionRatio`
