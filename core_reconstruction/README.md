...
- `raw note families / matcher` aperto per carrier `MURawNoteSeparation`, finestra locale, seed dinamico da cached spectral reference, score di selezione candidato, contratto `threshold-seeded matcher`, smoother mode `0` reverse-derived di `015c1480 / 015c0b60`, paired peak-gate kernel di `014a3550` e builder candidati classe `8` con mask, contrasto e smoothing
