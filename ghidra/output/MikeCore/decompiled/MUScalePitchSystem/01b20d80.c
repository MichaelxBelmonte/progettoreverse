...
void FUN_01b20d80(pthread_key_t param_1)

{
  ...
  if ((longlong *)unaff_RDI[0x52] == (longlong *)0x0) {
    return;
  }
  iVar3 = (**(code **)(*(longlong *)unaff_RDI[0x52] + 0xa88))();
  FUN_01b1dbf0();
  FUN_01ad3cb0();
  if (local_40 == '\0') {
    if (local_48 != 0) {
...
LAB_01b20dec:
  ...
  bVar1 = true;
LAB_01b21082:
  iVar6 = unaff_ESI + *(int *)((longlong)unaff_RDI + 0x194);
  *(int *)((longlong)unaff_RDI + 0x194) = iVar6;
  FUN_01ad3320();
  if ((local_40 != '\0') && (local_48 != 0)) {
    FUN_00d50b20();
  }
  ...
  if ((int)unaff_RDI[0x32] != iVar6) {
    *(int *)(unaff_RDI + 0x32) = iVar6;
