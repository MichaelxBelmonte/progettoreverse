...
/* WARNING: Removing unreachable block (ram,0x01a2488c) */
/* WARNING: Removing unreachable block (ram,0x01a24895) */
...

{
  ...
  if ((unaff_RDI[0x3b] == 0) || (FUN_01bcc520(), local_40 == (longlong *)0x0)) {
    FUN_01d9af40();
    return;
  }
  if (local_38 == '\0') {
  ...
  if (0.0 < fVar10) {
    plVar8 = (longlong *)unaff_RDI[0x2a];
    if (plVar8 == plVar7) {
...
LAB_01a24ab5:
    ...
    if ((longlong *)unaff_RDI[0x28] != (longlong *)0x0) {
      auVar15._0_8_ = (**(code **)(*(longlong *)unaff_RDI[0x28] + 0x4d8))();
...
LAB_01a24b97:
      ...
      plVar8 = (longlong *)unaff_RDI[0x2e];
      plVar7 = plVar8;
      bVar3 = bVar2;
    ...
    if (iVar6 == 0) {
      if (unaff_RDI[0x29] != 0) {
        ...
        if (local_40 == unaff_RDI) {
          local_78 = (undefined1  [8])(**(code **)(*(longlong *)unaff_RDI[0x29] + 0x4d8))();
          uStack_70 = extraout_XMM0_Qb_06;
          auVar16 = auVar24;
          FUN_01e3f820();
          blendps(auVar24,auVar16,2);
          auVar16 = blendps(_local_78,ZEXT816(0),2);
          (**(code **)(*(longlong *)unaff_RDI[0x29] + 0x4d0))(auVar16._0_8_);
        }
      }
      if (unaff_RDI[0x27] != 0) {
        FUN_01d9cbc0();
