...
int FUN_010ae7c0(X509 *param_1,undefined8 param_2,dword *param_3,int *param_4)

{
  ...
  lVar17 = *(longlong *)(unaff_RDI + 0xe8);
  ...
  if ((iVar4 == 1) && (*(int *)(unaff_RDI + 0x94) == 1)) {
    lVar12 = *(longlong *)(unaff_RDI + 0x10);
    uVar9 = (uint)(lVar12 != 0);
    if ((lVar17 != 0) && ((*(uint *)(lVar17 + 0x28) & 3) == 0)) {
      _local_80 = CONCAT44(uStackY_7c,(int)CONCAT71((int7)((ulonglong)param_1 >> 8),1));
...
joined_r0x010ae920:
      ...
      iVar4 = *(int *)(*(longlong *)(unaff_RDI + 0x20) + 0x28);
      if (0x3fffffff < iVar4) {
        *(undefined4 *)(*(longlong *)(unaff_RDI + 0x20) + 0x28) = 0x3fffffff;
        iVar4 = 0x3fffffff;
      }
      uVar22 = iVar4 + 1;
      a = (char *)(ulonglong)uVar22;
      if (uVar9 == 0) {
        local_58 = 3;
      }
      else {
        ...
        do {
          ...
          if (iVar11 <= (int)uVar22) {
            uVar16 = *(undefined8 *)(unaff_RDI + 0x98);
            *(undefined8 *)(unaff_RDI + 0x98) = 0;
            pXVar14 = pXVar23;
            iVar6 = (**(code **)(unaff_RDI + 0x40))();
            *(undefined8 *)(unaff_RDI + 0x98) = uVar16;
            if (iVar6 < 0) {
              *(undefined4 *)(unaff_RDI + 0xb0) = 0x46;
LAB_010af016:
              local_58 = 2;
LAB_010af066:
              iVar6 = (int)pXVar23;
              ...
              if ((uVar9 & 4) != 0) {
                if (((iVar11 <= iVar4) || (iVar4 < 1)) || (local_34 != 0)) {
                  ...
                  pXVar14 = (X509 *)((longlong)&segment_command_00000020.vmsize + 4);
                  param_3 = (dword *)0xc0e;
                ...
                *(int *)(unaff_RDI + 0x94) = iVar4;
                iVar11 = iVar4;
                if (lVar17 != 0) {
                  iVar4 = _OPENSSL_sk_num();
                  if ((0 < iVar4) && (*(int *)(unaff_RDI + 0x94) <= *(int *)(lVar17 + 0x2c))) {
                    *(undefined4 *)(lVar17 + 0x2c) = 0xffffffff;
                    _X509_free((X509 *)a);
                    *(undefined8 *)(lVar17 + 0x20) = 0;
                  }
                  iVar4 = _OPENSSL_sk_num();
                  if ((0 < iVar4) && (*(int *)(unaff_RDI + 0x94) <= *(int *)(lVar17 + 0x30))) {
              ...
              if (local_34 == 0) {
                ...
                _X509_free((X509 *)a);
                a = "crypto/x509/x509_vfy.c";
                pXVar14 = (X509 *)((longlong)&segment_command_00000020.vmsize + 1);
                param_3 = (dword *)0xc2c;
...
LAB_010aed99:
                ...
                _X509_free((X509 *)a);
                *(int *)(unaff_RDI + 0x94) = iVar11 + -1;
                pXVar14 = (X509 *)0x0;
                _OPENSSL_sk_set();
                if (*(int *)(unaff_RDI + 0x94) <= iVar11 + -1) goto LAB_010aed6e;
LAB_010aefa1:
                a = "crypto/x509/x509_vfy.c";
                pXVar14 = (X509 *)((longlong)&segment_command_00000020.vmsize + 4);
...
LAB_010aed61:
                if (iVar11 < *(int *)(unaff_RDI + 0x94)) goto LAB_010aefa1;
LAB_010aed6e:
                local_58 = FUN_010b1e10();
                a = (char *)(ulonglong)(local_58 - 1U);
                if (1 < local_58 - 1U) {
...
LAB_010aedaa:
            iVar6 = (int)pXVar23;
            if ((uVar9 & 4) == 0) {
              if ((bVar25) && (1 < *(int *)(unaff_RDI + 0x94))) {
                uVar9 = uVar9 | 4;
                iVar5 = *(int *)(unaff_RDI + 0x94) + -1;
                local_34 = 0;
                iVar4 = iVar5;
                goto LAB_010aea2a;
              }
              ...
              if (((local_34 == 0) && (iVar6 <= (int)uVar22)) &&
                ...
                if (iVar6 == 0) {
                  ...
                  *(undefined4 *)(unaff_RDI + 0xb0) = 1;
                  ...
                  if (iVar6 != 0) {
                    *(int *)(unaff_RDI + 0x94) = *(int *)(unaff_RDI + 0x94) + 1;
                    local_34 = 0;
                    pXVar13 = (X509 *)0x0;
                    ...
                    if ((*(longlong *)(unaff_RDI + 0xe8) != 0) &&
                       (local_58 = 3, (*(byte *)(*(longlong *)(unaff_RDI + 0xe8) + 0x28) & 5) != 0))
                    {
                      uVar24 = *(uint *)(unaff_RDI + 0x94);
                      if (uVar24 - 1 != 0) {
                        pXVar23 = (X509 *)(ulonglong)uVar24;
                        pXVar14 = (X509 *)_OPENSSL_sk_value();
                        if (pXVar14 != (X509 *)0x0) {
                          a = (char *)(ulonglong)(uVar24 - 1);
                          iVar6 = FUN_010b2220();
                          if (iVar6 < 0) goto LAB_010aeecc;
                          pXVar13 = pXVar14;
                          if (iVar6 != 0) {
                            *(uint *)(unaff_RDI + 0x94) = uVar24 - 2;
                            local_58 = 1;
                            goto LAB_010af066;
                          }
                        }
...
LAB_010af1af:
        ...
        if ((local_58 == 3) && (lVar17 != 0)) {
          if ((*(byte *)(lVar17 + 0x28) & 4) != 0) {
            lVar12 = *(longlong *)(unaff_RDI + 0xe8);
            iVar5 = *(int *)(unaff_RDI + 0x94);
            _OPENSSL_sk_value();
            iVar11 = _OPENSSL_sk_num();
            if (0 < iVar11) {
              iVar10 = 0;
              do {
                ...
                if ((((*pcVar15 == '\x02') && (pcVar15[1] == '\x01')) && (pcVar15[2] == '\0')) &&
                  ...
                  *(undefined4 *)(unaff_RDI + 0xf0) = 1;
                  *(int *)(lVar12 + 0x2c) = iVar5 + -1;
                  *(char **)(lVar12 + 0x18) = pcVar15;
                  iVar4 = _OPENSSL_sk_num();
                  if (*(int *)(unaff_RDI + 0x94) < iVar4) {
                    do {
                      _OPENSSL_sk_pop();
                      _X509_free((X509 *)a);
                      iVar4 = iVar4 + -1;
                    } while (*(int *)(unaff_RDI + 0x94) < iVar4);
                  }
                  goto LAB_010af2d8;
                }
                iVar10 = iVar10 + 1;
      ...
      iVar4 = _OPENSSL_sk_num();
      if ((int)uVar22 < iVar4) {
        *(int *)(unaff_RDI + 0xac) = iVar4 + -1;
        uVar16 = _OPENSSL_sk_value();
        *(undefined8 *)(unaff_RDI + 0xb8) = uVar16;
        uVar9 = 0x16;
      }
      ...
      *(uint *)(unaff_RDI + 0xb0) = uVar9;
      iVar4 = (**(code **)(unaff_RDI + 0x38))();
      if (iVar4 != 0) {
LAB_010af2d8:
        uVar9 = _OPENSSL_sk_num();
        if (*(longlong *)(unaff_RDI + 0xd8) == 0) {
          uVar22 = *(uint *)(*(longlong *)(unaff_RDI + 0x20) + 0x20);
          pXVar23 = (X509 *)(ulonglong)uVar22;
          bVar25 = (*(byte *)(*(longlong *)(unaff_RDI + 0x20) + 0x18) & 0x40) == 0;
        }
        else {
          bVar25 = true;
          uVar22 = 6;
        ...
        if (0 < (int)uVar9) {
          ...
          do {
            ...
            if (((*(byte *)(*(longlong *)(unaff_RDI + 0x20) + 0x18) & 0x10) == 0) &&
               ((*(byte *)(lVar17 + 0xe1) & 2) != 0)) {
              *(uint *)(unaff_RDI + 0xac) = uVar24;
              *(longlong *)(unaff_RDI + 0xb8) = lVar17;
              *(undefined4 *)(unaff_RDI + 0xb0) = 0x22;
              iVar10 = (**(code **)(unaff_RDI + 0x38))();
              if (iVar10 == 0) goto LAB_010ae8ce;
            }
            if ((bVar25) && ((*(byte *)(lVar17 + 0xe1) & 4) != 0)) {
              *(uint *)(unaff_RDI + 0xac) = uVar24;
              *(longlong *)(unaff_RDI + 0xb8) = lVar17;
              *(undefined4 *)(unaff_RDI + 0xb0) = 0x28;
              iVar10 = (**(code **)(unaff_RDI + 0x38))();
              if (iVar10 == 0) goto LAB_010ae8ce;
            }
...
LAB_010af4f7:
              *(longlong *)(unaff_RDI + 0xb8) = lVar12;
              iVar10 = (**(code **)(unaff_RDI + 0x38))();
              if (iVar10 == 0) goto LAB_010ae8ce;
            }
            else {
              if (iVar11 == -1) {
                pXVar23 = *(X509 **)(unaff_RDI + 0x20);
                ...
                uVar7 = 0x18;
                if ((iVar10 == 0) ||
                   (((pXVar23 = (X509 *)(ulonglong)(uVar24 + 1), (int)(uVar24 + 1) < (int)uVar9 ||
                     (pXVar23 = *(X509 **)(unaff_RDI + 0x20), (pXVar23->valid & 0x20) != 0)) &&
                    (iVar10 != 1)))) goto LAB_010af4d0;
              }
LAB_010af460:
              if (((*(byte *)(*(longlong *)(unaff_RDI + 0x20) + 0x18) & 0x20) != 0) &&
                 (1 < (int)uVar9)) {
              ...
              a = (char *)pXVar23;
              if ((((*(byte *)(lVar17 + 0xe0) & 0x10) == 0) && (*(longlong *)(lVar17 + 0xd0) != -1))
                 && ((*(byte *)(*(longlong *)(unaff_RDI + 0x20) + 0x18) & 0x20) != 0)) {
            ...
            if (0 < (int)uVar22) {
              if (((int)uVar24 < *(int *)(unaff_RDI + 0x94)) ||
                 (a = (char *)(ulonglong)uVar22,
                 *(uint *)(*(longlong *)(unaff_RDI + 0x20) + 0x20) != uVar22)) {
LAB_010af550:
                pXVar14 = (X509 *)(ulonglong)(0 < iVar11);
...
LAB_010af577:
                  ...
                  *(longlong *)(unaff_RDI + 0xb8) = lVar12;
                  *(undefined4 *)(unaff_RDI + 0xb0) = 0x1a;
                  iVar11 = (**(code **)(unaff_RDI + 0x38))();
            ...
            if (uVar24 < 2) {
              ...
              if (*(longlong *)(lVar17 + 0xd0) != -1) {
                a = (char *)(longlong)iVar4;
                pXVar14 = (X509 *)(longlong)iVar5;
                if ((longlong)(pXVar14->sha1_hash + *(longlong *)(lVar17 + 0xd0) + -0x68) <
                    (longlong)a) {
                  *(uint *)(unaff_RDI + 0xac) = uVar24;
                  *(longlong *)(unaff_RDI + 0xb8) = lVar17;
                  *(undefined4 *)(unaff_RDI + 0xb0) = 0x19;
                  iVar11 = (**(code **)(unaff_RDI + 0x38))();
                  if (iVar11 == 0) goto LAB_010ae8ce;
                }
              }
LAB_010af618:
            ...
            pXVar23 = (X509 *)((longlong)&MACH_HEADER.magic + 1);
            if ((uVar2 & 0x400) != 0) {
              lVar12 = *(longlong *)(lVar17 + 0xd8);
              if (lVar12 != -1) {
                a = (char *)(longlong)iVar5;
                if (lVar12 < (longlong)a) {
                  *(uint *)(unaff_RDI + 0xac) = uVar24;
                  *(longlong *)(unaff_RDI + 0xb8) = lVar17;
                  *(undefined4 *)(unaff_RDI + 0xb0) = 0x26;
                  iVar5 = (**(code **)(unaff_RDI + 0x38))();
        ...
        uVar9 = _OPENSSL_sk_num();
        a = (char *)pXVar23;
        if ((0 < *(int *)(*(longlong *)(unaff_RDI + 0x20) + 0x2c)) && (0 < (int)uVar9)) {
          uVar22 = 0;
          do {
            lVar17 = _OPENSSL_sk_value();
            if (uVar22 != 0) {
              lVar12 = _X509_get0_pubkey();
              a = *(char **)(unaff_RDI + 0x20);
              iVar4 = *(int *)((longlong)&(((X509 *)a)->ex_data).sk + 4);
              if (0 < iVar4) {
                if (lVar12 != 0) {
                  if (4 < iVar4) {
                    iVar4 = 5;
                  ...
                  a = &DAT_0240b440;
                  if (*(int *)(&DAT_0240b440 + (ulonglong)(iVar4 - 1) * 4) <= iVar5)
                  goto LAB_010af7f5;
                }
                *puVar1 = uVar22;
                lVar12 = lVar17;
                ...
                *(longlong *)(unaff_RDI + 0xb8) = lVar12;
                *(undefined4 *)(unaff_RDI + 0xb0) = 0x43;
                iVar4 = (**(code **)(unaff_RDI + 0x38))();
...
LAB_010af7f5:
            if ((int)uVar22 < (int)(uVar9 - 1)) {
              iVar4 = *(int *)(*(longlong *)(unaff_RDI + 0x20) + 0x2c);
              local_84 = -1;
              if (0 < iVar4) {
                pXVar14 = (X509 *)0x0;
                ...
                if (iVar5 != 0) {
                  ...
                  a = &DAT_0240b440;
                  if (*(int *)(&DAT_0240b440 + (ulonglong)(iVar4 - 1) * 4) <= local_84)
                  goto LAB_010af755;
                }
                *puVar1 = uVar22;
                if (lVar17 == 0) {
                ...
                *(longlong *)(unaff_RDI + 0xb8) = lVar17;
                *(undefined4 *)(unaff_RDI + 0xb0) = 0x44;
                iVar4 = (**(code **)(unaff_RDI + 0x38))();
                if (iVar4 == 0) goto LAB_010ae8ce;
              }
            }
LAB_010af755:
        ...
        iVar4 = (**(code **)(unaff_RDI + 0x50))();
        if (iVar4 == 0) {
          return 0;
        }
        b = *(X509_NAME **)(unaff_RDI + 0x98);
        pXVar14 = *(X509 **)(*(longlong *)(unaff_RDI + 0x20) + 0x18);
        iVar4 = _X509_chain_check_suiteb();
        if (iVar4 != 0) {
          uVar16 = _OPENSSL_sk_value();
          *(undefined8 *)(unaff_RDI + 0xb8) = uVar16;
          *(int *)(unaff_RDI + 0xb0) = iVar4;
          iVar4 = (**(code **)(unaff_RDI + 0x38))();
          if (iVar4 == 0) {
            return 0;
          }
        }
        if (*(code **)(unaff_RDI + 0x30) == (code *)0x0) {
          iVar4 = FUN_010b0cf0();
        }
        else {
          iVar4 = (**(code **)(unaff_RDI + 0x30))();
        }
        if (iVar4 != 0) {
          uVar9 = _OPENSSL_sk_num();
          if (0 < (int)uVar9) {
            do {
              ...
              uVar22 = uVar9 - 1;
              if ((uVar22 == 0) ||
                 (uVar24 = *(uint *)&pXVar23[1].akid & 0x20, pXVar14 = (X509 *)(ulonglong)uVar24,
                 uVar24 == 0)) {
                if ((*(uint *)&pXVar23[1].akid & 0x400) != 0) {
                  ...
                  *(uint *)(unaff_RDI + 0xac) = uVar22;
                  *(X509 **)(unaff_RDI + 0xb8) = pXVar23;
                  *(int *)(unaff_RDI + 0xb0) = (int)pXVar14;
                  iVar4 = (**(code **)(unaff_RDI + 0x38))();
                  if (iVar4 == 0) {
                    return 0;
                  }
...
joined_r0x010afacf:
                do {
                  ...
                  iVar4 = iVar4 + -1;
                  lVar17 = _OPENSSL_sk_value();
                  if (*(longlong *)(lVar17 + 0x118) != 0) {
                    uVar24 = _NAME_CONSTRAINTS_check();
                    pXVar14 = (X509 *)(ulonglong)(uVar24 | uVar22);
                    if ((uVar24 | uVar22) == 0) {
                      uVar24 = *(uint *)(*(longlong *)(unaff_RDI + 0x20) + 0x40);
          ...
          if (iVar4 != 0) {
            ...
            if (*(char *)(*(longlong *)(unaff_RDI + 0x20) + 0x18) < '\0') {
              iVar4 = (**(code **)(unaff_RDI + 0x70))();
              return iVar4;
            }
            return iVar4;
          }
...
LAB_010ae86f:
    if ((lVar12 == 0) ||
       (uVar3 = *(ulonglong *)(*(longlong *)(unaff_RDI + 0x20) + 0x18), (short)uVar3 < 0)) {
      uVar9 = lVar12 != 0 | 2;
      _local_80 = (ulonglong)uStackY_7c << 0x20;
      goto LAB_010ae8fa;
    }
