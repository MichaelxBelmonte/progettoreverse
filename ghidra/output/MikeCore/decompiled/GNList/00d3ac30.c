...
/* WARNING: Removing unreachable block (ram,0x00d3ad20) */
/* WARNING: Removing unreachable block (ram,0x00d3ad2c) */

undefined8 FUN_00d3ac30(undefined8 param_1,undefined8 param_2,size_t param_3)

{
  ...
  if ((((*(longlong **)(unaff_RDI + 0x20) != (longlong *)0x0) &&
      ...
      (lVar5 = (**(code **)(**(longlong **)(unaff_RDI + 0x20) + 0x360))(), lVar5 != 0)) &&
...
LAB_00d3adb5:
      ...
      if ((char)plVar3[2] == '@') {
        ...
        iVar4 = FUN_00e82730();
        _memcpy(puVar9,(void *)(longlong)iVar4,param_3);
      }
    ...
    while( true ) {
      ...
      if (*(longlong *)(lVar8 + lVar10) == 0) break;
      FUN_00c70850(CONCAT71((int7)((ulonglong)pcVar7 >> 8),cVar2),(int)cVar2);
      alStack_98[lVar11] = (longlong)puVar9;
      lVar6 = *(longlong *)(unaff_RDI + 0x28);
      while( true ) {
