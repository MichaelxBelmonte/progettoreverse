...
/* WARNING: Removing unreachable block (ram,0x019151f7) */
/* WARNING: Removing unreachable block (ram,0x01915203) */
/* WARNING: Removing unreachable block (ram,0x01914fc7) */
/* WARNING: Removing unreachable block (ram,0x01914fd3) */
/* WARNING: Removing unreachable block (ram,0x01915234) */
/* WARNING: Removing unreachable block (ram,0x01915240) */
...

{
  ...
  *pcVar14 = '\0';
  ...
  iVar13 = *(int *)(lVar2 + 0x80) % *(int *)(*(longlong *)(unaff_RDI + 0x50) + 0xc);
  lVar6 = *(longlong *)(*(longlong *)(unaff_RDI + 0x50) + 0x10);
  lVar12 = *(longlong *)(lVar6 + (longlong)iVar13 * 8);
  local_70 = lVar2;
  if (lVar12 != 0) {
    FUN_00d50b00();
  }
  pVar10 = (pthread_key_t)lVar6;
  local_78 = lVar12;
  FUN_017e1bc0();
  lVar2 = local_68;
  ...
  if ((pvVar5 == (void *)0x0) || (lVar6 = FUN_00e8b990(), lVar6 == 0)) {
    uVar7 = (ulonglong)*(uint *)(lVar12 + 0x3c);
...
LAB_01914d8b:
    ...
    uVar7 = (ulonglong)
            *(uint *)(*(longlong *)(lVar12 + 0x20 + (ulonglong)(*(uint *)(lVar6 + 0x154) & 1) * 8) +
                     0x3c);
    if (4 < uVar7) goto LAB_01914d8b;
LAB_01914b40:
    pVar10 = 0x1915800;
    uVar16 = (undefined7)((ulonglong)lVar12 >> 8);
    switch((longlong)&switchD_01914b4e::switchdataD_01915800 +
           (longlong)(int)(&switchD_01914b4e::switchdataD_01915800)[uVar7]) {
    case 0x1914b50:
      iVar13 = FUN_01715480();
      iVar13 = iVar13 * 7;
...
LAB_01914d68:
    ...
    case 0x1914d95:
      ...
      if (local_68 == 0) {
        ...
        uVar16 = (undefined7)((ulonglong)local_d0 >> 8);
        if (local_60[0] == '\0') {
          FUN_00d50b00();
          uVar15 = CONCAT71(uVar16,1);
          if ((local_60[0] != '\0') && (local_68 != 0)) {
  ...
  if ((pvVar5 == (void *)0x0) || (lVar8 = FUN_00e8b990(), lVar8 == 0)) {
    ...
    cVar3 = *(char *)(*(longlong *)(lVar12 + 0x20 + (ulonglong)(*(uint *)(lVar8 + 0x154) & 1) * 8) +
                     0x3a);
    lVar12 = local_78;
  }
  uVar9 = 0xffffffff;
  ...
  if ((*(char *)(local_70 + 0x84) != '\0') || (*(int *)(local_70 + 0x80) == 0)) {
    while( true ) {
      pvVar5 = _pthread_getspecific((pthread_key_t)lVar12);
      if ((pvVar5 == (void *)0x0) || (lVar8 = FUN_00e8b990(), lVar8 == 0)) {
        iVar1 = *(int *)(local_78 + 0x3c);
      }
      else {
        iVar1 = *(int *)(*(longlong *)
                          (local_78 + 0x20 + (ulonglong)(*(uint *)(lVar8 + 0x154) & 1) * 8) + 0x3c);
        lVar12 = local_78;
      }
  ...
  if (iVar18 != iVar13) {
    ...
    if (0 < *(int *)(lVar12 + 0xc)) {
      lVar6 = 0;
      do {
        local_68 = *(longlong *)(*(longlong *)(lVar12 + 0x10) + lVar6 * 8);
        FUN_017e4480();
        FUN_017e4370();
