...
/* WARNING: Removing unreachable block (ram,0x00d3bf2e) */
/* WARNING: Removing unreachable block (ram,0x00d3bf3a) */

void FUN_00d3bef0(undefined8 param_1)
