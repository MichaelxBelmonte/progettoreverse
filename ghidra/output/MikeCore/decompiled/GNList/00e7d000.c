...
ulonglong FUN_00e7d000(double param_1,double param_2)

{
  ...
  if (((DAT_023e1698 <= (double)(_DAT_023908f0 & (ulonglong)param_1)) || (_DAT_023934c0 <= param_1))
     || (param_1 <= DAT_023e16a8)) {
    uVar10 = 0x17fffffff;
    if (param_1 < 0.0) {
      return 0x180000000;
    }
    ...
    auVar19._0_8_ = ~-(ulonglong)(param_1 < 0.0) & (ulonglong)param_1;
    auVar19._8_8_ = 0;
    auVar1._8_4_ = (int)uVar10;
    auVar1._0_8_ = (_DAT_023945b0 ^ (ulonglong)param_1) & -(ulonglong)(param_1 < 0.0);
    ...
    uVar9 = 0;
    uVar13 = 1;
    dVar3 = (double)(_DAT_023908f0 & (ulonglong)param_1) - auVar27._0_8_;
    uVar24 = 0;
    uVar25 = 0;
    do {
      uVar16 = uVar9;
...
LAB_00e7d185:
  ...
  do {
    uVar8 = uVar7;
    uVar7 = (ulonglong)(uint)((int)uVar8 >> 1);
  } while ((uVar8 & 1) == 0);
  if (((int)uVar18 != 1) && ((int)uVar8 != 1)) {
    while( true ) {
      ...
      if (uVar12 == 0 || iVar17 < iVar6) {
        uVar7 = (ulonglong)(uint)(iVar6 - iVar17);
        do {
          uVar8 = (ulonglong)(uint)((int)uVar7 >> 1);
          uVar2 = uVar7 & 2;
          uVar7 = uVar8;
        } while (uVar2 == 0);
      }
    ...
    if (1 < iVar17) {
      ...
      uVar10 = (longlong)(int)uVar10 / (longlong)iVar17 & 0xffffffff;
    }
  }
LAB_00e7d217:
  return (ulonglong)uVar15 | uVar10 << 0x20;
}
