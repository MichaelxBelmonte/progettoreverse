...

{
  ...
  *puVar6 = &DAT_02572358;
  ...
  if (plVar1 != (longlong *)0x0) {
    ...
    while( true ) {
      ...
      *(undefined1 *)(plVar7 + 2) = uVar5;
      ...
      uVar16 = FUN_00c71d60();
      *(undefined4 *)((longlong)plVar7 + 0x14) = uVar16;
      if (plVar11 != (longlong *)0x0) {
        FUN_00d50b20();
      }
      if ((local_40 != '\0') && (local_48 != (longlong *)0x0)) {
      ...
      if (iVar10 == -1) {
        ...
        *(int *)((longlong)plVar7 + 0xc) = iVar10;
        local_40 = '\0';
        local_48 = plVar7;
        FUN_00d21140();
        if ((local_40 != '\0') && (local_48 != (longlong *)0x0)) {
  ...
  plVar11 = local_70;
  uVar9 = CONCAT71((int7)((ulonglong)uVar9 >> 8),DAT_026fdd40);
  ...
  if (plVar11 == (longlong *)0x0) {
    ...
    uVar13 = (undefined7)((ulonglong)unaff_R13 >> 8);
    bVar2 = 1;
    bVar3 = 0;
...
LAB_01801808:
  ...
  plVar7 = *pplVar14;
  if (plVar7 == plVar11) {
    if ((bool)(bVar3 & plVar7 != (longlong *)0x0)) {
    ...
    if ((bool)(bVar2 & plVar11 != (longlong *)0x0)) {
      uVar16 = FUN_00d50b20();
      uVar12 = (uint)CONCAT71(uVar13,1);
      plVar11 = plVar7;
    }
...
LAB_01801d7b:
  ...
  if (plVar11 == (longlong *)0x0) {
    ...
    if (DAT_02802690 != '\0') goto LAB_01801e81;
LAB_01801ea0:
    if (plVar11 != (longlong *)0x0) {
      FUN_00d50b00();
    }
