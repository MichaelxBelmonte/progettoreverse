...
ulonglong FUN_00d15850(undefined4 param_1)

{
  ...
  if (plVar6 != (longlong *)0x0) {
    if ((DAT_0277ce78 == '\0') && (iVar4 = ___cxa_guard_acquire(), iVar4 != 0)) {
    ...
    if (plVar6 != (longlong *)0x0) {
      ...
      local_d0 = lVar1;
      local_c8 = '\x01';
      local_58 = *(longlong **)(unaff_RDI + 0x10);
      local_d8 = *(undefined8 *)(unaff_RDI + 0x20);
      uVar10 = FUN_00083ea0(3,&local_d8);
      local_90 = (longlong *)&DAT_02571cc0;
      local_60 = *(undefined4 *)(unaff_RDI + 0x28);
...
LAB_00d15b9c:
    ...
    (**(code **)(*plVar6 + 0x360))();
    cVar2 = FUN_00e85ea0();
    uVar8 = (undefined7)((ulonglong)plVar6 >> 8);
    if (cVar2 == '\0') {
      uVar5 = CONCAT71(uVar8,DAT_02802690);
      plVar6 = DAT_02802688;
      if (DAT_02802690 == '\0') goto LAB_00d15aa5;
LAB_00d15a96:
      if (plVar6 == (longlong *)0x0) goto LAB_00d15aa5;
      FUN_00d50b00();
    }
    else {
...
LAB_00d15aa5:
      plVar7 = local_90;
      if (plVar6 == (longlong *)0x0) goto LAB_00d15b9c;
    }
    local_31 = (char)uVar5;
    if (*(int *)(unaff_RDI + 0x28) == 6) {
      local_b8 = '\0';
      local_c0 = plVar6;
      uVar3 = FUN_00d14ff0();
      uVar5 = (ulonglong)uVar3;
      ...
      uVar9 = (ulonglong)*(uint *)((longlong)plVar6 + 0xc);
      do {
        uVar5 = CONCAT71((int7)(uVar5 >> 8),0 < (int)uVar9);
        if ((int)uVar9 < 1) goto LAB_00d15b85;
        lVar1 = *(longlong *)(plVar6[2] + -8 + uVar9 * 8);
        if (lVar1 != 0) {
          FUN_00d50b00();
        }
        local_a8 = '\x01';
