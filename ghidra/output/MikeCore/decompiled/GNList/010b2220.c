...
/* WARNING: Removing unreachable block (ram,0x010b242a) */
...

{
  ...
  local_90 = (X509 *)(ulonglong)uVar12;
  local_88 = 0;
  uVar5 = uVar12 & 0xc;
  if (*(int *)(unaff_RSI + 0x2c) < 0) {
    uVar5 = uVar12;
  }
  if (((*(uint *)(unaff_RSI + 0x28) & uVar5) == 0) || (iVar6 = _OPENSSL_sk_num(), iVar6 < 1)) {
    uVar12 = 0;
  }
  else {
    iVar11 = 0;
    ...
    do {
      ...
      uVar3 = local_7c;
      bVar1 = *pbVar8;
      local_90 = (X509 *)(ulonglong)uVar5;
      uVar4 = local_88;
      local_7c = uVar3;
      if ((uVar5 >> (bVar1 & 0x1f) & 1) != 0) {
        if (local_84 != bVar1) {
          bVar2 = *(byte *)(*(longlong *)(*(longlong *)unaff_RSI + 8) + (ulonglong)pbVar8[2]);
          local_90 = (X509 *)(ulonglong)bVar2;
          local_80 = (uint)bVar2;
          uVar12 = 0x100;
          local_84 = (uint)bVar1;
        }
...
LAB_010b2402:
        ...
        unaff_RSI = impl;
        if ((uVar10 == 0) || (local_80 <= *(byte *)(*(longlong *)(*(longlong *)impl + 8) + uVar10)))
        {
          if (uVar12 == bVar1) {
            pvVar9 = (void *)(ulonglong)local_88;
...
LAB_010b24da:
              ...
              uVar4 = local_88;
              if (iVar7 == 0) {
                local_90 = (X509 *)(ulonglong)local_84;
                uVar12 = 0xcU >> ((byte)local_84 & 0x1f) & 1;
                if ((uVar12 != 0) || (*(int *)(unaff_RSI + 0x2c) < 0)) {
                  *(int *)(unaff_RSI + 0x2c) = param_1;
                  *(byte **)(unaff_RSI + 0x18) = pbVar8;
                  _CRYPTO_free(local_90);
                  *(EVP_MD **)(unaff_RSI + 0x20) = param_2;
                  _X509_up_ref();
                  goto LAB_010b2519;
                }
                break;
            ...
            local_90 = (X509 *)0x0;
            param_3 = *(uchar **)(**(longlong **)impl + uVar10 * 8);
            local_88 = 0;
            uVar12 = (uint)bVar1;
            if (param_3 == (uchar *)0x0) {
              pvVar9 = (void *)0x0;
              uVar4 = 0;
              if (*(longlong *)(pbVar8 + 0x10) == 0) goto LAB_010b24da;
            }
            else {
