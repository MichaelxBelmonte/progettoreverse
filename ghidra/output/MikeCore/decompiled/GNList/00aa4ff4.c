...
int FUN_00aa4ff4(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)
  ...
  do {
    ...
    case 0xc:
      if (local_48[0] == 0xf) {
        *(undefined8 *)(unaff_RDI + 0x38) = *(undefined8 *)(unaff_RDI + 0x30);
        iVar1 = (**(code **)(*unaff_RSI + 0xf8))(&switchD_00aa50e4::switchdataD_00aa54dc,&local_34);
        uVar7 = (ulonglong)local_34;
        uVar8 = *(longlong *)(unaff_RDI + 0x38) - *(longlong *)(unaff_RDI + 0x30);
        if (uVar8 < uVar7) {
          FUN_0088d550();
        }
        else if (uVar7 < uVar8) {
          *(ulonglong *)(unaff_RDI + 0x38) = *(longlong *)(unaff_RDI + 0x30) + uVar7;
        }
        iVar1 = iVar1 + iVar2;
        if (local_34 != 0) {
          uVar8 = 0;
    ...
    case 0x12:
      if (local_48[0] == 0xf) {
        ...
        for (lVar5 = *(longlong *)(unaff_RDI + 0xa0); lVar5 != lVar6; lVar5 = lVar5 + -0x20) {
          uVar9 = (*(code *)**(undefined8 **)(lVar5 + -0x20))();
        }
        *(longlong *)(unaff_RDI + 0xa0) = lVar6;
        ...
        if (local_34 != 0) {
          ...
          uVar8 = 0;
          do {
            iVar2 = (**(code **)(*(longlong *)(*(longlong *)(unaff_RDI + 0x98) + lVar6) + 0x10))();
            iVar1 = iVar1 + iVar2;
            uVar8 = uVar8 + 1;
            lVar6 = lVar6 + 0x20;
          } while (uVar8 < local_34);
