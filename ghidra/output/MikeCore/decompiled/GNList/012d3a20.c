...
LAB_012d3bf0:
  ...
  if (((lVar5 != 0) && (*(int *)(*(longlong *)(lVar5 + 0x10) + 0xc) != 0)) &&
     (lVar7 = *(longlong *)(unaff_RDI + 0x148), lVar7 != lVar5)) {
    FUN_00d50b00();
...
LAB_012d3db0:
    ...
    if (lVar7 == 0) {
      if (lVar5 != 0) {
        if ((*(int *)(*(longlong *)(lVar5 + 0x10) + 0xc) != 0) &&
           (lVar7 = *(longlong *)(unaff_RDI + 0x150), lVar7 != lVar5)) {
          FUN_00d50b00();
