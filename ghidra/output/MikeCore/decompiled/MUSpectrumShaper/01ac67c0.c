...
/* WARNING: Removing unreachable block (ram,0x01ac6b2c) */
/* WARNING: Removing unreachable block (ram,0x01ac6c2a) */
/* WARNING: Removing unreachable block (ram,0x01ac6c3a) */
/* WARNING: Removing unreachable block (ram,0x01ac6b39) */
/* WARNING: Removing unreachable block (ram,0x01ac6892) */
/* WARNING: Removing unreachable block (ram,0x01ac689b) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_01ac67c0(undefined8 param_1,undefined8 param_2)

{
  ...
  *(undefined8 *)((longlong)unaff_RDI + 0x1b4) = param_1;
  pvVar7 = _pthread_getspecific(in_ECX);
  if (pvVar7 != (void *)0x0) {
    FUN_00e8b990();
  }
  ...
  if (cVar6 != '\0') {
    ...
    if (cVar6 == '\0') {
      ...
      cVar6 = FUN_00d05410();
      if (cVar6 == '\0') {
        if (-1 < (int)*(uint *)((longlong)unaff_RDI + 0x19c)) {
          lVar8 = 0;
          auVar29._8_8_ = in_XMM0_Qb;
          auVar29._0_8_ = param_1;
          while (((float)param_1 < *(float *)(*(longlong *)(unaff_RDI[0x2f] + 0x10) + lVar8 * 4) ||
                 (*(float *)(*(longlong *)(unaff_RDI[0x2f] + 0x10) + 4 + lVar8 * 4) <=
                  (float)param_1))) {
            lVar8 = lVar8 + 1;
            if ((ulonglong)*(uint *)((longlong)unaff_RDI + 0x19c) + 1 == lVar8) goto LAB_01ac6b0a;
          }
          fVar18 = *(float *)(*(longlong *)(unaff_RDI[0x30] + 0x10) + lVar8 * 4);
          ...
          pcVar2 = *(char **)(unaff_RDI[0x2e] + 0x10);
          auVar22 = ZEXT816(0);
          lVar10 = 0xc;
