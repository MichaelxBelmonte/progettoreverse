...
void FUN_0105f8e0(longlong param_1,ulonglong param_2)

{
  ...
  if ((param_2 < 0x80) && (*(uint *)((longlong)unaff_RDI + 0x14) == 0)) {
    ...
    if (param_2 != 0) {
      ...
      do {
        uVar32 = uVar30 + *(longlong *)*unaff_RSI;
        puVar17 = *unaff_RSI;
        uVar30 = (ulonglong)CARRY8(uVar30,*(ulonglong *)*unaff_RSI);
  ...
  if (*(uint *)((longlong)unaff_RDI + 0x14) == 0) {
    uVar22 = *unaff_RDI;
    uVar30 = unaff_RDI[1];
    uVar31 = (ulonglong)(uint)unaff_RDI[2];
    if ((param_2 & 0x10) != 0) {
      bVar33 = CARRY8(uVar22,*(ulonglong *)*unaff_RSI);
      uVar22 = uVar22 + *(longlong *)*unaff_RSI;
      uVar23 = (ulonglong)bVar33;
      bVar33 = CARRY8(uVar30,*(ulonglong *)(*unaff_RSI + 8));
      uVar24 = uVar30 + *(ulonglong *)(*unaff_RSI + 8);
    ...
    *(uint *)((longlong)unaff_RDI + 0x14) = 1;
    ...
    if ((param_2 & 0x10) != 0) {
      uVar22 = unaff_RDI[1];
      uVar30 = (*unaff_RDI & 0xffffffff) + ((*unaff_RDI & 0xffffffff80000000) >> 6);
      uVar31 = uVar30 + (uVar22 << 0x34);
      uVar22 = ((uVar22 & 0xffffffff) >> 0xc) + ((uVar22 & 0xffffffff80000000) >> 0x12) +
               (ulonglong)CARRY8(uVar30,uVar22 << 0x34);
      uVar30 = (ulonglong)(uint)unaff_RDI[2] << 0x28;
      uVar23 = uVar22 + uVar30;
      uVar28 = (ulonglong)((uint)unaff_RDI[2] >> 0x18) + (ulonglong)CARRY8(uVar22,uVar30);
      ...
      if (param_1 == 0) {
        ...
        *(uint *)unaff_RDI = uVar18;
        *(uint *)((longlong)unaff_RDI + 4) = uVar19;
        *(uint *)(unaff_RDI + 1) = uVar29;
        *(uint *)((longlong)unaff_RDI + 0xc) = uVar21;
        *(uint *)(unaff_RDI + 2) = uVar26;
      }
      return;
    }
    auVar35 = ZEXT464((uint)*unaff_RDI);
    auVar38 = ZEXT464(*(uint *)((longlong)unaff_RDI + 4));
    auVar42 = ZEXT464((uint)unaff_RDI[1]);
    auVar44 = ZEXT464(*(uint *)((longlong)unaff_RDI + 0xc));
    auVar46 = ZEXT464((uint)unaff_RDI[2]);
  }
LAB_0105fb98:
  ...
  auVar34 = *(undefined1 (*) [16])(unaff_RDI + 6);
  pauVar1 = (undefined1 (*) [16])(unaff_RDI + 0xe);
  auVar49 = unaff_RSI[2];
  auVar45 = unaff_RSI[3];
  ...
  if (uVar20 >= 0x40 && uVar22 != 0) {
    ...
    auVar41 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 8),0xee);
    auVar40 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 8),0x44);
    auVar43 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 10),0xee);
    auVar4 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 10),0x44);
    auVar5 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0xc),0xee);
    auVar6 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0xc),0x44);
    auVar7 = vpshufd_avx(*pauVar1,0xee);
    auVar8 = vpshufd_avx(*pauVar1,0x44);
    auVar9 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x10),0xee);
    auVar10 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x10),0x44);
    auVar11 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x12),0xee);
    auVar12 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x12),0x44);
    auVar13 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x14),0xee);
    auVar14 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x14),0x44);
    auVar15 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x16),0xee);
    auVar16 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x16),0x44);
    do {
  ...
  auVar5 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 8),0x10);
  ...
  auVar6 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 10),0x10);
  auVar4 = vpmuludq_avx(auVar5,auVar49);
  auVar37 = vpaddq_avx(auVar37,auVar4);
  auVar7 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0xc),0x10);
  ...
  auVar37 = vpaddq_avx(auVar37,auVar4);
  auVar6 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x10),0x10);
  auVar4 = vpmuludq_avx(auVar7,auVar45);
  auVar41 = vpaddq_avx(auVar41,auVar4);
  auVar4 = vpmuludq_avx(auVar5,auVar51);
  auVar40 = vpaddq_avx(auVar40,auVar4);
  auVar7 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x12),0x10);
  auVar4 = vpmuludq_avx(auVar5,auVar48);
  auVar43 = vpaddq_avx(auVar43,auVar4);
  ...
  auVar37 = vpaddq_avx(auVar37,auVar4);
  auVar5 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x14),0x10);
  auVar4 = vpmuludq_avx(auVar7,auVar51);
  auVar41 = vpaddq_avx(auVar41,auVar4);
  auVar6 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x16),0x10);
  ...
  if (uVar22 != 0xffffffffffffffe0) {
    ...
    auVar4 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 6),0x32);
    ...
    auVar37 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 8),0x32);
    ...
    auVar34 = vpaddq_avx(auVar34,auVar51);
    auVar41 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 10),0x32);
    auVar51 = vpmuludq_avx(auVar37,auVar55);
    auVar48 = vpaddq_avx(auVar48,auVar51);
    auVar40 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0xc),0x32);
    ...
    auVar48 = vpaddq_avx(auVar48,auVar51);
    auVar41 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x10),0x32);
    auVar51 = vpmuludq_avx(auVar40,auVar52);
    auVar47 = vpaddq_avx(auVar47,auVar51);
    auVar51 = vpmuludq_avx(auVar37,auVar36);
    auVar45 = vpaddq_avx(auVar45,auVar51);
    auVar40 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x12),0x32);
    auVar51 = vpmuludq_avx(auVar37,auVar53);
    auVar49 = vpaddq_avx(auVar49,auVar51);
    ...
    auVar48 = vpaddq_avx(auVar48,auVar51);
    auVar37 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x14),0x32);
    auVar51 = vpmuludq_avx(auVar40,auVar36);
    auVar47 = vpaddq_avx(auVar47,auVar51);
    auVar41 = vpshufd_avx(*(undefined1 (*) [16])(unaff_RDI + 0x16),0x32);
  ...
  *(uint *)unaff_RDI = auVar53._0_4_;
  *(uint *)((longlong)unaff_RDI + 4) = auVar36._0_4_;
  *(uint *)(unaff_RDI + 1) = auVar55._0_4_;
  *(uint *)((longlong)unaff_RDI + 0xc) = auVar34._0_4_;
  *(uint *)(unaff_RDI + 2) = auVar54._0_4_;
  return;
}
