// Function: FUN_00ab2f02
// Address: 00ab2f02
// Size: 914 bytes
// Class: MUSpectrumShaper


int FUN_00ab2f02(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)
  ...
  do {
    ...
    case 0x10:
      if (local_3c == 0xf) {
        ...
        for (lVar5 = *(longlong *)(unaff_RDI + 0x88); lVar5 != lVar6; lVar5 = lVar5 + -0x20) {
        ...
        *(longlong *)(unaff_RDI + 0x88) = lVar6;
        ...
        if (local_34 != 0) {
          ...
          uVar7 = 0;
          do {
            iVar2 = (**(code **)(*(longlong *)(*(longlong *)(unaff_RDI + 0x80) + lVar6) + 0x10))();
            iVar1 = iVar1 + iVar2;
            uVar7 = uVar7 + 1;
            lVar6 = lVar6 + 0x20;
