// Function: FUN_0085e050
// Address: 0085e050
// Size: 8713 bytes
// Class: GNRunLoopObserverDelegate
// String references:
...

{
  ...
  *(undefined4 *)((longlong)unaff_RDI + 0x23c) = 0;
  if (DAT_027ebf10 == '\0') {
    iVar1 = ___cxa_guard_acquire();
    if (iVar1 != 0) {
      _DAT_0273ced8 = FUN_0006d940();
  ...
  *(undefined4 *)((longlong)unaff_RDI + 0x264) = 0;
  if (DAT_027ebf10 == '\0') {
    iVar1 = ___cxa_guard_acquire();
    if (iVar1 != 0) {
      _DAT_0273ced8 = FUN_0006d940();
