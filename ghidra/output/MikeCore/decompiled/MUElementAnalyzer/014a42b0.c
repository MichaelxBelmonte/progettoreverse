...
/* WARNING: Removing unreachable block (ram,0x014a462d) */
/* WARNING: Removing unreachable block (ram,0x014a4636) */
/* WARNING: Removing unreachable block (ram,0x014a44bc) */
/* WARNING: Removing unreachable block (ram,0x014a44c5) */
/* WARNING: Removing unreachable block (ram,0x014a51d3) */
/* WARNING: Removing unreachable block (ram,0x014a51e0) */
/* WARNING: Removing unreachable block (ram,0x014a4f73) */
/* WARNING: Removing unreachable block (ram,0x014a4f7c) */
/* WARNING: Removing unreachable block (ram,0x014a4660) */
/* WARNING: Removing unreachable block (ram,0x014a4669) */
/* WARNING: Removing unreachable block (ram,0x014a4513) */
/* WARNING: Removing unreachable block (ram,0x014a4520) */
/* WARNING: Removing unreachable block (ram,0x014a4fa7) */
/* WARNING: Removing unreachable block (ram,0x014a4fb4) */
/* WARNING: Removing unreachable block (ram,0x014a4693) */
/* WARNING: Removing unreachable block (ram,0x014a46a0) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined8 * FUN_014a42b0(float param_1,float param_2,float param_3,float param_4)

{
  ...
  *puVar15 = &DAT_02572358;
  (*pcVar10)();
  fVar18 = (float)_powf(DAT_023908ec * param_1,DAT_02394288);
  lVar16 = *unaff_RSI;
  if (*(int *)(lVar16 + 0xc) == 0) {
    *unaff_RDI = puVar15;
    *(undefined1 *)(unaff_RDI + 1) = 1;
    ...
    if (*(int *)(lVar16 + 0xc) < 1) {
      ...
      bVar4 = false;
      do {
        lVar16 = *(longlong *)(*(longlong *)(lVar16 + 0x10) + lVar17 * 8);
        if (local_50 == lVar16) {
          if ((!bVar4) && (local_50 != 0)) {
            bVar4 = true;
            FUN_00d50b00();
...
LAB_014a481e:
    if (0 < *(int *)((longlong)puVar14 + 0xc)) {
      ...
      bVar7 = bVar6;
      do {
        lVar2 = *(longlong *)(puVar14[2] + lVar17 * 8);
        if (local_88 == lVar2) {
          if ((!bVar5) && (local_88 != 0)) {
            bVar5 = true;
            FUN_00d50b00();
        ...
        if ((lVar16 != 0) && (dVar20 = *(double *)(local_88 + 0x10), local_a0 < dVar20)) {
          local_a0 = (double)(longlong)iVar13;
          do {
            local_a0 = (double)((longlong)local_a0 + 1);
            iVar13 = iVar13 + 1;
            if (local_38 == lVar16) {
              if ((bVar9) && (!bVar3)) {
                bVar6 = true;
              ...
              iVar1 = *(int *)((longlong)puVar15 + 0xc);
            }
            else {
              if (bVar9) {
                FUN_00d50b00();
...
LAB_014a4a40:
            ...
            if ((longlong)iVar1 <= (longlong)local_a0) {
              if (bVar9) {
                FUN_00d50b20();
              }
              bVar9 = false;
            ...
            lVar2 = *(longlong *)(puVar15[2] + (longlong)local_a0 * 8);
            if (lVar16 == lVar2) {
              if (!bVar9) {
                FUN_00d50b00();
                goto LAB_014a4af0;
...
LAB_014a4af0:
        ...
        if (DAT_0238fee8 <= dVar20 * _DAT_0240e3e0) {
...
LAB_014a4c8f:
          ...
          dVar20 = (double)_pow(dVar20 * _DAT_0240e3e0,(double)fVar19);
          fVar18 = *(float *)(local_88 + 0x20);
          fVar22 = (float)dVar20;
...
LAB_014a4c5d:
        ...
        local_a0 = dVar21;
        bVar7 = bVar6;
      } while (lVar17 < *(int *)((longlong)puVar14 + 0xc));
      ...
      if (iVar8 < 1) {
        ...
        local_38 = 0;
        iVar13 = *(int *)((longlong)puVar15 + 0xc);
joined_r0x014a4e9a:
        if (iVar13 <= iVar8) goto LAB_014a4ea0;
LAB_014a4e43:
        local_68 = *(longlong *)(puVar15[2] + (longlong)iVar8 * 8);
        if (lVar16 == local_68) {
          local_68 = lVar16;
          if ((!bVar9) && (lVar16 != 0)) {
            FUN_00d50b00();
...
joined_r0x014a4ed4:
        ...
        lVar17 = *(longlong *)(puVar15[2] + (ulonglong)(iVar8 - 1) * 8);
        if (local_38 == lVar17) {
          if (!bVar3) {
            if (local_38 == 0) {
              iVar13 = *(int *)((longlong)puVar15 + 0xc);
