...
/* WARNING: Removing unreachable block (ram,0x006fe945) */
/* WARNING: Removing unreachable block (ram,0x006fe951) */
/* WARNING: Removing unreachable block (ram,0x006feaab) */
/* WARNING: Removing unreachable block (ram,0x006feab7) */

void FUN_006fe880(longlong *param_1,longlong *param_2)
...
LAB_006fed54:
    ...
    iVar7 = 1;
    cVar3 = '\x01';
    if (unaff_RDI[2] == 0) goto LAB_006fed54;
    FUN_00d50b00();
    lVar5 = *param_2;
    FUN_00d50b20();
    if (lVar5 != 0) {
  ...
  if (cVar4 == '\0') {
    ...
    if (cVar4 == '\0') {
      ...
      if (local_94 == 1) {
        ...
        iVar7 = local_94;
        if (fVar9 <= fVar10) {
          iVar1 = *(int *)((longlong)unaff_RDI + 0xec);
          if ((local_50[0] != '\0') && (local_58 != 0)) {
            FUN_00d50b20();
          }
          if ((local_60 != '\0') && (local_68 != (longlong *)0x0)) {
...
LAB_006ff493:
      ...
      *(int *)((longlong)unaff_RDI + 0xec) = local_94;
    }
  }
  else {
    FUN_0021a630();
