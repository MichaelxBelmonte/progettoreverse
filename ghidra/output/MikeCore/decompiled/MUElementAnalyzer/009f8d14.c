...
/* WARNING: Removing unreachable block (ram,0x009f948f) */

longlong FUN_009f8d14(id *param_1,string *param_2,ulonglong *param_3,undefined8 param_4)
...
LAB_009f8dbc:
    lVar18 = (long)puVar13;
    if (plVar20 == (longlong *)0x0) goto LAB_009f8e27;
  }
    ...
    param_1 = (id *)(ulonglong)(*(longlong *)param_2 == 0);
    if ((plVar20 == (longlong *)0x0) == (*(longlong *)param_2 == 0)) goto LAB_009f8e27;
  }
  else if (plVar20 != (longlong *)0x0) goto LAB_009f8e27;
  plVar20 = (longlong *)*unaff_RSI;
  ...
  if ((uint)(int)cVar1 < 0x80) {
    uVar5 = *(uint *)(PTR___DefaultRuneLocale_0249c238 + (ulonglong)(uint)(int)cVar1 * 4 + 0x3c) &
            0x4000;
...
LAB_009f8e27:
  ...
  if (plVar17 == (longlong *)0x0) {
LAB_009f8eb8:
    if (plVar20 != (longlong *)0x0) goto LAB_009f8ebd;
LAB_009f8f0a:
    local_98 = 0;
  }
  else {
    if (plVar17[3] == plVar17[4]) {
      ...
      local_98 = 0;
      param_1 = (id *)(ulonglong)(*(longlong *)param_2 == 0);
      if ((plVar20 == (longlong *)0x0) == (*(longlong *)param_2 == 0)) goto LAB_009f8f1b;
    }
    else if (plVar20 != (longlong *)0x0) goto LAB_009f8f0a;
LAB_009f8ebd:
    plVar20 = (longlong *)*unaff_RSI;
    if ((char *)plVar20[3] == (char *)plVar20[4]) {
      cVar1 = (**(code **)(*plVar20 + 0x48))();
    ...
    if ((byte *)plVar20[3] == (byte *)plVar20[4]) {
      ...
      local_98 = (ulonglong)*(byte *)plVar20[3];
    }
  }
LAB_009f8f1b:
  local_e8 = 0;
  ...
  if (cVar1 == '\0') {
    ...
    *(undefined8 *)(pfVar6 + 8) = 0xffffffffffffffff;
    *(undefined **)pfVar6 = PTR_vtable_024a9850 + 0x10;
    std::ios_base::getloc();
  ...
  local_f8 = (byte *)(unaff_RDI + 0x10);
  bVar2 = *(byte *)(unaff_RDI + 0x10);
  if ((bVar2 & 1) == 0) {
    pcVar21 = (char *)(unaff_RDI + 0x11);
  }
  else {
    pcVar21 = *(char **)(unaff_RDI + 0x20);
  }
  local_f0 = unaff_RDI + 0x11;
  local_b0 = unaff_RDI + 0x70;
  local_a8 = unaff_RDI + 0x148;
  uVar14 = (undefined6)((ulonglong)local_a8 >> 0x10);
  local_9c = (undefined4)CONCAT62(uVar14,0x578);
  local_a0 = (undefined4)CONCAT62(uVar14,1);
  local_b4 = (undefined4)CONCAT62(uVar14,1);
  local_d0 = 0;
  local_d8 = 0;
...
LAB_009f905f:
  if ((bVar2 & 1) == 0) {
    uVar7 = (ulonglong)(bVar2 >> 1);
    lVar16 = local_f0;
  }
  else {
    uVar7 = *(ulonglong *)(unaff_RDI + 0x18);
    lVar16 = *(longlong *)(unaff_RDI + 0x20);
  }
...
LAB_009f90b4:
  ...
  if (plVar17 == (longlong *)0x0) {
LAB_009f90fb:
    if (plVar20 == (longlong *)0x0) goto LAB_009f9bd1;
  }
  else if (plVar17[3] == plVar17[4]) {
    iVar3 = (**(code **)(*plVar17 + 0x48))();
    if (iVar3 == -1) {
    ...
    if ((plVar20 == (longlong *)0x0) == (*(longlong *)param_2 == 0)) goto LAB_009f9bd1;
  }
  else if (plVar20 != (longlong *)0x0) goto LAB_009f9bd1;
  pcVar19 = pcVar21 + 1;
  if (*pcVar21 != '%') {
    if ((local_5c & 1) == 0) {
      plVar20 = (longlong *)*unaff_RSI;
  ...
  if (iVar3 < 0x59) {
    if (7 < iVar3 - 0x41U) {
      if (iVar3 == 0x4d) {
        ...
        puVar15 = (uint *)&local_58;
        local_c0 = (ulonglong *)FUN_009fca36(2,puVar15,local_78);
        bVar10 = true;
        puVar8 = local_c0;
        if (local_c0 == (ulonglong *)0xffffffffffffffff) {
          puVar15 = (uint *)param_2;
    ...
    this_00 = (string *)
              ((longlong)&switchD_009f9200::switchdataD_009f9e30 +
              (longlong)(int)(&switchD_009f9200::switchdataD_009f9e30)[iVar3 - 0x41U]);
    switch(iVar3) {
    case 0x41:
    ...
    case 0x46:
      ...
      local_5c = (uint)CONCAT71((int7)((ulonglong)this_00 >> 8),1);
      if (cVar1 == '.') {
        plVar20 = (longlong *)*unaff_RSI;
        if (plVar20[3] == plVar20[4]) {
          (**(code **)(*plVar20 + 0x50))();
    ...
    case 0x48:
      ...
      local_78[0] = CONCAT31(local_78[0]._1_3_,0x30);
      puVar15 = (uint *)&local_58;
      puVar8 = (ulonglong *)FUN_009fca36(2,puVar15,local_78);
      bVar10 = true;
      local_c8 = puVar8;
...
LAB_009f9912:
  ...
  psVar11 = (string *)(ulonglong)(iVar3 - 0x61U);
  if (0x18 < iVar3 - 0x61U) {
    if (iVar3 != 0x5a) {
      this_00 = psVar11;
...
LAB_009f96da:
        ...
        if (plVar17 == (longlong *)0x0) {
LAB_009f9721:
          if (plVar20 == (longlong *)0x0) goto LAB_009f97d9;
        }
        else if (plVar17[3] == plVar17[4]) {
          iVar3 = (**(code **)(*plVar17 + 0x48))();
          if (iVar3 == -1) {
          ...
          bVar10 = (*(longlong *)param_2 == 0) != (plVar20 == (longlong *)0x0);
          uVar7 = (ulonglong)bVar10;
          if (!bVar10) goto LAB_009f97d9;
        }
        else if (plVar20 != (longlong *)0x0) goto LAB_009f97d9;
        plVar20 = (longlong *)*unaff_RSI;
        if ((char *)plVar20[3] == (char *)plVar20[4]) {
          cVar1 = (**(code **)(*plVar20 + 0x48))();
        }
        ...
        if ((uint)(int)cVar1 < 0x80) {
          ...
          uVar5 = *(uint *)(PTR___DefaultRuneLocale_0249c238 +
                           (ulonglong)(uint)(int)cVar1 * 4 + 0x3c) & 0x4000;
        }
        else {
  ...
  this_00 = (string *)
            ((longlong)&switchD_009f91bf::switchdataD_009f9e50 +
            (longlong)(int)(&switchD_009f91bf::switchdataD_009f9e50)[(longlong)psVar11]);
  switch(psVar11) {
  case (string *)0x0:
  case (string *)0x16:
switchD_009f91bf_caseD_61:
    ...
    uVar7 = uStack_50;
    if ((local_58 & 1) == 0) {
      uVar7 = (ulonglong)((byte)local_58._0_1_ >> 1);
    }
...
LAB_009f94d5:
    puVar15 = (uint *)(ulonglong)local_5c;
    bVar10 = true;
    puVar8 = (ulonglong *)(ulonglong)((byte)local_58._0_1_ & 1);
...
LAB_009f9921:
  ...
  case (string *)0x9:
    ...
    local_78[0] = CONCAT31(local_78[0]._1_3_,0x30);
    puVar15 = (uint *)&local_58;
    puVar8 = (ulonglong *)((longlong)&MACH_HEADER.magic + 3);
...
switchD_009f91bf_caseD_73:
    ...
    local_78[0] = CONCAT31(local_78[0]._1_3_,0x30);
    puVar15 = (uint *)&local_58;
    puVar13 = (ulonglong *)((longlong)&MACH_HEADER.magic + 2);
...
LAB_009f99a6:
        ...
        bVar10 = (plVar17 == (longlong *)0x0) != (plVar20 != (longlong *)0x0);
        puVar13 = (ulonglong *)CONCAT71((int7)((ulonglong)puVar13 >> 8),bVar10);
        iVar3 = 0;
        if (bVar10) {
          iVar3 = 6;
        }
...
LAB_009f9808:
  ...
  if (plVar17 == (longlong *)0x0) {
LAB_009f9849:
    if (plVar20 == (longlong *)0x0) goto LAB_009f9897;
  }
  else if (plVar17[3] == plVar17[4]) {
    iVar3 = (**(code **)(*plVar17 + 0x48))();
    if (iVar3 == -1) {
    ...
    uVar7 = (ulonglong)(*(longlong *)param_2 == 0);
    if ((plVar20 == (longlong *)0x0) == (*(longlong *)param_2 == 0)) goto LAB_009f9897;
  }
  else if (plVar20 != (longlong *)0x0) goto LAB_009f9897;
  plVar20 = (longlong *)*unaff_RSI;
  if ((char *)plVar20[3] == (char *)plVar20[4]) {
    cVar1 = (**(code **)(*plVar20 + 0x48))();
  }
