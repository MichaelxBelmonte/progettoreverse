...
/* WARNING: Removing unreachable block (ram,0x0149e802) */
/* WARNING: Removing unreachable block (ram,0x0149e80f) */
/* WARNING: Removing unreachable block (ram,0x0149e9cd) */
/* WARNING: Removing unreachable block (ram,0x0149e9d6) */
...

{
  ...
  *puVar9 = &DAT_02572358;
  ...
  if ((int)in_EDX < 1) {
    ...
    bVar4 = false;
    do {
      lVar13 = *(longlong *)(*(longlong *)(*unaff_RSI + 0x10) + uVar10 * 8);
      if (local_40 == lVar13) {
        if ((!bVar5) && (local_40 != 0)) {
          bVar5 = true;
          FUN_00d50b00();
