  ...
  if ((in_RCX == (float *)0x0) || (in_RDX == 0)) {
    if ((int)uVar5 < (int)uVar6) {
      ...
      if (DAT_02411280 < in_XMM4_Da) {
        do {
          fVar13 = (float)((uint)(param_1 - *(float *)(unaff_RDI + uVar7 * 4)) & uVar2);
          if (fVar13 < param_2) {
            fVar11 = *(float *)(unaff_RSI + uVar7 * 4);
            fVar13 = *(float *)(lVar3 + (longlong)(int)((param_2 - fVar13) * fVar16 * fVar15) * 4) *
                     fVar11;
            fVar9 = fVar9 + fVar13;
            *(float *)(unaff_RSI + uVar7 * 4) = fVar11 - fVar13 * in_XMM4_Da;
          }
          uVar7 = uVar7 + 1;
        } while (uVar4 != uVar7);
      }
        ...
        do {
          fVar13 = (float)((uint)(param_1 - *(float *)(unaff_RDI + uVar7 * 4)) & _DAT_02390140);
          if (fVar13 < param_2) {
            fVar9 = fVar9 + *(float *)(lVar3 + (longlong)
                                               (int)((param_2 - fVar13) * fVar16 * DAT_0240e314) * 4
                                      ) * *(float *)(unaff_RSI + uVar7 * 4);
          }
          uVar7 = uVar7 + 1;
        } while (uVar4 != uVar7);
      }
    ...
    if (in_XMM4_Da <= DAT_02411280) {
      ...
      fVar9 = 0.0;
      do {
        fVar12 = (float)((uint)(param_1 - *(float *)(unaff_RDI + uVar7 * 4)) & uVar2);
        if (fVar12 < param_2) {
          fVar1 = *(float *)(unaff_RSI + uVar7 * 4);
          ...
          fVar9 = fVar9 + fVar14;
          *(float *)(unaff_RSI + uVar7 * 4) = fVar1 - fVar14 * in_XMM4_Da;
        }
        uVar7 = uVar7 + 1;
      } while (uVar4 != uVar7);
    }
LAB_014b7416:
  ...
  fVar11 = (float)((double)(float)((double)*(float *)(unaff_RSI +
