    ...
    if (uVar22 == 1) {
      ...
      if ((6 < uVar21) &&
         ((uVar9 = (ulonglong)uVar21 + 1,
          (float *)(unaff_RSI + (lVar12 + (ulonglong)uVar21) * 4 + 4) <= in_RCX ||
          (uVar22 = uVar16, in_RCX + uVar9 <= (float *)(unaff_RSI + lVar12 * 4))))) {
        ...
        if (uVar14 != 0) {
          lVar19 = unaff_RSI + (lVar11 + lVar12) * 4;
          lVar18 = 0;
          do {
      ...
      if ((uVar22 & 3) != 0) {
        uVar21 = 0;
        do {
          *pfVar10 = *(float *)(unaff_RSI + lVar12 * 4);
          pfVar10 = pfVar10 + 1;
          lVar12 = lVar12 + 1;
          uVar21 = uVar21 + 1;
      ...
      fVar27 = *(float *)(unaff_RSI + lVar12 * 4);
      lVar12 = lVar12 + 1;
      fVar25 = 0.0;
      lVar19 = 0;
      uVar16 = 0;
      ...
      do {
        fVar26 = fVar27;
        if (uVar16 == 0) {
          fVar26 = *(float *)(unaff_RSI + lVar12 * 4);
