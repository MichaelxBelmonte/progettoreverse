...

{
  ...
  if ((*(float *)(unaff_RDI + 0x9c) == param_1) &&
     (!NAN(*(float *)(unaff_RDI + 0x9c)) && !NAN(param_1))) {
    return;
  }
  *(float *)(unaff_RDI + 0x9c) = param_1;
  fVar3 = DAT_02390124;
  fVar2 = DAT_0239011c;
  fVar4 = DAT_02390124 - *(float *)(unaff_RDI + 0xa4);
  *(float *)(unaff_RDI + 0xa8) =
       (*(float *)(unaff_RDI + 0xa4) * DAT_0239011c + DAT_0239011c) * param_1;
  *(float *)(unaff_RDI + 0xac) = fVar4 * fVar2 * param_1;
