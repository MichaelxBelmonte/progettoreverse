...
/* WARNING: Removing unreachable block (ram,0x0024aa61) */
/* WARNING: Removing unreachable block (ram,0x0024aa6a) */

undefined8 FUN_0024a8a0(undefined8 param_1,int param_2)
...
LAB_0024a92d:
      ...
      *pcVar2 = '\0';
      ...
      if (local_50 == 0) {
        ...
        if (*(longlong *)(unaff_RDI + 0x90) == 0) goto LAB_0024a92d;
      }
      else {
        lVar3 = local_50;
...
LAB_0024a9ba:
      ...
      *pcVar2 = '\0';
      ...
      if (local_50 == 0) {
        lVar3 = *(longlong *)(unaff_RDI + 0x90);
        if (*(longlong *)(unaff_RDI + 0x90) == 0) goto LAB_0024a9ba;
      }
      else {
        lVar3 = local_50;
...
LAB_0024aa26:
      lVar3 = DAT_026f6f00;
      if (DAT_026f6f00 == 0) goto LAB_0024aa22;
LAB_0024aa32:
      FUN_00d50b00();
    }
    else {
      ...
      lVar3 = DAT_026f6e80;
      if (DAT_026f6e80 != 0) goto LAB_0024aa32;
LAB_0024aa22:
      lVar3 = 0;
    }
    FUN_00d6f370();
...
LAB_0024ab40:
  FUN_019928e0();
  FUN_01d66ab0();
  if ((plVar1 != (longlong *)0x0) && (local_50 != 0)) {
    FUN_00d50b20();
  }
  if (local_40[0] != '\0') {
    FUN_00d50b20();
