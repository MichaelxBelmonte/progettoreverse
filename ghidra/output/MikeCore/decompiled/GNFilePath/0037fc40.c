...
/* WARNING: Removing unreachable block (ram,0x0037ffdf) */
/* WARNING: Removing unreachable block (ram,0x0037ffeb) */
...

{
  ...
  (**(code **)(**(longlong **)(unaff_RDI + 0xf8) + 0x970))();
  local_68 = local_58;
  if (local_50 == '\0') {
    if (local_58 != 0) {
      FUN_00d50b00();
...
LAB_0037fca1:
    ...
    if (iVar4 != 0) {
      ...
      if (2 < iVar4) {
        ...
        if (((char)local_b0 != '\0') && (local_b8 != (undefined8 *)0x0)) {
          FUN_00d50b20();
        }
