...
/* WARNING: Removing unreachable block (ram,0x0007c097) */
/* WARNING: Removing unreachable block (ram,0x0007c0a3) */
/* WARNING: Removing unreachable block (ram,0x0007beaa) */
/* WARNING: Removing unreachable block (ram,0x0007beba) */
/* WARNING: Removing unreachable block (ram,0x0007bfe1) */
/* WARNING: Removing unreachable block (ram,0x0007bff1) */

void FUN_0007bcd0(undefined8 param_1,undefined8 param_2)

{
  ...
  plVar8 = local_50;
  if (local_48[0] == '\0') {
    if (local_50 == (longlong *)0x0) goto LAB_0007beed;
    FUN_00d50b00();
    if ((local_48[0] != '\0') && (local_50 != (longlong *)0x0)) {
      FUN_00d50b20();
    }
...
LAB_0007bf28:
  ...
  plVar2 = (longlong *)FUN_01a8fc90(param_2);
  ...
  *pcVar5 = '\0';
  ...
  if (local_78 == *unaff_RSI) {
    ...
    *pcVar5 = '\0';
    ...
    FUN_012e6a50();
    bVar11 = CONCAT71(uStack_f7,local_f8) != *unaff_RSI;
  ...
  if (bVar11) {
    ...
    *pcVar10 = '\0';
    ...
    if ((local_f8 != '\0') && (plVar8 != (longlong *)0x0)) {
      FUN_00d50b20();
    }
