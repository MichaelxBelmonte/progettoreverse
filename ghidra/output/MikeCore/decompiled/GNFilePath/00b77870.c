// Function: FUN_00b77870
// Address: 00b77870
// Size: 531 bytes
// Class: GNFilePath


void FUN_00b77870(float param_1)

{
  ...
  if ((*(float *)(unaff_RDI + 0xa4) == param_1) &&
     (!NAN(*(float *)(unaff_RDI + 0xa4)) && !NAN(param_1))) {
    return;
  }
  *(float *)(unaff_RDI + 0xa4) = param_1;
  fVar2 = DAT_0239011c;
  *(float *)(unaff_RDI + 0xa8) =
       (param_1 * DAT_0239011c + DAT_0239011c) * *(float *)(unaff_RDI + 0x9c);
  fVar3 = DAT_02390124;
  *(float *)(unaff_RDI + 0xac) = (DAT_02390124 - param_1) * fVar2 * *(float *)(unaff_RDI + 0x9c);
  uVar1 = *(undefined4 *)(unaff_RDI + 0x94);
  fVar2 = *(float *)(unaff_RDI + 0x98);
  *(undefined4 *)(unaff_RDI + 0xb0) = uVar1;
  *(float *)(unaff_RDI + 0xb4) = fVar2;
  ...
  *(undefined4 *)(unaff_RDI + 0x298) = uVar1;
  fVar3 = fVar3 - fVar2;
  *(float *)(unaff_RDI + 0xc0) = fVar2;
  *(float *)(unaff_RDI + 0xc4) = fVar3;
  *(float *)(unaff_RDI + 0x1c0) = fVar2;
  *(float *)(unaff_RDI + 0x1c4) = fVar3;
  *(float *)(unaff_RDI + 0xe0) = fVar2;
  *(float *)(unaff_RDI + 0xe4) = fVar3;
  *(float *)(unaff_RDI + 0x1e0) = fVar2;
  *(float *)(unaff_RDI + 0x1e4) = fVar3;
  *(float *)(unaff_RDI + 0x100) = fVar2;
  *(float *)(unaff_RDI + 0x104) = fVar3;
  *(float *)(unaff_RDI + 0x200) = fVar2;
  *(float *)(unaff_RDI + 0x204) = fVar3;
  *(float *)(unaff_RDI + 0x120) = fVar2;
  *(float *)(unaff_RDI + 0x124) = fVar3;
  *(float *)(unaff_RDI + 0x220) = fVar2;
  *(float *)(unaff_RDI + 0x224) = fVar3;
  *(float *)(unaff_RDI + 0x140) = fVar2;
  *(float *)(unaff_RDI + 0x144) = fVar3;
  *(float *)(unaff_RDI + 0x240) = fVar2;
  *(float *)(unaff_RDI + 0x244) = fVar3;
  *(float *)(unaff_RDI + 0x160) = fVar2;
  *(float *)(unaff_RDI + 0x164) = fVar3;
  *(float *)(unaff_RDI + 0x260) = fVar2;
  *(float *)(unaff_RDI + 0x264) = fVar3;
  *(float *)(unaff_RDI + 0x180) = fVar2;
  *(float *)(unaff_RDI + 0x184) = fVar3;
  *(float *)(unaff_RDI + 0x280) = fVar2;
  *(float *)(unaff_RDI + 0x284) = fVar3;
  *(float *)(unaff_RDI + 0x1a0) = fVar2;
  *(float *)(unaff_RDI + 0x1a4) = fVar3;
  *(float *)(unaff_RDI + 0x2a0) = fVar2;
