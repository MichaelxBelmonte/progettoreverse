...
void FUN_00228b40(longlong *param_1,double param_2)

{
  ...
  if (*(int *)(unaff_RDI + 0x198) == local_94) {
    return;
  }
  ...
  *(char *)pplVar8 = '\0';
  if ((local_50[0] != '\0') && (plVar7 != (longlong *)0x0)) {
    FUN_00d50b20();
  }
  pVar4 = (pthread_key_t)pplVar16;
  local_70 = (longlong *)(unaff_RDI + 0x90);
...
LAB_00228cd8:
  ...
  if (plVar7 == (longlong *)0x0) {
    local_b8 = CONCAT71((int7)((ulonglong)uVar18 >> 8),1);
    local_78 = plVar7;
LAB_00228ebc:
    if (1 < *(int *)(unaff_RDI + 0x198) - 1U) goto LAB_0022901b;
    plVar15 = (longlong *)*local_70;
    (**(code **)(&UNK_00001550 + *plVar15))();
    plVar7 = local_58;
    pplVar16 = &local_68;
    if (local_50[0] != '\0') {
...
LAB_00228f28:
    ...
    local_a8 = (longlong *)(**(code **)(*plVar7 + 0xf08))();
    if (plVar15 != (longlong *)0x0) {
      FUN_00d50b20();
    }
    local_d0 = DAT_023908c8;
    if (*(longlong *)(unaff_RDI + 0xc0) == 0) {
      local_c8 = DAT_023908c8;
      local_80 = (longlong *)DAT_023908c8;
    }
    else {
      FUN_00d50b00();
      FUN_00d50b20();
      plVar15 = *(longlong **)(unaff_RDI + 0xc0);
      if (plVar15 != (longlong *)0x0) {
        FUN_00d50b00();
      }
      local_80 = (longlong *)(**(code **)(*plVar15 + 0x408))();
      FUN_00d50b20();
      plVar15 = *(longlong **)(unaff_RDI + 0xc0);
      if (plVar15 != (longlong *)0x0) {
        FUN_00d50b00();
    ...
    local_a0 = (longlong *)DAT_023908c8;
    local_c0 = DAT_023908c8;
  }
  else {
...
LAB_00228ea5:
    ...
    if (iVar14 == 0) {
      ...
      if (plVar7 == local_58) {
        ...
        plVar15 = plVar7;
LAB_0022b5ab:
        if ((local_50[0] != '\0') && (plVar15 != (longlong *)0x0)) {
      ...
      local_b8 = CONCAT71((int7)((ulonglong)plVar7 >> 8),1);
      goto LAB_00228ebc;
    }
    local_a8 = plVar7;
    if (iVar14 == 1) {
      ...
      plVar15 = local_58;
      if (local_50[0] == '\0') {
        if (local_58 == (longlong *)0x0) goto LAB_0022b56a;
        FUN_00d50b00();
LAB_0022b312:
        local_a0 = plVar15;
        ...
        local_b8 = CONCAT71((int7)((ulonglong)plVar10 >> 8),1);
        if (plVar15 != (longlong *)0x0) {
          FUN_00d50b20();
        }
        bVar17 = false;
        ...
        if (local_58 != (longlong *)0x0) goto LAB_0022b312;
LAB_0022b56a:
        FUN_00d50b20();
        bVar17 = true;
        local_78 = (longlong *)0x0;
    ...
    if (iVar14 == 2) {
      if (local_94 == 0) {
        if (*(longlong **)(unaff_RDI + 0x1b8) != (longlong *)0x0) {
          local_78 = plVar7;
          local_80 = *(longlong **)(unaff_RDI + 0x1b8);
          uVar18 = FUN_00d50b00();
          local_a0 = (longlong *)CONCAT71((int7)((ulonglong)uVar18 >> 8),1);
          goto LAB_0022b6aa;
        }
      }
      else {
        ...
        if (plVar15 != (longlong *)0x0) {
          ...
          if (local_58 == (longlong *)0x0) {
            ...
            local_50[0] = '\0';
            local_a0 = (longlong *)CONCAT71((int7)((ulonglong)local_58 >> 8),1);
          }
          if ((local_60 != '\0') && (local_68 != (longlong *)0x0)) {
            FUN_00d50b20();
          }
          if ((local_88 != '\0') && (plVar15 != (longlong *)0x0)) {
            FUN_00d50b20();
          }
LAB_0022b6aa:
          if (local_80 != (longlong *)0x0) {
            ...
            while( true ) {
              ...
              pvVar6 = _pthread_getspecific((pthread_key_t)lVar13);
              pVar4 = (pthread_key_t)lVar13;
              if ((pvVar6 != (void *)0x0) && (lVar11 = FUN_00e8b990(), lVar11 != 0)) {
                pVar4 = (pthread_key_t)local_80;
              }
              pvVar6 = _pthread_getspecific(pVar4);
              if (pvVar6 != (void *)0x0) {
                FUN_00e8b990();
              ...
              local_68 = plVar12;
              local_60 = '\0';
              FUN_00d214d0(uVar18,*(undefined4 *)((longlong)plVar15 + 0xc));
              if ((local_60 != '\0') && (local_68 != (longlong *)0x0)) {
                FUN_00d50b20();
              }
              if (plVar12 != (longlong *)0x0) {
            ...
            local_b8 = CONCAT71((int7)((ulonglong)plVar12 >> 8),1);
            if ((char)local_a0 != '\0') {
              FUN_00d50b20();
            }
            goto LAB_00228ebc;
...
LAB_00229074:
    ...
    local_a0 = (longlong *)(**(code **)(*plVar7 + 0xf08))();
    if (plVar15 != (longlong *)0x0) {
      FUN_00d50b20();
    }
    local_c8 = DAT_023908c8;
    ...
    local_80 = (longlong *)DAT_023908c8;
    local_a8 = (longlong *)DAT_023908c8;
  }
  plVar15 = (longlong *)*local_70;
  (**(code **)(&UNK_00001550 + *plVar15))();
  plVar7 = local_58;
...
LAB_002291b3:
  ...
  plVar7 = local_68;
  if (local_60 == '\0') {
    if (((local_68 != (longlong *)0x0) && (dVar19 = (double)FUN_00d50b00(), local_60 != '\0')) &&
       (local_68 != (longlong *)0x0)) {
...
LAB_00229836:
    local_b0 = (int *)(unaff_RDI + 0x19c);
    *(undefined4 *)(unaff_RDI + 0x19c) = *(undefined4 *)(unaff_RDI + 0x198);
    *(int *)(unaff_RDI + 0x198) = local_94;
    if (local_94 == 2) {
      if (*(longlong *)(unaff_RDI + 0xb8) != 0) {
        FUN_00d50b00();
        FUN_00d50b20();
        (**(code **)(&UNK_00001550 + *(longlong *)*local_70))();
        plVar15 = local_58;
        local_68 = (longlong *)CONCAT71(local_68._1_7_,local_50[0]);
        pplVar16 = (longlong **)local_50;
        if (local_50[0] == '\0') {
        ...
        *(char *)pplVar16 = '\0';
        ...
        if (plVar15 == (longlong *)0x0) {
          plVar15 = (longlong *)*local_70;
          if (plVar15 != (longlong *)0x0) goto LAB_002298ea;
...
LAB_00229948:
        ...
        lVar11 = *(longlong *)(unaff_RDI + 0xb8);
        if (lVar11 != 0) {
          FUN_00d50b00();
        }
        uVar3 = FUN_00440c80();
...
LAB_00229593:
          ...
          *(char *)pplVar16 = '\0';
          ...
          if (plVar7 == (longlong *)0x0) {
            plVar7 = (longlong *)*local_70;
            if (plVar7 == (longlong *)0x0) goto LAB_00229593;
          }
...
LAB_00229595:
        ...
        FUN_019af2a0();
        if ((plVar15 != (longlong *)0x0) && (plVar7 != (longlong *)0x0)) {
          FUN_00d50b20();
        }
      }
    }
...
LAB_002295c8:
      ...
      if (plVar15 == (longlong *)0x0) goto LAB_00229836;
      plVar15 = (longlong *)*local_70;
      (**(code **)(&UNK_00001550 + *plVar15))();
      plVar7 = local_58;
      local_68 = (longlong *)CONCAT71(local_68._1_7_,local_50[0]);
...
LAB_00229806:
          ...
          *(char *)pplVar16 = '\0';
          ...
          if (plVar7 == (longlong *)0x0) {
            plVar7 = (longlong *)*local_70;
            if (plVar7 == (longlong *)0x0) goto LAB_00229806;
          }
...
LAB_00229fcd:
      ...
      *(char *)pplVar16 = '\0';
      ...
      if (plVar7 == (longlong *)0x0) {
        plVar7 = (longlong *)*local_70;
        if (plVar7 == (longlong *)0x0) goto LAB_00229fcd;
      }
...
LAB_0022a12b:
    ...
    if (!NAN((double)local_a0)) {
      ...
      if (plVar15 != (longlong *)0x0) {
        ...
        local_a8 = (longlong *)FUN_016553c0(local_a0);
        if ((local_50[0] != '\0') && (plVar15 != (longlong *)0x0)) {
          FUN_00d50b20();
        }
      }
    ...
    if (!NAN(local_c0)) {
      ...
      if (plVar15 != (longlong *)0x0) {
        ...
        local_80 = (longlong *)FUN_016553c0(local_c0);
        if ((local_50[0] != '\0') && (plVar15 != (longlong *)0x0)) {
          FUN_00d50b20();
        }
        FUN_00226f20();
    ...
    if ((!NAN((double)local_80)) && (*(longlong *)(unaff_RDI + 0xc0) != 0)) {
      FUN_00d50b00();
      FUN_00d50b20();
      plVar15 = *(longlong **)(unaff_RDI + 0xc0);
      if (plVar15 != (longlong *)0x0) {
    ...
    plVar15 = DAT_026f6ea0;
    if (DAT_026f6ea0 != (longlong *)0x0) {
      FUN_00d50b00();
    }
    dVar19 = (double)FUN_00e7d6f0();
    uVar9 = (ulonglong)(dVar19 * DAT_023907c0);
    dVar19 = dVar19 * DAT_023907c0 - _DAT_023907c8;
    uVar18 = FUN_0071a120();
    if ((((local_50[0] == '\0') && (local_58 != (longlong *)0x0)) &&
        (uVar18 = FUN_00d50b00(), local_50[0] != '\0')) && (local_58 != (longlong *)0x0)) {
      uVar18 = FUN_00d50b20();
    }
    bVar2 = (byte)(((longlong)dVar19 & (longlong)uVar9 >> 0x3f | uVar9) / 3);
    local_68 = plVar15;
    local_60 = '\0';
    ...
    if ((plVar7 != (longlong *)0x0 & bVar2) == 0) {
      (**(code **)(&UNK_00001550 + **(longlong **)(unaff_RDI + 0x90)))();
      FUN_019f7880();
      if ((local_50[0] != '\0') && (local_58 != (longlong *)0x0)) {
        FUN_00d50b20();
    ...
    FUN_00234140();
    (**(code **)((longlong)&dylib_command_00001288.dylib.name.offset + *plVar15))();
    if (lVar11 != 0) {
      FUN_00d50b20();
    }
    if ((local_50[0] != '\0') && (local_58 != (longlong *)0x0)) {
...
LAB_00229d5b:
      ...
      *(char *)pplVar16 = '\0';
      ...
      if (plVar7 == (longlong *)0x0) {
        plVar7 = (longlong *)*local_70;
        if (plVar7 == (longlong *)0x0) goto LAB_00229d5b;
      }
...
LAB_00229ee3:
    ...
    if ((!NAN((double)local_a8)) && (*(longlong *)(unaff_RDI + 0xc0) != 0)) {
      FUN_00d50b00();
      FUN_00d50b20();
      plVar15 = *(longlong **)(unaff_RDI + 0xc0);
      if (plVar15 != (longlong *)0x0) {
...
LAB_00229b92:
      ...
      *(char *)pplVar16 = '\0';
      ...
      if (plVar7 == (longlong *)0x0) {
        plVar7 = (longlong *)*local_70;
        if (plVar7 == (longlong *)0x0) goto LAB_00229b92;
      }
...
LAB_00229ced:
    ...
    FUN_000bdcb0();
    if (((cVar1 != '\0') && (local_88 != '\0')) && (local_90 != (longlong *)0x0)) {
      FUN_00d50b20();
    }
    if ((local_60 != '\0') && (local_68 != (longlong *)0x0)) {
      FUN_00d50b20();
    ...
    if (!NAN((double)local_a8)) {
      ...
      if (plVar15 != (longlong *)0x0) {
        ...
        local_a0 = (longlong *)FUN_01656080(local_a8);
        if ((local_50[0] != '\0') && (plVar15 != (longlong *)0x0)) {
          FUN_00d50b20();
        }
      }
    }
    if ((!NAN((double)local_a0)) && (*(longlong *)(unaff_RDI + 0xc0) != 0)) {
      FUN_00d50b00();
      FUN_00d50b20();
      plVar15 = *(longlong **)(unaff_RDI + 0xc0);
      if (plVar15 != (longlong *)0x0) {
    ...
    if ((!NAN(local_c0)) && (*(longlong *)(unaff_RDI + 0xc0) != 0)) {
      FUN_00d50b00();
      FUN_00d50b20();
      plVar15 = *(longlong **)(unaff_RDI + 0xc0);
      if (plVar15 != (longlong *)0x0) {
...
LAB_0022aea3:
    ...
    if (plVar15 == (longlong *)0x0) goto LAB_0022aea3;
  }
  if ((*local_b0 == 2) && (FUN_0021f1f0(), *(longlong *)(unaff_RDI + 0x98) != 0)) {
    FUN_00d50b00();
  ...
  if ((local_78 == (longlong *)0x0) || (*(int *)((longlong)local_78 + 0xc) == 0)) {
    plVar15 = (longlong *)*local_70;
    (**(code **)(&UNK_00001550 + *plVar15))();
    plVar7 = local_58;
    local_68 = (longlong *)CONCAT71(local_68._1_7_,local_50[0]);
...
LAB_0022b1b8:
  plVar15 = *(longlong **)(unaff_RDI + 0xd8);
  if (plVar15 != (longlong *)0x0) {
    uVar18 = FUN_00d50b00();
    (**(code **)(*plVar15 + 0x650))(uVar18,*(undefined4 *)(unaff_RDI + 0x198));
    if (unaff_RDI != 0) {
      FUN_00d50b20();
    }
    FUN_00637870();
