...
undefined8 FUN_01f85db0(undefined8 param_1,int param_2)
...
LAB_01f85fd1:
    ...
    if (local_40 == (longlong *)0x0) goto LAB_01f85eba;
LAB_01f85e18:
    uVar12 = FUN_01d66da0();
    local_188 = DAT_02800fe8;
    if (DAT_02800fe8 != 0) {
      uVar12 = FUN_00d50b00();
    }
    local_180 = '\x01';
    ...
    plVar9 = local_40;
    if ((DAT_026fde10 == '\0') && (iVar7 = ___cxa_guard_acquire(), iVar7 != 0)) {
...
LAB_01f85e96:
    ...
    FUN_00d50b20();
    if (local_48 == (longlong *)0x0) goto LAB_01f85fd1;
    cVar6 = (**(code **)(*local_48 + 0x398))();
    if (cVar6 != '\0') {
      (**(code **)(*local_48 + 0x370))();
      plVar9 = local_40;
      local_178 = DAT_028bb250;
      if (DAT_028bb250 != 0) {
        FUN_00d50b00();
      }
      local_170 = '\x01';
...
LAB_01f86173:
  ...
  if (cVar6 != '\0') {
    FUN_00cac150();
    plVar2 = (longlong *)CONCAT71(uStack_57,local_58);
    if (local_50 == '\0') {
    ...
    if (*(int *)((longlong)plVar2 + 0xc) != 0) {
      ...
      *pcVar8 = '\0';
      ...
      if (plVar2 == local_48) {
        ...
        if ((!bVar3) || (local_48 == (longlong *)0x0)) goto LAB_01f86530;
        local_48 = plVar2;
        FUN_00d50b20();
        bVar3 = true;
      }
      else if ((bVar3) && (local_48 != (longlong *)0x0)) {
        FUN_00d50b20();
        local_48 = plVar2;
        bVar3 = true;
      }
...
LAB_01f8658b:
  ...
  if (cVar6 == '\0') {
    ...
    (**(code **)(*(longlong *)unaff_RDI[0x10] + 0x620))();
  }
  if (bVar3) {
    FUN_00d50b20();
  }
