...
/* WARNING: Removing unreachable block (ram,0x0037ed95) */
/* WARNING: Removing unreachable block (ram,0x0037eda1) */
/* WARNING: Removing unreachable block (ram,0x0037efc3) */
/* WARNING: Removing unreachable block (ram,0x0037efcf) */
...

{
  ...
  *puVar3 = &DAT_02572358;
  uVar8 = (*DAT_02572370)();
  if ((plVar7 != (longlong *)0x0) && (*(int *)((longlong)plVar7 + 0xc) != 0)) {
    local_70 = '\0';
    local_78 = (longlong *)0x0;
    local_48 = plVar7;
    local_68 = plVar7;
