// Function: FUN_00b77a90
// Address: 00b77a90
// Size: 544 bytes
// Class: GNFilePath


void FUN_00b77a90(float param_1)

{
  ...
  param_1 = param_1 * DAT_0240e308;
  if ((*(float *)(unaff_RDI + 0x90) == param_1) &&
     (!NAN(*(float *)(unaff_RDI + 0x90)) && !NAN(param_1))) {
    return;
  }
  *(float *)(unaff_RDI + 0x90) = param_1;
  fVar3 = DAT_02390124;
  fVar2 = DAT_0239011c;
