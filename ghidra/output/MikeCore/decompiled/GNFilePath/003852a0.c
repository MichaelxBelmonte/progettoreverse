...
ulonglong FUN_003852a0(undefined8 param_1,undefined4 param_2)

{
  ...
  local_5c = param_2;
  (**(code **)(**(longlong **)(unaff_RDI + 0xe8) + 0x3f8))();
  plVar1 = local_58;
  ...
  if ((plVar1 != (longlong *)0x0) && (*(int *)((longlong)plVar1 + 0xc) != 0)) {
    local_50 = '\0';
...
LAB_003853cc:
    local_40 = (int)lVar6;
    if (local_40 < *(int *)((longlong)plVar1 + 0xc)) goto code_r0x003853d6;
    FUN_00115910();
    uVar5 = CONCAT71((int7)((ulonglong)&local_70 >> 8),1);
    if ((char)local_5c != '\0') {
      local_50 = '\0';
      local_58 = (longlong *)0x0;
      local_3c = 0;
      local_48 = plVar1;
      for (lVar6 = 0; local_40 = (int)lVar6, local_40 < *(int *)((longlong)plVar1 + 0xc);
          lVar6 = lVar6 + 1) {
        local_58 = *(longlong **)(plVar1[2] + lVar6 * 8);
        FUN_0037b970();
      }
      FUN_00115910();
      if (plVar2 == (longlong *)0x0) goto LAB_00385484;
      goto LAB_0038547c;
    }
    goto LAB_00385477;
  }
...
code_r0x003853d6:
  local_70 = *(longlong **)(plVar1[2] + lVar6 * 8);
  local_68 = '\0';
  local_58 = local_70;
  cVar3 = FUN_00d23d70();
