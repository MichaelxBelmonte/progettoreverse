...
ulonglong FUN_016f7150(undefined8 param_1,int param_2)
...
LAB_016f7368:
  ...
  local_84 = 0xffffffff;
  pvVar8 = _pthread_getspecific(pVar17);
  puVar19 = (undefined8 *)(unaff_RDI + 0x50);
  local_38 = puVar19;
  if (pvVar8 != (void *)0x0) {
    FUN_00e8b990();
  }
...
LAB_016f794d:
      ...
      pvVar8 = _pthread_getspecific((pthread_key_t)puVar20);
      if (pvVar8 != (void *)0x0) {
        FUN_00e8b990();
      }
      puVar20 = &local_84;
      ...
      FUN_00d4ff40();
      puVar21 = (ulonglong *)&DAT_02572358;
      *puVar19 = &DAT_02572358;
      pcVar4 = DAT_02572370;
      (*DAT_02572370)();
      dVar11 = DAT_023b4df8 / dVar11;
      dVar29 = (DAT_023b4df8 / local_b0) * dVar29;
      bVar25 = false;
      while( true ) {
        if (bVar25) {
          FUN_00e7b970();
          ...
          if (((uVar10 >> 0x20 == 0) || (iStack_b4 == 0)) || (cVar5 = FUN_00e7c020(), cVar5 == '\0')
            ...
            pvVar8 = _pthread_getspecific((pthread_key_t)puVar21);
            if (pvVar8 != (void *)0x0) {
              FUN_00e8b990();
            }
        ...
        pVar17 = (pthread_key_t)puVar21;
        if (local_80 < dVar27) break;
        FUN_00e7b820();
        local_60 = uVar10;
        if ((uVar10 >> 0x20 != 0) && (local_d0._4_4_ != 0)) {
          bVar6 = FUN_00e7c020();
          puVar21 = (ulonglong *)CONCAT71((int7)((ulonglong)puVar21 >> 8),!bVar25);
          if ((bVar6 & !bVar25) == 1) {
            FUN_00d23340();
            local_60 = CONCAT71(local_60._1_7_,local_40[0]);
            puVar21 = &local_60;
            puVar14 = (ulonglong *)local_40;
            if (local_40[0] == '\0') {
              puVar14 = puVar21;
            }
            *(char *)puVar14 = '\0';
...
LAB_016f8d75:
          ...
          pVar17 = (pthread_key_t)(local_150 >> 0x20);
          ...
          if (local_a8._4_4_ != 0) {
            ...
            if (local_48 >> 0x20 != 0) {
              ...
              if (cVar5 != '\0') {
                local_a8 = *(ulonglong *)(unaff_RDI + 0x68);
              }
            }
          }
LAB_016f84eb:
          ...
          FUN_00e7bac0();
          uVar7 = FUN_00e7cea0();
          pVar17 = *(pthread_key_t *)(local_48 + 0xc);
          ...
          lVar9 = *(longlong *)(*(longlong *)(local_48 + 0x10) + (ulonglong)uVar2 * 8);
          if (lVar9 != 0) {
            FUN_00d50b00();
          }
          pvVar8 = _pthread_getspecific(pVar17);
          ...
          local_170 = (ulonglong)uVar7;
          dVar28 = *(double *)(local_48 + 0x10);
          uVar1 = *(ulonglong *)((longlong)dVar28 + (longlong)(int)uVar7 * 8);
          if (uVar1 != 0) {
            FUN_00d50b00();
          }
          ...
          if (dVar27 - dVar30 <= DAT_023e16a0) {
            ...
            *puVar16 = &DAT_02572358;
            ...
            if (1 < (int)uVar24) {
              dVar11 = DAT_023b4df8 / dVar11;
              dVar32 = DAT_024119d0;
              if (local_158 * _DAT_023b1e98 <= DAT_024119d0) {
                dVar32 = local_158 * _DAT_023b1e98;
              }
              dVar31 = dVar31 * DAT_023b4df8;
              uVar12 = 1;
              do {
                pVar17 = SUB84(dVar28,0);
                pvVar8 = _pthread_getspecific(pVar17);
                ...
                if (dVar34 - dVar33 < dVar31 / dVar32) {
                  bVar3 = true;
                  bVar25 = true;
                  if (puVar16 != (undefined8 *)0x0) goto LAB_016f8d27;
                  goto LAB_016f8d33;
                }
            ...
            uVar24 = *(uint *)((longlong)puVar16 + 0xc);
            if ((int)uVar24 < 1) {
              bVar25 = false;
            }
            else {
              lVar15 = (ulonglong)uVar24 + 1;
              do {
                uVar24 = uVar24 - 1;
                lVar22 = puVar16[2];
                local_48 = *(ulonglong *)(lVar22 + (ulonglong)uVar24 * 8);
                if (local_48 != 0) {
                  uVar26 = FUN_00d50b00();
                }
                pVar17 = (pthread_key_t)lVar22;
                local_40[0] = '\0';
...
LAB_016f8d33:
        ...
        if (puVar19 == (undefined8 *)0x0) goto LAB_016f8f6f;
      }
      else {
        local_80 = local_80 + dVar29 * _DAT_024119f0;
        while (*(int *)((longlong)puVar19 + 0xc) != 0) {
          FUN_00d23340();
          local_60 = CONCAT71(local_60._1_7_,local_40[0]);
          puVar21 = &local_60;
          puVar14 = (ulonglong *)local_40;
      ...
      uVar12 = FUN_01909dc0();
      puVar19 = (undefined8 *)*local_38;
      pvVar8 = _pthread_getspecific(pVar17);
      if (pvVar8 != (void *)0x0) {
        puVar19 = (undefined8 *)*local_38;
        lVar9 = FUN_00e8b990();
        if (lVar9 != 0) {
          puVar19 = (undefined8 *)puVar19[(ulonglong)(*(uint *)(lVar9 + 0x154) & 1) + 4];
        }
      }
      local_80 = (double)FUN_018fcb10();
      FUN_00e7b820();
...
LAB_016f8f6f:
    ...
    FUN_01901eb0((DAT_023b4df8 / dVar28) * dVar29);
LAB_016f8f8e:
    uVar10 = CONCAT71((int7)((ulonglong)puVar19 >> 8),1);
  }
  if (local_78 != 0) {
    FUN_00d50b20();
  }
