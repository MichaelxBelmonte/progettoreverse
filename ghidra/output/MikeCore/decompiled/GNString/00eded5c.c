// Function: FUN_00eded5c
// Address: 00eded5c
// Size: 2301 bytes
// Class: GNString


ulonglong FUN_00eded5c(ulonglong *param_1,ulonglong *param_2)

{
  ...
  if (*(int *)(unaff_RDI + 300) == 0) {
      ...
      if (uVar19 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(unaff_RDI + 0x40 + uVar16 * 4) =
               (int)((*(longlong *)(lVar4 + 8 + uVar11) * -0x30e4432345000000 ^ uVar23) >>
                    (bVar12 & 0x3f));
      ...
      if (uVar31 - 0x20 < uVar19) {
        ...
        do {
          *(int *)(unaff_RDI + 0x40 + (ulonglong)((uint)uVar29 & 7) * 4) =
               (int)((*(longlong *)(lVar4 + uVar29) * -0x30e4432345000000 ^ uVar23) >>
                    (bVar18 & 0x3f));
          uVar29 = uVar29 + 1;
        } while (uVar19 != uVar29);
      }
    ...
    if ((uint)uVar11 < uVar31) {
      ...
      do {
        ...
        *(int *)(unaff_RDI + 0x40 + uVar23 * 4) =
             (int)((*(longlong *)(lVar21 + 8 + uVar11) * -0x30e4432345000000 ^
    ...
    *(int *)(unaff_RDI + 0x40 + (ulonglong)(uVar31 & 7) * 4) =
         (int)((*(longlong *)((uVar32 & 0xffffffff) + 8 + lVar4) * -0x30e4432345000000 ^ uVar9) >>
              (bVar12 & 0x3f));
  }
  else {
    uVar32 = *unaff_RSI;
    *(uint *)(unaff_RDI + 0x2c) = uVar31;
    uVar11 = (uVar32 * -0x30e4432345000000 ^ uVar9) >> (0x38U - cVar27 & 0x3f) & 0xffffffff;
  }
