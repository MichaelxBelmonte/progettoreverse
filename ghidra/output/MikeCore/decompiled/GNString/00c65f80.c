...
undefined8 FUN_00c65f80(uint param_1,longlong *param_2,int param_3,int *param_4)
  ...
  if (param_3 - 1U < 0x20) {
    ...
    *unaff_RDI = uVar18;
    if (param_1 != 0) {
      uVar4 = unaff_RDI[3];
      uVar5 = unaff_RDI[4];
      lVar19 = (longlong)(int)(uVar10 - uVar1) + 1;
      local_40 = (ulonglong)uVar2;
      iVar21 = 0;
      local_34 = 0;
      uVar10 = 0;
      do {
        ...
        if ((uVar8 < 9) && (uVar15 = uVar15 + uVar8 + (uint)(uVar20 % uVar17 != 0), uVar15 < 0x1a))
        {
          FUN_00c6c310();
          uVar9 = FUN_00c6c320();
          *(undefined4 *)(lVar6 + (ulonglong)((uint)local_40 >> 3)) = uVar9;
          uVar15 = uVar15 + (uint)local_40;
        }
        else {
          FUN_00c6c310();
          uVar9 = FUN_00c6c320(local_40 & 0xffffff07 ^ 0x17);
          *(undefined4 *)(lVar6 + (local_40 >> 3)) = uVar9;
          ...
          if (iVar14 < 0) {
            ...
            *(char *)(lVar6 + 4 + (ulonglong)((uint)local_40 >> 3)) = (char)uVar15;
          }
          else {
...
LAB_00c663c7:
          ...
          *(undefined4 *)(lVar6 + (ulonglong)(uVar15 >> 3)) = uVar9;
          uVar18 = 0;
          local_40 = (ulonglong)(uVar10 + uVar15);
        }
        uVar10 = local_38;
