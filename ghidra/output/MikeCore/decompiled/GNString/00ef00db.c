...
ulonglong FUN_00ef00db(ulonglong *param_1,ulonglong *param_2)

{
  ...
  uVar28 = *unaff_RSI * -0x30e4432340650000 >> (0x42U - *(char *)(puVar6 + 0x21) & 0x3f);
  ...
  if (*(int *)(unaff_RDI + 300) == 0) {
      ...
      if (uVar35 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(unaff_RDI + 0x40 + uVar14 * 4) =
               (int)((*(longlong *)(lVar16 + 8 + uVar21) * -0x30e4432340650000 ^ uVar15) >>
                    (bVar26 & 0x3f));
    ...
    if ((uint)uVar21 < uVar36) {
      ...
      do {
        ...
        *(int *)(unaff_RDI + 0x40 + uVar32 * 4) =
             (int)((*(longlong *)(lVar19 + 8 + uVar21) * -0x30e4432340650000 ^
    ...
    *(int *)(unaff_RDI + 0x40 + (ulonglong)(uVar36 & 7) * 4) =
         (int)((*(longlong *)((uVar38 & 0xffffffff) + 8 + lVar16) * -0x30e4432340650000 ^ uVar11) >>
              (bVar26 & 0x3f));
  }
  else {
    uVar35 = (uint)((*unaff_RSI * -0x30e4432340650000 ^ uVar11) >> (0x38U - cVar39 & 0x3f));
    *(uint *)(unaff_RDI + 0x2c) = uVar36;
  }
...
LAB_00ef082c:
        ...
        if ((uVar38 < uVar15) &&
           ...
           (ulonglong *)((longlong)unaff_RSI + uVar15) == param_2)) goto LAB_00ef0b86;
      }
      uVar32 = uVar32 + 1;
    } while (uVar32 != uVar11);
  }
