...
LAB_006cb664:
  ...
  local_40 = '\x01';
  FUN_00d14780(&local_48,&local_e8);
  plVar1 = local_38;
  if (local_30 == '\0') {
  ...
  unaff_RDI[0x1c] = (longlong)plVar5;
  if (lVar2 != 0) {
    FUN_00d50b20();
  }
  if (plVar1 != (longlong *)0x0) {
