  ...
  if (lVar4 == 0) {
    ...
    if (cVar6 == '\0') {
      ...
      *puVar8 = &DAT_025683c0;
      (*DAT_025683d8)();
      FUN_00c92170();
      puVar5 = *(undefined8 **)(unaff_RDI + 0x10);
      if (puVar5 == puVar8) {
        FUN_00d50b20();
      }
      else {
        *(undefined8 **)(unaff_RDI + 0x10) = puVar8;
      ...
      while( true ) {
        ...
        lVar12 = *(longlong *)(local_60 + 0x10);
        local_70 = *(longlong *)(lVar12 + 8 + lVar11 * 8);
        ...
        pVar10 = *(pthread_key_t *)(*(longlong *)(unaff_RDI + 0x10) + 0x18);
        dVar20 = local_98;
        local_88 = dVar19;
        if (((0x1e < pVar10 + 0xf) &&
            (pdVar1 = (double *)
                      ((longlong)(int)pVar10 + -8 +
...
LAB_0172e480:
        ...
        lVar11 = (longlong)*(int *)(lVar16 + 0x18);
        FUN_00c8e340(dVar20,1);
    ...
    do {
      ...
      pdVar1 = (double *)(*(longlong *)(lVar4 + 0x10) + -0x10 + lVar12);
      if (local_40 < *pdVar1 || local_40 == *pdVar1) {
        uVar9 = -(int)lVar11;
        goto LAB_0172defb;
      }
      lVar11 = lVar11 + -1;
      pdVar1 = (double *)(*(longlong *)(lVar4 + 0x10) + lVar12);
      lVar12 = lVar12 + 0x10;
...
LAB_0172defd:
    ...
    lVar12 = lVar11 << 4;
    do {
      if ((lVar11 <= iVar17) || (*(double *)(*(longlong *)(lVar4 + 0x10) + lVar12) <= local_40))
      break;
      lVar11 = lVar11 + -1;
      pdVar1 = (double *)(*(longlong *)(lVar4 + 0x10) + -0x10 + lVar12);
      lVar12 = lVar12 + -0x10;
    } while (local_40 <= *pdVar1);
    uVar14 = FUN_00e7b4e0(lVar12,(longlong)iVar17,uVar15);
