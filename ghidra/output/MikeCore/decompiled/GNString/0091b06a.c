...

{
  ...
  for (lVar16 = *(longlong *)(unaff_RDI + 0x18); lVar16 != *(longlong *)(unaff_RDI + 0x20);
      lVar16 = lVar16 + 1) {
  ...
  for (lVar16 = *(longlong *)(unaff_RDI + 0x30); lVar16 != *(longlong *)(unaff_RDI + 0x38);
      lVar16 = lVar16 + 1) {
    iVar1 = (**(code **)(*unaff_RSI + 0x80))();
    iVar4 = iVar4 + iVar1;
  }
  ...
  iVar5 = (**(code **)(*unaff_RSI + 0x98))();
  iVar6 = (**(code **)(*unaff_RSI + 0x38))();
  iVar7 = (**(code **)(*unaff_RSI + 0x30))(0xb,10);
