...
void FUN_017cb550(pthread_key_t param_1)

{
  ...
  plVar2 = plVar1;
  lVar3 = DAT_027feca0;
  if ((pvVar6 != (void *)0x0) && (lVar7 = FUN_00e8b990(), lVar3 = DAT_027feca0, lVar7 != 0)) {
