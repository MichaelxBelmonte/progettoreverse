...

{
  ...
  iVar11 = (**(code **)(*unaff_RSI + 0x30))(5,8);
  ...
  for (lVar28 = *(longlong *)(unaff_RDI + 0x170); lVar28 != *(longlong *)(unaff_RDI + 0x178);
      lVar28 = lVar28 + 8) {
  ...
  if (*(char *)(unaff_RDI + 0x396) != '\0') {
    iVar1 = (**(code **)(*unaff_RSI + 0x30))(0x1a,0xb);
  ...
  iVar5 = (**(code **)(*unaff_RSI + 0x78))();
  iVar6 = (**(code **)(*unaff_RSI + 0x38))();
  iVar7 = (**(code **)(*unaff_RSI + 0x30))(0x28,2);
  iVar8 = (**(code **)(*unaff_RSI + 0x78))();
  iVar9 = (**(code **)(*unaff_RSI + 0x38))();
  iVar10 = (**(code **)(*unaff_RSI + 0x30))(0x29,2);
  iVar11 = (**(code **)(*unaff_RSI + 0x78))();
  iVar12 = (**(code **)(*unaff_RSI + 0x38))();
  iVar13 = (**(code **)(*unaff_RSI + 0x30))(0x2a,2);
  ...
  if (*(char *)(unaff_RDI + 0x39c) != '\0') {
    iVar1 = (**(code **)(*unaff_RSI + 0x30))(0x2b,0xc);
    iVar2 = FUN_008e8a1e();
    iVar3 = (**(code **)(*unaff_RSI + 0x38))();
    iVar15 = iVar1 + iVar15 + iVar2 + iVar3;
  }
  if (*(char *)(unaff_RDI + 0x39d) != '\0') {
    iVar1 = (**(code **)(*unaff_RSI + 0x30))(0x2c,0xc);
    iVar2 = FUN_008e8a1e();
    iVar3 = (**(code **)(*unaff_RSI + 0x38))();
    iVar15 = iVar1 + iVar15 + iVar2 + iVar3;
  }
  if (*(char *)(unaff_RDI + 0x39e) != '\0') {
    iVar1 = (**(code **)(*unaff_RSI + 0x30))(0x2d,8);
    iVar2 = (**(code **)(*unaff_RSI + 0x90))();
    iVar3 = (**(code **)(*unaff_RSI + 0x38))();
    iVar15 = iVar1 + iVar15 + iVar2 + iVar3;
  }
  if (*(char *)(unaff_RDI + 0x39f) != '\0') {
    iVar1 = (**(code **)(*unaff_RSI + 0x30))(0x2e,8);
    iVar2 = (**(code **)(*unaff_RSI + 0x90))();
    iVar3 = (**(code **)(*unaff_RSI + 0x38))();
    iVar15 = iVar1 + iVar15 + iVar2 + iVar3;
  }
  if (*(char *)(unaff_RDI + 0x3a0) != '\0') {
    iVar1 = (**(code **)(*unaff_RSI + 0x30))(0x2f,8);
    iVar2 = (**(code **)(*unaff_RSI + 0x90))();
    iVar3 = (**(code **)(*unaff_RSI + 0x38))();
    iVar15 = iVar1 + iVar15 + iVar2 + iVar3;
  }
