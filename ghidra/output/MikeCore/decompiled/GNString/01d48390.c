...

{
  ...
  iVar1 = *(int *)(unaff_RDI[7] + 0xc);
  if (iVar1 < 2) goto LAB_01d485c2;
  lVar2 = unaff_RDI[8];
  lVar3 = *(longlong *)(*(longlong *)(unaff_RDI[7] + 0x10) + (ulonglong)(iVar1 - 2) * 8);
...
LAB_01d48537:
    (**(code **)(*unaff_RDI + 0x4a0))(*(undefined8 *)(lVar3 + 0x30),*(undefined8 *)(lVar3 + 0x38));
  }
