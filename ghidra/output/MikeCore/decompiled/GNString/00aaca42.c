...

{
  ...
  iVar38 = (**(code **)(*unaff_RSI + 0x30))(0x15,0xf);
  iVar39 = (**(code **)(*unaff_RSI + 0x58))();
  iVar39 = iVar2 + iVar1 + iVar3 + iVar4 + iVar5 + iVar6 + iVar7 + iVar8 + iVar9 + iVar10 + iVar11 +
           ...
           iVar32 + iVar33 + iVar34 + iVar35 + iVar36 + iVar37 + iVar38 + iVar39;
  for (plVar40 = *(longlong **)(unaff_RDI + 0xf8); plVar40 != *(longlong **)(unaff_RDI + 0x100);
      plVar40 = plVar40 + 4) {
    iVar1 = (**(code **)(*plVar40 + 0x18))();
    iVar39 = iVar39 + iVar1;
  }
  iVar1 = (**(code **)(*unaff_RSI + 0x60))();
  iVar2 = (**(code **)(*unaff_RSI + 0x38))();
  iVar3 = (**(code **)(*unaff_RSI + 0x30))(0x16,0xf);
  iVar4 = (**(code **)(*unaff_RSI + 0x58))();
  iVar4 = iVar1 + iVar39 + iVar2 + iVar3 + iVar4;
  for (plVar40 = *(longlong **)(unaff_RDI + 0x110); plVar40 != *(longlong **)(unaff_RDI + 0x118);
      plVar40 = plVar40 + 4) {
    iVar1 = (**(code **)(*plVar40 + 0x18))();
    iVar4 = iVar4 + iVar1;
  }
  ...
  for (plVar40 = *(longlong **)(unaff_RDI + 0x128); plVar40 != *(longlong **)(unaff_RDI + 0x130);
      plVar40 = plVar40 + 4) {
    iVar1 = (**(code **)(*plVar40 + 0x18))();
    iVar5 = iVar5 + iVar1;
  }
