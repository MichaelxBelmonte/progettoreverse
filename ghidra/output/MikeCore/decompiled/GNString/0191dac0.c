...
/* WARNING: Removing unreachable block (ram,0x0191e89e) */
/* WARNING: Removing unreachable block (ram,0x0191e877) */
/* WARNING: Removing unreachable block (ram,0x0191e884) */
/* WARNING: Removing unreachable block (ram,0x0191e0e5) */
/* WARNING: Removing unreachable block (ram,0x0191e0ee) */
/* WARNING: Removing unreachable block (ram,0x0191e14e) */
/* WARNING: Removing unreachable block (ram,0x0191e157) */
/* WARNING: Removing unreachable block (ram,0x0191e78c) */
/* WARNING: Removing unreachable block (ram,0x0191e795) */

void FUN_0191dac0(undefined8 param_1,undefined8 *param_2,ulonglong param_3)

{
  ...
  *puVar10 = &DAT_025683c0;
  ...
  if (*unaff_RSI != 0) {
    ...
    lVar19 = *unaff_RSI;
    if (lVar19 == local_40) {
      if (((char)unaff_RSI[1] != '\0') || (local_40 == 0)) goto LAB_0191dc12;
      if (local_38 == '\0') {
        FUN_00d50b00();
        goto LAB_0191dc0a;
      }
...
LAB_0191dfa4:
    ...
    *puVar11 = &DAT_025683c0;
    ...
    do {
      ...
      if ((~(uint)(*(ulonglong *)(*unaff_RSI + 0x18) >> ((byte)pvVar17 & 0x3f)) & 0xf) != 0) {
        iVar7 = FUN_01715480();
        iVar6 = *(int *)(puVar11 + 3);
        ...
        pvVar17 = (void *)(ulonglong)uVar13;
        *(uint *)(puVar11[2] + (longlong)iVar6) = uVar13;
      }
      lVar19 = lVar19 + 1;
      uVar25 = uVar25 + 4;
    } while (lVar19 != 0xc);
    ...
    if (3 < (int)uVar9) {
      ...
      do {
        ...
        pvVar17 = (void *)(ulonglong)((uVar8 / 0xc) * 0xc);
    ...
    _memcpy(pvVar17,(void *)(longlong)*(int *)(local_40 + 0x18),(size_t)param_3);
    if ((int)uVar13 < 4) {
      ...
      iVar7 = iVar7 - (*(int **)(local_40 + 0x10))[(longlong)(iVar18 >> 2) + -1];
      iVar14 = -iVar7;
      if (0 < iVar7) {
        iVar14 = iVar7;
      }
      param_3 = (ulonglong)(uint)(iVar14 + iVar6);
      lVar19 = *(longlong *)(local_40 + 0x10);
      iVar6 = 0;
      local_e8 = (ulonglong)uVar13;
      do {
        while( true ) {
          sVar22 = (size_t)param_3;
          uVar25 = (ulonglong)iVar6;
          ...
          *puVar12 = puVar24[uVar25];
          ...
          uVar9 = iVar7 - piVar23[(longlong)((int)uVar9 >> 2) + -1];
          uVar13 = -uVar9;
          if (0 < (int)uVar9) {
            uVar13 = uVar9;
          }
          ...
          if ((int)(iVar6 + uVar13) < (int)sVar22) {
            ...
            _memcpy(pvVar17,(void *)(longlong)*(int *)(local_40 + 0x18),sVar22);
            lVar19 = *(longlong *)(local_40 + 0x10);
            param_3 = (ulonglong)(iVar6 + uVar13);
          }
...
LAB_0191e4bc:
            uVar21 = lVar19 << 2 | 4;
            piVar23 = (int *)((longlong)puVar3 + uVar21);
            iVar6 = *piVar23;
            iVar7 = piVar23[1];
            iVar14 = piVar23[2];
            iVar18 = piVar23[3];
            ...
            piVar23 = (int *)((longlong)puVar3 + uVar21 + 0x10);
            iVar6 = *piVar23;
            iVar7 = piVar23[1];
            iVar14 = piVar23[2];
            iVar18 = piVar23[3];
...
LAB_0191e519:
    ...
    _memmove((void *)(ulonglong)((uVar13 / 0xc) * 0xc),(void *)(longlong)iVar18,sVar22);
  ...
  local_100 = 0;
  local_f8 = 0;
  pVar15 = (pthread_key_t)&local_110;
  local_120 = puVar10;
  FUN_0191ec80(DAT_0239011c,&local_120,&local_100);
  if (local_38 == '\0') {
