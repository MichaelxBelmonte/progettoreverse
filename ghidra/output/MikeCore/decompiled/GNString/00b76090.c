...

{
  ...
  uVar3 = *(uint *)(unaff_RDI + 0x54);
  uVar37 = 0x18;
  if (*(uint *)(unaff_RDI + 0x50) != 0x14) {
    uVar37 = *(uint *)(unaff_RDI + 0x50);
  }
  uVar2 = uVar37 - 1;
  ...
  uVar17 = _DAT_02411330;
  iVar16 = _UNK_023de31c;
  iVar15 = _UNK_023de318;
  iVar14 = _UNK_023de314;
  iVar13 = _DAT_023de310;
  iVar12 = _UNK_023d84fc;
  iVar11 = _UNK_023d84f8;
  iVar10 = _UNK_023d84f4;
  iVar9 = _DAT_023d84f0;
  auVar46 = _DAT_023d84e0;
  iVar8 = _UNK_023b2d5c;
  iVar7 = _UNK_023b2d58;
  iVar6 = _UNK_023b2d54;
  iVar5 = _DAT_023b2d50;
  if ((0 < (int)param_3) && (uVar3 != 0)) {
    fVar40 = DAT_02390124 / fVar40;
    uVar28 = (ulonglong)(param_1 * uVar3 * uVar37 >> 3);
    uVar34 = *(int *)(unaff_RDI + 0x80) * uVar37;
    ...
    uVar27 = 0;
    do {
      lVar1 = uVar27 + (longlong)param_2;
      if (uVar37 == 0) {
        uVar33 = 0;
        if (uVar3 != 1) {
          do {
            lVar4 = *(longlong *)(unaff_RSI + uVar33 * 8);
            if (lVar4 != 0) {
              *(float *)(lVar4 + lVar1 * 4) = fVar49;
            }
            lVar4 = *(longlong *)(unaff_RSI + 8 + uVar33 * 8);
            if (lVar4 != 0) {
              *(float *)(lVar4 + lVar1 * 4) = fVar49;
            }
            uVar33 = uVar33 + 2;
        ...
        if (((uVar3 & 1) != 0) && (lVar4 = *(longlong *)(unaff_RSI + uVar33 * 8), lVar4 != 0)) {
          *(float *)(lVar4 + lVar1 * 4) = fVar49;
        }
      }
      else if (uVar2 < 0x38) {
        ...
        do {
          ...
          if (uVar38 <= uVar34) {
            uVar31 = 0;
            lVar4 = *(longlong *)(*(longlong *)(unaff_RDI + 0x90) + 0x10);
            iVar24 = 0;
            if (7 < uVar2) {
              uVar31 = 0;
              iVar24 = 0;
              ...
              do {
                ...
                uVar31 = (uVar30 & *(byte *)(lVar4 + (ulonglong)((int)uVar28 + 1))) <<
                         ((byte)iVar24 + 8 & 0x1f) |
                         (uVar32 & *(byte *)(lVar4 + uVar28)) << ((byte)iVar24 & 0x1f) | uVar31;
                iVar24 = iVar24 + 0x10;
                uVar28 = (ulonglong)((int)uVar28 + 2);
                uVar29 = uVar29 - 0x10;
                iVar35 = iVar35 + 2;
              } while (iVar35 != 0);
            }
            ...
            uVar28 = (ulonglong)(uVar38 + uVar23);
            uVar29 = 0;
            if ((uVar31 & uVar21) != 0) {
              uVar29 = uVar22;
            }
...
LAB_00b7655a:
              ...
              uVar36 = (ulonglong)(uVar38 + uVar26);
              auVar61 = (undefined1  [16])0x0;
              auVar48 = ZEXT816(0);
              iVar24 = _DAT_023d84d0;
              ...
              do {
                ...
                auVar42 = pmovzxbd(auVar41,*(undefined4 *)(lVar4 + uVar28));
                ...
                auVar42 = pmovzxbd(auVar42,*(undefined4 *)(lVar4 + 4 + uVar28));
