...
ulonglong FUN_00edc2ac(ulonglong *param_1,ulonglong *param_2)

{
  ...
  uVar31 = (longlong)unaff_RSI - lVar5;
  ...
  uVar18 = *(undefined8 *)(unaff_RDI + 0x60);
  uVar7 = (uint)uVar18;
  cVar25 = (char)*(undefined4 *)(unaff_RDI + 0x34);
  if (*(int *)(unaff_RDI + 300) == 0) {
    uVar33 = *(uint *)(unaff_RDI + 0x2c);
    uVar13 = (ulonglong)uVar33;
    bVar11 = 0x18 - cVar25;
    lVar27 = lVar24;
    lVar28 = lVar9;
    bVar15 = bVar11;
    if (0x180 < uVar30 - uVar33) {
      if (uVar33 < 0xffffffa0) {
        uVar10 = uVar13 + 0x5f;
        while( true ) {
          uVar17 = (ulonglong)((uint)uVar13 & 7);
          uVar33 = *(uint *)(unaff_RDI + 0x40 + uVar17 * 4);
          *(uint *)(unaff_RDI + 0x40 + uVar17 * 4) =
               (*(int *)(lVar5 + 8 + uVar13) * -0x61c8864f ^ (uint)uVar18) >> (bVar11 & 0x1f);
          uVar17 = (ulonglong)(uVar33 >> 4 & 0xffffff0);
          bVar15 = *(char *)(lVar24 + uVar17) - 1U & 0xf;
          lVar27 = 0;
          if (bVar15 == 0) {
            lVar27 = 0xf;
          }
          lVar27 = (ulonglong)bVar15 + lVar27;
        ...
        bVar15 = 0x18 - (char)*(undefined4 *)(unaff_RDI + 0x34);
      }
      uVar13 = (ulonglong)(uVar30 - 0x20);
      uVar33 = 0;
      if (lVar5 + uVar13 <= (longlong)unaff_RSI + 1U) {
        uVar33 = ((int)((longlong)unaff_RSI + 1U) - (int)(lVar5 + uVar13)) + 1;
      }
      uVar21 = 8;
      if (uVar33 < 8) {
        uVar21 = uVar33;
    ...
    if ((uint)uVar13 < uVar30) {
      ...
      do {
        uVar10 = (ulonglong)((uint)uVar13 & 7);
        uVar33 = *(uint *)(unaff_RDI + 0x40 + uVar10 * 4);
        *(uint *)(unaff_RDI + 0x40 + uVar10 * 4) =
             (*(int *)(lVar14 + 8 + uVar13) * -0x61c8864f ^ *(uint *)(unaff_RDI + 0x60)) >>
             (bVar15 & 0x1f);
        uVar10 = (ulonglong)(uVar33 >> 4 & 0xffffff0);
        bVar23 = *(char *)(lVar27 + uVar10) - 1U & 0xf;
        lVar32 = 0;
        if (bVar23 == 0) {
          lVar32 = 0xf;
        }
        lVar32 = (ulonglong)bVar23 + lVar32;
    ...
    *(uint *)(unaff_RDI + 0x2c) = uVar30;
    uVar33 = *(uint *)(unaff_RDI + 0x40 + (ulonglong)(uVar30 & 7) * 4);
    *(uint *)(unaff_RDI + 0x40 + (ulonglong)(uVar30 & 7) * 4) =
         (*(int *)((uVar31 & 0xffffffff) + 8 + lVar5) * -0x61c8864f ^ uVar7) >> (bVar11 & 0x1f);
  }
  else {
    uVar33 = ((int)*unaff_RSI * -0x61c8864f ^ uVar7) >> (0x18U - cVar25 & 0x1f);
    *(uint *)(unaff_RDI + 0x2c) = uVar30;
  }
  *(int *)(unaff_RDI + 0x68) = *(int *)(unaff_RDI + 0x68) + uVar33;
  uVar31 = (ulonglong)(uVar33 >> 4 & 0xfffffff0);
  bVar15 = *(byte *)(lVar24 + uVar31);
  auVar34 = pshufb(ZEXT416(uVar33),(undefined1  [16])0x0);
  ...
  if (uVar20 != 0) {
    ...
    do {
      ...
      uVar10 = (ulonglong)((int)lVar14 + (uint)bVar15 & 0xf);
      if (uVar10 != 0) {
  ...
  lVar28 = 0;
LAB_00edc555:
  uVar13 = (ulonglong)(bVar15 - 1 & 0xf);
  if (uVar13 == 0) {
    lVar27 = 0xf;
  }
  lVar27 = lVar27 + uVar13;
  *(undefined1 *)(lVar24 + uVar31) = (char)lVar27;
  ((undefined1 *)(lVar24 + uVar31))[lVar27] = (char)uVar33;
  iVar29 = *(int *)(unaff_RDI + 0x2c);
  *(int *)(unaff_RDI + 0x2c) = iVar29 + 1;
  *(int *)(lVar9 + lVar27 * 4) = iVar29;
  if (lVar28 == 0) {
    ...
    do {
      ...
      if (uVar4 < uVar12) {
        if (*(int *)(lVar6 + uVar31) == (int)*unaff_RSI) {
          puVar26 = (ulonglong *)(lVar6 + uVar31 + 4);
          puVar16 = (ulonglong *)
                    (((longlong)(lVar6 + uVar8) - (longlong)puVar26) + (longlong)puVar2);
          if (param_2 <= puVar16) {
            puVar16 = param_2;
          }
          puVar22 = puVar2;
          puVar19 = puVar26;
          if (puVar2 < (ulonglong *)((longlong)puVar16 - 7U)) {
            uVar10 = *puVar2 ^ *puVar26;
            if (uVar10 == 0) {
              lVar27 = lVar6 + 0xc + uVar31;
              lVar14 = 0;
              do {
                puVar22 = (ulonglong *)((longlong)unaff_RSI + lVar14 + 0xc);
                if ((ulonglong *)((longlong)puVar16 - 7U) <= puVar22) {
                  puVar19 = (ulonglong *)(lVar27 + lVar14);
                  goto LAB_00edc7ae;
                }
                lVar32 = lVar14 + 8;
                uVar31 = *(ulonglong *)((longlong)unaff_RSI + lVar14 + 0xc) ^
...
LAB_00edc7ae:
            ...
            if (puVar22 < puVar16) {
              puVar22 = (ulonglong *)
                        ((longlong)puVar22 + (ulonglong)((char)*puVar19 == (char)*puVar22));
            }
            uVar31 = (longlong)puVar22 - (longlong)puVar2;
          }
          if ((char *)((longlong)puVar26 + uVar31) == (char *)(lVar6 + uVar8)) {
            puVar22 = (ulonglong *)((longlong)puVar2 + uVar31);
            puVar16 = puVar22;
            puVar26 = (ulonglong *)(lVar5 + uVar8);
            if (puVar22 < puVar1) {
              uVar10 = *puVar22 ^ *(ulonglong *)(lVar5 + uVar8);
              if (uVar10 == 0) {
                lVar27 = 0;
                do {
                  puVar16 = (ulonglong *)((longlong)unaff_RSI + lVar27 + uVar31 + 0xc);
                  if (puVar1 <= puVar16) {
                    puVar26 = (ulonglong *)(lVar27 + lVar9);
                    goto LAB_00edc895;
                  }
                  lVar14 = lVar27 + 8;
                  uVar10 = *(ulonglong *)((longlong)unaff_RSI + lVar27 + uVar31 + 0xc) ^
                           *(ulonglong *)(lVar9 + lVar27);
                  lVar27 = lVar14;
                } while (uVar10 == 0);
                uVar17 = 0;
                if (uVar10 != 0) {
...
LAB_00edc895:
              ...
              if (puVar16 < param_2) {
                puVar16 = (ulonglong *)
                          ((longlong)puVar16 + (ulonglong)((char)*puVar26 == (char)*puVar16));
              }
              uVar17 = (longlong)puVar16 - (longlong)puVar22;
            }
...
LAB_00edc8f6:
          if ((uVar13 < uVar31) &&
             (*param_1 = (ulonglong)((uVar30 + 3) - uVar4), uVar13 = uVar31,
             (ulonglong *)((longlong)unaff_RSI + uVar31) == param_2)) break;
        }
      }
      else {
        puVar16 = (ulonglong *)(lVar5 + uVar31);
        if (*(int *)((uVar13 - 3) + (longlong)puVar16) ==
            *(int *)((longlong)unaff_RSI + (uVar13 - 3))) {
          puVar26 = unaff_RSI;
          if (unaff_RSI < puVar1) {
            uVar10 = *unaff_RSI ^ *puVar16;
            if (uVar10 == 0) {
              lVar27 = lVar5 + 8 + uVar31;
              lVar14 = 0;
              do {
                puVar26 = (ulonglong *)((longlong)unaff_RSI + lVar14 + 8);
                if (puVar1 <= puVar26) {
                  puVar16 = (ulonglong *)(lVar27 + lVar14);
                  goto LAB_00edc6d7;
                }
                lVar32 = lVar14 + 8;
                uVar31 = *(ulonglong *)((longlong)unaff_RSI + lVar14 + 8) ^
                         *(ulonglong *)(lVar27 + lVar14);
                lVar14 = lVar32;
              } while (uVar31 == 0);
              uVar10 = 0;
...
LAB_00edc6d7:
            ...
            if ((puVar26 < (ulonglong *)((longlong)param_2 + -1)) &&
            ...
            if (puVar26 < param_2) {
              puVar26 = (ulonglong *)
                        ((longlong)puVar26 + (ulonglong)((char)*puVar16 == (char)*puVar26));
            }
            uVar31 = (longlong)puVar26 - (longlong)unaff_RSI;
          }
          goto LAB_00edc8f6;
        }
      }
