...

{
  ...
  if (cVar2 == '\0') {
    ...
    uVar8 = *(undefined8 *)(unaff_RDI + 0x50);
    if (DAT_02704060 != 0) {
      FUN_00d50b00();
    }
    local_68 = lVar6;
    ...
    if (local_38 != 0) {
      if (*(int *)(local_38 + 0xc) == 0) {
        ...
        do {
          ...
          do {
            lVar6 = local_38;
            if (*(uint *)(*(longlong *)(unaff_RDI + 0x40) + 0x1c) <= uVar7) goto LAB_00cd52b2;
            lVar6 = *(longlong *)(*(longlong *)(*(longlong *)(unaff_RDI + 0x40) + 0x20) + 0x10);
            iVar3 = 0;
            if ((*(int *)(lVar6 + -4 + lVar10) == iVar5) &&
               (*(longlong *)(lVar6 + -0x1c + lVar10) != 0)) {
              iVar3 = FUN_00e7de10();
              if (iVar3 == 0) {
                iVar3 = (int)uVar7 + 1;
              }
...
LAB_00cd525f:
      ...
      if (lVar1 != lVar10) {
        ...
        *(longlong *)(unaff_RDI + 0x58) = lVar10;
        if (lVar1 != 0) {
          FUN_00d50b20();
        }
        lVar10 = *(longlong *)(unaff_RDI + 0x50);
      }
      *(int *)(unaff_RDI + 0x48) = iVar3;
  ...
  do {
    ...
    if ((((*(int *)(lVar6 + -4 + lVar10) == 0) && (*(longlong *)(lVar6 + -0x1c + lVar10) != 0)) &&
