// Function: FUN_00ef19f2
// Address: 00ef19f2
// Size: 3293 bytes
// Class: GNString


ulonglong FUN_00ef19f2(ulonglong *param_1,ulonglong *param_2)

{
  ...
  uVar26 = *unaff_RSI * -0x30e4432340650000 >> (0x42U - *(char *)(puVar7 + 0x21) & 0x3f);
  ...
  if (*(int *)(unaff_RDI + 300) == 0) {
      ...
      if (uVar34 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(unaff_RDI + 0x40 + uVar14 * 4) =
               (int)((*(longlong *)(lVar16 + 8 + uVar18) * -0x30e4432340650000 ^ uVar15) >>
                    (bVar30 & 0x3f));
      ...
      if (uVar35 - 0x20 < uVar34) {
        ...
        do {
          *(int *)(unaff_RDI + 0x40 + (ulonglong)((uint)uVar15 & 7) * 4) =
               (int)((*(longlong *)(lVar16 + uVar15) * -0x30e4432340650000 ^ uVar32) >>
                    (bVar21 & 0x3f));
          uVar15 = uVar15 + 1;
        } while (uVar34 != uVar15);
      }
    ...
    if ((uint)uVar18 < uVar35) {
      ...
      do {
        ...
        *(int *)(unaff_RDI + 0x40 + uVar32 * 4) =
             (int)((*(longlong *)(lVar19 + 8 + uVar18) * -0x30e4432340650000 ^
    ...
    *(int *)(unaff_RDI + 0x40 + (ulonglong)(uVar35 & 7) * 4) =
         (int)((*(longlong *)((uVar37 & 0xffffffff) + 8 + lVar16) * -0x30e4432340650000 ^ uVar27) >>
              (bVar30 & 0x3f));
  }
  else {
    uVar34 = (uint)((*unaff_RSI * -0x30e4432340650000 ^ uVar27) >> (0x38U - cVar38 & 0x3f));
    *(uint *)(unaff_RDI + 0x2c) = uVar35;
  }
...
LAB_00ef21d3:
        ...
        if ((uVar37 < uVar15) &&
           ...
           (ulonglong *)((longlong)unaff_RSI + uVar15) == param_2)) goto LAB_00ef2500;
      }
      uVar32 = uVar32 + 1;
    } while (uVar32 != uVar27);
  }
