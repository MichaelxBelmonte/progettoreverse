...
undefined8 FUN_00338e90(undefined8 param_1,int param_2)
...
LAB_00339106:
      ...
      while( true ) {
        ...
        plVar1 = *(longlong **)(local_68[2] + 8 + lVar5 * 8);
        local_78 = plVar1;
        local_40 = plVar1;
        FUN_000f5df0();
    ...
    FUN_01caeb00();
    uVar10 = FUN_01e4ec80();
    local_118 = DAT_02702958;
    if (DAT_02702958 != (longlong *)0x0) {
      uVar10 = FUN_00d50b00();
    }
    local_110 = '\x01';
    pplVar7 = &local_78;
...
LAB_00338fc4:
  ...
  FUN_0009c8e0();
  uVar10 = (**(code **)(*unaff_RDI + 0x4a0))();
  plVar1 = local_78;
  if (local_70 == '\0') {
    if (local_78 == (longlong *)0x0) goto LAB_00339876;
    uVar10 = FUN_00d50b00();
    if ((local_70 != '\0') && (local_78 != (longlong *)0x0)) {
      uVar10 = FUN_00d50b20();
    }
  }
  else if (local_78 == (longlong *)0x0) goto LAB_00339876;
  local_70 = '\0';
  local_78 = (longlong *)0x0;
  local_68 = plVar1;
  local_60 = 0xffffffff;
