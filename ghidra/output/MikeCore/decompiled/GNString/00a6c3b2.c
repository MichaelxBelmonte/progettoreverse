...
int FUN_00a6c3b2(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)
  ...
  do {
    ...
    case 0xf:
      if (local_40[0] == 0xf) {
        ...
        for (lVar5 = *(longlong *)(unaff_RDI + 0x80); lVar5 != lVar6; lVar5 = lVar5 + -0x20) {
        ...
        *(longlong *)(unaff_RDI + 0x80) = lVar6;
        ...
        if (local_34 != 0) {
          ...
          uVar7 = 0;
          do {
            iVar2 = (**(code **)(*(longlong *)(*(longlong *)(unaff_RDI + 0x78) + lVar6) + 0x10))();
            iVar1 = iVar1 + iVar2;
            uVar7 = uVar7 + 1;
            lVar6 = lVar6 + 0x20;
    ...
    case 0x10:
      if (local_40[0] == 0xf) {
        ...
        uVar8 = extraout_XMM0_Da;
        for (lVar5 = *(longlong *)(unaff_RDI + 0x98); lVar5 != lVar6; lVar5 = lVar5 + -0x20) {
          uVar8 = (*(code *)**(undefined8 **)(lVar5 + -0x20))();
        }
        *(longlong *)(unaff_RDI + 0x98) = lVar6;
        iVar1 = (**(code **)(*unaff_RSI + 0xf8))(uVar8,&local_34);
        FUN_00a63e90();
        iVar1 = iVar1 + iVar2;
        if (local_34 != 0) {
          ...
          uVar7 = 0;
          do {
            iVar2 = (**(code **)(*(longlong *)(*(longlong *)(unaff_RDI + 0x90) + lVar6) + 0x10))();
            iVar1 = iVar1 + iVar2;
            uVar7 = uVar7 + 1;
            lVar6 = lVar6 + 0x20;
          } while (uVar7 < local_34);
