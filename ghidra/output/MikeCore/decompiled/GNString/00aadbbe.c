...
int FUN_00aadbbe(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  lVar9 = unaff_RDI + 0xb8;
  lVar10 = unaff_RDI + 0xa0;
  lVar11 = unaff_RDI + 0x98;
  lVar12 = unaff_RDI + 0x80;
  ...
  do {
    ...
    case 0x17:
      if (local_3c == 0xf) {
        ...
        for (lVar5 = *(longlong *)(unaff_RDI + 0xf8); lVar5 != lVar6; lVar5 = lVar5 + -0x20) {
          uVar8 = (*(code *)**(undefined8 **)(lVar5 + -0x20))();
        }
        *(longlong *)(unaff_RDI + 0xf8) = lVar6;
        ...
        if (local_34 != 0) {
          ...
          uVar7 = 0;
          do {
            iVar2 = (**(code **)(*(longlong *)(*(longlong *)(unaff_RDI + 0xf0) + lVar6) + 0x10))();
            iVar1 = iVar1 + iVar2;
            uVar7 = uVar7 + 1;
            lVar6 = lVar6 + 0x20;
