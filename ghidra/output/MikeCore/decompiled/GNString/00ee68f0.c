...
ulonglong FUN_00ee68f0(ulonglong *param_1,ulonglong *param_2)

{
  ...
  uVar26 = *unaff_RSI * -0x30e4432345000000 >> (0x38U - *(char *)((longlong)puVar7 + 0x34) & 0x3f);
  ...
  if (*(int *)(unaff_RDI + 300) == 0) {
      ...
      if (uVar9 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(unaff_RDI + 0x40 + uVar13 * 4) =
               (int)((*(longlong *)(lVar12 + 8 + uVar39) * -0x30e4432345000000 ^ uVar14) >>
                    (bVar15 & 0x3f));
      ...
      if (uVar34 - 0x20 < uVar9) {
        ...
        do {
          *(int *)(unaff_RDI + 0x40 + (ulonglong)((uint)uVar14 & 7) * 4) =
               (int)((*(longlong *)(lVar12 + uVar14) * -0x30e4432345000000 ^ uVar27) >>
                    (bVar24 & 0x3f));
          uVar14 = uVar14 + 1;
        } while (uVar9 != uVar14);
      }
    ...
    if ((uint)uVar39 < uVar34) {
      ...
      do {
        ...
        *(int *)(unaff_RDI + 0x40 + uVar27 * 4) =
             (int)((*(longlong *)(lVar8 + 8 + uVar39) * -0x30e4432345000000 ^
    ...
    *(int *)(unaff_RDI + 0x40 + (ulonglong)(uVar34 & 7) * 4) =
         (int)((*(longlong *)((uVar35 & 0xffffffff) + 8 + lVar12) * -0x30e4432345000000 ^ uVar11) >>
              (bVar15 & 0x3f));
  }
  else {
    uVar9 = (uint)((*unaff_RSI * -0x30e4432345000000 ^ uVar11) >> (0x38U - cVar19 & 0x3f));
    *(uint *)(unaff_RDI + 0x2c) = uVar34;
  }
