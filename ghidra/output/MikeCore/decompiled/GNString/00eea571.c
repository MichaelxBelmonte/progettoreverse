...
ulonglong FUN_00eea571(ulonglong *param_1,ulonglong *param_2)

{
  ...
  do {
    ...
    uVar23 = (ulonglong)(*(longlong *)(lVar17 + uVar25) * -0x30e4432345000000) >> (bVar19 & 0x3f);
...
LAB_00eeace1:
      ...
      if ((uVar25 < uVar35) &&
         ...
         (ulonglong *)((longlong)unaff_RSI + uVar35) == param_2)) goto LAB_00eea723;
    }
    if ((uVar11 <= uVar34) ||
