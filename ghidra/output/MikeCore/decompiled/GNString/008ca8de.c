...

{
  ...
  for (lVar9 = *(longlong *)(unaff_RDI + 0x10); lVar9 != *(longlong *)(unaff_RDI + 0x18);
      lVar9 = lVar9 + 1) {
  ...
  for (lVar9 = *(longlong *)(unaff_RDI + 0x30); lVar9 != *(longlong *)(unaff_RDI + 0x38);
      lVar9 = lVar9 + 1) {
    iVar1 = (**(code **)(*unaff_RSI + 0x80))();
    iVar8 = iVar8 + iVar1;
  }
  ...
  if (*(char *)(unaff_RDI + 0xa4) != '\0') {
    iVar1 = (**(code **)(*unaff_RSI + 0x30))(0xd,2);
    iVar2 = (**(code **)(*unaff_RSI + 0x78))();
    iVar3 = (**(code **)(*unaff_RSI + 0x38))();
    iVar5 = iVar1 + iVar5 + iVar2 + iVar3;
  }
  if (*(char *)(unaff_RDI + 0xa5) != '\0') {
    iVar1 = (**(code **)(*unaff_RSI + 0x30))(0xe,0xf);
    iVar2 = (**(code **)(*unaff_RSI + 0x58))();
    iVar2 = iVar1 + iVar5 + iVar2;
    for (lVar9 = *(longlong *)(unaff_RDI + 0x80); lVar9 != *(longlong *)(unaff_RDI + 0x88);
        lVar9 = lVar9 + 1) {
      iVar1 = (**(code **)(*unaff_RSI + 0x80))();
      iVar2 = iVar2 + iVar1;
    }
