...
/* WARNING: Removing unreachable block (ram,0x01b7c785) */
/* WARNING: Removing unreachable block (ram,0x01b7c78e) */

ulonglong FUN_01b7c6b0(pthread_key_t param_1,char param_2)
  ...
  if (cVar2 == '\0') {
    ...
    if ((cVar2 != '\0') && (uVar5 = (**(code **)(*unaff_RDI + 0x9d8))(), uVar5 >> 0x20 != 0)) {
      ...
      *pcVar9 = '\0';
      ...
      if ((char)uVar4 != '\0') {
        if (param_2 != '\0') {
          uVar7 = (**(code **)(*unaff_RDI + 0x9f0))(uVar7,local_60);
