...
undefined8 FUN_00fc2650(BIGNUM *param_1,undefined8 *param_2,BIGNUM *param_3,BIGNUM *param_4)

{
  ...
  if (((*(longlong *)(unaff_RDI + 8) == 0) || (*(longlong *)(unaff_RDI + 0x10) == 0)) ||
     (*(longlong *)(unaff_RDI + 0x18) == 0)) {
    iVar2 = 0x65;
    iVar3 = 0xc1;
LAB_00fc26e8:
    ...
    if (a != (BN_MONT_CTX *)0x0) {
      ...
      if ((lVar6 != 0) && (lVar6 = _bn_wexpand(), lVar6 != 0)) {
        if (param_3 == (BIGNUM *)0x0) {
          ...
          do {
            pBVar8 = param_3;
            pBVar10 = (BIGNUM *)(longlong)(int)param_4;
            m = local_38;
            iVar4 = _BN_generate_dsa_nonce(param_3,*(undefined8 *)(unaff_RDI + 0x28));
            if (iVar4 == 0) goto LAB_00fc2805;
            iVar4 = _BN_is_zero();
          } while (iVar4 != 0);
        }
        ...
        if ((((*(byte *)(unaff_RDI + 0x30) & 1) == 0) ||
            ...
            pBVar7 = _BN_MONT_CTX_set_locked
                               ((BN_MONT_CTX **)local_38,(int)*(undefined8 *)(unaff_RDI + 8),pBVar10
                                ,(BN_CTX *)m), pBVar7 != (BN_MONT_CTX *)0x0)) &&
           (pBVar7 = a, iVar4 = _BN_add(pBVar8,*(BIGNUM **)(unaff_RDI + 0x10),pBVar10), iVar4 != 0))
        {
          pBVar9 = *(BIGNUM **)(unaff_RDI + 0x10);
          iVar4 = _BN_add(pBVar8,pBVar9,pBVar10);
          if (iVar4 != 0) {
            _BN_is_bit_set(pBVar8,(int)pBVar9);
            _BN_consttime_swap(iVar3 + 2,(BIGNUM *)a,pBVar10,(int)m);
            pcVar1 = *(code **)(*(longlong *)(unaff_RDI + 0x50) + 0x28);
            m = *(BIGNUM **)(unaff_RDI + 0x38);
            if (pcVar1 == (code *)0x0) {
              iVar3 = _BN_mod_exp_mont(*(BIGNUM **)(unaff_RDI + 8),pBVar5,local_38,m,
                                       (BN_CTX *)CONCAT44(iVar2,in_stack_ffffffffffffffa8),pBVar7);
            }
            else {
              m = local_38;
              iVar3 = (*pcVar1)(pBVar5,*(undefined8 *)(unaff_RDI + 0x18));
            }
            if (iVar3 != 0) {
              pBVar10 = *(BIGNUM **)(unaff_RDI + 0x10);
              pBVar5 = local_38;
              iVar3 = _BN_div(pBVar10,param_1,local_38,m,
                              (BN_CTX *)CONCAT44(iVar2,in_stack_ffffffffffffffa8));
              w = (ulong)param_1;
              if (iVar3 != 0) {
                r = *(char **)(unaff_RDI + 0x10);
                pBVar8 = _BN_new();
