...
ulonglong FUN_00ed6c15(ulonglong *param_1,ulonglong *param_2)

{
  ...
  if (*(int *)(unaff_RDI + 300) == 0) {
      ...
      if (uVar14 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(unaff_RDI + 0x40 + uVar11 * 4) =
               (int)((*(longlong *)(lVar4 + 8 + uVar9) * -0x30e4432345000000 ^ uVar12) >>
                    (bVar3 & 0x3f));
      ...
      if (uVar22 - 0x20 < uVar14) {
        ...
        do {
          *(int *)(unaff_RDI + 0x40 + (ulonglong)((uint)uVar12 & 7) * 4) =
               (int)((*(longlong *)(lVar4 + uVar12) * -0x30e4432345000000 ^ uVar15) >>
                    (bVar13 & 0x3f));
          uVar12 = uVar12 + 1;
        } while (uVar14 != uVar12);
      }
    ...
    if ((uint)uVar9 < uVar22) {
      ...
      do {
        ...
        *(int *)(unaff_RDI + 0x40 + uVar15 * 4) =
             (int)((*(longlong *)(lVar1 + 8 + uVar9) * -0x30e4432345000000 ^
    ...
    *(int *)(unaff_RDI + 0x40 + (ulonglong)(uVar22 & 7) * 4) =
         (int)((*(longlong *)((uVar23 & 0xffffffff) + 8 + lVar4) * -0x30e4432345000000 ^ uVar8) >>
              (bVar3 & 0x3f));
  }
  else {
    uVar23 = *unaff_RSI;
