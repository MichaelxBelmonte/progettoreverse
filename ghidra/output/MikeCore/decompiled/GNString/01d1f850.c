...
ulonglong FUN_01d1f850(undefined8 param_1,undefined8 param_2)
...
joined_r0x01d1f8a9:
  ...
  local_78 = '\x01';
  DAT_027e7c20 = local_b8;
  if (local_b8 != 0) {
    local_78 = '\x01';
    FUN_00d50b00();
  }
  local_b0 = '\x01';
  cVar1 = (**(code **)(*unaff_RDI + 0x4d8))(param_2,&local_b8);
  ...
  if (cVar1 == '\0') {
    ...
    local_98 = lVar4;
    local_90 = '\x01';
    (**(code **)(*unaff_RDI + 0x4d0))(uVar8,&local_98);
