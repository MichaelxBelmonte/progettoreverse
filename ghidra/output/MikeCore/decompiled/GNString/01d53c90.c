...

{
  ...
  uVar14 = *(ulonglong *)(unaff_RDI + 0x30);
  local_5c = 0;
  uVar10 = 0;
  if (uVar14 != 0) {
    uVar10 = (ulonglong)*(uint *)(uVar14 + 0xc);
  }
  if (*(longlong *)(unaff_RDI + 0x20) != 0) {
    local_5c = *(uint *)(*(longlong *)(unaff_RDI + 0x20) + 0xc);
  }
  if (*(longlong *)(unaff_RDI + 0x28) == 0) {
    local_3c = 0;
  }
  else {
    local_3c = *(uint *)(*(longlong *)(unaff_RDI + 0x28) + 0xc);
  }
      ...
      if (DAT_0239424c < fVar25) {
        ...
        do {
          ...
          if ((fVar26 < fVar23) &&
            ...
            lVar4 = *(longlong *)(*(longlong *)(lVar11 + 0x50) + 8);
            lVar13 = (longlong)((int)fVar23 * iVar19 + iVar21);
            ...
            if (((lVar11 != 0) &&
                ((byte)local_34 ==
                 (char)(int)((double)(*(float *)(lVar11 + 0x18) * DAT_02394220) + DAT_023942d0))) &&
               ((byte)local_32 ==
                (char)(int)((double)(*(float *)(lVar11 + 0x14) * DAT_02394220) + DAT_023942d0))) {
              local_58 = 0;
              if ((byte)local_36 !=
                  (char)(int)((double)(*(float *)(lVar11 + 0x10) * DAT_02394220) + DAT_023942d0)) {
                local_58 = (ulonglong)bVar3;
              }
            }
          }
          ...
          if (-1 < iVar5) {
            ...
            if ((fVar26 < fVar23) &&
              ...
              lVar4 = *(longlong *)(*(longlong *)(lVar11 + 0x50) + 8);
              lVar13 = (longlong)((int)fVar23 * iVar5 + iVar21);
              *(char *)(lVar4 + lVar13 * 4) =
  ...
  if (0.0 < fVar22) {
    uVar6 = local_5c >> 0x10;
    uVar12 = local_5c >> 8;
    fVar23 = (float)(local_3c >> 0x10 & 0xff) / DAT_02394220;
    fVar27 = (float)(local_3c >> 8 & 0xff) / DAT_02394220;
    fVar30 = (float)(local_3c & 0xff) / DAT_02394220;
    uVar7 = local_5c & 0xff;
    local_64 = 0.0;
    iVar19 = 0;
        ...
        do {
          ...
          if (iVar19 == 0) {
            ...
            if ((local_40 < *(float *)(lVar11 + 0x1c) * *(float *)(lVar11 + 0x48)) &&
              ...
              if ((lVar11 == 0) ||
                 ((byte)local_34 !=
                  (char)(int)((double)(*(float *)(lVar11 + 0x18) * fVar26) + DAT_023942d0))) {
                local_3c = 0;
              }
              else {
                local_3c = 0;
                if ((byte)local_32 ==
                    (char)(int)((double)(*(float *)(lVar11 + 0x14) * fVar26) + DAT_023942d0))
                goto LAB_01d544cd;
              }
            }
          }
          else {
            iVar5 = FUN_00e7d780(*(undefined4 *)(*(longlong *)(unaff_RDI + 0x18) + 0x48));
            iVar5 = iVar19 - iVar5;
            if (-1 < iVar5) {
              ...
              if ((local_40 < fVar26) &&
                 ((float)iVar5 < *(float *)(lVar11 + 0x48) * *(float *)(lVar11 + 0x20))) {
                lVar4 = *(longlong *)(*(longlong *)(lVar11 + 0x50) + 8);
                lVar13 = (longlong)(int)(uVar20 + (int)fVar26 * iVar5 * 4);
                ...
                if ((((lVar11 != 0) &&
                     ((byte)local_34 ==
                      (char)(int)((double)(*(float *)(lVar11 + 0x18) * DAT_02394220) + DAT_023942d0)
                            ...
                            (char)(int)((double)(*(float *)(lVar11 + 0x14) * DAT_02394220) +
                                       DAT_023942d0))) &&
                   (local_3c = (uint)bVar2,
                   (byte)local_36 ==
                   (char)(int)((double)(*(float *)(lVar11 + 0x10) * DAT_02394220) + DAT_023942d0)))
            ...
            if ((local_40 < fVar26) &&
              ...
              lVar4 = *(longlong *)(*(longlong *)(lVar11 + 0x50) + 8);
              lVar13 = (longlong)((int)fVar26 * iVar19 + iVar21);
              bVar1 = *(byte *)(lVar4 + lVar13 * 4);
              local_36 = (ushort)bVar1;
              bVar18 = *(byte *)(lVar4 + 1 + lVar13 * 4);
              local_32 = (ushort)bVar18;
...
LAB_01d544cd:
                if ((byte)local_36 ==
                    (char)(int)((double)(*(float *)(lVar11 + 0x10) * fVar26) + DAT_023942d0)) {
                  local_58 = 0;
                }
              }
            }
          ...
          lVar11 = *(longlong *)(unaff_RDI + 0x18);
          iVar5 = FUN_00e7d780(*(undefined4 *)(lVar11 + 0x48));
          iVar5 = iVar5 + iVar19;
          if (-1 < iVar5) {
            fVar26 = *(float *)(lVar11 + 0x1c) * *(float *)(lVar11 + 0x48);
            if ((local_40 < fVar26) &&
               ((float)iVar5 < *(float *)(lVar11 + 0x48) * *(float *)(lVar11 + 0x20))) {
              lVar4 = *(longlong *)(*(longlong *)(lVar11 + 0x50) + 8);
              lVar13 = (longlong)((int)fVar26 * iVar5 + iVar21);
              bVar1 = *(byte *)(lVar4 + lVar13 * 4);
          ...
          fVar32 = (float)(byte)local_58 / DAT_02394220;
          fVar26 = DAT_02390124;
          if (*(longlong *)(unaff_RDI + 0x28) != 0) {
            fVar26 = (float)local_3c / DAT_02394220;
          }
          fVar33 = (DAT_02390124 - fVar32) * ((float)(local_5c & 0xff) / DAT_02394220);
          fVar28 = fVar32 + fVar33;
          fVar24 = 0.0;
          fVar31 = 0.0;
          if ((fVar28 != 0.0) || (fVar29 = DAT_02390124, NAN(fVar28))) {
            fVar29 = DAT_02390124 - fVar26;
            uVar17 = uVar12 & 0xff;
            uVar8 = uVar7;
            uVar9 = uVar6 & 0xff;
            if (*(longlong *)(unaff_RDI + 0x20) == 0) {
            ...
            fVar24 = (((float)(byte)local_38 / DAT_02394220) * fVar33 +
                     (fVar29 * fVar23 + ((float)uVar9 / DAT_02394220) * fVar26) * fVar32) / fVar28;
            fVar31 = (((float)(local_44 & 0xff) / DAT_02394220) * fVar33 +
                     (fVar27 * fVar29 + ((float)uVar17 / DAT_02394220) * fVar26) * fVar32) / fVar28;
            fVar29 = (((float)(local_48 & 0xff) / DAT_02394220) * fVar33 +
                     (fVar30 * fVar29 + ((float)uVar8 / DAT_02394220) * fVar26) * fVar32) / fVar28;
          }
          fVar28 = fVar28 * DAT_02394220;
          lVar11 = *(longlong *)(unaff_RDI + 0x18);
          iVar5 = FUN_00e7d780(*(undefined4 *)(lVar11 + 0x48));
          fVar26 = DAT_02394220;
          iVar5 = iVar5 + iVar19;
          if (-1 < iVar5) {
            ...
            if ((local_40 < fVar32) &&
               ((float)iVar5 < *(float *)(lVar11 + 0x48) * *(float *)(lVar11 + 0x20))) {
              fVar29 = fVar29 * DAT_02394220;
              fVar31 = fVar31 * DAT_02394220;
              lVar4 = *(longlong *)(*(longlong *)(lVar11 + 0x50) + 8);
              lVar13 = (longlong)((int)fVar32 * iVar5 + iVar21);
              uVar17 = (int)fVar28 & 0xff;
              *(char *)(lVar4 + lVar13 * 4) =
                   (char)((((int)(fVar24 * DAT_02394220) & 0xffU) * uVar17) / 0xff);
