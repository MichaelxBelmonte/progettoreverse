// Function: FUN_00ed458f
// Address: 00ed458f
// Size: 1840 bytes
// Class: GNString


ulonglong FUN_00ed458f(ulonglong *param_1,ulonglong *param_2)

{
  ...
  if (unaff_RSI < (longlong *)(lVar6 + uVar20)) {
    ...
    if (*(uint *)(unaff_RDI + 0x2c) < (uint)local_90) {
      do {
        uVar10 = (ulonglong)(*(longlong *)(lVar6 + uVar20) * -0x30e4432345000000) >> (bVar24 & 0x3f)
        ;
    ...
    *(uint *)(unaff_RDI + 0x2c) = (uint)local_90;
    uVar20 = (ulonglong)(*unaff_RSI * -0x30e4432345000000) >> (bVar24 & 0x3f);
...
LAB_00ed4af3:
        ...
        if (local_38 < uVar22) {
          ...
          if ((ulonglong *)((longlong)unaff_RSI + uVar22) == local_68) goto LAB_00ed4c95;
        }
