...
bool FUN_00ba1e20(ulonglong *param_1,uint *param_2,undefined8 param_3,uint param_4)

{
  ...
  local_48 = 8;
  (**(code **)(*(longlong *)*unaff_RDI + 0x380))(&local_48,&local_44);
  bVar6 = local_48 != 8;
  ...
  local_58 = 0;
  local_50 = 0;
  local_54 = CONCAT13((undefined1)local_40,local_44._1_3_);
  local_5c = local_44;
  iVar2 = FUN_00ccce90();
  ...
  if ((int)param_4 < 1) {
LAB_00ba1f99:
    (**(code **)(*(longlong *)*unaff_RDI + 0x390))();
    if ((local_d0 != '\0') && (local_d8 != 0)) {
      FUN_00d50b20();
    }
    if ((0 < (int)local_4c) && ((ulonglong)local_4c + local_68 <= unaff_RSI)) goto LAB_00ba205d;
LAB_00ba1fe1:
    local_48 = 1;
    (**(code **)(*(longlong *)*unaff_RDI + 0x380))(&local_48,local_3c);
    bVar6 = local_48 == 1;
    if ((local_70 != '\0') && (local_78 != 0)) {
      FUN_00d50b20();
    }
...
LAB_00ba205d:
  ...
  if ((int)uVar1 < 0) {
    ...
    *param_1 = (ulonglong)uVar1;
    (**(code **)(*(longlong *)*unaff_RDI + 0x390))((ulonglong)uVar1,&local_68);
