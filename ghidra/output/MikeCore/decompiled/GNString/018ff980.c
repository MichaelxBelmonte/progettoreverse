...
longlong * FUN_018ff980(int *param_1,ulonglong param_2)
...
LAB_018ffd5d:
  ...
  lVar7 = *(longlong *)
           (*(longlong *)(*(longlong *)(unaff_RSI + 0x38) + 0x10) + 8 + (longlong)iVar5 * 8);
  uVar4 = FUN_019079b0();
  if (((iVar5 == *(int *)(*(longlong *)(unaff_RSI + 0x38) + 0xc) + -2) && (uVar4 >> 0x20 != 0)) &&
