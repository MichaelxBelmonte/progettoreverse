...
ulonglong FUN_00ed859d(ulonglong *param_1,ulonglong *param_2)

{
  ...
  if (*(int *)(unaff_RDI + 300) == 0) {
      ...
      if (uVar16 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(unaff_RDI + 0x40 + uVar13 * 4) =
               (int)((*(longlong *)(lVar4 + 8 + local_158) * -0x30e4432340650000 ^ uVar14) >>
                    (bVar12 & 0x3f));
      ...
      if (uVar21 - 0x20 < uVar16) {
        ...
        do {
          *(int *)(unaff_RDI + 0x40 + (ulonglong)((uint)uVar14 & 7) * 4) =
               (int)((*(longlong *)(lVar4 + uVar14) * -0x30e4432340650000 ^ uVar10) >>
                    (bVar15 & 0x3f));
          uVar14 = uVar14 + 1;
        } while (uVar16 != uVar14);
      }
    ...
    if ((uint)local_158 < uVar21) {
      ...
      do {
        ...
        *(int *)(unaff_RDI + 0x40 + uVar10 * 4) =
             (int)((*(longlong *)(lVar1 + 8 + local_158) * -0x30e4432340650000 ^
    ...
    *(int *)(unaff_RDI + 0x40 + (ulonglong)(uVar21 & 7) * 4) =
         (int)((*(longlong *)((uVar22 & 0xffffffff) + 8 + lVar4) * -0x30e4432340650000 ^ uVar9) >>
              (bVar12 & 0x3f));
  }
  else {
    uVar22 = *unaff_RSI;
