...
//   "userServerAccountId"
//   "userTransferAllowed"
//   "LsActivationInfoWire"
//   "selfRelation"
//   "dirty"
//   "ilokAuth"


int FUN_00a63ef6(void)

{
  ...
  iVar20 = (**(code **)(*unaff_RSI + 0x30))(0xf,8);
  ...
  iVar50 = (**(code **)(*unaff_RSI + 0x30))(0x19,0xf);
  iVar51 = (**(code **)(*unaff_RSI + 0x58))();
  iVar51 = iVar2 + iVar1 + iVar3 + iVar4 + iVar5 + iVar6 + iVar7 + iVar8 + iVar9 + iVar10 + iVar11 +
  ...
  for (plVar52 = *(longlong **)(unaff_RDI + 0x138); plVar52 != *(longlong **)(unaff_RDI + 0x140);
      plVar52 = plVar52 + 4) {
    iVar1 = (**(code **)(*plVar52 + 0x18))();
    iVar51 = iVar51 + iVar1;
  }
  iVar1 = (**(code **)(*unaff_RSI + 0x60))();
  iVar2 = (**(code **)(*unaff_RSI + 0x38))();
  iVar3 = (**(code **)(*unaff_RSI + 0x30))(0x1a,0xf);
  iVar4 = (**(code **)(*unaff_RSI + 0x58))();
  iVar4 = iVar1 + iVar51 + iVar2 + iVar3 + iVar4;
  for (plVar52 = *(longlong **)(unaff_RDI + 0x150); plVar52 != *(longlong **)(unaff_RDI + 0x158);
      plVar52 = plVar52 + 4) {
    iVar1 = (**(code **)(*plVar52 + 0x18))();
    iVar4 = iVar4 + iVar1;
  }
