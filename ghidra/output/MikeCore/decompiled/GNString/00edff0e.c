// Function: FUN_00edff0e
// Address: 00edff0e
// Size: 2255 bytes
// Class: GNString


ulonglong FUN_00edff0e(ulonglong *param_1,ulonglong *param_2)

{
  ...
  if (*(int *)(unaff_RDI + 300) == 0) {
      ...
      if (uVar24 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(unaff_RDI + 0x40 + uVar14 * 4) =
               (int)((*(longlong *)(lVar4 + 8 + uVar9) * -0x30e4432340650000 ^ uVar21) >>
                    (bVar10 & 0x3f));
      ...
      if (uVar31 - 0x20 < uVar24) {
        ...
        do {
          *(int *)(unaff_RDI + 0x40 + (ulonglong)((uint)uVar29 & 7) * 4) =
               (int)((*(longlong *)(lVar4 + uVar29) * -0x30e4432340650000 ^ uVar21) >>
                    (bVar16 & 0x3f));
          uVar29 = uVar29 + 1;
        } while (uVar24 != uVar29);
      }
    ...
    if ((uint)uVar9 < uVar31) {
      ...
      do {
        ...
        *(int *)(unaff_RDI + 0x40 + uVar21 * 4) =
             (int)((*(longlong *)(lVar19 + 8 + uVar9) * -0x30e4432340650000 ^
    ...
    *(int *)(unaff_RDI + 0x40 + (ulonglong)(uVar31 & 7) * 4) =
         (int)((*(longlong *)((uVar32 & 0xffffffff) + 8 + lVar4) * -0x30e4432340650000 ^ uVar26) >>
              (bVar10 & 0x3f));
  }
  else {
    uVar32 = *unaff_RSI;
    *(uint *)(unaff_RDI + 0x2c) = uVar31;
    uVar9 = (uVar32 * -0x30e4432340650000 ^ uVar26) >> (0x38U - cVar27 & 0x3f) & 0xffffffff;
  }
  ...
  if (uVar24 != 0) {
    ...
    do {
      ...
      if (uVar26 != 0) {
        ...
        if (uVar24 < uVar22) goto LAB_00ee0232;
        *(uint *)(local_138[0] + lVar30 * 4) = uVar24;
        lVar30 = lVar30 + 1;
        iVar23 = iVar23 + -1;
      }
      uVar32 = uVar32 & uVar32 - 1;
      if ((uVar32 == 0) || (iVar23 == 0)) goto LAB_00ee0232;
    } while( true );
  }
  lVar30 = 0;
LAB_00ee0232:
