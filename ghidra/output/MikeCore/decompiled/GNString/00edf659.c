...
ulonglong FUN_00edf659(ulonglong *param_1,ulonglong *param_2)

{
  ...
  if (*(int *)(unaff_RDI + 300) == 0) {
      ...
      if (uVar18 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(unaff_RDI + 0x40 + uVar12 * 4) =
               (int)((*(longlong *)(lVar4 + 8 + uVar11) * -0x30e4432340650000 ^ uVar13) >>
                    (bVar14 & 0x3f));
      ...
      if (uVar32 - 0x20 < uVar18) {
        ...
        do {
          *(int *)(unaff_RDI + 0x40 + (ulonglong)((uint)uVar13 & 7) * 4) =
               (int)((*(longlong *)(lVar4 + uVar13) * -0x30e4432340650000 ^ uVar21) >>
                    (bVar22 & 0x3f));
          uVar13 = uVar13 + 1;
        } while (uVar18 != uVar13);
      }
    ...
    if ((uint)uVar11 < uVar32) {
      ...
      do {
        ...
        *(int *)(unaff_RDI + 0x40 + uVar21 * 4) =
             (int)((*(longlong *)(lVar16 + 8 + uVar11) * -0x30e4432340650000 ^
    ...
    *(int *)(unaff_RDI + 0x40 + (ulonglong)(uVar32 & 7) * 4) =
         (int)((*(longlong *)((uVar33 & 0xffffffff) + 8 + lVar4) * -0x30e4432340650000 ^ uVar15) >>
              (bVar14 & 0x3f));
  }
  else {
    uVar33 = *unaff_RSI;
