...
ulonglong FUN_00ee9272(ulonglong *param_1,ulonglong *param_2)

{
  ...
  uVar10 = *unaff_RSI * -0x30e4432340650000 >> (0x38U - *(char *)((longlong)puVar6 + 0x34) & 0x3f);
  ...
  if (*(int *)(unaff_RDI + 300) == 0) {
      ...
      if (uVar9 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(unaff_RDI + 0x40 + uVar13 * 4) =
               (int)((*(longlong *)(lVar11 + 8 + uVar39) * -0x30e4432340650000 ^ uVar14) >>
                    (bVar34 & 0x3f));
      ...
      if (uVar35 - 0x20 < uVar9) {
        ...
        do {
          *(int *)(unaff_RDI + 0x40 + (ulonglong)((uint)uVar14 & 7) * 4) =
               (int)((*(longlong *)(lVar11 + uVar14) * -0x30e4432340650000 ^ uVar24) >>
                    (bVar23 & 0x3f));
          uVar14 = uVar14 + 1;
        } while (uVar9 != uVar14);
      }
    ...
    if ((uint)uVar39 < uVar35) {
      ...
      do {
        ...
        *(int *)(unaff_RDI + 0x40 + uVar24 * 4) =
             (int)((*(longlong *)(lVar7 + 8 + uVar39) * -0x30e4432340650000 ^
    ...
    *(int *)(unaff_RDI + 0x40 + (ulonglong)(uVar35 & 7) * 4) =
         (int)((*(longlong *)((uVar36 & 0xffffffff) + 8 + lVar11) * -0x30e4432340650000 ^ uVar26) >>
              (bVar34 & 0x3f));
  }
  else {
    uVar9 = (uint)((*unaff_RSI * -0x30e4432340650000 ^ uVar26) >> (0x38U - cVar8 & 0x3f));
    *(uint *)(unaff_RDI + 0x2c) = uVar35;
  }
