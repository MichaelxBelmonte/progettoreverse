...
/* WARNING: Removing unreachable block (ram,0x00456202) */
/* WARNING: Removing unreachable block (ram,0x0045620b) */
...
LAB_0045609a:
    ...
    if (cVar1 != '\0') {
      ...
      uVar9 = FUN_00e7d6f0();
      *(undefined8 *)(unaff_RDI + 0x78) = uVar9;
      goto LAB_00456308;
    }
  }
  FUN_00453670();
...
LAB_00456210:
    if (*(int *)((longlong)local_60 + 0xc) < 1) {
      ...
      do {
        ...
        bVar5 = bVar5 | bVar2;
        iVar6 = iVar6 + 1;
      } while (iVar6 < *(int *)((longlong)local_60 + 0xc));
      bVar5 = bVar5 & 1;
    }
    FUN_0015ee90();
    FUN_00d50b20();
