...
/* WARNING: Removing unreachable block (ram,0x00456d78) */
/* WARNING: Removing unreachable block (ram,0x00456d81) */
...
LAB_00456c12:
    ...
    if (cVar1 != '\0') {
      ...
      uVar8 = FUN_00e7d6f0();
      *(undefined8 *)(unaff_RDI + 0x78) = uVar8;
      goto LAB_00456e88;
    }
  }
  FUN_00453670();
  if (local_68 == '\0') {
    if (local_70 == (longlong *)0x0) goto LAB_00456e88;
    FUN_00d50b00();
  }
  else if (local_70 == (longlong *)0x0) goto LAB_00456e88;
