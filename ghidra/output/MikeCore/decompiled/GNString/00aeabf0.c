...
/* WARNING: Removing unreachable block (ram,0x00aeae0c) */
/* WARNING: Removing unreachable block (ram,0x00aeae15) */
/* WARNING: Removing unreachable block (ram,0x00aeae7c) */
/* WARNING: Removing unreachable block (ram,0x00aeae85) */
...

{
  ...
  lVar15 = DAT_02764880;
  if ((*(longlong *)(unaff_RDI + 0xb0) == 0) || (*(longlong *)(unaff_RDI + 0xb8) == 0)) {
    if (DAT_02764880 != 0) {
      FUN_00d50b00();
    }
    FUN_00cc78b0();
  ...
  *puVar13 = 0;
  puVar13[1] = 0;
  puVar13[2] = 0;
  *(undefined8 **)(unaff_RDI + 0x38) = puVar13;
  pvVar14 = operator_new((ulong)param_1);
  uVar18 = FUN_00c66860();
  *(void **)(unaff_RDI + 0x30) = pvVar14;
  iVar11 = FUN_00c668e0(uVar18,*(undefined4 *)(*(longlong *)(unaff_RDI + 0xb0) + 0x18));
  if (iVar11 != 0) {
  ...
  uVar12 = *(int *)(unaff_RDI + 0x6c) - 1;
  if (uVar12 < 4) {
    *(undefined4 *)(unaff_RDI + 0x50) = *(undefined4 *)(&DAT_023d51a0 + (longlong)(int)uVar12 * 4);
  }
  else {
  ...
  iVar11 = *(int *)(unaff_RDI + 0x50);
  iVar17 = *(int *)(unaff_RDI + 0x68);
  iVar9 = *(int *)(unaff_RDI + 0x54);
  FUN_00c8e690();
  ...
  lVar15 = *(longlong *)(*(longlong *)(unaff_RDI + 0xb8) + 0x10);
  bVar1 = *(byte *)(lVar15 + 8);
  bVar2 = *(byte *)(lVar15 + 9);
  ...
  iVar11 = *(int *)(*(longlong *)(unaff_RDI + 0xb8) + 0x18);
  if (0x18 < iVar11) {
    uVar12 = 0x18;
    while( true ) {
      lVar10 = DAT_02764880;
  ...
  *(ulonglong *)(unaff_RDI + 0x40) =
       ((ulonglong)bVar6 << 8 |
        (((ulonglong)bVar4 << 8 |
         (ulonglong)((uint)bVar3 | (uint)bVar2 << 8 | (uint)bVar1 << 0x10) << 0x10) +
        (ulonglong)bVar5) * 0x10000 | (ulonglong)bVar7) << 8 | (ulonglong)bVar8;
  return;
}
