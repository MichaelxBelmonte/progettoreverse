...
float FUN_0173fdf0(float param_1,float param_2,float param_3,pthread_key_t param_4)

{
  ...
  uVar3 = (**(code **)(*unaff_RDI + 0x3a8))(param_1);
  ...
  if ((in_DL != '\0') && (unaff_SIL == '\0')) {
    (**(code **)(*unaff_RDI + 0x3a8))(param_1);
    local_68 = (float)(**(code **)(*unaff_RDI + 0x3a0))();
    if (local_res8 == (int *)0x0) {
      return local_68;
    }
    local_34 = (**(code **)(*unaff_RDI + 0x370))();
    goto LAB_01740191;
  }
  local_98 = param_2;
  local_34 = param_4;
  if (unaff_SIL != '\0') {
    ...
    if (iVar4 == -1000000) {
LAB_0173ffb6:
      if ((*in_R8 == 0) || (DAT_0239011c - param_3 <= (float)(_DAT_02390140 & (uint)param_2))) {
LAB_017400ee:
        (**(code **)(*unaff_RDI + 0x3b0))(param_1);
        local_34 = (**(code **)(*unaff_RDI + 0x370))();
      }
      else {
        ...
        iVar4 = *(int *)(*(longlong *)(*in_R8 + 0x10) + (ulonglong)uVar1 * 4);
        if ((iVar4 == -1000000) ||
           (pVar7 = param_4, iVar5 = (**(code **)(*unaff_RDI + 0x378))(), iVar5 == -1000000))
        goto LAB_017400ee;
      ...
      local_98 = param_2;
      if (local_70 != '\0') {
        fVar9 = (float)((uint)param_2 ^ _DAT_023945e0);
        local_98 = fVar9;
      }
    }
    else {
  ...
  if (in_DL == '\0') {
    ...
    local_68 = local_68 + (float)((uint)(fVar9 - local_68) & _DAT_02390140) * local_98;
  }
  if (local_res8 == (int *)0x0) {
    return local_68;
  }
