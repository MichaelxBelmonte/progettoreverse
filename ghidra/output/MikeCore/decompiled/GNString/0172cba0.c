...
/* WARNING: Removing unreachable block (ram,0x0172cbe4) */
/* WARNING: Removing unreachable block (ram,0x0172cbed) */

undefined4 FUN_0172cba0(undefined8 param_1)

{
  ...
  lVar5 = (longlong)&switchD_0172cc18::switchdataD_0172d140 +
          (longlong)(int)(&switchD_0172cc18::switchdataD_0172d140)[unaff_ESI - 10U];
  ...
  case 10:
    ...
    FUN_012e5ae0();
    FUN_00d23310();
    pVar4 = (pthread_key_t)CONCAT71((int7)((ulonglong)lVar5 >> 8),local_40[0]);
    pcVar6 = local_38;
    if (local_40[0] != '\0') {
      pcVar6 = local_40;
    }
