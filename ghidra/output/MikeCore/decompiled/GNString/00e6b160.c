...
void FUN_00e6b160(undefined4 param_1)
...
LAB_00e6b214:
  ...
  if (cVar4 != '\0') {
    ...
    plVar1 = DAT_02787938;
    local_70 = DAT_02787940;
    if ((plVar2 == (longlong *)0x0) && (DAT_02787938 != (longlong *)0x0)) {
      FUN_00d50b00();
      local_70 = DAT_02787940;
      plVar2 = plVar1;
    }
    DAT_02787940 = local_70;
    if (local_70 != 0) {
      FUN_00d50b00();
    }
    local_68 = '\x01';
    local_58 = '\0';
    local_60 = plVar2;
    uVar7 = FUN_00e97060(DAT_025908a0,&local_60);
    plVar1 = local_40;
    if (local_38 == '\0') {
