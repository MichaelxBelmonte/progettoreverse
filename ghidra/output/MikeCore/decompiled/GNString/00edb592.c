// Function: FUN_00edb592
// Address: 00edb592
// Size: 3354 bytes
// Class: GNString


ulonglong FUN_00edb592(ulonglong *param_1,ulonglong *param_2)

{
  ...
  if (unaff_RSI < (longlong *)(uVar20 + lVar5)) {
    ...
    if (*(uint *)(unaff_RDI + 0x2c) < uVar23) {
      do {
        uVar28 = (ulonglong)(*(longlong *)(lVar5 + uVar20) * -0x30e4432340650000) >> (bVar32 & 0x3f)
        ;
    ...
    *(uint *)(unaff_RDI + 0x2c) = uVar23;
    uVar20 = (ulonglong)(*unaff_RSI * -0x30e4432340650000) >> (bVar32 & 0x3f);
...
LAB_00edbef4:
        ...
        if (uVar20 < uVar42) {
          ...
          if ((ulonglong *)((longlong)unaff_RSI + uVar42) == param_2) goto LAB_00edc25d;
        }
