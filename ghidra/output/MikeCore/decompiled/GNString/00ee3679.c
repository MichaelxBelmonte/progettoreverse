...
ulonglong FUN_00ee3679(ulonglong *param_1,ulonglong *param_2)

{
  ...
  if (*(uint *)(unaff_RDI + 0x2c) < (uint)local_d8) {
    do {
      uVar12 = (ulonglong)(*(longlong *)(lVar5 + uVar26) * -0x30e4432340650000) >> (bVar33 & 0x3f);
  ...
  *(uint *)(unaff_RDI + 0x2c) = (uint)local_d8;
  lVar7 = *unaff_RSI;
  uVar26 = (ulonglong)(lVar7 * -0x30e4432340650000) >> (bVar33 & 0x3f);
...
LAB_00ee3d66:
  ...
  uVar10 = *(uint *)(puVar8[0xe] +
                    ((ulonglong)(lVar7 * -0x30e4432340650000) >> (-*(char *)(puVar8 + 0x21) & 0x3fU)
                    ) * 4);
  if (uVar40 < uVar10) {
