// Function: FUN_00ef0d22
// Address: 00ef0d22
// Size: 3280 bytes
// Class: GNString


ulonglong FUN_00ef0d22(ulonglong *param_1,ulonglong *param_2)

{
  ...
  uVar25 = *unaff_RSI * -0x30e4432340650000 >> (0x42U - *(char *)(puVar7 + 0x21) & 0x3f);
  ...
  if (*(int *)(unaff_RDI + 300) == 0) {
      ...
      if (uVar34 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(unaff_RDI + 0x40 + uVar15 * 4) =
               (int)((*(longlong *)(lVar17 + 8 + uVar41) * -0x30e4432340650000 ^ uVar16) >>
                    (bVar37 & 0x3f));
      ...
      if (uVar33 - 0x20 < uVar34) {
        ...
        do {
          *(int *)(unaff_RDI + 0x40 + (ulonglong)((uint)uVar16 & 7) * 4) =
               (int)((*(longlong *)(lVar17 + uVar16) * -0x30e4432340650000 ^ uVar31) >>
                    (bVar9 & 0x3f));
          uVar16 = uVar16 + 1;
        } while (uVar34 != uVar16);
      }
    ...
    if ((uint)uVar41 < uVar33) {
      ...
      do {
        ...
        *(int *)(unaff_RDI + 0x40 + uVar31 * 4) =
             (int)((*(longlong *)(lVar20 + 8 + uVar41) * -0x30e4432340650000 ^
    ...
    *(int *)(unaff_RDI + 0x40 + (ulonglong)(uVar33 & 7) * 4) =
         (int)((*(longlong *)((uVar35 & 0xffffffff) + 8 + lVar17) * -0x30e4432340650000 ^ uVar19) >>
              (bVar37 & 0x3f));
  }
  else {
    uVar34 = (uint)((*unaff_RSI * -0x30e4432340650000 ^ uVar19) >> (0x38U - cVar30 & 0x3f));
    *(uint *)(unaff_RDI + 0x2c) = uVar33;
  }
  ...
  if (uVar21 != 0) {
    ...
    do {
      ...
      if (uVar19 != 0) {
        ...
        if (uVar21 < uVar38) goto LAB_00ef10b2;
        *(uint *)(local_138[0] + lVar39 * 4) = uVar21;
        lVar39 = lVar39 + 1;
        iVar11 = iVar11 + -1;
      }
      uVar35 = uVar35 & uVar35 - 1;
      if ((uVar35 == 0) || (iVar11 == 0)) goto LAB_00ef10b2;
    } while( true );
  }
  lVar39 = 0;
LAB_00ef10b2:
...
LAB_00ef14e4:
        ...
        if ((uVar35 < uVar16) &&
           ...
           (ulonglong *)((longlong)unaff_RSI + uVar16) == param_2)) goto LAB_00ef1807;
      }
      uVar31 = uVar31 + 1;
    } while (uVar31 != uVar19);
  }
