// Function: FUN_00a3da34
// Address: 00a3da34
// Size: 983 bytes
// Class: GNString


undefined8 FUN_00a3da34(_Unwind_Exception *param_1,undefined8 param_2,size_t param_3)

{
  ...
  if (puVar4 == *(undefined8 **)(lVar3 + 0x18)) {
    ...
    param_3 = 0xffffffff;
    if (0x1fffffffffffffff < uVar1) goto LAB_00a3dde9;
    ...
    if (uVar9 == 0) {
      ...
      if (0x1fffffffffffffff < uVar9) goto LAB_00a3ddee;
      param_3 = 0xffffffff;
