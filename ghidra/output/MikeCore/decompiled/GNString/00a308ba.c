// Function: FUN_00a308ba
// Address: 00a308ba
// Size: 983 bytes
// Class: GNString


undefined8 FUN_00a308ba(_Unwind_Exception *param_1,undefined8 param_2,size_t param_3)

{
  ...
  if (puVar4 == *(undefined8 **)(lVar3 + 0x18)) {
    ...
    param_3 = 0xffffffff;
    if (0x1fffffffffffffff < uVar1) goto LAB_00a30c6f;
    ...
    if (uVar9 == 0) {
      ...
      if (0x1fffffffffffffff < uVar9) goto LAB_00a30c74;
      param_3 = 0xffffffff;
