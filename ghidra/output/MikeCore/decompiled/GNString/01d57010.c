...
/* WARNING: Removing unreachable block (ram,0x01d57127) */
/* WARNING: Removing unreachable block (ram,0x01d57133) */
/* WARNING: Removing unreachable block (ram,0x01d5728c) */
/* WARNING: Removing unreachable block (ram,0x01d57298) */
/* WARNING: Removing unreachable block (ram,0x01d57063) */
/* WARNING: Removing unreachable block (ram,0x01d5706f) */

void FUN_01d57010(undefined8 param_1,undefined8 param_2)

{
  ...
  if (unaff_RDI[0x39] != 0) {
    ...
    iVar1 = *(int *)((longlong)unaff_RDI + 0x1d4);
    if (iVar1 == 3) {
    ...
    auVar14._4_4_ = (float)((ulonglong)auVar8._0_8_ >> 0x20);
    auVar8._8_4_ = (undefined4)extraout_XMM0_Qb;
    ...
    if (iVar1 == 1) {
      ...
      bVar5 = (float)((ulonglong)param_2 >> 0x20) < auVar14._4_4_;
      if (!bVar5) {
      ...
      if (iVar1 == 0) {
        ...
        if (fVar11 <= auVar16._4_4_) {
          if (fVar11 < auVar16._4_4_) {
            ...
            auVar13._0_4_ = (fVar6 - auVar8._0_4_) * DAT_0239011c;
          ...
          auVar12._0_4_ = (auVar14._4_4_ - auVar16._0_4_) * DAT_0239011c;
    ...
    if (bVar5) {
      cVar4 = FUN_01d53b40();
      if ((cVar4 == '\0') || (lVar2 = unaff_RDI[0x3d], lVar2 == 0)) {
        lVar2 = unaff_RDI[0x39];
        if (lVar2 != 0) {
          FUN_00d50b00();
        }
