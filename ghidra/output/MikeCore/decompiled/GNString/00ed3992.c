...
ulonglong FUN_00ed3992(ulonglong *param_1,ulonglong *param_2)

{
  ...
  do {
    ...
    uVar20 = (ulonglong)(*(longlong *)(lVar4 + uVar9) * -0x30e4432345000000) >> (bVar12 & 0x3f);
  ...
  *(uint *)(unaff_RDI + 0x2c) = uVar17;
  uVar8 = *(uint *)(lVar6 + (*unaff_RSI * -0x30e4432345000000 >> (bVar12 & 0x3f)) * 4);
  if (uVar8 < uVar13) {
    return 3;
  }
  uVar9 = 3;
