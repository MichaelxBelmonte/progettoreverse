...
/* WARNING: Removing unreachable block (ram,0x016d643a) */
/* WARNING: Removing unreachable block (ram,0x016d6443) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_016d63b0(pthread_key_t param_1)

{
  ...
  if (*(longlong *)(unaff_RDI + 0x78) == 0) {
    ...
    if (3 < *(int *)(local_68 + 0xc)) {
      dVar20 = DAT_02390108 / dVar20;
      iVar12 = 1;
      do {
        lVar8 = *(longlong *)(uVar4 + 0x10);
        lVar2 = *(longlong *)(lVar8 + (longlong)iVar12 * 8);
        if (lVar2 != 0) {
          FUN_00d50b00();
          lVar8 = *(longlong *)(uVar4 + 0x10);
        }
        lVar3 = *(longlong *)(lVar8 + 8 + (longlong)iVar12 * 8);
        if (lVar3 != 0) {
          FUN_00d50b00();
        }
        ...
        if (local_68 == 0) {
          ...
          if (local_80 == 0) {
            ...
            if (7 < *(int *)(lVar8 + 0x18)) {
              ...
              lVar16 = 1;
              iVar18 = 0;
              iVar6 = *(int *)(*(longlong *)(lVar8 + 0x10) + 4);
              while( true ) {
                ...
                iVar18 = iVar18 + 8;
                lVar16 = lVar16 + 1;
                iVar6 = *(int *)(*(longlong *)(lVar8 + 0x10) + -4 + lVar16 * 8);
              }
            }
            pVar13 = (pthread_key_t)lVar8;
LAB_016d6666:
...
LAB_016d6753:
        ...
        if (!bVar19) {
          ...
          if (iVar12 < *(int *)(uVar4 + 0xc) + -2) {
            do {
              uVar10 = *(ulonglong *)(uVar4 + 0x10);
              lVar8 = *(longlong *)(uVar10 + (longlong)iVar6 * 8);
              if (lVar8 != 0) {
                FUN_00d50b00();
                uVar10 = *(ulonglong *)(uVar4 + 0x10);
              }
              lVar16 = *(longlong *)(uVar10 + 8 + (longlong)iVar6 * 8);
              if (lVar16 != 0) {
                FUN_00d50b00();
              }
              ...
              if (local_68 == 0) {
                ...
                uVar10 = *(ulonglong *)(unaff_RDI + 0x70);
                if (7 < *(int *)(uVar10 + 0x18)) {
                  uVar11 = local_80 >> 0x20;
                  lVar17 = 1;
                  iVar14 = 0;
                  iVar18 = *(int *)(*(longlong *)(uVar10 + 0x10) + 4);
                  do {
                    ...
                    iVar14 = iVar14 + 8;
                    lVar17 = lVar17 + 1;
                    iVar18 = *(int *)(*(longlong *)(uVar10 + 0x10) + -4 + lVar17 * 8);
                  } while( true );
                }
                pVar13 = (pthread_key_t)uVar10;
                pvVar7 = _pthread_getspecific(pVar13);
                if (pvVar7 != (void *)0x0) {
                  FUN_00e8b990();
                }
                ...
                dVar21 = (double)((ulonglong)
                                 ...
                                 _DAT_023908f0);
                uVar10 = (ulonglong)(dVar20 < dVar21);
                iVar18 = iVar6 + 1;
                if (dVar20 < dVar21) {
                  iVar18 = iVar6;
                }
