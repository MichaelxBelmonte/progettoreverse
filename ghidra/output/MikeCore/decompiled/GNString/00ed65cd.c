...
ulonglong FUN_00ed65cd(ulonglong *param_1,ulonglong *param_2)

{
  ...
  if (*(int *)(unaff_RDI + 300) == 0) {
      ...
      if (uVar7 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(unaff_RDI + 0x40 + uVar12 * 4) =
               (int)((*(longlong *)(lVar2 + 8 + uVar8) * -0x30e4432345000000 ^ uVar13) >>
                    (bVar10 & 0x3f));
      ...
      if (uVar22 - 0x20 < uVar7) {
        ...
        do {
          *(int *)(unaff_RDI + 0x40 + (ulonglong)((uint)uVar13 & 7) * 4) =
               (int)((*(longlong *)(lVar2 + uVar13) * -0x30e4432345000000 ^ uVar16) >>
                    (bVar14 & 0x3f));
          uVar13 = uVar13 + 1;
        } while (uVar7 != uVar13);
      }
    ...
    if ((uint)uVar8 < uVar22) {
      ...
      do {
        ...
        *(int *)(unaff_RDI + 0x40 + uVar16 * 4) =
             (int)((*(longlong *)(lVar4 + 8 + uVar8) * -0x30e4432345000000 ^
    ...
    *(int *)(unaff_RDI + 0x40 + (ulonglong)(uVar22 & 7) * 4) =
         (int)((*(longlong *)((uVar23 & 0xffffffff) + 8 + lVar2) * -0x30e4432345000000 ^ uVar17) >>
              (bVar10 & 0x3f));
  }
  else {
    uVar23 = *unaff_RSI;
