...

{
  ...
  if (0 < iVar3) {
    ...
    do {
      ...
      if ((uVar5 & 2) == 0) {
        uVar16 = *param_4;
        pXVar12 = (X509_NAME *)(ulonglong)uVar16;
        a = *(X509 **)(unaff_RDI + 0x20);
        if ((a->valid & 0x1000) == 0) {
          if ((uVar5 & 0x60) == 0) goto LAB_010b26fe;
        }
        else if ((uVar5 & 0x40) == 0) {
          if (*(longlong *)&pXVar8[5].modified == 0) {
LAB_010b26fe:
            ...
            uVar15 = (*(uint *)((longlong)&pXVar8[4].entries + 4) >> 1 & 0x100 | uVar5) ^ 0x100;
            b = (X509_NAME *)0x0;
            iVar4 = FUN_010b2e90();
            uVar5 = uVar15 + 0x40;
            if (iVar4 == 0) {
...
LAB_010b2937:
              ...
              if ((uVar15 & 0x10) == 0) {
                if (((ulonglong)pXVar1[1].akid & 0x10) == 0) {
                  uVar15 = uVar15 & 8;
                }
                else {
                  uVar15 = uVar15 & 4;
...
LAB_010b2ba3:
                            a = (X509 *)(ulonglong)(uVar15 & *(uint *)(puVar10 + 3));
                            goto LAB_010b2bfb;
                          }
                          if (*piVar11 == 1) {
                            if (*(longlong *)(piVar11 + 4) != 0) {
                              if (*piVar2 == 1) {
...
LAB_010b2b50:
                            ...
                            if (*(longlong *)(piVar2 + 4) != 0) goto LAB_010b2b50;
                          }
                          else {
                            iVar6 = _OPENSSL_sk_num();
                            if (0 < iVar6) {
                  ...
                  if (((pXVar8[4].bytes == (BUF_MEM *)0x0) || (*(longlong *)pXVar8[4].bytes == 0))
                     && (a = (X509 *)(ulonglong)uVar15, pXVar12 = pXVar8, (uVar5 & 0x20) != 0)) {
LAB_010b2bfb:
              ...
              if (((*(byte *)(*(longlong *)(unaff_RDI + 0x20) + 0x19) & 0x10) != 0) &&
...
LAB_010b2690:
    ...
    if (local_58 != (X509_NAME *)0x0) {
      ...
      *param_3 = uVar17;
      a_00 = (X509_CRL *)(ulonglong)uVar14;
      *param_4 = uVar14;
      _X509_CRL_up_ref();
      _X509_CRL_free(a_00);
      param_2->entries = (STACK *)0x0;
      if (((*(byte *)(*(longlong *)(unaff_RDI + 0x20) + 0x19) & 0x20) != 0) &&
         (uVar14 = *(uint *)((longlong)&local_58[4].entries + 4) |
                   *(uint *)(*(longlong *)(unaff_RDI + 0xb8) + 0xe0),
         pXVar8 = (X509_NAME *)(ulonglong)uVar14, (uVar14 & 0x1000) != 0)) {
        iVar3 = _OPENSSL_sk_num();
        if (0 < iVar3) {
          iVar3 = 0;
          do {
            ...
            if ((pSVar13[5].data != (char **)0x0) && (local_58[5].entries != (STACK *)0x0)) {
              ...
              if (iVar4 == 0) {
                pXVar12 = (X509_NAME *)((longlong)&segment_command_00000020.maxprot + 2);
                iVar4 = FUN_010b0570();
                if (iVar4 != 0) {
