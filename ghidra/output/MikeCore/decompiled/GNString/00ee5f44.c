// Function: FUN_00ee5f44
// Address: 00ee5f44
// Size: 2476 bytes
// Class: GNString


ulonglong FUN_00ee5f44(ulonglong *param_1,ulonglong *param_2)

{
  ...
  uVar34 = *unaff_RSI * -0x30e4432345000000 >> (0x38U - *(char *)((longlong)puVar5 + 0x34) & 0x3f);
  ...
  if (*(int *)(unaff_RDI + 300) == 0) {
      ...
      if (uVar8 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(unaff_RDI + 0x40 + uVar15 * 4) =
               (int)((*(longlong *)(lVar11 + 8 + uVar10) * -0x30e4432345000000 ^ uVar16) >>
                    (bVar22 & 0x3f));
      ...
      if (uVar36 - 0x20 < uVar8) {
        ...
        do {
          *(int *)(unaff_RDI + 0x40 + (ulonglong)((uint)uVar16 & 7) * 4) =
               (int)((*(longlong *)(lVar11 + uVar16) * -0x30e4432345000000 ^ uVar19) >>
                    (bVar17 & 0x3f));
          uVar16 = uVar16 + 1;
        } while (uVar8 != uVar16);
      }
    ...
    if ((uint)uVar10 < uVar36) {
      ...
      do {
        ...
        *(int *)(unaff_RDI + 0x40 + uVar19 * 4) =
             (int)((*(longlong *)(lVar6 + 8 + uVar10) * -0x30e4432345000000 ^
    ...
    *(int *)(unaff_RDI + 0x40 + (ulonglong)(uVar36 & 7) * 4) =
         (int)((*(longlong *)((uVar37 & 0xffffffff) + 8 + lVar11) * -0x30e4432345000000 ^ uVar9) >>
              (bVar22 & 0x3f));
  }
  else {
    uVar8 = (uint)((*unaff_RSI * -0x30e4432345000000 ^ uVar9) >> (0x38U - cVar28 & 0x3f));
    *(uint *)(unaff_RDI + 0x2c) = uVar36;
  }
  ...
  if (uVar7 != 0) {
    ...
    do {
      ...
      if (uVar10 != 0) {
        ...
        if (uVar18 < uVar13) goto LAB_00ee6274;
        auStack_138[lVar29] = uVar18;
        lVar29 = lVar29 + 1;
        iVar33 = iVar33 + -1;
      }
      uVar9 = uVar9 & uVar9 - 1;
      if ((uVar9 == 0) || (iVar33 == 0)) goto LAB_00ee6274;
    } while( true );
  }
  lVar29 = 0;
LAB_00ee6274:
  ...
  if ((uVar7 != 0) && (iVar33 != 0)) {
    ...
    do {
      ...
      if (uVar34 != 0) {
        ...
        if (uVar8 < uVar13) goto LAB_00ee64c1;
        auStack_138[lVar39] = uVar8;
        lVar39 = lVar39 + 1;
        iVar33 = iVar33 + -1;
      }
      uVar9 = uVar9 & uVar9 - 1;
      if ((uVar9 == 0) || (iVar33 == 0)) goto LAB_00ee64c1;
    } while( true );
  }
  goto LAB_00ee670f;
LAB_00ee64c1:
