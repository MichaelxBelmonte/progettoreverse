...
ulonglong FUN_00ee1b57(ulonglong *param_1,ulonglong *param_2)

{
  ...
  do {
    ...
    uVar20 = (ulonglong)(*(longlong *)(lVar12 + uVar24) * -0x30e4432340650000) >> (bVar15 & 0x3f);
...
LAB_00ee1fb6:
      ...
      if ((uVar13 < uVar20) &&
         ...
         (ulonglong *)((longlong)unaff_RSI + uVar20) == param_2)) goto LAB_00ee1caf;
    }
    uVar20 = uVar13;
    if ((uVar10 <= uVar9) ||
