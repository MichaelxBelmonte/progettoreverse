// Function: FUN_00a32062
// Address: 00a32062
// Size: 983 bytes
// Class: GNString


undefined8 FUN_00a32062(_Unwind_Exception *param_1,undefined8 param_2,size_t param_3)

{
  ...
  if (puVar4 == *(undefined8 **)(lVar3 + 0x18)) {
    ...
    param_3 = 0xffffffff;
    if (0x1fffffffffffffff < uVar1) goto LAB_00a32417;
    ...
    if (uVar9 == 0) {
      ...
      if (0x1fffffffffffffff < uVar9) goto LAB_00a3241c;
      param_3 = 0xffffffff;
