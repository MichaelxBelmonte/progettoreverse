...
void FUN_01c78b10(pthread_key_t param_1,longlong *param_2)

{
  ...
  if (*unaff_RDI != 0) {
    ...
    if (cVar1 != '\0') {
      pvVar2 = _pthread_getspecific((pthread_key_t)plVar6);
      if (pvVar2 != (void *)0x0) {
        FUN_00e8b990();
      }
      FUN_0150d890();
      ...
      FUN_01505930();
      FUN_00d23310();
      pVar5 = (pthread_key_t)CONCAT71((int7)((ulonglong)plVar6 >> 8),local_d0[0]);
      pcVar7 = local_38;
      if (local_d0[0] != '\0') {
        pcVar7 = local_d0;
      }
