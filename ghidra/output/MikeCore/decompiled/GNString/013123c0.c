...
/* WARNING: Removing unreachable block (ram,0x013124b0) */
/* WARNING: Removing unreachable block (ram,0x01312492) */

byte FUN_013123c0(longlong param_1,byte param_2)

{
  ...
  if (lVar7 != 0) {
    ...
    while( true ) {
      ...
      local_58 = *(longlong *)(*(longlong *)(lVar7 + 0x10) + 8 + lVar5 * 8);
      bVar2 = FUN_013123c0(*(longlong *)(lVar7 + 0x10),param_2);
      bVar8 = bVar8 | bVar2;
    }
    FUN_01312d90();
...
LAB_013125bd:
      ...
      if (lVar7 != 0) {
        ...
        *(undefined1 *)(unaff_RDI + 0x16a) = uVar9;
        FUN_00d50b20();
        FUN_00d50b20();
        return 0;
      }
