...
/* WARNING: Removing unreachable block (ram,0x015baf37) */
/* WARNING: Removing unreachable block (ram,0x015baf43) */
/* WARNING: Removing unreachable block (ram,0x015bb49a) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_015ba5e0(void *param_1,undefined8 param_2,size_t param_3)

{
  ...
  fVar29 = *(float *)(unaff_RDI + 0xa8);
  fVar42 = *(float *)(unaff_RDI + 0xa4);
  local_68._0_4_ = DAT_0239011c;
  local_38 = *(float *)(unaff_RDI + 0xa0) + DAT_0239011c;
  FUN_00c8e690();
  lVar25 = local_48;
  ...
  if (3 < (int)*(uint *)(lVar25 + 0x18)) {
    _memset_pattern16(param_1,(void *)((ulonglong)((*(uint *)(lVar25 + 0x18) >> 2) - 1) * 4 + 4),
                      param_3);
  }
  pVar14 = (pthread_key_t)param_1;
  fVar36 = local_38 + (float)local_68._0_4_;
  if ((fVar29 == DAT_02390d34) && (!NAN(fVar29) && !NAN(DAT_02390d34))) {
    if ((fVar36 == DAT_02394244) && (!NAN(fVar36) && !NAN(DAT_02394244))) goto LAB_015ba6e7;
  }
  local_38 = fVar36;
  if (*(int *)(unaff_RDI + 0x40) != 3) {
    ___bzero();
    auVar32 = ZEXT416(_DAT_023945e0 & (uint)fVar29) | _DAT_023945f0;
    auVar32._0_4_ = auVar32._0_4_ + fVar29;
    auVar32 = roundss(ZEXT816(0),auVar32,0xb);
    uVar27 = -(uint)((float)((uint)(auVar32._0_4_ - fVar29) & _DAT_02390140) < DAT_0239429c);
      ...
      do {
        ...
        if (-1 < (int)uVar27) {
          ...
          if ((int)uVar27 < (int)uVar24) {
            *(float *)(*(longlong *)(lVar25 + 0x10) + uVar18 * 4) =
                 (DAT_02390124 - (local_34 - (float)(int)uVar27)) +
                 *(float *)(*(longlong *)(lVar25 + 0x10) + uVar18 * 4);
          }
          if ((int)uVar27 < (int)(uVar24 - 1)) {
            *(float *)(*(longlong *)(lVar25 + 0x10) + 4 + uVar18 * 4) =
    ...
    if (local_38 <= fVar42) {
      do {
        ...
        if ((-1 < (int)uVar27) && ((int)uVar27 < (int)(uVar24 - 1))) {
          uVar18 = (ulonglong)uVar27;
          lVar12 = *(longlong *)(lVar25 + 0x10);
          fVar29 = *(float *)(lVar12 + uVar18 * 4);
          if (((float)((uint)(fVar29 + DAT_02390118) & _DAT_02390140) < DAT_02391094) &&
             ((fVar42 = *(float *)(lVar12 + 4 + uVar18 * 4),
              (float)((uint)(fVar42 + DAT_02390118) & _DAT_02390140) < DAT_02391094 &&
              (fVar42 = (float)((uint)(fVar42 - fVar29) & _DAT_02390140), fVar42 < DAT_02394288))))
          {
            local_4c = fVar29;
            _powf(fVar42 / DAT_02394288);
            uVar28 = _powf();
            *(undefined4 *)(lVar12 + uVar18 * 4) = uVar28;
            uVar28 = _powf();
            *(undefined4 *)(lVar12 + (uVar18 + 1) * 4) = uVar28;
          }
        }
        fVar29 = local_34 + (float)local_68._0_4_;
    ...
    if (0 < (int)uVar24) {
      ...
      if (DAT_02394274 <= fVar29) {
        lVar12 = *(longlong *)(lVar25 + 0x10);
        if (uVar24 < 4) {
          uVar17 = 0;
        }
        else {
          uVar17 = (ulonglong)(uVar24 & 0xfffffffc);
          ...
          if (uVar17 - 4 == 0) {
            ...
            lVar16 = 0;
            do {
              auVar32 = divps(*(undefined1 (*) [16])(lVar12 + lVar16 * 4),auVar43);
              *(undefined1 (*) [16])(lVar12 + lVar16 * 4) = auVar32;
              auVar32 = divps(*(undefined1 (*) [16])(lVar12 + 0x10 + lVar16 * 4),auVar43);
              *(undefined1 (*) [16])(lVar12 + 0x10 + lVar16 * 4) = auVar32;
              lVar16 = lVar16 + 8;
              lVar21 = lVar21 + 2;
            } while (lVar21 != 0);
          }
...
LAB_015bb337:
    ...
    if (uVar24 < 8) {
      ...
      uVar18 = (ulonglong)(uVar24 & 0xfffffff8);
      uVar17 = (uVar18 - 8 >> 3) + 1;
      if (uVar18 - 8 == 0) {
        lVar16 = 0;
LAB_015bb429:
        ...
        auVar38 = maxps(_DAT_02416630,auVar35);
        auVar32 = maxps(_DAT_02416630,auVar39);
        *(undefined1 (*) [16])(lVar12 + lVar16 * 4) = auVar38;
        *(undefined1 (*) [16])(lVar12 + 0x10 + lVar16 * 4) = auVar32;
      }
      else {
        ...
        do {
          ...
          *(undefined1 (*) [16])(lVar12 + lVar16 * 4) = auVar43;
          *(undefined1 (*) [16])(lVar12 + 0x10 + lVar16 * 4) = auVar38;
          ...
          *(undefined1 (*) [16])(lVar12 + 0x20 + lVar16 * 4) = auVar38;
          *(undefined1 (*) [16])(lVar12 + 0x30 + lVar16 * 4) = auVar43;
          lVar16 = lVar16 + 0x10;
          lVar21 = lVar21 + 2;
        } while (lVar21 != 0);
  ...
  if (bVar26) {
    ...
    if (local_48 == 0) {
      ...
      uVar23 = (undefined7)((ulonglong)unaff_R12 >> 8);
      if (local_40 == '\0') {
        uVar31 = FUN_00d50b00();
...
LAB_015baec0:
    ...
    if (local_48 == 0) {
      ...
      fVar36 = (float)CONCAT71((int7)((ulonglong)uVar22 >> 8),1);
  ...
  if (1 < *(int *)(unaff_RDI + 0x44)) {
    ...
    uVar18 = (ulonglong)(uint)(iVar13 * 0xc);
    iVar9 = iVar9 + iVar13 * -0xc;
    fVar29 = ((fVar29 + DAT_023b1608) / DAT_023908ec) * DAT_0241f360;
    local_38 = DAT_02390124 - (float)(_DAT_02390140 & (uint)fVar42);
    ...
    uVar24 = 0xfc;
    do {
      pvVar11 = _pthread_getspecific((pthread_key_t)uVar18);
      if ((pvVar11 == (void *)0x0) || (lVar12 = FUN_00e8b990(), lVar12 == 0)) {
        plVar20 = (longlong *)local_68._0_8_;
      }
      else {
        uVar18 = local_68._0_8_;
        plVar20 = *(longlong **)
                   (local_68._0_8_ + 0x20 + (ulonglong)(*(uint *)(lVar12 + 0x154) & 1) * 8);
      }
      pVar14 = (pthread_key_t)uVar18;
      iVar10 = (**(code **)(*plVar20 + 0x378))();
      if (iVar10 == -1000000) {
        local_34 = DAT_02390124;
        fVar36 = local_38;
        if (DAT_0239424c < fVar42) {
LAB_015bb249:
          local_34 = fVar36;
        }
      }
...
LAB_015bb24e:
      ...
      uVar18 = (ulonglong)(uint)(iVar10 * 2);
      fVar30 = DAT_02390d28 - (float)(iVar10 * 2);
      fVar36 = fVar30 + DAT_02390124;
      if (iVar15 < 1) {
        fVar36 = fVar30;
      }
      fVar36 = fVar36 - fVar29;
      if ((0.0 <= fVar36) && (fVar36 < DAT_02390124)) {
        fVar36 = fVar36 * local_34;
      }
      auVar33._0_8_ = _expf(uVar18,fVar36);
      auVar33._8_8_ = extraout_XMM0_Qb;
      auVar34._4_12_ = auVar33._4_12_;
      auVar34._0_4_ = ((float)auVar33._0_8_ + DAT_02390d00) / _DAT_02411060;
      fVar30 = (float)_powf(auVar34._0_8_);
      fVar36 = DAT_0240d16c;
      if (DAT_0240d16c <= fVar30) {
        fVar36 = fVar30;
      }
      *(float *)(*(longlong *)(local_70 + 0x10) + lVar25 * 4) = fVar36;
      lVar25 = lVar25 + 1;
      iVar13 = iVar13 + 7;
      uVar24 = uVar24 + 7;
      iVar9 = iVar9 + 7;
    } while (lVar25 < *(int *)(unaff_RDI + 0x44));
  }
  lVar25 = local_70;
...
LAB_015ba6e7:
  **(undefined4 **)(lVar25 + 0x10) = 0x3f800000;
  if (*(longlong *)(unaff_RDI + 0x80) != lVar25) {
    FUN_00d64850();
    lVar12 = *(longlong *)(unaff_RDI + 0x80);
    if (lVar12 != lVar25) {
      FUN_00d50b00();
      *(longlong *)(unaff_RDI + 0x80) = lVar25;
      if (lVar12 != 0) {
        FUN_00d50b20();
      }
    }
