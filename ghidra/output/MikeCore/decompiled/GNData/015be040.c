...
/* WARNING: Removing unreachable block (ram,0x015be233) */
/* WARNING: Removing unreachable block (ram,0x015be23c) */

void FUN_015be040(pthread_key_t param_1)

{
  ...
  if (local_30 != 0) {
    if ((*(int *)(unaff_RDI + 0x40) == 3) || (*(int *)(unaff_RDI + 0x40) == 0)) {
      pvVar5 = _pthread_getspecific(param_1);
      if (pvVar5 != (void *)0x0) {
        FUN_00e8b990();
      }
      ...
      fVar13 = (float)_exp2f(fVar13 * DAT_023941f4);
      if ((local_28 != '\0') && (local_30 != 0)) {
        FUN_00d50b20();
      }
    }
