...

{
  ...
  local_38 = *(float *)(*(longlong *)(*(longlong *)(unaff_RDI + 0x58) + 0x10) + lVar3 * 4);
  fVar4 = (float)FUN_015bcfa0(local_38,&local_38);
  fVar6 = *(float *)(*(longlong *)(*(longlong *)(unaff_RDI + 0x58) + 0x10) + lVar3 * 4);
  param_1 = param_1 / fVar6;
  fVar7 = (float)(-(uint)(param_1 < DAT_02394274) & (uint)DAT_02390d34 |
                 ~-(uint)(param_1 < DAT_02394274) & (uint)param_1);
  if (fVar7 < DAT_02390124) {
    fVar7 = DAT_02390124 / fVar7;
  }
  fVar5 = DAT_02390d34;
  if (fVar7 <= DAT_02390d34) {
    fVar5 = fVar7;
  }
  fVar5 = DAT_02390d34 - fVar5;
  fVar6 = local_38 / fVar6;
  if (0.0 < fVar4) {
    if (DAT_02390124 < fVar4) {
      fVar6 = DAT_02390124 / fVar6;
      fVar4 = DAT_02390d34 - fVar4;
    }
    else {
      fVar5 = 0.0;
    }
  ...
  if (*(int *)(unaff_RDI + 0x40) == 3) {
    ...
    fVar7 = (float)_exp2f((float)(unaff_ESI + 0x23) * DAT_023908e0 * DAT_023941f4);
    local_34 = (fVar7 * DAT_023941f8) / local_34;
  }
  else {
  ...
  if (0.0 < fVar4) {
    fVar7 = (float)_powf();
    fVar7 = (DAT_02390124 / fVar7) /
            *(float *)(*(longlong *)(*(longlong *)(unaff_RDI + 0x58) + 0x10) + lVar3 * 4);
...
LAB_015b9287:
    ...
    if (param_1 <= DAT_0240e34c) goto LAB_015b9197;
  }
  else {
...
LAB_015b9186:
  ...
  param_1 = DAT_0240e34c;
LAB_015b9197:
  if (param_2 != '\0') {
    param_1 = param_1 * *(float *)(*(longlong *)(*(longlong *)(unaff_RDI + 0x80) + 0x10) + lVar3 * 4
                                  );
  }
  return param_1;
}
