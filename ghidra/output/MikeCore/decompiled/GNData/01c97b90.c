...
ulonglong FUN_01c97b90(undefined8 param_1,longlong *param_2)

{
  ...
  if (iVar8 == 1) {
    ...
    *(undefined1 *)plVar14 = 0;
    ...
    local_a8 = *(longlong *)(unaff_RDI + 0x38);
    if (local_a8 != 0) {
      FUN_00d50b00();
    }
    local_1b8 = 1;
        ...
        *puVar10 = &DAT_02572358;
        ...
        if (*unaff_RSI != 0) {
          ...
          while( true ) {
            ...
            local_70 = *(longlong *)(*(longlong *)(local_60 + 0x10) + 8 + lVar11 * 8);
            pvVar9 = _pthread_getspecific((pthread_key_t)*(longlong *)(local_60 + 0x10));
            if (pvVar9 != (void *)0x0) {
              FUN_00e8b990();
            }
            FUN_01274b60();
          ...
          FUN_001159b0();
          puVar16 = (undefined8 *)*unaff_RSI;
        }
        lVar11 = unaff_RSI[1];
        if (puVar16 == puVar10) {
          if (((char)lVar11 == '\0') && (puVar10 != (undefined8 *)0x0)) {
            FUN_00d50b00();
            goto LAB_01c98283;
          }
        }
          ...
          *unaff_RSI = (longlong)puVar10;
          if (((char)lVar11 != '\0') && (puVar16 != (undefined8 *)0x0)) {
            FUN_00d50b20();
          }
LAB_01c98283:
...
LAB_01c982fd:
      ...
      *(undefined1 *)plVar12 = 0;
      ...
      if (lVar13 != 0) {
        ...
        local_70 = lVar3;
        local_68._0_1_ = '\0';
        FUN_00d214d0(uVar20,*(undefined4 *)(lVar13 + 0xc));
        if (((char)local_68 != '\0') && (local_70 != 0)) {
          FUN_00d50b20();
        }
        if (lVar3 != 0) {
    ...
    uVar17 = CONCAT71((int7)((ulonglong)local_a8 >> 8),1);
    FUN_00d50b20();
  }
  else {
LAB_01c98b09:
