...
/* WARNING: Removing unreachable block (ram,0x015c3c32) */
/* WARNING: Removing unreachable block (ram,0x015c3c47) */
/* WARNING: Type propagation algorithm not settling */

void FUN_015c35f0(longlong param_1,longlong param_2,longlong param_3,uint param_4)
  ...
  if (0 < (int)param_4) {
    ...
    do {
      ...
      if (iVar50 < (int)uVar42) {
        lVar45 = (longlong)(int)uVar32;
        lVar35 = local_res8 + 0x30 + (longlong)(iVar31 + local_44) * 4;
        lVar38 = (longlong)(int)uVar37;
        lVar33 = (longlong)(iVar36 + (iVar40 - iVar46));
        uVar44 = local_res8 + lVar33 * 4;
        fVar54 = *(float *)(unaff_RSI + uVar47 * 4);
        fVar53 = *(float *)(unaff_RDI + uVar47 * 4) * fVar54;
        uVar51 = (ulonglong)iVar50;
        lVar28 = (longlong)(iVar27 >> 0x1f & -iVar27);
        ...
        if ((uVar43 < 8) ||
           ((param_3 + uVar51 * 4 < local_res8 + ((lVar38 + lVar33) - uVar51) * 4 &&
            (uVar44 < (ulonglong)(param_3 + lVar38 * 4))))) {
joined_r0x015c383a:
          uVar52 = uVar26;
...
LAB_015c3915:
        ...
        if ((7 < uVar43) &&
           ((local_res8 + ((lVar33 + lVar38) - uVar51) * 4 <= param_1 + uVar51 * 4 ||
            ((ulonglong)(param_1 + lVar38 * 4) <= uVar44)))) {
...
LAB_015c36e0:
    ...
    do {
      while (fVar53 = *(float *)(param_3 + uVar47 * 4), fVar53 < fVar54) {
        *(undefined4 *)(param_2 + uVar47 * 4) = *(undefined4 *)(unaff_RDI + uVar47 * 4);
        uVar47 = uVar47 + 1;
...
LAB_015c3cac:
  ...
  if ((int)param_4 < 1) {
    ...
    if (uVar30 - 1 < 3) {
      ...
      fVar53 = 0.0;
      do {
        fVar7 = *(float *)(unaff_RSI + uVar47 * 4);
        fVar4 = *(float *)(unaff_RSI + 4 + uVar47 * 4);
        fVar5 = *(float *)(unaff_RSI + 8 + uVar47 * 4);
        fVar6 = *(float *)(unaff_RSI + 0xc + uVar47 * 4);
    ...
    if ((ulonglong)(param_4 & 3) != 0) {
      uVar44 = 0;
      do {
        fVar7 = *(float *)(unaff_RSI + uVar47 * 4 + uVar44 * 4);
        fVar53 = fVar53 + fVar7;
        fVar54 = fVar54 + fVar7 * *(float *)(param_2 + uVar47 * 4 + uVar44 * 4);
        uVar44 = uVar44 + 1;
      } while ((param_4 & 3) != uVar44);
    }
    if (DAT_02394274 < fVar53) goto LAB_015c3e16;
    if (uVar30 - 1 < 7) {
      fVar54 = 0.0;
      uVar30 = 0;
    }
