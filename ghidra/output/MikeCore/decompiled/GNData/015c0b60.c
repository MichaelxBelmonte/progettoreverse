...

{
  ...
  uVar8 = (ulonglong)in_EDX;
  fVar20 = (float)_logf();
  uVar10 = (int)(DAT_02411070 / (double)fVar20);
  if ((int)(DAT_02411070 / (double)fVar20) < 1) {
    uVar10 = 1;
  }
  ...
  uVar10 = (uint)uVar7;
  iVar15 = uVar10 * 2 + 1;
  if (*(int *)(unaff_RDI + 0x24) < iVar15) {
    if (*(longlong *)(unaff_RDI + 0x18) != 0) {
      FUN_00e83070();
      *(undefined8 *)(unaff_RDI + 0x18) = 0;
    }
    pfVar3 = (float *)FUN_00e83010();
    *(float **)(unaff_RDI + 0x18) = pfVar3;
    *(int *)(unaff_RDI + 0x24) = iVar15;
  }
  else {
    pfVar3 = *(float **)(unaff_RDI + 0x18);
  }
  pfVar1 = pfVar3 + uVar7;
  switch(in_ECX) {
  case 0:
    ...
    break;
  case 1:
    param_2 = *(float *)*unaff_RSI;
    param_3 = ((float *)*unaff_RSI)[in_EDX - 1];
  case 4:
    uVar11 = uVar10 - 1;
    uVar5 = uVar7;
    pfVar4 = pfVar1;
    pfVar13 = pfVar3;
    if ((6 < uVar11) &&
       ((uVar14 = (ulonglong)uVar11 + 1, pfVar3 + uVar7 + uVar11 + 1 <= pfVar3 ||
        (pfVar3 + uVar14 <= pfVar1)))) {
      uVar18 = uVar14 & 0xfffffffffffffff8;
      uVar12 = (uVar18 - 8 >> 3) + 1;
      uVar5 = (ulonglong)((uint)uVar12 & 3);
      if (uVar18 - 8 < 0x18) {
        lVar9 = 0;
      }
      else {
      ...
      uVar5 = (ulonglong)(uVar10 - (int)uVar18);
    }
    uVar11 = (uint)uVar5;
    uVar17 = uVar11 - 1;
    if ((uVar5 & 7) != 0) {
  ...
  case 2:
    ...
    do {
      ...
      uVar6 = (uint)((ulonglong)uVar11 + lVar9);
      if ((longlong)((ulonglong)uVar11 + lVar9) < 1) {
        uVar6 = 0;
      }
      if ((int)in_EDX <= (int)uVar6) {
        uVar6 = uVar11;
      }
      pfVar1[lVar9] = *(float *)(lVar16 + (longlong)(int)uVar17 * 4);
      pfVar1[uVar5 - 1] = *(float *)(lVar16 + (longlong)(int)uVar6 * 4);
      lVar9 = lVar9 + -1;
      bVar19 = uVar5 != uVar7;
      uVar5 = uVar5 + 1;
    } while (bVar19);
  ...
  if (uVar10 != 1) {
    uVar5 = (ulonglong)((uint)(uVar7 - 1) & 3);
    if (uVar7 - 2 < 3) {
      lVar16 = 1;
    }
    else {
  ...
  if (in_R8B != '\0') {
    ...
    if (0 < (int)in_EDX) {
      ...
      if ((in_EDX & 1) != 0) {
        uVar10 = in_EDX - 1;
        fVar21 = *(float *)(lVar16 + (ulonglong)uVar10 * 4);
        fVar20 = (fVar20 - fVar21) * param_1 + fVar21;
        *(float *)(lVar16 + (ulonglong)uVar10 * 4) = fVar20;
        uVar8 = uVar8 - 1;
      }
      if (in_EDX != 1) {
        lVar9 = uVar8 + 2;
        do {
          uVar11 = uVar10 - 2;
          fVar21 = *(float *)(lVar16 + (ulonglong)(uVar10 - 1) * 4);
          fVar21 = (fVar20 - fVar21) * param_1 + fVar21;
          *(float *)(lVar16 + (ulonglong)(uVar10 - 1) * 4) = fVar21;
          fVar20 = *(float *)(lVar16 + (ulonglong)uVar11 * 4);
          fVar20 = (fVar21 - fVar20) * param_1 + fVar20;
          *(float *)(lVar16 + (ulonglong)uVar11 * 4) = fVar20;
          lVar9 = lVar9 + -2;
          uVar10 = uVar11;
        } while (2 < lVar9);
      }
