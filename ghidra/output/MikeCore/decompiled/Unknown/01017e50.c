...
bool FUN_01017e50(ENGINE *param_1,ulonglong param_2,DSO_METHOD *param_3,code *param_4)
  ...
  if (DAT_0278acf0 < 0) {
    ...
    iVar1 = _CRYPTO_get_ex_new_index
                      (0,0,(void *)0x0,FUN_01018680,
                       (undefined1 *)CONCAT44(in_stack_fffffffffffffefc,in_stack_fffffffffffffef8),
...
LAB_01017ee4:
  ...
  iVar1 = 0x9c;
  plVar2 = (longlong *)_CRYPTO_zalloc();
  if (plVar2 == (longlong *)0x0) {
...
LAB_01018093:
  ...
  plVar2[7] = (longlong)"v_check";
  plVar2[8] = (longlong)"bind_engine";
...
joined_r0x01017fdd:
  ...
  dso = (DSO *)((longlong)&switchD_01018002::switchdataD_01018658 +
               (longlong)(int)(&switchD_01018002::switchdataD_01018658)[unaff_ESI - 200U]);
  switch(unaff_ESI) {
  case 200:
    ...
    if (pEVar11 == (ENGINE *)0x0) {
      ...
      pcVar8 = _CRYPTO_strdup((char *)dso,(char *)((longlong)&section_00000108.size + 7),
                              (int)param_3);
    }
    plVar2[3] = (longlong)pcVar8;
    goto LAB_010183f5;
  case 0xc9:
  ...
  case 0xce:
    ...
    *plVar2 = (longlong)pDVar5;
    ...
    if (plVar2[3] == 0) {
      ...
      pcVar8 = (char *)((longlong)&MACH_HEADER.magic + 2);
      dso = (DSO *)0x0;
...
LAB_0101848d:
        ...
        if ((int)plVar2[4] == 0) {
          pDVar6 = _DSO_bind_func(dso,pcVar8);
          plVar2[1] = (longlong)pDVar6;
          if ((pDVar6 == (DSO_FUNC_TYPE)0x0) ||
             (puVar7 = (undefined *)(*pDVar6)(), puVar7 <= &UNK_0002ffff)) {
            plVar2[1] = 0;
            plVar2[2] = 0;
            _DSO_free(dso);
            *plVar2 = 0;
        ...
        iVar1 = (*(code *)plVar2[2])(uVar13,local_60);
        if (iVar1 == 0) {
          plVar2[1] = 0;
          plVar2[2] = 0;
          _DSO_free(dso);
    ...
    if (0 < iVar1) {
      ...
      do {
        ...
        pDVar5 = _DSO_load((DSO *)0x0,(char *)0x0,param_3,(int)param_4);
        if (pDVar5 != (DSO *)0x0) {
          pcVar8 = (char *)((longlong)&section_00000158.size + 4);
          _CRYPTO_free(dso);
          goto LAB_0101848d;
        }
        _CRYPTO_free(dso);
