...
void FUN_01389e90(longlong param_1,int param_2)

{
  ...
  *puVar2 = &DAT_02572358;
  local_90 = puVar2;
  (*DAT_02572370)();
  puVar2 = (undefined8 *)*unaff_RSI;
  if (1 < *(int *)((longlong)puVar2 + 0xc)) {
    local_58 = '\0';
    ...
    while( true ) {
      ...
      lVar5 = local_50[2];
      local_60 = *(longlong **)(lVar5 + 8 + lVar3 * 8);
...
LAB_0138a0d0:
          ...
          if (local_a0 < 1) {
            ...
            if ((pvVar4 != (void *)0x0) && (lVar5 = FUN_00e8b990(), lVar5 != 0)) {
              plVar8 = (longlong *)plVar11[(ulonglong)(*(uint *)(lVar5 + 0x154) & 1) + 4];
            }
...
LAB_0138a1c8:
          ...
          if ((pvVar4 != (void *)0x0) && (lVar3 = FUN_00e8b990(), lVar3 != 0)) {
            plVar8 = (longlong *)plVar11[(ulonglong)(*(uint *)(lVar3 + 0x154) & 1) + 4];
          }
          cVar1 = (**(code **)(*plVar8 + 0x3c8))();
          if (cVar1 == '\0') {
            pvVar4 = _pthread_getspecific(pVar6);
            if ((pvVar4 != (void *)0x0) && (lVar3 = FUN_00e8b990(), lVar3 != 0)) {
              plVar11 = (longlong *)plVar11[(ulonglong)(*(uint *)(lVar3 + 0x154) & 1) + 4];
            }
...
LAB_01389f60:
            local_38 = (longlong *)CONCAT44(local_38._4_4_,(int)local_38 + 1);
          }
          FUN_00d50b20();
        }
        FUN_00d50b20();
...
LAB_0138ae70:
  if (*(int *)((longlong)local_90 + 0xc) != 0) {
    ...
    if (0 < *(int *)((longlong)local_90 + 0xc)) {
      uVar12 = 0;
      do {
        local_60 = *(longlong **)(local_90[2] + (ulonglong)uVar12 * 8);
        uVar7 = uVar12;
        ...
        if (plVar11 != (longlong *)0x0) {
          ...
          while( true ) {
            ...
            lVar5 = local_78[2];
            local_88 = *(longlong **)(lVar5 + 8 + lVar3 * 8);
            pvVar4 = _pthread_getspecific((pthread_key_t)lVar5);
            pVar6 = (pthread_key_t)lVar5;
            if (pvVar4 != (void *)0x0) {
              FUN_00e8b990();
      ...
      } while ((int)uVar12 < *(int *)((longlong)local_90 + 0xc));
    }
    FUN_001150f0();
    FUN_013357a0();
  }
