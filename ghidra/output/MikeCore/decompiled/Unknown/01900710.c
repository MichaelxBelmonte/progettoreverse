...
longlong * FUN_01900710(double param_1,int *param_2)
...
LAB_01900a6b:
  ...
  if (((dVar7 == param_1) && (!NAN(dVar7) && !NAN(param_1))) ||
    ...
    lVar3 = *(longlong *)
             (*(longlong *)(*(longlong *)(unaff_RSI + 0x38) + 0x10) + (longlong)iVar2 * 8);
    *(undefined1 *)(unaff_RDI + 1) = 0;
  }
  else {
    iVar1 = iVar2 + 1;
    if (iVar1 == *(int *)(*(longlong *)(unaff_RSI + 0x38) + 0xc) + -1) {
      dVar7 = (double)FUN_01907950();
      if (dVar7 <= param_1) {
        lVar3 = *(longlong *)
                 (*(longlong *)(*(longlong *)(unaff_RSI + 0x38) + 0x10) + (longlong)iVar1 * 8);
        *(undefined1 *)(unaff_RDI + 1) = 0;
    ...
    if (dVar8 - param_1 <= param_1 - dVar7) {
      lVar3 = *(longlong *)(lVar3 + (longlong)iVar1 * 8);
      *(undefined1 *)(unaff_RDI + 1) = 0;
    }
    else {
      lVar3 = *(longlong *)(lVar3 + (longlong)iVar2 * 8);
      *(undefined1 *)(unaff_RDI + 1) = 0;
    }
  }
joined_r0x019009a3:
