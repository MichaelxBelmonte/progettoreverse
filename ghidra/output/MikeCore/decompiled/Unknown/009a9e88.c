// Function: FUN_009a9e88
// Address: 009a9e88
// Size: 992 bytes
// Class: Unknown


void FUN_009a9e88(undefined8 param_1,undefined8 param_2,size_t param_3)

{
  ...
  if ((ulonglong)unaff_RDI[4] < 0x1000) {
    lVar4 = unaff_RDI[3];
...
LAB_009aa21e:
    ...
    puVar5 = puVar11;
    if (puVar11 != (undefined8 *)unaff_RDI[3]) goto LAB_009aa207;
    ...
    if (puVar14 < puVar9 || lVar4 == 0) {
      ...
      if ((ulonglong)pvVar2 >> 0x3d != 0) goto LAB_009aa21e;
    ...
    unaff_RDI[4] = unaff_RDI[4] - 0x1000;
    puVar11 = (undefined8 *)unaff_RDI[2];
    local_38 = *(undefined8 *)unaff_RDI[1];
    puVar14 = (undefined8 *)unaff_RDI[1] + 1;
    unaff_RDI[1] = (longlong)puVar14;
