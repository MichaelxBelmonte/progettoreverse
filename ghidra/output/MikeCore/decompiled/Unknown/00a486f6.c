...
//   "void license_services::LsEntityUtilsAuthorization::add(license_services::LsAuthorizationWire &)"


void FUN_00a486f6(void)

{
  ...
  if (lVar4 != -1) {
    ...
    FUN_00983230();
    FUN_00983230();
    FUN_00928ab0("void license_services::LsEntityUtilsAuthorization::add(license_services::LsAuthorizationWire &)"
                 ,0x68);
    FUN_009c78cb();
  }
  FUN_009b4be0();
  ...
  if (lVar7 == *(longlong *)(lVar4 + 0x58)) {
    lVar7 = (lVar7 - *(longlong *)(lVar4 + 0x48) >> 5) * -0x1111111111111111;
    if (0x88888888888888 < lVar7 + 1U) {
                    /* WARNING: Subroutine does not return */
      std::__vector_base_common<true>::__throw_length_error();
    }
    FUN_00a48d90(lVar4 + 0x58,lVar7);
    FUN_00a6f16a();
    FUN_00a48d00();
    FUN_00a48e00();
  }
    ...
    FUN_00a6f16a();
    *(longlong *)(lVar4 + 0x50) = lVar7 + 0x1e0;
  }
  return;
}
