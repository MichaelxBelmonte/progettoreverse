...
void FUN_01090740(undefined8 param_1,longlong param_2)

{
  ...
  uVar11 = (ulonglong)auStack_250 & 0xfffffffffffffc00;
  pauVar1 = (undefined1 (*) [32])(unaff_RSI + param_2 * 0x40);
  pauVar12 = (undefined1 (*) [32])(uVar11 + 0x1c0);
  *(int **)(uVar11 + 0x200) = unaff_RDI;
  *(longlong *)(uVar11 + 0x208) = unaff_RSI;
  *(undefined1 (**) [32])(uVar11 + 0x210) = pauVar1;
  *(BADSPACEBASE **)(uVar11 + 0x218) = register0x00000020;
  auVar4 = _DAT_0108e5c0;
  auVar3 = _DAT_0108e5a0;
  pauVar14 = (undefined1 (*) [32])(unaff_RSI + 0x40);
  iVar6 = *unaff_RDI;
  uVar10 = unaff_RDI[1];
  uVar8 = unaff_RDI[2];
  pauVar20 = pauVar14;
  ...
  do {
    ...
    auVar25 = vpshufb_avx2(auVar21,_DAT_0108e580);
    auVar22._0_16_ =
    ...
    auVar27 = vpshufb_avx2(auVar31,_DAT_0108e580);
    auVar23._0_16_ =
    ...
    auVar28 = vpshufb_avx2(auVar22,_DAT_0108e580);
    auVar21 = vpaddd_avx2(auVar25,_DAT_0108e380);
    auVar29 = vpshufb_avx2(auVar23,_DAT_0108e580);
    auVar31 = vpaddd_avx2(auVar27,_DAT_0108e3a0);
    auVar22 = vpaddd_avx2(auVar28,_DAT_0108e3c0);
    auVar23 = vpaddd_avx2(auVar29,_DAT_0108e3e0);
    *pauVar12 = auVar21;
    uVar5 = 0;
    pauVar12[1] = auVar31;
    *(undefined8 *)(pauVar12[-3] + 0x18) = *(undefined8 *)(pauVar12[2] + 0x18);
    ...
    pauVar12[-1] = auVar23;
    pauVar1 = pauVar12 + -2;
    pauVar12 = (undefined1 (*) [32])&DAT_0108e400;
    do {
      pauVar13 = pauVar1;
      ...
      *pauVar1 = auVar21;
      ...
      pauVar20 = pauVar12 + 4;
      pauVar12 = pauVar12 + 4;
    } while (*(char *)((longlong)*pauVar20 + 3) != '\0');
    uVar5 = iVar6 + uVar5;
    iVar6 = uVar19 + *(int *)pauVar13[-2] + (uVar17 & uVar16) + (~uVar16 & uVar18) +
            ((uVar16 >> 0x19 | uVar16 * 0x80) ^ (uVar16 >> 0xb | uVar16 * 0x200000) ^
            (uVar16 >> 6 | uVar16 * 0x4000000));
