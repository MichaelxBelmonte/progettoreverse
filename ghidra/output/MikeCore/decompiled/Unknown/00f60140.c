...
undefined8 FUN_00f60140(code *param_1,int param_2,ulong *param_3)

{
  ...
  if (param_2 == 0x1001) {
    ...
    lVar4 = 0;
    do {
      uVar6 = (ulonglong)*(ushort *)(unaff_RDI + lVar4) << 0x30;
    ...
    lVar4 = 0;
    do {
      local_38 = (ulonglong)*(byte *)(unaff_RDI + 3 + lVar4) |
                 (ulonglong)*(byte *)(unaff_RDI + 2 + lVar4) << 8 |
                 (ulonglong)*(byte *)(unaff_RDI + 1 + lVar4) << 0x10 |
                 (ulonglong)*(byte *)(unaff_RDI + lVar4) << 0x18;
      if ((param_1 != (code *)0x0) && (uVar3 = (*param_1)(), (int)uVar3 < 1)) {
        return uVar3;
      }
      lVar4 = lVar4 + 4;
    } while (unaff_ESI != (uint)lVar4);
