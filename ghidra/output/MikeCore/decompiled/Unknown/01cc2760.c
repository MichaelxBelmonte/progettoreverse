...
undefined8 FUN_01cc2760(undefined8 param_1,undefined8 param_2,undefined8 param_3,float param_4)

{
  ...
  switch(unaff_ESI) {
  case 8:
    param_1 = (**(code **)(*unaff_RDI + 0x548))(fVar11,fVar15);
    break;
  case 9:
  case 0x23:
  case 0x24:
    uVar13 = (**(code **)(*unaff_RDI + 0x548))(fVar11);
  ...
  case 0x10:
    ...
    break;
  case 0x27:
    auVar19._0_8_ = (**(code **)(*unaff_RDI + 0x548))(fVar11);
