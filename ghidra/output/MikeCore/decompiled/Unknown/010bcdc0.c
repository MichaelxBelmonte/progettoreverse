...
undefined8 FUN_010bcdc0(BIO *param_1,char param_2,size_t param_3)

{
  ...
  if (unaff_ESI == 1) {
    ...
    if (iVar1 < 1) {
      ...
      ___memcpy_chk(0x10);
      uVar2 = (ulonglong)param_1->cb_arg & 7;
      if (uVar2 == 0) {
        iVar1 = *(int *)&param_1->method;
      }
      else {
    ...
    _memset((void *)(ulonglong)(4U - iVar1),4U - iVar1,param_3);
    _BIO_printf((BIO *)(ulonglong)local_47,(char *)(ulonglong)local_48,(ulonglong)local_46,
                (ulonglong)local_45);
  }
  else if (unaff_ESI == 2) {
    ...
    format = (char *)(longlong)(int)uVar3;
    ...
    if (0 < iVar1) {
      ...
      do {
        ...
        bio = (BIO *)(ulonglong)(byte)param_1->callback[lVar6];
        _BIO_printf(bio,pcVar4);
        lVar6 = lVar6 + 1;
      } while (lVar6 < *(int *)&param_1->method);
    }
    _BIO_printf(bio,(char *)(ulonglong)(*(uint *)&param_1->cb_arg & 7));
  }
  uVar8 = 1;
LAB_010bd0df:
