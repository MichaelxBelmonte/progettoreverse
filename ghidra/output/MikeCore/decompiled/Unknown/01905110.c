...
void FUN_01905110(double param_1,undefined4 param_2)
    ...
    *pdVar8 = local_90;
    ...
    if (1 < iVar9) {
      ...
      do {
        ...
        pdVar8[lVar10] =
             (DAT_023b4df8 / ((local_88 / local_d0) * local_98 + local_80)) * dVar12 +
             pdVar8[lVar10 + -1];
        lVar10 = lVar10 + 1;
        iVar9 = *(int *)(uVar1 + 0xc);
        uVar5 = local_48;
    ...
    local_88 = *(double *)((longlong)*(int *)(uVar5 + 0x18) + -8 + (longlong)pdVar8);
    if (local_a8 == 0) {
      ...
      *(undefined1 *)puVar6 = 0;
      ...
      if (1 < *(int *)(uVar1 + 0xc)) {
        lVar10 = 1;
        do {
          pvVar2 = _pthread_getspecific((pthread_key_t)puVar6);
          if (pvVar2 != (void *)0x0) {
            FUN_00e8b990();
          }
          FUN_01907cc0(*(undefined8 *)(*(longlong *)(local_48 + 0x10) + lVar10 * 8));
          lVar10 = lVar10 + 1;
      ...
      while( true ) {
        ...
        pvVar2 = _pthread_getspecific((pthread_key_t)pdVar8);
        if (pvVar2 != (void *)0x0) {
          FUN_00e8b990();
        }
        FUN_01907cc0(*(undefined8 *)(*(longlong *)(local_48 + 0x10) + -8 + lVar10 * 8));
