...
ulonglong FUN_00fd8790(undefined4 *param_1,longlong param_2,int param_3,EVP_MD *param_4)

{
  ...
  pAVar13 = (ASN1_OBJECT *)
            ((longlong)&switchD_00fd87ca::switchdataD_00fd91a0 +
            (longlong)(int)(&switchD_00fd87ca::switchdataD_00fd91a0)[unaff_ESI - 1U]);
  switch(unaff_ESI) {
  case 1:
    uVar21 = 1;
    if (param_2 != 0) break;
      ...
      if (lVar7 != 0) {
        ...
        if (iVar3 != 0) {
          ...
          if ((ASN1_OBJECT *)CONCAT44(in_stack_ffffffffffffffac,in_stack_ffffffffffffffa8) ==
            ...
            if (0 < iVar4) {
              ppuVar15 = (uchar **)((longlong)&section_00000338.addr + 2);
              local_50 = _CRYPTO_malloc((int)local_48,(char *)((longlong)&section_00000338.addr + 2)
                                        ,iVar3);
              local_40 = (ASN1_OBJECT *)local_50;
              if ((local_50 != (char **)0x0) &&
                 (uVar6 = _i2o_ECPublicKey((EC_KEY *)local_48,ppuVar15), 0 < (int)uVar6)) {
                _ASN1_STRING_set0(local_48,(void *)(ulonglong)uVar6,iVar3);
                uVar21 = *(ulonglong *)&local_38->encrypt & 0xfffffffffffffff0 | 8;
                *(ulonglong *)&local_38->encrypt = uVar21;
                local_40 = (ASN1_OBJECT *)0x0;
...
LAB_00fd8a40:
            ...
            if (iVar4 != 0) {
              ...
              if (uVar6 == 0) {
                pAVar16 = (ASN1_TYPE *)((longlong)&section_00000388.size + 2);
              }
              else {
                pAVar16 = (ASN1_TYPE *)(ulonglong)uVar6;
                if (uVar6 == 1) {
                  pAVar16 = (ASN1_TYPE *)((longlong)&section_00000388.size + 3);
                }
              }
              if (iVar3 == 1) {
                uVar21 = 0;
                ...
                if (local_68 == (EVP_MD *)0x0) {
                  ...
                  pEVar14 = (EVP_CIPHER_CTX *)
                            ((longlong)&dylib_command_00000ff0.dylib.compatibility_version + 1);
                        ...
                        if ((0 < iVar4) &&
                          ...
                          if (0 < iVar4) {
                            ...
                            if (((local_40 != (ASN1_OBJECT *)0x0) && (uVar6 != 0)) &&
                              ...
                              _ASN1_STRING_set0(str,(void *)(ulonglong)uVar6,iVar3);
                              local_40 = (ASN1_OBJECT *)0x0;
                ...
                if (param_4 != (EVP_MD *)0x0) {
                  ...
                  if (0 < iVar3) {
                    ...
                    if (*(int *)local_48->data == 0x10) {
                      piVar1 = *(int **)((longlong)local_48->data + 8);
                      pEVar14 = *(EVP_CIPHER_CTX **)(piVar1 + 2);
                      bVar2 = false;
                      local_38 = pEVar14;
                      pXVar8 = _d2i_X509_ALGOR((X509_ALGOR **)pEVar14,(uchar **)(longlong)*piVar1,
                                               lVar17);
                      if ((pXVar8 != (X509_ALGOR *)0x0) &&
                        ...
                        if ((pEVar9 != (EVP_CIPHER *)0x0) &&
                          ...
                          if ((iVar3 != 0) &&
                            ...
                            bVar2 = false;
                            pEVar14 = (EVP_CIPHER_CTX *)
                                      ((longlong)&dylib_command_00000ff0.dylib.compatibility_version
                                      + 3);
                            param_4 = (EVP_MD *)0x0;
                            iVar3 = _EVP_PKEY_CTX_ctrl(0x1007,0x400,uVar6);
                            if (0 < iVar3) {
                              pEVar14 = (EVP_CIPHER_CTX *)(ulonglong)uVar6;
