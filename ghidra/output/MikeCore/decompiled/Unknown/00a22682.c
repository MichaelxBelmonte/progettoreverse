...
void FUN_00a22682(undefined8 param_1,undefined8 param_2,char *param_3)

{
  ...
  if (iVar2 != iVar8) {
    ...
    param_3 = 
    "/Users/admin/jenkins/workspace/EdenFiveMacFull/common/paceSources/generated/licenseServices/liblicenseservices/LsCachedObjectVectorActivationInfo.cpp"
    ;
  ...
  if (plVar3 == plVar4) {
LAB_00a226ff:
    if ((plVar17 == plVar4) || ((longlong)plVar17 - (longlong)plVar3 == -8)) goto LAB_00a2270d;
    lVar18 = (longlong)plVar17 - (longlong)plVar3 >> 3;
  }
  else {
    do {
      if (*plVar17 == *(longlong *)(unaff_RSI + 0x10)) goto LAB_00a226ff;
      plVar17 = plVar17 + 1;
...
LAB_00a2270d:
  ...
  *(longlong *)(lVar11 + 0x18) = lVar5 + lVar18 * 8 + ((longlong)pvVar12 >> 3) * 8;
  ...
  pvVar13 = (void *)((longlong)pvVar10 + lVar18 * 0x180);
  pvVar12 = (void *)((longlong)pvVar10 + lVar18 * 0x180 + 0x180);
  pvVar16 = pvVar13;
  if (pvVar12 != pvVar6) {
    do {
      pvVar16 = (void *)((longlong)pvVar13 + 0x180);
      FUN_00a649c0();
      sVar15 = (size_t)param_3;
      pvVar12 = (void *)((longlong)pvVar13 + 0x300);
      pvVar13 = pvVar16;
    } while (pvVar12 != pvVar6);
    pvVar12 = *(void **)(lVar14 + 0x50);
    if (pvVar12 == pvVar16) goto LAB_00a2289a;
  }
  do {
    puVar1 = (undefined8 *)((longlong)pvVar12 + -0x180);
    pvVar12 = (void *)((longlong)pvVar12 + -0x180);
    (**(code **)*puVar1)();
    sVar15 = (size_t)param_3;
...
LAB_00a2289a:
  *(void **)(lVar14 + 0x50) = pvVar16;
  ...
  if (plVar4 != (longlong *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00a22927. Too many branches */
