...

{
  ...
  for (plVar20 = *(longlong **)(unaff_RDI + 0x70); plVar20 != *(longlong **)(unaff_RDI + 0x78);
      plVar20 = plVar20 + 3) {
    iVar1 = (**(code **)(*unaff_RSI + 0x58))();
    iVar1 = iVar1 + iVar18;
    for (lVar19 = *plVar20; lVar19 != plVar20[1]; lVar19 = lVar19 + 1) {
      iVar2 = (**(code **)(*unaff_RSI + 0x80))();
      iVar1 = iVar1 + iVar2;
    }
    iVar18 = (**(code **)(*unaff_RSI + 0x60))();
    iVar18 = iVar18 + iVar1;
  }
