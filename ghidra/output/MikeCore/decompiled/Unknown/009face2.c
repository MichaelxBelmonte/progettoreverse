...
void FUN_009face2(longlong *param_1,longlong *param_2,undefined8 param_3,ulong param_4)
...
LAB_009fad8f:
    if (plVar11 == (longlong *)0x0) goto LAB_009fae0a;
  }
    ...
    plVar7 = (longlong *)(ulonglong)(*param_2 == 0);
    if ((plVar11 == (longlong *)0x0) == (*param_2 == 0)) goto LAB_009fae0a;
  }
  else if (plVar11 != (longlong *)0x0) goto LAB_009fae0a;
  plVar11 = (longlong *)*unaff_RSI;
  ...
  if ((0xff < (uint)(int)cVar4) || ((puVar3[(ulonglong)(uint)(int)cVar4 * 4 + 0x3d] & 4) == 0))
  goto LAB_009fae0a;
  plVar11 = (longlong *)*unaff_RSI;
  ...
  goto LAB_009fad19;
LAB_009fae0a:
  pvVar8 = (void *)(CONCAT71((int7)((ulonglong)plVar7 >> 8),(byte)local_48) & 0xffffffffffffff01);
  uVar6 = uStack_40;
  if ((local_48 & 1) == 0) {
    uVar6 = (ulonglong)((byte)local_48 >> 1);
  }
  if (uVar6 != 0) {
    if (uVar6 < 6) {
      lVar13 = 0;
      this = local_38;
      if ((local_48 & 1) == 0) {
        this = (bad_cast *)((longlong)&local_48 + 1);
      }
      cVar4 = FUN_009f5ffe();
      if (cVar4 == '\0') {
...
LAB_009fafb9:
      ...
      *param_1 = lVar13;
      pvVar8 = (void *)(CONCAT71((int7)((ulonglong)param_1 >> 8),(byte)local_48) &
                       0xffffffffffffff01);
      if ((local_48 & 1) == 0) {
      ...
      *param_1 = lVar10 * lVar13;
      ...
      if (((ulonglong)in_stack_ffffffffffffff98 & 1) == 0) {
