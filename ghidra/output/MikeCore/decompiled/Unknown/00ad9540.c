...
int FUN_00ad9540(undefined8 param_1,string *param_2)

{
  ...
  this = (string *)(ulonglong)*(uint *)(unaff_RDI + 0x20);
  uVar1 = *(int *)(unaff_RDI + 0x18) + 1;
  *(uint *)(unaff_RDI + 0x18) = uVar1;
...
switchD_00ad9581_caseD_5:
  ...
  this = (string *)
         ((longlong)&switchD_00ad9581::switchdataD_00ad991c +
         (longlong)(int)(&switchD_00ad9581::switchdataD_00ad991c)[unaff_ESI - 2U]);
  switch(unaff_ESI) {
  case 2:
    iVar2 = FUN_00ad64b0();
    break;
