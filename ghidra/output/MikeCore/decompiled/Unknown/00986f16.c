...
/* WARNING: Removing unreachable block (ram,0x009870d3) */
/* WARNING: Removing unreachable block (ram,0x009870e5) */
/* WARNING: Removing unreachable block (ram,0x00987259) */

void FUN_00986f16(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  pcVar2 = pcStackY_70;
  (**(code **)(*unaff_RDI + 0x20))(0,&DAT_023cd044);
  ...
  local_34 = FUN_0096dcbd(uVar5,unaff_RSI);
  ...
  (**(code **)(*unaff_RDI + 0x20))(uVar5,&DAT_023cd04d);
  if (pcVar2 != (code *)0x0) {
    LOCK();
    pcVar1 = pcVar2 + 8;
  ...
  uVar5 = FUN_00928ab0("virtual void pace::Asn1ParserCert::GetEcdsaSignature(BIG_SignatureECDSA_Struct &)"
                       ,0x43b);
  uVar5 = FUN_009c720b(uVar5,uVar4);
  local_34 = FUN_0096dcbd(uVar5,unaff_RSI + 0x38);
  if (local_34 != 0) {
    FUN_00925fd0();
    uVar4 = FUN_00926010();
    puVar6 = &LAB_009977a0;
