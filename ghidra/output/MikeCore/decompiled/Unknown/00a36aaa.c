...
void FUN_00a36aaa(undefined8 param_1,undefined8 param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a36b27:
    if ((plVar17 == plVar4) || ((longlong)plVar17 - (longlong)plVar3 == -8)) goto LAB_00a36b35;
    lVar18 = (longlong)plVar17 - (longlong)plVar3 >> 3;
  }
  else {
    do {
      if (*plVar17 == *(longlong *)(unaff_RSI + 0x10)) goto LAB_00a36b27;
      plVar17 = plVar17 + 1;
...
LAB_00a36b35:
  ...
  *(longlong *)(lVar11 + 0x18) = lVar5 + lVar18 * 8 + ((longlong)pvVar12 >> 3) * 8;
  ...
  pvVar13 = (void *)((longlong)pvVar10 + lVar18 * 0xc0);
  pvVar12 = (void *)((longlong)pvVar10 + lVar18 * 0xc0 + 0xc0);
  pvVar16 = pvVar13;
  if (pvVar12 != pvVar6) {
    do {
      pvVar16 = (void *)((longlong)pvVar13 + 0xc0);
      FUN_00aa5ac6();
      sVar15 = (size_t)param_3;
      pvVar12 = (void *)((longlong)pvVar13 + 0x180);
      pvVar13 = pvVar16;
  ...
  do {
    puVar1 = (undefined8 *)((longlong)pvVar12 + -0xc0);
    pvVar12 = (void *)((longlong)pvVar12 + -0xc0);
    (**(code **)*puVar1)();
    sVar15 = (size_t)param_3;
...
LAB_00a36cc2:
  *(void **)(lVar14 + 0x50) = pvVar16;
  ...
  if (plVar4 != (longlong *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00a36d4f. Too many branches */
