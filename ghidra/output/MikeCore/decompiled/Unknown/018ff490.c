...
longlong * FUN_018ff490(int *param_1,ulonglong param_2)
...
joined_r0x018ff7b1:
  ...
  if (iVar5 == *(int *)(lVar6 + 0xc) + -2) {
    lVar6 = *(longlong *)(*(longlong *)(lVar6 + 0x10) + 8 + lVar8 * 8);
    uVar4 = FUN_019079b0();
  ...
  if (iVar5 == 0) {
    ...
    lVar6 = *(longlong *)(*(longlong *)(*(longlong *)(unaff_RSI + 0x38) + 0x10) + -8 + lVar8 * 8);
    FUN_019079b0();
  }
LAB_018ff938:
