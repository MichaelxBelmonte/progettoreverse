// Function: FUN_00a24858
// Address: 00a24858
// Size: 916 bytes
// Class: Unknown


void FUN_00a24858(undefined8 param_1,undefined8 param_2,size_t param_3)
  ...
  if (local_40 != *(longlong *)(unaff_RSI + 0x50)) {
    ...
    do {
      ...
      *(undefined1 *)(puVar7 + 5) = 0;
      ...
      puVar7[0xd] = 0;
      puVar7[0xc] = 0;
      *(undefined4 *)(puVar7 + 0x12) = 0x1010100;
      *(undefined2 *)((longlong)puVar7 + 0x94) = 0;
      FUN_00a670e2();
...
LAB_00a24bee:
      ...
      local_40 = local_40 + 0x98;
    } while (local_40 != *(longlong *)(unaff_RSI + 0x50));
  }
  *(undefined4 *)(unaff_RDI[3] + 0x40) = 0x67;
  FUN_009b99ca();
  return;
}
