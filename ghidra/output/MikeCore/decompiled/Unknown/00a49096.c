...
//   "void license_services::LsEntityUtilsCertificateChain::add(license_services::LsCertificateChainWire ...


void FUN_00a49096(void)

{
  ...
  if (lVar4 != -1) {
    ...
    FUN_00983230();
    FUN_00983230();
    FUN_00928ab0("void license_services::LsEntityUtilsCertificateChain::add(license_services::LsCertificateChainWire &)"
                 ,0x68);
    FUN_009c78cb();
  }
  FUN_009b4be0();
  ...
  if (lVar7 == *(longlong *)(lVar4 + 0x58)) {
    lVar7 = (lVar7 - *(longlong *)(lVar4 + 0x48) >> 4) * -0x79435e50d79435e5;
    if (0xd79435e50d7943 < lVar7 + 1U) {
                    /* WARNING: Subroutine does not return */
      std::__vector_base_common<true>::__throw_length_error();
    }
    FUN_00a49730(lVar4 + 0x58,lVar7);
    FUN_00a71090();
    FUN_00a496a0();
    FUN_00a497a0();
  }
    ...
    FUN_00a71090();
    *(longlong *)(lVar4 + 0x50) = lVar7 + 0x130;
  }
  return;
}
