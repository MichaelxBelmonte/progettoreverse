...
void FUN_00a3b07c(undefined8 param_1,undefined8 param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a3b0f9:
    if ((plVar16 == plVar4) || ((longlong)plVar16 - (longlong)plVar3 == -8)) goto LAB_00a3b107;
    lVar17 = (longlong)plVar16 - (longlong)plVar3 >> 3;
  }
  else {
    do {
      if (*plVar16 == *(longlong *)(unaff_RSI + 0x10)) goto LAB_00a3b0f9;
      plVar16 = plVar16 + 1;
...
LAB_00a3b107:
  ...
  *(longlong *)((longlong)pvVar11 + 0x18) = lVar9 + lVar17 * 8 + ((longlong)pvVar10 >> 3) * 8;
  lVar14 = lVar17 * 0xe8 + *(longlong *)((longlong)pvVar8 + 0x48);
  lVar12 = lVar14 + 0xe8;
  ...
  if (lVar12 != lVar9) {
    ...
    if (lVar12 == lVar15) goto LAB_00a3b28e;
  }
  do {
    puVar1 = (undefined8 *)(lVar12 + -0xe8);
    lVar12 = lVar12 + -0xe8;
    (**(code **)*puVar1)();
    sVar13 = (size_t)param_3;
  } while (lVar15 != lVar12);
LAB_00a3b28e:
  *(longlong *)((longlong)pvVar8 + 0x50) = lVar15;
  ...
  if (plVar4 != (longlong *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00a3b31b. Too many branches */
