...
longlong FUN_010c2450(uint *param_1,ASN1_ITEM *param_2,undefined8 param_3,char *param_4)
...
LAB_010c2b67:
      ...
      iVar23 = 0;
LAB_010c24f9:
      puVar13 = (undefined8 *)_OPENSSL_sk_value();
...
LAB_010c2c62:
            it_00 = (ASN1_ITEM *)((longlong)&segment_command_00000020.vmsize + 1);
            iVar6 = 0xf3;
LAB_010c2c7e:
...
LAB_010c2c3c:
                            ...
                            *(ASN1_OBJECT **)it = pAVar15;
                            if (pAVar15 == (ASN1_OBJECT *)0x0) {
                              it_00 = (ASN1_ITEM *)((longlong)&segment_command_00000020.vmsize + 4);
                              iVar6 = 0x128;
                            }
                            else {
                              param_1 = (uint *)it;
...
switchD_010c27fc_caseD_5:
                                      ...
                                      case 3:
                                        iVar8 = _strncmp((char *)&switchD_010c27fc::
                                                         ...
                                                         (char *)((longlong)&MACH_HEADER.magic + 3),
                                                         sVar10);
                                        break;
                                      case 4:
                                        iVar8 = _strncmp((char *)&switchD_010c27fc::
                                      ...
                                      case 7:
                                        iVar8 = _strncmp((char *)&switchD_010c27fc::
                                                                  switchdataD_010c2fac,
                                                         (char *)((longlong)&MACH_HEADER.cputype + 3
                                                                 ),sVar10);
                                        break;
                                      case 9:
                                        iVar8 = _strncmp((char *)&switchD_010c27fc::
                                                                  switchdataD_010c2fac,
                                                         (char *)((longlong)&MACH_HEADER.cpusubtype
                                                                 + 1),sVar10);
                                        break;
                                      case 10:
                                        iVar8 = _strncmp((char *)&switchD_010c27fc::
                                      ...
                                      case 0xd:
                                        iVar8 = _strncmp((char *)&switchD_010c27fc::
                                                                  switchdataD_010c2fac,
                                                         (char *)((longlong)&MACH_HEADER.filetype +
                                                                 1),sVar10);
                                      }
...
LAB_010c2929:
                                    ...
                                    param_2 = (ASN1_ITEM *)(ulonglong)sVar10;
                                    ...
                                    if (iVar8 == 0) {
                                      ...
                                      *(uint *)(*(longlong *)pAVar17 + 4) = (uint)!bVar5 * 4 + 0x16;
                                      goto LAB_010c2929;
                                    }
                                    iVar8 = _strcmp((char *)param_1,&param_2->itype);
                                    if (iVar8 != 0) {
                                    ...
                                    lVar2._1_3_ = *(undefined3 *)&pAVar16->field_0x1;
                                    ...
                                    if (0 < iVar8) {
                                      ...
                                      do {
                                        ...
                                        if (pAVar18 == (ASN1_INTEGER *)0x0) {
                                          it_00 = (ASN1_ITEM *)
                                                  ((longlong)&section_00000068.addr + 4);
                                          iVar6 = 0x17f;
LAB_010c2c13:
                                          pcVar22 = "crypto/x509v3/v3_cpols.c";
                                        ...
                                        if (iVar9 == 0) {
                                          ...
                                          it_00 = (ASN1_ITEM *)
                                                  ((longlong)&segment_command_00000020.vmsize + 1);
                                          iVar6 = 0x189;
                                          goto LAB_010c2c13;
                                        }
                                        iVar8 = iVar8 + 1;
                              ...
                              it_00 = (ASN1_ITEM *)((longlong)&section_00000068.addr + 6);
                              iVar6 = 0x167;
                            }
                          }
                          pcVar22 = "crypto/x509v3/v3_cpols.c";
...
LAB_010c2a80:
            ...
            pcVar22 = "crypto/x509v3/v3_cpols.c";
            it_00 = (ASN1_ITEM *)((longlong)&section_00000068.addr + 3);
