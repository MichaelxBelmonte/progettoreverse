...
void FUN_01536c30(double param_1,undefined8 param_2)

{
  ...
  FUN_016ca840(0,unaff_RSI,&local_68,&local_84);
  lVar7 = local_50;
  if ((((local_48 == '\0') && (local_50 != 0)) && (FUN_00d50b00(), local_48 != '\0')) &&
     (local_50 != 0)) {
    FUN_00d50b20();
  }
  local_60 = DAT_023b4df8 / local_60;
  local_a0 = 0.0;
  iVar13 = 0;
  iVar11 = 0;
  do {
    if (_DAT_0240ed28 < (double)((ulonglong)(local_60 - local_a0) & _DAT_023908f0)) {
...
LAB_015370c0:
    ...
    iStack_8c = (int)((ulonglong)param_2 >> 0x20);
