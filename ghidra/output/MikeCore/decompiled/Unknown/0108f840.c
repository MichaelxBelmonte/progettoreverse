...
void FUN_0108f840(undefined8 param_1,longlong param_2)

{
  ...
  auVar8 = _DAT_0108e5c0;
  auVar7 = _DAT_0108e5a0;
  pauVar1 = unaff_RSI + param_2 * 4;
  uVar9 = *unaff_RDI;
  uVar12 = unaff_RDI[1];
  uVar10 = unaff_RDI[2];
  uVar11 = unaff_RDI[3];
  ...
  uVar18 = unaff_RDI[7];
  do {
    auVar2 = vpshufb_avx(*unaff_RSI,_DAT_0108e580);
    auVar3 = vpshufb_avx(unaff_RSI[1],_DAT_0108e580);
    auVar4 = vpshufb_avx(unaff_RSI[2],_DAT_0108e580);
    local_c0 = vpaddd_avx(auVar2,_DAT_0108e380);
    auVar5 = vpshufb_avx(unaff_RSI[3],_DAT_0108e580);
    local_b0 = vpaddd_avx(auVar3,_DAT_0108e3a0);
    local_a0 = vpaddd_avx(auVar4,_DAT_0108e3c0);
    local_90 = vpaddd_avx(auVar5,_DAT_0108e3e0);
    uVar14 = uVar12 ^ uVar10;
    pauVar13 = (undefined1 (*) [16])&DAT_0108e380;
    do {
      ...
      local_a0 = auVar23;
      local_90 = auVar24;
    } while (*(char *)((longlong)*pauVar6 + 3) != '\0');
    ...
    iVar15 = uVar9 + local_90._12_4_ + ((uVar19 ^ uVar18) & uVar20 ^ uVar18) +
             (uVar21 >> 6 | uVar21 << 0x1a);
    uVar9 = (uVar16 >> 2 | uVar16 << 0x1e) +
            iVar15 + ((uVar10 ^ uVar11) & (uVar12 ^ uVar10) ^ uVar10) + *unaff_RDI;
    unaff_RSI = unaff_RSI + 4;
    uVar12 = uVar12 + unaff_RDI[1];
    uVar10 = uVar10 + unaff_RDI[2];
    uVar11 = uVar11 + unaff_RDI[3];
    uVar21 = uVar14 + iVar15 + unaff_RDI[4];
    uVar20 = uVar20 + unaff_RDI[5];
    uVar19 = uVar19 + unaff_RDI[6];
    uVar18 = uVar18 + unaff_RDI[7];
    *unaff_RDI = uVar9;
    unaff_RDI[1] = uVar12;
    unaff_RDI[2] = uVar10;
    unaff_RDI[3] = uVar11;
