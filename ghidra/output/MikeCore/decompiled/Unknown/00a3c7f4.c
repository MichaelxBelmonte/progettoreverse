...
void FUN_00a3c7f4(undefined8 param_1,undefined8 param_2,char *param_3)

{
  ...
  if (iVar2 != iVar6) {
    ...
    param_3 = 
    "/Users/admin/jenkins/workspace/EdenFiveMacFull/common/paceSources/generated/licenseServices/liblicenseservices/LsCachedObjectVectorSignedInfo.cpp"
    ;
  ...
  if (plVar3 == plVar4) {
LAB_00a3c871:
    if ((plVar16 == plVar4) || ((longlong)plVar16 - (longlong)plVar3 == -8)) goto LAB_00a3c87f;
    lVar17 = (longlong)plVar16 - (longlong)plVar3 >> 3;
  }
  else {
    do {
      if (*plVar16 == *(longlong *)(unaff_RSI + 0x10)) goto LAB_00a3c871;
      plVar16 = plVar16 + 1;
...
LAB_00a3c87f:
  ...
  *(longlong *)((longlong)pvVar11 + 0x18) = lVar9 + lVar17 * 8 + ((longlong)pvVar10 >> 3) * 8;
  ...
  if (lVar12 != lVar9) {
    ...
    if (lVar12 == lVar15) goto LAB_00a3ca06;
  }
  do {
...
LAB_00a3ca06:
  *(longlong *)((longlong)pvVar8 + 0x50) = lVar15;
  ...
  if (plVar4 != (longlong *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00a3ca93. Too many branches */
