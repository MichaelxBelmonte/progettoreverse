...
int FUN_00fbdd80(undefined8 param_1,undefined8 param_2,char *param_3,BN_GENCB *param_4)

{
  ...
  case 0:
    ...
    if (piVar2[2] == 2) {
      param_3 = (char *)0x0;
      iVar3 = _dsa_builtin_paramgen2(0,(longlong)iVar8,0,0,pDVar5,pDVar9,pDVar6);
LAB_00fbdfa0:
      if (0 < iVar3) {
        _BN_GENCB_free();
      ...
      param_3 = (char *)0x0;
      iVar3 = _dsa_builtin_paramgen(0,(longlong)iVar8,0,0);
      goto LAB_00fbdfa0;
    }
    _DSA_free((DSA *)r);
LAB_00fbdfe0:
