...
void FUN_0029f5d0(int param_1,longlong *param_2,uchar *param_3)
...
LAB_0029fcf8:
        ...
        *puVar11 = &DAT_025683c0;
        ...
        if (0 < iVar8) {
          do {
            ...
            iVar9 = _RSA_private_decrypt
                              ((int)pRVar10,puVar12,(uchar *)((longlong)&MACH_HEADER.magic + 1),rsa,
                               siglen);
            if (iVar9 == -1) {
              FUN_00e83070();
              _RSA_free(pRVar13);
        ...
        _RSA_free(pRVar13);
        if (puVar11 == (undefined8 *)0x0) goto LAB_0029fcf8;
        if (*(int *)(puVar11 + 3) == 0x30) {
          ...
          FUN_00c8e340();
          *(undefined1 *)(*(longlong *)(lVar6 + 0x10) + (longlong)iVar8) = 0;
          FUN_00e7b4e0();
          FUN_00c92250();
          lVar7 = local_458;
          if (((local_450 == '\0') && (local_458 != 0)) &&
          ...
          FUN_00c8e340();
          *(undefined1 *)(*(longlong *)(lVar7 + 0x10) + (longlong)iVar8) = 0;
          puVar11 = (undefined8 *)FUN_00e8fc40();
          FUN_00d4ff40();
          *puVar11 = &DAT_025683c0;
          (*pcVar4)();
...
LAB_0029fe4e:
            ...
            if (uVar15 != 0) {
              ...
              do {
                ...
                FUN_00c92190();
                ctx_00 = (EVP_CIPHER_CTX *)(ctx_00->oiv + (longlong)(int)outl + -0x18);
...
LAB_0029fe30:
              *(undefined1 *)(unaff_RDI + 1) = 0;
              *unaff_RDI = 0;
              if (puVar11 != (undefined8 *)0x0) goto LAB_0029fe4e;
            }
            else {
              FUN_00c92190();
              _EVP_CIPHER_CTX_reset();
