...
/* WARNING: Removing unreachable block (ram,0x0098f590) */
/* WARNING: Removing unreachable block (ram,0x0098f5c7) */
...

{
  ...
  lVar1 = unaff_RSI[1];
  psVar7 = local_1c8;
  for (lVar8 = *unaff_RSI; lVar8 != lVar1; lVar8 = lVar8 + 0x18) {
    if (psStack_1c0 == local_1b8) {
      psVar6 = (string *)(((longlong)local_1b8 - (longlong)psVar7 >> 3) * -0x5555555555555555);
      ...
      for (psVar5 = psStack_1c0; psVar5 != psVar7; psVar5 = psVar5 + -0x18) {
        *(undefined8 *)(local_1c8 + -8) = *(undefined8 *)(psVar5 + -8);
        uVar2 = *(undefined8 *)(psVar5 + -0x18);
        *(undefined8 *)(local_1c8 + -0x10) = *(undefined8 *)(psVar5 + -0x10);
        *(undefined8 *)(local_1c8 + -0x18) = uVar2;
