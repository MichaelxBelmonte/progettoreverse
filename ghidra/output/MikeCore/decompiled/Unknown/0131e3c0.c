...
void FUN_0131e3c0(undefined8 param_1,longlong *param_2)

{
  ...
  if (*unaff_RSI != 0) {
    lVar1 = **(longlong **)(unaff_RDI[0x20] + 0x10);
    if (lVar1 != 0) {
      FUN_00d50b00();
    }
    FUN_00c9fe40();
    ...
    *pcVar4 = '\0';
    ...
    if (local_58 != 0) {
      *(int *)(unaff_RDI + 0x1f) = (int)unaff_RDI[0x1f] + *(int *)(local_58 + 0xc);
      local_50[0] = '\0';
      FUN_00d214d0();
      if ((local_50[0] != '\0') && (local_58 != 0)) {
        FUN_00d50b20();
    ...
    lVar1 = *(longlong *)(*(longlong *)(unaff_RDI[0x20] + 0x10) + 8);
    if (lVar1 != 0) {
      FUN_00d50b00();
    }
    FUN_00c9fe40();
  ...
  if (*param_2 != 0) {
    ...
    if (iVar3 < 2) {
      ...
      iVar2 = iVar3 + -1;
      if (*(int *)(unaff_RDI[0x21] + 0xc) < iVar3 + -1) {
        iVar2 = *(int *)(unaff_RDI[0x21] + 0xc);
      }
      iVar5 = iVar2;
      if (0 < iVar2) {
        do {
      ...
      *(int *)(unaff_RDI + 0x1f) = iVar3 - iVar2;
    }
  }
  return;
}
