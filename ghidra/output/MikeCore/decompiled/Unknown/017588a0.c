...
/* WARNING: Removing unreachable block (ram,0x01758c55) */
/* WARNING: Removing unreachable block (ram,0x01758c5e) */
/* WARNING: Removing unreachable block (ram,0x01758a67) */
/* WARNING: Removing unreachable block (ram,0x01758a70) */

ulonglong FUN_017588a0(ulonglong param_1)

{
  ...
  uVar3 = *(ulonglong *)(unaff_RDI + 0x58);
  if (uVar3 != 0) {
    FUN_00d50b00();
  }
  ...
  if (cVar5 != '\0') {
    ...
    if (cVar5 == '\0') {
      ...
      local_58 = iVar1;
      do {
        pvVar9 = _pthread_getspecific((pthread_key_t)uVar14);
...
LAB_01758c70:
            ...
            if (cVar5 == '\0') {
              ...
              lVar20 = (longlong)(int)uVar17 + -lVar10;
              unaff_R12 = local_50;
              do {
                pvVar9 = _pthread_getspecific((pthread_key_t)uVar14);
                ...
                if (iVar8 <= lVar20) {
                  uVar4 = CONCAT71((int7)((ulonglong)uVar13 >> 8),lVar11 < iVar8) & 0xffffffff;
                  uVar18 = unaff_R12;
                ...
                FUN_01736e70();
                uVar18 = *(ulonglong *)(*(longlong *)(local_50 + 0x10) + lVar11 * 8);
                if (unaff_R12 != uVar18) {
                  if (uVar18 != 0) {
                    FUN_00d50b00();
                  }
