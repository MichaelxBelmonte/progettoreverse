...
undefined8 FUN_00fbb700(char *param_1,longlong param_2,undefined8 param_3,EVP_MD *param_4)

{
  ...
  if (unaff_ESI == 8) {
    *(undefined4 *)&((EVP_CIPHER_CTX *)param_1)->cipher = 1;
    return 1;
  }
  if (unaff_ESI != 7) {
    return 0xfffffffe;
    ...
    if (iVar1 != 0) {
      ...
      if (local_58 == pAVar9) {
        ...
        if (pAVar13 != (ASN1_INTEGER *)0x0) {
          ...
          if (0 < (int)uVar4) {
            _ASN1_STRING_set0((ASN1_STRING *)ctx,(void *)(ulonglong)uVar4,iVar1);
            uVar15 = *(ulonglong *)&local_50->encrypt & 0xfffffffffffffff0 | 8;
            *(ulonglong *)&local_50->encrypt = uVar15;
            local_40 = 0;
...
LAB_00fbb9c8:
        ctx = (char *)((longlong)&dylib_command_00000ff0.dylib.compatibility_version + 2);
        ...
        if (0 < iVar1) {
          ...
          if (iVar3 != 0) {
            ...
            if (local_60 == (EVP_MD *)0x0) {
              local_60 = _EVP_sha1();
              ctx = (char *)((longlong)&dylib_command_00000ff0.dylib.compatibility_version + 3);
...
LAB_00fbc006:
                    ...
                    if (0 < iVar1) {
                      ...
                      if (local_68 == (DH *)0x0) {
                        ...
                        ctx = (char *)((longlong)&section_00000338.offset + 2);
                      ...
                      if ((local_40 != 0) && (uVar4 != 0)) {
                        ...
                        if ((EVP_CIPHER_CTX *)ctx != (EVP_CIPHER_CTX *)0x0) {
                          _ASN1_STRING_set0((ASN1_STRING *)str,(void *)(ulonglong)uVar4,iVar1);
                          local_40 = 0;
...
LAB_00fbb765:
    ...
    if (iVar1 == 0xf5) {
      param_1 = (char *)((longlong)&dylib_command_00000ff0.dylib.compatibility_version + 2);
      param_4 = (EVP_MD *)0x0;
...
LAB_00fbba93:
      ...
      param_4 = _EVP_sha1();
      param_1 = (char *)((longlong)&dylib_command_00000ff0.dylib.compatibility_version + 3);
      len = 0;
      ...
      pXVar6 = _d2i_X509_ALGOR((X509_ALGOR **)param_1,(uchar **)(longlong)*piVar10,len);
      ...
      if (local_58 == (ASN1_OBJECT *)0x0) {
        ...
        _ASN1_STRING_get0_data();
        param_1 = (char *)((longlong)&section_00000298.flags + 2);
