...
undefined2 FUN_009fa172(byte *param_1,longlong *param_2,byte *param_3)
...
LAB_009fa40f:
        ...
        *(undefined8 *)(param_3 + 0x10) = local_68;
        *(undefined8 *)(param_3 + 8) = local_70;
        *(ulonglong *)param_3 = CONCAT62(uStack_76,local_78);
        local_78 = 0;
