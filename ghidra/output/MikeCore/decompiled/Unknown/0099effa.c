...
//   "virtual void pace::ILok2Commander::AuthEx(const CMD_CmmdPayload_AuthEx_Struct &, const vector<uint8...


void FUN_0099effa(undefined8 param_1,undefined8 param_2,void *param_3)

{
  ...
  if (unaff_RDI[7] == 0) {
    FUN_00925fd0();
    uVar1 = FUN_00926010();
    uVar3 = FUN_00928ab0("virtual void pace::ILok2Commander::AuthEx(const CMD_CmmdPayload_AuthEx_Struct &, const vector<uint8_t> &, CMD_RsltPayload_AuthEx_Struct &, vector<uint8_t> &)"
                         ,0x956);
    FUN_009c720b(uVar3,uVar1);
  }
  uVar3 = (**(code **)(*unaff_RDI + 0x168))(&local_118,local_58);
  (**(code **)(*(longlong *)unaff_RDI[7] + 0x10))(uVar3,&local_280);
  (**(code **)(*unaff_RDI + 600))(0,0,param_1,&local_48);
  pvVar2 = local_50;
  (**(code **)(*unaff_RDI + 0x170))(local_50,&local_48);
  if (local_48 != 0) {
    lStack_40 = local_48;
