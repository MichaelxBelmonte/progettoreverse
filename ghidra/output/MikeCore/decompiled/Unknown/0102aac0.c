...
ulonglong FUN_0102aac0(ulonglong param_1,EVP_CIPHER_CTX *param_2,size_t param_3,void *param_4)
...
LAB_0102ab83:
  *(undefined4 *)(lVar2 + 0x11c) = 0;
  *(undefined4 *)(lVar2 + 0x2ec) = 0xffffffff;
  return uVar3;
}
