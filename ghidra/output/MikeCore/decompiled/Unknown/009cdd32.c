...

{
  ...
  while (FUN_00ac92d0(), 1 < CONCAT22(uStack_56,CONCAT11(uStack_57,local_58))) {
    FUN_00ac9e20();
    pvVar2 = (void *)((ulonglong)local_60 ^ (ulonglong)local_38 | local_68 ^ local_40);
    if ((local_58 & 1) != 0) {
  ...
  *(undefined8 *)(unaff_RDI + 0x10) = local_48;
  *(void **)(unaff_RDI + 8) = local_50;
  *(ulonglong *)unaff_RDI = CONCAT44(uStack_54,CONCAT22(uStack_56,CONCAT11(uStack_57,local_58)));
  local_58 = 0;
  uStack_57 = 0;
  pvVar2 = local_50;
  if ((local_b0[0] & 1) != 0) {
