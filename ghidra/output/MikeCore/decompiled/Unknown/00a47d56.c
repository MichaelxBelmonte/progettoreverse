...
//   "void license_services::LsEntityUtilsAuthRelation::add(license_services::LsAuthRelationWire &)"


void FUN_00a47d56(void)

{
  ...
  if (lVar4 != -1) {
    ...
    FUN_00983230();
    FUN_00983230();
    FUN_00928ab0("void license_services::LsEntityUtilsAuthRelation::add(license_services::LsAuthRelationWire &)"
                 ,0x68);
    FUN_009c78cb();
  }
  FUN_009b4be0();
  ...
  if (lVar7 == *(longlong *)(lVar4 + 0x58)) {
    lVar7 = (lVar7 - *(longlong *)(lVar4 + 0x48) >> 4) * 0x2e8ba2e8ba2e8ba3;
    if (0x1745d1745d1745d < lVar7 + 1U) {
                    /* WARNING: Subroutine does not return */
      std::__vector_base_common<true>::__throw_length_error();
    }
    FUN_00a483f0(lVar4 + 0x58,lVar7);
    FUN_00a6cb80();
    FUN_00a48360();
    FUN_00a48460();
  }
    ...
    FUN_00a6cb80();
    *(longlong *)(lVar4 + 0x50) = lVar7 + 0xb0;
  }
  return;
}
