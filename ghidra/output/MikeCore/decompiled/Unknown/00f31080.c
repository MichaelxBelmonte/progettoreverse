...
byte * FUN_00f31080(char *param_1,undefined8 *param_2)

{
  ...
  if (param_2 != (undefined8 *)0x0) {
    FUN_00f2fb40(extraout_XMM0_Da,(ulonglong)param_1 & 0xffffffff);
        ...
        do {
          ...
          if (((bVar3 < 0x7f) && ((PTR___DefaultRuneLocale_0249c238[uVar7 * 4 + 0x3d] & 5) == 0)) &&
             ((uVar15 = (int)uVar7 - 0x2d, 0x32 < (byte)uVar15 ||
              ((0x4000000002003U >> ((ulonglong)(uVar15 & 0xff) & 0x3f) & 1) == 0))))
          goto LAB_00f31270;
          pbVar1 = pbVar10 + 1;
          uVar7 = (ulonglong)*pbVar1;
          pbVar10 = pbVar10 + 1;
        } while (*pbVar1 != 0);
        bVar3 = 0;
LAB_00f31270:
        if (0 < (longlong)pbVar10 - (longlong)pbVar6) {
          FUN_00f2d870();
          bVar3 = *pbVar10;
        }
        if (bVar3 != 0) {
          ...
          *puVar8 = 2;
          *(undefined1 *)((longlong)puVar8 + 0x12) = 0;
          puVar8[1] = 2;
          *(undefined2 *)(puVar8 + 2) = 0x2f3c;
          FUN_00f2d920();
          while (*pbVar10 != 0) {
            pcVar4 = (char *)FUN_00f2fd80();
            if (pcVar4 == (char *)0x0) {
LAB_00f31429:
              ...
              *(undefined1 *)(lVar5 + 0x50) = 1;
              *(undefined4 *)(lVar5 + 0x54) = 6;
              _strlen(pcVar13);
              uVar17 = FUN_00f2d870();
              *(undefined8 *)(lVar5 + 100) = 0xffffffffffffffff;
              if (param_2 == (undefined8 *)0x0) goto LAB_00f31761;
            ...
            cVar2 = *pcVar4;
            if (cVar2 == '>') {
              pcVar13 = (char *)((ulonglong)param_1 & 0xffffffff);
            ...
            plVar9[1] = -1;
            plVar9[2] = 0;
            *plVar9 = (longlong)&DAT_02593b58;
            plVar9[4] = (longlong)&DAT_02802e90;
            plVar9[5] = (longlong)&DAT_02802e90;
            plVar9[6] = 0;
            plVar9[7] = 0;
            plVar9[3] = lVar5;
            pcVar13 = (char *)((ulonglong)param_1 & 0xffffffff);
    ...
    *(undefined8 *)(lVar5 + 100) = 0xffffffffffffffff;
    ...
    FUN_00f2fb40(uVar16,(ulonglong)param_1 & 0xffffffff);
    uVar12 = *param_2;
  }
  else {
    if (lVar5 == 0) {
  ...
  *(undefined8 *)(lVar5 + 100) = uVar12;
  return (byte *)0x0;
  while( true ) {
    cVar2 = (pcVar4 + 1)[(longlong)pcVar13];
    pcVar13 = pcVar13 + 1;
    if (cVar2 == '\0') break;
LAB_00f31550:
    cVar14 = *(char *)((longlong)(puVar8 + 2) + (longlong)pcVar13);
...
LAB_00f316bd:
      *(undefined8 *)(lVar5 + 100) = 0xffffffffffffffff;
      pbVar10 = (byte *)0x0;
      if ((pcVar4 == (char *)0x0) || (pbVar10 = (byte *)0x0, param_2 == (undefined8 *)0x0))
      goto LAB_00f31763;
      FUN_00f2fb40(uVar17,uVar16);
      uVar12 = *param_2;
      goto LAB_00f3175c;
...
LAB_00f31761:
  pbVar10 = (byte *)0x0;
LAB_00f31763:
  if ((puVar8 != (undefined8 *)PTR_DAT_0249c250) && (puVar8 != (undefined8 *)0x0)) {
