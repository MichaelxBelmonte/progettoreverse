...
/* WARNING: Removing unreachable block (ram,0x0185ec8e) */
/* WARNING: Removing unreachable block (ram,0x0185ec97) */

longlong * FUN_0185ebf0(longlong *param_1,int param_2,int param_3,int param_4)

{
  ...
  if (param_4 != 0) {
    ...
    if (0 < iVar9) {
      local_34 = DAT_02390124 / (float)iVar9;
    }
  }
  FUN_00c8e690();
  ...
  if (unaff_ESI < param_2) {
    lVar11 = (longlong)unaff_ESI;
    local_38 = (char)param_4;
    if (local_38 == '\0') {
      lVar5 = *(longlong *)(*param_1 + 0x10);
      pauVar10 = *(undefined1 (**) [16])(local_48 + 0x10);
      ...
      do {
        pfVar4 = *(float **)(*(longlong *)(lVar5 + lVar11 * 8) + 0x10);
        fVar1 = *pfVar4;
      ...
      do {
        ...
        fVar14 = DAT_02390124 - (float)iVar9 * local_34;
        fVar30 = 0.0;
        if (0.0 <= fVar14) {
          fVar30 = fVar14;
        }
        fVar12 = (float)FUN_00e84a50(fVar30);
        pfVar4 = *(float **)(*(longlong *)(*(longlong *)(*param_1 + 0x10) + lVar11 * 8) + 0x10);
        pauVar10 = *(undefined1 (**) [16])(local_48 + 0x10);
        fVar30 = *pfVar4;
