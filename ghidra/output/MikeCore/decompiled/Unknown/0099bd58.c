...
//   "virtual void pace::ILok2Commander::GetAuthRecord(const CMD_CmmdPayload_GetAuthRecord_Struct &, CMD_...


void FUN_0099bd58(undefined8 param_1,undefined8 param_2)

{
  ...
  if (unaff_RDI[7] == 0) {
    FUN_00925fd0();
    uVar1 = FUN_00926010();
    uVar3 = FUN_00928ab0("virtual void pace::ILok2Commander::GetAuthRecord(const CMD_CmmdPayload_GetAuthRecord_Struct &, CMD_RsltPayload_GetAuthRecord_Struct &)"
                         ,0x5f1);
    uVar3 = FUN_009c720b(uVar3,uVar1);
  }
  uVar3 = (**(code **)(*unaff_RDI + 0xd0))(uVar3,&local_108);
