...
void FUN_01095980(undefined8 param_1,longlong param_2)

{
  ...
  uVar8 = (ulonglong)auStack_550 & 0xfffffffffffff800;
  pauVar1 = (undefined1 (*) [32])(unaff_RSI + param_2 * 0x80);
  pauVar9 = (undefined1 (*) [32])(uVar8 + 0x480);
  *(longlong **)(uVar8 + 0x500) = unaff_RDI;
  *(longlong *)(uVar8 + 0x508) = unaff_RSI;
  *(undefined1 (**) [32])(uVar8 + 0x510) = pauVar1;
  *(BADSPACEBASE **)(uVar8 + 0x518) = register0x00000020;
  pauVar11 = (undefined1 (*) [32])(unaff_RSI + 0x80);
  lVar4 = *unaff_RDI;
  uVar7 = unaff_RDI[1];
  uVar5 = unaff_RDI[2];
  pauVar17 = pauVar11;
  ...
  do {
    ...
    auVar23 = vpshufb_avx2(auVar19,_DAT_010937c0);
    auVar21._0_16_ =
    ...
    auVar25 = vpshufb_avx2(auVar20,_DAT_010937c0);
    auVar22._0_16_ =
    ...
    auVar26 = vpshufb_avx2(auVar21,_DAT_010937c0);
    auVar28._0_16_ =
    ...
    auVar27 = vpshufb_avx2(auVar22,_DAT_010937c0);
    auVar29._0_16_ =
    ...
    auVar28 = vpshufb_avx2(auVar28,_DAT_010937c0);
    auVar30._0_16_ =
    ...
    auVar29 = vpshufb_avx2(auVar29,_DAT_010937c0);
    auVar31._0_16_ =
    ...
    auVar19 = vpaddq_avx2(auVar23,_DAT_010932c0);
    auVar30 = vpshufb_avx2(auVar30,_DAT_010937c0);
    auVar20 = vpaddq_avx2(auVar25,_DAT_010932e0);
    auVar31 = vpshufb_avx2(auVar31,_DAT_010937c0);
    auVar21 = vpaddq_avx2(auVar26,_DAT_01093300);
    auVar22 = vpaddq_avx2(auVar27,_DAT_01093320);
    *pauVar9 = auVar19;
    auVar19 = vpaddq_avx2(auVar28,_DAT_01093340);
    pauVar9[1] = auVar20;
    auVar20 = vpaddq_avx2(auVar29,_DAT_01093360);
    pauVar9[2] = auVar21;
    auVar21 = vpaddq_avx2(auVar30,_DAT_01093380);
    pauVar9[3] = auVar22;
    *(undefined8 *)(pauVar9[-5] + 0x18) = *(undefined8 *)(pauVar9[4] + 0x18);
    auVar22 = vpaddq_avx2(auVar31,_DAT_010933a0);
    pauVar9[-4] = auVar19;
    uVar18 = 0;
    pauVar9[-3] = auVar20;
    pauVar9[-2] = auVar21;
    ...
    pauVar9[-1] = auVar22;
    pauVar1 = pauVar9 + -4;
    pauVar9 = (undefined1 (*) [32])&DAT_01093440;
    do {
      pauVar10 = pauVar1;
      *(undefined8 *)(pauVar10[-5] + 0x18) = *(undefined8 *)(pauVar10[-1] + 0x18);
      ...
      lVar4 = uVar16 + *(longlong *)pauVar10[4] + (uVar14 & uVar13) + (~uVar13 & uVar15) +
      ...
      lVar4 = uVar15 + *(longlong *)(pauVar10[4] + 8) + (uVar13 & uVar6) + (~uVar6 & uVar14) +
      ...
      auVar32 = vpsrlq_avx2(auVar20,7);
      auVar20 = vpsllq_avx2(auVar20,0x38);
      lVar4 = uVar14 + *(longlong *)pauVar10[5] + (uVar6 & uVar5) + (~uVar5 & uVar13) +
      ...
      auVar22 = vpsllq_avx2(auVar24,0x2a);
      auVar21 = vpsrlq_avx2(auVar20,0x2a);
      lVar4 = uVar13 + *(longlong *)(pauVar10[5] + 8) + (uVar5 & uVar7) + (~uVar7 & uVar6) +
      ...
      auVar32 = vpsrlq_avx2(auVar20,7);
      auVar20 = vpsllq_avx2(auVar20,0x38);
      lVar4 = uVar6 + *(longlong *)pauVar10[6] + (uVar7 & uVar18) + (~uVar18 & uVar5) +
      ...
      auVar22 = vpsllq_avx2(auVar24,0x2a);
      auVar21 = vpsrlq_avx2(auVar20,0x2a);
      lVar4 = uVar5 + *(longlong *)(pauVar10[6] + 8) + (uVar18 & uVar16) + (~uVar16 & uVar7) +
      ...
      auVar32 = vpsrlq_avx2(auVar20,7);
      auVar20 = vpsllq_avx2(auVar20,0x38);
      lVar4 = uVar7 + *(longlong *)pauVar10[7] + (uVar16 & uVar15) + (~uVar15 & uVar18) +
      ...
      auVar22 = vpsllq_avx2(auVar24,0x2a);
      auVar21 = vpsrlq_avx2(auVar20,0x2a);
      lVar4 = uVar18 + *(longlong *)(pauVar10[7] + 8) + (uVar15 & uVar14) + (~uVar14 & uVar16) +
      ...
      *(undefined8 *)(pauVar10[-9] + 0x18) = *(undefined8 *)(pauVar10[-5] + 0x18);
      ...
      auVar32 = vpsrlq_avx2(auVar20,7);
      auVar20 = vpsllq_avx2(auVar20,0x38);
      lVar4 = uVar16 + *(longlong *)*pauVar10 + (uVar14 & uVar13) + (~uVar13 & uVar15) +
      ...
      auVar22 = vpsllq_avx2(auVar24,0x2a);
      auVar21 = vpsrlq_avx2(auVar20,0x2a);
      lVar4 = uVar15 + *(longlong *)(*pauVar10 + 8) + (uVar13 & uVar6) + (~uVar6 & uVar14) +
              ((uVar6 >> 0x29 | uVar6 * 0x800000) ^ (uVar6 >> 0x12 | uVar6 << 0x2e) ^
              (uVar6 >> 0xe | uVar6 << 0x32));
      ...
      *pauVar1 = auVar19;
      ...
      auVar32 = vpsrlq_avx2(auVar20,7);
      auVar20 = vpsllq_avx2(auVar20,0x38);
      lVar4 = uVar14 + *(longlong *)pauVar10[1] + (uVar6 & uVar5) + (~uVar5 & uVar13) +
              ((uVar5 >> 0x29 | uVar5 * 0x800000) ^ (uVar5 >> 0x12 | uVar5 << 0x2e) ^
              (uVar5 >> 0xe | uVar5 << 0x32));
      ...
      auVar22 = vpsllq_avx2(auVar24,0x2a);
      auVar21 = vpsrlq_avx2(auVar20,0x2a);
      lVar4 = uVar13 + *(longlong *)(pauVar10[1] + 8) + (uVar5 & uVar7) + (~uVar7 & uVar6) +
              ((uVar7 >> 0x29 | uVar7 * 0x800000) ^ (uVar7 >> 0x12 | uVar7 << 0x2e) ^
              (uVar7 >> 0xe | uVar7 << 0x32));
      ...
      auVar32 = vpsrlq_avx2(auVar20,7);
      auVar20 = vpsllq_avx2(auVar20,0x38);
      lVar4 = uVar6 + *(longlong *)pauVar10[2] + (uVar7 & uVar18) + (~uVar18 & uVar5) +
              ((uVar18 >> 0x29 | uVar18 * 0x800000) ^ (uVar18 >> 0x12 | uVar18 << 0x2e) ^
              (uVar18 >> 0xe | uVar18 << 0x32));
      ...
      auVar22 = vpsllq_avx2(auVar24,0x2a);
      auVar21 = vpsrlq_avx2(auVar20,0x2a);
      lVar4 = uVar5 + *(longlong *)(pauVar10[2] + 8) + (uVar18 & uVar16) + (~uVar16 & uVar7) +
              ((uVar16 >> 0x29 | uVar16 * 0x800000) ^ (uVar16 >> 0x12 | uVar16 << 0x2e) ^
              (uVar16 >> 0xe | uVar16 << 0x32));
      ...
      auVar32 = vpsrlq_avx2(auVar20,7);
      auVar20 = vpsllq_avx2(auVar20,0x38);
      lVar4 = uVar7 + *(longlong *)pauVar10[3] + (uVar16 & uVar15) + (~uVar15 & uVar18) +
              ((uVar15 >> 0x29 | uVar15 * 0x800000) ^ (uVar15 >> 0x12 | uVar15 << 0x2e) ^
              (uVar15 >> 0xe | uVar15 << 0x32));
      ...
      auVar22 = vpsllq_avx2(auVar24,0x2a);
      auVar21 = vpsrlq_avx2(auVar20,0x2a);
      lVar4 = uVar18 + *(longlong *)(pauVar10[3] + 8) + (uVar15 & uVar14) + (~uVar14 & uVar16) +
              ((uVar14 >> 0x29 | uVar14 * 0x800000) ^ (uVar14 >> 0x12 | uVar14 << 0x2e) ^
              (uVar14 >> 0xe | uVar14 << 0x32));
      uVar12 = uVar7 ^ uVar5;
      ...
      pauVar17 = pauVar9 + 4;
      pauVar9 = pauVar9 + 8;
    } while (*(char *)((longlong)*pauVar17 + 7) != '\0');
    uVar18 = lVar4 + uVar18;
    lVar4 = uVar16 + *(longlong *)pauVar10[-4] + (uVar14 & uVar13) + (~uVar13 & uVar15) +
            ((uVar13 >> 0x29 | uVar13 * 0x800000) ^ (uVar13 >> 0x12 | uVar13 << 0x2e) ^
            (uVar13 >> 0xe | uVar13 << 0x32));
    ...
    uVar15 = lVar4 + ((uVar18 ^ uVar7) & (uVar16 ^ uVar18) ^ uVar18) +
             ((uVar16 >> 0x22 | uVar16 * 0x40000000) ^ (uVar16 >> 0x27 | uVar16 * 0x2000000) ^
             (uVar16 >> 0x1c | uVar16 << 0x24));
    lVar4 = uVar14 + *(longlong *)pauVar10[-3] + (uVar6 & uVar5) + (~uVar5 & uVar13) +
            ((uVar5 >> 0x29 | uVar5 * 0x800000) ^ (uVar5 >> 0x12 | uVar5 << 0x2e) ^
            (uVar5 >> 0xe | uVar5 << 0x32));
    uVar7 = uVar7 + lVar4;
    uVar14 = lVar4 + ((uVar16 ^ uVar18) & (uVar15 ^ uVar16) ^ uVar16) +
             ((uVar15 >> 0x22 | uVar15 * 0x40000000) ^ (uVar15 >> 0x27 | uVar15 * 0x2000000) ^
             (uVar15 >> 0x1c | uVar15 << 0x24));
    lVar4 = uVar13 + *(longlong *)(pauVar10[-3] + 8) + (uVar5 & uVar7) + (~uVar7 & uVar6) +
            ((uVar7 >> 0x29 | uVar7 * 0x800000) ^ (uVar7 >> 0x12 | uVar7 << 0x2e) ^
            (uVar7 >> 0xe | uVar7 << 0x32));
    uVar18 = uVar18 + lVar4;
    uVar13 = lVar4 + ((uVar15 ^ uVar16) & (uVar14 ^ uVar15) ^ uVar15) +
    ...
    uVar5 = lVar4 + ((uVar13 ^ uVar14) & (uVar6 ^ uVar13) ^ uVar13) +
            ((uVar6 >> 0x22 | uVar6 * 0x40000000) ^ (uVar6 >> 0x27 | uVar6 * 0x2000000) ^
            (uVar6 >> 0x1c | uVar6 << 0x24));
    lVar4 = uVar7 + *(longlong *)pauVar10[-1] + (uVar16 & uVar15) + (~uVar15 & uVar18) +
            ((uVar15 >> 0x29 | uVar15 * 0x800000) ^ (uVar15 >> 0x12 | uVar15 << 0x2e) ^
            (uVar15 >> 0xe | uVar15 << 0x32));
    uVar14 = uVar14 + lVar4;
    uVar7 = lVar4 + ((uVar6 ^ uVar13) & (uVar5 ^ uVar6) ^ uVar6) +
            ((uVar5 >> 0x22 | uVar5 * 0x40000000) ^ (uVar5 >> 0x27 | uVar5 * 0x2000000) ^
            (uVar5 >> 0x1c | uVar5 << 0x24));
    lVar4 = uVar18 + *(longlong *)(pauVar10[-1] + 8) + (uVar15 & uVar14) + (~uVar14 & uVar16) +
            ((uVar14 >> 0x29 | uVar14 * 0x800000) ^ (uVar14 >> 0x12 | uVar14 << 0x2e) ^
            (uVar14 >> 0xe | uVar14 << 0x32));
    uVar13 = uVar13 + lVar4;
    uVar18 = lVar4 + ((uVar5 ^ uVar6) & (uVar7 ^ uVar5) ^ uVar5) +
             ((uVar7 >> 0x22 | uVar7 * 0x40000000) ^ (uVar7 >> 0x27 | uVar7 * 0x2000000) ^
             (uVar7 >> 0x1c | uVar7 << 0x24));
    lVar4 = uVar16 + *(longlong *)*pauVar1 + (uVar14 & uVar13) + (~uVar13 & uVar15) +
            ((uVar13 >> 0x29 | uVar13 * 0x800000) ^ (uVar13 >> 0x12 | uVar13 << 0x2e) ^
            (uVar13 >> 0xe | uVar13 << 0x32));
    uVar6 = uVar6 + lVar4;
    uVar16 = lVar4 + ((uVar7 ^ uVar5) & (uVar18 ^ uVar7) ^ uVar7) +
             ((uVar18 >> 0x22 | uVar18 * 0x40000000) ^ (uVar18 >> 0x27 | uVar18 * 0x2000000) ^
             (uVar18 >> 0x1c | uVar18 << 0x24));
    lVar4 = uVar15 + *(longlong *)(pauVar10[-8] + 8) + (uVar13 & uVar6) + (~uVar6 & uVar14) +
            ((uVar6 >> 0x29 | uVar6 * 0x800000) ^ (uVar6 >> 0x12 | uVar6 << 0x2e) ^
            (uVar6 >> 0xe | uVar6 << 0x32));
    uVar5 = uVar5 + lVar4;
    uVar15 = lVar4 + ((uVar18 ^ uVar7) & (uVar16 ^ uVar18) ^ uVar18) +
             ((uVar16 >> 0x22 | uVar16 * 0x40000000) ^ (uVar16 >> 0x27 | uVar16 * 0x2000000) ^
             (uVar16 >> 0x1c | uVar16 << 0x24));
    lVar4 = uVar14 + *(longlong *)pauVar10[-7] + (uVar6 & uVar5) + (~uVar5 & uVar13) +
            ((uVar5 >> 0x29 | uVar5 * 0x800000) ^ (uVar5 >> 0x12 | uVar5 << 0x2e) ^
            (uVar5 >> 0xe | uVar5 << 0x32));
    uVar7 = uVar7 + lVar4;
    uVar14 = lVar4 + ((uVar16 ^ uVar18) & (uVar15 ^ uVar16) ^ uVar16) +
             ((uVar15 >> 0x22 | uVar15 * 0x40000000) ^ (uVar15 >> 0x27 | uVar15 * 0x2000000) ^
             (uVar15 >> 0x1c | uVar15 << 0x24));
    lVar4 = uVar13 + *(longlong *)(pauVar10[-7] + 8) + (uVar5 & uVar7) + (~uVar7 & uVar6) +
            ((uVar7 >> 0x29 | uVar7 * 0x800000) ^ (uVar7 >> 0x12 | uVar7 << 0x2e) ^
            (uVar7 >> 0xe | uVar7 << 0x32));
    uVar18 = uVar18 + lVar4;
    uVar13 = lVar4 + ((uVar15 ^ uVar16) & (uVar14 ^ uVar15) ^ uVar15) +
    ...
    uVar5 = lVar4 + ((uVar13 ^ uVar14) & (uVar6 ^ uVar13) ^ uVar13) +
            ((uVar6 >> 0x22 | uVar6 * 0x40000000) ^ (uVar6 >> 0x27 | uVar6 * 0x2000000) ^
            (uVar6 >> 0x1c | uVar6 << 0x24));
    lVar4 = uVar7 + *(longlong *)pauVar10[-5] + (uVar16 & uVar15) + (~uVar15 & uVar18) +
            ((uVar15 >> 0x29 | uVar15 * 0x800000) ^ (uVar15 >> 0x12 | uVar15 << 0x2e) ^
            (uVar15 >> 0xe | uVar15 << 0x32));
    uVar14 = uVar14 + lVar4;
    uVar7 = lVar4 + ((uVar6 ^ uVar13) & (uVar5 ^ uVar6) ^ uVar6) +
            ((uVar5 >> 0x22 | uVar5 * 0x40000000) ^ (uVar5 >> 0x27 | uVar5 * 0x2000000) ^
            (uVar5 >> 0x1c | uVar5 << 0x24));
    lVar4 = uVar18 + *(longlong *)(pauVar10[-5] + 8) + (uVar15 & uVar14) + (~uVar14 & uVar16) +
            ((uVar14 >> 0x29 | uVar14 * 0x800000) ^ (uVar14 >> 0x12 | uVar14 << 0x2e) ^
            (uVar14 >> 0xe | uVar14 << 0x32));
    plVar2 = *(longlong **)pauVar10[0x20];
    ...
    *plVar2 = lVar3;
    ...
    do {
      uVar18 = lVar3 + uVar18;
      lVar4 = uVar16 + *(longlong *)(*pauVar9 + 0x10) + (uVar14 & uVar13) + (~uVar13 & uVar15) +
              ((uVar13 >> 0x29 | uVar13 << 0x17) ^ (uVar13 >> 0x12 | uVar13 << 0x2e) ^
              (uVar13 >> 0xe | uVar13 << 0x32));
      uVar6 = uVar6 + lVar4;
      uVar16 = lVar4 + (uVar12 & (uVar18 ^ uVar7) ^ uVar7) +
               ((uVar18 >> 0x22 | uVar18 * 0x40000000) ^ (uVar18 >> 0x27 | uVar18 * 0x2000000) ^
               (uVar18 >> 0x1c | uVar18 << 0x24));
      lVar4 = uVar15 + *(longlong *)(*pauVar9 + 0x18) + (uVar13 & uVar6) + (~uVar6 & uVar14) +
              ((uVar6 >> 0x29 | uVar6 * 0x800000) ^ (uVar6 >> 0x12 | uVar6 << 0x2e) ^
              (uVar6 >> 0xe | uVar6 << 0x32));
      uVar5 = uVar5 + lVar4;
      uVar15 = lVar4 + ((uVar18 ^ uVar7) & (uVar16 ^ uVar18) ^ uVar18) +
               ((uVar16 >> 0x22 | uVar16 * 0x40000000) ^ (uVar16 >> 0x27 | uVar16 * 0x2000000) ^
               (uVar16 >> 0x1c | uVar16 << 0x24));
      lVar4 = uVar14 + *(longlong *)(pauVar9[1] + 0x10) + (uVar6 & uVar5) + (~uVar5 & uVar13) +
              ((uVar5 >> 0x29 | uVar5 * 0x800000) ^ (uVar5 >> 0x12 | uVar5 << 0x2e) ^
              (uVar5 >> 0xe | uVar5 << 0x32));
      uVar7 = uVar7 + lVar4;
      uVar14 = lVar4 + ((uVar16 ^ uVar18) & (uVar15 ^ uVar16) ^ uVar16) +
               ((uVar15 >> 0x22 | uVar15 * 0x40000000) ^ (uVar15 >> 0x27 | uVar15 * 0x2000000) ^
               (uVar15 >> 0x1c | uVar15 << 0x24));
      lVar4 = uVar13 + *(longlong *)(pauVar9[1] + 0x18) + (uVar5 & uVar7) + (~uVar7 & uVar6) +
              ((uVar7 >> 0x29 | uVar7 * 0x800000) ^ (uVar7 >> 0x12 | uVar7 << 0x2e) ^
              (uVar7 >> 0xe | uVar7 << 0x32));
      uVar18 = uVar18 + lVar4;
      uVar13 = lVar4 + ((uVar15 ^ uVar16) & (uVar14 ^ uVar15) ^ uVar15) +
               ((uVar14 >> 0x22 | uVar14 * 0x40000000) ^ (uVar14 >> 0x27 | uVar14 * 0x2000000) ^
               (uVar14 >> 0x1c | uVar14 << 0x24));
      lVar4 = uVar6 + *(longlong *)(pauVar9[2] + 0x10) + (uVar7 & uVar18) + (~uVar18 & uVar5) +
              ((uVar18 >> 0x29 | uVar18 * 0x800000) ^ (uVar18 >> 0x12 | uVar18 << 0x2e) ^
              (uVar18 >> 0xe | uVar18 << 0x32));
      uVar16 = uVar16 + lVar4;
      uVar6 = lVar4 + ((uVar14 ^ uVar15) & (uVar13 ^ uVar14) ^ uVar14) +
              ((uVar13 >> 0x22 | uVar13 * 0x40000000) ^ (uVar13 >> 0x27 | uVar13 * 0x2000000) ^
              (uVar13 >> 0x1c | uVar13 << 0x24));
      lVar4 = uVar5 + *(longlong *)(pauVar9[2] + 0x18) + (uVar18 & uVar16) + (~uVar16 & uVar7) +
              ((uVar16 >> 0x29 | uVar16 * 0x800000) ^ (uVar16 >> 0x12 | uVar16 << 0x2e) ^
              (uVar16 >> 0xe | uVar16 << 0x32));
      uVar15 = uVar15 + lVar4;
      uVar5 = lVar4 + ((uVar13 ^ uVar14) & (uVar6 ^ uVar13) ^ uVar13) +
              ((uVar6 >> 0x22 | uVar6 * 0x40000000) ^ (uVar6 >> 0x27 | uVar6 * 0x2000000) ^
              (uVar6 >> 0x1c | uVar6 << 0x24));
      lVar4 = uVar7 + *(longlong *)(pauVar9[3] + 0x10) + (uVar16 & uVar15) + (~uVar15 & uVar18) +
              ((uVar15 >> 0x29 | uVar15 * 0x800000) ^ (uVar15 >> 0x12 | uVar15 << 0x2e) ^
              (uVar15 >> 0xe | uVar15 << 0x32));
      uVar14 = uVar14 + lVar4;
      uVar7 = lVar4 + ((uVar6 ^ uVar13) & (uVar5 ^ uVar6) ^ uVar6) +
              ((uVar5 >> 0x22 | uVar5 * 0x40000000) ^ (uVar5 >> 0x27 | uVar5 * 0x2000000) ^
              (uVar5 >> 0x1c | uVar5 << 0x24));
      lVar3 = uVar18 + *(longlong *)(pauVar9[3] + 0x18) + (uVar15 & uVar14) + (~uVar14 & uVar16) +
              ((uVar14 >> 0x29 | uVar14 * 0x800000) ^ (uVar14 >> 0x12 | uVar14 << 0x2e) ^
              (uVar14 >> 0xe | uVar14 << 0x32));
      uVar12 = uVar7 ^ uVar5;
      uVar13 = uVar13 + lVar3;
