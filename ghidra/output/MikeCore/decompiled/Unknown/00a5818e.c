...
//   "pace::NoDeletePtr<LsActivationInfo> license_services::LsObjectRelationVectorActivationInfo::at(cons...
//   "LsObjectRelationVector<>::at: Index is out of range. This object relation vector contains %u entrie...


undefined8 FUN_00a5818e(undefined8 param_1,ulonglong param_2)

{
  ...
  if ((*(char *)(unaff_RSI + 0x10) == '\0') &&
    ...
    FUN_00925fd0();
    FUN_00926010();
    FUN_00928ab0("pace::NoDeletePtr<LsActivationInfo> license_services::LsObjectRelationVectorActivationInfo::at(const size_t)"
                 ,0x6e);
    FUN_009c78cb();
  }
