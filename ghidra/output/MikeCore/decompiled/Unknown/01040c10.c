...
undefined8 FUN_01040c10(EVP_MD *param_1,EVP_MD *param_2,EVP_MD *param_3,ENGINE *param_4)

{
  ...
  if (((iVar2 == 0) ||
      (local_80 = p_Var5, iVar2 = _EVP_MD_CTX_copy_ex((EVP_MD_CTX *)pkey,(EVP_MD_CTX *)unaff_RDI),
      iVar2 == 0)) ||
     (((EVP_MD *)local_c8._16_8_ != (EVP_MD *)0x0 &&
      (unaff_RDI = (EVP_MD *)local_c8._8_8_,
      iVar2 = _EVP_DigestUpdate((EVP_MD_CTX *)pkey,(void *)local_c8._8_8_,(size_t)pEVar6),
      iVar2 == 0)))) {
LAB_01040ff5:
    len = (size_t)unaff_RDI;
  }
  else {
    ...
    if ((iVar2 == 0) || (iVar2 = _EVP_MD_CTX_copy_ex((EVP_MD_CTX *)pkey,pEVar7), iVar2 == 0)) {
      ...
      if ((EVP_MD *)local_c8._16_8_ != (EVP_MD *)0x0) {
        while( true ) {
          ...
          if (local_a0 <= (EVP_MD *)(ulonglong)uVar1) break;
          ...
          iVar2 = _EVP_DigestSignFinal();
          if (iVar2 == 0) goto LAB_01040f7d;
          local_a0 = (EVP_MD *)((longlong)local_a0 - uVar8);
...
LAB_01040fbe:
      ...
      do {
        ...
        cnt = (size_t)pEVar6;
        if (iVar2 == 0) goto LAB_01040f6b;
        if (local_a0 <= (EVP_MD *)(ulonglong)uVar1) goto LAB_01040fbe;
        iVar2 = _EVP_MD_CTX_copy_ex((EVP_MD_CTX *)pkey,(EVP_MD_CTX *)in);
        if (iVar2 == 0) goto LAB_01040f6b;
        pEVar7 = (EVP_MD_CTX *)local_c8;
        iVar2 = _EVP_DigestSignFinal();
