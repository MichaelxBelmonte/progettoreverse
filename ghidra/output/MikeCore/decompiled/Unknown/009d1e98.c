// Function: FUN_009d1e98
// Address: 009d1e98
// Size: 921 bytes
// Class: Unknown


void FUN_009d1e98(undefined8 param_1,undefined8 param_2,size_t param_3)
...
LAB_009d222c:
    ...
    puVar4 = puVar10;
    if (puVar10 != (undefined8 *)unaff_RDI[3]) goto LAB_009d2215;
    ...
    if (puVar13 < puVar8 || lVar3 == 0) {
      ...
      if ((ulonglong)pvVar1 >> 0x3d != 0) goto LAB_009d222c;
