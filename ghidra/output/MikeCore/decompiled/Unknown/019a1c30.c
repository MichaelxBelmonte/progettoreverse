...
void FUN_019a1c30(pthread_key_t param_1)

{
  ...
  if (unaff_RDI[0x3d] != 0) {
    ...
    while( true ) {
      ...
      unaff_R14 = *(longlong *)(*(longlong *)(local_50 + 0x10) + 8 + lVar2 * 8);
      local_60 = unaff_R14;
      ...
      if ((pvVar3 != (void *)0x0) && (lVar4 = FUN_00e8b990(), unaff_R14 = lVar2, lVar4 != 0)) {
        unaff_R14 = *(longlong *)(lVar2 + 0x20 + (ulonglong)(*(uint *)(lVar4 + 0x154) & 1) * 8);
      }
      local_130 = 0;
  ...
  if (unaff_RDI[0x3e] != 0) {
    ...
    while( true ) {
      ...
      local_48 = CONCAT44(local_48._4_4_,iVar10);
      if (*(int *)(local_50 + 0xc) <= iVar10) break;
      lVar4 = *(longlong *)(local_50 + 0x10);
      local_60 = *(longlong *)(lVar4 + 8 + lVar2 * 8);
      ...
      if (lVar4 != 0) {
        ...
        if ((pvVar3 != (void *)0x0) && (lVar2 = FUN_00e8b990(), unaff_R14 = lVar4, lVar2 != 0)) {
          unaff_R14 = *(longlong *)(lVar4 + 0x20 + (ulonglong)(*(uint *)(lVar2 + 0x154) & 1) * 8);
        }
        local_120 = 0;
        (**(code **)(unaff_RDI[0x28] + 0x10))();
        FUN_00d50b00();
        local_120 = '\x01';
        local_128 = unaff_RDI + 0x28;
        FUN_000823a0();
        FUN_00e86210();
        lVar2 = DAT_026f6f60;
        if (DAT_026f6f60 != 0) {
  ...
  lVar4 = local_60;
  if (local_60 == 0) {
    uVar14 = (undefined7)((ulonglong)uVar6 >> 8);
    bVar12 = 1;
    local_34 = 0;
  }
  else {
    if (local_58 == '\0') {
      ...
      bVar12 = 0;
      uVar14 = 0;
      local_34 = (uint)CONCAT71((int7)((ulonglong)uVar6 >> 8),1);
...
LAB_019a2211:
  ...
  if (lVar4 == local_60) {
    if ((bool)(bVar12 & lVar4 != 0)) {
      ...
      FUN_00d50b00();
      uVar8 = (uint)CONCAT71((int7)((ulonglong)lVar2 >> 8),1);
    }
LAB_019a2416:
    if (local_58 == '\0') {
...
LAB_019a23bf:
  ...
  lVar11 = local_60;
  cVar13 = (char)uVar9;
  uVar14 = (undefined7)((ulonglong)lVar2 >> 8);
  if (lVar4 == local_60) {
    lVar11 = lVar4;
    if ((cVar13 == '\0') && (lVar4 != 0)) {
...
LAB_019a2788:
  ...
  lVar11 = local_60;
  cVar13 = (char)uVar9;
  uVar14 = (undefined7)((ulonglong)lVar4 >> 8);
  if (lVar2 == local_60) {
    lVar11 = lVar2;
    if ((cVar13 == '\0') && (lVar2 != 0)) {
