...
bool FUN_01040600(EVP_MD *param_1,ulonglong *param_2,undefined8 param_3,char *param_4)

{
  ...
  plVar35 = *(longlong **)(unaff_RDI + 0x28);
  if (*plVar35 == 0) {
    iVar26 = 0x69;
    reason = 0x81;
LAB_01040810:
  ...
  _EVP_md5();
  lVar34 = (ulonglong)((uint)uVar28 & 1) + (uVar28 >> 1);
  plVar29 = plVar35;
  lVar33 = lVar31;
  file = unaff_RSI;
  ...
  if ((uVar36 < 8) || ((unaff_RSI < pcVar27 + uVar36 && (pcVar27 < unaff_RSI + uVar36)))) {
    uVar28 = 0;
  }
  else {
    if (uVar36 < 0x20) {
      ...
      if (uVar28 - 0x20 == 0) {
        ...
        do {
          ...
          uVar9 = puVar2[2];
          uVar10 = puVar2[3];
          puVar2 = (uint *)(unaff_RSI + lVar31);
          uVar11 = puVar2[1];
          uVar12 = puVar2[2];
          uVar13 = puVar2[3];
          puVar3 = (uint *)(unaff_RSI + lVar31 + 0x10);
          uVar14 = *puVar3;
          uVar15 = puVar3[1];
          uVar16 = puVar3[2];
          uVar17 = puVar3[3];
          puVar3 = (uint *)(unaff_RSI + lVar31 + 0x20);
          uVar18 = *puVar3;
          uVar19 = puVar3[1];
          uVar20 = puVar3[2];
          uVar21 = puVar3[3];
          puVar3 = (uint *)(unaff_RSI + lVar31 + 0x30);
          uVar22 = *puVar3;
          uVar23 = puVar3[1];
          uVar24 = puVar3[2];
          uVar25 = puVar3[3];
          puVar3 = (uint *)(unaff_RSI + lVar31);
          *puVar3 = *puVar2 ^ *puVar1;
          puVar3[1] = uVar11 ^ uVar4;
          puVar3[2] = uVar12 ^ uVar5;
          puVar3[3] = uVar13 ^ uVar6;
          puVar1 = (uint *)(unaff_RSI + lVar31 + 0x10);
          *puVar1 = uVar14 ^ uVar7;
    ...
    do {
      *(ulonglong *)(unaff_RSI + uVar32) =
           *(ulonglong *)(unaff_RSI + uVar32) ^ *(ulonglong *)(pcVar27 + uVar32);
      uVar32 = uVar32 + 8;
    } while (uVar28 != uVar32);
    if (uVar36 == uVar28) goto LAB_0104079f;
  }
LAB_01040732:
  ...
  for (uVar32 = uVar36 & 3; uVar32 != 0; uVar32 = uVar32 - 1) {
    unaff_RSI[uVar28] = unaff_RSI[uVar28] ^ pcVar27[uVar28];
    uVar28 = uVar28 + 1;
  }
  if (2 < uVar30 + uVar36) {
    do {
      unaff_RSI[uVar28] = unaff_RSI[uVar28] ^ pcVar27[uVar28];
      unaff_RSI[uVar28 + 1] = unaff_RSI[uVar28 + 1] ^ pcVar27[uVar28 + 1];
      unaff_RSI[uVar28 + 2] = unaff_RSI[uVar28 + 2] ^ pcVar27[uVar28 + 2];
      unaff_RSI[uVar28 + 3] = unaff_RSI[uVar28 + 3] ^ pcVar27[uVar28 + 3];
      uVar28 = uVar28 + 4;
    } while (uVar36 != uVar28);
  }
LAB_0104079f:
