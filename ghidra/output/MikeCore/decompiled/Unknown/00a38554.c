...
void FUN_00a38554(undefined8 param_1,undefined8 param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a385f9:
    if ((plVar15 == plVar4) || ((longlong)plVar15 - (longlong)plVar3 == -8)) goto LAB_00a38607;
    lVar16 = (longlong)plVar15 - (longlong)plVar3 >> 3;
  }
  else {
    do {
      if (*plVar15 == lVar16) goto LAB_00a385f9;
      plVar15 = plVar15 + 1;
...
LAB_00a38607:
  ...
  *(longlong *)((longlong)pvVar10 + 0x18) = lVar8 + lVar16 * 8 + ((longlong)pvVar9 >> 3) * 8;
  ...
  if (lVar11 != lVar8) {
    ...
    if (lVar11 == lVar14) goto LAB_00a3873a;
  }
  do {
...
LAB_00a3873a:
  *(longlong *)((longlong)pvVar7 + 0x50) = lVar14;
  ...
  if (plVar4 != (longlong *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00a387c7. Too many branches */
