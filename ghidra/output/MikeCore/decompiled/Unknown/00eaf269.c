// Function: FUN_00eaf269
// Address: 00eaf269
// Size: 2127 bytes
// Class: Unknown


ulonglong FUN_00eaf269(longlong *param_1,undefined8 param_2,ulonglong *param_3,int *param_4)

{
  ...
  if ((longlong *)(lVar16 + uVar15) <= param_1) {
    ...
    if (*(uint *)(unaff_RSI + 0x2c) < uVar29) {
      ...
      do {
        uVar11 = (uint)uVar15;
        uVar23 = (ulonglong)(*(longlong *)(lVar16 + uVar15) * -0x30e4432345000000) >>
...
LAB_00eaf436:
    ...
    *(uint *)(unaff_RSI + 0x2c) = (uint)local_70;
    ...
    uVar15 = (ulonglong)(*local_48 * -0x30e4432345000000) >> (-*(char *)(unaff_RSI + 0x108) & 0x3fU)
    ;
    uVar23 = 0;
