...
undefined8 FUN_00fc2db0(EVP_MD *param_1,uint param_2,undefined8 param_3,char *param_4)

{
  ...
  puVar1 = *(uint **)(unaff_RDI + 0x28);
  if (unaff_ESI < 0x1001) {
    if (0xc < unaff_ESI - 1U) {
      return 0xfffffffe;
    }
    pEVar5 = (EVP_MD *)
             ((longlong)&switchD_00fc2de5::switchdataD_00fc2fb4 +
             (longlong)(int)(&switchD_00fc2de5::switchdataD_00fc2fb4)[unaff_ESI - 1U]);
    uVar4 = 1;
    switch(unaff_ESI) {
    case 1:
