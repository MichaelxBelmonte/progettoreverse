...
//   "pace::NoDeletePtr<LsAssociativeArray> license_services::LsObjectRelationVectorAssociativeArray::at(...


undefined8 FUN_00a58a2e(undefined8 param_1,ulonglong param_2)

{
  ...
  if ((*(char *)(unaff_RSI + 0x10) == '\0') &&
    ...
    FUN_00925fd0();
    FUN_00926010();
    FUN_00928ab0("pace::NoDeletePtr<LsAssociativeArray> license_services::LsObjectRelationVectorAssociativeArray::at(const size_t)"
                 ,0x6e);
    FUN_009c78cb();
  }
