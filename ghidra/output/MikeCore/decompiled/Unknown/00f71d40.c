...

{
  ...
  bp = (BIO *)(ulonglong)param_2;
  local_38 = *(longlong *)PTR____stack_chk_guard_024a9898;
  lVar11 = *(longlong *)&param_1->flags;
  if ((lVar11 == 0) || (pcVar10 = *(code **)(lVar11 + 0x18), pcVar10 == (code *)0x0)) {
    pcVar10 = (code *)0x0;
    it = (ASN1_ITEM *)(ulonglong)(uint)(int)*(char *)&param_1->method;
    if ((int)*(char *)&param_1->method == 0) goto LAB_00f71db4;
LAB_00f71dbf:
    if (*unaff_RSI == (_func_4494 *)0x0) {
      if (((ulonglong)local_res10->sn & 1) != 0) {
        if ((local_res8 == 0) &&
...
switchD_00f71de5_caseD_3:
    ...
    pBVar6 = (BIO *)((longlong)&switchD_00f71de5::switchdataD_00f7258c +
                    (longlong)(int)(&switchD_00f71de5::switchdataD_00f7258c)[(longlong)it]);
    switch(it) {
    case (ASN1_ITEM *)0x0:
    ...
    default:
      ...
      if (0 < (longlong)*(ASN1_ITEM_EXP **)&param_1->init) {
        lVar11 = 0;
        do {
          tt = (ASN1_TEMPLATE *)((longlong)&MACH_HEADER.magic + 1);
          pBVar3 = (BIO *)_asn1_do_adb((ASN1_VALUE **)pBVar6,
                                       (ASN1_TEMPLATE *)((longlong)&MACH_HEADER.magic + 1),
                                       (int)pAVar9);
          ...
          lVar11 = lVar11 + 1;
          pBVar6 = pBVar3;
        } while (lVar11 < (longlong)*(ASN1_ITEM_EXP **)&param_1->init);
      }
      if (((ulonglong)local_res10->sn & 2) != 0) {
        bVar7 = false;
        iVar1 = _BIO_printf((BIO *)"",(char *)bp);
        if (iVar1 < 0) goto LAB_00f7251e;
      }
      if (pcVar10 == (code *)0x0) goto LAB_00f72519;
      iVar1 = (*pcVar10)(&stack0xffffffffffffff38,param_1);
      break;
    case (ASN1_ITEM *)0x2:
      uVar2 = _asn1_get_choice_selector((ASN1_VALUE **)pBVar6,it);
      if (((int)uVar2 < 0) ||
         (pBVar6 = (BIO *)(ulonglong)uVar2,
         (longlong)*(ASN1_ITEM_EXP **)&param_1->init <= (longlong)pBVar6)) {
        iVar1 = _BIO_printf(pBVar6,(char *)(ulonglong)uVar2);
        if (*(longlong *)PTR____stack_chk_guard_024a9898 == local_38) {
          return 0 < iVar1;
        }
        goto LAB_00f72586;
      ...
      iVar1 = FUN_00f72750(pcVar4 + (longlong)pBVar6 * 0x28,bp,local_res10);
      break;
    case (ASN1_ITEM *)0x3:
    ...
    case (ASN1_ITEM *)0x4:
      ...
      if ((lVar11 == 0) || (*(code **)(lVar11 + 0x30) == (code *)0x0)) {
...
LAB_00f71db4:
  if (param_1->callback != (_func_4494 *)((longlong)&MACH_HEADER.magic + 1)) goto LAB_00f71dbf;
...
switchD_00f71de5_caseD_5:
  ...
  iVar1 = FUN_00f72620(param_4,param_3);
  if (iVar1 == 0) goto LAB_00f72574;
  if ((lVar11 != 0) && (*(code **)(lVar11 + 0x38) != (code *)0x0)) {
  ...
  if (*(char *)&param_1->method == '\x05') {
    param_4 = (char *)*unaff_RSI;
    p_Var8 = (_func_4494 *)
             ((longlong)*(int *)((longlong)&((BIO *)param_4)->method + 4) & 0xfffffffffffffeff);
    pBVar6 = (BIO *)param_4;
LAB_00f722b9:
    if (((ulonglong)local_res10->sn & 8) == 0) {
      pcVar4 = (char *)0x0;
      pBVar3 = pBVar6;
    }
    else {
LAB_00f72370:
    ...
    if (p_Var8 != (_func_4494 *)((longlong)&MACH_HEADER.cputype + 1)) goto LAB_00f722d1;
LAB_00f72389:
    iVar1 = _BIO_puts((BIO *)param_4,(char *)local_res10);
    goto joined_r0x00f723a8;
  }
  p_Var8 = param_1->callback;
  if (p_Var8 == (_func_4494 *)((longlong)&MACH_HEADER.magic + 1)) {
    p_Var8 = (_func_4494 *)((longlong)&MACH_HEADER.magic + 1);
    pBVar6 = (BIO *)0x0;
    goto LAB_00f722b9;
  }
  pBVar6 = (BIO *)*unaff_RSI;
  if (p_Var8 != (_func_4494 *)0xfffffffffffffffc) goto LAB_00f722b9;
  p_Var8 = (_func_4494 *)(longlong)*(int *)&pBVar6->method;
  pBVar3 = (BIO *)pBVar6->callback;
  unaff_RSI = &pBVar6->callback;
  pBVar6 = pBVar3;
  if (((ulonglong)local_res10->sn & 0x10) == 0) goto LAB_00f72370;
  pcVar4 = (char *)0x0;
  if (p_Var8 == (_func_4494 *)((longlong)&MACH_HEADER.cputype + 1)) goto LAB_00f72389;
LAB_00f722d1:
  if ((pcVar4 != (char *)0x0) &&
  ...
  if ((undefined1 *)((longlong)&MACH_HEADER.flags + 3) < p_Var8 + 3) {
switchD_00f72326_caseD_fffffffe:
  ...
  param_4 = (char *)((longlong)&switchD_00f72326::switchdataD_00f725a8 +
                    (longlong)(int)(&switchD_00f72326::switchdataD_00f725a8)[(longlong)(p_Var8 + 3)]
                    );
  switch(p_Var8) {
  case (_func_4494 *)0x1:
    iVar1 = *(int *)unaff_RSI;
  ...
  case (_func_4494 *)0xa:
    ...
    if (pcVar4 != (char *)0x0) {
      iVar1 = _BIO_puts((BIO *)param_4,(char *)local_res10);
      uVar2 = (uint)(0 < iVar1);
      local_res10 = (ASN1_OBJECT *)((longlong)&section_00000158.reloff + 2);
  ...
  case (_func_4494 *)0x3:
  case (_func_4494 *)0x4:
    if (*(int *)((longlong)&pBVar3->method + 4) == 3) {
      bVar7 = false;
      iVar1 = _BIO_printf((BIO *)param_4,(char *)(ulonglong)((uint)pBVar3->cb_arg & 7));
      len = (int)pAVar9;
    ...
    iVar1 = _BIO_dump_indent((BIO *)(ulonglong)(param_2 + 2),
                             (char *)(ulonglong)*(uint *)&pBVar3->method,len,uVar2);
    goto joined_r0x00f723a8;
  case (_func_4494 *)0x6:
    p_Var8 = *unaff_RSI;
    ...
    _OBJ_obj2txt((char *)((longlong)&MACH_HEADER.magic + 1),(int)p_Var8,pAVar9,uVar2);
...
LAB_00f724d2:
  ...
  case (_func_4494 *)0x11:
    ...
    bVar7 = false;
    if (0 < iVar1) {
      iVar1 = _ASN1_parse_dump(bp,(uchar *)(longlong)*(int *)&pBVar3->method,0,uVar2,
