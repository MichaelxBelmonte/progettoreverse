...
/* WARNING: Removing unreachable block (ram,0x01a5797a) */
/* WARNING: Removing unreachable block (ram,0x01a57986) */
...

{
  ...
  if (0 < *(int *)(lVar8 + 0xc)) {
    uVar11 = (ulonglong)(*(int *)(lVar8 + 0xc) - 1);
    if (plVar7 != (longlong *)0x0) {
      plVar7 = *(longlong **)(*(longlong *)(lVar8 + 0x10) + uVar11 * 8);
      do {
        if (plVar7 != (longlong *)0x0) {
          FUN_00d50b00();
        }
        ...
        plVar7 = local_48;
        if (local_40[0] == '\0') {
          if (local_48 == (longlong *)0x0) goto LAB_01a57480;
          FUN_00d50b00();
          if ((local_40[0] != '\0') && (local_48 != (longlong *)0x0)) {
            FUN_00d50b20();
          }
...
LAB_01a57514:
          ...
          if (local_48 != (longlong *)0x0) goto LAB_01a57430;
LAB_01a57480:
          bVar10 = true;
LAB_01a57493:
          local_78 = '\0';
          ...
          (**(code **)(**(longlong **)
                         (*(longlong *)(*(longlong *)(unaff_RDI + 0x48) + 0x10) + uVar11 * 8) +
                      0x478))();
          FUN_00d23620();
          if (!bVar10) goto LAB_01a57514;
        }
        FUN_00d50b20();
        if ((longlong)uVar11 < 1) goto LAB_01a57791;
        uVar11 = uVar11 - 1;
        lVar8 = *(longlong *)(unaff_RDI + 0x48);
        plVar7 = *(longlong **)(*(longlong *)(lVar8 + 0x10) + uVar11 * 8);
      } while( true );
    ...
    while( true ) {
      ...
      (**(code **)(**(longlong **)
                     (*(longlong *)(*(longlong *)(unaff_RDI + 0x48) + 0x10) + uVar11 * 8) + 0x478))
                ();
      FUN_00d23620();
      if (plVar7 != (longlong *)0x0) {
        FUN_00d50b20();
      ...
      FUN_00d50b20();
      if ((longlong)uVar11 < 1) break;
      uVar11 = uVar11 - 1;
      plVar7 = *(longlong **)(*(longlong *)(*(longlong *)(unaff_RDI + 0x48) + 0x10) + uVar11 * 8);
    }
  }
LAB_01a57791:
  plVar7 = local_58;
...
LAB_01a57810:
  if (plVar7 != (longlong *)0x0) {
    ...
    if (*(int *)((longlong)plVar7 + 0xc) < 1) {
      ...
      bVar10 = false;
      do {
        lVar1 = *(longlong *)(local_50[2] + lVar9 * 8);
        if (lVar1 != 0) {
          FUN_00d50b00();
        }
        FUN_01a57e90();
