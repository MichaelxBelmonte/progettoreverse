...
/* WARNING: Removing unreachable block (ram,0x01689186) */
/* WARNING: Removing unreachable block (ram,0x0168918f) */
/* WARNING: Removing unreachable block (ram,0x01688dfc) */
/* WARNING: Removing unreachable block (ram,0x01688e05) */

void FUN_01688cf0(undefined8 param_1)

{
  ...
  lVar2 = *(longlong *)(*(longlong *)(unaff_RSI + 0x30) + 0x30);
