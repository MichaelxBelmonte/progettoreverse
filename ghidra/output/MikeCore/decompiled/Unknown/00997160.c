...
/* WARNING: Removing unreachable block (ram,0x00997242) */
/* WARNING: Removing unreachable block (ram,0x0099724c) */
...

{
  ...
  FUN_009525d0();
  if ((DAT_02743fe8 == '\0') && (iVar3 = ___cxa_guard_acquire(), iVar3 != 0)) {
    puVar4 = operator_new((ulong)param_1);
    puVar4[6] = &PTR____cxa_pure_virtual_02524c00;
    *puVar4 = PTR_DAT_0249c0d8 + 0x10;
    puVar4[1] = local_60;
    ...
    *(undefined4 *)(puVar4 + 4) = 0x81;
    ...
    ;
    *puVar4 = &DAT_0251e1d8;
    puVar4[5] = &DAT_0251e208;
    puVar4[6] = &DAT_0251e248;
    FUN_009590c0();
    DAT_02743fd8 = local_30;
    DAT_02743fe0 = local_28;
      ...
      if (local_28 != (longlong *)0x0) {
        ...
        *(int *)plVar1 = (int)*plVar1 + -1;
        ...
        if ((int)*plVar1 == 0) {
          (**(code **)(*local_28 + 0x10))();
          LOCK();
          piVar2 = (int *)((longlong)local_28 + 0xc);
          *piVar2 = *piVar2 + -1;
          UNLOCK();
          if (*piVar2 == 0) {
            (**(code **)(*local_28 + 0x18))();
  ...
  *unaff_RDI = DAT_02743fd8;
  plVar1 = DAT_02743fe0;
  unaff_RDI[1] = DAT_02743fe0;
