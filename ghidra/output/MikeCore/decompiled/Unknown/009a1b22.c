...
//   "virtual void pace::ILok2Commander::GetLastEEPROMFailure(const CMD_CmmdPayload_GetLastEEPROMFailure_...


void FUN_009a1b22(undefined8 param_1,undefined8 param_2)

{
  ...
  if (unaff_RDI[7] == 0) {
    FUN_00925fd0();
    uVar1 = FUN_00926010();
    uVar3 = FUN_00928ab0("virtual void pace::ILok2Commander::GetLastEEPROMFailure(const CMD_CmmdPayload_GetLastEEPROMFailure_Struct &, CMD_RsltPayload_GetLastEEPROMFailure_Struct &)"
                         ,0xc86);
    uVar3 = FUN_009c720b(uVar3,uVar1);
  }
  uVar3 = (**(code **)(*unaff_RDI + 0x218))(uVar3,&local_108);
