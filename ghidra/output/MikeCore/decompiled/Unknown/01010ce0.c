...
undefined8 FUN_01010ce0(char *param_1,undefined8 param_2,EC_POINT *param_3,BN_CTX *param_4)

{
  ...
  *(undefined4 *)(plVar3 + 4) = 1;
  ...
  uVar9 = 0;
  if ((unaff_RSI == (BN_CTX *)0x0) && (unaff_RSI = _BN_CTX_new(), unaff_RSI == (BN_CTX *)0x0)) {
    uVar9 = 0;
  }
  else {
    ...
    if (lVar4 != 0) {
      iVar1 = _BN_is_zero();
      if (iVar1 == 0) {
        pEVar7 = (EC_POINT *)((longlong)&section_00000338.size + 2);
        pvVar5 = _CRYPTO_malloc((int)param_1,(char *)((longlong)&section_00000338.size + 2),
                                (int)param_3);
        if (pvVar5 != (void *)0x0) {
          ...
          if (((r != (EC_POINT *)0x0) && (r_00 != (EC_POINT *)0x0)) &&
            ...
            pEVar8 = (EC_POINT *)(((ulonglong)pvVar5 & 0xffffffffffffffc0) + 0x40);
            param_1 = (char *)((longlong)pvVar5 - (ulonglong)((uint)pvVar5 & 0x3f));
            uVar9 = 0;
            local_54 = 0;
            pEVar7 = pEVar8;
            do {
              ...
              do {
                iVar1 = _EC_POINT_make_affine
                                  ((EC_GROUP *)param_1,(EC_POINT *)unaff_RSI,(BN_CTX *)param_3);
                if (iVar1 == 0) goto LAB_01010e8c;
                ...
                param_1 = (char *)unaff_RSI;
                iVar1 = _EC_POINT_dbl((EC_GROUP *)unaff_RSI,r,param_3,param_4);
                if (((iVar1 == 0) ||
                    (param_1 = (char *)unaff_RSI,
                    iVar1 = _EC_POINT_dbl((EC_GROUP *)unaff_RSI,r,param_3,param_4), iVar1 == 0)) ||
                   ((param_1 = (char *)unaff_RSI,
                    iVar1 = _EC_POINT_dbl((EC_GROUP *)unaff_RSI,r,param_3,param_4), iVar1 == 0 ||
                    ((((param_1 = (char *)unaff_RSI,
                       iVar1 = _EC_POINT_dbl((EC_GROUP *)unaff_RSI,r,param_3,param_4), iVar1 == 0 ||
              ...
              param_1 = (char *)pEVar2;
              pEVar7 = r_00;
              param_3 = (EC_POINT *)unaff_RSI;
              iVar1 = _EC_POINT_add((EC_GROUP *)pEVar2,r_00,(EC_POINT *)unaff_RSI,
                                    (EC_POINT *)param_4,
                                    (BN_CTX *)
            ...
            *plVar3 = unaff_RDI;
            plVar3[1] = 7;
            plVar3[2] = (longlong)pEVar8;
            plVar3[3] = (longlong)pvVar5;
            *(undefined4 *)(unaff_RDI + 0x98) = 4;
