...
void FUN_00a3b3e6(undefined8 param_1,undefined8 param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a3b48b:
    if ((plVar15 == plVar4) || ((longlong)plVar15 - (longlong)plVar3 == -8)) goto LAB_00a3b499;
...
LAB_00a3b499:
  ...
  *(longlong *)((longlong)pvVar10 + 0x18) = lVar8 + lVar16 * 8 + ((longlong)pvVar9 >> 3) * 8;
  lVar13 = lVar16 * 0xe8 + *(longlong *)((longlong)pvVar7 + 0x48);
  lVar11 = lVar13 + 0xe8;
...
LAB_00a3b5cc:
  *(longlong *)((longlong)pvVar7 + 0x50) = lVar14;
  ...
  if (plVar4 != (longlong *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00a3b659. Too many branches */
