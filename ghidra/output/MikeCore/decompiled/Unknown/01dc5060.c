...
/* WARNING: Removing unreachable block (ram,0x01dc539d) */
/* WARNING: Removing unreachable block (ram,0x01dc53a9) */
/* WARNING: Removing unreachable block (ram,0x01dc543f) */
/* WARNING: Removing unreachable block (ram,0x01dc544c) */
/* WARNING: Removing unreachable block (ram,0x01dc5b07) */

void FUN_01dc5060(undefined8 param_1,float param_2)
...
LAB_01dc515e:
    ...
    FUN_01dcc290(uVar13,DAT_028b8a58);
        ...
        if (iVar9 < iVar6 + -1) {
          ...
          while( true ) {
            ...
            if (fVar11 < (float)uVar13) {
              ...
              FUN_01db96b0(fVar11 + DAT_02390124);
              if ((local_38 != '\0') && (local_40 != (longlong *)0x0)) {
                FUN_00d50b20();
              }
              bVar10 = true;
  ...
  if (DAT_028b8a5c != -1) {
    ...
    if (cVar3 == '\0') {
      ...
      bVar10 = DAT_028b8a48 != 0;
      if ((local_38 != '\0') && (local_40 != (longlong *)0x0)) {
        FUN_00d50b20();
      }
      if ((bVar5 & bVar10) == 0) goto LAB_01dc5980;
    }
    else if (DAT_028b8a48 == 0) goto LAB_01dc5980;
    fVar11 = (fVar14 - param_2) + DAT_028b8a60;
    DAT_028b8a60 = fVar11;
    fVar12 = (float)FUN_01d526f0();
    fVar12 = DAT_023908ec - fVar12;
    if (fVar11 < fVar12) {
      fVar12 = (float)FUN_01d526f0();
      fVar12 = DAT_023908ec - fVar12;
      DAT_028b8a60 = fVar12;
    ...
    FUN_01e3f820();
    auVar16._0_4_ = auVar16._0_4_ + DAT_02394248;
    if (auVar16._0_4_ < fVar11) {
      FUN_01e3f820();
      DAT_028b8a60 = auVar16._0_4_ + DAT_02394248;
    }
    auVar16 = ZEXT816(0);
    if (fVar14 < 0.0) {
      auVar19 = insertps(local_98,ZEXT416((uint)DAT_02390124),0x11);
    }
    else {
      auVar19 = insertps(local_98,ZEXT416((uint)DAT_02390124),0x10);
    }
    FUN_01e3f820();
    auVar18 = auVar16._4_12_;
    fVar14 = auVar16._0_4_ + DAT_02390d00;
    local_98._0_4_ = auVar19._0_4_;
    if (fVar14 < (float)local_98._0_4_) {
      FUN_01e3f820();
      auVar17._0_4_ = fVar14 + DAT_02390d00;
    ...
    if (iVar9 != -1) {
      ...
      if ((cVar3 != '\0') && (iVar9 != DAT_028b8a5c)) {
        ...
        if (iVar6 == iVar9) {
          ...
          FUN_01dce080(extraout_XMM0_Qa_03,DAT_028b8a5c);
        }
      }
    }
