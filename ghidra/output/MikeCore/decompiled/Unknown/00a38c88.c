// Function: FUN_00a38c88
// Address: 00a38c88
// Size: 935 bytes
// Class: Unknown


void FUN_00a38c88(undefined8 param_1,undefined8 param_2,size_t param_3)
  ...
  *unaff_RDI = &DAT_025272c8;
  ...
  if (local_40 != *(longlong *)(unaff_RSI + 0x50)) {
    ...
    do {
      ...
      *(undefined4 *)((longlong)puVar7 + 0x99) = 0x10101;
      *(undefined2 *)((longlong)puVar7 + 0x9d) = 0;
      FUN_00aaac2a();
...
LAB_00a39031:
  ...
  *(undefined4 *)(unaff_RDI[3] + 0x40) = 0x7a;
  FUN_009b99ca();
  return;
}
