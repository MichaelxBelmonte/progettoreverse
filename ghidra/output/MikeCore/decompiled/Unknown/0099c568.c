...
//   "virtual void pace::ILok2Commander::GetStorageRecord(const CMD_CmmdPayload_GetStorageRecord_Struct &...


void FUN_0099c568(undefined8 param_1,undefined8 param_2)

{
  ...
  if (unaff_RDI[7] == 0) {
    FUN_00925fd0();
    uVar1 = FUN_00926010();
    uVar3 = FUN_00928ab0("virtual void pace::ILok2Commander::GetStorageRecord(const CMD_CmmdPayload_GetStorageRecord_Struct &, CMD_RsltPayload_GetStorageRecord_Struct &)"
                         ,0x671);
    uVar3 = FUN_009c720b(uVar3,uVar1);
  }
  uVar3 = (**(code **)(*unaff_RDI + 0xf0))(uVar3,&local_108);
