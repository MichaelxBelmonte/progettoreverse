...
/* WARNING: Removing unreachable block (ram,0x0186ad05) */
/* WARNING: Removing unreachable block (ram,0x0186ad11) */
/* WARNING: Removing unreachable block (ram,0x0186a82b) */
/* WARNING: Removing unreachable block (ram,0x0186a837) */
/* WARNING: Removing unreachable block (ram,0x0186a4d9) */
/* WARNING: Removing unreachable block (ram,0x0186a4e5) */
/* WARNING: Removing unreachable block (ram,0x0186ab13) */
/* WARNING: Removing unreachable block (ram,0x0186ab1f) */
/* WARNING: Removing unreachable block (ram,0x0186ac75) */
/* WARNING: Removing unreachable block (ram,0x0186ac82) */
/* WARNING: Removing unreachable block (ram,0x0186ac34) */
/* WARNING: Removing unreachable block (ram,0x0186ac41) */
/* WARNING: Removing unreachable block (ram,0x0186a52c) */
/* WARNING: Removing unreachable block (ram,0x0186a535) */
/* WARNING: Removing unreachable block (ram,0x0186b560) */
/* WARNING: Removing unreachable block (ram,0x0186b56d) */
/* WARNING: Removing unreachable block (ram,0x0186ab66) */
/* WARNING: Removing unreachable block (ram,0x0186ab6f) */
/* WARNING: Removing unreachable block (ram,0x0186b16f) */
/* WARNING: Removing unreachable block (ram,0x0186b17c) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0186a3a0(float param_1,undefined8 *param_2,float *param_3,float *param_4,undefined8 param_5
                 )

{
  ...
  if (*(int *)(lVar13 + 0xc) < 1) {
    ...
    local_7c = 0;
    do {
      lVar13 = *(longlong *)(*(longlong *)(*(longlong *)(lVar13 + 0x10) + lVar15 * 8) + 0x20);
      if ((*(int *)(lVar13 + 0xc) != 0) &&
         (*(longlong *)(**(longlong **)(lVar13 + 0x10) + 0x10) != 0)) {
        FUN_00d50b00();
        iVar10 = FUN_01715480();
        ...
        bVar16 = true;
        if ((local_48 == (longlong *)0x0) || (FUN_018d8750(), local_48 == (longlong *)0x0)) {
          local_70 = 0;
          local_78 = 0;
          bVar18 = false;
        }
          ...
          if ((cVar8 == '\0') ||
             (lVar13 = *unaff_RDI, (longlong)*(int *)(lVar13 + 0xc) <= lVar15 + 1)) {
            bVar16 = false;
            bVar18 = false;
          }
          else {
            ...
            do {
              lVar13 = *(longlong *)
                        (*(longlong *)(*(longlong *)(lVar13 + 0x10) + lVar17 * 8) + 0x20);
              if ((*(int *)(lVar13 + 0xc) != 0) &&
                 (lVar13 = *(longlong *)(**(longlong **)(lVar13 + 0x10) + 0x10), lVar13 != 0)) {
                FUN_00d50b00();
                iVar11 = FUN_01715480();
                bVar18 = true;
                if (iVar11 != iVar10) {
        ...
        *pfVar1 = fVar28;
        ...
        if (local_70 == 0 && local_78 == 0) {
          ...
          auVar26 = blendps(auVar27,_DAT_0238ff00,2);
...
LAB_0186b100:
          ...
          if (local_48 != (longlong *)0x0) goto LAB_0186b100;
        }
        if (local_48 != (longlong *)0x0) {
          FUN_00d50b20();
          FUN_00d50b20();
  ...
  fVar25 = (DAT_02394250 - fVar32) / _DAT_02417218;
  fVar30 = ((DAT_02390124 - fVar25) * _DAT_0241b544 + local_34) * DAT_023942a8;
  fVar29 = DAT_0239011c;
  if (DAT_02394274 < fVar32) {
    fVar29 = (float)local_d8._4_4_ / fVar32;
  }
  fVar28 = fVar28 - (DAT_02390118 + fVar32);
  *local_res10 = fVar28;
  *(bool *)local_res18 = param_1 < fVar28;
  *(bool *)param_5 = DAT_02390124 <= fVar25 + fVar30 || param_1 < fVar28;
  *param_4 = fVar32;
  *param_3 = fVar29;
  *local_res8 = local_34;
  return;
