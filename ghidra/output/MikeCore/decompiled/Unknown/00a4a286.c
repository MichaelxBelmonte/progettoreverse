...
//   "void license_services::LsEntityUtilsDatabaseInfo::add(license_services::LsDatabaseInfoWire &)"


void FUN_00a4a286(void)

{
  ...
  if (lVar5 != -1) {
    ...
    FUN_00983230();
    FUN_00983230();
    FUN_00928ab0("void license_services::LsEntityUtilsDatabaseInfo::add(license_services::LsDatabaseInfoWire &)"
                 ,0x66);
    FUN_009c78cb();
  }
  FUN_009b4be0();
  ...
  if (lVar8 == *(longlong *)(lVar5 + 0x58)) {
    lVar8 = (lVar8 - *(longlong *)(lVar5 + 0x48) >> 4) * 0x34f72c234f72c235;
    if (0x8d3dcb08d3dcb0 < lVar8 + 1U) {
                    /* WARNING: Subroutine does not return */
      std::__vector_base_common<true>::__throw_length_error();
    }
    FUN_00a2ff80(lVar5 + 0x58,lVar8);
    FUN_00a98ec4();
    FUN_00a2fef0();
    FUN_00a2fff0();
  }
    ...
    FUN_00a98ec4();
    *(longlong *)(lVar5 + 0x50) = lVar8 + 0x1d0;
  }
  return;
}
