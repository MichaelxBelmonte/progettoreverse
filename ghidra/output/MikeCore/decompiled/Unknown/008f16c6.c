...

{
  ...
  iVar20 = (**(code **)(*unaff_RSI + 0x30))(0xd,8);
  iVar21 = (**(code **)(*unaff_RSI + 0x90))();
  iVar22 = (**(code **)(*unaff_RSI + 0x38))();
  iVar23 = (**(code **)(*unaff_RSI + 0x30))(0x14,0xf);
  ...
  for (lVar25 = *(longlong *)(unaff_RDI + 0x50); lVar25 != *(longlong *)(unaff_RDI + 0x58);
      lVar25 = lVar25 + 1) {
  ...
  iVar3 = (**(code **)(*unaff_RSI + 0x30))(0x15,8);
  iVar4 = (**(code **)(*unaff_RSI + 0x90))();
  iVar5 = (**(code **)(*unaff_RSI + 0x38))();
  iVar6 = (**(code **)(*unaff_RSI + 0x30))(0x16,8);
