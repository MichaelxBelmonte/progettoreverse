...
undefined8 FUN_0102ade0(undefined8 *param_1,uint param_2,size_t param_3,char *param_4)

{
  ...
  case 0:
    ...
    *(undefined8 *)(lVar4 + 0x2d8) = uVar10;
    *(undefined8 *)(lVar4 + 0x2e4) = 0xffffffff;
    *(undefined4 *)(lVar4 + 0x2ec) = 0xffffffff;
    break;
  default:
    goto switchD_0102ae24_caseD_1;
  case 8:
    lVar5 = _EVP_CIPHER_CTX_get_cipher_data();
    if (*(longlong *)(lVar4 + 0x2a0) != 0) {
      if (*(longlong *)(lVar4 + 0x2a0) != lVar4) {
        return 0;
      }
      *(longlong *)(lVar5 + 0x2a0) = lVar5;
    }
    lVar9 = *(longlong *)(lVar4 + 0x2d8);
    lVar6 = _EVP_CIPHER_CTX_iv_noconst();
    if (lVar9 != lVar6) {
      pvVar7 = _CRYPTO_malloc((int)buf,(char *)((longlong)&section_00000158.addr + 2),param_3);
      *(void **)(lVar5 + 0x2d8) = pvVar7;
      if (pvVar7 == (void *)0x0) {
        _ERR_put_error(0x20104f3,0x41,0x17b,param_4,unaff_R14D);
        return 0;
      }
      pvVar7 = (void *)(longlong)*(int *)(lVar4 + 0x2e0);
      goto LAB_0102afa3;
    }
    uVar10 = _EVP_CIPHER_CTX_iv_noconst();
    *(undefined8 *)(lVar5 + 0x2d8) = uVar10;
    break;
  case 9:
    if ((int)param_2 < 1) {
      return 0;
...
LAB_0102afa3:
  ...
  case 0x12:
    if (param_2 == 0xffffffff) {
      _memcpy(&switchD_0102ae24::switchdataD_0102b314,(void *)(longlong)*(int *)(lVar4 + 0x2e0),
              param_3);
      *(undefined4 *)(lVar4 + 0x2e8) = 1;
    }
    else {
      if ((int)param_2 < 4) {
        return 0;
  ...
  case 0x13:
    ...
    _CRYPTO_gcm128_setiv(&switchD_0102ae24::switchdataD_0102b314,(longlong)*(int *)(lVar4 + 0x2e0));
    ...
    _memcpy(buf,(void *)(longlong)(int)uVar12,param_3);
    lVar5 = *(longlong *)(lVar4 + 0x2d8);
    lVar9 = (longlong)*(int *)(lVar4 + 0x2e0);
  ...
  case 0x16:
    ...
    puVar8 = (undefined8 *)_EVP_CIPHER_CTX_buf_noconst();
    uVar10 = *(undefined8 *)((longlong)param_1 + 5);
    *puVar8 = *param_1;
    *(undefined8 *)((longlong)puVar8 + 5) = uVar10;
    *(undefined4 *)(lVar4 + 0x2ec) = 0xd;
    lVar4 = _EVP_CIPHER_CTX_buf_noconst();
    uVar2 = *(undefined1 *)(lVar4 + 0xb);
    lVar4 = _EVP_CIPHER_CTX_buf_noconst();
    uVar11 = (uint)CONCAT11(uVar2,*(undefined1 *)(lVar4 + 0xc));
    if (uVar11 < 8) {
      return 0;
    }
    uVar12 = uVar11 - 8;
  ...
  case 0x18:
    ...
    _memcpy(buf,(void *)(longlong)(int)param_2,param_3);
    _CRYPTO_gcm128_setiv();
    *(undefined4 *)(lVar4 + 0x11c) = 1;
    break;
  case 0x25:
    *(undefined4 *)param_1 = *(undefined4 *)(lVar4 + 0x2e0);
  }
  uVar10 = 1;
