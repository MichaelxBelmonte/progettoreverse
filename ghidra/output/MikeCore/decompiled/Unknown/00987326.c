...
/* WARNING: Removing unreachable block (ram,0x009874e3) */
/* WARNING: Removing unreachable block (ram,0x009874f5) */
/* WARNING: Removing unreachable block (ram,0x009873de) */
/* WARNING: Removing unreachable block (ram,0x009873e4) */
/* WARNING: Removing unreachable block (ram,0x00987666) */
/* WARNING: Removing unreachable block (ram,0x00987578) */
/* WARNING: Removing unreachable block (ram,0x0098757e) */

void FUN_00987326(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  (**(code **)(*unaff_RDI + 0x20))(uVar6,&DAT_023cd04d);
  if (pcVar2 != (code *)0x0) {
    LOCK();
    pcVar1 = pcVar2 + 8;
  ...
  (**(code **)(*unaff_RDI + 0x28))();
  (**(code **)(*local_78 + 0x48))();
  if (pcStackY_70 != (code *)0x0) {
    LOCK();
    pcVar2 = pcStackY_70 + 8;
    lVar3 = *(longlong *)pcVar2;
    *(longlong *)pcVar2 = *(longlong *)pcVar2 + -1;
    UNLOCK();
    if (lVar3 == 0) {
      (**(code **)(*(longlong *)pcStackY_70 + 0x10))();
      std::__shared_weak_count::__release_weak();
    }
  }
  return;
