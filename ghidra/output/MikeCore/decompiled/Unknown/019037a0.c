...
void FUN_019037a0(double param_1,double *param_2,longlong *param_3)
...
LAB_01903a01:
    ...
    iVar12 = *(int *)(*(longlong *)(unaff_RDI + 0x38) + 0xc);
    local_40 = dVar1;
    if ((local_38[0] != '\0') && (dVar2 != 0.0)) {
      dVar13 = (double)FUN_00d50b20();
    }
    ...
    if (iVar12 != 0) {
      ...
      *pcVar5 = '\0';
      ...
      if (dVar2 == dVar1) {
        iVar10 = *(int *)(*(longlong *)(unaff_RDI + 0x38) + 0xc) + -1;
      }
      else {
  ...
  if (iVar10 < *(int *)(*(longlong *)(unaff_RDI + 0x38) + 0xc)) {
    ...
    if ((local_78 != 0.0) || (NAN(local_78))) {
      do {
        ...
        lVar11 = lVar11 + 1;
      } while (lVar11 < *(int *)(*(longlong *)(unaff_RDI + 0x38) + 0xc));
    }
    else {
      do {
        cVar3 = FUN_00e7c7f0();
...
LAB_01903c58:
  ...
  if (lVar11 != 0) {
    ...
    for (lVar8 = 0; local_58 = (int)lVar8, local_58 < *(int *)(lVar11 + 0xc); lVar8 = lVar8 + 1) {
      local_90 = *(undefined8 *)(*(longlong *)(lVar11 + 0x10) + lVar8 * 8);
      local_88 = 0;
