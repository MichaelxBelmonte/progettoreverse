...

{
  ...
  uVar11 = unaff_RDI[4] + (uVar1 << 5 | uVar1 >> 0x1b) + uVar32 + ((uVar4 ^ uVar3) & uVar2 ^ uVar4)
           + 0x5a827999;
  ...
  *unaff_RDI = (uVar6 << 1 | (uint)((int)uVar6 < 0)) + uVar1 + uVar25 + (uVar5 ^ uVar17 ^ uVar9) +
               (uVar33 * 0x20 | uVar33 >> 0x1b) + 0xca62c1d6;
  unaff_RDI[1] = uVar33 + uVar2;
  unaff_RDI[2] = (uVar9 * 0x40000000 | uVar9 >> 2) + uVar3;
  unaff_RDI[3] = uVar5 + uVar4;
  unaff_RDI[4] = uVar17 + unaff_RDI[4];
  return;
}
