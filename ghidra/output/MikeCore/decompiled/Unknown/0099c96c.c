...
//   "virtual void pace::ILok2Commander::WriteStorageRecordData(const CMD_CmmdPayload_WriteStorageRecordD...


void FUN_0099c96c(undefined8 param_1,undefined8 param_2)

{
  ...
  if (unaff_RDI[7] == 0) {
    FUN_00925fd0();
    uVar1 = FUN_00926010();
    uVar3 = FUN_00928ab0("virtual void pace::ILok2Commander::WriteStorageRecordData(const CMD_CmmdPayload_WriteStorageRecordData_Struct &, const vector<uint8_t> &, CMD_RsltPayload_WriteStorageRecordData_Struct &)"
                         ,0x6b0);
    FUN_009c720b(uVar3,uVar1);
  }
  uVar3 = (**(code **)(*unaff_RDI + 0x100))(&local_110,param_2);
