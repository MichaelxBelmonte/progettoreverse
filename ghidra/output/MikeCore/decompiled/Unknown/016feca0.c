...
/* WARNING: Removing unreachable block (ram,0x016ff927) */
/* WARNING: Removing unreachable block (ram,0x016ff934) */
/* WARNING: Removing unreachable block (ram,0x016ff0dc) */
/* WARNING: Removing unreachable block (ram,0x016ff0e5) */
/* WARNING: Removing unreachable block (ram,0x016ff5c4) */
/* WARNING: Removing unreachable block (ram,0x016ff5cd) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_016feca0(pthread_key_t param_1,char param_2)

{
  ...
  dVar8 = local_40;
  if (*(int *)(*(longlong *)(unaff_RDI + 0x60) + 0xc) < 2) {
    return;
  }
  if (*unaff_RSI == **(longlong **)(*(longlong *)(unaff_RDI + 0x60) + 0x10)) {
    return;
  }
...
LAB_016fee8f:
  ...
  FUN_01909dc0();
  FUN_00e7b970();
  if ((ulonglong)dVar7 >> 0x20 != 0) {
    bVar9 = FUN_00e7c6b0();
    bVar22 = bVar22 & bVar9;
  }
  pvVar13 = _pthread_getspecific(param_1);
  lVar15 = unaff_RDI + 0x50;
  if (pvVar13 != (void *)0x0) {
    FUN_00e8b990();
  }
  dVar3 = (double)FUN_018fd630();
  pvVar13 = _pthread_getspecific((pthread_key_t)lVar15);
  if (pvVar13 != (void *)0x0) {
    FUN_00e8b990();
  }
  dVar25 = (double)FUN_018fd630();
  bVar19 = dVar3 / dVar25 <= DAT_023b1e80 && DAT_024119f8 <= dVar3 / dVar25;
  uVar17 = CONCAT71((int7)((ulonglong)lVar15 >> 8),bVar19);
  pVar20 = (pthread_key_t)uVar17;
  if ((bVar19 & bVar22) != 0) {
    local_a0 = dVar25;
    ...
    FUN_00c92170();
    FUN_00c92160();
    dVar3 = DAT_023b4df8 / dVar3;
    dVar34 = DAT_023b4df8 / local_a0;
    pdVar2 = *(double **)((longlong)dVar7 + 0x10);
    auVar30._0_8_ = (dVar3 + local_118) * _DAT_02411890;
    ...
    dVar26 = DAT_024119a8 * (_UNK_024118a8 * dVar34 + dVar25);
    *pdVar2 = (_DAT_024118a0 * dVar34 + dVar25) * 0.0 + auVar31._0_8_;
    ...
    pdVar2[2] = (_DAT_024118d0 * dVar34 + dVar25) * _DAT_024118e0 +
                (_DAT_024118b0 * dVar3 + local_118) * _DAT_024118c0;
    pdVar2[3] = dVar32 + dVar26;
    dVar26 = (_UNK_024118f8 * dVar3 + local_118) * _UNK_02411908;
    dVar33 = (_UNK_02411918 * dVar34 + dVar25) * _UNK_02411928;
    dVar32 = (dVar3 * _DAT_02411930 + local_118) * _DAT_02411940;
    dVar27 = (dVar3 * _UNK_02411938 + local_118) * _UNK_02411948;
    dVar28 = dVar34 * _DAT_02411950;
    dVar29 = dVar34 * _UNK_02411958;
    pdVar2[4] = (_DAT_02411910 * dVar34 + dVar25) * _DAT_02411920 +
                (_DAT_024118f0 * dVar3 + local_118) * _DAT_02411900;
    pdVar2[5] = dVar33 + dVar26;
    dVar26 = (dVar29 + dVar25) * _UNK_02411968;
    pdVar2[6] = (dVar28 + dVar25) * _DAT_02411960 + dVar32;
    pdVar2[7] = dVar26 + dVar27;
    dVar3 = (dVar3 * DAT_0241c3f0 + local_118) * _DAT_02411a00;
    pdVar2[8] = (dVar25 - dVar34) * _DAT_02411a08 + dVar3;
    local_138 = dVar7;
    ...
    if (dVar7 != local_a0) {
      pvVar13 = _pthread_getspecific((pthread_key_t)uVar14);
      if (pvVar13 != (void *)0x0) {
        FUN_00e8b990();
      }
      local_158 = dVar7;
    ...
    do {
      ...
      FUN_00e7c260();
      uVar24 = FUN_01907b60((int)*(undefined8 *)
                                  (*(longlong *)((longlong)local_138 + 0x10) +
                                  (longlong)(int)local_78 * 8));
      local_e8 = 0;
      if (local_38 == '\0') {
        if (dVar7 != 0.0) {
          uVar24 = FUN_00d50b00();
    ...
    FUN_00d4ff40();
    *puVar18 = &DAT_025fa538;
    uVar6 = _UNK_0239372c;
    uVar5 = _UNK_02393728;
    uVar24 = _UNK_02393724;
    *(undefined4 *)((longlong)puVar18 + 0xc) = _DAT_02393720;
    *(undefined4 *)(puVar18 + 2) = uVar24;
    *(undefined4 *)((longlong)puVar18 + 0x14) = uVar5;
    *(undefined4 *)(puVar18 + 3) = uVar6;
    uVar24 = FUN_00d500e0();
  ...
  lVar23 = 0;
  while( true ) {
    pvVar13 = _pthread_getspecific((pthread_key_t)uVar17);
    if (pvVar13 != (void *)0x0) {
      FUN_00e8b990();
    }
    uVar4 = FUN_018fcb10();
    *(undefined8 *)(*(longlong *)((longlong)dVar7 + 0x10) + lVar23 * 8) = uVar4;
    FUN_00e7c260();
    lVar15 = local_98;
    dVar3 = local_b0;
    if (lVar23 == 10) break;
  ...
  lVar16 = (longlong)local_a4;
  lVar23 = *(longlong *)((longlong)dVar7 + 0x10);
  *(double *)(lVar23 + lVar16 * 8) =
       (*(double *)(lVar23 + -8 + lVar16 * 8) + *(double *)(lVar23 + 8 + lVar16 * 8)) * DAT_023942d0
  ;
  iStack_6c = (int)((ulonglong)local_b0 >> 0x20);
  if (local_40 == 0.0) {
    FUN_00e7c280();
    pVar20 = (pthread_key_t)lVar23;
    FUN_00e7c280();
    FUN_00e7c280();
  }
  else {
...
LAB_016ffc7b:
  local_58 = CONCAT44((int)((ulonglong)dVar7 >> 0x20),1);
  uVar24 = FUN_00e7c260();
  ...
  if (-1 < (int)pVar20) {
    uVar14 = (ulonglong)(uint)(local_a4 - iVar11);
    lVar23 = (longlong)(local_a4 - iVar11);
    iVar11 = iVar12 + iVar11 + 1;
    do {
      lVar15 = *(longlong *)((longlong)dVar7 + 0x10);
      ...
      uVar24 = FUN_01907b60(SUB84(dStack_130 * _UNK_02411858 +
                                  dVar3 * DAT_024119b8 +
                                  local_a0 * _DAT_024119b0 + local_118 * DAT_024119a8 +
                                  local_138 * _DAT_02411850,0));
      local_b8 = 0;
      if (local_38 == '\0') {
        if (local_40 != 0.0) {
          uVar24 = FUN_00d50b00();
