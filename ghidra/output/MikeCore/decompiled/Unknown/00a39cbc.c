...
void FUN_00a39cbc(undefined8 param_1,undefined8 param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a39d61:
    if ((plVar16 == plVar4) || ((longlong)plVar16 - (longlong)plVar3 == -8)) goto LAB_00a39d6f;
    lVar17 = (longlong)plVar16 - (longlong)plVar3 >> 3;
  }
  else {
    do {
      if ((void *)*plVar16 == pvVar12) goto LAB_00a39d61;
      plVar16 = plVar16 + 1;
...
LAB_00a39d6f:
  ...
  *(longlong *)(lVar10 + 0x18) = lVar5 + lVar17 * 8 + ((longlong)pvVar11 >> 3) * 8;
  ...
  pvVar12 = (void *)((longlong)pvVar9 + lVar17 * 0xa0);
  pvVar11 = (void *)((longlong)pvVar9 + lVar17 * 0xa0 + 0xa0);
  pvVar15 = pvVar12;
  if (pvVar11 != pvVar6) {
    do {
      pvVar15 = (void *)((longlong)pvVar12 + 0xa0);
      FUN_00aaac2a();
      sVar14 = (size_t)param_3;
      pvVar11 = (void *)((longlong)pvVar12 + 0x140);
      pvVar12 = pvVar15;
    } while (pvVar11 != pvVar6);
    pvVar11 = *(void **)(lVar13 + 0x50);
    if (pvVar11 == pvVar15) goto LAB_00a39ea7;
  }
  do {
    puVar1 = (undefined8 *)((longlong)pvVar11 + -0xa0);
    pvVar11 = (void *)((longlong)pvVar11 + -0xa0);
    (**(code **)*puVar1)();
    sVar14 = (size_t)param_3;
...
LAB_00a39ea7:
  *(void **)(lVar13 + 0x50) = pvVar15;
  ...
  if (plVar4 != (longlong *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00a39f34. Too many branches */
