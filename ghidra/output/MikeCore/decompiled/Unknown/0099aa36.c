...
//   "virtual bool pace::ILok2Commander::GenerateAuthProtocolSignature(const CMD_CmmdPayload_GenerateAuth...


undefined4 FUN_0099aa36(void *param_1,undefined8 param_2)

{
  ...
  if (unaff_RDI[7] == 0) {
    FUN_00925fd0();
    uVar1 = FUN_00926010();
    uVar3 = FUN_00928ab0("virtual bool pace::ILok2Commander::GenerateAuthProtocolSignature(const CMD_CmmdPayload_GenerateAuthProtocolSignature_Struct &, CMD_RsltPayload_GenerateAuthProtocolSignature_Struct &, BIG_CompactSignatureECDSA_Struct &)"
                         ,0x47a);
    uVar3 = FUN_009c720b(uVar3,uVar1);
  }
  uVar3 = (**(code **)(*unaff_RDI + 0xa0))(uVar3,&local_110);
  (**(code **)(*(longlong *)unaff_RDI[7] + 0x10))(uVar3,&local_278);
  (**(code **)(*unaff_RDI + 600))(0,0,param_2,&local_48);
  pvVar2 = local_50;
  uVar3 = (**(code **)(*unaff_RDI + 0xa8))(local_50,&local_48);
  if (local_48 != 0) {
    lStack_40 = local_48;
