...
/* WARNING: Removing unreachable block (ram,0x01544be0) */
/* WARNING: Removing unreachable block (ram,0x01544bec) */
/* WARNING: Removing unreachable block (ram,0x01544b95) */
/* WARNING: Removing unreachable block (ram,0x01544ba1) */

void FUN_015446f0(longlong *param_1,undefined8 param_2,longlong *param_3,uint param_4)

{
  ...
  longlong *unaff_RSI;
  longlong unaff_RDI;
  pthread_key_t local_res8;
  int local_68 [12];
  longlong local_38;
  
  local_38 = *(longlong *)PTR____stack_chk_guard_024a9898;
  FUN_01717720();
  iVar6 = *(int *)(*unaff_RSI + 0x18);
  iVar5 = iVar6 + 3;
  if (-1 < iVar6) {
    iVar5 = iVar6;
  }
  ...
  if (3 < iVar6) {
    ...
    do {
      if (iVar6 != -1000000) {
        ...
        FUN_017dca70();
        if (uVar9 != param_4) {
          if ((*(float *)(unaff_RDI + 0x7c) != DAT_0239424c) ||
             (NAN(*(float *)(unaff_RDI + 0x7c)) || NAN(DAT_0239424c))) {
            pvVar7 = _pthread_getspecific(local_res8);
            if (pvVar7 != (void *)0x0) {
              FUN_00e8b990();
            }
            uVar2 = FUN_017dde10();
            lVar8 = *(longlong *)(*(longlong *)(*param_3 + 0x10) + uVar9 * 8);
            ...
            if ((uVar2 & 8) == 0) {
              ...
              if (iVar1 < (int)uVar4) {
                do {
                  if (*(longlong *)(*(longlong *)(lVar8 + 0x10) + lVar11 * 8) != 0) {
      ...
      if (uVar9 + 1 == (ulonglong)(uint)(iVar5 >> 2)) break;
      uVar9 = uVar9 + 1;
      iVar6 = *(int *)(*(longlong *)(*unaff_RSI + 0x10) + uVar9 * 4);
    } while( true );
  }
