...

{
  ...
  do {
    ...
    auVar33 = vpshufb_avx2(auVar32,_DAT_0108d000);
    auVar43 = vpsrld_avx2(auVar10,6);
    ...
    auVar13 = vpaddd_avx2(auVar13,_DAT_0108c800);
    ...
    auVar45 = vpsrld_avx2(auVar6,2);
    auVar31 = vpslld_avx2(auVar6,0x1e);
    auVar13 = vpaddd_avx2(auVar13,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
    ...
    auVar13 = vpaddd_avx2(auVar13,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
    ...
    local_2e0 = vpshufb_avx2(auVar29,_DAT_0108d000);
    auVar43 = vpsrld_avx2(auVar9,6);
    ...
    auVar12 = vpaddd_avx2(auVar12,_DAT_0108c820);
    ...
    auVar45 = vpsrld_avx2(auVar13,2);
    auVar31 = vpslld_avx2(auVar13,0x1e);
    auVar12 = vpaddd_avx2(auVar12,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
    ...
    auVar12 = vpaddd_avx2(auVar12,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
    ...
    local_2c0 = vpshufb_avx2(auVar30,_DAT_0108d000);
    auVar43 = vpsrld_avx2(auVar8,6);
    ...
    auVar11 = vpaddd_avx2(auVar11,_DAT_0108c840);
    ...
    auVar45 = vpsrld_avx2(auVar12,2);
    auVar31 = vpslld_avx2(auVar12,0x1e);
    auVar11 = vpaddd_avx2(auVar11,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
    ...
    auVar11 = vpaddd_avx2(auVar11,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
    ...
    local_2a0 = vpshufb_avx2(auVar31,_DAT_0108d000);
    auVar43 = vpsrld_avx2(auVar7,6);
    ...
    auVar10 = vpaddd_avx2(auVar10,_DAT_0108c860);
    ...
    auVar45 = vpsrld_avx2(auVar11,2);
    auVar31 = vpslld_avx2(auVar11,0x1e);
    auVar10 = vpaddd_avx2(auVar10,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
    ...
    auVar10 = vpaddd_avx2(auVar10,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
    ...
    local_280 = vpshufb_avx2(auVar34,_DAT_0108d000);
    auVar43 = vpsrld_avx2(auVar6,6);
    ...
    auVar9 = vpaddd_avx2(auVar9,_DAT_0108c880);
    ...
    auVar45 = vpsrld_avx2(auVar10,2);
    auVar31 = vpslld_avx2(auVar10,0x1e);
    auVar9 = vpaddd_avx2(auVar9,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
    ...
    auVar9 = vpaddd_avx2(auVar9,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
    ...
    local_260 = vpshufb_avx2(auVar35,_DAT_0108d000);
    auVar43 = vpsrld_avx2(auVar13,6);
    ...
    auVar8 = vpaddd_avx2(auVar8,_DAT_0108c8a0);
    ...
    auVar45 = vpsrld_avx2(auVar9,2);
    auVar31 = vpslld_avx2(auVar9,0x1e);
    auVar8 = vpaddd_avx2(auVar8,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
    ...
    auVar8 = vpaddd_avx2(auVar8,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
    ...
    local_240 = vpshufb_avx2(auVar36,_DAT_0108d000);
    auVar43 = vpsrld_avx2(auVar12,6);
    ...
    auVar7 = vpaddd_avx2(auVar7,_DAT_0108c8c0);
    ...
    auVar45 = vpsrld_avx2(auVar8,2);
    auVar31 = vpslld_avx2(auVar8,0x1e);
    auVar7 = vpaddd_avx2(auVar7,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
    ...
    auVar7 = vpaddd_avx2(auVar7,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
    ...
    auVar32 = vpunpckldq_avx2(ZEXT1632(auVar15),ZEXT1632(auVar14));
    auVar43._0_16_ = ZEXT116(0) * auVar32._0_16_ + ZEXT116(1) * auVar17._0_16_;
    auVar43._16_16_ = ZEXT116(0) * auVar17._16_16_ + ZEXT116(1) * auVar32._0_16_;
    local_220 = vpshufb_avx2(auVar43,_DAT_0108d000);
    auVar43 = vpsrld_avx2(auVar11,6);
    ...
    auVar6 = vpaddd_avx2(auVar6,_DAT_0108c8e0);
    ...
    auVar45 = vpsrld_avx2(auVar7,2);
    auVar31 = vpslld_avx2(auVar7,0x1e);
    auVar6 = vpaddd_avx2(auVar6,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
    ...
    auVar6 = vpaddd_avx2(auVar6,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
    ...
    local_200 = vpshufb_avx2(auVar45,_DAT_0108d000);
    auVar43 = vpsrld_avx2(auVar10,6);
    auVar34 = vpslld_avx2(auVar10,0x1a);
    auVar13 = vpaddd_avx2(local_200,auVar13);
    auVar29 = vpsrld_avx2(auVar10,0xb);
    auVar35 = vpslld_avx2(auVar10,0x15);
    auVar13 = vpaddd_avx2(auVar13,_DAT_0108c900);
    auVar30 = vpsrld_avx2(auVar10,0x19);
    auVar36 = vpslld_avx2(auVar10,7);
    auVar32 = vpandn_avx2(auVar10,auVar12);
    auVar17 = vpand_avx2(auVar10,auVar11);
    ...
    auVar32 = vpunpckldq_avx2(ZEXT1632(auVar15),ZEXT1632(auVar14));
    auVar44._0_16_ = ZEXT116(0) * auVar32._0_16_ + ZEXT116(1) * auVar17._0_16_;
    auVar44._16_16_ = ZEXT116(0) * auVar17._16_16_ + ZEXT116(1) * auVar32._0_16_;
    local_1e0 = vpshufb_avx2(auVar44,_DAT_0108d000);
    auVar43 = vpsrld_avx2(auVar9,6);
    auVar34 = vpslld_avx2(auVar9,0x1a);
    auVar12 = vpaddd_avx2(local_1e0,auVar12);
    auVar29 = vpsrld_avx2(auVar9,0xb);
    auVar35 = vpslld_avx2(auVar9,0x15);
    auVar12 = vpaddd_avx2(auVar12,_DAT_0108c920);
    auVar30 = vpsrld_avx2(auVar9,0x19);
    auVar36 = vpslld_avx2(auVar9,7);
    auVar32 = vpandn_avx2(auVar9,auVar11);
    auVar17 = vpand_avx2(auVar9,auVar10);
    ...
    local_1c0 = vpshufb_avx2(auVar37,_DAT_0108d000);
    auVar43 = vpsrld_avx2(auVar8,6);
    auVar34 = vpslld_avx2(auVar8,0x1a);
    auVar11 = vpaddd_avx2(local_1c0,auVar11);
    auVar29 = vpsrld_avx2(auVar8,0xb);
    auVar35 = vpslld_avx2(auVar8,0x15);
    auVar11 = vpaddd_avx2(auVar11,_DAT_0108c940);
    auVar30 = vpsrld_avx2(auVar8,0x19);
    auVar36 = vpslld_avx2(auVar8,7);
    auVar32 = vpandn_avx2(auVar8,auVar10);
    auVar17 = vpand_avx2(auVar8,auVar9);
    ...
    local_1a0 = vpshufb_avx2(auVar38,_DAT_0108d000);
    auVar43 = vpsrld_avx2(auVar7,6);
    auVar34 = vpslld_avx2(auVar7,0x1a);
    auVar10 = vpaddd_avx2(local_1a0,auVar10);
    auVar29 = vpsrld_avx2(auVar7,0xb);
    auVar35 = vpslld_avx2(auVar7,0x15);
    auVar10 = vpaddd_avx2(auVar10,_DAT_0108c960);
    auVar30 = vpsrld_avx2(auVar7,0x19);
    auVar36 = vpslld_avx2(auVar7,7);
    auVar32 = vpandn_avx2(auVar7,auVar9);
    auVar17 = vpand_avx2(auVar7,auVar8);
    ...
    local_180 = vpshufb_avx2(auVar39,_DAT_0108d000);
    auVar43 = vpsrld_avx2(auVar6,6);
    auVar34 = vpslld_avx2(auVar6,0x1a);
    auVar9 = vpaddd_avx2(local_180,auVar9);
    auVar29 = vpsrld_avx2(auVar6,0xb);
    auVar35 = vpslld_avx2(auVar6,0x15);
    auVar9 = vpaddd_avx2(auVar9,_DAT_0108c980);
    auVar30 = vpsrld_avx2(auVar6,0x19);
    auVar36 = vpslld_avx2(auVar6,7);
    auVar32 = vpandn_avx2(auVar6,auVar8);
    auVar17 = vpand_avx2(auVar6,auVar7);
    ...
    auVar32 = vpunpckldq_avx2(ZEXT1632(auVar15),ZEXT1632(auVar14));
    auVar40._0_16_ = ZEXT116(0) * auVar32._0_16_ + ZEXT116(1) * auVar17._0_16_;
    auVar40._16_16_ = ZEXT116(0) * auVar17._16_16_ + ZEXT116(1) * auVar32._0_16_;
    local_160 = vpshufb_avx2(auVar40,_DAT_0108d000);
    auVar43 = vpsrld_avx2(auVar13,6);
    auVar34 = vpslld_avx2(auVar13,0x1a);
    auVar8 = vpaddd_avx2(local_160,auVar8);
    auVar29 = vpsrld_avx2(auVar13,0xb);
    auVar35 = vpslld_avx2(auVar13,0x15);
    auVar8 = vpaddd_avx2(auVar8,_DAT_0108c9a0);
    auVar30 = vpsrld_avx2(auVar13,0x19);
    auVar36 = vpslld_avx2(auVar13,7);
    auVar32 = vpandn_avx2(auVar13,auVar7);
    auVar17 = vpand_avx2(auVar13,auVar6);
    ...
    auVar12 = vpaddd_avx2(auVar12,auVar8);
    auVar8 = vpaddd_avx2(auVar10 ^ auVar17,auVar8);
    auVar17 = vpaddd_avx2(auVar8,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
    ...
    auVar8 = vpunpckldq_avx2(ZEXT1632(auVar14),ZEXT1632(auVar16));
    auVar14 = vpinsrd_avx(ZEXT416(puVar22[0xe]),puVar24[0xe],1);
    auVar32 = vpunpckldq_avx2(ZEXT1632(auVar15),ZEXT1632(auVar14));
    auVar41._0_16_ = ZEXT116(0) * auVar32._0_16_ + ZEXT116(1) * auVar8._0_16_;
    auVar41._16_16_ = ZEXT116(0) * auVar8._16_16_ + ZEXT116(1) * auVar32._0_16_;
    local_140 = vpshufb_avx2(auVar41,_DAT_0108d000);
    auVar43 = vpsrld_avx2(auVar12,6);
    auVar34 = vpslld_avx2(auVar12,0x1a);
    auVar7 = vpaddd_avx2(local_140,auVar7);
    auVar29 = vpsrld_avx2(auVar12,0xb);
    auVar35 = vpslld_avx2(auVar12,0x15);
    auVar7 = vpaddd_avx2(auVar7,_DAT_0108c9c0);
    auVar30 = vpsrld_avx2(auVar12,0x19);
    auVar36 = vpslld_avx2(auVar12,7);
    auVar32 = vpandn_avx2(auVar12,auVar6);
    auVar8 = vpand_avx2(auVar12,auVar13);
    auVar45 = vpsrld_avx2(auVar17,2);
    auVar31 = vpslld_avx2(auVar17,0x1e);
    auVar7 = vpaddd_avx2(auVar7,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
    auVar29 = vpsrld_avx2(auVar17,0xd);
    auVar30 = vpslld_avx2(auVar17,0x13);
    auVar7 = vpaddd_avx2(auVar7,auVar32 ^ auVar8);
    auVar8 = vpand_avx2(auVar10 ^ auVar9,auVar9 ^ auVar17);
    auVar32 = vpsrld_avx2(auVar17,0x16);
    auVar34 = vpslld_avx2(auVar17,10);
    auVar11 = vpaddd_avx2(auVar11,auVar7);
    auVar7 = vpaddd_avx2(auVar9 ^ auVar8,auVar7);
    auVar8 = vpaddd_avx2(auVar7,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
    puVar5 = puVar25 + 0xf;
    ...
    local_120 = vpshufb_avx2(auVar42,_DAT_0108d000);
    ...
    auVar6 = vpaddd_avx2(auVar6,_DAT_0108c9e0);
    auVar31 = vpsrld_avx2(auVar11,0x19);
    auVar43 = vpslld_avx2(auVar11,7);
    auVar32 = vpandn_avx2(auVar11,auVar13);
    auVar7 = vpand_avx2(auVar11,auVar12);
    auVar44 = vpsrld_avx2(auVar8,2);
    auVar34 = vpslld_avx2(auVar8,0x1e);
    auVar29 = auVar17 ^ auVar8;
    auVar6 = vpaddd_avx2(auVar6,auVar45 ^ auVar35 ^ auVar30 ^ auVar36 ^ auVar31 ^ auVar43);
    auVar30 = vpsrld_avx2(auVar8,0xd);
    auVar35 = vpslld_avx2(auVar8,0x13);
    auVar6 = vpaddd_avx2(auVar6,auVar32 ^ auVar7);
    auVar32 = vpand_avx2(auVar9 ^ auVar17,auVar29);
    auVar31 = vpsrld_avx2(auVar8,0x16);
    auVar36 = vpslld_avx2(auVar8,10);
    auVar7 = vpaddd_avx2(auVar10,auVar6);
    auVar6 = vpaddd_avx2(auVar17 ^ auVar32,auVar6);
    auVar6 = vpaddd_avx2(auVar6,auVar44 ^ auVar34 ^ auVar30 ^ auVar35 ^ auVar31 ^ auVar36);
    iVar18 = 3;
    pauVar20 = (undefined1 (*) [32])&DAT_0108c980;
    do {
      auVar10 = vpaddd_avx2(auVar33,local_1e0);
      auVar43 = vpsrld_avx2(local_2e0,3);
      ...
      auVar10 = vpaddd_avx2(auVar10,auVar43 ^ auVar33 ^ auVar31 ^ auVar32 ^ auVar34);
      ...
      auVar10 = vpaddd_avx2(auVar33,auVar13);
      ...
      auVar43 = vpslld_avx2(auVar7,7);
      auVar32 = vpandn_avx2(auVar7,auVar12);
      auVar13 = vpand_avx2(auVar7,auVar11);
      auVar44 = vpsrld_avx2(auVar6,2);
      auVar34 = vpslld_avx2(auVar6,0x1e);
      auVar10 = vpaddd_avx2(auVar10,auVar45 ^ auVar35 ^ auVar30 ^ auVar36 ^ auVar31 ^ auVar43);
      auVar30 = vpsrld_avx2(auVar6,0xd);
      auVar31 = vpslld_avx2(auVar6,0x13);
      auVar10 = vpaddd_avx2(auVar10,auVar32 ^ auVar13);
      auVar13 = vpand_avx2(auVar29,auVar8 ^ auVar6);
      auVar32 = vpsrld_avx2(auVar6,0x16);
      auVar29 = vpslld_avx2(auVar6,10);
      auVar9 = vpaddd_avx2(auVar9,auVar10);
      auVar10 = vpaddd_avx2(auVar8 ^ auVar13,auVar10);
      auVar10 = vpaddd_avx2(auVar10,auVar44 ^ auVar34 ^ auVar30 ^ auVar31 ^ auVar32 ^ auVar29);
      auVar13 = vpaddd_avx2(local_2e0,local_1c0);
      auVar43 = vpsrld_avx2(local_2c0,3);
      ...
      auVar13 = vpaddd_avx2(auVar13,auVar43 ^ auVar32 ^ auVar31 ^ auVar29 ^ auVar34);
      auVar32 = vpsrld_avx2(local_120,0x13);
      auVar29 = vpslld_avx2(local_120,0xd);
      local_2e0 = vpaddd_avx2(auVar13,auVar36 ^ auVar30 ^ auVar35 ^ auVar32 ^ auVar29);
      auVar43 = vpsrld_avx2(auVar9,6);
      auVar34 = vpslld_avx2(auVar9,0x1a);
      auVar12 = vpaddd_avx2(local_2e0,auVar12);
      auVar29 = vpsrld_avx2(auVar9,0xb);
      auVar35 = vpslld_avx2(auVar9,0x15);
      auVar12 = vpaddd_avx2(auVar12,pauVar20[5]);
      auVar30 = vpsrld_avx2(auVar9,0x19);
      auVar36 = vpslld_avx2(auVar9,7);
      auVar32 = vpandn_avx2(auVar9,auVar11);
      auVar13 = vpand_avx2(auVar9,auVar7);
      auVar45 = vpsrld_avx2(auVar10,2);
      auVar31 = vpslld_avx2(auVar10,0x1e);
      auVar12 = vpaddd_avx2(auVar12,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
      auVar29 = vpsrld_avx2(auVar10,0xd);
      auVar34 = vpslld_avx2(auVar10,0x13);
      auVar12 = vpaddd_avx2(auVar12,auVar32 ^ auVar13);
      auVar32 = vpand_avx2(auVar8 ^ auVar6,auVar6 ^ auVar10);
      auVar30 = vpsrld_avx2(auVar10,0x16);
      auVar35 = vpslld_avx2(auVar10,10);
      auVar13 = vpaddd_avx2(auVar17,auVar12);
      auVar12 = vpaddd_avx2(auVar6 ^ auVar32,auVar12);
      auVar12 = vpaddd_avx2(auVar12,auVar45 ^ auVar31 ^ auVar29 ^ auVar34 ^ auVar30 ^ auVar35);
      auVar17 = vpaddd_avx2(local_2c0,local_1a0);
      auVar43 = vpsrld_avx2(local_2a0,3);
      ...
      auVar17 = vpaddd_avx2(auVar17,auVar43 ^ auVar32 ^ auVar31 ^ auVar29 ^ auVar34);
      ...
      auVar36 = vpslld_avx2(auVar13,7);
      auVar32 = vpandn_avx2(auVar13,auVar7);
      auVar17 = vpand_avx2(auVar13,auVar9);
      auVar45 = vpsrld_avx2(auVar12,2);
      auVar31 = vpslld_avx2(auVar12,0x1e);
      auVar11 = vpaddd_avx2(auVar11,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
      auVar29 = vpsrld_avx2(auVar12,0xd);
      auVar30 = vpslld_avx2(auVar12,0x13);
      auVar11 = vpaddd_avx2(auVar11,auVar32 ^ auVar17);
      auVar17 = vpand_avx2(auVar6 ^ auVar10,auVar10 ^ auVar12);
      auVar32 = vpsrld_avx2(auVar12,0x16);
      auVar34 = vpslld_avx2(auVar12,10);
      auVar8 = vpaddd_avx2(auVar8,auVar11);
      auVar11 = vpaddd_avx2(auVar10 ^ auVar17,auVar11);
      auVar11 = vpaddd_avx2(auVar11,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
      auVar17 = vpaddd_avx2(local_2a0,local_180);
      auVar43 = vpsrld_avx2(local_280,3);
      ...
      auVar30 = vpsrld_avx2(auVar8,0x19);
      auVar36 = vpslld_avx2(auVar8,7);
      auVar32 = vpandn_avx2(auVar8,auVar9);
      ...
      auVar30 = vpslld_avx2(auVar11,0x13);
      auVar7 = vpaddd_avx2(auVar7,auVar32 ^ auVar17);
      auVar17 = vpand_avx2(auVar10 ^ auVar12,auVar12 ^ auVar11);
      auVar32 = vpsrld_avx2(auVar11,0x16);
      auVar34 = vpslld_avx2(auVar11,10);
      auVar6 = vpaddd_avx2(auVar6,auVar7);
      auVar7 = vpaddd_avx2(auVar12 ^ auVar17,auVar7);
      auVar7 = vpaddd_avx2(auVar7,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
      auVar17 = vpaddd_avx2(local_280,local_160);
      auVar43 = vpsrld_avx2(local_260,3);
      ...
      auVar29 = vpsrld_avx2(auVar6,0xb);
      auVar35 = vpslld_avx2(auVar6,0x15);
      auVar9 = vpaddd_avx2(auVar9,pauVar20[8]);
      auVar30 = vpsrld_avx2(auVar6,0x19);
      auVar36 = vpslld_avx2(auVar6,7);
      auVar32 = vpandn_avx2(auVar6,auVar13);
      auVar17 = vpand_avx2(auVar6,auVar8);
      auVar45 = vpsrld_avx2(auVar7,2);
      auVar31 = vpslld_avx2(auVar7,0x1e);
      auVar9 = vpaddd_avx2(auVar9,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
      auVar29 = vpsrld_avx2(auVar7,0xd);
      auVar30 = vpslld_avx2(auVar7,0x13);
      auVar9 = vpaddd_avx2(auVar9,auVar32 ^ auVar17);
      auVar17 = vpand_avx2(auVar12 ^ auVar11,auVar11 ^ auVar7);
      auVar32 = vpsrld_avx2(auVar7,0x16);
      auVar34 = vpslld_avx2(auVar7,10);
      ...
      auVar43 = vpsrld_avx2(local_240,3);
      ...
      auVar43 = vpsrld_avx2(auVar10,6);
      auVar34 = vpslld_avx2(auVar10,0x1a);
      auVar13 = vpaddd_avx2(local_260,auVar13);
      auVar29 = vpsrld_avx2(auVar10,0xb);
      auVar35 = vpslld_avx2(auVar10,0x15);
      auVar13 = vpaddd_avx2(auVar13,pauVar20[9]);
      auVar30 = vpsrld_avx2(auVar10,0x19);
      auVar36 = vpslld_avx2(auVar10,7);
      auVar32 = vpandn_avx2(auVar10,auVar8);
      ...
      auVar30 = vpslld_avx2(auVar9,0x13);
      auVar13 = vpaddd_avx2(auVar13,auVar32 ^ auVar17);
      auVar17 = vpand_avx2(auVar11 ^ auVar7,auVar7 ^ auVar9);
      auVar32 = vpsrld_avx2(auVar9,0x16);
      auVar34 = vpslld_avx2(auVar9,10);
      ...
      auVar43 = vpsrld_avx2(local_220,3);
      ...
      auVar43 = vpsrld_avx2(auVar12,6);
      auVar34 = vpslld_avx2(auVar12,0x1a);
      auVar8 = vpaddd_avx2(local_240,auVar8);
      auVar29 = vpsrld_avx2(auVar12,0xb);
      auVar35 = vpslld_avx2(auVar12,0x15);
      auVar8 = vpaddd_avx2(auVar8,pauVar20[10]);
      auVar30 = vpsrld_avx2(auVar12,0x19);
      auVar36 = vpslld_avx2(auVar12,7);
      auVar32 = vpandn_avx2(auVar12,auVar6);
      auVar17 = vpand_avx2(auVar12,auVar10);
      auVar45 = vpsrld_avx2(auVar13,2);
      auVar31 = vpslld_avx2(auVar13,0x1e);
      auVar8 = vpaddd_avx2(auVar8,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
      auVar29 = vpsrld_avx2(auVar13,0xd);
      auVar30 = vpslld_avx2(auVar13,0x13);
      auVar8 = vpaddd_avx2(auVar8,auVar32 ^ auVar17);
      auVar17 = vpand_avx2(auVar7 ^ auVar9,auVar9 ^ auVar13);
      auVar32 = vpsrld_avx2(auVar13,0x16);
      auVar34 = vpslld_avx2(auVar13,10);
      auVar11 = vpaddd_avx2(auVar11,auVar8);
      auVar8 = vpaddd_avx2(auVar9 ^ auVar17,auVar8);
      auVar8 = vpaddd_avx2(auVar8,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
      auVar17 = vpaddd_avx2(local_220,auVar33);
      auVar43 = vpsrld_avx2(local_200,3);
      ...
      auVar30 = vpslld_avx2(auVar8,0x13);
      auVar6 = vpaddd_avx2(auVar6,auVar32 ^ auVar17);
      auVar17 = vpand_avx2(auVar9 ^ auVar13,auVar13 ^ auVar8);
      auVar32 = vpsrld_avx2(auVar8,0x16);
      auVar34 = vpslld_avx2(auVar8,10);
      auVar7 = vpaddd_avx2(auVar7,auVar6);
      auVar6 = vpaddd_avx2(auVar13 ^ auVar17,auVar6);
      auVar6 = vpaddd_avx2(auVar6,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
      auVar17 = vpaddd_avx2(local_200,local_2e0);
      auVar43 = vpsrld_avx2(local_1e0,3);
      ...
      auVar30 = vpslld_avx2(auVar6,0x13);
      auVar10 = vpaddd_avx2(auVar10,auVar32 ^ auVar17);
      auVar17 = vpand_avx2(auVar13 ^ auVar8,auVar8 ^ auVar6);
      auVar32 = vpsrld_avx2(auVar6,0x16);
      auVar34 = vpslld_avx2(auVar6,10);
      auVar9 = vpaddd_avx2(auVar9,auVar10);
      auVar10 = vpaddd_avx2(auVar8 ^ auVar17,auVar10);
      auVar10 = vpaddd_avx2(auVar10,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
      auVar17 = vpaddd_avx2(local_1e0,local_2c0);
      auVar43 = vpsrld_avx2(local_1c0,3);
      ...
      auVar29 = vpsrld_avx2(auVar9,0xb);
      auVar35 = vpslld_avx2(auVar9,0x15);
      auVar12 = vpaddd_avx2(auVar12,pauVar20[0xd]);
      auVar30 = vpsrld_avx2(auVar9,0x19);
      auVar36 = vpslld_avx2(auVar9,7);
      auVar32 = vpandn_avx2(auVar9,auVar11);
      auVar17 = vpand_avx2(auVar9,auVar7);
      auVar45 = vpsrld_avx2(auVar10,2);
      auVar31 = vpslld_avx2(auVar10,0x1e);
      auVar12 = vpaddd_avx2(auVar12,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
      auVar29 = vpsrld_avx2(auVar10,0xd);
      ...
      auVar30 = vpsrld_avx2(auVar10,0x16);
      auVar35 = vpslld_avx2(auVar10,10);
      auVar17 = vpaddd_avx2(auVar13,auVar12);
      auVar12 = vpaddd_avx2(auVar6 ^ auVar32,auVar12);
      auVar12 = vpaddd_avx2(auVar12,auVar45 ^ auVar31 ^ auVar29 ^ auVar34 ^ auVar30 ^ auVar35);
      auVar13 = vpaddd_avx2(local_1c0,local_2a0);
      auVar43 = vpsrld_avx2(local_1a0,3);
      ...
      local_1c0 = vpaddd_avx2(auVar13,auVar36 ^ auVar30 ^ auVar35 ^ auVar32 ^ auVar29);
      auVar43 = vpsrld_avx2(auVar17,6);
      ...
      auVar13 = vpand_avx2(auVar17,auVar9);
      auVar45 = vpsrld_avx2(auVar12,2);
      auVar31 = vpslld_avx2(auVar12,0x1e);
      auVar11 = vpaddd_avx2(auVar11,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
      auVar29 = vpsrld_avx2(auVar12,0xd);
      auVar30 = vpslld_avx2(auVar12,0x13);
      auVar11 = vpaddd_avx2(auVar11,auVar32 ^ auVar13);
      auVar13 = vpand_avx2(auVar6 ^ auVar10,auVar10 ^ auVar12);
      auVar32 = vpsrld_avx2(auVar12,0x16);
      auVar34 = vpslld_avx2(auVar12,10);
      auVar8 = vpaddd_avx2(auVar8,auVar11);
      auVar11 = vpaddd_avx2(auVar10 ^ auVar13,auVar11);
      auVar11 = vpaddd_avx2(auVar11,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
      auVar13 = vpaddd_avx2(local_1a0,local_280);
      auVar43 = vpsrld_avx2(local_180,3);
      ...
      local_1a0 = vpaddd_avx2(auVar13,auVar36 ^ auVar30 ^ auVar35 ^ auVar32 ^ auVar29);
      auVar43 = vpsrld_avx2(auVar8,6);
      auVar34 = vpslld_avx2(auVar8,0x1a);
      ...
      auVar36 = vpslld_avx2(auVar8,7);
      auVar32 = vpandn_avx2(auVar8,auVar9);
      auVar13 = vpand_avx2(auVar8,auVar17);
      auVar45 = vpsrld_avx2(auVar11,2);
      auVar31 = vpslld_avx2(auVar11,0x1e);
      auVar7 = vpaddd_avx2(auVar7,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
      auVar29 = vpsrld_avx2(auVar11,0xd);
      auVar30 = vpslld_avx2(auVar11,0x13);
      auVar7 = vpaddd_avx2(auVar7,auVar32 ^ auVar13);
      auVar13 = vpand_avx2(auVar10 ^ auVar12,auVar12 ^ auVar11);
      auVar32 = vpsrld_avx2(auVar11,0x16);
      auVar34 = vpslld_avx2(auVar11,10);
      auVar6 = vpaddd_avx2(auVar6,auVar7);
      auVar7 = vpaddd_avx2(auVar12 ^ auVar13,auVar7);
      auVar7 = vpaddd_avx2(auVar7,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
      auVar13 = vpaddd_avx2(local_180,local_260);
      auVar43 = vpsrld_avx2(local_160,3);
      ...
      local_180 = vpaddd_avx2(auVar13,auVar36 ^ auVar30 ^ auVar35 ^ auVar32 ^ auVar29);
      auVar43 = vpsrld_avx2(auVar6,6);
      auVar34 = vpslld_avx2(auVar6,0x1a);
      auVar9 = vpaddd_avx2(local_180,auVar9);
      auVar29 = vpsrld_avx2(auVar6,0xb);
      auVar35 = vpslld_avx2(auVar6,0x15);
      auVar9 = vpaddd_avx2(auVar9,pauVar20[0x10]);
      auVar30 = vpsrld_avx2(auVar6,0x19);
      auVar36 = vpslld_avx2(auVar6,7);
      auVar32 = vpandn_avx2(auVar6,auVar17);
      auVar13 = vpand_avx2(auVar6,auVar8);
      auVar45 = vpsrld_avx2(auVar7,2);
      auVar31 = vpslld_avx2(auVar7,0x1e);
      auVar9 = vpaddd_avx2(auVar9,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
      auVar29 = vpsrld_avx2(auVar7,0xd);
      auVar34 = vpslld_avx2(auVar7,0x13);
      auVar9 = vpaddd_avx2(auVar9,auVar32 ^ auVar13);
      auVar32 = vpand_avx2(auVar12 ^ auVar11,auVar11 ^ auVar7);
      auVar30 = vpsrld_avx2(auVar7,0x16);
      auVar35 = vpslld_avx2(auVar7,10);
      auVar13 = vpaddd_avx2(auVar10,auVar9);
      auVar9 = vpaddd_avx2(auVar11 ^ auVar32,auVar9);
      auVar9 = vpaddd_avx2(auVar9,auVar45 ^ auVar31 ^ auVar29 ^ auVar34 ^ auVar30 ^ auVar35);
      auVar10 = vpaddd_avx2(local_160,local_240);
      auVar43 = vpsrld_avx2(local_140,3);
      ...
      auVar10 = vpaddd_avx2(auVar10,auVar43 ^ auVar32 ^ auVar31 ^ auVar29 ^ auVar34);
      ...
      auVar43 = vpsrld_avx2(auVar13,6);
      auVar34 = vpslld_avx2(auVar13,0x1a);
      auVar10 = vpaddd_avx2(local_160,auVar17);
      auVar29 = vpsrld_avx2(auVar13,0xb);
      auVar35 = vpslld_avx2(auVar13,0x15);
      auVar10 = vpaddd_avx2(auVar10,pauVar20[0x11]);
      auVar30 = vpsrld_avx2(auVar13,0x19);
      auVar36 = vpslld_avx2(auVar13,7);
      auVar32 = vpandn_avx2(auVar13,auVar8);
      auVar17 = vpand_avx2(auVar13,auVar6);
      auVar45 = vpsrld_avx2(auVar9,2);
      auVar31 = vpslld_avx2(auVar9,0x1e);
      auVar10 = vpaddd_avx2(auVar10,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
      ...
      auVar10 = vpaddd_avx2(auVar7 ^ auVar17,auVar10);
      auVar17 = vpaddd_avx2(auVar10,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
      auVar10 = vpaddd_avx2(local_140,local_220);
      auVar43 = vpsrld_avx2(local_120,3);
      ...
      auVar43 = vpsrld_avx2(auVar12,6);
      auVar34 = vpslld_avx2(auVar12,0x1a);
      auVar8 = vpaddd_avx2(local_140,auVar8);
      auVar29 = vpsrld_avx2(auVar12,0xb);
      auVar35 = vpslld_avx2(auVar12,0x15);
      auVar8 = vpaddd_avx2(auVar8,pauVar20[0x12]);
      auVar30 = vpsrld_avx2(auVar12,0x19);
      auVar36 = vpslld_avx2(auVar12,7);
      auVar32 = vpandn_avx2(auVar12,auVar6);
      auVar10 = vpand_avx2(auVar12,auVar13);
      auVar45 = vpsrld_avx2(auVar17,2);
      auVar31 = vpslld_avx2(auVar17,0x1e);
      auVar8 = vpaddd_avx2(auVar8,auVar43 ^ auVar34 ^ auVar29 ^ auVar35 ^ auVar30 ^ auVar36);
      auVar29 = vpsrld_avx2(auVar17,0xd);
      ...
      auVar10 = vpand_avx2(auVar7 ^ auVar9,auVar9 ^ auVar17);
      auVar32 = vpsrld_avx2(auVar17,0x16);
      auVar34 = vpslld_avx2(auVar17,10);
      auVar11 = vpaddd_avx2(auVar11,auVar8);
      auVar8 = vpaddd_avx2(auVar9 ^ auVar10,auVar8);
      auVar8 = vpaddd_avx2(auVar8,auVar45 ^ auVar31 ^ auVar29 ^ auVar30 ^ auVar32 ^ auVar34);
      auVar10 = vpaddd_avx2(local_120,local_200);
      auVar43 = vpsrld_avx2(auVar33,3);
      ...
      auVar43 = vpslld_avx2(auVar11,7);
      auVar32 = vpandn_avx2(auVar11,auVar13);
      auVar10 = vpand_avx2(auVar11,auVar12);
      auVar44 = vpsrld_avx2(auVar8,2);
      auVar34 = vpslld_avx2(auVar8,0x1e);
      auVar29 = auVar17 ^ auVar8;
      auVar6 = vpaddd_avx2(auVar6,auVar45 ^ auVar35 ^ auVar30 ^ auVar36 ^ auVar31 ^ auVar43);
      auVar30 = vpsrld_avx2(auVar8,0xd);
      auVar31 = vpslld_avx2(auVar8,0x13);
      auVar6 = vpaddd_avx2(auVar6,auVar32 ^ auVar10);
      auVar10 = vpand_avx2(auVar9 ^ auVar17,auVar29);
      auVar32 = vpsrld_avx2(auVar8,0x16);
      auVar35 = vpslld_avx2(auVar8,10);
      auVar7 = vpaddd_avx2(auVar7,auVar6);
      auVar6 = vpaddd_avx2(auVar17 ^ auVar10,auVar6);
      auVar6 = vpaddd_avx2(auVar6,auVar44 ^ auVar34 ^ auVar30 ^ auVar31 ^ auVar32 ^ auVar35);
      iVar18 = iVar18 + -1;
    ...
    auVar10 = vpand_avx2(auVar17,auVar32);
    auVar9 = vpand_avx2(auVar9,auVar32);
    auVar6 = vpaddd_avx2(auVar6,*unaff_RDI);
    auVar33 = vpand_avx2(auVar7,auVar32);
    auVar7 = vpaddd_avx2(auVar8,unaff_RDI[1]);
    auVar11 = vpand_avx2(auVar11,auVar32);
    auVar8 = vpaddd_avx2(auVar10,unaff_RDI[2]);
    auVar12 = vpand_avx2(auVar12,auVar32);
    auVar9 = vpaddd_avx2(auVar9,unaff_RDI[3]);
    auVar13 = vpand_avx2(auVar13,auVar32);
    auVar10 = vpaddd_avx2(auVar33,*pauVar4);
    auVar11 = vpaddd_avx2(auVar11,unaff_RDI[5]);
    *unaff_RDI = auVar6;
    auVar12 = vpaddd_avx2(auVar12,unaff_RDI[6]);
    unaff_RDI[1] = auVar7;
    auVar13 = vpaddd_avx2(auVar13,unaff_RDI[7]);
    unaff_RDI[2] = auVar8;
    unaff_RDI[3] = auVar9;
    *pauVar4 = auVar10;
    unaff_RDI[5] = auVar11;
