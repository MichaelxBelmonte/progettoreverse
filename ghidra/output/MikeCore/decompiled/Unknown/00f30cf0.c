...
undefined8 * FUN_00f30cf0(undefined *param_1)
...
LAB_00f30fbd:
        bVar2 = pcVar6[1];
        if (((0x7e < (ulonglong)bVar2) ||
            (param_1 = PTR___DefaultRuneLocale_0249c238,
            (PTR___DefaultRuneLocale_0249c238[(ulonglong)bVar2 * 4 + 0x3d] & 1) != 0)) ||
           (bVar2 == 0x5f)) {
        ...
        if (cVar1 == '<') {
          if (pcVar6[1] == '!') {
            ...
            if (pcVar6[1] == '\0') {
              pcVar13 = "!--";
LAB_00f30ed3:
              uVar9 = (ulong)CONCAT71((int7)((ulonglong)uVar10 >> 8),*pcVar13);
            }
          }
        }
        if ((char)uVar9 != '\0') {
          ...
          do {
            ...
            cVar3 = (pcVar6 + 1)[(longlong)puVar8];
            param_1 = puVar8 + 1;
          } while (cVar3 != '\0');
...
LAB_00f30f0d:
          ...
          if (cVar1 == '<') {
            cVar1 = pcVar6[1];
            param_1 = (undefined *)CONCAT71((int7)((ulonglong)param_1 >> 8),cVar1);
            if (cVar1 == '!') {
              if (pcVar6[2] == '\0') {
                pcVar13 = "";
                goto LAB_00f30fb7;
...
LAB_00f30fb7:
  ...
  FUN_00f2dc20();
  *puVar7 = &DAT_025938e0;
  puVar7[10] = &DAT_02802e90;
  puVar7[0xb] = &DAT_02802e90;
  puVar7[0xc] = &DAT_02802e90;
LAB_00f3103c:
  puVar7[3] = unaff_RDI;
  return puVar7;
}
