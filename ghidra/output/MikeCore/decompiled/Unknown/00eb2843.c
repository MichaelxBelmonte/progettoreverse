...
ulonglong FUN_00eb2843(longlong *param_1,undefined8 param_2,ulonglong *param_3,int *param_4)

{
  ...
  if ((longlong *)(lVar6 + uVar19) <= param_1) {
    ...
    if (*(uint *)(unaff_RSI + 0x2c) < uVar8) {
      ...
      lVar9 = local_d8 + 8;
      do {
        uVar16 = (ulonglong)(*(longlong *)(lVar6 + uVar19) * -0x30e4432345000000) >>
...
LAB_00eb2b0e:
    ...
    *(uint *)(unaff_RSI + 0x2c) = (uint)local_c8;
    ...
    uVar19 = (ulonglong)(*param_1 * -0x30e4432345000000) >> (-*(char *)(unaff_RSI + 0x108) & 0x3fU);
