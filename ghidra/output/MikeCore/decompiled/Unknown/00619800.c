...
/* WARNING: Removing unreachable block (ram,0x0061997f) */
/* WARNING: Removing unreachable block (ram,0x0061998b) */

char FUN_00619800(undefined8 param_1,undefined4 param_2)
