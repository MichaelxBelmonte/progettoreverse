...
undefined4 FUN_010710a0(RSA *param_1,undefined8 param_2,RSA *param_3,BN_MONT_CTX *param_4)

{
  ...
  pvVar4 = _CRYPTO_malloc((int)rsa,(char *)((longlong)&section_000000b8.reserved1 + 3),(int)param_3)
  ;
...
joined_r0x010711de:
  ...
  uVar8 = *(uint *)((longlong)&param_1->_method_mod_n + 4);
  if ((uVar8 & 2) != 0) {
    pBVar3 = param_1->n;
    rsa = (char *)n;
