...
longlong * FUN_018feab0(int *param_1,ulonglong param_2)
...
LAB_018feec8:
    ...
    if (((iVar8 == *(int *)(*(longlong *)(unaff_RSI + 0x38) + 0xc) + -2) &&
        (uVar4 = FUN_019079b0(), uVar4 >> 0x20 != 0)) &&
       ((iStack_34 != 0 && (cVar2 = FUN_00e7c020(), cVar2 == '\0')))) {
      lVar6 = lVar6 + 1;
    }
    lVar6 = *(longlong *)(*(longlong *)(*(longlong *)(unaff_RSI + 0x38) + 0x10) + lVar6 * 8);
    *(undefined1 *)(unaff_RDI + 1) = 0;
    if (lVar6 != 0) {
      FUN_00d50b00();
    }
