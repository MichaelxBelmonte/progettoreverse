...
//   "virtual void pace::ILok2Commander::StartAuthProtocolHash(CMD_CmmdPayload_StartAuthProtocolHash_Stru...


void FUN_0099a5e4(undefined8 param_1,undefined8 param_2)

{
  ...
  if (unaff_RDI[7] == 0) {
    FUN_00925fd0();
    uVar1 = FUN_00926010();
    uVar3 = FUN_00928ab0("virtual void pace::ILok2Commander::StartAuthProtocolHash(CMD_CmmdPayload_StartAuthProtocolHash_Struct &, CMD_RsltPayload_StartAuthProtocolHash_Struct &)"
                         ,0x421);
    uVar3 = FUN_009c720b(uVar3,uVar1);
  }
  uVar3 = (**(code **)(*unaff_RDI + 0x90))(uVar3,&local_108);
