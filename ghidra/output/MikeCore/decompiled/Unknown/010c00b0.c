...
ASN1_VALUE * FUN_010c00b0(char *param_1,ASN1_ITEM *param_2,undefined8 param_3,char *param_4)
    ...
    if (0 < iVar2) {
      ...
      do {
        ...
        if (iVar3 != 0) {
          ...
          param_1 = (char *)((longlong)&MACH_HEADER.magic + 1);
        ...
        if (iVar4 != 0) {
          ...
          if (*(char *)(lVar1 + (int)sVar5) != '\0') {
            ...
            if (*(char *)(lVar1 + (int)(sVar6 + sVar5)) == '-') {
              ...
              if (*(char *)(lVar1 + (int)(sVar8 + sVar7 + (int)(((ulonglong)(sVar6 + sVar5) << 0x20)
                                                                + 0x100000000 >> 0x20))) == '\0') {
                ...
                param_2 = (ASN1_ITEM *)((longlong)&segment_command_00000020.vmsize + 1);
...
LAB_010c0527:
        ...
        if (*(int **)(pAVar9 + (ulonglong)(iVar3 != 0) * 8) == (int *)0x0) {
...
LAB_010c03f2:
        ...
        local_40 = param_2;
        if (**(int **)(pAVar9 + (ulonglong)(iVar3 != 0) * 8) != 0) goto LAB_010c03f2;
LAB_010c013a:
        iVar2 = iVar2 + 1;
