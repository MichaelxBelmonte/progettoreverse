...
void FUN_00a26d88(undefined8 param_1,undefined8 param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a26e2d:
    if ((plVar15 == plVar4) || ((longlong)plVar15 - (longlong)plVar3 == -8)) goto LAB_00a26e3b;
    lVar16 = (longlong)plVar15 - (longlong)plVar3 >> 3;
  }
  else {
    do {
      if (*plVar15 == lVar16) goto LAB_00a26e2d;
      plVar15 = plVar15 + 1;
...
LAB_00a26e3b:
  ...
  *(longlong *)((longlong)pvVar10 + 0x18) = lVar8 + lVar16 * 8 + ((longlong)pvVar9 >> 3) * 8;
  lVar13 = lVar16 * 0x148 + *(longlong *)((longlong)pvVar7 + 0x48);
  lVar11 = lVar13 + 0x148;
  ...
  if (lVar11 != lVar8) {
    ...
    if (lVar11 == lVar14) goto LAB_00a26f6e;
  }
  do {
    puVar1 = (undefined8 *)(lVar11 + -0x148);
    lVar11 = lVar11 + -0x148;
    (**(code **)*puVar1)();
    sVar12 = (size_t)param_3;
  } while (lVar14 != lVar11);
LAB_00a26f6e:
  *(longlong *)((longlong)pvVar7 + 0x50) = lVar14;
  ...
  if (plVar4 != (longlong *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00a26ffb. Too many branches */
