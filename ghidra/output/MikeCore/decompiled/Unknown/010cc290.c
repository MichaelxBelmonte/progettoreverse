...

{
  ...
  if (iVar8 == 1) {
    ...
    if ((X509 *)((longlong)&MACH_HEADER.magic + 1) < param_2) {
      pcVar13 = (char *)(ulonglong)(param_1 | (uint)(*unaff_RSI == '.') << 0xf);
    }
    local_70 = FUN_010ccd30;
    if (((ulonglong)pcVar13 & 2) == 0) {
...
LAB_010cc469:
      ...
      do {
        ...
        if (*piVar10 == iVar8) {
          ...
          if (((*(longlong *)(piVar10 + 2) == 0) || (*piVar10 == 0)) ||
             (bVar3 = true, piVar10[1] != local_48)) {
            bVar3 = true;
          }
          else {
            param_3 = (int *)(ulonglong)param_1;
            a = param_2;
            iVar5 = (*local_70)(param_2,unaff_RSI);
  ...
  if ((bool)(bVar2 & (param_1 & 0x20) == 0)) {
    ...
    while (uVar7 = _X509_NAME_get_index_by_NID((X509_NAME *)a,(int)in,(int)param_3), -1 < (int)uVar7
      ...
      if ((pAVar11->data != (uchar *)0x0) && (pAVar11->length != 0)) {
        ...
        param_3 = (int *)(ulonglong)param_1;
        a = param_2;
        iVar8 = (*local_70)(param_2,unaff_RSI);
      ...
      in = (ASN1_STRING *)(ulonglong)uVar7;
      if (iVar8 != 0) {
        return iVar8;
      }
    }
