...
longlong * FUN_00d9b420(undefined8 param_1,undefined4 param_2)
...
LAB_00d9b67e:
        ...
        if ((char)local_44 != '\0') {
          if ((((*(int *)(lVar6 + 0x20) == -1) && (*(longlong *)(lVar6 + 0x10) != 0)) &&
              (FUN_00e7dde0(), *(int *)(lVar6 + 0x20) == -1)) && (*(longlong *)(lVar6 + 0x10) != 0))
          {
            FUN_00e7dde0();
          }
          FUN_00e7b4e0();
