...
/* WARNING: Removing unreachable block (ram,0x01686b2d) */
/* WARNING: Removing unreachable block (ram,0x01686b36) */
/* WARNING: Removing unreachable block (ram,0x016867e6) */
/* WARNING: Removing unreachable block (ram,0x016867f2) */
/* WARNING: Removing unreachable block (ram,0x01686906) */
/* WARNING: Removing unreachable block (ram,0x01686912) */

void FUN_016863a0(ulonglong param_1)
  ...
  if (iVar4 < 1) {
    ...
    *unaff_RDI = 0;
    ...
    do {
      ...
      cVar14 = cVar14 + -6;
      param_1 = (ulonglong)CONCAT31(cVar13 >> 7,cVar14);
      iVar19 = (int)cVar14;
      uVar16 = iVar5 + iVar19;
      ...
      do {
        ...
        *puVar10 = &DAT_025fe670;
        ...
        puVar10[9] = 0;
        (*pcVar3)();
        cVar13 = *(char *)((longlong)puVar7 + lVar20);
...
LAB_01686737:
          lVar11 = DAT_027cd560;
          if (DAT_027cd560 == 0) goto LAB_01686750;
          FUN_00d50b00();
        }
        FUN_017395b0();
        if (lVar11 != 0) {
      ...
      if (iVar5 == 0) {
        ...
        *(undefined1 *)(unaff_RDI + 1) = 0;
        *unaff_RDI = 0;
        if (plVar8 == (longlong *)0x0) goto joined_r0x01686b64;
LAB_01686b4c:
        FUN_00d50b20();
        ...
        FUN_016843a0();
        if (local_48 == '\0') {
          if (local_50 == (longlong *)0x0) goto LAB_01686930;
          FUN_00d50b00();
LAB_016868a1:
          pvVar9 = _pthread_getspecific(pVar15);
          if (pvVar9 != (void *)0x0) {
          ...
          if (local_50 != (longlong *)0x0) goto LAB_016868a1;
LAB_01686930:
          pvVar9 = _pthread_getspecific(pVar15);
          if (pvVar9 != (void *)0x0) {
            FUN_00e8b990();
    ...
    if ((pvVar9 != (void *)0x0) && (lVar12 = FUN_00e8b990(), lVar12 != 0)) {
      plVar8 = (longlong *)plVar6[(ulonglong)(*(uint *)(lVar12 + 0x154) & 1) + 4];
    }
