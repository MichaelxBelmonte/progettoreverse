...
//   "virtual void pace::ILok2Commander::GetAuthPartitionInfo(const CMD_CmmdPayload_GetAuthPartitionInfo_...


void FUN_009a0f16(undefined8 param_1,undefined8 param_2)

{
  ...
  if (unaff_RDI[7] == 0) {
    FUN_00925fd0();
    uVar1 = FUN_00926010();
    uVar3 = FUN_00928ab0("virtual void pace::ILok2Commander::GetAuthPartitionInfo(const CMD_CmmdPayload_GetAuthPartitionInfo_Struct &, CMD_RsltPayload_GetAuthPartitionInfo_Struct &)"
                         ,0xbd5);
    uVar3 = FUN_009c720b(uVar3,uVar1);
  }
  uVar3 = (**(code **)(*unaff_RDI + 0x1e8))(uVar3,&local_108);
