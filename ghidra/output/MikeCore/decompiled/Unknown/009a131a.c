...
//   "virtual void pace::ILok2Commander::GetFirmwarePartitionInfo(const CMD_CmmdPayload_GetFirmwarePartit...


void FUN_009a131a(undefined8 param_1,undefined8 param_2)

{
  ...
  if (unaff_RDI[7] == 0) {
    FUN_00925fd0();
    uVar1 = FUN_00926010();
    uVar3 = FUN_00928ab0("virtual void pace::ILok2Commander::GetFirmwarePartitionInfo(const CMD_CmmdPayload_GetFirmwarePartitionInfo_Struct &, CMD_RsltPayload_GetFirmwarePartitionInfo_Struct &)"
                         ,0xc0e);
    uVar3 = FUN_009c720b(uVar3,uVar1);
  }
  uVar3 = (**(code **)(*unaff_RDI + 0x1f8))(uVar3,&local_108);
