...
/* WARNING: Removing unreachable block (ram,0x015b3782) */
/* WARNING: Removing unreachable block (ram,0x015b378e) */

ulonglong FUN_015b3700(float param_1,float *param_2,ulonglong param_3,undefined8 param_4)

{
  ...
  FUN_00c92160();
  fVar19 = (float)iVar12;
  fVar20 = param_1 * fVar19 + DAT_02391090;
  uVar18 = -uVar17;
  if (0 < (int)uVar17) {
    uVar18 = uVar17;
  }
  if (-2 < iVar12) {
    ...
    if ((uVar1 & 1) == 0) {
      *(undefined4 *)
       (lVar4 + (longlong)
           ...
           = uVar2;
      uVar5 = (ulonglong)(1 - iVar16);
    }
    if (uVar1 != 0) {
      do {
        iVar13 = (int)uVar5;
        *(undefined4 *)
         (lVar4 + (longlong)(int)((iVar13 % (int)uVar17 >> 0x1f & uVar18) + iVar13 % (int)uVar17) *
                  4) = uVar2;
        iVar8 = (iVar13 + 1) % (int)uVar17;
        *(undefined4 *)(lVar4 + (longlong)(int)((iVar8 >> 0x1f & uVar18) + iVar8) * 4) = uVar2;
        uVar5 = (ulonglong)(iVar13 + 2);
    ...
    if (uVar1 != 0) {
      ...
      do {
        *(undefined4 *)
         (lVar4 + (longlong)(int)((iVar8 % (int)uVar17 >> 0x1f & uVar18) + iVar8 % (int)uVar17) * 4)
             = uVar2;
        iVar9 = (iVar8 + 1) % (int)uVar17;
        *(undefined4 *)(lVar4 + (longlong)(int)((iVar9 >> 0x1f & uVar18) + iVar9) * 4) = uVar2;
        iVar8 = iVar8 + 2;
        iVar13 = iVar13 + -2;
      } while (iVar13 != 0);
    }
    ...
    if (uVar1 != 0) {
      ...
      do {
        *(undefined4 *)
         (lVar4 + (longlong)(int)((iVar12 % (int)uVar17 >> 0x1f & uVar18) + iVar12 % (int)uVar17) *
                  4) = uVar2;
        iVar16 = (iVar12 + 1) % (int)uVar17;
        *(undefined4 *)(lVar4 + (longlong)(int)((iVar16 >> 0x1f & uVar18) + iVar16) * 4) = uVar2;
        iVar12 = iVar12 + 2;
        iVar15 = iVar15 + -2;
      } while (iVar15 != 0);
    }
  ...
  if ((int)uVar17 < 1) {
    *param_2 = DAT_02390d00 / fVar19;
    uVar5 = (ulonglong)(uint)DAT_02391074;
  }
  else {
    lVar4 = *(longlong *)(local_a8 + 0x10);
    uVar5 = (ulonglong)(uVar17 & 3);
    fVar20 = DAT_02391074;
    if ((ulonglong)uVar17 - 1 < 3) {
      ...
      param_3 = (ulonglong)(uVar17 & 0xfffffffc);
      uVar10 = 0xffffffff;
      uVar6 = 0;
      do {
    ...
    *param_2 = (float)iVar12 / fVar19;
    ...
    if (local_c8 != '\0') {
      ...
      do {
        ...
        fVar20 = fVar19 * DAT_0239011c * DAT_023908e0;
        pvVar7 = (void *)(uVar10 & 0xffffffff);
        FUN_00e7df20((double)fVar19,"%4d %.3f ");
        uVar18 = (uint)(fVar20 + DAT_0239011c);
        if ((int)uVar18 < 0) {
          uVar18 = 0;
        }
