...
char * FUN_00f6adc0(CONF *param_1,char *param_2,undefined8 param_3,undefined8 param_4)
...
LAB_00f6b133:
    ...
    s = (char *)((longlong)&MACH_HEADER.magic + 1);
    if (0 < iVar2) {
      iVar7 = 0;
      do {
...
LAB_00f6b057:
          ...
          if (iVar3 == 0) {
            local_68 = (char *)((longlong)&segment_command_00000020.vmsize + 1);
