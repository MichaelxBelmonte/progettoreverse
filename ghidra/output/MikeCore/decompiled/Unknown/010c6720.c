...
void FUN_010c6720(undefined8 param_1,uint param_2)

{
  ...
  if (0 < iVar3) {
    _BIO_printf((BIO *)"",(char *)(ulonglong)param_2,param_1);
  }
  iVar3 = _OPENSSL_sk_num();
  if (0 < iVar3) {
    iVar3 = 0;
    do {
      ...
      gen = (GENERAL_NAME *)(ulonglong)(param_2 + 2);
      out = "";
      ...
      if (*(int *)*puVar5 == 7) {
        ...
        if (iVar4 == 0x20) {
          ...
          gen = (GENERAL_NAME *)(ulonglong)(byte)*puVar2;
          out = (char *)(ulonglong)*(byte *)((longlong)puVar2 + 1);
          _BIO_printf((BIO *)out,(char *)gen,(ulonglong)(byte)puVar2[1],
                      (ulonglong)*(byte *)((longlong)puVar2 + 3));
        }
        else {
          _BIO_printf((BIO *)out,(char *)gen);
        }
