...
//   "void license_services::LsEntityUtilsActivationInfo::add(license_services::LsActivationInfoWire &)"


void FUN_00a44eb6(void)

{
  ...
  if (lVar5 != -1) {
    ...
    FUN_00983230();
    FUN_00983230();
    FUN_00928ab0("void license_services::LsEntityUtilsActivationInfo::add(license_services::LsActivationInfoWire &)"
                 ,0x68);
    FUN_009c78cb();
  }
  FUN_009b4be0();
  ...
  if (lVar8 == *(longlong *)(lVar5 + 0x58)) {
    lVar8 = (lVar8 - *(longlong *)(lVar5 + 0x48) >> 7) * -0x5555555555555555;
    if (0xaaaaaaaaaaaaaa < lVar8 + 1U) {
                    /* WARNING: Subroutine does not return */
      std::__vector_base_common<true>::__throw_length_error();
    }
    FUN_00a22fb0(lVar5 + 0x58,lVar8);
    FUN_00a645b4();
    FUN_00a22f20();
    FUN_00a891c4();
  }
    ...
    FUN_00a645b4();
    *(longlong *)(lVar5 + 0x50) = lVar8 + 0x180;
  }
  return;
}
