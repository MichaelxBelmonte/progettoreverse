...
ulonglong FUN_0096e692(uint param_1,longlong param_2,uint param_3,byte *param_4,longlong *param_5,
                      uint *param_6,longlong param_7,longlong *param_8,uint *param_9,uint *param_10)

{
  ...
  if ((((((local_res20 != (int *)0x0) && (param_6 != (uint *)0x0)) && (local_res18 != (int *)0x0))
       && (((local_res10 != 0 && (local_res8 != (uint *)0x0)) &&
           ((param_4 != (byte *)0x0 && ((unaff_RDI != 0 && (param_2 != 0)))))))) &&
      (param_1 < 0x501)) && (local_b00 = param_4, local_af0 = param_3, param_5 != (longlong *)0x0))
  {
    FUN_0096dfe2();
    FUN_0096dfe2();
    FUN_0096dfbe();
    ...
    if (lVar5 == 0) {
      ...
      local_ae8 = (ulonglong)local_b04 + lVar5;
      local_b48 = lVar5;
      ...
      if ((uVar2 == 0) && (uVar8 = 0x144, local_ac8 == 2)) {
        ...
        if ((int)uVar6 == 0) {
          local_adc = (undefined4)CONCAT71((int7)(uVar6 >> 8),1);
          local_b40 = param_2;
          local_b14 = param_1;
          do {
            if (local_ad0 == 0) {
              ...
              if (local_ac4 < 0x501) {
                ...
                if (local_ad0 != 0) {
                  ...
                  local_b10 = local_ad0 + (ulonglong)local_ab8;
                  local_ad0 = FUN_009700c0(&DAT_023c8b78,local_ad4,1,0);
                  if (local_ad0 == 0) {
                    uVar8 = 0x13c;
                    break;
                  }
                  ...
                  local_ad0 = FUN_009700c0(&DAT_023c8b86,local_ad4,1,0);
                  if (local_ad0 == 0) {
                    uVar8 = 0x13d;
                    break;
                  }
                  ...
                  local_ad0 = FUN_009700c0(&DAT_023c8b82,local_ad4,1,0);
                  if (local_ad0 == 0) {
                    uVar8 = 0x13e;
                    break;
                  }
                  ...
                  local_ad0 = FUN_009700c0(&DAT_023c8b60,local_ad4,0);
                  if (local_ad0 == 0) {
                    uVar8 = 0x135;
                    break;
                  }
...
LAB_0096f1b9:
                  local_ad0 = FUN_009700c0(&DAT_023c8b6c,local_ad4,0,&local_ab8);
                  if (local_ad0 == 0) {
                    uVar8 = 0x137;
                    break;
                  }
                  ...
                  if (local_abe != 0) {
                    local_ad0 = FUN_009700c0(&DAT_023c8b68,local_ad4,0,&local_ab8);
                    if (local_ad0 == 0) {
                      uVar8 = 0x136;
                      break;
                    }
                  ...
                  local_ad0 = FUN_009700c0(&DAT_023c8b5c,local_ad4,0,&local_ab8);
                  if (local_ad0 == 0) {
                    uVar8 = 0x139;
                    break;
                  }
                  ...
                  local_ad0 = FUN_009700c0(&DAT_023c8b58,local_ad4,0,&local_ab8);
                  if (local_ad0 == 0) {
                    uVar8 = 0x138;
                    break;
                  }
