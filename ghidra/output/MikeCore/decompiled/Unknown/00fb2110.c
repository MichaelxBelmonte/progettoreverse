...
undefined8 FUN_00fb2110(CONF *param_1,char *param_2,undefined8 param_3,char *param_4)

{
  ...
  if (iVar2 < 1) {
    ...
    _ERR_put_error(0x200bb77,iVar8,iVar12,param_4,(int)unaff_RSI);
    ...
    if (lVar5 != 0) {
      ...
      if (0 < iVar2) {
        ...
        do {
          pcVar3 = _CRYPTO_strdup((char *)param_1,
                                  (char *)((longlong)&segment_command_00000020.nsects + 3),
                                  (int)param_3);
          *(char **)(lVar5 + uVar10 * 0x18) = pcVar3;
          if (pcVar3 == (char *)0x0) goto LAB_00fb2400;
          iVar2 = _OPENSSL_sk_num();
          uVar11 = (ulonglong)iVar2;
          pcVar3 = (char *)((longlong)&segment_command_00000020.flags + 3);
          lVar6 = _CRYPTO_zalloc();
          *(longlong *)(lVar5 + 8 + uVar10 * 0x18) = lVar6;
          if (lVar6 == 0) goto LAB_00fb2400;
          *(ulonglong *)(lVar5 + 0x10 + uVar10 * 0x18) = uVar11;
          if (iVar2 != 0) {
            if (uVar11 < 2) {
              uVar11 = 1;
            }
            ...
            do {
              iVar2 = (int)pcVar3;
              _OPENSSL_sk_value();
              lVar1 = *(longlong *)(lVar5 + uVar10 * 0x18 + 8);
              ...
              *(char **)(lVar1 + 8 + lVar6) = pcVar7;
              if ((*(longlong *)(lVar1 + lVar6) == 0) || (pcVar7 == (char *)0x0)) goto LAB_00fb2400;
              uVar9 = uVar9 + 1;
              lVar6 = lVar6 + 0x10;
            } while (uVar11 != uVar9);
          }
      ...
      _ERR_add_error_data(0x201e2ac,*(undefined8 *)(lVar6 + 8),*(undefined8 *)(lVar6 + 0x10));
    }
  }
LAB_00fb2400:
  FUN_00fb2430();
