...
undefined8 FUN_00f76800(longlong *param_1,longlong *param_2)

{
  ...
  local_468[0xf] = '\0';
  pcVar5 = local_468;
  buf = (char *)((longlong)&segment_command_000003d8.fileoff + 1);
  file = &segment_command_00000020;
  iVar3 = _getnameinfo((sockaddr *)((longlong)&segment_command_000003d8.fileoff + 1),
  ...
  if (local_468[0] == '\0') {
    if ((*(char *)(unaff_RDI + 1) == '\x1e') || (*(char *)(unaff_RDI + 1) == '\x02')) {
      uVar2 = *(ushort *)(unaff_RDI + 2);
    }
    else {
      uVar2 = 0;
    }
    buf = (char *)(ulonglong)(ushort)(uVar2 << 8 | uVar2 >> 8);
    _BIO_snprintf(buf,0x2031e88,pcVar5);
  }
  iVar3 = (int)pcVar5;
  if (param_2 != (longlong *)0x0) {
    pcVar5 = _CRYPTO_strdup(buf,(char *)((longlong)&section_000000b8.align + 1),iVar3);
    *param_2 = (longlong)pcVar5;
  }
  if (param_1 != (longlong *)0x0) {
    pcVar5 = _CRYPTO_strdup(buf,(char *)((longlong)&section_000000b8.align + 3),iVar3);
    *param_1 = (longlong)pcVar5;
  }
  if ((param_2 == (longlong *)0x0) || (*param_2 != 0)) {
    uVar6 = 1;
    if ((param_1 == (longlong *)0x0) || (*param_1 != 0)) goto LAB_00f76a74;
    if (param_2 != (longlong *)0x0) {
      _CRYPTO_free(buf);
      *param_2 = 0;
    }
LAB_00f76a38:
    ...
    *param_1 = 0;
    ...
    _CRYPTO_free(buf);
    *param_2 = 0;
    if (param_1 != (longlong *)0x0) goto LAB_00f76a38;
  }
