...
char * FUN_00f31bf0(char *param_1,undefined8 *param_2)
...
LAB_00f31cd3:
  if ((lVar4 != 0) && (*(char *)(lVar4 + 0x50) == '\0')) {
    ...
    *(undefined4 *)(lVar4 + 0x54) = 10;
    _strlen(param_1);
    FUN_00f2d870();
    *(undefined8 *)(lVar4 + 100) = 0xffffffffffffffff;
    if ((pcVar5 != (char *)0x0) && (param_2 != (undefined8 *)0x0)) {
      FUN_00f2fb40();
      *(undefined8 *)(lVar4 + 100) = *param_2;
    }
  }
  return (char *)0x0;
}
