...
/* WARNING: Removing unreachable block (ram,0x01979dfa) */
/* WARNING: Removing unreachable block (ram,0x01979e03) */

void FUN_01979d80(undefined8 param_1,float param_2)

{
  ...
  fStack_84 = (float)((ulonglong)uVar4 >> 0x20);
  local_88 = local_88 + fVar6 * DAT_0239011c;
  fVar8 = local_98 + param_2 * DAT_0239011c + DAT_02390d00;
  FUN_01d48b40();
  plVar1 = (longlong *)*unaff_RSI;
  FUN_01e3f820();
  uVar7 = extraout_XMM0_Dd;
  (**(code **)(*plVar1 + 0x3e0))();
  fVar3 = (float)(**(code **)(*unaff_RDI + 0xb10))();
  FUN_01e3f820();
  fVar6 = fStack_84;
  FUN_01e3f820();
  (**(code **)(*unaff_RDI + 0x640))();
  ...
  (**(code **)(*(longlong *)*unaff_RSI + 0x3c0))(auVar5._0_8_,DAT_02394298);
  return;
}
