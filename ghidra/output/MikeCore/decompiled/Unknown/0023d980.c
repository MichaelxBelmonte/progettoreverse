...
ulonglong FUN_0023d980(undefined8 param_1,char param_2)
...
LAB_0023da04:
    ...
    *pcVar4 = '\0';
    ...
    if (plVar5 == (longlong *)0x0) {
      ...
      if (plVar5 == (longlong *)0x0) goto LAB_0023da04;
    }
...
LAB_0023da07:
  ...
  if (local_40 == (longlong *)0x0) {
    ...
    (**(code **)(*plVar5 + 0xed0))();
    cVar3 = (**(code **)(*(longlong *)CONCAT71(uStack_4f,local_50) + 0x3b0))();
  ...
  if (cVar3 == '\0') {
    ...
    if (local_40 == (longlong *)0x0) {
      ...
      (**(code **)(*plVar5 + 0xed0))();
      cVar3 = (**(code **)(*(longlong *)CONCAT71(uStack_4f,local_50) + 0x3a8))();
      if ((local_48 != '\0') && (CONCAT71(uStack_4f,local_50) != 0)) {
        FUN_00d50b20();
      }
    }
    ...
    if (cVar3 == '\0') {
      if (param_2 != '\0') {
        ...
        (**(code **)("/System/Library/Frameworks/CoreText.framework/Versions/A/CoreText" +
                    *plVar5 + 0x20))();
        if ((cVar3 != '\0') &&
           (cVar3 = (**(code **)((longlong)&dylib_command_000012e8.dylib.name.offset + *plVar5))(),
           cVar3 == '\0')) {
          (**(code **)((longlong)&dylib_command_000012e8.cmd + *plVar5))();
        }
        lVar1 = DAT_026f6e08;
        if (DAT_026f6e08 != 0) {
          FUN_00d50b00();
