...
//   "void license_services::LsEntityUtilsSignedInfo::add(license_services::LsSignedInfoWire &)"


void FUN_00a4f476(void)

{
  ...
  if (lVar4 != -1) {
    ...
    FUN_00983230();
    FUN_00983230();
    FUN_00928ab0("void license_services::LsEntityUtilsSignedInfo::add(license_services::LsSignedInfoWire &)"
                 ,0x68);
    FUN_009c78cb();
  }
  FUN_009b4be0();
