// Function: FUN_00a3a408
// Address: 00a3a408
// Size: 755 bytes
// Class: Unknown


void FUN_00a3a408(void *param_1,undefined8 param_2,size_t param_3)
...
LAB_00a3a6fd:
      ...
      local_40 = local_40 + 0xe8;
    } while (local_40 != *(longlong *)(unaff_RSI + 0x50));
  }
  *(undefined4 *)(unaff_RDI[3] + 0x40) = 0x7b;
  FUN_009b99ca();
  return;
}
