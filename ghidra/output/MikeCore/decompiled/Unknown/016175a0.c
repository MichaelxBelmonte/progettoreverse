...
/* WARNING: Removing unreachable block (ram,0x01617833) */

void FUN_016175a0(undefined4 param_1,longlong *param_2,uint param_3)

{
  ...
  if ((((lVar15 != 0) && (lVar16 = FUN_01483950(), lVar16 != 0)) &&
    ...
    uVar24 = (ulonglong)(param_3 & 0xfffffffc);
    local_b8 = 1;
    local_b0 = 0;
    uVar26 = 0;
    local_38 = 0;
    ...
    do {
      ...
      if (*param_2 == 0) {
        ...
        uVar29 = lVar25 * 4 + *(longlong *)(*param_2 + 0x10);
      }
...
LAB_016177f7:
      ...
      if (0 < *(int *)(lVar22 + 0xc)) {
        lVar31 = 0;
        do {
          lVar30 = *(longlong *)(*(longlong *)(lVar22 + 0x10) + lVar31 * 8);
          if (local_50 == lVar30) {
          ...
          lVar19 = (longlong)*(int *)(lVar22 + 0xc);
          lVar30 = lVar31;
          if (lVar31 < lVar19) {
            do {
              lVar19 = *(longlong *)(*(longlong *)(lVar22 + 0x10) + lVar30 * 8);
              if (lVar28 == lVar19) {
                if ((!bVar9) && (lVar28 != 0)) {
                  bVar9 = true;
                  FUN_00d50b00();
              ...
              if (iVar23 < iVar13) {
                ...
                if (DAT_0239424c < fVar33) {
                  ...
                  if (-1 < (int)uVar14) {
                    ...
                    *(float *)(uVar1 + (ulonglong)uVar14 * 4) =
                         fVar33 * fVar32 + *(float *)(uVar1 + (ulonglong)uVar14 * 4);
                  }
                }
              }
              lVar30 = lVar30 + 1;
      ...
      if ((uVar29 != 0) && (0 < (int)param_3)) {
        if ((param_3 < 4) ||
          ...
          do {
            ...
            uVar34 = *(undefined4 *)(lVar31 + 4);
            uVar6 = *(undefined4 *)(lVar31 + 0xc);
            uVar8 = _powf();
            uVar34 = _powf(uVar34);
            uVar35 = _powf(*(undefined4 *)(uVar29 + 8 + uVar27 * 4));
            uVar5 = _powf(uVar6);
        ...
        uVar20 = uVar27;
        if ((param_3 & 1) != 0) {
          fVar33 = (float)_powf(*(undefined4 *)(uVar29 + uVar27 * 4));
        ...
        if (~uVar27 != -uVar18) {
          ...
          lVar31 = 0;
          do {
            fVar33 = (float)_powf(*(undefined4 *)(lVar25 + lVar31 * 4));
            *(float *)(lVar4 + -4 + lVar31 * 4) = fVar33 * *(float *)(lVar4 + -4 + lVar31 * 4);
            fVar33 = (float)_powf(*(undefined4 *)(lVar25 + 4 + lVar31 * 4));
