...
bool FUN_010599e0(ASN1_OBJECT *param_1,undefined8 param_2,void **param_3,X509_ALGOR *param_4)

{
  ...
  puVar3 = *(uint **)(*(longlong *)(unaff_RDI + 8) + 8);
  uVar9 = *(undefined8 *)(puVar3 + 2);
  uVar1 = *puVar3;
  if (*(longlong *)(*(longlong *)(unaff_RDI + 8) + 0x10) == 0) {
    pEVar7 = (EVP_MD *)((longlong)&MACH_HEADER.magic + 1);
  }
  else {
    lVar5 = _ASN1_INTEGER_get((ASN1_INTEGER *)(ulonglong)uVar1);
...
LAB_01059c3b:
    ...
    if (iVar4 != 0) {
      len = **(size_t **)(*(longlong *)(unaff_RDI + 0x10) + 0x20);
      iVar4 = _HMAC_Update();
      if (iVar4 != 0) {
        iVar4 = _HMAC_Final();
        len = (size_t)param_3;
