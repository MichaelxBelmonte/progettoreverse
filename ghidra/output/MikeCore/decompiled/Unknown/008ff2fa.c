...
//   "releaseDate"
//   "FindAuthOptions"
//   "sortChainsHighestRankingFirst"
//   "includeAuthNamesIfAvailable"
//   "includeActivationInfoIfAvailable"
//   "updateLegacyTokenState"
//   "includeSharedLicenseWhenLocalLicenseFound"
//   "includeCloudLicenseWhenLocalLicenseFound"
//   "includeRemoteServerStats"
//   "statsBeginDate"
//   "statsEndDate"


int FUN_008ff2fa(void)

{
  ...
  iVar11 = (**(code **)(*unaff_RSI + 0x30))(4,2);
  iVar12 = (**(code **)(*unaff_RSI + 0x78))();
  iVar13 = (**(code **)(*unaff_RSI + 0x38))();
  iVar14 = (**(code **)(*unaff_RSI + 0x30))(5,2);
  ...
  iVar20 = (**(code **)(*unaff_RSI + 0x30))(10,8);
  iVar21 = (**(code **)(*unaff_RSI + 0x90))();
  iVar22 = (**(code **)(*unaff_RSI + 0x38))();
  iVar23 = (**(code **)(*unaff_RSI + 0x30))(0x14,2);
  iVar24 = (**(code **)(*unaff_RSI + 0x78))();
  iVar25 = (**(code **)(*unaff_RSI + 0x38))();
  iVar26 = (**(code **)(*unaff_RSI + 0x30))(0x15,0xb);
  iVar27 = (**(code **)(*unaff_RSI + 0xa8))();
  iVar28 = (**(code **)(*unaff_RSI + 0x38))();
  iVar29 = (**(code **)(*unaff_RSI + 0x30))(0x16,0xb);
  iVar30 = (**(code **)(*unaff_RSI + 0xa8))();
  iVar31 = (**(code **)(*unaff_RSI + 0x38))();
  iVar32 = (**(code **)(*unaff_RSI + 0x30))(0x1e,10);
  iVar33 = (**(code **)(*unaff_RSI + 0x98))();
  iVar34 = (**(code **)(*unaff_RSI + 0x38))();
  iVar35 = (**(code **)(*unaff_RSI + 0x40))();
  iVar36 = (**(code **)(*unaff_RSI + 0x28))();
