...
undefined8 FUN_00fe3810(EC_KEY *param_1,undefined8 *param_2,longlong param_3,BIGNUM *param_4)

{
  ...
  if (unaff_RDI == 0) {
LAB_00fe39fe:
    unaff_RSI = in_stack_ffffffffffffff98;
    iVar2 = 0x43;
    iVar1 = 0x2f;
LAB_00fe3a1a:
    _ERR_put_error(0x200efcb,iVar2,iVar1,(char *)param_4,(int)unaff_RSI);
    return 0;
  }
  pEVar8 = param_1;
  puVar9 = param_2;
  ...
  a = (char *)unaff_RSI;
  pBVar11 = unaff_RSI;
  if ((unaff_RSI == (BIGNUM *)0x0) &&
     (unaff_RSI = (BIGNUM *)_BN_CTX_new(), unaff_RSI == (BIGNUM *)0x0)) {
    iVar2 = 0x41;
    iVar1 = 0x3e;
    unaff_RSI = pBVar11;
    goto LAB_00fe3a1a;
...
LAB_00fe3ab6:
  ...
  pBVar12 = unaff_RSI;
  if (((iVar1 == 0) || (iVar1 = _BN_set_bit((BIGNUM *)a,iVar2), pBVar12 = unaff_RSI, iVar1 == 0)) ||
     (iVar2 = _BN_set_bit((BIGNUM *)a,iVar2), pBVar12 = unaff_RSI, iVar2 == 0)) goto LAB_00fe3ac2;
  if (param_3 == 0) {
    do {
      do {
      ...
      param_4 = unaff_RSI;
      iVar2 = _EC_POINT_mul((EC_GROUP *)0x0,(EC_POINT *)r,(BIGNUM *)0x0,(EC_POINT *)unaff_RSI,
      ...
      iVar2 = _BN_nnmod(unaff_RSI,m,pBVar4,(BN_CTX *)param_4);
    ...
    do {
      ...
      iVar2 = _EC_POINT_get_affine_coordinates(0,pBVar6);
      if (iVar2 == 0) goto LAB_00fe3c71;
      iVar2 = _BN_nnmod(unaff_RSI,m,d,(BN_CTX *)param_4);
      if (iVar2 == 0) goto LAB_00fe3c8f;
      iVar2 = _BN_is_zero();
    } while (iVar2 != 0);
  }
  iVar2 = _ec_group_do_inverse_ord(unaff_RSI,r);
  if (iVar2 == 0) {
    iVar2 = 3;
    iVar1 = 0x7d;
LAB_00fe3cd2:
...
LAB_00fe3ac2:
  ...
  if (pBVar12 != pBVar11) {
LAB_00fe3ade:
    _BN_CTX_free((BN_CTX *)unaff_RSI);
  }
LAB_00fe3ae3:
  _EC_POINT_free((EC_POINT *)unaff_RSI);
  _BN_clear_free(unaff_RSI);
  return uVar10;
}
