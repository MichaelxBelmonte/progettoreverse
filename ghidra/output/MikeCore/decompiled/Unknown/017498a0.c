...
ulonglong FUN_017498a0(pthread_key_t param_1)

{
  ...
  uVar13 = 0;
  puVar10 = &DAT_02411e30;
  local_38 = 0;
  bVar1 = false;
  do {
    if (uVar13 < 4) {
      local_68 = (ulonglong)*puVar10;
    }
    uVar11 = local_68;
    iVar5 = (**(code **)(*unaff_RDI + 0x378))();
    if (iVar5 == -1000000) {
LAB_01749b36:
      local_3c = '\0';
      local_58 = 0;
...
joined_r0x01749a55:
    ...
    if (iVar5 == -1000000) {
      bVar4 = 0;
      uVar14 = (ulonglong)((int)local_68 + (int)uVar7 + 1);
    }
    else {
      FUN_01740240();
      if (local_50 == local_38) {
