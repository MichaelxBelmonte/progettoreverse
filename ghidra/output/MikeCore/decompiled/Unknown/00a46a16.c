...
//   "void license_services::LsEntityUtilsAuthKey::add(license_services::LsAuthKeyWire &)"


void FUN_00a46a16(void)

{
  ...
  if (lVar4 != -1) {
    ...
    FUN_00983230();
    FUN_00983230();
    FUN_00928ab0("void license_services::LsEntityUtilsAuthKey::add(license_services::LsAuthKeyWire &)"
                 ,0x68);
    FUN_009c78cb();
  }
  FUN_009b4be0();
  ...
  if (lVar7 == *(longlong *)(lVar4 + 0x58)) {
    lVar7 = (lVar7 - *(longlong *)(lVar4 + 0x48) >> 3) * -0x7063e7063e7063e7;
    if (0xc7ce0c7ce0c7ce < lVar7 + 1U) {
                    /* WARNING: Subroutine does not return */
      std::__vector_base_common<true>::__throw_length_error();
    }
    FUN_00a470b0(lVar4 + 0x58,lVar7);
    FUN_00a6a008();
    FUN_00a47020();
    FUN_00a47120();
  }
    ...
    FUN_00a6a008();
    *(longlong *)(lVar4 + 0x50) = lVar7 + 0x148;
  }
  return;
}
