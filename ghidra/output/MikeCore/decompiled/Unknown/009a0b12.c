...
//   "virtual void pace::ILok2Commander::GetEEPROMPartitionInfo(const CMD_CmmdPayload_GetEEPROMPartitionI...


void FUN_009a0b12(undefined8 param_1,undefined8 param_2)

{
  ...
  if (unaff_RDI[7] == 0) {
    FUN_00925fd0();
    uVar1 = FUN_00926010();
    uVar3 = FUN_00928ab0("virtual void pace::ILok2Commander::GetEEPROMPartitionInfo(const CMD_CmmdPayload_GetEEPROMPartitionInfo_Struct &, CMD_RsltPayload_GetEEPROMPartitionInfo_Struct &)"
                         ,0xb9c);
    uVar3 = FUN_009c720b(uVar3,uVar1);
  }
  uVar3 = (**(code **)(*unaff_RDI + 0x1d8))(uVar3,&local_108);
