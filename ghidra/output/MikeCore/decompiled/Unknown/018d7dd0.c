...
/* WARNING: Removing unreachable block (ram,0x018d80b9) */
/* WARNING: Removing unreachable block (ram,0x018d80c5) */
...

{
  ...
  *pcVar10 = '\0';
  ...
  FUN_00d8e3d0();
  if ((((local_60[0] == '\0') && (local_68 != (undefined8 *)0x0)) &&
      (FUN_00d50b00(), local_60[0] != '\0')) && (local_68 != (undefined8 *)0x0)) {
    FUN_00d50b20();
  }
  local_60[0] = '\x01';
  local_60[1] = '\0';
  ...
  lVar2 = *unaff_RDI;
  if (lVar2 == local_48) {
    if (((char)unaff_RDI[1] != '\0') || (local_48 == 0)) goto LAB_018d8007;
    if (local_40 == '\0') {
      FUN_00d50b00();
      goto LAB_018d7fff;
    }
...
LAB_018d8047:
  ...
  if (0 < *(int *)((longlong)local_68 + 0xc)) {
    uVar12 = 0;
    do {
      cVar6 = (**(code **)(**(longlong **)(local_68[2] + uVar12 * 8) + 0x50))();
      if (cVar6 != '\0') {
        uVar11 = (uint)uVar12;
      ...
      uVar12 = uVar12 + 1;
    } while ((longlong)uVar12 < (longlong)*(int *)((longlong)local_68 + 0xc));
    iVar8 = -1;
  }
LAB_018d8116:
  FUN_00d50b20();
