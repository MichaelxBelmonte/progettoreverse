...
undefined8 FUN_009f3f64(undefined8 param_1,string *param_2,undefined8 param_3,ulong param_4)

{
  ...
  bVar3 = false;
  local_31 = unaff_SIL;
  std::string::operator=((string *)CONCAT71((int7)((ulonglong)param_1 >> 8),1),param_2);
  pcVar16 = local_50;
  paVar17 = local_58;
  if ((local_60 & 1) == 0) {
    pcVar16 = (char *)((longlong)&local_60 + 1);
    paVar17 = (allocator *)(local_60 >> 1 & 0x7f);
  }
  this = (string *)(paVar17 + -1);
  psVar6 = (string *)0xffffffffffffffff;
  if (paVar17 != (allocator *)0x0) {
    pcVar1 = pcVar16 + (longlong)paVar17;
    pcVar12 = pcVar16;
    do {
      lVar5 = 0;
      do {
...
LAB_009f4033:
    psVar6 = (string *)0xffffffffffffffff;
    if (pcVar13 != pcVar1) {
      psVar6 = (string *)(pcVar13 + -(longlong)pcVar16);
    }
  }
  uVar14 = (ulong)pcVar8;
  if (psVar6 == this) {
  ...
  if ((pcVar16[(longlong)this] < '\0') ||
     ((PTR___DefaultRuneLocale_0249c238[(ulonglong)(byte)pcVar16[(longlong)this] * 4 + 0x3d] & 4) ==
      0)) {
    FUN_00925fd0();
    FUN_00926010();
    FUN_00983230();
  ...
  aVar2 = (paVar17 + -2)[(longlong)pcVar16];
  if ((char)aVar2 < '\0') {
LAB_009f4296:
    bVar3 = false;
  }
  else {
    if (((((PTR___DefaultRuneLocale_0249c238[(ulonglong)(byte)aVar2 * 4 + 0x3d] & 4) == 0) ||
         ((paVar17 + -3)[(longlong)pcVar16] != (allocator)0x3a)) ||
        ((char)(paVar17 + -4)[(longlong)pcVar16] < '\0')) ||
       ((((PTR___DefaultRuneLocale_0249c238
           [(ulonglong)(byte)(paVar17 + -4)[(longlong)pcVar16] * 4 + 0x3d] & 4) == 0 ||
         ((char)(paVar17 + -5)[(longlong)pcVar16] < '\0')) ||
        (((PTR___DefaultRuneLocale_0249c238
           [(ulonglong)(byte)(paVar17 + -5)[(longlong)pcVar16] * 4 + 0x3d] & 4) == 0 ||
         (((pcVar16 + -6)[(longlong)paVar17] != '-' && ((pcVar16 + -6)[(longlong)paVar17] != '+'))))
        )))) {
      if (((PTR___DefaultRuneLocale_0249c238[(ulonglong)(byte)aVar2 * 4 + 0x3d] & 4) == 0) ||
         (((((paVar17 + -3)[(longlong)pcVar16] != (allocator)0x3a ||
            ((char)(paVar17 + -4)[(longlong)pcVar16] < '\0')) ||
           ((PTR___DefaultRuneLocale_0249c238
             [(ulonglong)(byte)(paVar17 + -4)[(longlong)pcVar16] * 4 + 0x3d] & 4) == 0)) ||
          (((pcVar16 + -5)[(longlong)paVar17] != '-' && ((pcVar16 + -5)[(longlong)paVar17] != '+')))
          ))) goto LAB_009f4296;
...
LAB_009f429a:
  ...
  local_c8 = 0;
  local_c0 = 0xffffffff;
  local_150 = (undefined **)&DAT_025174b8;
  ...
  local_160 = 0;
  local_158 = 0x18;
  if (DAT_028a0490 == (facet *)0x0) {
    pfVar7 = operator_new((ulong)this_00);
    FUN_009f6eaa();
    DAT_028a0490 = pfVar7;
    FUN_009d485c();
  }
  (**(code **)(*(longlong *)DAT_028a0490 + 0x20))();
  lVar5 = DAT_02517450;
  std::ios_base::getloc();
  pfVar7 = DAT_028a0490;
  if (DAT_028a0490 == (facet *)0x0) {
  ...
  if (*(longlong **)((longlong)alStack_1a8 + lVar5) != (longlong *)0x0) {
    (**(code **)(**(longlong **)((longlong)alStack_1a8 + lVar5) + 0x10))();
