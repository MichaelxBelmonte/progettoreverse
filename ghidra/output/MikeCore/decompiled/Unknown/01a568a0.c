// Function: FUN_01a568a0
// Address: 01a568a0
// Size: 1497 bytes
// Class: Unknown


ulonglong FUN_01a568a0(undefined8 param_1,byte param_2)

{
  ...
  if (((byte)uVar2 & param_2) == 0) goto LAB_01a56e67;
  ...
  if (plVar9 == (longlong *)0x0) {
LAB_01a56b4e:
    if (DAT_02802688 != 0) goto LAB_01a56b5f;
LAB_01a56c79:
    FUN_01a58e40();
    FUN_00d23310();
    plVar7 = local_40;
    ...
    *(char *)pplVar6 = '\0';
    ...
    dVar13 = (double)(**(code **)(*plVar9 + 0x380))(dVar12);
    FUN_01a58e40();
    plVar7 = local_40;
    local_78 = 0;
    if (local_38[0] == '\0') {
    ...
    (**(code **)(*plVar9 + 0x360))();
    cVar1 = FUN_00e85ea0();
    if (cVar1 == '\0') goto LAB_01a56b4e;
    if (local_60 == (longlong *)0x0) goto LAB_01a56c79;
LAB_01a56b5f:
    FUN_01a58e40();
    FUN_00d23310();
    pVar4 = (pthread_key_t)CONCAT71((int7)((ulonglong)param_1 >> 8),local_38[0]);
    ...
    *pcVar5 = '\0';
    ...
    local_40 = (longlong *)FUN_01a8fc00();
    FUN_00e7b970();
    local_58 = local_40;
    FUN_01a58e40();
    local_90 = local_40;
