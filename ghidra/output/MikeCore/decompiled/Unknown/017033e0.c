...
/* WARNING: Removing unreachable block (ram,0x01703554) */
/* WARNING: Removing unreachable block (ram,0x0170355d) */
/* WARNING: Removing unreachable block (ram,0x01703853) */
/* WARNING: Removing unreachable block (ram,0x0170385c) */

void FUN_017033e0(pthread_key_t param_1,ulonglong param_2)

{
  ...
  if (unaff_RSI >> 0x20 != 0) {
    ...
    do {
      while( true ) {
        param_1 = (pthread_key_t)puVar5;
        if (((iStack_54 != 0) && ((int)(unaff_RSI >> 0x20) != 0)) &&
