...

{
  ...
  iVar29 = (**(code **)(*unaff_RSI + 0x30))(0x12,2);
  iVar30 = (**(code **)(*unaff_RSI + 0x78))();
  ...
  iVar44 = (**(code **)(*unaff_RSI + 0x30))(0x17,8);
  iVar45 = (**(code **)(*unaff_RSI + 0x90))();
  ...
  for (plVar52 = *(longlong **)(unaff_RDI + 0xa8); plVar52 != *(longlong **)(unaff_RDI + 0xb0);
      plVar52 = plVar52 + 4) {
