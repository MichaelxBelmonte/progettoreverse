...
/* WARNING: Removing unreachable block (ram,0x01866e6f) */
/* WARNING: Removing unreachable block (ram,0x01866e7b) */
/* WARNING: Removing unreachable block (ram,0x01866ec0) */
/* WARNING: Removing unreachable block (ram,0x01866ecc) */
/* WARNING: Removing unreachable block (ram,0x01867108) */
/* WARNING: Removing unreachable block (ram,0x01867111) */
/* WARNING: Removing unreachable block (ram,0x0186753d) */
/* WARNING: Removing unreachable block (ram,0x0186754a) */
/* WARNING: Removing unreachable block (ram,0x0186750a) */
/* WARNING: Removing unreachable block (ram,0x01867517) */
/* WARNING: Removing unreachable block (ram,0x01866f16) */
/* WARNING: Removing unreachable block (ram,0x01866f1f) */
/* WARNING: Removing unreachable block (ram,0x0186718c) */
/* WARNING: Removing unreachable block (ram,0x01867195) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

float FUN_01866e10(longlong *param_1,int param_2)

{
  ...
  if ((local_40 == 0) && ((MACH_HEADER.flags & 0xfffffffc) != 4)) {
    ...
    if (unaff_ESI < param_2) {
      ...
      pauVar15 = *(undefined1 (**) [16])(local_40 + 0x10);
      lVar16 = (longlong)unaff_ESI;
      ...
      do {
        pfVar2 = *(float **)(*(longlong *)(lVar13 + lVar16 * 8) + 0x10);
    ...
    if ((*(uint *)(local_40 + 0x18) & 0xfffffffc) == 4) {
      *(undefined4 *)(*(longlong *)(local_40 + 0x10) + (longlong)iVar12 * 4) = 0x3f000000;
    }
    else {
      FUN_018e1cf0();
      if ((local_38 == '\0') && (local_40 != 0)) {
    ...
    fVar27 = pfVar2[1];
    fVar28 = pfVar4[1];
    if (((fVar27 != DAT_0239424c) || (local_84 = fVar28, NAN(fVar27) || NAN(DAT_0239424c))) &&
    ...
    FUN_00d50b20();
    FUN_00d50b20();
    fVar27 = (local_44 + DAT_0239424c + local_84 + local_80 + local_7c + local_78 + local_74 +
              local_70 + local_6c + local_68 + local_64 + local_60 + local_5c) * _DAT_0241c6c4 +
             DAT_02390124;
    local_44 = DAT_02394254;
    if (DAT_02394254 <= fVar27) {
      local_44 = fVar27;
    }
  }
  FUN_00d50b20();
