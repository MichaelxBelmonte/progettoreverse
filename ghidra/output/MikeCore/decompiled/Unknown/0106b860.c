...
uint FUN_0106b860(int *param_1,longlong param_2,int param_3,char *param_4)

{
  ...
  case 2:
    ...
    break;
  case 3:
    if (*(longlong *)(*(longlong *)(unaff_RDI + 0x28) + 0x60) != 0) {
  ...
  case 5:
    if (param_2 == 1) {
      puVar6 = (undefined8 *)_CMS_SignerInfo_get0_pkey_ctx();
      iVar2 = (int)lVar16;
...
LAB_0106ba38:
      _OBJ_nid2obj(iVar10);
      _X509_ALGOR_set0((X509_ALGOR *)0x0,(ASN1_OBJECT *)((longlong)&MACH_HEADER.cputype + 1),param_3
                       ,param_4);
      goto LAB_0106ba9d;
    }
    break;
  case 7:
    ...
    if (param_2 == 1) {
      ...
      if (iVar2 != 6) {
        ...
        plVar5 = (longlong *)_ASN1_TYPE_unpack_sequence();
...
LAB_0106bf6b:
                ...
                if (iVar2 == 0x3a7) {
                  piVar1 = *(int **)(lVar16 + 8);
                  if (*piVar1 == 4) {
                    local_60 = *(undefined8 *)(*(longlong *)(piVar1 + 2) + 8);
                    *(undefined8 *)(*(longlong *)(piVar1 + 2) + 8) = 0;
                    local_4c = **(undefined4 **)(piVar1 + 2);
                    goto LAB_0106bf6b;
                  }
                  iVar2 = 0xa0;
                  reason = 0x3c1;
        ...
        if (local_50 == 4) {
          ...
          if (0 < iVar10) {
            ...
            if (0 < iVar10) {
              ...
              if (-1 < (int)uVar3) {
                puVar6 = (undefined8 *)_RSA_OAEP_PARAMS_new();
                uVar15 = 0;
                uVar14 = 0;
                if (puVar6 != (undefined8 *)0x0) {
                  ...
                  if (0 < (int)uVar3) {
                    ...
                    iVar10 = _ASN1_OCTET_STRING_set
                                       ((ASN1_OCTET_STRING *)pEVar13,(uchar *)(ulonglong)uVar3,
                                        (int)oct);
                    if (iVar10 == 0) {
