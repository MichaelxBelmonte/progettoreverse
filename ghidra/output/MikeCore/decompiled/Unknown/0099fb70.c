...
//   "virtual void pace::ILok2Commander::StartRelativeTimeLimit(const CMD_CmmdPayload_StartRelativeTimeLi...


void FUN_0099fb70(undefined8 param_1,undefined8 param_2)

{
  ...
  if (unaff_RDI[7] == 0) {
    FUN_00925fd0();
    uVar1 = FUN_00926010();
    uVar3 = FUN_00928ab0("virtual void pace::ILok2Commander::StartRelativeTimeLimit(const CMD_CmmdPayload_StartRelativeTimeLimit_Struct &, CMD_RsltPayload_StartRelativeTimeLimit_Struct &)"
                         ,0xa34);
    uVar3 = FUN_009c720b(uVar3,uVar1);
  }
  uVar3 = (**(code **)(*unaff_RDI + 400))(uVar3,&local_108);
