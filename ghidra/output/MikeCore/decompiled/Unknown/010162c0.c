...
undefined8 FUN_010162c0(EVP_PKEY *param_1,char *param_2,void **param_3,X509_ALGOR *param_4)
...
LAB_010164a6:
    ...
    if (iVar6 == 0) {
      _memcpy(param_2,(void *)(longlong)(int)(uint)param_3,(size_t)key);
      goto LAB_010165d2;
    }
  }
...
LAB_01016591:
  ...
  if (iVar6 == 2) {
    ...
    *pbVar4 = *pbVar4 & 0xfc;
    ...
    if ((unaff_ESI != 0x40a) && (unaff_ESI != 0x43f)) {
      psVar5 = (segment_command *)((ulonglong)(unaff_ESI == 0x40b) ^ 0x39);
    }
