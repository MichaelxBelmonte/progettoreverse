    ...
    do {
      ...
      if (iVar5 == 0xa5) {
        ...
        if (plVar2 != (longlong *)0x0) {
          _BIO_printf((BIO *)"",(char *)(ulonglong)uVar4,*(undefined8 *)(*plVar2 + 8));
          iVar5 = _OPENSSL_sk_num();
          pcVar8 = "";
          if (1 < iVar5) {
            pcVar8 = "s";
          }
          aint = (ASN1_INTEGER *)(ulonglong)uVar4;
          param_1 = "";
          ...
          if (0 < iVar5) {
            ...
            do {
              ...
              if (lVar7 == 0) {
                ...
                _BIO_puts((BIO *)param_1,(char *)aint);
                aint = (ASN1_INTEGER *)((longlong)&section_000001a8.size + 3);
        ...
        uVar9 = *(undefined8 *)(*(longlong *)(lVar7 + 8) + 8);
        pcVar8 = param_2;
LAB_010c3541:
        param_1 = "";
