...
//   "void license_services::LsEntityUtilsLicense::add(license_services::LsLicenseWire &)"


void FUN_00a4c666(void)

{
  ...
  if (lVar4 != -1) {
    ...
    FUN_00983230();
    FUN_00983230();
    FUN_00928ab0("void license_services::LsEntityUtilsLicense::add(license_services::LsLicenseWire &)"
                 ,0x68);
    FUN_009c78cb();
  }
  FUN_009b4be0();
