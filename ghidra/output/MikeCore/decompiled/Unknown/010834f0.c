...
void FUN_010834f0(undefined8 param_1,longlong param_2)

{
  ...
  pauVar15 = unaff_RSI + param_2 * 4;
  uVar6 = *unaff_RDI;
  pauVar16 = unaff_RSI + 4;
  if (pauVar15 <= unaff_RSI + 4) {
    pauVar16 = unaff_RSI;
  }
  uVar5 = unaff_RDI[1];
  uVar7 = unaff_RDI[2];
  uVar8 = unaff_RDI[3];
  uVar12 = unaff_RDI[4];
  pauVar14 = unaff_RSI + 4;
  auVar20._0_16_ = ZEXT116(0) * *pauVar16 + ZEXT116(1) * *unaff_RSI;
  auVar20._16_16_ = ZEXT116(0) * SUB4816((undefined1  [48])0x0,0) + ZEXT116(1) * *pauVar16;
  auVar25._0_16_ = ZEXT116(0) * pauVar16[1] + ZEXT116(1) * unaff_RSI[1];
  auVar25._16_16_ = ZEXT116(0) * SUB4816((undefined1  [48])0x0,0) + ZEXT116(1) * pauVar16[1];
  auVar17 = vpshufb_avx2(auVar20,_DAT_01084ec0);
  auVar24._0_16_ = ZEXT116(0) * pauVar16[2] + ZEXT116(1) * unaff_RSI[2];
  auVar24._16_16_ = ZEXT116(0) * SUB4816((undefined1  [48])0x0,0) + ZEXT116(1) * pauVar16[2];
  auVar19 = vpshufb_avx2(auVar25,_DAT_01084ec0);
  auVar23._0_16_ = ZEXT116(0) * pauVar16[3] + ZEXT116(1) * unaff_RSI[3];
  auVar23._16_16_ = ZEXT116(0) * SUB4816((undefined1  [48])0x0,0) + ZEXT116(1) * pauVar16[3];
  auVar24 = vpshufb_avx2(auVar24,_DAT_01084ec0);
  auVar25 = vpshufb_avx2(auVar23,_DAT_01084ec0);
  local_300 = vpaddd_avx2(auVar17,_DAT_01084e40);
  local_2e0 = vpaddd_avx2(auVar19,_DAT_01084e40);
  local_2c0 = vpaddd_avx2(auVar24,_DAT_01084e40);
  local_2a0 = vpaddd_avx2(auVar25,_DAT_01084e40);
  ...
  local_280 = vpaddd_avx2(auVar23,_DAT_01084e40);
  ...
  local_260 = vpaddd_avx2(auVar30,_DAT_01084e60);
  ...
  local_240 = vpaddd_avx2(auVar29,_DAT_01084e60);
  ...
  local_220 = vpaddd_avx2(auVar27,_DAT_01084e60);
  auVar20 = _DAT_01084e60;
  do {
    ...
    uVar6 = uVar5 + local_2c0._12_4_ + (uVar8 & uVar12 ^ ~uVar8 & uVar13) +
            (uVar10 >> 0x1b | uVar10 * 0x20);
    auVar32 = vpaddd_avx2(auVar24,_DAT_01084e80);
    uVar11 = uVar6 >> 2 | uVar6 * 0x40000000;
    ...
    uVar10 = uVar11 + local_280._0_4_ + (uVar6 & uVar13 ^ ~uVar6 & uVar5) +
             (uVar8 >> 0x1b | uVar8 * 0x20);
    auVar1 = vpaddd_avx2(auVar25,_DAT_01084e80);
    uVar9 = uVar10 >> 2 | uVar10 * 0x40000000;
    ...
    uVar7 = uVar8 >> 2 | uVar8 * 0x40000000;
    auVar23 = vpaddd_avx2(auVar17,_DAT_01084e80);
    ...
    uVar12 = uVar6 >> 2 | uVar6 * 0x40000000;
    auVar30 = vpaddd_avx2(auVar2,_DAT_01084e80);
    ...
    uVar13 = uVar8 >> 2 | uVar8 * 0x40000000;
    auVar29 = vpaddd_avx2(auVar3,_DAT_01084e80);
    ...
    uVar5 = uVar10 >> 2 | uVar10 * 0x40000000;
    auVar27 = vpaddd_avx2(auVar4,_DAT_01084ea0);
    ...
    uVar9 = uVar10 >> 2 | uVar10 * 0x40000000;
    auVar26 = vpaddd_avx2(auVar18,_DAT_01084ea0);
    ...
    uVar7 = uVar8 >> 2 | uVar8 * 0x40000000;
    auVar2 = vpaddd_avx2(auVar19,_DAT_01084ea0);
    ...
    uVar12 = uVar6 >> 2 | uVar6 * 0x40000000;
    auVar3 = vpaddd_avx2(auVar21,_DAT_01084ea0);
    ...
    uVar13 = uVar8 >> 2 | uVar8 * 0x40000000;
    auVar4 = vpaddd_avx2(auVar22,_DAT_01084ea0);
    ...
    uVar8 = uVar12 + iStack_94 + (uVar6 ^ uVar9 ^ uVar7) + (uVar5 >> 0x1b | uVar5 * 0x20) +
            *unaff_RDI;
    uVar5 = uVar5 + unaff_RDI[1];
    uVar12 = (uVar6 >> 2 | uVar6 * 0x40000000) + unaff_RDI[2];
    *unaff_RDI = uVar8;
    uVar9 = uVar9 + unaff_RDI[3];
    unaff_RDI[1] = uVar5;
    uVar6 = unaff_RDI[4];
    unaff_RDI[2] = uVar12;
    unaff_RDI[3] = uVar9;
    unaff_RDI[4] = uVar7 + uVar6;
    auVar20 = _DAT_01084e60;
    ...
    auVar17 = vpshufb_avx2(auVar18,_DAT_01084ec0);
    uVar5 = uVar10 >> 2 | uVar10 * 0x40000000;
    ...
    auVar19 = vpshufb_avx2(auVar19,_DAT_01084ec0);
    local_300 = vpaddd_avx2(auVar17,_DAT_01084e40);
    uVar11 = uVar6 >> 2 | uVar6 * 0x40000000;
    ...
    auVar24 = vpshufb_avx2(auVar21,_DAT_01084ec0);
    local_2e0 = vpaddd_avx2(auVar19,_DAT_01084e40);
    ...
    auVar25 = vpshufb_avx2(auVar22,_DAT_01084ec0);
    local_2c0 = vpaddd_avx2(auVar24,_DAT_01084e40);
    ...
    uVar6 = uVar9 + iStack_84 + (uVar7 ^ uVar8 ^ uVar12) + (uVar5 >> 0x1b | uVar5 * 0x20) +
            *unaff_RDI;
    uVar5 = uVar5 + unaff_RDI[1];
    uVar7 = (uVar7 >> 2 | uVar7 * 0x40000000) + unaff_RDI[2];
    *unaff_RDI = uVar6;
    uVar8 = uVar8 + unaff_RDI[3];
    unaff_RDI[1] = uVar5;
    uVar12 = uVar12 + unaff_RDI[4];
    unaff_RDI[2] = uVar7;
    unaff_RDI[3] = uVar8;
    unaff_RDI[4] = uVar12;
