...

{
  ...
  pcVar1 = *(char **)(unaff_RDI + 0x20);
  pcVar9 = (char *)(lVar8 + 1);
  *(char **)(unaff_RDI + 0x18) = pcVar9;
  if (pcVar9 == pcVar1) goto LAB_009e8b11;
  iVar4 = (int)*pcVar9;
  bVar2 = false;
  switch(iVar4) {
  case 0x24:
    *(longlong *)(unaff_RDI + 0x18) = lVar8 + 2;
    FUN_009e818c();
    return;
  case 0x25:
  case 0x28:
  ...
  case 0x2b:
    ...
    *(char **)(unaff_RDI + 0x18) = pcVar9;
    if ((pcVar9 != pcVar1) && (*pcVar9 == '{')) {
      ...
      *(char **)(unaff_RDI + 0x18) = pcVar10;
      while (pcVar10 != pcVar1) {
        if (*pcVar10 == '}') {
          plVar5 = (longlong *)FUN_009e9238(pcVar9,pcVar10);
          lVar8 = *plVar5;
          if (plVar5[1] != lVar8) {
            do {
              FUN_009e818c();
    ...
    uVar7 = ((*(longlong **)(unaff_RDI + 8))[1] - **(longlong **)(unaff_RDI + 8) >> 3) *
            -0x5555555555555555;
    iVar4 = 0;
    if (1 < uVar7) {
      iVar4 = (int)uVar7 + -2;
    }
    plVar5 = (longlong *)FUN_009e2686(iVar4 + -1);
    lVar8 = *plVar5;
    if (plVar5[1] != lVar8) {
      do {
        FUN_009e818c();
...
LAB_009e8b11:
      *(longlong *)(unaff_RDI + 0x18) = lVar8;
      ...
      FUN_009e8d30();
      pvVar6 = (void *)((longlong)&MACH_HEADER.cpusubtype + 2);
      ...
      *(undefined8 *)(unaff_RDI + 0x18) = *(undefined8 *)(unaff_RDI + 0x18);
      ...
      if ((*(char **)(unaff_RDI + 0x18) == *(char **)(unaff_RDI + 0x20)) ||
         (**(char **)(unaff_RDI + 0x18) != '}')) goto LAB_009e8b02;
      plVar5 = (longlong *)FUN_009e2686();
      lVar8 = *plVar5;
      if (plVar5[1] != lVar8) {
        do {
