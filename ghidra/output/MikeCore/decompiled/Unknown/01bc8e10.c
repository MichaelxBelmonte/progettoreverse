...
/* WARNING: Removing unreachable block (ram,0x01bc9338) */
/* WARNING: Removing unreachable block (ram,0x01bc9344) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_01bc8e10(pthread_key_t param_1,undefined8 param_2)

{
  ...
  lVar16 = unaff_RSI[0x2c];
  if (lVar16 != 0) {
    *(undefined1 *)(unaff_RDI + 1) = 0;
    goto joined_r0x01bc9506;
  }
  (**(code **)(*(longlong *)unaff_RSI[0x2a] + 0x398))();
  ...
  if ((local_50 == (longlong *)0x0) || (*(int *)((longlong)local_50 + 0xc) == 0)) {
    ...
    *unaff_RDI = 0;
    ...
    uVar19 = (**(code **)(*unaff_RSI + 0x4d8))();
    if (fVar21 <= DAT_02390d34) {
      *(undefined1 *)(unaff_RDI + 1) = 0;
      *unaff_RDI = 0;
      bVar5 = true;
      bVar17 = true;
      ...
      if (unaff_RSI[0x2f] == 0) {
LAB_01bc91e9:
        lVar16 = unaff_RSI[0x2f];
      }
      else {
        iVar2 = *(int *)(unaff_RSI[0x2f] + 0x18);
        iVar13 = iVar2 + 3;
        if (-1 < iVar2) {
          iVar13 = iVar2;
        }
        pVar12 = iVar13 >> 2;
        if ((float)(int)pVar12 < DAT_02391098 * fVar21) {
          unaff_RSI[0x2f] = 0;
          FUN_00d50b20();
          if (unaff_RSI[0x2f] == 0) goto LAB_01bc91e9;
        }
        FUN_00d23340();
      ...
      if (lVar16 == 0) {
        ...
        FUN_00c92170();
        FUN_00c92160();
        plVar14 = (longlong *)unaff_RSI[0x2f];
        if (plVar14 == local_50) {
          ...
          unaff_RSI[0x2f] = (longlong)local_50;
...
LAB_01bc92d1:
        ...
        uVar6 = _DAT_023945e0;
        fVar21 = DAT_02390124;
        uVar3 = *(uint *)(unaff_RSI[0x2f] + 0x18);
        if (3 < (int)uVar3) {
          fVar18 = fVar18 * DAT_0239011c + (float)((ulonglong)uVar19 >> 0x20) + DAT_023b1608;
          lVar16 = *(longlong *)(unaff_RSI[0x2f] + 0x10);
          uVar15 = 0;
          do {
      ...
      (**(code **)(unaff_RSI[0x27] + 0x10))();
      FUN_00d50b00();
      FUN_01916410();
      plVar14 = (longlong *)unaff_RSI[0x2c];
      plVar11 = plVar14;
      if (plVar14 != local_50) {
        plVar11 = local_50;
        if (local_48[0] == '\0') {
          ...
          FUN_00d50b00();
          plVar14 = (longlong *)unaff_RSI[0x2c];
          unaff_RSI[0x2c] = (longlong)local_50;
        }
        else {
          local_48[0] = '\0';
LAB_01bc9445:
          unaff_RSI[0x2c] = (longlong)plVar11;
        }
        if (plVar14 != (longlong *)0x0) {
          FUN_00d50b20();
          plVar11 = local_50;
      ...
      if (unaff_RSI + 0x27 != (longlong *)0x0) {
        (**(code **)(unaff_RSI[0x27] + 0x10))();
        FUN_00d50b20();
      }
      bVar5 = false;
