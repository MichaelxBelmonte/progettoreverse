...
//   "void license_services::LsEntityUtilsAssociativeArray::add(license_services::LsAssociativeArrayWire ...


void FUN_00a46076(void)

{
  ...
  if (lVar4 != -1) {
    ...
    FUN_00983230();
    FUN_00983230();
    FUN_00928ab0("void license_services::LsEntityUtilsAssociativeArray::add(license_services::LsAssociativeArrayWire &)"
                 ,0x68);
    FUN_009c78cb();
  }
  FUN_009b4be0();
  ...
  if (lVar7 == *(longlong *)(lVar4 + 0x58)) {
    lVar7 = (lVar7 - *(longlong *)(lVar4 + 0x48) >> 3) * -0x79435e50d79435e5;
    if (0x1af286bca1af286 < lVar7 + 1U) {
                    /* WARNING: Subroutine does not return */
      std::__vector_base_common<true>::__throw_length_error();
    }
    FUN_00a46710(lVar4 + 0x58,lVar7);
    FUN_00a66f6c();
    FUN_00a46680();
    FUN_00a46780();
  }
    ...
    FUN_00a66f6c();
    *(longlong *)(lVar4 + 0x50) = lVar7 + 0x98;
  }
  return;
}
