...
void FUN_01d39830(undefined8 param_1,undefined8 param_2,float param_3,float param_4)

{
  ...
  fStack_64 = (float)((ulonglong)param_1 >> 0x20);
  fStack_60 = (float)in_XMM0_Qb;
  fStack_5c = (float)((ulonglong)in_XMM0_Qb >> 0x20);
  ...
  *(undefined4 *)((longlong)puVar10 + 0xc) = 0;
  puVar10[6] = 0;
  puVar10[7] = 0;
  *(undefined8 *)((longlong)puVar10 + 0x39) = 0;
  *(undefined8 *)((longlong)puVar10 + 0x41) = 0;
  FUN_00d500e0();
  fVar11 = _DAT_023945d0 * (float)param_2 + _DAT_023b5dd0;
  ...
  fVar18 = fVar11 + (float)param_2 + DAT_02390d00;
  ...
  if ((local_48 != 0.0) || (NAN(local_48))) {
    ...
    FUN_01d39310(auVar17._0_8_,fStack_64 + local_48,local_48,DAT_02410f88);
  }
  puVar10[7] = param_1;
  puVar10[8] = param_2;
