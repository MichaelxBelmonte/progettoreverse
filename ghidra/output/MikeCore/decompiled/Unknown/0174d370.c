...
/* WARNING: Removing unreachable block (ram,0x0174d813) */
/* WARNING: Removing unreachable block (ram,0x0174d81f) */
/* WARNING: Removing unreachable block (ram,0x0174d905) */
/* WARNING: Removing unreachable block (ram,0x0174d90e) */

void FUN_0174d370(longlong param_1)

{
  ...
  if (cVar2 == '\0') {
    ...
    if (iVar6 < unaff_ESI) {
      ...
      FUN_01736e70();
      FUN_00d23340();
      pVar10 = (pthread_key_t)CONCAT71((int7)((ulonglong)param_1 >> 8),local_50[0]);
      pcVar11 = local_38;
      if (local_50[0] != '\0') {
        pcVar11 = local_50;
      }
