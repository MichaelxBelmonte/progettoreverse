...
undefined8 FUN_01071b30(BIGNUM *param_1,longlong param_2,BIGNUM *param_3,BIGNUM *param_4)
    ...
    if ((uVar12 & 4) != 0) {
      ...
      if (pBVar6 != (BN_MONT_CTX *)0x0) {
        ...
        if (pBVar6 != (BN_MONT_CTX *)0x0) {
          if ((int)uVar1 < 1) {
            _BN_free(a);
            if (*(undefined **)(*(longlong *)(param_2 + 8) + 0x30) == PTR__BN_mod_exp_mont_0249c0e8)
            {
...
joined_r0x01072386:
    if (((uVar12 & 2) == 0) ||
       (a = param_1,
       pBVar6 = _BN_MONT_CTX_set_locked
                          ((BN_MONT_CTX **)param_1,(int)*(undefined8 *)(param_2 + 0x18),param_3,
                           (BN_CTX *)param_4), pBVar6 != (BN_MONT_CTX *)0x0)) {
      if (bVar15) {
        a = param_1;
        iVar2 = _bn_from_mont_fixed_top(param_1,*(undefined8 *)(param_2 + 0x88));
        uVar13 = 0;
        uVar14 = 0;
        if ((iVar2 == 0) ||
           (a = param_1, iVar2 = _bn_to_mont_fixed_top(param_1,*(undefined8 *)(param_2 + 0x88)),
        ...
        uVar14 = uVar13;
        if ((iVar2 == 0) ||
           ((a = param_1, iVar2 = _bn_from_mont_fixed_top(param_1,*(undefined8 *)(param_2 + 0x80)),
            iVar2 == 0 ||
            (a = param_1, iVar2 = _bn_to_mont_fixed_top(param_1,*(undefined8 *)(param_2 + 0x80)),
            iVar2 == 0)))) goto LAB_010723c5;
        ...
        iVar2 = _bn_mul_mont_fixed_top(a,*(undefined8 *)(param_2 + 0x50),param_1);
        if ((iVar2 == 0) ||
           (a = param_1, iVar2 = _bn_mul_fixed_top(param_1,*(undefined8 *)(param_2 + 0x38)),
           iVar2 == 0)) goto LAB_010723c5;
...
LAB_01071d88:
        if ((*(BIGNUM **)(param_2 + 0x20) != (BIGNUM *)0x0) &&
          ...
          if (*(undefined **)(*(longlong *)(param_2 + 8) + 0x30) == PTR__BN_mod_exp_mont_0249c0e8) {
            ...
            a = *(BIGNUM **)(param_2 + 0x18);
            pBVar5 = *(BIGNUM **)(param_2 + 0x78);
            iVar2 = (**(code **)(*(longlong *)(param_2 + 8) + 0x30))
                              (a,*(undefined8 *)(param_2 + 0x20));
          }
          if ((iVar2 == 0) || (iVar2 = _BN_sub(a,unaff_RSI,pBVar4), iVar2 == 0)) goto LAB_010723c2;
          iVar2 = _BN_is_zero();
          if (iVar2 == 0) {
            a = *(BIGNUM **)(param_2 + 0x18);
            uVar13 = 0;
            ...
            if (iVar2 == 0) {
              ...
              a = *(BIGNUM **)(param_2 + 0x18);
              iVar2 = (**(code **)(*(longlong *)(param_2 + 8) + 0x30))
                                (a,pBVar4,param_1,*(undefined8 *)(param_2 + 0x78));
              _BN_free(a);
              if (iVar2 == 0) goto LAB_010723c5;
            }
          }
      ...
      if (pBVar7 != (BIGNUM *)0x0) {
        ...
        if (pBVar8 != (BIGNUM *)0x0) {
          ...
          iVar2 = (**(code **)(*(longlong *)(param_2 + 8) + 0x30))(a,pBVar8,param_1);
          if (iVar2 != 0) {
            _BN_free(a);
            a = *(BIGNUM **)(param_2 + 0x30);
            uVar14 = 0;
            ...
            pBVar9 = param_1;
            iVar2 = (**(code **)(*(longlong *)(param_2 + 8) + 0x30))(a,pBVar7);
            _BN_free(a);
            if (iVar2 == 0) goto LAB_010723c5;
            if (0 < (int)uVar1) {
              pBVar7 = _BN_new();
              ...
              do {
                ...
                auStack_58[(longlong)pBVar11] = pBVar9;
                if (pBVar9 == (BIGNUM *)0x0) {
LAB_010723b1:
                  _BN_free(a);
                  goto LAB_010723bd;
                }
                puVar10 = (undefined8 *)_OPENSSL_sk_value();
                _BN_with_flags();
                _BN_with_flags();
                a = (BIGNUM *)*puVar10;
              ...
              } while ((BN_CTX *)(ulonglong)uVar1 != pBVar11);
              _BN_free(a);
              _BN_free(a);
            }
            ...
            if (0 < (int)uVar1) {
              ...
              in_stack_ffffffffffffff68 = (BN_CTX *)(ulonglong)uVar1;
              pBVar11 = (BN_CTX *)0x0;
              do {
                puVar10 = (undefined8 *)_OPENSSL_sk_value();
                iVar2 = _BN_sub(a,unaff_RDI,pBVar9);
                if ((iVar2 == 0) ||
                   (a = param_1,
