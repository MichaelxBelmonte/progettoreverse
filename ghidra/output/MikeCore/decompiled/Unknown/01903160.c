...
void FUN_01903160(undefined8 param_1,longlong *param_2)

{
  ...
  *pcVar6 = '\0';
  ...
  if (local_58 == lVar1) {
    ...
    iVar9 = *(int *)(*(longlong *)(unaff_RDI + 0x38) + 0xc);
    if ((local_38[0] != '\0') && (local_58 != 0)) {
      FUN_00d50b20();
    }
    iVar11 = 0;
    if (iVar9 != 0) {
      ...
      *pcVar4 = '\0';
      ...
      if (local_58 == lVar1) {
        lVar1 = *param_2;
        iVar11 = *(int *)(*(longlong *)(unaff_RDI + 0x38) + 0xc) + -1;
...
joined_r0x01903357:
  ...
  *pcVar6 = '\0';
  ...
  iVar10 = *(int *)(*(longlong *)(unaff_RDI + 0x38) + 0xc);
  if ((local_38[0] != '\0') && (local_58 != 0)) {
    FUN_00d50b20();
  }
  iVar9 = 0;
