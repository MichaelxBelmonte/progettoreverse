...
//   "virtual void pace::ILok2Commander::CloseConnection(const CMD_CmmdPayload_CloseConnection_Struct &, ...


void FUN_0099856a(undefined8 param_1,undefined8 param_2)

{
  ...
  if (unaff_RDI[7] == 0) {
    FUN_00925fd0();
    uVar1 = FUN_00926010();
    uVar3 = FUN_00928ab0("virtual void pace::ILok2Commander::CloseConnection(const CMD_CmmdPayload_CloseConnection_Struct &, CMD_RsltPayload_CloseConnection_Struct &)"
                         ,0x13e);
    uVar3 = FUN_009c720b(uVar3,uVar1);
  }
  uVar3 = (**(code **)(*unaff_RDI + 0x28))(uVar3,&local_108);
