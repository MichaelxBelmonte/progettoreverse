...
undefined8 FUN_010a0b90(PKCS12 *param_1,undefined8 param_2,longlong *param_3,X509 **param_4)
    ...
    *(undefined4 *)param_4 = 1;
    ...
    if ((iVar1 == 0) && (iVar2 = _PKCS12_verify_mac(param_1,(char *)0x0,iVar2), iVar2 == 0)) {
      ...
      if (lVar6 == 0) {
        ...
        iVar2 = _PKCS12_verify_mac((PKCS12 *)pcVar8,(char *)(ulonglong)sVar3,local_res10);
...
LAB_010a0dae:
          ...
          if (iVar2 < 1) {
            local_448 = (ASN1_BIT_STRING *)((longlong)&MACH_HEADER.magic + 1);
          }
          else {
            do {
              _OPENSSL_sk_value();
