...
/* WARNING: Removing unreachable block (ram,0x0009b368) */
/* WARNING: Removing unreachable block (ram,0x0009b35c) */
/* WARNING: Removing unreachable block (ram,0x0009b84a) */
/* WARNING: Removing unreachable block (ram,0x0009b856) */

void FUN_0009b2d0(undefined8 param_1,int param_2)

{
  ...
  if (((param_2 == 0) && (iVar6 = FUN_00d45870(), iVar6 == unaff_ESI)) && (unaff_RDI[2] != 0)) {
    return;
  }
  iVar6 = FUN_00d45870();
  if (iVar6 != unaff_ESI) {
    lVar7 = unaff_RDI[0x11];
    if (lVar7 != 0) {
      FUN_00d50b00();
    }
    FUN_006c5ee0();
...
LAB_0009b3cc:
  ...
  if (unaff_RDI[0x13] != 0) {
    ...
    iStack_3c = 0;
    local_38 = 0;
    local_48 = unaff_RDI[0x13];
    while( true ) {
      lVar7 = (longlong)local_40;
      local_40 = local_40 + 1;
      if (*(int *)(local_48 + 0xc) <= local_40) break;
      local_58 = *(longlong *)(*(longlong *)(local_48 + 0x10) + 8 + lVar7 * 8);
      FUN_00017760();
      if (iStack_3c != 0) {
        if (iStack_3c < 0) {
          iStack_3c = -iStack_3c;
  ...
  if (iVar6 < 2) {
    if (((longlong *)unaff_RDI[0x10] != (longlong *)0x0) &&
       ((**(code **)(*(longlong *)unaff_RDI[0x10] + 0x478))(), unaff_RDI[0x10] != 0)) {
      unaff_RDI[0x10] = 0;
      FUN_00d50b20();
    }
  }
  else if (unaff_RDI[0x10] == 0) {
    ...
    if (lVar2 == 0) {
      ...
      *pcVar9 = '\0';
      ...
      do {
        ...
        lVar2 = *(longlong *)(*(longlong *)(lVar8 + 0x10) + lVar7 * 8);
        lVar3 = unaff_RDI[0x17];
        local_58 = lVar2;
        if (lVar3 != 0) {
          FUN_00d50b00();
        }
