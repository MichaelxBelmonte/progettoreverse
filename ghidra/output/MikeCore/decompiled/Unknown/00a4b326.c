...
//   "void license_services::LsEntityUtilsExpirationWarning::add(license_services::LsExpirationWarningWir...


void FUN_00a4b326(void)

{
  ...
  if (lVar4 != -1) {
    ...
    FUN_00983230();
    FUN_00983230();
    FUN_00928ab0("void license_services::LsEntityUtilsExpirationWarning::add(license_services::LsExpirationWarningWire &)"
                 ,0x68);
    FUN_009c78cb();
  }
  FUN_009b4be0();
  ...
  if (lVar7 == *(longlong *)(lVar4 + 0x58)) {
    lVar7 = (lVar7 - *(longlong *)(lVar4 + 0x48) >> 4) * -0x30c30c30c30c30c3;
    if (0xc30c30c30c30c3 < lVar7 + 1U) {
                    /* WARNING: Subroutine does not return */
      std::__vector_base_common<true>::__throw_length_error();
    }
    FUN_00a4b9c0(lVar4 + 0x58,lVar7);
    FUN_00a9cfcc();
    FUN_00a4b930();
    FUN_00a4ba30();
  }
    ...
    FUN_00a9cfcc();
    *(longlong *)(lVar4 + 0x50) = lVar7 + 0x150;
  }
  return;
}
