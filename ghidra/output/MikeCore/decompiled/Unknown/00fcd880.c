// Function: FUN_00fcd880
// Address: 00fcd880
// Size: 530 bytes
// Class: Unknown


void FUN_00fcd880(undefined8 param_1,longlong param_2)

{
  ...
  *unaff_RDI = *unaff_RSI + unaff_RSI[10];
  ...
  FUN_00fcc780(uVar13,unaff_RSI + 0x1e);
  iVar1 = (int)*(undefined8 *)(unaff_RSI + 0x14) * 2;
  iVar2 = (int)((ulonglong)*(undefined8 *)(unaff_RSI + 0x14) >> 0x20) * 2;
  iVar3 = unaff_RSI[0x16];
  iVar4 = unaff_RSI[0x17];
  iVar5 = unaff_RSI[0x18];
  iVar6 = unaff_RSI[0x19];
  iVar7 = unaff_RSI[0x1a];
  iVar8 = unaff_RSI[0x1b];
  iVar9 = unaff_RSI[0x1c];
  iVar10 = unaff_RSI[0x1d];
