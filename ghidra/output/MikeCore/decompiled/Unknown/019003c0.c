...
longlong * FUN_019003c0(double param_1,int *param_2)
...
LAB_0190068b:
  ...
  lVar2 = *(longlong *)(unaff_RSI + 0x38);
  lVar6 = (longlong)iVar3;
  if (iVar3 == *(int *)(lVar2 + 0xc) + -2) {
    lVar2 = *(longlong *)(*(longlong *)(lVar2 + 0x10) + 8 + lVar6 * 8);
    dVar8 = (double)FUN_01907950();
    if (param_1 <= dVar8) {
      lVar2 = *(longlong *)(unaff_RSI + 0x38);
      goto LAB_0190055d;
...
LAB_0190055d:
    ...
    if (iVar3 != 0) {
      if ((dVar8 == param_1) && (!NAN(dVar8) && !NAN(param_1))) {
        lVar2 = *(longlong *)
                 (*(longlong *)(*(longlong *)(unaff_RSI + 0x38) + 0x10) + -8 + lVar6 * 8);
        FUN_01907950();
      }
      goto LAB_0190059a;
    }
