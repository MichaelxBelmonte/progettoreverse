...

{
  ...
  iVar11 = (**(code **)(*unaff_RSI + 0x30))(4,0xc);
  iVar12 = FUN_008d98ba();
  iVar13 = (**(code **)(*unaff_RSI + 0x38))();
  iVar14 = (**(code **)(*unaff_RSI + 0x30))(5,0xc);
  iVar15 = FUN_008d9cf0();
  iVar16 = (**(code **)(*unaff_RSI + 0x38))();
  iVar17 = (**(code **)(*unaff_RSI + 0x30))(6,0xc);
  iVar18 = FUN_008dba22();
  iVar19 = (**(code **)(*unaff_RSI + 0x38))();
  iVar20 = (**(code **)(*unaff_RSI + 0x30))(7,0xf);
  ...
  for (plVar22 = *(longlong **)(unaff_RDI + 0x1e8); plVar22 != *(longlong **)(unaff_RDI + 0x1f0);
