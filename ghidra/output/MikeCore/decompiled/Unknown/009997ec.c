...
//   "virtual void pace::ILok2Commander::SubmitSignedMessage(bool, const vector<uint8_t> &, CMD_RsltPaylo...


void FUN_009997ec(undefined8 param_1,undefined8 param_2)

{
  ...
  if (unaff_RDI[7] == 0) {
    FUN_00925fd0();
    uVar1 = FUN_00926010();
    uVar3 = FUN_00928ab0("virtual void pace::ILok2Commander::SubmitSignedMessage(bool, const vector<uint8_t> &, CMD_RsltPayload_SubmitSignedMessage_Struct &)"
                         ,0x2f5);
    FUN_009c720b(uVar3,uVar1);
  }
  uVar3 = (**(code **)(*unaff_RDI + 0x1b8))(&local_110,param_2);
