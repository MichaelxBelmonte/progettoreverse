...
void FUN_010816a0(undefined8 param_1,longlong param_2)

{
  ...
  auVar1._4_4_ = unaff_RDI[2];
  auVar1._0_4_ = unaff_RDI[3];
  auVar1._8_4_ = unaff_RDI[1];
  auVar1._12_4_ = *unaff_RDI;
  auVar2._0_12_ = ZEXT812(0);
  auVar2._12_4_ = unaff_RDI[4];
  auVar4 = pshufb(*unaff_RSI,_DAT_01084ee0);
  auVar6 = pshufb(unaff_RSI[1],_DAT_01084ee0);
  auVar8 = pshufb(unaff_RSI[2],_DAT_01084ee0);
  auVar9 = pshufb(unaff_RSI[3],_DAT_01084ee0);
  do {
    param_2 = param_2 + -1;
  ...
  *unaff_RDI = auVar7._12_4_;
  unaff_RDI[1] = auVar7._8_4_;
  unaff_RDI[2] = auVar7._4_4_;
  unaff_RDI[3] = auVar7._0_4_;
  unaff_RDI[4] = auVar2._12_4_;
  return;
}
