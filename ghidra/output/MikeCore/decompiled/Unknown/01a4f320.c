...
ulonglong FUN_01a4f320(undefined8 param_1,longlong *param_2)
...
LAB_01a4f4b3:
    ...
    if (cVar6 != '\0') {
      ...
      if (local_138 == (longlong *)0x0) {
        ...
        plVar15 = (longlong *)
                  CONCAT71((int7)((ulonglong)local_138 >> 8),
                           *(int *)((longlong)local_138 + 0xc) != 0);
        local_88 = CONCAT71((int7)((ulonglong)plVar11 >> 8),1);
      }
      pVar16 = (pthread_key_t)plVar17;
      if (((char)local_130 != '\0') && (local_138 != (longlong *)0x0)) {
        uVar23 = FUN_00d50b20();
      }
      if ((char)plVar15 == '\0') {
        bVar2 = false;
      ...
      local_198 = local_138;
      if ((char)local_130 == '\0') {
        if (((local_138 != (longlong *)0x0) && (FUN_00d50b00(), (char)local_130 != '\0')) &&
           (local_138 != (longlong *)0x0)) {
          FUN_00d50b20();
        }
      }
      ...
      FUN_01d3abf0();
      local_1b8 = (longlong *)FUN_01e466c0();
      local_3c = 0;
...
LAB_01a4f680:
      ...
      if (plVar11 != local_138) {
        ...
        plVar15 = (longlong *)CONCAT71((int7)((ulonglong)plVar15 >> 8),cVar6);
        if ((char)local_130 != '\0') {
          *unaff_RSI = (longlong)local_138;
...
LAB_01a4f721:
        *(undefined1 *)(unaff_RSI + 1) = 1;
        if (*unaff_RSI == 0) goto LAB_01a50984;
LAB_01a4f732:
        iVar7 = FUN_01d3a5a0();
        if (iVar7 == 6) {
          if (((char)local_130 != '\0') && (local_138 != (longlong *)0x0)) {
        ...
        uVar8 = *(uint *)((longlong)local_58 + 0xc);
        if (((char)local_130 != '\0') && (local_138 != (longlong *)0x0)) {
          FUN_00d50b20();
        }
        plVar20 = (longlong *)(ulonglong)uVar8;
        if (uVar8 == 0) goto LAB_01a509ba;
        iVar7 = FUN_01d3a5a0();
        if (iVar7 == 5) {
          (**(code **)(*plVar17 + 0x958))();
          cVar6 = (**(code **)(*local_138 + 0x3c8))();
          uVar22 = (undefined7)((ulonglong)plVar15 >> 8);
          plVar15 = local_138;
          if (cVar6 == '\0') {
            if (((char)local_130 != '\0') && (local_138 != (longlong *)0x0)) {
              FUN_00d50b20();
...
LAB_01a4f848:
            ...
            if (local_138 == local_70) {
              plVar15 = plVar11;
              uVar9 = local_3c;
              if (((char)local_3c == '\0') && (local_138 != (longlong *)0x0)) {
                uVar9 = (undefined4)CONCAT71(uVar22,1);
              ...
              if ((char)local_130 != '\0') {
                local_70 = local_138;
                uVar9 = (undefined4)CONCAT71(uVar22,1);
                if (((char)local_3c == '\0') || (plVar11 == (longlong *)0x0)) goto LAB_01a4f8c6;
                FUN_00d50b20();
                goto LAB_01a4f9a1;
              }
              if (local_138 != (longlong *)0x0) {
              ...
              local_70 = local_138;
              uVar9 = (undefined4)CONCAT71(uVar22,1);
              if (((char)local_3c != '\0') && (plVar11 != (longlong *)0x0)) {
                FUN_00d50b20();
              }
            }
            if (((char)local_130 != '\0') && (local_138 != (longlong *)0x0)) {
...
LAB_01a4f9a1:
          ...
          if ((char)local_1b8 != '\0') {
            FUN_00d23340();
            local_50 = (longlong *)CONCAT71(local_50._1_7_,(char)local_130);
            pplVar18 = &local_50;
            pplVar14 = &local_130;
            if ((char)local_130 == '\0') {
              pplVar14 = pplVar18;
            ...
            *(undefined1 *)pplVar14 = 0;
            ...
            pvVar10 = _pthread_getspecific((pthread_key_t)pplVar18);
            if (pvVar10 != (void *)0x0) {
              FUN_00e8b990();
            }
            plVar11 = (longlong *)FUN_00e8b990();
            (**(code **)(*plVar11 + 0x3b8))();
            if (((char)local_50 != '\0') && (local_138 != (longlong *)0x0)) {
              FUN_00d50b20();
            }
          }
          FUN_00083c20();
          ...
          if (*pplVar18 == (longlong *)0x0) {
            ...
            local_1a0 = (longlong *)(**(code **)(*plVar15 + 0x370))(local_358);
            local_80 = (longlong *)(**(code **)(*plVar15 + 0x370))(local_78);
            uVar25 = FUN_01a51960();
            FUN_00c9fe20();
            local_50 = (longlong *)CONCAT71(local_50._1_7_,(char)local_130);
            pplVar18 = &local_130;
            ...
            *(undefined1 *)pplVar18 = 0;
            ...
            else if (local_138 != (longlong *)0x0) {
LAB_01a500d1:
              local_130._0_1_ = '\0';
              local_138 = (longlong *)0x0;
              local_350 = plVar19;
              ...
              while( true ) {
                ...
                lVar12 = (longlong)(int)local_120;
                iVar7 = (int)local_120 + 1;
                local_120 = CONCAT44(local_120._4_4_,iVar7);
                if (*(int *)((longlong)local_128 + 0xc) <= iVar7) break;
                local_138 = *(longlong **)(local_128[2] + 8 + lVar12 * 8);
                local_2c0 = '\0';
                local_2c8 = local_138;
                local_1b8 = (longlong *)FUN_019c1040(local_80);
                local_2b0 = '\0';
                local_2b8 = local_138;
            ...
            local_1b8 = (longlong *)FUN_01a8fc90(local_78);
...
LAB_01a4fd98:
              ...
              while( true ) {
                ...
                local_188 = '\x01';
                local_190 = plVar15;
                FUN_01281db0(uVar13,(*(int *)(unaff_RDI + 0x34) != 0) * '\x02');
          ...
          *(undefined1 *)pplVar14 = 0;
          ...
          plVar15 = (longlong *)FUN_00e8b990();
          uVar9 = (**(code **)(*plVar15 + 0x3c0))();
          local_1b8 = (longlong *)CONCAT44(local_1b8._4_4_,uVar9);
          if ((local_68 != '\0') && (local_138 != (longlong *)0x0)) {
            FUN_00d50b20();
          }
          local_288 = local_50;
          local_280 = '\0';
          ...
          local_278 = local_50;
          local_270 = '\0';
          local_80 = (longlong *)FUN_012664b0();
      ...
      if (((char)unaff_RSI[1] == '\0') && (local_138 != (longlong *)0x0)) {
        if ((char)local_130 == '\0') {
          FUN_00d50b00();
          goto LAB_01a4f721;
        }
LAB_01a4f6dc:
      ...
      if (*unaff_RSI != 0) goto LAB_01a4f732;
LAB_01a50984:
      if (((char)local_130 != '\0') && (local_138 != (longlong *)0x0)) {
        FUN_00d50b20();
      }
LAB_01a509ba:
      ...
      bVar1 = true;
      bVar2 = false;
      uVar21 = CONCAT71((int7)((ulonglong)plVar20 >> 8),1);
      bVar4 = true;
      bVar5 = false;
