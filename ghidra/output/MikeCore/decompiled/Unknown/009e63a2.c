...
char * FUN_009e63a2(char *param_1,longlong param_2,char param_3)
  ...
  if (*(int *)(param_2 + 0x10) != 0) {
    ...
    do {
      ...
      if (*pcVar8 == '\0') {
        cVar4 = *unaff_RDI;
        if (param_3 != '\0') {
          pcVar6 = (char *)**(undefined8 **)(*plVar2 + 8);
        ...
        while (pcVar8 = pcVar9 + 1, unaff_RSI != pcVar10) {
          cVar4 = *pcVar10;
          if (param_3 != '\0') {
            lVar7 = **(longlong **)(*plVar2 + 8);
            cVar4 = (**(code **)(lVar7 + 0x28))();
            pcVar6 = (char *)CONCAT71((int7)((ulonglong)lVar7 >> 8),*pcVar9);
          }
...
LAB_009e64db:
  ...
  cVar4 = *unaff_RDI;
  if (param_3 != '\0') {
    cVar4 = (**(code **)(**(longlong **)(*plVar2 + 8) + 0x28))();
  }
