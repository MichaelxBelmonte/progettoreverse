...
void FUN_00c6c630(int param_1,undefined1 *param_2,uint param_3,byte param_4)

{
  ...
  if (local_res8 == 0) {
    if (local_res18 == 0) {
      ...
      uVar6 = 0;
      do {
        uVar9 = *(int *)(unaff_RDI + uVar6 * 4) << (bVar4 & 0x1f);
        uVar5 = *(ushort *)(local_res10 + uVar6 * 4) | uVar9;
        uVar8 = *(int *)(unaff_RSI + uVar6 * 4) << (bVar4 & 0x1f);
    ...
    if (0 < (int)param_3) {
      ...
      uVar6 = 0;
      do {
        iVar2 = *(int *)(unaff_RSI + uVar6 * 4);
        iVar7 = (*(int *)(unaff_RDI + uVar6 * 4) + iVar2) - (iVar2 * local_res8 >> (param_4 & 0x1f))
        ;
