...

{
  ...
  for (lVar28 = *(longlong *)(unaff_RDI + 0x18); lVar28 != *(longlong *)(unaff_RDI + 0x20);
      lVar28 = lVar28 + 1) {
  ...
  iVar6 = (**(code **)(*unaff_RSI + 0x30))(0xb,10);
  iVar7 = (**(code **)(*unaff_RSI + 0x98))();
  iVar8 = (**(code **)(*unaff_RSI + 0x38))();
  iVar9 = (**(code **)(*unaff_RSI + 0x30))(0xc,10);
  iVar10 = (**(code **)(*unaff_RSI + 0x98))();
  iVar11 = (**(code **)(*unaff_RSI + 0x38))();
  iVar12 = (**(code **)(*unaff_RSI + 0x30))(0xd,10);
  iVar13 = (**(code **)(*unaff_RSI + 0x98))();
  iVar14 = (**(code **)(*unaff_RSI + 0x38))();
  iVar16 = (**(code **)(*unaff_RSI + 0x30))(0xe,8);
  iVar17 = (**(code **)(*unaff_RSI + 0x90))();
  iVar18 = (**(code **)(*unaff_RSI + 0x38))();
  iVar19 = (**(code **)(*unaff_RSI + 0x30))(0xf,8);
  iVar20 = (**(code **)(*unaff_RSI + 0x90))();
  iVar21 = (**(code **)(*unaff_RSI + 0x38))();
  iVar22 = (**(code **)(*unaff_RSI + 0x30))(0x14,2);
  iVar23 = (**(code **)(*unaff_RSI + 0x78))();
  iVar24 = (**(code **)(*unaff_RSI + 0x38))();
  iVar25 = (**(code **)(*unaff_RSI + 0x30))(0x15,2);
  ...
  iVar21 = iVar1 + iVar27 + iVar2 + iVar3 + iVar4 + iVar5 + iVar6 + iVar7 + iVar8 + iVar9 + iVar10 +
           ...
           iVar21;
  if (*(char *)(unaff_RDI + 0x387) != '\0') {
    iVar1 = (**(code **)(*unaff_RSI + 0x30))(0x28,0xc);
    iVar2 = FUN_008f4812();
    iVar3 = (**(code **)(*unaff_RSI + 0x38))();
    iVar21 = iVar1 + iVar21 + iVar2 + iVar3;
  }
  iVar1 = (**(code **)(*unaff_RSI + 0x30))(0x29,0xb);
  iVar2 = (**(code **)(*unaff_RSI + 0xa8))();
  iVar3 = (**(code **)(*unaff_RSI + 0x38))();
