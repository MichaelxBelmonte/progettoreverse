...
undefined8 FUN_01054680(ENGINE *param_1,undefined8 *param_2,undefined8 param_3,ENGINE *param_4)

{
  ...
  while( true ) {
    ...
    if (iVar2 == 0) {
      ...
      if (0xc < (int)sVar5) {
        iVar2 = _strcmp((char *)e,pcVar8);
        if (((iVar2 == 0) && (*(char *)((longlong)(int)sVar5 + -0xc) == ' ')) &&
           (0 < (int)(sVar5 - 0xc))) {
          bVar10 = false;
          lVar7 = _EVP_PKEY_asn1_find_str();
          if ((lVar7 != 0) && (*(longlong *)(lVar7 + 0xb8) != 0)) break;
        }
      }
    }
    else {
      ...
      if (iVar2 == 0) {
        ...
        if (0xb < (int)sVar5) {
          iVar2 = _strcmp((char *)e,pcVar8);
          if (((iVar2 == 0) && (*(char *)((longlong)(int)sVar5 + -0xb) == ' ')) &&
             ((0 < (int)(sVar5 - 0xb) && (lVar7 = _EVP_PKEY_asn1_find_str(), lVar7 != 0)))) {
            bVar10 = *(longlong *)(lVar7 + 0x70) != 0;
            _ENGINE_finish(e);
          }
        }
      }
