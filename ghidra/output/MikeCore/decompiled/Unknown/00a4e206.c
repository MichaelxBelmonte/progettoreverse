...
//   "void license_services::LsEntityUtilsSignature::add(license_services::LsSignatureWire &)"


void FUN_00a4e206(void)

{
  ...
  if (lVar5 != -1) {
    ...
    FUN_00983230();
    FUN_00983230();
    FUN_00928ab0("void license_services::LsEntityUtilsSignature::add(license_services::LsSignatureWire &)"
                 ,0x68);
    FUN_009c78cb();
  }
  FUN_009b4be0();
  ...
  if (lVar8 == *(longlong *)(lVar5 + 0x58)) {
    lVar8 = (lVar8 - *(longlong *)(lVar5 + 0x48) >> 5) * -0x3333333333333333;
    if (0x199999999999999 < lVar8 + 1U) {
                    /* WARNING: Subroutine does not return */
      std::__vector_base_common<true>::__throw_length_error();
    }
    FUN_00a4e814(lVar5 + 0x58,lVar8);
    FUN_00aaaaa2();
    FUN_00a91810();
    FUN_00a3a320();
  }
    ...
    FUN_00aaaaa2();
    *(longlong *)(lVar5 + 0x50) = lVar8 + 0xa0;
  }
  return;
}
