...
//   "void license_services::LsEntityUtilsMachineBinding::add(license_services::LsMachineBindingWire &)"


void FUN_00a4d006(void)

{
  ...
  if (lVar5 != -1) {
    ...
    FUN_00983230();
    FUN_00983230();
    FUN_00928ab0("void license_services::LsEntityUtilsMachineBinding::add(license_services::LsMachineBindingWire &)"
                 ,0x68);
    FUN_009c78cb();
  }
  FUN_009b4be0();
  ...
  if (lVar8 == *(longlong *)(lVar5 + 0x58)) {
    lVar8 = (lVar8 - *(longlong *)(lVar5 + 0x48) >> 6) * -0x5555555555555555;
    if (0x155555555555555 < lVar8 + 1U) {
                    /* WARNING: Subroutine does not return */
      std::__vector_base_common<true>::__throw_length_error();
    }
    FUN_00a37458(lVar5 + 0x58,lVar8);
    FUN_00aa58e2();
    FUN_00a373c8();
    FUN_00a8fd44();
  }
    ...
    FUN_00aa58e2();
    *(longlong *)(lVar5 + 0x50) = lVar8 + 0xc0;
  }
  return;
}
