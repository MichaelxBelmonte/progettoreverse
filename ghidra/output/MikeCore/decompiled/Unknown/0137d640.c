...
LAB_0137d7e6:
    ...
    while( true ) {
      ...
      pvVar8 = _pthread_getspecific((pthread_key_t)*(longlong *)(local_78 + 0x10));
      if (pvVar8 != (void *)0x0) {
        FUN_00e8b990();
      }
      ...
      *(double *)(local_90[2] + (longlong)iVar13) = local_48;
      if (local_70._4_4_ != 0) {
        if (local_70 < 0) {
    ...
    FUN_001150f0();
    FUN_00d50b20();
    local_128 = *(longlong *)(unaff_RSI + 0x40);
  ...
  lVar7 = *(longlong *)(unaff_RSI + 0x1b0);
  if (lVar7 != 0) {
    FUN_00d50b00();
  }
...
LAB_0137da4d:
  ...
  pvVar8 = _pthread_getspecific((pthread_key_t)uVar11);
  if (pvVar8 != (void *)0x0) {
    plVar14 = *(longlong **)(unaff_RSI + 0x38);
    lVar7 = FUN_00e8b990();
    if (lVar7 != 0) {
  ...
  if ((int)uVar2 < 1) {
    ...
    *unaff_RDI = 0;
    ...
    local_e8 = (ulonglong)uVar2;
    do {
      pVar10 = (pthread_key_t)uVar11;
      uVar11 = (ulonglong)((int)uVar15 - 1);
      lVar7 = *(longlong *)(*(longlong *)(local_58 + 0x10) + uVar11 * 8);
      if (lVar7 != 0) {
        FUN_00d50b00();
      }
      local_38 = lVar7;
      ...
      do {
        ...
        lVar7 = lVar7 + 1;
      } while ((_DAT_0240d308 <= dVar20) || (dVar20 <= DAT_023944d8));
      FUN_00d23340();
      lVar7 = local_88;
      local_a8 = local_80[0];
      pcVar9 = local_80;
      ...
      *pcVar9 = '\0';
      ...
      local_f0 = 1;
      local_f8 = lVar7;
      lVar12 = (longlong)(local_48 * local_100);
...
LAB_0137dd10:
      ...
      if (lVar16 != 0) {
        ...
        if (DAT_023942a8 < (float)((uint)(local_48._0_4_ - fVar17) & _DAT_02390140)) {
          local_d8 = '\0';
          local_e0 = lVar16;
          pvVar8 = _pthread_getspecific(pVar10);
          if ((pvVar8 != (void *)0x0) && (lVar7 = FUN_00e8b990(), lVar7 != 0)) {
        ...
        fVar17 = (float)FUN_0125a2c0();
        if (DAT_02394240 < (float)((uint)(local_48._0_4_ - fVar17) & _DAT_02390140)) {
          local_c8 = '\0';
          local_d0 = lVar16;
          pvVar8 = _pthread_getspecific(pVar10);
          if (pvVar8 != (void *)0x0) {
