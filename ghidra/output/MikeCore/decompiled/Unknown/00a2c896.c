...
void FUN_00a2c896(undefined8 param_1,undefined8 param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a2c93b:
    if ((plVar15 == plVar4) || ((longlong)plVar15 - (longlong)plVar3 == -8)) goto LAB_00a2c949;
    lVar16 = (longlong)plVar15 - (longlong)plVar3 >> 3;
  }
  else {
    do {
      if (*plVar15 == lVar16) goto LAB_00a2c93b;
      plVar15 = plVar15 + 1;
...
LAB_00a2c949:
  ...
  *(longlong *)((longlong)pvVar10 + 0x18) = lVar8 + lVar16 * 8 + ((longlong)pvVar9 >> 3) * 8;
  lVar13 = lVar16 * 0x130 + *(longlong *)((longlong)pvVar7 + 0x48);
  lVar11 = lVar13 + 0x130;
  ...
  if (lVar11 != lVar8) {
    ...
    if (lVar11 == lVar14) goto LAB_00a2ca7c;
  }
  do {
    puVar1 = (undefined8 *)(lVar11 + -0x130);
    lVar11 = lVar11 + -0x130;
    (**(code **)*puVar1)();
    sVar12 = (size_t)param_3;
  } while (lVar14 != lVar11);
LAB_00a2ca7c:
  *(longlong *)((longlong)pvVar7 + 0x50) = lVar14;
  ...
  if (plVar4 != (longlong *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00a2cb09. Too many branches */
