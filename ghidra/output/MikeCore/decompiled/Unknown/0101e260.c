...

{
  ...
  if ((out != (uint *)0x0) && (pBVar2 != (BIO *)0x0)) {
    ...
    out[0] = 0;
    out[1] = 0;
    if ((unaff_RSI != (BIO *)0x0) && (0 < (int)inl)) {
      local_34 = 0;
      do {
        outl = &segment_command_000003d8.fileoff;
        if ((int)inl < 0x400) {
          outl = (qword *)(ulonglong)inl;
        }
        ...
        if ((uVar4 & 0x100) == 0) {
          param_1 = unaff_RSI;
          param_2 = out;
          _EVP_EncodeUpdate((EVP_ENCODE_CTX *)unaff_RSI,(uchar *)out,(int *)outl,param_4,inl);
          if (extraout_EAX == 0) {
...
LAB_0101e4dc:
          ...
          if ((int)uVar4 < 1) {
            ...
            param_1 = (BIO *)(ulonglong)uVar4;
            uVar1 = uVar1 - (uVar4 & 0xffff);
            param_2 = (uint *)(ulonglong)uVar1;
          ...
          _memcpy(param_1,(void *)(ulonglong)uVar1,n);
          uVar4 = out[2] + uVar1;
          param_2 = (uint *)(ulonglong)uVar4;
          out[2] = uVar4;
          local_34 = local_34 + uVar1;
          if ((int)uVar4 < 3) {
            return local_34;
        ...
        inl = inl - uVar1;
        unaff_RSI = (BIO *)((longlong)&unaff_RSI->method + (ulonglong)uVar1);
        out[1] = 0;
        while (0 < (int)uVar4) {
          param_2 = (uint *)(ulonglong)uVar4;
          uVar1 = _BIO_write(param_1,param_2,(int)param_3);
