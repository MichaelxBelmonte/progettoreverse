...
uchar * FUN_010bb450(undefined8 param_1,char *param_2,undefined1 *param_3,char *param_4)
...
LAB_010bb61f:
          ...
          ipasc = (dword *)((longlong)&section_00000388.size + 6);
          pcVar13 = _CRYPTO_strdup(name,(char *)((longlong)&section_00000388.size + 6),(int)param_3)
          ;
...
LAB_010bb949:
        ...
        if (*piVar10 == 0) {
          param_2 = (char *)((longlong)&section_00000388.flags + 2);
          name = (char *)0x0;
          if (*(longlong *)(piVar10 + 2) != 0) goto LAB_010bb4f8;
LAB_010bb4d3:
          ...
          *(ASN1_NULL **)(name + 8) = pAVar9;
          ...
          if (*piVar10 == 1) {
            if (*(longlong *)(piVar10 + 2) != 0) goto LAB_010bb949;
            goto LAB_010bb4d3;
          }
          name = *(char **)(piVar10 + 2);
        ...
        *piVar10 = 0;
        ...
        if (cVar1 != '\0') {
          ...
          if (cVar1 != '-') {
            ...
            if (cVar1 == '/') {
              uVar4 = _strtoul((char *)ipout,(char **)((longlong)&MACH_HEADER.cpusubtype + 2),sVar5)
              ;
              if ((local_80 != pcVar13 + iVar3) && (*local_80 == '\0')) {
                name = (char *)local_48;
                param_3 = (undefined1 *)(ulonglong)uVar4;
                iVar3 = _X509v3_addr_add_prefix(name,puVar12);
                param_2 = (char *)((longlong)&segment_command_000003d8.filesize + 7);
          ...
          if ((sVar7 == 0) || (pcVar13[(int)(sVar6 + iVar3 + sVar7)] != '\0')) {
            ...
            name = (char *)local_48;
            iVar3 = _memcmp(ipout,(void *)(ulonglong)local_68,sVar5);
            if (iVar3 < 1) {
...
LAB_010bbb2e:
        ...
        name = (char *)local_48;
        param_3 = (undefined1 *)(ulonglong)(local_68 << 3);
        iVar3 = _X509v3_addr_add_prefix(name,puVar12);
        param_2 = (char *)((longlong)&segment_command_000003d8.filesize + 7);
        in_stack_ffffffffffffff78 = puVar11;
        if (iVar3 == 0) {
