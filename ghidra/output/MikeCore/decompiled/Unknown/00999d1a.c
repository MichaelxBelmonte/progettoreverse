...
//   "virtual void pace::ILok2Commander::GetILokCertChain(const CMD_CmmdPayload_GetILokCertChain_Struct &...


void FUN_00999d1a(void *param_1,undefined8 param_2)

{
  ...
  if (unaff_RDI[7] == 0) {
    FUN_00925fd0();
    uVar1 = FUN_00926010();
    uVar3 = FUN_00928ab0("virtual void pace::ILok2Commander::GetILokCertChain(const CMD_CmmdPayload_GetILokCertChain_Struct &, CMD_RsltPayload_GetILokCertChain_Struct &, vector<uint8_t> &)"
                         ,0x363);
    uVar3 = FUN_009c720b(uVar3,uVar1);
  }
  uVar3 = (**(code **)(*unaff_RDI + 0x78))(uVar3,&local_110);
  (**(code **)(*(longlong *)unaff_RDI[7] + 0x10))(uVar3,&local_278);
  (**(code **)(*unaff_RDI + 600))(0,0,param_2,&local_48);
  pvVar2 = local_50;
  (**(code **)(*unaff_RDI + 0x80))(local_50,&local_48);
  if (local_48 != 0) {
    lStack_40 = local_48;
