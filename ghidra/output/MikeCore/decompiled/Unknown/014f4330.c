...
/* WARNING: Removing unreachable block (ram,0x014f4a90) */
/* WARNING: Removing unreachable block (ram,0x014f4a99) */
/* WARNING: Removing unreachable block (ram,0x014f4def) */
/* WARNING: Removing unreachable block (ram,0x014f4df8) */
/* WARNING: Type propagation algorithm not settling */

undefined8
FUN_014f4330(undefined4 param_1,uint param_2,longlong *param_3,longlong *param_4,undefined4 param_5,
            undefined8 param_6,undefined4 param_7,longlong *param_8,longlong *param_9)
...
joined_r0x014f487f:
        ...
        local_c0 = CONCAT71((int7)((ulonglong)uVar15 >> 8),1);
        if (cVar26 == '\0') {
          local_98 = local_68;
        }
        else {
...
LAB_014f49ee:
      if (local_98 == 0) {
        ...
        if (local_a0 != 0) {
          fVar32 = (fVar32 + *(float *)(local_a0 + 0x58)) * DAT_0239011c;
        }
LAB_014f4760:
        *pfVar13 = fVar32;
      }
  ...
  pVar18 = 1;
  uVar31 = FUN_015c1480((float)iVar9 * DAT_0240dec8 * DAT_023908d8,iVar23 + 1);
  FUN_014c34a0(uVar31,uVar21);
...
LAB_014f471c:
  ...
  iVar9 = (int)local_f0;
  if ((pvVar12 != (void *)0x0) && (lVar14 = FUN_00e8b990(), lVar14 != 0)) {
    pVar18 = (pthread_key_t)local_40;
  }
  FUN_014f38a0();
  lVar14 = *unaff_RSI;
  if (lVar14 == local_68) {
    if (((char)unaff_RSI[1] == '\0') && (local_68 != 0)) {
      if (local_60 == '\0') {
        FUN_00d50b00();
      }
      goto LAB_014f4d5d;
...
LAB_014f4e05:
  ...
  uVar11 = param_2 + 1;
  if ((int)uVar11 < iVar9) {
    local_110 = (longlong)*(int *)(*param_4 + 0x30);
    ...
    *(undefined8 *)((longlong)local_a8 + 0x44) = 0;
    ...
    fVar32 = (fVar32 + fVar33) * DAT_0239011c;
    local_dc = (local_dc - local_e4) / (float)iVar23;
    local_70 = local_f8 + ((longlong)(int)uVar11 - (longlong)(int)param_2);
    local_50 = 0;
    bVar4 = false;
...
LAB_014f52fe:
      ...
      FUN_00d4ff40();
      *puVar16 = &DAT_025f1488;
      *(undefined8 *)((longlong)puVar16 + 0xc) = 0;
      *(undefined8 *)((longlong)puVar16 + 0x14) = 0;
      *(undefined8 *)((longlong)puVar16 + 0x1c) = 0;
      *(undefined8 *)((longlong)puVar16 + 0x24) = 0;
      *(undefined8 *)((longlong)puVar16 + 0x2c) = 0;
      *(undefined8 *)((longlong)puVar16 + 0x34) = 0;
      ...
      *(undefined8 *)((longlong)puVar16 + 0x44) = 0;
      ...
      if (puVar16 == local_78) {
        ...
        bVar7 = true;
        if ((bVar30) && (local_78 != (undefined8 *)0x0)) {
          FUN_00d50b20();
        }
      }
      bVar30 = bVar7;
      ...
      if (local_a8 == puVar16) {
        puVar6 = local_a8;
        bVar7 = bVar3;
        if ((!bVar3) && (local_a8 != (undefined8 *)0x0)) {
          FUN_00d50b00();
          bVar7 = true;
        }
      }
      ...
      FUN_015c66c0();
      FUN_015c6ba0();
      FUN_014eecb0(local_118,(float)*(double *)(*param_4 + 0x50),*(undefined4 *)(*param_4 + 0x2c));
      FUN_014eed60((float)*(double *)(*param_4 + 0x50),*(undefined4 *)(*param_4 + 0x20));
      *(float *)(local_50 + 0x28) = fVar32;
      fVar33 = DAT_02394274;
      if (DAT_02394274 <= *local_70) {
        fVar33 = *local_70;
      }
  ...
  if (*(int *)(lVar14 + 0xc) < 1) {
    ...
    lVar25 = 0;
    uVar21 = CONCAT71((int7)((ulonglong)uVar15 >> 8),local_31);
    uVar24 = uVar21 & 0xffffffff;
    do {
      pVar18 = (pthread_key_t)uVar21;
      lVar14 = *(longlong *)(*(longlong *)(lVar14 + 0x10) + lVar25 * 8);
      bVar29 = (byte)uVar24;
      if (local_40 == lVar14) {
        lVar14 = local_40;
        local_31 = bVar29;
      ...
      pvVar12 = _pthread_getspecific((pthread_key_t)uVar15);
      if (pvVar12 != (void *)0x0) {
        FUN_00e8b990();
      }
      FUN_014f0770();
      lVar25 = lVar25 + 1;
      lVar14 = *param_8;
      uVar21 = (ulonglong)*(int *)(lVar14 + 0xc);
      uVar22 = 0;
      uVar24 = (ulonglong)local_31;
    } while (lVar25 < (longlong)uVar21);
  }
  FUN_00e83070();
