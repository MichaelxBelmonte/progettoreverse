...
void FUN_00a26a1e(undefined8 param_1,undefined8 param_2,char *param_3)

{
  ...
  if (iVar2 != iVar6) {
    ...
    param_3 = 
    "/Users/admin/jenkins/workspace/EdenFiveMacFull/common/paceSources/generated/licenseServices/liblicenseservices/LsCachedObjectVectorAuthKey.cpp"
    ;
  ...
  if (plVar3 == plVar4) {
LAB_00a26a9b:
    if ((plVar16 == plVar4) || ((longlong)plVar16 - (longlong)plVar3 == -8)) goto LAB_00a26aa9;
    lVar17 = (longlong)plVar16 - (longlong)plVar3 >> 3;
  }
  else {
    do {
      if (*plVar16 == *(longlong *)(unaff_RSI + 0x10)) goto LAB_00a26a9b;
      plVar16 = plVar16 + 1;
...
LAB_00a26aa9:
  ...
  *(longlong *)((longlong)pvVar11 + 0x18) = lVar9 + lVar17 * 8 + ((longlong)pvVar10 >> 3) * 8;
  lVar14 = lVar17 * 0x148 + *(longlong *)((longlong)pvVar8 + 0x48);
  lVar12 = lVar14 + 0x148;
  ...
  if (lVar12 != lVar9) {
    ...
    if (lVar12 == lVar15) goto LAB_00a26c30;
  }
  do {
    puVar1 = (undefined8 *)(lVar12 + -0x148);
    lVar12 = lVar12 + -0x148;
    (**(code **)*puVar1)();
    sVar13 = (size_t)param_3;
  } while (lVar15 != lVar12);
LAB_00a26c30:
  *(longlong *)((longlong)pvVar8 + 0x50) = lVar15;
  ...
  if (plVar4 != (longlong *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00a26cbd. Too many branches */
