...
//   "virtual void pace::ILok2Commander::CompressExpiredBlindDemo(const CMD_CmmdPayload_CompressExpiredBl...


void FUN_0099f76c(undefined8 param_1,undefined8 param_2)

{
  ...
  if (unaff_RDI[7] == 0) {
    FUN_00925fd0();
    uVar1 = FUN_00926010();
    uVar3 = FUN_00928ab0("virtual void pace::ILok2Commander::CompressExpiredBlindDemo(const CMD_CmmdPayload_CompressExpiredBlindDemo_Struct &, CMD_RsltPayload_CompressExpiredBlindDemo_Struct &)"
                         ,0x9f6);
    uVar3 = FUN_009c720b(uVar3,uVar1);
  }
  uVar3 = (**(code **)(*unaff_RDI + 0x180))(uVar3,&local_108);
