...
ulonglong FUN_00f6e2c0(ASN1_ITEM *param_1,char *param_2,ASN1_ITEM *param_3,undefined4 param_4)

{
  ...
  if (unaff_RDI == (ASN1_ITEM *)0x0) {
    return 0;
  }
  lVar18 = *(longlong *)&param_1->size;
...
LAB_00f6e36e:
  ...
  ppAVar10 = (ASN1_VALUE **)
             ((longlong)&switchD_00f6e38c::switchdataD_00f6eccc +
             (longlong)(int)(&switchD_00f6e38c::switchdataD_00f6eccc)[uVar9]);
  iVar4 = (int)param_3;
  switch(uVar9) {
  case 0:
    if (*(longlong *)&param_1->tcount == 0) {
      uVar16 = FUN_00f6eee0(param_1,param_2,param_3,param_4);
      return uVar16;
    }
    if ((iVar4 == -1) && (local_res8 == '\0')) {
      uVar16 = FUN_00f6ecf0(*(longlong *)&param_1->tcount,param_2,0,local_res10);
      return uVar16;
    }
    iVar4 = 0xaa;
    iVar5 = 0xaf;
  ...
  default:
    ...
    if (iVar4 == 0) {
      ...
      if ((lVar18 == 0) || ((*(byte *)(lVar18 + 8) & 4) == 0)) {
        ...
        local_60 = param_2 + (*unaff_RSI - (longlong)local_50);
        cVar14 = '\x01';
      }
      if (local_32 == '\0') {
        iVar4 = 0x95;
        ...
        lVar15._0_1_ = unaff_RDI->itype;
        lVar15._1_3_ = *(undefined3 *)&unaff_RDI->field_0x1;
        lVar15._4_4_ = unaff_RDI->utype;
        if ((lVar15 == 0) &&
          ...
          if ((in_stack_ffffffffffffff98 != (ASN1_ITEM *)0x0) &&
             (iVar4 = (*(code *)in_stack_ffffffffffffff98)(0), iVar4 == 0)) goto LAB_00f6ec3b;
          lVar18 = *(longlong *)&param_1->tcount;
          iVar4 = (int)unaff_RDI;
          if ((longlong)param_1->funcs < 1) {
            uVar16 = 0;
          }
          else {
            lVar15 = 0;
            ...
            do {
              ...
              lVar15 = lVar15 + 1;
              lVar18 = lVar18 + 0x28;
            } while (lVar15 < (longlong)param_1->funcs);
            uVar16 = 0;
            cVar14 = local_31;
            if (0 < (longlong)param_1->funcs) {
              do {
                pAVar12 = (ASN1_TEMPLATE *)((longlong)&MACH_HEADER.magic + 1);
                pcVar13 = &param_1->itype;
                pAVar6 = _asn1_do_adb((ASN1_VALUE **)param_1,
                                      (ASN1_TEMPLATE *)((longlong)&MACH_HEADER.magic + 1),iVar4);
                if (pAVar6 == (ASN1_TEMPLATE *)0x0) goto LAB_00f6e331;
                _asn1_get_field_ptr((ASN1_VALUE **)pcVar13,pAVar12);
                pcVar13 = local_50;
                cVar14 = local_31;
                if (local_60 == (char *)0x0) break;
                if (((1 < (longlong)local_60) && (*local_50 == '\0')) && (local_50[1] == '\0')) {
                  pcVar13 = local_50 + 2;
                  if ((char)local_54 == '\0') {
                    iVar4 = 0x9f;
                    iVar5 = 0x168;
                  ...
                  local_60 = local_50 + ((longlong)local_60 - (longlong)pcVar13);
                  local_54 = local_54 & 0xffffff00;
                  local_50 = pcVar13;
                  goto LAB_00f6eb69;
                }
                if (uVar16 == (longlong)param_1->funcs - 1U) {
                  bVar3 = 0;
                }
                else {
                ...
                if (iVar5 == -1) {
                  ...
                  local_60 = pcVar13 + ((longlong)local_60 - (longlong)local_50);
                }
                uVar16 = uVar16 + 1;
                cVar14 = local_31;
              } while ((longlong)uVar16 < (longlong)param_1->funcs);
            }
          }
          if ((char)local_54 != '\0') {
            if ((((longlong)local_60 < 2) || (*local_50 != '\0')) || (local_50[1] != '\0')) {
              iVar4 = 0x89;
              iVar5 = 400;
              break;
            }
...
LAB_00f6eb69:
          if ((cVar14 != '\0') || (local_60 == (char *)0x0)) {
            ...
            if ((longlong)uVar16 < (longlong)param_1->funcs) {
              do {
                pAVar12 = (ASN1_TEMPLATE *)((longlong)&MACH_HEADER.magic + 1);
                pcVar13 = &param_1->itype;
                pAVar6 = _asn1_do_adb((ASN1_VALUE **)param_1,
            ...
            iVar4 = _asn1_enc_save((ASN1_VALUE **)param_1,
                                   (uchar *)(ulonglong)(uint)((int)local_50 - (int)*unaff_RSI),iVar4
                                   ,pAVar17);
            if ((iVar4 != 0) &&
               ((in_stack_ffffffffffffff98 == (ASN1_ITEM *)0x0 ||
                (iVar4 = (*(code *)in_stack_ffffffffffffff98)(0,param_1), iVar4 != 0)))) {
              *unaff_RSI = (longlong)pcVar13;
              return 1;
            }
            goto LAB_00f6ec3b;
          }
...
LAB_00f6e538:
    lVar18._0_1_ = unaff_RDI->itype;
    lVar18._1_3_ = *(undefined3 *)&unaff_RDI->field_0x1;
    lVar18._4_4_ = unaff_RDI->utype;
    if (lVar18 == 0) {
      in_stack_ffffffffffffff98 = pAVar17;
      iVar4 = _ASN1_item_ex_new(ppAVar10,unaff_RDI);
      if (iVar4 == 0) {
        iVar4 = 0x3a;
        iVar5 = 0xf9;
        break;
      ...
      in_stack_ffffffffffffff98 = pAVar17;
      uVar9 = _asn1_get_choice_selector(ppAVar10,unaff_RDI);
      if ((-1 < (int)uVar9) && ((longlong)(ulonglong)uVar9 < (longlong)param_1->funcs)) {
    ...
    if ((longlong)ppAVar8 < 1) {
      uVar9 = 0;
LAB_00f6eaaf:
      ppAVar10 = (ASN1_VALUE **)(ulonglong)uVar9;
      if (ppAVar8 == ppAVar10) {
        if (local_31 != '\0') {
    ...
    _asn1_get_field_ptr(ppAVar10,(ASN1_TEMPLATE *)param_1);
    param_3 = (ASN1_ITEM *)((longlong)&MACH_HEADER.magic + 1);
    pAVar12 = pAVar6;
    pAVar17 = local_res10;
...
LAB_00f6ec7d:
      ...
      uVar2._1_3_ = *(undefined3 *)&param_1[1].field_0x1;
  ...
  case 3:
    goto LAB_00f6e356;
  case 4:
                    /* WARNING: Could not recover jumptable at 0x00f6e49a. Too many branches */
  ...
  case 5:
    if (iVar4 == -1) {
      ...
      if (iVar4 == 0) {
        ...
        uVar16 = (ulonglong)local_54;
        if (uVar16 < 0x1f) {
          uVar7 = *(ulonglong *)(&DAT_023ec1f0 + uVar16 * 8);
        }
        else {
          uVar7 = 0;
        }
        if (((ulonglong)param_1->templates & uVar7) != 0) {
...
LAB_00f6e331:
  ...
  uVar1._1_3_ = *(undefined3 *)&param_1[1].field_0x1;
