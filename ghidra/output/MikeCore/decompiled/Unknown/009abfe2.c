...
void FUN_009abfe2(longlong *param_1,undefined8 *param_2,undefined4 param_3,undefined8 param_4)

{
  ...
  param_2[1] = local_90;
  *param_2 = local_98;
  if ((*(int *)((longlong)param_2 + 0x1c) == unaff_ESI) && (local_74 == '\0')) {
    lVar1 = param_1[1] - *param_1;
    local_68 = lVar1 >> 5;
    if ((lVar1 == 0) || (*(int *)(local_68 * 0x20 + -8 + *param_1) == -1)) {
      FUN_00925fd0();
      local_40 = (longlong *)FUN_00926010();
      FUN_00983230();
      FUN_00928ab0("void pace::Ilok2Protocols::getAuthRecordWithAllStorageRecords(const ILok2Ref, EEPROM_AuthRecordStruct &, vector<EEPROM_StorageRecordStruct> &, bool, const boost::posix_time::ptime *)"
                   ,0x347);
      FUN_009c720b();
  ...
  if (*(int *)((longlong)param_2 + 0x1c) != unaff_ESI) {
    FUN_00925fd0();
    FUN_00926010();
    FUN_00928ab0("void pace::Ilok2Protocols::getAuthRecordWithAllStorageRecords(const ILok2Ref, EEPROM_AuthRecordStruct &, vector<EEPROM_StorageRecordStruct> &, bool, const boost::posix_time::ptime *)"
                 ,0x376);
