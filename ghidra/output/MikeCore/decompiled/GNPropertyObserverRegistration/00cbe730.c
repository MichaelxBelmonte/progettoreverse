...
/* WARNING: Removing unreachable block (ram,0x00cbe836) */
/* WARNING: Removing unreachable block (ram,0x00cbe828) */
/* WARNING: Removing unreachable block (ram,0x00cbe844) */
...

{
  ...
  if ((DAT_02774128 == '\0') && (iVar1 = ___cxa_guard_acquire(), iVar1 != 0)) {
