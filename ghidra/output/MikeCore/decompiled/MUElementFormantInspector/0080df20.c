...
/* WARNING: Removing unreachable block (ram,0x0080e079) */
/* WARNING: Removing unreachable block (ram,0x0080e06b) */
/* WARNING: Removing unreachable block (ram,0x0080e087) */
...

{
  ...
  if ((DAT_02734d50 == '\0') && (iVar1 = ___cxa_guard_acquire(), iVar1 != 0)) {
