...
/* WARNING: Removing unreachable block (ram,0x01e45f53) */
/* WARNING: Removing unreachable block (ram,0x01e45f63) */
/* WARNING: Removing unreachable block (ram,0x01e45c84) */
/* WARNING: Removing unreachable block (ram,0x01e45c90) */
/* WARNING: Removing unreachable block (ram,0x01e45bd2) */
/* WARNING: Removing unreachable block (ram,0x01e45bdb) */
...

{
  ...
  iVar9 = FUN_01d3a5a0();
  if (((iVar9 == 5) && (cVar7 = (**(code **)(*unaff_RDI + 0x750))(), cVar7 != '\0')) &&
...
LAB_01e45be0:
        ...
        FUN_00d50b00();
        FUN_01d5ef60(uVar11,_DAT_0241f410);
        if (unaff_RDI != (longlong *)0x0) {
          FUN_00d50b20();
        }
        FUN_01d62b80();
    ...
    if ((cVar7 != '\0') &&
      ...
      uVar11 = FUN_01d3b620();
      (**(code **)(*unaff_RDI + 0x8f0))(local_68,uVar11);
      FUN_01d3a560();
...
LAB_01e46133:
            ...
            if (*unaff_RSI == 0) {
LAB_01e4618d:
              (**(code **)(*unaff_RDI + 0x900))(local_68);
              goto LAB_01e46234;
            }
            plVar6 = (longlong *)unaff_RDI[6];
            plVar2 = unaff_RDI;
            while (plVar3 = plVar6, plVar3 != (longlong *)0x0) {
              plVar6 = (longlong *)plVar3[6];
              plVar2 = plVar3;
            ...
            uVar11 = FUN_01d3abf0();
            uVar12 = FUN_01e466c0();
            if (*unaff_RSI == 0) goto LAB_01e4621e;
            iVar9 = FUN_01d3a5a0();
            if (iVar9 == 5) {
              FUN_01d3b590();
              (**(code **)(*unaff_RDI + 0x8f8))(uVar12,local_68);
...
LAB_01e45b31:
      cVar8 = (**(code **)(*unaff_RDI + 0x878))();
      if (cVar8 == '\0') {
        cVar8 = '\0';
      }
      else {
        if ((DAT_026f3380 == '\0') && (iVar9 = ___cxa_guard_acquire(), iVar9 != 0)) {
    ...
    if (cVar8 != '\0') {
      ...
      uVar10 = FUN_01d3b590();
      if ((uVar10 & 4) == 0) {
        (**(code **)(*unaff_RDI + 0x8c8))();
      }
      else {
        (**(code **)(*unaff_RDI + 0x8d0))();
      }
      FUN_00d50b20();
      return;
    }
  ...
  if ((iVar9 == 2) || (iVar9 = FUN_01d3a5a0(), iVar9 == 8)) {
    ...
    uVar11 = FUN_01d3b590();
    cVar7 = (**(code **)(*unaff_RDI + 0x438))(*unaff_RDI,uVar11);
    if (local_48 != (longlong *)0x0) {
      FUN_00d50b20();
    }
    if ((local_40 != '\0') && (local_48 != (longlong *)0x0)) {
