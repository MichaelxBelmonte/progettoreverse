// Reconstructed implementation of GNCustomAlertPanel
// From MikeCore binary — reverse-engineered pseudocode

#include "GNCustomAlertPanel.h"

// ============================================================
// @01f69100 — 2840 bytes
// ============================================================

/* WARNING: Removing unreachable block (ram,0x01f695ea) */
/* WARNING: Removing unreachable block (ram,0x01f695fa) */
/* WARNING: Removing unreachable block (ram,0x01f69aa9) */
/* WARNING: Removing unreachable block (ram,0x01f69ab9) */
/* WARNING: Removing unreachable block (ram,0x01f6978d) */
/* WARNING: Removing unreachable block (ram,0x01f6979d) */
/* WARNING: Removing unreachable block (ram,0x01f6985d) */
/* WARNING: Removing unreachable block (ram,0x01f69880) */
/* WARNING: Removing unreachable block (ram,0x01f696a2) */
/* WARNING: Removing unreachable block (ram,0x01f696c0) */
/* WARNING: Removing unreachable block (ram,0x01f69202) */
/* WARNING: Removing unreachable block (ram,0x01f69220) */
/* WARNING: Removing unreachable block (ram,0x01f69204) */
/* WARNING: Removing unreachable block (ram,0x01f69222) */
/* WARNING: Removing unreachable block (ram,0x01f692f1) */
/* WARNING: Removing unreachable block (ram,0x01f69301) */
/* WARNING: Removing unreachable block (ram,0x01f696a4) */
/* WARNING: Removing unreachable block (ram,0x01f696c2) */
/* WARNING: Removing unreachable block (ram,0x01f6985f) */
/* WARNING: Removing unreachable block (ram,0x01f69882) */
/* WARNING: Type propagation algorithm not settling */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_01f69100(undefined8 param_1,undefined8 param_2)

{
  ...
  fVar32 = (float)((ulonglong)param_2 >> 0x20);
  fVar29 = (float)param_2;
  FUN_01e3f820();
  fVar14 = *(float *)(unaff_RDI + 0xf4);
  fVar13 = *(float *)(unaff_RDI + 0xf8);
  fVar28 = fVar29;
  fVar33 = fVar32;
  uVar15 = FUN_01e3f530();
  lVar1 = *(longlong *)(unaff_RDI + 0x38);
  fVar27 = (float)((ulonglong)uVar15 >> 0x20);
  if (*(int *)(unaff_RDI + 0x138) == 0) {
    ...
    local_58 = -1;
    local_98 = ZEXT1216((undefined1  [12])0x0) << 0x20;
    iVar11 = 0;
    plVar9 = (longlong *)0x0;
    while( true ) {
      ...
      plVar8 = *(longlong **)(*(longlong *)(lVar1 + 0x10) + 8 + lVar7 * 8);
      fVar13 = (float)FUN_01e3f500();
      iVar5 = FUN_01e3f4f0();
      if ((iVar5 != 2) && (*(float *)(unaff_RDI + 0x140) < fVar13)) {
        ...
        if ((plVar9 != (longlong *)0x0) && (NAN(*(float *)(unaff_RDI + 0x13c)))) {
          (**(code **)(*plVar8 + 0x5e0))();
        }
        if (plVar8 != plVar9) {
          plVar9 = plVar8;
...
LAB_01f69859:
    do {
      ...
      iVar11 = FUN_01e3f4f0();
      if ((iVar11 != 2) && (*(float *)(unaff_RDI + 0x140) < fVar14)) {
        local_88 = (undefined1  [8])(**(code **)(*plVar8 + 0x5c8))();
        uStack_80 = extraout_XMM0_Qb_01;
        auVar26 = _local_88;
        fVar14 = (float)(**(code **)(*plVar8 + 0x5f0))();
        local_88._4_4_ = (undefined4)((ulonglong)local_88 >> 0x20);
        uStack_80._0_4_ = (float)extraout_XMM0_Qb_01;
        uStack_80._4_4_ = (float)((ulonglong)extraout_XMM0_Qb_01 >> 0x20);
        if ((fVar14 == (float)local_98._0_4_) && (!NAN(fVar14) && !NAN((float)local_98._0_4_))) {
          if ((float)local_c8._0_4_ + (float)local_88._0_4_ < 0.0) {
            (**(code **)(*plVar8 + 0x5d8))(DAT_023dccec);
            goto LAB_01f69859;
          }
        ...
        case 1:
          ...
          auVar21._0_4_ = auVar20._4_4_ * DAT_0239011c;
        ...
        case 0:
          local_48 = blendps(local_48,_DAT_0238ff00,2);
          break;
        case 4:
          local_48 = blendps(local_48,_DAT_0238ff00,2);
          bVar10 = true;
        ...
        if (plVar9 != (longlong *)0x0) {
          if (NAN(*(float *)(unaff_RDI + 0x13c))) {
            uVar15 = (**(code **)(*plVar9 + 0x5e0))();
            auVar24._0_4_ = (float)uVar15 + local_48._0_4_;
            auVar24._4_4_ = (float)((ulonglong)uVar15 >> 0x20) + local_48._4_4_;
            auVar24._8_4_ = (float)extraout_XMM0_Qb_02 + local_48._8_4_;
            auVar24._12_4_ = (float)((ulonglong)extraout_XMM0_Qb_02 >> 0x20) + local_48._12_4_;
            local_48 = blendps(auVar24,local_48,2);
          }
          else {
            local_48._0_4_ = local_48._0_4_ + *(float *)(unaff_RDI + 0x13c);
          }
        }
        FUN_01e3f530();
        FUN_00d05650();
  ...
  if (0 < *(int *)(lVar1 + 0xc)) {
    ...
    do {
      plVar9 = *(longlong **)(*(longlong *)(lVar1 + 0x10) + lVar7 * 8);
      fVar14 = (float)FUN_01e3f500();
      iVar11 = FUN_01e3f4f0();
      if ((iVar11 == 2) || (fVar14 <= *(float *)(unaff_RDI + 0x140))) {
        (**(code **)(*plVar9 + 0x5d8))(DAT_023dccec);
      }
      else {
        local_88 = (undefined1  [8])(**(code **)(*plVar9 + 0x5c8))();
        uStack_80 = extraout_XMM0_Qb;
        (**(code **)(*plVar9 + 0x5f0))();
        if ((extraout_XMM0_Db_00 == (float)local_98._0_4_) &&
           (!NAN(extraout_XMM0_Db_00) && !NAN((float)local_98._0_4_))) {
          uVar6 = (undefined4)((ulonglong)extraout_XMM0_Qb >> 0x20);
        ...
        case 1:
          ...
          auVar18._0_4_ = (fVar29 - (float)local_88._0_4_) * DAT_0239011c;
        ...
        case 0:
          local_48 = blendps(local_48,_DAT_0238ff00,0xd);
        }
        if ((longlong *)local_c8._0_8_ != (longlong *)0x0) {
          ...
          if (NAN(*(float *)(unaff_RDI + 0x13c))) {
            uVar15 = (**(code **)(*(longlong *)local_c8._0_8_ + 0x5e0))();
            auVar31._0_4_ = fVar13 + (float)uVar15;
            auVar31._4_4_ = fVar13 + (float)((ulonglong)uVar15 >> 0x20);
            auVar31._8_4_ = fVar14 + (float)extraout_XMM0_Qb_00;
            auVar31._12_4_ = fVar14 + (float)((ulonglong)extraout_XMM0_Qb_00 >> 0x20);
            local_48 = insertps(local_48,auVar31,0x1c);
          }
          else {
            auVar35._4_12_ = auVar34._4_12_;
            auVar35._0_4_ = fVar13 + *(float *)(unaff_RDI + 0x13c);
        ...
        FUN_00d05650();
        (**(code **)(*plVar9 + 0x5d8))();
        plVar8 = (longlong *)local_c8._0_8_;
        if (plVar9 != (longlong *)local_c8._0_8_) {
          plVar8 = plVar9;
        }
  ...
  if (0 < *(int *)(lVar1 + 0xc)) {
    ...
    do {
      ...
      if (iVar11 == 4) {
        ...
        uVar6 = (undefined4)((ulonglong)extraout_XMM0_Qb_04 >> 0x20);
        fVar28 = (float)((ulonglong)local_98._0_8_ >> 0x20);
...
void FUN_01f6ab40(undefined8 param_1)

{
  ...
  if (plVar1 == plVar4) {
    ...
    *(longlong **)(unaff_RDI + 0xa8) = plVar4;
...
// ============================================================
// @01f6a6d0 — 1101 bytes
// str: ""GNCustomAlertPanel""
// str: ""handlePanelOK""
// str: ""handlePanelCancel""
// str: ""handlePanelOther""
// ============================================================
...

{
  ...
  if (DAT_028bad50 == '\0') {
    ...
    if (iVar1 != 0) {
      if (DAT_027f65f0 == '\0') {
        iVar1 = ___cxa_guard_acquire();
        if (iVar1 != 0) {
          _DAT_027f6540 = FUN_00015ff0();
          _DAT_027f6528 = "GNCustomAlertPanel";
          _DAT_027f6530 = 0xb0;
          _DAT_027f6538 = FUN_01e7ffc0;
          _DAT_027f6548 = 0;
          uRam00000000027f6550 = 0;
          _DAT_027f6558 = 0;
          _DAT_027f65d0 = 0;
          uRam00000000027f65d8 = 0;
          _DAT_027f65e0 = 0;
          DAT_027f65e2 = 1;
          _DAT_027f6560 = 0;
          uRam00000000027f6568 = 0;
          _DAT_027f6570 = 0;
          uRam00000000027f6578 = 0;
          _DAT_027f6580 = 0;
          uRam00000000027f6588 = 0;
          _DAT_027f6590 = 0;
          uRam00000000027f6598 = 0;
          _DAT_027f65a0 = 0;
          uRam00000000027f65a8 = 0;
          _DAT_027f65b0 = 0;
          uRam00000000027f65b8 = 0;
          _DAT_027f65c0 = 0;
          uRam00000000027f65c8 = 0;
          DAT_027f65eb = 0;
          _DAT_027f65e3 = 0;
          ___cxa_guard_release();
        }
      }
      _DAT_028bad10 = "handlePanelOK";
      _DAT_028bad18 = &DAT_027f6528;
      _DAT_028bad20 = 0;
      _DAT_028bad28 = &DAT_02800a78;
      _DAT_028bad30 = FUN_01f6c700;
      _DAT_028bad38 = 0x5d9;
      _DAT_028bad40 = 0;
      uRam00000000028bad48 = 0;
      ___cxa_guard_release();
    }
  }
  FUN_00e87c70();
  if (DAT_028bad98 == '\0') {
    ...
    if (iVar1 != 0) {
      ...
      _DAT_028bad58 = "handlePanelCancel";
      _DAT_028bad60 = &DAT_027f6528;
      _DAT_028bad68 = 0;
      _DAT_028bad70 = &DAT_02800a78;
      _DAT_028bad78 = FUN_01f6c700;
      _DAT_028bad80 = 0x5e1;
      _DAT_028bad88 = 0;
      uRam00000000028bad90 = 0;
      ___cxa_guard_release();
    }
  }
  FUN_00e87c70();
  if (DAT_028bade0 == '\0') {
    ...
    if (iVar1 != 0) {
      ...
      _DAT_028bada0 = "handlePanelOther";
      _DAT_028bada8 = &DAT_027f6528;
      _DAT_028badb0 = 0;
      _DAT_028badb8 = &DAT_02800a78;
      _DAT_028badc0 = FUN_01f6c700;
      _DAT_028badc8 = 0x5e9;
      _DAT_028badd0 = 0;
      uRam00000000028badd8 = 0;
      ___cxa_guard_release();
    }
  }
  FUN_00e87c70();
