// Reconstructed implementation of MUTool
// From MikeCore binary — reverse-engineered pseudocode

#include "MUTool.h"

// ============================================================
// @01721000 — 15762 bytes
// str: "" %@""
// str: ""/%@""
// str: ""1%@""
// str: ""3%@""
...
undefined8 * FUN_01a68ad0(longlong param_1)

{
  ...
  if (cVar4 == '\0') {
    ...
    (**(code **)(*unaff_RSI + 0xa70))((undefined4)local_1f8);
    ...
    *pcVar8 = '\0';
    ...
    if (lVar7 == 0) {
      *(undefined1 *)((longlong)unaff_RSI + 0x204) = 0;
      bVar2 = false;
      bVar1 = false;
      lVar7 = DAT_027e26a0;
    ...
    local_a0 = (**(code **)(*unaff_RSI + 0x9d8))();
    local_98 = (**(code **)(*unaff_RSI + 0x9e0))();
  }
  *(undefined1 *)((longlong)unaff_RSI + 0x204) = 0;
  FUN_00d403d0();
  lVar7 = DAT_027e2678;
...
// ============================================================
// @01a65460 — 2139 bytes
// str: ""handleAnalyzeChords""
// str: ""handleMoveUp""
// str: ""handleMoveDown""
// str: ""handleMoveUpFine""
// str: ""handleMoveDownFine""
// ============================================================
...
/* WARNING: Removing unreachable block (ram,0x01a60012) */
/* WARNING: Removing unreachable block (ram,0x01a6001b) */
/* WARNING: Removing unreachable block (ram,0x01a60099) */
/* WARNING: Removing unreachable block (ram,0x01a600a2) */

void FUN_01a5ffc0(pthread_key_t param_1)
...
void FUN_01a639d0(undefined8 param_1,undefined8 param_2)
...
void FUN_00235240(undefined8 param_1)
...
LAB_002353ce:
    ...
    cVar3 = (**(code **)(**(longlong **)(unaff_RDI + 0xc0) + 0x398))();
    local_70 = param_1;
...
LAB_0023554b:
  ...
  if (((cVar3 != '\0') && (DAT_02805cda != cVar3)) && (*(char *)(unaff_RDI + 0x150) != '\0')) {
    *(undefined1 *)(unaff_RDI + 0x150) = 0;
    FUN_0021e5f0();
  }
  plVar1 = *(longlong **)(unaff_RDI + 0x90);
  (**(code **)(&UNK_00001550 + *plVar1))();
...
LAB_0023563b:
  ...
  if (*(longlong **)(unaff_RDI + 0x98) != (longlong *)0x0) {
    (**(code **)(**(longlong **)(unaff_RDI + 0x98) + 0x928))(local_70);
  }
  if (cVar3 != '\0') {
    FUN_0021eea0(0);
  }
...
undefined8 FUN_00236500(undefined8 param_1,int param_2)
