// Reconstructed implementation of GNBinaryArchiveTypeInfoContainer
// From MikeCore binary — reverse-engineered pseudocode

#include "GNBinaryArchiveTypeInfoContainer.h"
...
/* WARNING: Removing unreachable block (ram,0x00e5edb7) */
/* WARNING: Removing unreachable block (ram,0x00e5edc3) */

void FUN_00e5ed60(undefined8 param_1,longlong *param_2)

{
  ...
  if (((10 < iStack_120) && (*pcVar11 == '\x1f')) && (pcVar11[1] == -0x75)) {
    ...
    uVar9 = 10;
    if ((bVar2 & 4) != 0) {
      uVar9 = (ulonglong)((byte)pcVar11[10] + 0xc);
    }
    bVar4 = bVar2 & 8;
    while (bVar4 != 0) {
    ...
    if (iVar7 == 0) {
      do {
        if (local_108 == 0) {
          ...
          if (iStack_120 * 2 < *(int *)(unaff_RSI + 0x14)) {
            local_108 = *(int *)(unaff_RSI + 0x14);
          }
...
// ============================================================
// @00e5cf00 — 527 bytes
// str: ""GNBinaryArchiveTypeInfoContainer""
// ============================================================
