// Reconstructed implementation of GNError
...
// ============================================================
// @00e9af00 — 8033 bytes
// str: ""      %d work, %d block, ratio %5.2f\n""
// str: ""    too repetitive; using fallback sorting algorithm\n""
// str: ""        bucket sorting ...\n""
// str: ""        main sort initialise ...\n""
// str: ""        qsort [0x%x, 0x%x]   done %d   this %d\n""
// ============================================================
...
void FUN_00e9a650(undefined8 *param_1,undefined8 param_2,longlong *param_3)

{
  ...
  if ((local_31 == '\0') || (plVar3 == (longlong *)0x0)) {
