...
uint FUN_00fe2a10(EVP_MD *param_1,uint param_2,uint64_t param_3,char *param_4)
...
LAB_00fe2cd0:
    ...
    case 0x1003:
      ...
      *(char *)(plVar1 + 3) = (char)param_2;
      if (param_2 == 0xffffffff) {
        ...
        pEVar6 = *(EC_KEY **)(*(int64_t *)(*(int64_t *)(this_ptr + 0x10) + 0x28) + 0x18);
    ...
    case 0x1004:
      if (param_2 == 0xfffffffe) {
        return (int)*(char *)((int64_t)plVar1 + 0x19);
      }
      if (1 < param_2 - 1) {
        return 0xfffffffe;
      }
      *(char *)((int64_t)plVar1 + 0x19) = (char)param_2;
      break;
    case 0x1005:
      plVar1[4] = (int64_t)param_1;
      break;
    case 0x1006:
      lVar5 = plVar1[4];
      goto LAB_00fe2b16;
    ...
    case 0x1009:
      ...
      plVar1[5] = (int64_t)param_1;
      if (param_1 == (EVP_MD *)0x0) {
        plVar1[6] = 0;
      }
      else {
        plVar1[6] = (int64_t)(int)param_2;
      }
      break;
    case 0x100a:
      lVar5 = plVar1[5];
      param_1->type = (int)lVar5;
      param_1->pkey_type = (int)((uint64_t)lVar5 >> 0x20);
