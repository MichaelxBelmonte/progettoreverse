...

{
  ...
  if (local_70 == 0) {
    ...
    (**(code **)(*this_ptr + 0x9b0))();
    bVar8 = *(int *)((int64_t)local_40 + 0xc) == 0;
    if (local_38 != '\0') {
      FUN_00d50b20();
    }
  }
  ...
  FUN_01e436c0();
  if (local_70 != 0) {
    fVar9 = param_2 + param_1 + g_02390d00;
    local_68 = '\0';
    local_70 = 0;
    local_58 = -1;
    fVar10 = g_023908d8 + extraout_XMM0_Db + g_02394210;
LAB_019454eb:
    lVar4 = (int64_t)local_58;
    local_58 = local_58 + 1;
    if (local_58 < *(int *)(local_48 + 0xc)) {
      local_70 = *(int64_t *)(*(int64_t *)(local_48 + 0x10) + 8 + lVar4 * 8);
      pvVar3 = _pthread_getspecific((void*)*(int64_t *)(local_48 + 0x10));
      if (pvVar3 != (void *)0x0) {
        FUN_00e8b990();
      }
      dVar15 = (double)FUN_014bb640();
      uVar11 = (**(code **)(*this_ptr + 0x938))();
      dVar1 = (double)this_ptr[0xba];
      (**(code **)(*this_ptr + 0xed0))();
...
LAB_01945b5a:
  ...
  fVar9 = *(float *)((int64_t)this_ptr + 0x5cc);
  if ((*(float *)(local_70 + 0x1c) != fVar9) || (NAN(*(float *)(local_70 + 0x1c)) || NAN(fVar9))) {
    if (0.0 <= fVar9) {
      if (fVar9 <= g_02390124) {
        ...
        *(void*)(local_70 + 0x1c) = 0x3f800000;
        fVar9 = g_02394220;
      }
    }
    else {
      *(void*)(local_70 + 0x1c) = 0;
      fVar9 = 0.0;
    }
    auVar17 = ZEXT416(g_023945e0 & (uint)fVar9) | g_023945f0;
    auVar18._4_12_ = auVar17._4_12_;
    auVar18._0_4_ = auVar17._0_4_ + fVar9;
    auVar17 = roundss(ZEXT816(0),auVar18,0xb);
    *(char *)(local_70 + 0xf) = (char)(int64_t)auVar17._0_4_;
  }
  FUN_01d488d0();
  FUN_01d48b40();
  if (local_48 != 0) {
    if (0 < *(int *)(local_48 + 0xc)) {
      fVar9 = extraout_XMM0_Db + g_023908d8 + g_02394210;
      lVar7 = 0;
      do {
        plVar6 = *(int64_t **)(*(int64_t *)(local_48 + 0x10) + lVar7 * 8);
        pvVar3 = _pthread_getspecific((void*)lVar4);
        if (pvVar3 != (void *)0x0) {
          FUN_00e8b990();
        }
        ...
        if (fVar12 < fVar10) {
          ...
          auVar16._0_8_ = (**(code **)(*this_ptr + 0x938))((double)lVar5 / dVar14);
...
code_r0x019455ee:
  ...
  fVar12 = (float)(~-(uint)(fVar12 < g_0239424c) & (uint)fVar12 |
                  ((uint)fVar12 ^ g_023945e0) & -(uint)(fVar12 < g_0239424c));
  fVar13 = g_02390d34 - (fVar12 + fVar12);
  fVar12 = g_0239011c;
  if ((g_0239011c < fVar13) || (fVar12 = fVar13, g_0239424c <= fVar13)) {
LAB_01945650:
    FUN_01cfcdc0();
    if (local_38 == '\0') {
      if (local_40 != (int64_t *)0x0) {
    ...
    if ((param_1 <= auVar17._0_4_ + g_02390124) && (auVar17._0_4_ + g_02390d00 <= fVar9)) {
    ...
    fVar12 = fVar12 * *(float *)((int64_t)this_ptr + 0x5cc);
    if ((*(float *)((int64_t)local_40 + 0x1c) != fVar12) ||
       (NAN(*(float *)((int64_t)local_40 + 0x1c)) || NAN(fVar12))) {
      if (0.0 <= fVar12) {
        if (fVar12 <= g_02390124) {
          *(float *)((int64_t)local_40 + 0x1c) = fVar12;
          fVar12 = fVar12 * g_02394220;
        }
        else {
          *(void*)((int64_t)local_40 + 0x1c) = 0x3f800000;
          fVar12 = g_02394220;
        }
      }
      else {
      ...
      auVar17 = ZEXT416((uint)fVar12 & g_023945e0) | g_023945f0;
      auVar17._0_4_ = auVar17._0_4_ + fVar12;
      auVar17 = roundss(auVar17,auVar17,0xb);
      *(char *)((int64_t)local_40 + 0xf) = (char)(int64_t)auVar17._0_4_;
    }
    FUN_01d488d0();
    FUN_01d48b40();
    plVar6 = (int64_t *)*arg1;
