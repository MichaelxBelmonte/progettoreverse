...
void FUN_00a2adf2(uint64_t param_1,uint64_t param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a2ae6f:
    if ((plVar16 == plVar4) || ((int64_t)plVar16 - (int64_t)plVar3 == -8)) goto LAB_00a2ae7d;
    lVar17 = (int64_t)plVar16 - (int64_t)plVar3 >> 3;
  }
  else {
    do {
      if (*plVar16 == *(int64_t *)(arg1 + 0x10)) goto LAB_00a2ae6f;
      plVar16 = plVar16 + 1;
