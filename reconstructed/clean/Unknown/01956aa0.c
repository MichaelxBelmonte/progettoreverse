...
void FUN_01956aa0(void* param_1)

{
  ...
  if (plVar9 != (int64_t *)0x0) {
    ...
    if (pvVar7 != (void *)0x0) {
      ...
      lVar8 = FUN_00e8b990();
      if (lVar8 != 0) {
        plVar9 = (int64_t *)plVar9[(uint64_t)(*(uint *)(lVar8 + 0x154) & 1) + 4];
      }
    }
    (**(code **)(*plVar9 + 0x378))();
    ...
    if (local_40 != (int64_t *)0x0) {
      ...
      if (local_40 != (int64_t *)0x0) {
        ...
        uVar13 = FUN_0198a7d0(~-(uint)(!NAN(fVar10) && !NAN(fVar10)) & g_024112ac |
        ...
        auVar17._4_4_ = (int)((uint64_t)uVar14 >> 0x20);
        auVar17._0_4_ = (float)uVar14 * g_023908e0;
        auVar17._8_4_ = extraout_XMM0_Dc_02;
        auVar17._12_4_ = extraout_XMM0_Dd_02;
        auVar16 = insertps(auVar15,auVar17,0x10);
        auVar3._4_4_ = (int)((uint64_t)uVar13 >> 0x20);
        auVar3._0_4_ = (float)uVar13 + fVar10 * g_0241b660;
        ...
        if ((((((float)uVar12 != fVar10) || (NAN((float)uVar12) || NAN(fVar10))) ||
             ((float)((uint64_t)uVar12 >> 0x20) != (float)((uint64_t)uVar11 >> 0x20))) ||
            (((auVar17._0_4_ != local_88 || (NAN(auVar17._0_4_) || NAN(local_88))) ||
             (auVar17._4_4_ != fStack_84)))) &&
           ((**(code **)(*this_ptr + 0x4d0))(fVar10), this_ptr[0x2f] != 0)) {
          this_ptr[0x2f] = 0;
          FUN_00d50b20();
        }
        if (!bVar6) {
