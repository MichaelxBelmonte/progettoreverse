...

{
  ...
  (**(code **)(*this_ptr + 0x38))(uVar8,&g_023c8ba0);
  local_50 = local_88;
  if (local_90 == (int64_t *)0x0) {
    ...
    *(void*)(plVar5 + 1) = 6;
    ...
    plVar5[2] = 0;
    plVar5[1] = 0;
    *plVar5 = (int64_t)&g_02520f98;
    plVar5[3] = (int64_t)plVar6;
    *(void*)(plVar6 + 1) = 4;
    LOCK();
    plVar5[1] = plVar5[1] + 1;
    UNLOCK();
