...
uint32_t FUN_0099affa(void*param_1,void*param_2)

{
  ...
  bool bVar14;
  uint32_t uVar15;
  uint8_t local_a48 [112];
  uint8_t local_9d8 [56];
  uint *local_9a0;
  code *local_998;
  void*local_990;
  uint *local_930;
  ...
  if (lVar6 != 0) {
    ...
    do {
      ...
      lVar6 = *(int64_t *)(lVar6 + (uint64_t)bVar14 * 8);
    } while (lVar6 != 0);
    if ((lVar9 != this_ptr + 0x28) && (*(uint *)(lVar9 + 0x20) <= uVar3)) goto LAB_0099b180;
  }
  FUN_00925fd0();
  uVar5 = FUN_00926010();
  FUN_00983230();
...
LAB_0099b180:
  ...
  cVar2 = (**(code **)(*(int64_t *)(lVar6 + 0x28) + 0x18))();
  if (cVar2 == '\0') {
    FUN_00925fd0();
    uVar5 = FUN_00926010();
    FUN_00983230();
  ...
  (**(code **)(*(int64_t *)(lVar6 + 0x28) + 0x40))(local_a48,&local_920);
  if (local_920 == -1) {
    FUN_00925fd0();
    uVar5 = FUN_00926010();
    FUN_00983230();
  ...
  if ((uint64_t)(lStack_910 - local_918) < uVar11) {
    FUN_0088d550();
  }
  else if (uVar11 < (uint64_t)(lStack_910 - local_918)) {
    lStack_910 = uVar11 + local_918;
  }
  puVar7 = local_9d8;
  (**(code **)(*(int64_t *)(this_ptr + 0x270) + 0x48))(puVar7,local_918);
  uVar3 = FUN_0098f810();
  iVar4 = _memcmp(puVar7,(void *)(uint64_t)uVar3,sVar13);
  if (iVar4 != 0) {
    FUN_00925fd0();
    uVar5 = FUN_00926010();
    uVar15 = FUN_00928ab0("virtual bool pace::ILok2Commander::GenerateAuthProtocolSignature_ExtractExtraResultData(const CMD_RsltPayload_GenerateAuthProtocolSignature_Struct &, const vector<uint8_t> &, BIG_CompactSignatureECDSA_Struct &)"
