...

{
  ...
  if ((param_2 & 0x40) != 0) {
    ...
    iVar3 = (*this_ptr)();
    pAVar8 = (ASN1_TYPE *)CONCAT71((int7)((uint64_t)pAVar8 >> 8),iVar3 != 0);
    if (iVar3 == 0) {
      return -1;
    }
    iVar3 = (iVar3 != 0) + sVar2;
  ...
  if ((char)param_2 < '\0') {
LAB_00f62644:
    out = (uchar **)((int64_t)&MACH_HEADER.magic + 1);
    iVar5 = (*this_ptr)();
    if (iVar5 != 0) {
      if ((param_2 & 0x200) == 0) {
        iVar5 = param_1->type;
        if (arg1 != 0) {
          ...
          lVar10 = 0;
          do {
            iVar6 = (*this_ptr)("0123456789ABCDEF"[(byte)pcVar9[lVar10] >> 4],2);
            if (iVar6 == 0) {
              return -1;
            }
            lVar10 = lVar10 + 1;
        ...
        if (pvVar7 == (void *)0x0) {
          ...
          if ((arg1 != 0) && (iVar5 != 0)) {
            ...
            do {
              pAVar8 = (ASN1_TYPE *)
                       (uint64_t)
                       (byte)"0123456789ABCDEF"[*(byte *)((int64_t)pvVar7 + lVar10) >> 4];
              iVar6 = (*this_ptr)(pAVar8,2);
              if (iVar6 == 0) {
                iVar5 = -1;
                goto LAB_00f627d4;
              }
...
LAB_00f627d4:
    ...
    uVar4 = 9;
    if ((param_2 & 0x20) == 0) {
      pAVar8 = (ASN1_TYPE *)(uint64_t)(uVar1 - 1);
      if ((uVar1 - 1 < 0x1e) &&
         (pAVar8 = (ASN1_TYPE *)0x2a23efff, (0x2a23efffUL >> ((uint64_t)uVar1 & 0x3f) & 1) == 0)) {
        uVar11 = 0;
        if (uVar1 != 0xc) {
          uVar11 = (int)(char)(&g_023ebb70)[uVar1];
        }
        uVar4 = 1;
        if (uVar1 != 0xc) {
          uVar4 = (int)(char)(&g_023ebb70)[uVar1] | 8;
        }
      }
    ...
    if (((local_31 == '\0') || (iVar3 = (*this_ptr)(local_31,1), iVar3 != 0)) &&
