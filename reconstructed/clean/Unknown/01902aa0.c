...
void FUN_01902aa0(double param_1,uint64_t *param_2)

{
  ...
  uVar4 = FUN_00e7bdb0();
  if ((((arg1 >> 0x20 != 0) && (uVar4 >> 0x20 != 0)) && (cVar2 = FUN_00e7c000(), cVar2 != '\0')
  ...
  *pcVar5 = '\0';
  ...
  if (uVar1 == uVar4) {
    ...
    iVar8 = *(int *)(*(int64_t *)(this_ptr + 0x38) + 0xc);
    if ((local_38[0] != '\0') && (uVar4 != 0)) {
      FUN_00d50b20();
    }
    if (iVar8 != 0) {
      ...
      *pcVar5 = '\0';
      ...
      if (uVar1 == uVar4) {
        iVar8 = *(int *)(*(int64_t *)(this_ptr + 0x38) + 0xc) + -1;
        goto LAB_01902d8e;
      }
      ...
      iVar3 = *(int *)(*(int64_t *)(this_ptr + 0x38) + 0xc);
...
LAB_01902d8e:
  ...
  if (iVar8 < *(int *)(*(int64_t *)(this_ptr + 0x38) + 0xc)) {
    ...
    if ((param_1 != 0.0) || (NAN(param_1))) {
      do {
        ...
        lVar12 = lVar12 + 1;
      } while (lVar12 < *(int *)(*(int64_t *)(this_ptr + 0x38) + 0xc));
    }
    else {
      do {
        cVar2 = FUN_00e7c7f0();
