...
uint32_t FUN_00c659d0(uint param_1,int *param_2,int param_3,int *param_4)

{
  ...
  uVar12 = 0xffffffce;
  if (((arg1 != (uint64_t *)0x0) && (param_2 != (int *)0x0)) && (param_4 != (int *)0x0)) {
    iVar1 = *(int *)(this_ptr + 8);
    uVar2 = *(uint *)(this_ptr + 0xc);
    uVar3 = *(uint *)(this_ptr + 0x10);
    *param_4 = 0;
    uVar4 = (uint)arg1[2];
    ...
    if (param_1 == 0) {
      ...
      uVar6 = *arg1;
      iVar5 = *(int *)((int64_t)arg1 + 0x14);
      uVar22 = *(uint *)(this_ptr + 4);
      uVar11 = 0;
      uVar19 = 0;
      uVar18 = (uint64_t)uVar4;
LAB_00c65aa1:
...
LAB_00c65d50:
        ...
        if (uVar10 < 9) {
          ...
          uVar10 = uVar10 & uVar7;
          uVar18 = (uint64_t)(uVar16 + param_3);
        }
        piVar15 = param_2 + 1;
        *param_2 = (uVar11 + uVar10 + 1 >> 1) * (-(uVar10 + uVar11 & 1) | 1);
        ...
        if (uVar22 != 0) {
          ___bzero();
          piVar15 = param_2 + (uint64_t)(uVar22 - 1) + 2;
