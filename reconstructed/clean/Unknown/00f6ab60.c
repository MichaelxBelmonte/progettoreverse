...
LAB_00f6ad6b:
    ...
    oid = (char *)((int64_t)&MACH_HEADER.magic + 1);
    if (0 < iVar2) {
      iVar8 = 0;
      do {
        iVar2 = (int)param_2;
        ...
        if (pcVar6 != (char *)0x0) {
          if (pcVar6[1] != '\0') {
            ...
            pcVar7 = _CRYPTO_malloc((int)oid,(char *)((int64_t)&segment_command_00000020.filesize +
                                                     6),(int)param_3);
            iVar2 = (int)unaff_R12;
            if (pcVar7 != (char *)0x0) {
              _memcpy(oid,pcVar9,(size_t)param_3);
              pcVar7[(int64_t)pcVar9] = '\0';
              goto LAB_00f6acc6;
            }
...
LAB_00f6acc6:
        ...
        param_2 = (char *)((int64_t)&segment_command_00000020.nsects + 1);
        _CRYPTO_free(oid);
        iVar2 = (int)unaff_R12;
