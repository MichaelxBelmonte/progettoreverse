...
void FUN_01a85710(uint64_t param_1,char param_2)

{
  ...
  (**(code **)(*this_ptr + 0x4d8))();
  _local_e8 = in_XMM1;
  pvVar4 = _pthread_getspecific((void*)uVar6);
  if (pvVar4 != (void *)0x0) {
    FUN_00e8b990();
  }
  FUN_0126e7e0();
...
LAB_01a8637e:
    if (local_68 == (int64_t *)0x0) goto LAB_01a8638b;
  }
  else {
    pvVar4 = _pthread_getspecific((void*)uVar6);
    if (pvVar4 != (void *)0x0) {
...
LAB_01a85e36:
      ...
      if (0 < *(int *)((int64_t)local_68 + 0xc)) {
        ...
        auVar15._0_4_ = (float)local_e8._4_4_ * g_0239011c;
        auVar16 = roundss(auVar15,auVar15,9);
        local_138 = insertps(auVar16,auVar16,0x1d);
        lVar7 = 0;
        iVar8 = 0;
        do {
          lVar2 = *(int64_t *)(local_68[2] + lVar7 * 8);
...
LAB_01a85f90:
          ...
          lVar7 = lVar7 + 1;
        } while ((int)lVar7 < *(int *)((int64_t)local_68 + 0xc));
      }
      FUN_01a81420();
      FUN_00d50b20();
      FUN_00d50b20();
