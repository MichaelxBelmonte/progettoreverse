...

{
  ...
  _X509_ALGOR_get0(local_40,(int *)&local_48,arg1,(X509_ALGOR *)in_R9);
  len = (long)arg1;
  pAVar2 = _d2i_ASN1_INTEGER((ASN1_INTEGER **)local_40,(uchar **)(int64_t)in_stack_ffffffffffffffc8
                             ,len);
...
LAB_00fbeee5:
    ...
    pBVar5 = (BIGNUM *)(int64_t)*local_48;
