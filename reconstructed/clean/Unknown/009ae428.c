...
void FUN_009ae428(uint64_t param_1,uint64_t param_2,uint64_t param_3,int64_t *param_4)

{
  ...
  FUN_0098d41a();
  pvVar4 = (void *)(uint64_t)local_27c;
  pvVar3 = (void *)(local_res8[1] - *local_res8);
  if (pvVar3 < pvVar4) {
    FUN_00958ec0();
  }
  else if (pvVar4 < pvVar3) {
    local_res8[1] = *local_res8 + (int64_t)pvVar4;
  }
  if (local_2a8 != 0) {
