...
void FUN_016450a0(double param_1,float param_2,double param_3,int64_t *param_4)

{
  ...
  uVar16 = (**(code **)(*plVar9 + 0x388))
                     (g_0238fee8 / param_3,&local_68,uVar3,
                      (int64_t)(param_1 * dVar15) - (int64_t)(iVar2 * iVar12));
  ...
  if ((3 < iVar2) && (**(void**)(*this_ptr + 0x10) = 0, 7 < iVar2)) {
    uVar13 = 2;
    if (2 < iVar4 >> 2) {
      uVar13 = (uint64_t)(uint)(iVar4 >> 2);
    }
    uVar11 = 1;
    fVar18 = g_02394274;
    do {
      ...
      if (iVar2 < iVar12) {
        iVar4 = iVar2 * 2;
        uVar16 = *(void*)(lVar1 + (int64_t)iVar4 * 4);
        fVar18 = (float)uVar16;
        fVar14 = (float)((uint64_t)uVar16 >> 0x20);
        fVar18 = SQRT(fVar14 * fVar14 + fVar18 * fVar18) + g_0239424c;
        if (1 < iVar2) {
          uVar16 = *(void*)(lVar1 + (uint64_t)(iVar4 - 2) * 4);
          fVar14 = (float)uVar16;
          fVar17 = (float)((uint64_t)uVar16 >> 0x20);
          fVar18 = fVar18 + SQRT(fVar17 * fVar17 + fVar14 * fVar14);
        }
        if (iVar2 < iVar12 + -1) {
          uVar16 = *(void*)(lVar1 + (int64_t)(iVar4 + 2) * 4);
          fVar14 = (float)uVar16;
          fVar17 = (float)((uint64_t)uVar16 >> 0x20);
          fVar18 = fVar18 + SQRT(fVar17 * fVar17 + fVar14 * fVar14);
        }
      }
      *(float *)(*(int64_t *)(*this_ptr + 0x10) + uVar11 * 4) = fVar18;
      uVar11 = uVar11 + 1;
    } while (uVar13 != uVar11);
  }
  return;
