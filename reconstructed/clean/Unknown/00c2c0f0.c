...
LAB_00c2c13f:
  ...
  if (plVar1 == (int64_t *)0x0) goto LAB_00c2c594;
  pplVar9 = &local_40;
  FUN_01e05950();
  plVar2 = local_40;
  FUN_00c41750();
...
LAB_00c2c1bf:
  ...
  lVar5 = g_027e7c20;
  if (plVar2 == (int64_t *)0x0) goto LAB_00c2c594;
  if (g_027e7c20 != 0) {
    FUN_00d50b00();
  }
  FUN_01ccab60();
...
LAB_00c2c4f1:
    ...
    if (plVar3 != plVar8) {
      ...
      plVar2[3] = (int64_t)plVar8;
      if (plVar3 != (int64_t *)0x0) goto LAB_00c2c52c;
    }
  }
