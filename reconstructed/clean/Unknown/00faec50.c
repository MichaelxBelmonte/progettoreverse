...
uint64_t FUN_00faec50(BUF_MEM *param_1,void*param_2,BIO *param_3,BIO *param_4)
...
LAB_00faedbb:
            ...
            pBVar22 = (BIO *)(int64_t)(int)uVar7;
            p_Var1 = p_Var3 + (int64_t)pBVar22;
            p_Var3[(int64_t)pBVar22] = (_func_4494)0x0;
            pcVar10 = p_Var3 + (int64_t)pBVar22 + 3;
            ...
            if (bVar28) {
              ...
              pCVar12 = (CONF_VALUE *)(uint64_t)sVar6;
              if (((bVar30) && (2 < (int)sVar6)) &&
                 (uVar21 = (byte)p_Var1[2] ^ 0xbf | *(ushort *)p_Var1 ^ 0xbbef,
                 pBVar22 = (BIO *)(uint64_t)uVar21, uVar21 == 0)) {
                pCVar12 = (CONF_VALUE *)(uint64_t)(sVar6 - 3);
                pCVar9 = pCVar12;
                _memmove((void *)0x0,pCVar12,(size_t)param_3);
                p_Var1[(int64_t)pCVar12] = (_func_4494)0x0;
              }
              iVar5 = (int)pCVar12;
              bVar30 = iVar5 != 0;
            }
...
LAB_00faf02c:
              ...
              pBVar22 = (BIO *)CONCAT71((int7)((uint64_t)pBVar22 >> 8),bVar18);
              iVar25 = iVar8;
...
joined_r0x00faf4da:
              ...
              if (bVar18 == 0) {
                ...
                pBVar29 = (BIO *)(uint64_t)*(byte *)&pBVar27->method;
                pBVar11 = pBVar27;
                pBVar26 = pBVar29;
                if (-1 < (char)*(byte *)&pBVar27->method) {
                  do {
                    uVar21 = *(ushort *)(*(int64_t *)(this_ptr + 8) + (int64_t)pBVar26 * 2);
                    pBVar22 = (BIO *)(uint64_t)uVar21;
                    if ((uVar21 & 0x800) != 0) goto LAB_00faf20d;
                    if ((uVar21 & 0x10) == 0) break;
                    bVar18 = *(char *)((int64_t)&pBVar11->method + 1);
                    pBVar26 = (BIO *)(uint64_t)bVar18;
                    pBVar11 = (BIO *)((int64_t)&pBVar11->method + 1);
                  } while (-1 < (char)bVar18);
                }
                do {
                  bVar18 = (byte)pBVar26;
                  if ((char)bVar18 < '\0') goto LAB_00faf1f0;
                  param_3 = *(BIO **)(this_ptr + 8);
                  uVar21 = *(ushort *)((int64_t)&param_3->method + (int64_t)pBVar26 * 2);
                  pBVar22 = (BIO *)(uint64_t)uVar21;
                  ...
                  if ((uVar21 & 0x400) == 0) {
                    if ((uVar21 & 0x40) == 0) {
                      if ((uVar21 & 0x20) == 0) {
                        ...
                        bVar18 = *(char *)((int64_t)&pBVar11->method + 1);
                        if (((char)bVar18 < '\0') ||
                           ((*(byte *)((int64_t)&param_3->method + (uint64_t)bVar18 * 2) & 8) == 0
                           )) {
                          pBVar11 = (BIO *)((int64_t)&pBVar11->method + 2);
                          goto LAB_00faf11a;
                        }
                      }
LAB_00faf1f0:
                      ...
                      do {
                        while( true ) {
                          pBVar22 = pBVar11;
                          pBVar26 = (BIO *)((int64_t)&pBVar22->method + 1);
                          bVar19 = *(char *)((int64_t)&pBVar22->method + 1);
                          pBVar11 = pBVar26;
                          if ((char)bVar19 < '\0') break;
                          uVar21 = *(ushort *)((int64_t)&param_3->method + (uint64_t)bVar19 * 2);
                          bVar20 = bVar19;
                          if (((uVar21 & 8) != 0) || (bVar19 == bVar18)) goto LAB_00faf1fe;
                          if ((uVar21 & 0x20) != 0) {
                            bVar19 = *(char *)((int64_t)&pBVar22->method + 2);
                            pBVar11 = (BIO *)((int64_t)&pBVar22->method + 2);
                            if ((-1 < (char)bVar19) &&
                               ((*(byte *)((int64_t)&param_3->method + (uint64_t)bVar19 * 2) & 8)
                                != 0)) goto LAB_00faf11a;
                          }
                        }
                        bVar20 = bVar18;
...
LAB_00faf1fe:
                    ...
                    do {
                      pBVar26 = pBVar11;
                      pBVar22 = (BIO *)((int64_t)&pBVar26->method + 1);
                      bVar19 = *(char *)((int64_t)&pBVar26->method + 1);
                      if ((-1 < (char)bVar19) &&
                         ((*(byte *)((int64_t)&param_3->method + (uint64_t)bVar19 * 2) & 8) != 0))
                      break;
                      pBVar11 = pBVar22;
                    } while ((bVar19 != bVar18) ||
                            (pBVar11 = (BIO *)((int64_t)&pBVar26->method + 2), bVar19 = bVar18,
                            *(char *)((int64_t)&pBVar26->method + 2) == bVar18));
                    pBVar11 = pBVar22;
                    if (bVar19 == bVar18) {
                      pBVar11 = (BIO *)((int64_t)&pBVar26->method + 2);
                    }
                  }
LAB_00faf11a:
                  pBVar26 = (BIO *)(uint64_t)*(byte *)&pBVar11->method;
                } while( true );
              }
            }
            else {
LAB_00faf002:
              pCVar9 = pCVar12;
              iVar5 = (int)pCVar9;
              pBVar22 = (BIO *)((int64_t)&pCVar9->section + 1);
              do {
                iVar8 = (int)pCVar9;
                pCVar9 = (CONF_VALUE *)(uint64_t)(iVar8 - 1);
                if ((p_Var1[(int64_t)pCVar9] != (_func_4494)0xd) &&
                   (p_Var1[(int64_t)pCVar9] != (_func_4494)0xa)) goto LAB_00faf02c;
                pBVar22 = (BIO *)&pBVar22[-1].ex_data.field_0xf;
              } while (1 < (int64_t)pBVar22);
              iVar25 = 0;
              iVar8 = 0;
...
LAB_00faf063:
              ...
              local_f8 = (LHASH *)((int64_t)&local_f8->b + 1);
...
LAB_00faf08c:
              ...
              uVar7 = uVar24 - 1;
              bVar18 = *(byte *)((int64_t)&pCVar9->section + (uint64_t)uVar7);
              if (((char)bVar18 < '\0') ||
                 (param_3 = *(BIO **)(this_ptr + 8),
                 (*(byte *)((int64_t)&param_3->method + (uint64_t)bVar18 * 2) & 0x20) == 0))
              goto LAB_00faf0ab;
              bVar28 = true;
              if (1 < (int)uVar24) {
                bVar18 = *(char *)((int64_t)pCVar9 + ((uint64_t)uVar7 - 1));
                pCVar9 = (CONF_VALUE *)(uint64_t)bVar18;
                if ((char)bVar18 < '\0') goto LAB_00faed99;
                bVar30 = (*(byte *)((int64_t)&param_3->method + (int64_t)pCVar9 * 2) & 0x20) == 0;
                if (bVar30) {
                  uVar24 = uVar7;
                }
...
LAB_00fafc10:
          ...
          param_3 = (BIO *)((int64_t)&section_000000b8.size + 4);
          _ERR_put_error(0x200b783,7,0xe4,(char *)param_4,in_stack_fffffffffffffee8);
          goto LAB_00fafa57;
        }
        iVar5 = 0x67;
        param_3 = (BIO *)((int64_t)&section_000000b8.addr + 4);
      }
    }
  }
  pcVar23 = "crypto/conf/conf_def.c";
...
LAB_00fafa5e:
  ...
  if (lVar2 != *(int64_t *)(this_ptr + 0x10)) {
    _CONF_free(local_f8);
...
LAB_00faf213:
  ...
  if (-1 < (char)bVar18) {
    ...
    pBVar4 = pBVar27;
LAB_00faf230:
    pBVar22 = (BIO *)((int64_t)&pBVar4->method + 1);
    uVar21 = *(ushort *)(lVar14 + (int64_t)pBVar29 * 2);
    pCVar9 = (CONF_VALUE *)(uint64_t)uVar21;
    ...
    if ((char)pBVar29 == '[') {
      ...
      while ((pBVar22 = (BIO *)pcVar23, param_3 = (BIO *)pcVar23, -1 < (char)bVar18 &&
             ((*(ushort *)(lVar14 + (uint64_t)bVar18 * 2) & 0x18) == 0x10))) {
        bVar18 = *(char *)((int64_t)&((BIO *)pcVar23)->method + 1);
        pcVar23 = (char *)((int64_t)&((BIO *)pcVar23)->method + 1);
      }
joined_r0x00faf889:
...
LAB_00fafd6b:
          pcVar23 = "crypto/conf/conf_def.c";
          param_3 = (BIO *)((int64_t)&section_00000108.reserved2 + 2);
      ...
      uVar21 = *(ushort *)(lVar14 + (uint64_t)bVar18 * 2);
      if ((uVar21 & 0x20) == 0) {
        if ((uVar21 & 0x307) == 0) {
          if ((uVar21 & 0x18) != 0x10) goto LAB_00faf907;
          param_4 = (BIO *)((int64_t)pBVar22 + 1);
          do {
            pBVar27 = param_4;
            bVar18 = *(byte *)&pBVar27->method;
            param_4 = pBVar27;
            if ((char)bVar18 < '\0') break;
            param_4 = (BIO *)((int64_t)&pBVar27->method + 1);
          } while ((*(ushort *)(lVar14 + (uint64_t)bVar18 * 2) & 0x18) == 0x10);
          goto LAB_00faf907;
        }
      }
      else if (((char)*(byte *)((int64_t)pBVar22 + 1) < '\0') ||
              ((*(byte *)(lVar14 + (uint64_t)*(byte *)((int64_t)pBVar22 + 1) * 2) & 8) == 0)) {
        bVar18 = *(byte *)((int64_t)pBVar22 + 2U);
        pBVar22 = (BIO *)((int64_t)pBVar22 + 2U);
        goto joined_r0x00faf889;
      }
      bVar18 = *(byte *)((int64_t)pBVar22 + 1U);
      pBVar22 = (BIO *)((int64_t)pBVar22 + 1U);
      goto joined_r0x00faf889;
    }
    pBVar11 = pBVar4;
    pBVar27 = pBVar4;
    ...
    if (((uint64_t)pCVar9 & 0x307) != 0) {
      do {
        ...
        while( true ) {
          ...
          pBVar22 = (BIO *)(uint64_t)bVar18;
          uVar21 = *(ushort *)(lVar14 + (int64_t)pBVar22 * 2);
          pCVar9 = (CONF_VALUE *)(uint64_t)uVar21;
          pBVar29 = pBVar22;
...
LAB_00faf370:
          bVar18 = *(char *)((int64_t)&pBVar11->method + 1);
          pBVar22 = (BIO *)(uint64_t)bVar18;
          if ((-1 < (char)bVar18) && ((*(byte *)(lVar14 + (int64_t)pBVar22 * 2) & 8) != 0)) break;
          pBVar11 = (BIO *)((int64_t)&pBVar11->method + 2);
          bVar18 = *(byte *)&pBVar11->method;
        }
      } while( true );
    }
    if (((char)pBVar29 == ':') && (*(char *)((int64_t)&pBVar11->method + 1) == ':')) {
      *(void*)&pBVar11->method = 0;
      bVar18 = *(char *)((int64_t)&pBVar11->method + 2);
      pBVar27 = (BIO *)((int64_t)&pBVar11->method + 2);
      pBVar26 = pBVar4;
      pcVar23 = (char *)pBVar27;
      pBVar11 = pBVar27;
      if (-1 < (char)bVar18) {
        do {
          pBVar29 = (BIO *)(uint64_t)bVar18;
          uVar21 = *(ushort *)(*(int64_t *)(this_ptr + 8) + (int64_t)pBVar29 * 2);
          pBVar22 = (BIO *)(uint64_t)uVar21;
          if ((uVar21 & 0x20) == 0) {
            pBVar11 = (BIO *)pcVar23;
...
LAB_00faf54c:
            ...
            pBVar22 = (BIO *)(uint64_t)bVar18;
            if ((-1 < (char)bVar18) &&
               ((*(byte *)(*(int64_t *)(this_ptr + 8) + (int64_t)pBVar22 * 2) & 8) != 0))
            goto LAB_00faf54c;
            pcVar23 = (char *)((int64_t)&((BIO *)pcVar23)->method + 2);
            bVar18 = *(byte *)&((BIO *)pcVar23)->method;
          }
          pBVar11 = (BIO *)pcVar23;
        } while (-1 < (char)bVar18);
...
LAB_00faf572:
    ...
    do {
      bVar18 = (byte)pBVar29;
      uVar7 = *(ushort *)(*(int64_t *)(this_ptr + 8) + (int64_t)pBVar29 * 2) & 0x18;
      pBVar22 = (BIO *)(uint64_t)uVar7;
...
LAB_00faf283:
  ...
  *(void*)&pBVar11->method = 0;
  ...
  if (-1 < (char)bVar18) {
    do {
      if ((*(ushort *)(*(int64_t *)(this_ptr + 8) + (uint64_t)bVar18 * 2) & 0x18) != 0x10) break;
      bVar18 = *(char *)((int64_t)&((BIO *)pcVar23)->method + 1);
      pcVar23 = (char *)((int64_t)&((BIO *)pcVar23)->method + 1);
    } while (-1 < (char)bVar18);
  }
  pBVar22 = (BIO *)&(((BIO *)((int64_t)pcVar23 + -0x68))->ex_data).field_0xf;
  pBVar11 = (BIO *)pcVar23;
  while (((char)bVar18 < '\0' ||
         ((*(byte *)(*(int64_t *)(this_ptr + 8) + (uint64_t)bVar18 * 2) & 8) == 0))) {
    bVar18 = *(char *)((int64_t)&pBVar11->method + 1);
    pBVar11 = (BIO *)((int64_t)&pBVar11->method + 1);
    pBVar22 = (BIO *)((int64_t)&pBVar22->method + 1);
  }
  do {
    pBVar11 = pBVar22;
    pBVar22 = pBVar11;
  ...
  } while ((*(byte *)(*(int64_t *)(this_ptr + 8) + (uint64_t)*(byte *)&pBVar11->method * 2) &
           0x10) != 0);
  *(char *)((int64_t)&pBVar11->method + 1) = '\0';
  local_128 = pBVar26;
  pCVar12 = _CRYPTO_malloc((int)pBVar22,(char *)((int64_t)&section_00000158.reserved1 + 3),
                           (int)param_3);
  ...
  pcVar13 = _CRYPTO_strdup((char *)pBVar22,(char *)((int64_t)&section_00000158.reserved2 + 3),
                           (int)param_3);
  pCVar12->name = pcVar13;
  pCVar12->value = (char *)0x0;
  if (pcVar13 == (char *)0x0) {
    iVar5 = 0x41;
    param_3 = (BIO *)((int64_t)&section_00000158.reserved3 + 2);
  }
  else {
...
LAB_00fafc56:
    pcVar23 = "crypto/conf/conf_def.c";
    param_3 = (BIO *)((int64_t)&section_00000158.nrelocs + 3);
  ...
  if (bVar18 == 0x3d) {
    ...
    if (-1 < (char)bVar18) {
      do {
        if ((*(ushort *)(*(int64_t *)(this_ptr + 8) + (uint64_t)bVar18 * 2) & 0x18) != 0x10)
        break;
        bVar18 = *(char *)((int64_t)&((BIO *)pcVar23)->method + 1);
        pcVar23 = (char *)((int64_t)&((BIO *)pcVar23)->method + 1);
      } while (-1 < (char)bVar18);
  ...
  do {
    ...
    pBVar22 = (BIO *)&pBVar11[-1].ex_data.field_0xf;
           ...
           0x10) != 0);
  *(void*)((int64_t)&pBVar11->method + 1) = 0;
  mode = &local_130;
  iVar5 = FUN_00fb00c0();
  lVar14 = local_130;
  in_stack_fffffffffffffee8 = (int)pBVar27;
...
joined_r0x00faf99d:
    ...
    param_3 = (BIO *)((int64_t)&section_00000158.align + 2);
  }
  pcVar23 = "crypto/conf/conf_def.c";
