...
LAB_00ac9f03:
      if ((bVar2 & 1) == 0) {
        pbVar5 = this_ptr + 1;
        uVar10 = (uint64_t)(bVar2 >> 1);
      }
      else {
        uVar10 = *(uint64_t *)(this_ptr + 8);
        pbVar5 = pbVar4;
      }
      if (uVar10 <= uVar7) {
        uVar13 = uVar10;
...
LAB_00ac9f59:
    if (*(int64_t *)(this_ptr + 8) == 0) goto LAB_00ac9f62;
LAB_00ac9fc5:
    pbVar5 = this_ptr + 1;
    if ((bVar2 & 1) != 0) {
      pbVar5 = pbVar4;
    ...
    if (3 < uVar7) {
      ...
      if (2 < uVar13) {
        ...
        if (pbVar12 != pbVar5 + uVar13) {
          uVar10 = (int64_t)pbVar12 - (int64_t)pbVar5;
        }
      }
  ...
  if ((bVar2 & 1) == 0) {
    do {
      ...
      lVar9 = lVar6;
            ...
            (lVar3 = lVar8 + -1, lVar8 = lVar8 + -1, lVar9 = lVar8, this_ptr[lVar3] == 0x2f));
  }
  else {
    do {
      if (lVar8 == 1) goto LAB_00aca08d;
