...
uint64_t FUN_00eb69ba(int64_t *param_1,uint64_t param_2,uint64_t *param_3,int *param_4)

{
  ...
  if (*(uint *)(arg1 + 0x2c) < uVar34) {
    ...
    do {
      uVar9 = (uint)uVar29;
      uVar12 = (uint64_t)(*(int64_t *)(lVar5 + uVar29) * -0x30e4432345000000) >>
...
LAB_00eb6c01:
  ...
  *(uint *)(arg1 + 0x2c) = uVar34;
  ...
  lVar17 = *param_1;
  uVar29 = (uint64_t)(lVar17 * -0x30e4432345000000) >> (-*(char *)(arg1 + 0x108) & 0x3fU);
  local_70 = 0;
...
LAB_00eb7174:
            ...
            if ((byte *)((int64_t)puVar30 + uVar18) != pbVar7) goto LAB_00eb71e4;
...
LAB_00eb758b:
  ...
  uVar8 = *(uint *)(puVar6[0xe] +
                   ((uint64_t)(lVar17 * -0x30e4432345000000) >> (-local_100 & 0x3fU)) * 4);
  if (local_fc < uVar8) {
    lVar37 = puVar6[0x10];
