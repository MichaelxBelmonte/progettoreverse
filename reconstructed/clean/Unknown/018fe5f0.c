...
uint64_t FUN_018fe5f0(uint64_t param_1,int *param_2)

{
  ...
  uVar4 = FUN_019079b0();
  iVar8 = (int)(arg1 >> 0x20);
  if (((arg1 >> 0x20 != 0) && (uVar4 >> 0x20 != 0)) && (cVar2 = FUN_00e7c020(), cVar2 != '\0'))
  {
    iVar7 = 0;
    if (param_2 != (int *)0x0) {
LAB_018fe9c6:
...
LAB_018fea0a:
    uVar4 = FUN_019079b0();
    if (((iVar7 == *(int *)(*(int64_t *)(this_ptr + 0x38) + 0xc) + -2) && (uVar4 >> 0x20 != 0)) &&
