...

{
  ...
  uVar55 = local_38 + 1;
  plVar38 = (int64_t *)FUN_00e83010();
  uVar57 = iVar36 + 1;
  lVar39 = FUN_00e83010();
  *plVar38 = lVar39;
  uVar53 = (uint64_t)uVar55;
  if (-1 < local_38) {
    *plVar38 = lVar39;
    if (local_38 != 0) {
      uVar40 = (uint64_t)((uint)(uVar53 - 1) & 3);
      lVar39 = 1;
      if (2 < uVar53 - 2) {
        iVar54 = iVar36 * 4 + 4;
        iVar51 = iVar36 * 3 + 3;
        ...
        do {
          uVar46 = uVar43;
          plVar38[uVar46 + 1] = (int64_t)(int)uVar37 * 4 + *plVar38;
          plVar38[uVar46 + 2] = (int64_t)iVar45 * 4 + *plVar38;
          plVar38[uVar46 + 3] = (int64_t)iVar51 * 4 + *plVar38;
          plVar38[uVar46 + 4] = (int64_t)iVar42 * 4 + *plVar38;
      ...
      if (uVar40 != 0) {
        ...
        uVar43 = 0;
        do {
          plVar38[lVar39 + uVar43] = (int64_t)iVar42 * 4 + *plVar38;
          uVar43 = uVar43 + 1;
          iVar42 = iVar42 + uVar57;
        } while (uVar40 != uVar43);
      }
    }
    uVar40 = (uint64_t)(uVar55 & 7);
    if (uVar53 - 1 < 7) {
      uVar43 = 0;
    }
    else {
  ...
  if (-1 < iVar36) {
    ...
    if (uVar57 < 8) {
      ...
      uVar43 = (uint64_t)(uVar57 & 0xfffffff8);
      uVar48 = (uVar43 - 8 >> 3) + 1;
      uVar46 = (uint64_t)((uint)uVar48 & 3);
      iVar58 = g_0238fcc0;
...
LAB_00d9c0bc:
  ...
  uVar4 = *(void*)(plVar38[local_38] + (int64_t)iVar36 * 4);
  FUN_00e83070();
  *plVar38 = 0;
  FUN_00e83070();
  return uVar4;
