...
void* FUN_014f7360(float param_1,uint param_2)

{
  ...
  *puVar19 = &g_02572358;
  ...
  if (*(int *)(lVar23 + 0xc) < 1) {
    ...
    bVar3 = false;
    do {
      puVar32 = *(void**)(*(int64_t *)(lVar23 + 0x10) + lVar21 * 8);
      if (local_40 == puVar32) {
      ...
      lVar23 = *(int64_t *)(puVar19[2] + (int64_t)*(int *)(local_40 + 5) * 8);
      if (local_b0 == lVar23) {
        if ((!bVar6) && (local_b0 != 0)) {
          bVar6 = true;
          FUN_00d50b00();
  ...
  if (0 < (int)param_2) {
    uVar22 = 0;
    do {
      lVar23 = *(int64_t *)(puVar19[2] + uVar22 * 8);
      if (local_b0 == lVar23) {
        if ((!bVar6) && (local_b0 != 0)) {
          bVar6 = true;
          FUN_00d50b00();
      ...
      if (0 < *(int *)(local_b0 + 0xc)) {
        lVar23 = 0;
        do {
          puVar32 = *(void**)(*(int64_t *)(local_b0 + 0x10) + lVar23 * 8);
          if (local_40 == puVar32) {
            if ((!bVar3) && (local_40 != (void*)0x0)) {
              bVar3 = true;
              FUN_00d50b00();
...
LAB_014f7880:
            if (*(float *)(local_40 + 6) <= g_02394274 && g_02394274 != *(float *)(local_40 + 6)
               ) {
LAB_014f7892:
              *(void*)(local_40 + 6) = 0x800000;
            }
          }
          else {
            if (puVar32 != (void*)0x0) {
            ...
            bVar3 = true;
            local_40 = puVar32;
            if (*(float *)(puVar32 + 6) <= g_02394274 && g_02394274 != *(float *)(puVar32 + 6))
            goto LAB_014f7892;
          }
          FUN_014f6db0();
          if (local_140 == '\0') {
  ...
  if (*(int *)((int64_t)puVar16 + 0xc) == 0) {
    ...
    do {
      ...
      if (0 < *(int *)((int64_t)puVar16 + 0xc)) {
        lVar21 = 0;
        do {
          lVar24 = *(int64_t *)(puVar16[2] + lVar21 * 8);
          if (local_58 == lVar24) {
            if ((!bVar7) && (local_58 != 0)) {
              bVar7 = true;
              FUN_00d50b00();
...
LAB_014f7ac0:
          ...
          bVar28 = bVar27;
          if ((local_50 != (void*)0x0) && (bVar28 = bVar4, bVar27)) {
            FUN_00d50b20();
          }
          fVar2 = 0.0;
          local_50 = (void*)0x0;
          ...
          do {
            ...
            if (local_c0 == local_40) {
              ...
              if ((!bVar3) || (local_40 == (void*)0x0)) goto LAB_014f7c50;
              fVar30 = (float)FUN_00d50b20();
              local_40 = local_c0;
              bVar3 = true;
            }
            else if ((bVar3) && (local_40 != (void*)0x0)) {
              fVar30 = (float)FUN_00d50b20();
              local_40 = local_c0;
              bVar3 = true;
            }
...
LAB_014f7c50:
            ...
            if ((-1 < (int)uVar25) && ((int)uVar25 < (int)param_2)) {
              lVar24 = *(int64_t *)(puVar19[2] + (uint64_t)uVar25 * 8);
              if (lVar23 == lVar24) {
                if (bVar8) {
...
LAB_014f7ce2:
              ...
              if (0 < (int)dVar1) {
                ...
                bVar28 = bVar27;
                do {
                  puVar33 = *(void**)(*(int64_t *)(lVar23 + 0x10) + lVar24 * 8);
                  if (puVar32 == puVar33) {
                    if ((!bVar5) && (puVar32 != (void*)0x0)) {
                      bVar5 = true;
                      fVar30 = (float)FUN_00d50b00();
                    }
LAB_014f7e60:
...
joined_r0x014f8018:
                  ...
                  if (local_60 != 0) {
                    ...
                    if (local_c0 == puVar32) {
                      fVar31 = *(float *)((int64_t)local_40 + 0x2c);
                      if (in_CL == '\0') {
                        fVar30 = (float)((uint)(fVar31 - *(float *)((int64_t)puVar32 + 0x2c)) &
                                        g_02390140);
                        if (fVar30 < param_1) {
                          fVar30 = fVar30 * fVar29;
                          fVar31 = (g_02390124 - fVar30) * *(float *)(puVar32 + 6);
                          if (fVar2 < fVar31) {
          ...
          if (local_50 == (void*)0x0) {
            *(void*)(local_58 + 0xc) = 0;
            ...
            local_50[2] = local_88;
            *(float *)((int64_t)local_50 + 0x34) = fVar2;
            local_c0 = local_50;
            local_b8 = '\0';
          ...
          lVar21 = lVar21 + 1;
        } while (lVar21 < *(int *)((int64_t)puVar16 + 0xc));
      }
      FUN_00d242c0(fVar30,0);
      uVar25 = *(uint *)((int64_t)puVar17 + 0xc);
      uVar14 = uVar25 + 3;
      if (-1 < (int)uVar25) {
        uVar14 = uVar25;
      }
      ...
      if (0 < (int)uVar14) {
        ...
        bVar9 = bVar10;
        do {
          puVar33 = *(void**)(puVar17[2] + uVar22 * 8);
          if (local_40 == puVar33) {
            if ((!bVar3) && (local_40 != (void*)0x0)) {
              bVar3 = true;
              FUN_00d50b00();
...
joined_r0x014f8583:
          if ((cVar13 != '\0') && (*(char *)(local_58 + 0xd) != '\0')) {
            lVar21 = *(int64_t *)(local_40[2] + 0x18);
            if (lVar21 == local_60) {
              lVar24 = local_60;
              bVar10 = bVar9;
              if ((!bVar9) && (lVar21 != 0)) {
...
LAB_014f8730:
      ...
      FUN_00d214d0();
      local_c0 = puVar18;
    } while (*(int *)((int64_t)puVar16 + 0xc) != 0);
  }
  *this_ptr = puVar15;
  *(void*)(this_ptr + 1) = 1;
  if (puVar19 != (void*)0x0) {
