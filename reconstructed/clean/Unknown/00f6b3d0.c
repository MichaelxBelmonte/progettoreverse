...
int FUN_00f6b3d0(BIO *param_1,int *param_2,uint64_t param_3,int param_4)

{
  ...
  piVar6 = (int *)((uint64_t)param_2 & 0xffffffff);
  data = param_2;
  puVar4 = (void*)_BIO_get_data();
  pBVar5 = _BIO_next(param_1);
  if ((((arg1 == 0) || ((int)param_2 < 0)) || (puVar4 == (void*)0x0)) ||
     (pBVar5 == (BIO *)0x0)) {
    return 0;
  }
  iVar7 = 0;
...
switchD_00f6b486_default:
  ...
  case 1:
    data = *(int **)(puVar4 + 0xc);
    b = (uint *)((int64_t)&MACH_HEADER.magic + 2);
    iVar3 = FUN_00f6b980();
    iVar2 = (int)data;
    if (iVar3 < 1) break;
    goto switchD_00f6b486_default;
  case 2:
    ...
    param_3 = (uint64_t)(uint)puVar4[8];
    data = piVar6;
    _ASN1_put_object((uchar **)(uint64_t)(uint)puVar4[9],constructed,puVar4[8],param_4,(int)pBVar5)
    ;
    puVar4[7] = constructed;
    *puVar4 = 3;
    goto switchD_00f6b486_default;
  case 3:
    data = (int *)(uint64_t)(uint)puVar4[6];
    ...
    break;
  case 4:
    data = (int *)(uint64_t)(uint)puVar4[7];
    ...
    iVar2 = (int)data;
    if (iVar3 < 1) break;
    piVar6 = (int *)(uint64_t)(uint)(constructed - iVar3);
    piVar1 = puVar4 + 7;
    *piVar1 = *piVar1 - iVar3;
    if (*piVar1 == 0) {
      *puVar4 = 2;
