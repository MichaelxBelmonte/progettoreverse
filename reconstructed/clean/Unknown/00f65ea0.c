...
ASN1_TYPE * FUN_00f65ea0(X509V3_CTX *param_1,int param_2,uint64_t param_3,list_cb *param_4)

{
  ...
  pSVar8 = (STACK *)((int64_t)&MACH_HEADER.magic + 1);
  ...
  local_68 = (uint64_t)(uint)local_288._8_4_;
...
LAB_00f664e2:
        if (iVar4 == 3) {
          ...
          *(uint64_t *)plVar1 = *(uint64_t *)plVar1 & 0xfffffffffffffff0;
          plVar1 = &((pAVar11->value).asn1_string)->flags;
          *(uint64_t *)plVar1 = *(uint64_t *)plVar1 | 8;
        }
        goto LAB_00f660ea;
      }
      if (uVar2 == 3) {
...
LAB_00f660ea:
    ...
    case 0x1e:
      if (uVar2 == 1) {
        str = (uint *)((int64_t)&dylib_command_00000ff0.dylib.current_version + 1);
      }
      else {
        if (uVar2 != 2) {
          pcVar16 = "crypto/asn1/asn1_gen.c";
...
LAB_00f66422:
  pSVar8 = (STACK *)((int64_t)&section_000001a8.addr + 2);
...
LAB_00f6669d:
    line = (size_t)ptag;
    a = (ASN1_TYPE **)(uint64_t)local_90;
    local_68 = CONCAT44(local_68._4_4_,iVar5);
    if (0 < (int)local_90) {
      ppcVar17 = local_278 + (int64_t)a * 3;
      iVar5 = 0;
      do {
        a = (ASN1_TYPE **)(int64_t)*(int *)((int64_t)ppcVar17 + -4);
        *ppcVar17 = (char *)((int64_t)iVar4 + (int64_t)a);
        iVar4 = _ASN1_object_size(*(int *)((int64_t)ppcVar17 + -4),*(int *)(ppcVar17 + -2),
                                  (int)ptag);
        line = (size_t)ptag;
        iVar5 = iVar5 + 1;
        ppcVar17 = ppcVar17 + -3;
    ...
    if (puVar14 != (void*)0x0) {
      if (0 < (int)local_90) {
        ...
        do {
          line = piVar19[-3];
          _ASN1_put_object((uchar **)(uint64_t)(uint)piVar19[-4],*piVar19,line,inform,
                           in_stack_fffffffffffffd98);
          if (piVar19[-1] != 0) {
            *local_40 = 0;
            local_40 = local_40 + 1;
      ...
      _memcpy(a,(void *)(int64_t)(int)local_68,line);
      local_84._4_8_ = puVar14;
      pAVar11 = _d2i_ASN1_TYPE(a,(uchar **)(int64_t)iVar4,line);
      goto LAB_00f667d4;
    }
  }
  else {
    ptag = (ASN1_STRING *)(int64_t)iVar5;
