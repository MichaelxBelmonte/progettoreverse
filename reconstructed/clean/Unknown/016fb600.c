...
void FUN_016fb600(uint64_t param_1,uint64_t param_2,uint64_t param_3,uint64_t param_4)

{
  ...
  if (*(int *)(local_48 + 0xc) < 1) {
    local_64 = (uint32_t)CONCAT71(uVar11,1);
  }
  else {
    local_64 = (uint32_t)CONCAT71(uVar11,1);
    lVar15 = 0;
    do {
      uVar10 = *(uint64_t *)(*(int64_t *)(local_48 + 0x10) + lVar15 * 8);
      uVar13 = local_48;
      if (uVar10 != 0) {
        FUN_00d50b00();
      }
      ...
      if (cVar4 != '\0') {
        if (**(uint64_t **)(*(int64_t *)(this_ptr + 0x60) + 0x10) == uVar10) {
        ...
        if ((local_70._4_4_ != 0) && (local_40 >> 0x20 != 0)) {
          ...
          if (cVar4 != '\0') {
            ...
            uVar17 = uVar10;
            uVar6 = FUN_016f51d0();
            while (pVar12 = (void*)uVar13, uVar6 >> 0x20 != 0) {
              uVar16 = FUN_00e7bdb0();
...
LAB_016fb859:
  ...
  if ((cVar4 == '\0') && (*(int *)(local_48 + 0xc) != 0)) {
    ...
    *(void*)(puVar8 + 2) = uVar16;
    *(void*)((int64_t)puVar8 + 0x14) = uVar1;
    *(void*)(puVar8 + 3) = uVar2;
    FUN_00d500e0();
    uVar9 = FUN_00e7bdb0();
    *(void*)((int64_t)puVar8 + 0x14) = uVar9;
    *(void*)((int64_t)puVar8 + 0xc) = uVar9;
    pvVar7 = _pthread_getspecific(pVar12);
    if (pvVar7 != (void *)0x0) {
      FUN_00e8b990();
    }
    ...
    *(uint64_t *)((int64_t)puVar8 + 0xc) = uVar10;
    uVar16 = FUN_00d23340();
    uVar10 = local_40;
    pVar12 = (void*)CONCAT71((int7)(uVar13 >> 8),local_38[0]);
    ...
    *(uint64_t *)((int64_t)puVar8 + 0x14) = uVar10;
    local_d0 = 0;
    local_c8 = 0;
    local_c0 = 0;
    pVar12 = 0;
