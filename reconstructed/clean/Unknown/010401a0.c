...
uint64_t FUN_010401a0(char *param_1,byte *param_2,uint64_t param_3,char *param_4)
      ...
      if (iVar5 != 0) {
        ...
        if (iVar5 == 0) {
          ...
          while( true ) {
            ...
            if ((CARRY8((uint64_t)(bVar9 - 0x30),uVar7)) || (SUB168(auVar1 * ZEXT816(10),8) != 0))
            break;
            bVar9 = *param_2;
            if (bVar9 == 0) {
              if (uVar8 < 2) {
              ...
              if ((byte)(((uVar7 >> 4) + uVar7 & 0xf0f0f0f0f0f0f0f) * 0x101010101010101 >> 0x38) < 2
                ...
                *(uint64_t *)(*(int64_t *)(this_ptr + 0x28) + 0x20) = uVar8;
                return 1;
              }
              return 0;
            }
          ...
          if (iVar5 == 0) {
            ...
            while (param_2 = param_2 + 1, (byte)(bVar9 - 0x30) < 10) {
              ...
              uVar8 = (bVar9 - 0x30) + uVar7;
              if ((CARRY8((uint64_t)(bVar9 - 0x30),uVar7)) || (SUB168(auVar2 * ZEXT816(10),8) != 0)
                 ) break;
              bVar9 = *param_2;
              if (bVar9 == 0) {
                if (uVar8 == 0) {
                ...
                *(uint64_t *)(*(int64_t *)(this_ptr + 0x28) + 0x28) = uVar8;
                return 1;
              }
            }
          }
            ...
            if (iVar5 == 0) {
              ...
              while (param_2 = param_2 + 1, (byte)(bVar9 - 0x30) < 10) {
                ...
                uVar8 = (bVar9 - 0x30) + uVar7;
                if ((CARRY8((uint64_t)(bVar9 - 0x30),uVar7)) ||
                ...
                if (bVar9 == 0) {
                  ...
                  *(uint64_t *)(*(int64_t *)(this_ptr + 0x28) + 0x30) = uVar8;
                  return 1;
                }
              }
            }
              ...
              while (param_2 = param_2 + 1, (byte)(bVar9 - 0x30) < 10) {
                ...
                if (bVar9 == 0) {
                  ...
                  *(uint64_t *)(*(int64_t *)(this_ptr + 0x28) + 0x38) = uVar8;
                  return 1;
                }
              }
            }
