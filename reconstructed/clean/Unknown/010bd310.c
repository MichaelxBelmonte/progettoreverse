...
uint64_t FUN_010bd310(uint param_1,uint64_t param_2,uint64_t param_3,char *param_4)

{
  ...
  format = (ASN1_STRING *)(uint64_t)param_1;
...
LAB_010bd3bb:
    ...
    uVar11 = 0;
    do {
      plVar5 = (int64_t *)_OPENSSL_sk_value();
      uVar11 = uVar11 + 1;
      iVar3 = _BIO_printf((BIO *)"",(char *)format,(uint64_t)uVar11);
      uVar7 = 0xffffffff;
      if (iVar3 < 1) break;
      if (*plVar5 != 0) {
          ...
          if (plVar5[2] != 0) {
            ...
            if (0 < iVar3) {
              ...
              do {
                ...
                _OBJ_obj2txt((char *)((int64_t)&MACH_HEADER.magic + 1),iVar4,(ASN1_OBJECT *)pcVar8,
                             no_name);
                pcVar9 = "";
                pcVar8 = (char *)pAVar6;
    ...
    if (0 < iVar3) {
      pcVar8 = "";
      gen = (GENERAL_NAME *)(uint64_t)param_1;
