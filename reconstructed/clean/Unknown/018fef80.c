...
int64_t * FUN_018fef80(int *param_1,uint64_t param_2)
...
joined_r0x018ff342:
    ...
    if ((((uVar5 >> 0x20 == 0) || (param_2 >> 0x20 == 0)) || (cVar3 = FUN_00e7c000(), cVar3 == '\0')
      ...
      if ((((iVar7 + 1 == *(int *)(*(int64_t *)(arg1 + 0x38) + 0xc) + -1) &&
      ...
      lVar2 = *(int64_t *)
               (*(int64_t *)(*(int64_t *)(arg1 + 0x38) + 0x10) + (int64_t)(iVar7 + 1) * 8);
      *(void*)(this_ptr + 1) = 0;
    }
    else {
      lVar2 = *(int64_t *)
               (*(int64_t *)(*(int64_t *)(arg1 + 0x38) + 0x10) + (int64_t)iVar7 * 8);
      *(void*)(this_ptr + 1) = 0;
    }
    if (lVar2 != 0) {
      FUN_00d50b00();
