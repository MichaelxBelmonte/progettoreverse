...
int64_t FUN_00efda22(int param_1,int64_t param_2,int param_3,int param_4)

{
  ...
  puVar13 = (void*)((int64_t)this_ptr + arg1 + -2);
  uVar10 = param_3 - 5;
  param_3 = param_3 + 1;
  iVar6 = 4;
  bVar18 = false;
...
LAB_00efdc24:
        ...
        *puVar14 = (short)uVar10;
        ...
        return (int64_t)puVar14 + ((int64_t)(iVar9 + 7 >> 3) - (int64_t)this_ptr);
      }
    ...
    uVar11 = (int)uVar16 + 1;
    uVar8 = uVar7;
    if ((uVar15 <= uVar11) || (uVar16 = (uint64_t)uVar11, (int)uVar7 < 2)) goto LAB_00efdc24;
  } while( true );
}
