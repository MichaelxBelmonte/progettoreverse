...

{
  ...
  iVar44 = (**(code **)(*arg1 + 0x30))(0x17,8);
  iVar45 = (**(code **)(*arg1 + 0x90))();
  ...
  for (plVar52 = *(int64_t **)(this_ptr + 0xa8); plVar52 != *(int64_t **)(this_ptr + 0xb0);
      plVar52 = plVar52 + 4) {
  ...
  *(int *)((int64_t)arg1 + 0x1c) = *(int *)((int64_t)arg1 + 0x1c) + -1;
  return iVar1 + iVar51 + iVar2 + iVar3 + iVar4;
}
