...
uint FUN_017916d0(int64_t *param_1,int param_2,int64_t *param_3)

{
  ...
  if (((~uVar6 & 0xf0000) != 0) &&
     ((*(uint64_t *)(*this_ptr + 0x18) & 0xf00000000) != 0xf00000000)) {
    uVar6 = FUN_01715480();
    if (0xb < uVar6) {
      return 0;
    }
    ...
    if ((uVar6 & 0xf000000) != 0xf000000) {
      ...
      if (lVar1 == local_40) {
        if (bVar16) {
          local_50 = '\x01';
          cVar11 = '\x01';
          if (((char)this_ptr[1] == '\0') && (cVar11 = local_50, local_40 != 0)) {
            FUN_00d50b00();
            *(void*)(this_ptr + 1) = 1;
            cVar11 = '\x01';
          }
...
LAB_01791da3:
  ...
  case 10:
    ...
    bVar15 = (~*(uint64_t *)(*this_ptr + 0x18) & 0xf0000000000) != 0;
...
LAB_01791e9a:
  ...
  if (((param_1 != (int64_t *)0x0) && (bVar4 == 1 && *param_1 == 0)) &&
     (lVar1 = *arg1, lVar1 != *param_1)) {
    lVar2 = arg1[1];
    if (((char)lVar2 != '\0') && (lVar1 != 0)) {
      FUN_00d50b00();
    }
  ...
  if (((local_80 == 1 && bVar13 == 0) &&
      (uVar14 = uVar6, (~*(uint64_t *)(*this_ptr + 0x18) & 0xf0000000000) != 0)) &&
     (((uint)*(uint64_t *)(*this_ptr + 0x18) & 0xf0000) != 0xf0000)) {
    if (local_40 == 0) {
      iVar7 = FUN_01715480();
    }
    else {
    ...
    if ((~(uint)(*(uint64_t *)(*arg1 + 0x18) >> (cVar11 * '\x04' & 0x3fU)) & 0xf) != 0) {
      uVar14 = uVar12;
    }
    if (uVar14 == 5) {
      cVar11 = cVar11 + '\x06';
    ...
    if ((param_1 != (int64_t *)0x0) &&
       (uVar6 = (uint)(*(uint64_t *)(*arg1 + 0x18) >> ((byte)(iVar7 << 2) & 0x3f)),
       (~uVar6 & 0xf) != 0)) {
      uVar6 = uVar6 & 0xf;
      uVar12 = 0xffffffff;
      if (uVar6 != 0xf) {
