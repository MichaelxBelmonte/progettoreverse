...
uint FUN_01073d20(uint *param_1,uint param_2,uint64_t param_3,char *param_4)
  ...
  if (unaff_ESI - 0x1001U < 0xd) {
    ...
    case 0x1001:
      if (param_2 - 1 < 6) {
        ...
        if (param_2 == 6) {
          bVar2 = *(byte *)(this_ptr + 4) & 0x18;
        }
        else {
          if (*(int *)*this_ptr == 0x390) goto LAB_01074154;
          if (param_2 != 4) goto LAB_010741ae;
          bVar2 = *(byte *)((int64_t)this_ptr + 0x21) & 3;
        }
        if (bVar2 != 0) {
          if (*(int64_t *)(puVar1 + 8) == 0) {
            pEVar6 = _EVP_sha1();
        ...
        if (-4 < (int)param_2) {
          ...
          if (param_2 == 0xffffffff) {
            ...
            if (param_2 == 0xfffffffe) {
              if (*(int *)(this_ptr + 4) != 0x10) goto LAB_010741ef;
              iVar3 = 0x92;
              iVar4 = 0x1c1;
              break;
            }
...
LAB_0107407e:
    ...
    case 0x1008:
      if ((puVar1[7] | 2) == 6) {
        ...
        if (*(int64_t *)(puVar1 + 10) != 0) {
          *(int64_t *)param_1 = *(int64_t *)(puVar1 + 10);
          return 1;
        }
switchD_01073d9a_caseD_d:
        *(int64_t *)param_1 = *(int64_t *)(puVar1 + 8);
        return 1;
      }
      iVar3 = 0x9c;
      iVar4 = 0x208;
...
LAB_01074012:
    ...
    case 0x100a:
      if (puVar1[7] == 4) {
        ...
        if ((param_1 != (uint *)0x0) && (0 < (int)param_2)) {
          ...
          *(uint64_t *)(puVar1 + 0x12) = (uint64_t)param_2;
          return 1;
        }
        puVar1[0x10] = 0;
        puVar1[0x11] = 0;
    ...
    case 0x100c:
      if (puVar1[7] == 4) {
        *(int64_t *)param_1 = *(int64_t *)(puVar1 + 0x10);
        return puVar1[0x12];
      }
      iVar3 = 0x8d;
      iVar4 = 0x22c;
...
LAB_01074170:
    ...
    pEVar6 = (EVP_MD *)
             ((int64_t)&switchD_01073d9a::switchdataD_010741f8 +
             (int64_t)(int)(&switchD_01073d9a::switchdataD_010741f8)[unaff_ESI - 1U]);
    switch(unaff_ESI) {
    case 1:
      iVar3 = FUN_01074770();
      if (iVar3 == 0) {
