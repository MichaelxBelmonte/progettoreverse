...

{
  ...
  local_58 = (uint)*(void*)this_ptr;
  uStack_54 = (uint)((uint64_t)*(void*)this_ptr >> 0x20);
  local_9c[9] = (uint)*(void*)arg1;
  uStack_74 = (uint)((uint64_t)*(void*)arg1 >> 0x20);
  uStack_50 = (uint)*(void*)(this_ptr + 2);
  uStack_70 = (uint)*(void*)(arg1 + 2);
  uStack_4c = (uint)((uint64_t)*(void*)(this_ptr + 2) >> 0x20);
  uStack_6c = (uint)((uint64_t)*(void*)(arg1 + 2) >> 0x20);
  local_48 = (uint)*(void*)(this_ptr + 4);
  uStack_44 = (uint)((uint64_t)*(void*)(this_ptr + 4) >> 0x20);
  local_a0 = uStack_44;
  uStack_40 = (uint)*(void*)(this_ptr + 6);
  uStack_3c = (uint)((uint64_t)*(void*)(this_ptr + 6) >> 0x20);
  ...
  while( true ) {
    ...
    uVar1 = uVar6 + this_ptr[local_d0 + -1];
    uVar8 = *(uint *)(&g_023be3d0 + (uint64_t)(uVar1 & 0xff) * 4) ^ this_ptr[local_d0] ^
            *(uint *)(&g_023be7d0 + (uint64_t)(uVar1 >> 8 & 0xff) * 4) ^
            *(uint *)(&g_023bebd0 + (uint64_t)(uVar1 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&g_023befd0 + (uint64_t)(uVar1 >> 0x18) * 4);
    uVar1 = uVar12 + uVar8;
    uVar10 = (uVar23 & 0xff0000) << 8 |
             uVar19 & 0xff0000 | uVar16 >> 8 & 0xff00 | uVar24 >> 0x10 & 0xff;
    uVar14 = this_ptr[local_d0 + -1] ^ *(uint *)(&g_023be3d0 + (uint64_t)(uVar1 & 0xff) * 4) ^
             *(uint *)(&g_023be7d0 + (uint64_t)(uVar1 >> 8 & 0xff) * 4) ^
             *(uint *)(&g_023bebd0 + (uint64_t)(uVar1 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&g_023befd0 + (uint64_t)(uVar1 >> 0x18) * 4);
    uVar1 = uVar13 + uVar14;
    uVar8 = uVar8 ^ *(uint *)(&g_023be3d0 + (uint64_t)(uVar1 & 0xff) * 4) ^
            *(uint *)(&g_023be7d0 + (uint64_t)(uVar1 >> 8 & 0xff) * 4) ^
            *(uint *)(&g_023bebd0 + (uint64_t)(uVar1 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&g_023befd0 + (uint64_t)(uVar1 >> 0x18) * 4);
    uVar1 = uVar15 + uVar8;
    uVar14 = uVar14 ^ *(uint *)(&g_023be3d0 + (uint64_t)(uVar1 & 0xff) * 4) ^
             *(uint *)(&g_023be7d0 + (uint64_t)(uVar1 >> 8 & 0xff) * 4) ^
             *(uint *)(&g_023bebd0 + (uint64_t)(uVar1 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&g_023befd0 + (uint64_t)(uVar1 >> 0x18) * 4);
    uVar1 = uVar7 + uVar14;
    ...
    uVar8 = uVar8 ^ *(uint *)(&g_023be3d0 + (uint64_t)(uVar1 & 0xff) * 4) ^
            ...
            *(uint *)(&g_023befd0 + (uint64_t)(uVar1 >> 0x18) * 4);
    uVar1 = uVar8 + uVar16;
    uVar1 = uVar14 ^ *(uint *)(&g_023be3d0 + (uint64_t)(uVar1 & 0xff) * 4) ^
            *(uint *)(&g_023be7d0 + (uint64_t)(uVar1 >> 8 & 0xff) * 4) ^
            *(uint *)(&g_023bebd0 + (uint64_t)(uVar1 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&g_023befd0 + (uint64_t)(uVar1 >> 0x18) * 4);
    uVar16 = uVar16 + uVar1;
    uVar14 = uVar8 ^ *(uint *)(&g_023be3d0 + (uint64_t)(uVar16 & 0xff) * 4) ^
             *(uint *)(&g_023be7d0 + (uint64_t)(uVar16 >> 8 & 0xff) * 4) ^
             *(uint *)(&g_023bebd0 + (uint64_t)(uVar16 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&g_023befd0 + (uint64_t)(uVar16 >> 0x18) * 4);
    uVar10 = uVar10 + uVar14;
    uVar1 = uVar1 ^ *(uint *)(&g_023be3d0 + (uint64_t)(uVar10 & 0xff) * 4) ^
            *(uint *)(&g_023be7d0 + (uint64_t)(uVar10 >> 8 & 0xff) * 4) ^
            *(uint *)(&g_023bebd0 + (uint64_t)(uVar10 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&g_023befd0 + (uint64_t)(uVar10 >> 0x18) * 4);
    uVar9 = uVar9 + uVar1;
    uVar9 = uVar14 ^ *(uint *)(&g_023be3d0 + (uint64_t)(uVar9 & 0xff) * 4) ^
            *(uint *)(&g_023be7d0 + (uint64_t)(uVar9 >> 8 & 0xff) * 4) ^
            *(uint *)(&g_023bebd0 + (uint64_t)(uVar9 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&g_023befd0 + (uint64_t)(uVar9 >> 0x18) * 4);
    uVar7 = uVar7 + uVar9;
    uVar1 = uVar1 ^ *(uint *)(&g_023be3d0 + (uint64_t)(uVar7 & 0xff) * 4) ^
            *(uint *)(&g_023be7d0 + (uint64_t)(uVar7 >> 8 & 0xff) * 4) ^
            *(uint *)(&g_023bebd0 + (uint64_t)(uVar7 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&g_023befd0 + (uint64_t)(uVar7 >> 0x18) * 4);
    uVar15 = uVar15 + uVar1;
    uVar7 = uVar9 ^ *(uint *)(&g_023be3d0 + (uint64_t)(uVar15 & 0xff) * 4) ^
            *(uint *)(&g_023be7d0 + (uint64_t)(uVar15 >> 8 & 0xff) * 4) ^
            *(uint *)(&g_023bebd0 + (uint64_t)(uVar15 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&g_023befd0 + (uint64_t)(uVar15 >> 0x18) * 4);
    uVar13 = uVar13 + uVar7;
    uVar14 = uVar1 ^ *(uint *)(&g_023be3d0 + (uint64_t)(uVar13 & 0xff) * 4) ^
             *(uint *)(&g_023be7d0 + (uint64_t)(uVar13 >> 8 & 0xff) * 4) ^
             *(uint *)(&g_023bebd0 + (uint64_t)(uVar13 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&g_023befd0 + (uint64_t)(uVar13 >> 0x18) * 4);
    uVar12 = uVar12 + uVar14;
    uVar8 = uVar7 ^ *(uint *)(&g_023be3d0 + (uint64_t)(uVar12 & 0xff) * 4) ^
            *(uint *)(&g_023be7d0 + (uint64_t)(uVar12 >> 8 & 0xff) * 4) ^
            *(uint *)(&g_023bebd0 + (uint64_t)(uVar12 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&g_023befd0 + (uint64_t)(uVar12 >> 0x18) * 4);
    uVar6 = uVar6 + uVar8;
    uVar1 = *(uint *)(&g_023be3d0 + (uint64_t)(uVar6 & 0xff) * 4);
    uVar7 = *(uint *)(&g_023be7d0 + (uint64_t)(uVar6 >> 8 & 0xff) * 4);
    uVar9 = *(uint *)(&g_023bebd0 + (uint64_t)(uVar6 >> 0x10 & 0xff) * 4);
    uVar6 = *(uint *)(&g_023befd0 + (uint64_t)(uVar6 >> 0x18) * 4);
  ...
  uVar2 = *arg1 ^ local_9c[7];
  uVar3 = arg1[1] ^ local_9c[8];
  ...
  uVar10 = uVar6 ^ local_9c[1] & 0xffff ^ uVar23 ^ uVar16 ^ uVar8 ^
           uVar5 ^ local_9c[8] & 0xffff0000 ^ arg1[2];
  ...
  uVar27 = uVar26 ^ uVar21 ^
           ...
           local_9c[1] >> 0x10 ^ uVar13 ^ uVar1 ^ uVar25 ^ arg1[4] ^ uVar7;
  uVar1 = local_9c[6] << 0x10;
  uVar9 = uVar27 ^ uVar24;
  uVar22 = uVar21 ^ uVar7 ^ uVar15 ^
           local_9c[3] ^ uVar23 ^ uVar14 ^ uVar26 ^
           local_9c[1] & 0xffff0000 ^ uVar6 ^ (uint)local_d0 ^ uVar11 ^ uVar25 ^ arg1[5] ^
           uVar1;
  uVar6 = uVar22 ^ uVar24;
  ...
  uVar5 = uVar1 ^ uVar15 ^ local_9c[6] >> 0x10 ^
          ...
          uVar13 ^ uVar23 ^ (local_9c[8] & 0xffff ^ local_9c[7] >> 0x10 | uVar11) ^ arg1[7];
  _uStack_40 = CONCAT44(uVar24 ^ uVar5,uVar7);
  uVar1 = *this_ptr ^ uVar3 << 0x10;
  uVar8 = uVar2 >> 0x10 ^ uVar1;
  uVar14 = uVar19 << 0x10 ^ this_ptr[1];
  uVar11 = uVar3 >> 0x10 ^ uVar14;
  stack0xffffffffffffff88 = CONCAT44(uVar11,uVar8);
  uVar13 = uVar4 << 0x10 ^ this_ptr[2];
  uVar10 = uVar10 >> 0x10 ^ uVar13;
  uVar18 = uVar9 << 0x10 ^ this_ptr[3];
  uVar25 = uVar12 >> 0x10 ^ uVar18;
  _uStack_70 = CONCAT44(uVar25,uVar10);
  uVar19 = uVar6 << 0x10 ^ this_ptr[4];
  local_68 = uVar27 >> 0x10 ^ uVar19;
  uVar16 = uVar16 << 0x10;
  uVar23 = this_ptr[5] ^ uVar16;
  uStack_64 = uVar22 >> 0x10 ^ uVar23;
  uVar4 = (uVar24 ^ uVar5) << 0x10 ^ this_ptr[6];
  uStack_60 = uVar7 >> 0x10 ^ uVar4;
  uVar12 = (uVar5 >> 0x10 | uVar2 << 0x10 ^ uVar2 & 0xffff0000) ^ this_ptr[7];
