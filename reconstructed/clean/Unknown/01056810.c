...
int FUN_01056810(BIO *param_1,PKCS8_PRIV_KEY_INFO *param_2,int64_t param_3,EVP_CIPHER *param_4)
  ...
  if (pBVar4 == (BIO *)0x0) {
    ...
    if (param_4 == (EVP_CIPHER *)0x0) {
      ...
      if ((int)pbe_nid < 1) {
        ...
        _ERR_put_error(0x2019887,0x6f,0x53,(char *)pEVar6,(int)this_ptr);
        _PKCS8_PRIV_KEY_INFO_free((PKCS8_PRIV_KEY_INFO *)a);
        goto LAB_01056a5f;
      }
      pBVar5 = (BIO *)(uint64_t)pbe_nid;
      pEVar6 = (EVP_CIPHER *)&stack0xfffffffffffffbc8;
      pBVar4 = (BIO *)_PKCS8_encrypt(pbe_nid,pEVar6,(char *)0x0,0,this_ptr,
...
LAB_0105694b:
      ...
      pBVar5 = (BIO *)(uint64_t)local_res8;
      pEVar6 = param_4;
      pBVar4 = (BIO *)_PKCS8_encrypt(local_res8,param_4,(char *)0x0,0,this_ptr,
                                     in_stack_fffffffffffffbc0,in_stack_fffffffffffffbc8,
                                     in_stack_fffffffffffffbd0);
    ...
    if (pBVar4 != (BIO *)0x0) {
      if (iVar3 == 0) {
        iVar3 = _PEM_ASN1_write_bio(pBVar4,this_ptr,0,0);
      }
      else {
