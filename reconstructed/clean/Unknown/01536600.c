...

{
  ...
  if (0 < (int)param_2) {
    ...
    uVar2 = 0;
    do {
      fVar8 = *(float *)(arg1 + (int64_t)pvVar5 * 4);
...
LAB_015367aa:
    ...
    } while (pvVar5 != (void *)(uint64_t)param_2);
    param_1 = (void *)(uint64_t)param_2;
    if (0 < (int)uVar2) {
      param_1 = (void *)(uint64_t)(uVar2 & 3);
      ...
      if (param_1 != (void *)0x0) {
        pvVar5 = (void *)0x0;
        do {
          fVar10 = fVar10 + *(float *)(auStack_54 + (int64_t)pvVar5 * 4 + uVar6 * 4 + -4);
          fVar8 = fVar8 + local_78[uVar6 + (int64_t)pvVar5];
          pvVar5 = (void *)((int64_t)pvVar5 + 1);
        } while (param_1 != pvVar5);
      }
      auVar9._4_12_ = _auStack_54;
      auVar9._0_4_ = local_58;
      auVar9 = insertps(auVar9,ZEXT416((uint)(fVar10 * (g_02390124 / (float)(int)uVar2))),0x10);
      local_1a8 = auVar9._0_8_;
      auVar9 = insertps(ZEXT416((uint)((g_02390124 / (float)(int)uVar2) * fVar8)),local_78[0],0x10
                       );
...
LAB_015368cd:
  ...
  pcVar1 = g_025ddb40;
  pfVar7 = local_154;
  local_16c = g_02390d04;
  fVar8 = g_02390d00;
  while( true ) {
    fVar10 = (float)((uint64_t)*(void*)(pfVar7 + -2) >> 0x20) * local_1b8._4_4_ +
             (float)((uint64_t)*(void*)(pfVar7 + -4) >> 0x20) * local_1a8._4_4_ +
             (float)*(void*)(pfVar7 + -4) * (float)local_1a8 +
             (float)*(void*)(pfVar7 + -2) * (float)local_1b8;
    if (fVar8 * g_0240ed30 < fVar10) {
