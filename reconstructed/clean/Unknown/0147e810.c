...
LAB_0147ea5e:
          ...
          if (0 < *(int *)(lVar16 + 0xc)) {
            lVar10 = 0;
            do {
              lVar11 = *(int64_t *)(*(int64_t *)(lVar16 + 0x10) + lVar10 * 8);
              if (lVar17 == lVar11) {
                if ((!bVar6) && (lVar17 != 0)) {
                  bVar6 = true;
                  FUN_00d50b00();
              ...
              lVar11 = (int64_t)((int)*(float *)(lVar17 + 0x18) % 100);
              *(float *)((int64_t)puVar8 + lVar11 * 4) =
                   *(float *)(lVar17 + 0x1c) + *(float *)((int64_t)puVar8 + lVar11 * 4);
              lVar10 = lVar10 + 1;
    ...
    *(void*)(puVar8 + 0x74) = *(void*)(puVar8 + 0x10);
    *(void*)((int64_t)puVar8 + 0x3a4) = *(void*)((int64_t)puVar8 + 0x84);
    *(void*)(puVar8 + 0x75) = *(void*)(puVar8 + 0x11);
    *(void*)((int64_t)puVar8 + 0x3ac) = *(void*)((int64_t)puVar8 + 0x8c);
    *(void*)(puVar8 + 0x42) = *(void*)(puVar8 + 0x10);
    *(void*)((int64_t)puVar8 + 0x214) = *(void*)((int64_t)puVar8 + 0x84);
    *(void*)(puVar8 + 0x43) = *(void*)(puVar8 + 0x11);
    *(void*)((int64_t)puVar8 + 0x21c) = *(void*)((int64_t)puVar8 + 0x8c);
    *(void*)(puVar8 + 0x76) = *(void*)(puVar8 + 0x12);
    *(void*)((int64_t)puVar8 + 0x3b4) = *(void*)((int64_t)puVar8 + 0x94);
    *(void*)(puVar8 + 0x77) = *(void*)(puVar8 + 0x13);
    *(void*)((int64_t)puVar8 + 0x3bc) = *(void*)((int64_t)puVar8 + 0x9c);
    *(void*)(puVar8 + 0x44) = *(void*)(puVar8 + 0x12);
    *(void*)((int64_t)puVar8 + 0x224) = *(void*)((int64_t)puVar8 + 0x94);
    *(void*)(puVar8 + 0x45) = *(void*)(puVar8 + 0x13);
    *(void*)((int64_t)puVar8 + 0x22c) = *(void*)((int64_t)puVar8 + 0x9c);
    *(void*)(puVar8 + 0x78) = *(void*)(puVar8 + 0x14);
    *(void*)((int64_t)puVar8 + 0x3c4) = *(void*)((int64_t)puVar8 + 0xa4);
    *(void*)(puVar8 + 0x79) = *(void*)(puVar8 + 0x15);
    *(void*)((int64_t)puVar8 + 0x3cc) = *(void*)((int64_t)puVar8 + 0xac);
    *(void*)(puVar8 + 0x46) = *(void*)(puVar8 + 0x14);
    *(void*)((int64_t)puVar8 + 0x234) = *(void*)((int64_t)puVar8 + 0xa4);
    *(void*)(puVar8 + 0x47) = *(void*)(puVar8 + 0x15);
    *(void*)((int64_t)puVar8 + 0x23c) = *(void*)((int64_t)puVar8 + 0xac);
    ...
    lVar10 = 100;
    do {
      fVar19 = *(float *)((int64_t)puVar8 + lVar10 * 4);
      iVar1 = (int)lVar10;
      if (fVar18 < fVar19) {
        iVar15 = iVar1;
      }
      fVar20 = *(float *)((int64_t)puVar8 + lVar10 * 4 + 4);
      if (fVar19 <= fVar18) {
        fVar19 = fVar18;
      }
      iVar2 = iVar1 + 1;
      ...
      fVar18 = *(float *)((int64_t)puVar8 + lVar10 * 4 + 8);
      iVar15 = iVar1 + 2;
      if (fVar18 <= fVar20) {
        fVar18 = fVar20;
        iVar15 = iVar2;
      }
      fVar19 = *(float *)((int64_t)puVar8 + lVar10 * 4 + 0xc);
      iVar2 = iVar1 + 3;
      if (fVar19 <= fVar18) {
        fVar19 = fVar18;
        iVar2 = iVar15;
      }
      fVar18 = *(float *)((int64_t)puVar8 + lVar10 * 4 + 0x10);
      iVar15 = iVar1 + 4;
      if (fVar18 <= fVar19) {
        fVar18 = fVar19;
        iVar15 = iVar2;
