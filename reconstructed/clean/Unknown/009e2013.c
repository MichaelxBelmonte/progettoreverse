...
char * FUN_009e2013(char *param_1,int64_t param_2,char param_3)

{
    ...
    do {
      ...
      if (*pcVar8 == '\0') {
        ...
        while( true ) {
          cVar4 = *pcVar9;
          if (param_3 != '\0') {
            lVar7 = **(int64_t **)(*plVar3 + 8);
            cVar4 = (**(code **)(lVar7 + 0x28))();
            pcVar6 = (char *)CONCAT71((int7)((uint64_t)lVar7 >> 8),*pcVar8);
          }
          if (cVar4 != (char)pcVar6) break;
          pcVar1 = pcVar8 + 1;
          pcVar6 = (char *)CONCAT71((int7)((uint64_t)pcVar6 >> 8),*pcVar1);
          pcVar8 = pcVar8 + 1;
          bVar11 = arg1 + -1 == pcVar9;
          pcVar9 = pcVar9 + 1;
  ...
  cVar4 = *this_ptr;
  if (param_3 != '\0') {
    cVar4 = (**(code **)(**(int64_t **)(*plVar3 + 8) + 0x28))();
  }
