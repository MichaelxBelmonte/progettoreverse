...
void FUN_009c95f6(id *param_1,byte *param_2,uint32_t param_3,char param_4)

{
  ...
  if (param_4 == '\0') {
    if ((char)param_1 != '\0') {
      std::ios_base::getloc();
      plVar1 = (int64_t *)std::locale::use_facet(param_1);
      param_1 = (id *)*plVar1;
      (**(code **)(param_1 + 0x38))();
    ...
    if ((*local_78 & 1) == 0) {
      uVar6 = (uint64_t)(*local_78 >> 1);
    }
    else {
      uVar6 = *(uint64_t *)(local_78 + 8);
    }
    ...
    FUN_009c8de4();
    FUN_009c8de4();
    uVar6 = (uint64_t)local_90[0];
    param_1 = (id *)0x0;
    psVar10 = local_88;
    piVar8 = local_80;
    if ((local_90[0] & 1) == 0) {
      psVar10 = (string *)(uint64_t)(local_90[0] >> 1);
      piVar8 = (id *)((uint64_t)local_90 | 1);
    }
    piVar3 = local_a0;
    uVar5 = local_a8;
    if ((local_b0[0] & 1) == 0) {
      piVar3 = (id *)((uint64_t)local_b0 | 1);
      uVar5 = (uint64_t)(local_b0[0] >> 1);
    }
    psVar11 = (string *)0x0;
...
LAB_009c9860:
      ...
      psVar11 = (string *)0x0;
      if ((piVar9 != (id *)(psVar10 + (int64_t)piVar8)) &&
         (psVar10 = (string *)(piVar9 + -(int64_t)piVar8), psVar10 != (string *)0xffffffffffffffff)
         ) {
        param_1 = local_48;
        psVar11 = (string *)0x0;
LAB_009c98c0:
        if (psVar11 == (string *)0x0) {
          ...
          FUN_009ad920();
          std::ios_base::getloc();
          plVar1 = (int64_t *)std::locale::use_facet((id *)psVar11);
          param_1 = (id *)*plVar1;
          (**(code **)(param_1 + 0x38))();
          std::locale::~locale((locale *)param_1);
          std::ostream::put((char)param_1);
          ...
          FUN_009ad920();
          piVar3 = (id *)(psVar10 + -(int64_t)psVar11);
          std::string::string((string *)piVar3,psVar11,(ulong)local_90,(ulong)piVar8,paVar12);
          FUN_009ad920();
          std::ios_base::getloc();
          plVar1 = (int64_t *)std::locale::use_facet(piVar3);
          param_1 = (id *)*plVar1;
          (**(code **)(param_1 + 0x38))();
          std::locale::~locale((locale *)param_1);
          std::ostream::put((char)param_1);
        ...
        if (psVar11 < psVar10) {
          piVar3 = (id *)((uint64_t)local_90 | 1);
          if ((local_90[0] & 1) != 0) {
            piVar3 = local_80;
          }
          param_1 = (id *)((uint64_t)local_b0 | 1);
          if ((local_b0[0] & 1) != 0) {
            param_1 = local_a0;
          }
          if (uVar5 != 0) {
            piVar9 = piVar3 + (int64_t)psVar11;
            do {
              uVar4 = 0;
              do {
                if (*piVar9 == param_1[uVar4]) {
                  if ((piVar9 == (id *)(psVar10 + (int64_t)piVar3)) ||
                     (psVar10 = (string *)(piVar9 + -(int64_t)piVar3),
              ...
              piVar9 = piVar9 + 1;
            } while (piVar9 != (id *)(psVar10 + (int64_t)piVar3));
LAB_009c9aee:
...
LAB_009c9af8:
    uVar7 = (ulong)piVar8;
    param_1 = (id *)CONCAT71((int7)((uint64_t)param_1 >> 8),1);
...
code_r0x009c986d:
  piVar9 = piVar9 + 1;
  if (piVar9 == (id *)(psVar10 + (int64_t)piVar8)) goto LAB_009c9af8;
  goto LAB_009c985a;
}
