...

{
  ...
  if (g_023908ec <= param_1) {
    fVar21 = (float)_logf(param_1 * g_02394204);
    iVar5 = FUN_01483610(fVar21 * g_02394208);
    iVar6 = FUN_00e7d780(g_02390d30);
    iVar7 = FUN_00e7d780(g_0241c3ec);
    iVar8 = FUN_014832c0();
    fVar21 = (float)_logf(param_1 * g_02390d30 * g_02394204);
    iVar9 = FUN_01483610(fVar21 * g_02394208);
    iVar1 = iVar8 + -1;
    if (iVar9 < iVar8) {
      iVar1 = iVar9;
    }
    ...
    if (0 < *(int *)(lVar10 + 0xc)) {
      lVar13 = 0;
      do {
        lVar10 = *(int64_t *)(*(int64_t *)(lVar10 + 0x10) + lVar13 * 8);
        if (lVar10 != 0) {
          FUN_00d50b00();
        }
        FUN_015f8890();
        ...
        if (((*(int *)(lVar3 + 0xc) == 0) ||
            (iVar8 = *(int *)(**(int64_t **)(lVar3 + 0x10) + 0x10), iVar5 < iVar8)) ||
           (iVar1 < iVar8 + *(int *)(g_02802f00 + 0x18))) {
LAB_01221260:
          FUN_00d50b20();
        }
        else {
...
LAB_01220dc8:
                ...
                if (cVar4 == '\0') {
                  FUN_00d50b00();
                  if (iVar1 < *(int *)(g_02802f00 + 0x18) + *(int *)(lVar14 + 0x10)) {
                    FUN_00d50b20();
                    goto LAB_01220e20;
                  }
                  cVar4 = '\x01';
                  ...
                  do {
                    ...
                    iVar19 = *(int *)(g_02802f00 + lVar15 * 4);
