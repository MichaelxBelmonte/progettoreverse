...
LAB_00f94a10:
  ...
  uVar10 = (uint64_t)(param_2 + 7U >> 3);
  num = param_2 + 7U & 7;
  puVar7 = (uchar *)(uint64_t)num;
  iVar2 = 0x1fe << (sbyte)num;
  uVar6 = 0x27;
  buf = puVar7;
  pbVar4 = _CRYPTO_malloc(num,(char *)((int64_t)&segment_command_00000020.cmdsize + 3),line);
  if (pbVar4 == (byte *)0x0) {
...
LAB_00f94a43:
  ...
  if (iVar9 < 0) {
    ...
    if (iVar9 == 0) {
      ...
      puVar7 = (uchar *)(uint64_t)(byte)((sbyte)num - 1);
      iVar9 = 3;
    }
...
LAB_00f94aee:
  ...
  *pbVar4 = bVar1;
  ...
  pBVar5 = _BN_bin2bn((uchar *)(uint64_t)CONCAT31((int3)((uint)iVar2 >> 8),bVar1),unaff_ESI,param_3
                     );
