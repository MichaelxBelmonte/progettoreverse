...
LAB_00ac7a82:
    ...
    if (param_2 == (int *)0x0) {
      ...
      *(void*)((int64_t)puVar8 + 0x17) = 0x6b6e696c6d79735f;
      puVar8[2] = 0x5f646165723a3a6d;
      puVar8[1] = 0x6574737973656c69;
      *puVar8 = 0x663a3a74736f6f62;
      *(void*)((int64_t)puVar8 + 0x1f) = 0;
      if ((g_02754570 == '\0') && (iVar6 = ___cxa_guard_acquire(), iVar6 != 0)) {
        g_02754568 = 0x8fafd21e25c5e09b;
        g_02754560 = &g_02520080;
        ___cxa_guard_release();
      }
      uVar2 = (**(code **)(g_02754560 + 0x30))();
      uVar11 = FUN_00ac4640((uint64_t)CONCAT14(uVar2,iVar5));
    ...
    *param_2 = iVar5;
    ...
    if (CONCAT44(extraout_var,sVar4) < 0x400) {
      ...
      if (param_2 != (int *)0x0) {
        *param_2 = 0;
        *(void*)(param_2 + 1) = 0;
        if ((g_02754570 == '\0') && (iVar5 = ___cxa_guard_acquire(), iVar5 != 0)) {
          g_02754568 = 0x8fafd21e25c5e09b;
          g_02754560 = &g_02520080;
          ___cxa_guard_release();
        }
...
LAB_00ac7675:
    ...
    operator_delete__(param_1);
    operator_new__((ulong)param_1);
    sVar4 = _readlink(param_1,&g_00080000,param_3);
    ...
    operator_delete__(param_1);
    operator_new__((ulong)param_1);
    sVar4 = _readlink(param_1,&g_00200000,param_3);
    ...
    operator_delete__(param_1);
    operator_new__((ulong)param_1);
    sVar4 = _readlink(param_1,&g_01000000,param_3);
