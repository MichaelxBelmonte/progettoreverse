...
void FUN_009a9e88(uint64_t param_1,uint64_t param_2,size_t param_3)
...
LAB_009aa21e:
    ...
    puVar5 = puVar11;
    if (puVar11 != (void*)this_ptr[3]) goto LAB_009aa207;
    ...
    if (puVar14 < puVar9 || lVar4 == 0) {
      ...
      if ((uint64_t)pvVar2 >> 0x3d != 0) goto LAB_009aa21e;
