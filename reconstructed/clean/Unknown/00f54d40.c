...
void FUN_00f54d40(uint8_t (*param_1) [16],int64_t param_2,uint8_t (*param_3) [16],
                 int *param_4)

{
  ...
  uint8_t auVar45 [64];
  int64_t local_res8;
  uint8_t auStack_270 [576];
  
  uVar15 = (uint64_t)auStack_270 & 0xfffffffffffffc00;
  pauVar16 = (uint8_t (*) [32])(uVar15 + 0x1c0);
  lVar23 = local_res8 - this_ptr;
  uVar13 = param_2 * 0x40 + this_ptr;
  *(uint64_t *)(uVar15 + 0x210) = uVar13;
  *(uint8_t (**) [16])(uVar15 + 0x220) = param_3;
  *(int **)(uVar15 + 0x228) = param_4;
  *(int64_t *)(uVar15 + 0x230) = lVar23;
  *(BADSPACEBASE **)(uVar15 + 0x238) = register0x00000020;
  auVar5 = vpinsrq_avx(ZEXT816(0),arg1 - this_ptr,1);
  auVar45 = ZEXT1664(auVar5);
  pauVar1 = param_1 + 8;
  auVar39 = ZEXT1664(*param_3);
  lVar27 = (uint64_t)*(uint *)param_1[0xf] - 9;
  auVar5 = *(uint8_t (*) [16])(&g_00f52b60 + lVar27 * 8);
  auVar2 = *(uint8_t (*) [16])(&g_00f52b70 + lVar27 * 8);
  auVar3 = *(uint8_t (*) [16])(&g_00f52b80 + lVar27 * 8);
  uVar25 = this_ptr + 0x40;
  iVar9 = *param_4;
  uVar14 = param_4[1];
  uVar11 = param_4[2];
  pauVar18 = (uint8_t (*) [32])(lVar23 + uVar25);
  if (uVar25 == uVar13) {
    pauVar18 = (uint8_t (*) [32])(uVar15 + 0x1c0);
  }
  uVar12 = param_4[3];
  uVar20 = param_4[4];
  uVar21 = param_4[5];
  ...
  do {
    auVar28._0_16_ =
         ZEXT116(0) * *(uint8_t (*) [16])*pauVar18 +
         ZEXT116(1) * *(uint8_t (*) [16])(lVar23 + -0x40 + uVar25);
    auVar28._16_16_ =
         ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) +
         ZEXT116(1) * *(uint8_t (*) [16])*pauVar18;
    auVar38._0_16_ =
         ZEXT116(0) * *(uint8_t (*) [16])(*pauVar18 + 0x10) +
         ZEXT116(1) * *(uint8_t (*) [16])(lVar23 + -0x30 + uVar25);
    auVar38._16_16_ =
         ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) +
         ZEXT116(1) * *(uint8_t (*) [16])(*pauVar18 + 0x10);
    auVar32 = vpshufb_avx2(auVar28,g_00f52b40);
    auVar29._0_16_ =
         ZEXT116(0) * *(uint8_t (*) [16])pauVar18[1] +
         ZEXT116(1) * *(uint8_t (*) [16])(lVar23 + -0x20 + uVar25);
    auVar29._16_16_ =
         ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) +
         ZEXT116(1) * *(uint8_t (*) [16])pauVar18[1];
    auVar34 = vpshufb_avx2(auVar38,g_00f52b40);
    auVar30._0_16_ =
         ZEXT116(0) * *(uint8_t (*) [16])(pauVar18[1] + 0x10) +
         ZEXT116(1) * *(uint8_t (*) [16])(lVar23 + -0x10 + uVar25);
    auVar30._16_16_ =
         ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) +
         ZEXT116(1) * *(uint8_t (*) [16])(pauVar18[1] + 0x10);
    auVar35 = vpshufb_avx2(auVar29,g_00f52b40);
    pauVar26 = (uint8_t (*) [16])(uVar25 - 0x40);
    auVar28 = vpaddd_avx2(auVar32,g_00f52940);
    auVar36 = vpshufb_avx2(auVar30,g_00f52b40);
    auVar38 = vpaddd_avx2(auVar34,g_00f52960);
    auVar29 = vpaddd_avx2(auVar35,g_00f52980);
    auVar30 = vpaddd_avx2(auVar36,g_00f529a0);
    *pauVar16 = auVar28;
    uVar8 = 0;
    pauVar16[1] = auVar38;
    *(void*)(pauVar16[-3] + 0x18) = *(void*)(pauVar16[3] + 0x18);
    pauVar16[-2] = auVar29;
    uVar19 = uVar14 ^ uVar11;
    pauVar16[-1] = auVar30;
    pauVar16 = pauVar16 + -2;
    pauVar18 = (uint8_t (*) [32])&g_00f529c0;
    do {
      pauVar17 = pauVar16;
      auVar40 = *pauVar26;
      auVar6 = vpinsrq_avx(auVar45._0_16_,pauVar26,0);
      auVar45 = ZEXT1664(auVar6);
      *(void*)(pauVar17[-3] + 0x18) = *(void*)(pauVar17[-1] + 0x18);
      ...
      pauVar17[-1] = auVar28;
      pauVar16 = pauVar17 + -4;
      *(void*)(pauVar17[-5] + 0x18) = *(void*)(pauVar17[-3] + 0x18);
      ...
      *(uint8_t (*) [16])(lVar27 + auVar6._0_8_) = auVar41;
      pauVar26 = (uint8_t (*) [16])(auVar6._0_8_ + 0x10);
      pauVar7 = pauVar18 + 4;
      pauVar18 = pauVar18 + 4;
    } while ((*pauVar7)[3] != '\0');
    ...
    *(uint8_t (*) [16])(lVar27 + auVar6._0_8_) = auVar40;
    pauVar26 = (uint8_t (*) [16])(auVar6._0_8_ + 0x10);
    ...
    *piVar4 = iVar10;
    ...
    piVar4[6] = uVar22;
    piVar4[7] = uVar24;
    if (pauVar26 == *(uint8_t (**) [16])(pauVar17[0xc] + 0x10)) break;
    uVar8 = 0;
    uVar19 = uVar14 ^ uVar11;
    do {
      auVar6 = vpinsrq_avx(auVar45._0_16_,pauVar26,0);
      ...
      auVar39 = ZEXT1664(auVar40);
      pauVar18 = pauVar18 + -4;
      *(uint8_t (*) [16])(lVar27 + lVar23) = auVar40;
      pauVar26 = (uint8_t (*) [16])(lVar23 + 0x10);
    } while (pauVar16 <= pauVar18);
    piVar4 = *(int **)(pauVar17[0xd] + 8);
    uVar25 = lVar23 + 0x50;
    lVar23 = *(int64_t *)(pauVar17[0xd] + 0x10);
    ...
    uVar22 = uVar22 + piVar4[6];
    uVar24 = uVar24 + piVar4[7];
    uVar13 = *(uint64_t *)(pauVar17[0xc] + 0x10);
    *piVar4 = iVar9;
    pauVar18 = (uint8_t (*) [32])(lVar23 + uVar25);
    if (uVar25 == uVar13) {
      pauVar18 = pauVar16;
  ...
  **(uint8_t (**) [16])pauVar17[0xd] = auVar40;
  return;
}
