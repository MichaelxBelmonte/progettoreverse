...
uint64_t FUN_010596c0(uint64_t param_1,ASN1_STRING *param_2,int param_3)
    ...
    do {
      ...
      case 0x98:
        ...
        if (iVar3 == 0x9e) {
          ...
          if (puVar10 != (uint *)0x0) {
            in = (ASN1_STRING *)(uint64_t)*puVar10;
          ...
          if ((lVar6 != 0) && (uVar5 = _ASN1_STRING_to_UTF8((uchar **)x,in), -1 < (int)uVar5)) {
            iVar3 = _X509_alias_set1((X509 *)x,(uchar *)(uint64_t)uVar5,param_3);
            in = (ASN1_STRING *)((int64_t)&section_000000b8.size + 3);
            _CRYPTO_free(x);
            if (iVar3 == 0) {
LAB_01059918:
              _X509_free((X509 *)x);
