...

{
  ...
  iVar2 = *(int *)(**(int64_t **)(*arg1 + 0x10) + 0x18);
  iVar6 = iVar2 + 3;
  if (-1 < iVar2) {
    iVar6 = iVar2;
  }
  ...
  *puVar8 = &g_025f0d98;
  ...
  if (0 < *(int *)(lVar13 + 0xc)) {
    ...
    fVar17 = g_023d5000;
    if (local_44 / local_5c <= g_023d5000) {
      fVar17 = local_44 / local_5c;
    }
    uVar9 = 2;
    if (2 < iVar6 >> 2) {
      uVar9 = (uint64_t)(uint)(iVar6 >> 2);
    }
    lVar11 = 0;
    local_5c = fVar17;
    do {
      lVar13 = *(int64_t *)(*(int64_t *)(lVar13 + 0x10) + lVar11 * 8);
      if (lVar13 != 0) {
      ...
      if (iVar6 == -1) {
        if ((local_res18 != '\0') && ((int)local_70 < (int)local_44)) {
          uVar12 = (uint64_t)(int)local_70;
          uVar15 = uVar12;
          if (((int)local_44 - (int)local_70 & 1U) != 0) {
            fVar17 = (float)___bzero();
            uVar15 = uVar12 + 1;
          }
          if (~uVar12 + (int64_t)(int)fVar19 != 0) {
            do {
              ___bzero();
              fVar17 = (float)___bzero();
              uVar15 = uVar15 + 2;
            } while ((int64_t)(int)fVar19 != uVar15);
          }
        }
      }
      else if (7 < iVar2) {
        uVar15 = (uint64_t)iVar6;
        local_44 = (float)(iVar7 - iVar6);
        lVar13 = uVar9 - 1;
        if (local_44 == 0.0 || iVar7 < iVar6) {
          do {
            local_80 = uVar15 * 4 + *(int64_t *)(local_58 + 0x10);
          ...
          local_70 = (uint64_t)(iVar7 - iVar6 & 3);
          uVar16 = 1;
          do {
            lVar4 = local_58;
            lVar13 = *(int64_t *)(*arg1 + 0x10);
            lVar3 = *(int64_t *)(local_58 + 0x10);
            uVar10 = uVar15;
            for (uVar14 = local_70; uVar14 != 0; uVar14 = uVar14 - 1) {
              *(void*)(lVar3 + uVar10 * 4) =
                   *(void*)
                    (*(int64_t *)(*(int64_t *)(lVar13 + uVar10 * 8) + 0x10) + uVar16 * 4);
              uVar10 = uVar10 + 1;
            }
            if (2 < ~uVar15 + uVar12) {
              do {
                *(void*)(lVar3 + uVar10 * 4) =
                     *(void*)
                      (*(int64_t *)(*(int64_t *)(lVar13 + uVar10 * 8) + 0x10) + uVar16 * 4);
                *(void*)(lVar3 + 4 + uVar10 * 4) =
                     *(void*)
                      (*(int64_t *)(*(int64_t *)(lVar13 + 8 + uVar10 * 8) + 0x10) + uVar16 * 4);
                *(void*)(lVar3 + 8 + uVar10 * 4) =
                     *(void*)
                      (*(int64_t *)(*(int64_t *)(lVar13 + 0x10 + uVar10 * 8) + 0x10) + uVar16 * 4)
                ;
                *(void*)(lVar3 + 0xc + uVar10 * 4) =
                     *(void*)
                      (*(int64_t *)(*(int64_t *)(lVar13 + 0x18 + uVar10 * 8) + 0x10) + uVar16 * 4)
                ;
                uVar10 = uVar10 + 4;
              } while (uVar12 != uVar10);
            }
            ...
            lVar13 = *(int64_t *)(lVar4 + 0x10);
            lVar3 = *(int64_t *)(*in_RCX + 0x10);
            uVar10 = uVar15;
            do {
              ...
              if (fVar19 < local_64) {
                ...
                if (fVar19 < local_60) {
                  *(float *)(*(int64_t *)
                              (*(int64_t *)(*(int64_t *)(*arg1 + 0x10) + uVar10 * 8) + 0x10)
                            + uVar16 * 4) = fVar1;
                }
                else {
                  fVar19 = g_02390124 - (fVar19 - local_60) / local_84;
                  lVar4 = *(int64_t *)
                           (*(int64_t *)(*(int64_t *)(*arg1 + 0x10) + uVar10 * 8) + 0x10);
                  *(float *)(lVar4 + uVar16 * 4) =
                       (g_02390124 - fVar19) * *(float *)(lVar4 + uVar16 * 4) + fVar1 * fVar19;
                }
              }
              uVar10 = uVar10 + 1;
            } while (uVar12 != uVar10);
