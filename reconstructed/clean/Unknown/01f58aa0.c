...
void FUN_01f58aa0(uint64_t param_1,uint64_t param_2,float param_3,float param_4)

{
  ...
  switch(in_EDX) {
  case 8:
    lVar7 = (*PTR__objc_msgSend_024a9998)(in_RCX,8);
    (*puVar4)((double)param_3);
    lVar8 = 8;
    break;
  case 9:
    if (fVar17 <= fVar18) goto switchD_01f58b00_caseD_24;
  case 0x23:
    lVar7 = (*PTR__objc_msgSend_024a9998)(in_RCX,0x23);
    lVar8 = (*puVar4)();
    if (lVar8 != 0) {
    ...
    auVar12._4_4_ = (int)((uint64_t)dVar3 >> 0x20);
    auVar12._8_8_ = 0;
    ...
    (*puVar4)();
    (*puVar4)(local_48,uVar16);
    uVar10 = (*puVar4)();
    (*puVar4)(extraout_XMM0_Qa_02,uVar10);
    lVar8 = 0x23;
    break;
  default:
  ...
  case 0x21:
    lVar7 = (*PTR__objc_msgSend_024a9998)(in_RCX,0x21);
    (*puVar4)();
    lVar8 = 0x21;
    break;
  case 0xf:
    lVar7 = (*PTR__objc_msgSend_024a9998)(in_RCX,0xf);
    if (param_3 <= g_0239011c) {
      fVar18 = g_0239426c * param_3 * g_02394298 + g_024112a0;
    }
    else {
      fVar18 = (g_02390118 + param_3) * g_0239426c * g_02394298;
    }
    (*PTR__objc_msgSend_024a9998)(fVar18);
    lVar8 = 0xf;
    break;
  case 0x22:
switchD_01f58b00_caseD_22:
    lVar7 = (*PTR__objc_msgSend_024a9998)(in_RCX,0x22);
    (*puVar4)(g_02390124 - param_3);
    lVar8 = 0x22;
    break;
  case 0x24:
switchD_01f58b00_caseD_24:
    lVar7 = (*PTR__objc_msgSend_024a9998)(in_RCX,0x24);
    lVar8 = (*puVar4)();
    ...
    auVar13._4_4_ = (int)((uint64_t)dVar3 >> 0x20);
    auVar13._8_8_ = 0;
    ...
    if (param_4 < g_02390124) {
      ...
      auVar13 = roundss(ZEXT816(0),
                        ZEXT416((uint)((g_02390124 - param_3) * (float)(dStack_70 - local_140))),9
                       );
      local_48._0_4_ = SUB84((double)auVar13._0_4_,0);
    }
    (*puVar4)();
    (*puVar4)(uVar10,local_48._0_4_);
    uVar10 = (*puVar4)();
    (*puVar4)(extraout_XMM0_Qa_04,uVar10);
    lVar8 = 0x24;
  }
  if (lVar7 == 0) {
...
switchD_01f58b00_caseD_a:
  ...
  fVar15 = (float)((uint64_t)param_1 >> 0x20);
  uVar16 = (uint32_t)((uint64_t)in_XMM0_Qb >> 0x20);
  auVar1._4_4_ = fVar15;
  auVar1._0_4_ = fVar15 + g_02390124;
  auVar1._8_4_ = uVar16;
  ...
  if ((uint)lVar8 < 0x25) {
    if ((0x60000c000U >> lVar8 & 1) == 0) {
      ...
      if ((0x1800000000U >> lVar8 & 1) != 0) {
        auVar2._4_4_ = fVar15;
        auVar2._0_4_ = fVar15 + g_02390124 + g_02390d00;
        auVar2._8_4_ = uVar16;
  ...
  if ((uint)lVar8 - 0x23 < 2) {
    if ((*(int64_t *)(*arg1 + 0x28) == 0) ||
       (lVar7 = (*PTR__objc_msgSend_024a9998)(), lVar7 != 0)) goto LAB_01f592b9;
    lVar7 = *(int64_t *)(this_ptr + 0x40);
    uVar10 = extraout_XMM0_Qa_05;
  }
  else {
    cVar6 = (*PTR__objc_msgSend_024a9998)(fVar18 + fVar18,PTR_s_setEnabled__026c97e8);
    uVar10 = extraout_XMM0_Qa_06;
    if (cVar6 != '\0') {
      uVar10 = (*PTR__objc_msgSend_024a9998)(extraout_XMM0_Qa_06,in_R8B);
    }
    if (*(int64_t *)(*arg1 + 0x28) == 0) goto LAB_01f592b9;
  }
  (*PTR__objc_msgSend_024a9998)(uVar10,lVar7);
LAB_01f592b9:
  auVar14._4_12_ = auVar13._4_12_;
  auVar14._0_4_ = auVar13._0_4_ - fVar18;
  cVar6 = (*PTR__objc_msgSend_024a9998)(auVar14._0_8_,PTR_s_cell_026ca280);
  puVar4 = PTR__objc_msgSend_024a9998;
  if (cVar6 != '\0') {
  ...
  if ((lVar7 != 0) || (lVar7 = (*PTR__objc_msgSend_024a9998)(), lVar7 != 0)) {
