...
void FUN_01d494d0(float param_1,uint64_t param_2,float param_3,float param_4)

{
  ...
  fVar39 = (float)((uint64_t)param_2 >> 0x20);
  ...
  auVar36._0_4_ = fVar39 * local_44 * g_0239011c;
  ...
  uVar15 = (uint)(int64_t)(fVar34 * local_44 + fVar33 * local_44 + g_02390124);
  if (in_EDX < uVar15) {
    uVar21 = (uint64_t)(iVar10 + 2U);
    uVar31 = in_ECX + in_EDX;
    iVar24 = uVar31 - uVar15;
    if (uVar31 < uVar15) {
      iVar24 = 0;
    }
    uVar14 = (uint64_t)(uint)(in_ECX - iVar24);
    lVar6 = FUN_00e83010();
    if (lVar6 != 0) {
      if (local_res18 == '\0') {
        local_9c = in_R8[in_R9D - (int)(int64_t)((float)(in_R9D - 1) * param_4)];
        local_74 = *in_R8;
      }
      else {
        local_74 = *in_R8;
        fVar34 = (float)(local_74 >> 0x10 & 0xff) * g_02391098;
        fVar33 = g_02394220;
        if (fVar34 <= g_02394220) {
          fVar33 = fVar34;
        }
        fVar39 = (float)(local_74 >> 8 & 0xff) * g_02391098;
        fVar40 = (float)(local_74 & 0xff) * g_02391098;
        fVar34 = g_02394220;
        if (fVar39 <= g_02394220) {
          fVar34 = fVar39;
        }
        fVar39 = g_02394220;
        if (fVar40 <= g_02394220) {
          fVar39 = fVar40;
        }
      ...
      if (0 < iVar24) {
        ...
        uVar5 = local_74 >> 0x18;
        uVar21 = (uint64_t)(uint)((int)local_68 * iVar24);
        uVar16 = local_74 & 0xffffff;
        uVar26 = 1;
        if (1 < (int)local_68) {
          uVar26 = local_68 & 0xffffffff;
        }
        fVar39 = g_0239011c * fVar34;
        uVar7 = (int64_t)(local_5c * local_70 + 0.0) & 0xffffffff;
        if (local_70 <= 0.0) {
          uVar7 = 0;
        }
        iVar25 = iVar10 + 1;
        ...
        do {
          ...
          auVar38._0_4_ = auVar36._0_4_ + g_023945d0;
          ...
          if (uVar23 - uVar28 != 0 && (int)uVar28 <= (int)uVar23) {
            fVar41 = g_02390124 / ((float)(int)(uVar23 - uVar28) + g_0239011c);
            uVar29 = uVar23;
          }
          if ((uVar31 == 0) || (local_34 == uVar15)) {
            ...
            if (((param_4 == 0.0) && (!NAN(param_4))) ||
              ...
              local_88._12_4_ = (int)((uint64_t)extraout_XMM0_Qb_00 >> 0x20);
...
LAB_01d4a049:
              ...
              uVar14 = (uint64_t)(uint)(iVar30 + (int)lVar18);
            }
            else {
              if ((fVar33 != 0.0) || (NAN(fVar33))) {
                auVar36 = ZEXT416((uint)(fVar39 / fVar33));
                auVar36 = roundss(auVar36,auVar36,10);
                uVar23 = (uint)(int64_t)auVar36._0_4_;
                uVar31 = in_R9D - uVar23;
                if (in_R9D < uVar23) {
                  uVar31 = 0;
                }
                if (0.0 < local_70) {
                  uVar31 = (uint)(int64_t)((local_5c - (float)uVar31) * local_70 + (float)uVar31);
                }
                *puVar2 = in_R8[uVar31];
                uVar19 = 1;
                if (uVar28 != 1) {
                  ...
                  if (0.0 < local_70) {
                    ...
                    do {
                      ...
                      auVar36 = roundss(auVar36,auVar36,10);
                      uVar20 = (uint)(int64_t)auVar36._0_4_;
                      uVar11 = in_R9D - uVar20;
                      if (in_R9D < uVar20) {
                        uVar11 = 0;
                      }
                      uVar11 = in_R8[(int64_t)
                  ...
                  do {
                    ...
                    auVar36 = roundss(auVar36,auVar36,10);
                    uVar11 = (uint)(int64_t)auVar36._0_4_;
...
LAB_01d4a150:
            ...
            if (iVar12 - iVar30 != 0 && iVar30 <= iVar12) {
              if ((iVar10 - iVar30 & 1U) != 0) {
                puVar9 = puVar2;
                if (iVar30 != 0) {
                  *(void*)(lVar6 + ((uint)((iVar12 - iVar30) * iVar22) + local_40) * 4) = 0;
                  puVar9 = (uint *)(lVar6 + ((uint)((iVar12 + iVar30) * iVar22) + local_40) * 4);
                }
                *puVar9 = 0;
                uVar14 = (uint64_t)(iVar30 + 1);
              }
              iVar24 = iVar12;
              if (iVar25 != iVar30) {
                iVar30 = (int)uVar14;
                ...
                do {
                  ...
                  puVar9 = puVar2;
                  if (iVar12 != 0) {
                    *(void*)(lVar6 + (uVar31 + local_40) * 4) = 0;
                    puVar9 = (uint *)(lVar6 + (uVar28 + local_40) * 4);
                  }
                  *puVar9 = 0;
                  puVar9 = puVar2;
                  if (iVar12 != -1) {
                    *(void*)(lVar6 + (uVar23 + local_40) * 4) = 0;
          ...
          uVar43 = 0;
          uVar42 = 0;
          *(void*)(lVar6 + ((uint)(((int)local_68 - iVar24) * (int)local_50) + local_40) * 4)
               = 0;
          local_40 = local_40 + 1;
          uVar14 = local_50;
          fVar40 = fVar33;
    ...
    (**(code **)(*this_ptr + 0x570))(uVar14,0,(iVar10 + 2U) * 2,in_EDX,lVar6);
  }
  return;
}
