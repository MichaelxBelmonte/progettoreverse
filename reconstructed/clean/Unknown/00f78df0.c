...
uint64_t FUN_00f78df0(double param_1,uint64_t param_2,int param_3,uint param_4)
...
LAB_00f78e6a:
  ...
  if (local_res10 == 2) {
    iVar8 = 0;
    if ((((param_1 != 0.0) || (NAN(param_1))) && (iVar8 = 1, g_023b67d8 <= param_1)) &&
       ((uVar2 != 0 || (param_1 < g_0241eeb8)))) {
      if (0 < (int)uVar2) {
        dVar21 = g_0238fee8;
        uVar4 = uVar2;
        if ((uVar2 & 7) != 0) {
        ...
        if (6 < uVar2 - 1) {
          do {
            dVar21 = dVar21 * g_0241eeb8 * g_0241eeb8 * g_0241eeb8 * g_0241eeb8 *
                     g_0241eeb8 * g_0241eeb8 * g_0241eeb8 * g_0241eeb8;
            uVar4 = uVar4 - 8;
          } while (uVar4 != 0);
        }
        iVar8 = 1;
...
LAB_00f78f5b:
    if ((param_1 != 0.0) || (NAN(param_1))) {
      uVar16 = 0;
      for (; dVar22 < g_0238fee8; dVar22 = dVar22 * g_0241eeb8) {
        uVar16 = uVar16 - 1;
      }
      for (; g_0241eeb8 < dVar22; dVar22 = dVar22 / g_0241eeb8) {
        uVar16 = uVar16 + 1;
      }
    }
    else {
...
LAB_00f79026:
  dVar22 = (double)(~-(uint64_t)(dVar22 < 0.0) & (uint64_t)dVar22 |
                   (g_023945b0 ^ (uint64_t)dVar22) & -(uint64_t)(dVar22 < 0.0));
  uVar17 = 0;
  if (g_023ed350 <= dVar22) goto LAB_00f79657;
  uVar5 = (int64_t)(dVar22 - g_023907c8) & (int64_t)dVar22 >> 0x3f | (int64_t)dVar22;
  local_c8 = 9;
  if ((int)uVar2 < 9) {
  ...
  if (uVar4 == 0) {
    ...
    if (6 < uVar4 - 1) {
      do {
        dVar20 = dVar20 * g_0241eeb8 * g_0241eeb8 * g_0241eeb8 * g_0241eeb8 *
                 g_0241eeb8 * g_0241eeb8 * g_0241eeb8 * g_0241eeb8;
        uVar9 = uVar9 - 8;
      } while (uVar9 != 0);
    }
    uVar12 = ((int64_t)dVar20 + 1) - (uint64_t)(dVar20 - (double)(int64_t)dVar20 < g_023942d0);
    uVar9 = uVar4;
    if ((local_c8 & 7) != 0) {
      uVar9 = 0;
      do {
  ...
  dVar21 = (dVar22 - ((auVar23._8_8_ - _UNK_023e16d8) +
                     ((double)CONCAT44(g_023e16c0,(int)uVar5) - g_023e16d0))) * dVar21;
  lVar13 = (int64_t)dVar21;
  uVar14 = (lVar13 + 1) - (uint64_t)(dVar21 - (double)lVar13 < g_023942d0);
  uVar5 = (uVar5 + 1) - (uint64_t)(uVar14 < uVar12);
  uVar6 = 0;
  if (uVar14 < uVar12) {
    uVar12 = uVar6;
  }
...
LAB_00f793fc:
  acStack_79[(int64_t)(int)uVar12 + 1] = '\0';
  uVar2 = 0;
  if (iVar8 == 1) {
    uVar6 = -uVar16;
    if (0 < (int64_t)uVar16) {
  ...
  if (iVar8 == 1) {
    ...
    if (iVar3 != 0) {
      ...
      if (iVar3 != 0) {
        ...
        do {
          if ((int64_t)uVar16 < 1) goto LAB_00f7984a;
          uVar16 = uVar16 - 1;
