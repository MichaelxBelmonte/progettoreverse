...
//   "void license_services::LsEntityUtilsTimeLimit::add(license_services::LsTimeLimitWire &)"

void FUN_00a4fe16(void)

{
  ...
  if (lVar4 != -1) {
    ...
    FUN_00983230();
    FUN_00983230();
    FUN_00928ab0("void license_services::LsEntityUtilsTimeLimit::add(license_services::LsTimeLimitWire &)"
                 ,0x68);
    FUN_009c78cb();
  }
  FUN_009b4be0();
