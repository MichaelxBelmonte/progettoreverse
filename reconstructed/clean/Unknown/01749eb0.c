...
uint64_t FUN_01749eb0(float param_1)
...
LAB_0174a1d5:
              ...
              if (iVar9 < 0) {
                ...
                if (iVar9 <= iVar16) {
                  ...
                  if ((pvVar10 != (void *)0x0) && (lVar11 = FUN_00e8b990(), lVar11 != 0)) {
                    in_RCX = puVar2;
                    puVar14 = *(void**)
                               (puVar2 + (uint64_t)(*(uint *)(lVar11 + 0x154) & 1) * 8 + 0x20);
                  }
                  pvVar10 = _pthread_getspecific((void*)in_RCX);
                  if (pvVar10 != (void *)0x0) {
                    FUN_00e8b990();
      ...
      uVar15 = CONCAT71((int7)((uint64_t)puVar14 >> 8),iVar8 != -1);
