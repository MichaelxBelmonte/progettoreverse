...
void FUN_00a22682(uint64_t param_1,uint64_t param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a226ff:
    if ((plVar17 == plVar4) || ((int64_t)plVar17 - (int64_t)plVar3 == -8)) goto LAB_00a2270d;
    lVar18 = (int64_t)plVar17 - (int64_t)plVar3 >> 3;
  }
  else {
    do {
      if (*plVar17 == *(int64_t *)(arg1 + 0x10)) goto LAB_00a226ff;
      plVar17 = plVar17 + 1;
...
LAB_00a2270d:
  ...
  *(int64_t *)(lVar11 + 0x18) = lVar5 + lVar18 * 8 + ((int64_t)pvVar12 >> 3) * 8;
  ...
  pvVar13 = (void *)((int64_t)pvVar10 + lVar18 * 0x180);
  pvVar12 = (void *)((int64_t)pvVar10 + lVar18 * 0x180 + 0x180);
  pvVar16 = pvVar13;
  if (pvVar12 != pvVar6) {
    do {
      pvVar16 = (void *)((int64_t)pvVar13 + 0x180);
      FUN_00a649c0();
      sVar15 = (size_t)param_3;
      pvVar12 = (void *)((int64_t)pvVar13 + 0x300);
      pvVar13 = pvVar16;
  ...
  do {
    puVar1 = (void*)((int64_t)pvVar12 + -0x180);
    pvVar12 = (void *)((int64_t)pvVar12 + -0x180);
    (**(code **)*puVar1)();
    sVar15 = (size_t)param_3;
