...
uint32_t FUN_00f6eee0(ASN1_STRING *param_1,uint64_t param_2,uint param_3,ASN1_STRING **param_4)
...
LAB_00f6f0c7:
  ...
  if (1 < local_44 - 0x10) {
    ...
    local_31 = '\x01';
    pAVar8 = (ASN1_STRING *)(uint64_t)(uint)(int)(char)local_32;
    uVar11 = 0;
    value = (char *)0x0;
    data = pAVar5;
    iVar3 = FUN_00f6fde0();
...
LAB_00f6f12b:
  pAVar10 = *(ASN1_STRING **)arg1;
  uVar12 = (uint)local_32;
  if (local_32 != 0) {
    local_b8 = pAVar10;
    if (0 < (int64_t)local_70) {
      uVar13 = 1;
      pAVar10 = local_50;
      do {
        iVar3 = (int)uVar13;
        ...
        lVar18 = 0;
        while( true ) {
          pcVar9 = (char *)((int64_t)&local_70->length + lVar19);
          iVar14 = (int)lVar18;
          if ((((int *)pcVar9 == (int *)((int64_t)&MACH_HEADER.magic + 1)) ||
              (*(char *)((int64_t)&pAVar10->length + lVar18 * 2) != '\0')) ||
             (*(char *)((int64_t)&pAVar10->length + lVar18 * 2 + 1) != '\0')) break;
          if ((int)pAVar8 == iVar14) {
            pAVar16 = (ASN1_STRING *)((int64_t)&pAVar10->length + (uint64_t)(iVar3 - 1) * 2 + 2);
            goto LAB_00f6f31e;
          }
          lVar18 = lVar18 + 1;
          lVar1 = (int64_t)&local_70->length + lVar19;
          lVar19 = lVar19 + -2;
          if (lVar1 < 3) goto LAB_00f6f296;
        }
        pAVar16 = (ASN1_STRING *)((int64_t)pAVar10 - lVar19);
        value = pcVar9;
        ...
        if ((char)uVar4 < '\0') {
          ...
          if (uVar12 != 0) {
            pAVar8 = (ASN1_STRING *)
                     (pcVar9 + (int64_t)((int64_t)pAVar10 + (-(int64_t)pAVar16 - lVar19)));
          }
        }
        if ((char)uVar4 < '\0') {
          pcVar9 = "crypto/asn1/tasn_dec.c";
        ...
        if ((char)uVar12 == '\0') {
          ...
          pAVar16 = (ASN1_STRING *)((int64_t)&pAVar8->length + (int64_t)&pAVar16->length);
        }
        else {
          if (iVar3 + 1 == iVar14) {
            pcVar9 = "crypto/asn1/tasn_dec.c";
          ...
          uVar13 = (uint64_t)((iVar3 - iVar14) + 1);
        }
        local_70 = (ASN1_STRING *)
                   (pcVar9 + (int64_t)((int64_t)pAVar10 + (-(int64_t)pAVar16 - lVar19)));
        pAVar10 = pAVar16;
      } while (0 < (int64_t)local_70);
      if ((int)uVar13 == 0) {
LAB_00f6f31e:
        data = (ASN1_STRING *)((int64_t)pAVar16 - (int64_t)local_b8);
        pAStack_a0 = local_b8;
        local_50 = pAVar16;
        goto LAB_00f6f33e;
      }
...
LAB_00f6f296:
  ...
  pAVar8 = local_70;
  data = (ASN1_STRING *)(((int64_t)local_50 - (int64_t)pAVar10) + (int64_t)local_70);
LAB_00f6f33a:
  pAStack_a0 = pAVar10;
  local_50 = (ASN1_STRING *)((int64_t)&local_70->length + (int64_t)&local_50->length);
LAB_00f6f33e:
  iVar14 = (int)pAVar5;
LAB_00f6f342:
  uVar12 = local_44;
  pcVar9 = (char *)(uint64_t)local_44;
  local_60 = pAStack_a0;
  if ((local_58[1].data != (uchar *)0x0) &&
     (pcVar2 = *(code **)(local_58[1].data + 0x28), pcVar2 != 0x0)) {
  ...
  case 1:
    if (iVar3 == 1) {
      *(uint *)this_ptr = (uint)(byte)pAStack_a0->length;
      goto LAB_00f6f694;
    }
    iVar3 = 0x6a;
    iVar15 = 0x345;
  ...
  case 10:
    pAVar6 = _c2i_ASN1_INTEGER((ASN1_INTEGER **)&switchD_00f6f3ee::switchdataD_00f6f75c,
                               (uchar **)(int64_t)iVar3,iVar15);
    pcVar9 = (char *)str;
    if (pAVar6 != (ASN1_INTEGER *)0x0) {
      this_ptr->asn1_string->type = this_ptr->asn1_string->type & 0x100U | uVar12;
LAB_00f6f682:
...
joined_r0x00f6f751:
    ...
    goto LAB_00f6f6ae;
  case 0x1c:
    if (((uint64_t)data & 3) == 0) goto switchD_00f6f3ee_caseD_4;
    iVar3 = 0xd7;
    iVar15 = 0x374;
    break;
  case 0x1e:
    if (((uint64_t)data & 1) == 0) goto switchD_00f6f3ee_caseD_4;
    iVar3 = 0xd6;
    iVar15 = 0x36f;
  }
  pcVar9 = "crypto/asn1/tasn_dec.c";
