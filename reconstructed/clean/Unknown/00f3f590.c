...
mbstate_t * FUN_00f3f590(uint64_t param_1,mbstate_t *param_2,uint *param_3,mbstate_t *param_4)

{
  ...
  iVar11 = FUN_00f425b0();
  if (((segment_command *)(this_ptr->__mbstate8 + 0x48))->cmd == 0) {
    FUN_00f425c0();
    FUN_00f425c0();
    *(int *)(this_ptr->__mbstate8 + 0x34) = *(int *)(this_ptr->__mbstate8 + 0x34) + 1;
  }
  local_308 = (mbstate_t *)0x0;
  uVar12 = FUN_00f425c0();
  pmVar23 = (mbstate_t *)(uint64_t)uVar12;
  *(uint64_t *)(this_ptr->__mbstate8 + 0x20) = *(uint64_t *)(this_ptr->__mbstate8 + 0x18);
  *(uint64_t *)(this_ptr->__mbstate8 + 0x28) =
       *(uint64_t *)(this_ptr->__mbstate8 + 0x18) +
       (int64_t)(int)*(qword *)(this_ptr->__mbstate8 + 0x30) * 4;
  iVar13 = FUN_00f425b0();
  bVar55 = uVar12 == 0;
  if (iVar13 <= iVar11) {
    local_334 = 0;
...
LAB_00f41fd1:
    pmVar25 = pmVar23;
    if (bVar55) {
      *(mbstate_t **)(this_ptr->__mbstate8 + 0x10) = local_308;
    }
LAB_00f4200f:
  ...
  pmVar1 = (mbstate_t *)(this_ptr->__mbstate8 + 0x18);
...
LAB_00f3f680:
  ...
  switch(uVar14) {
  case 0:
    if (((*(uint *)(this_ptr->__mbstate8 + 0x44) & 0x11) == 1) &&
       (uVar12 = FUN_00f425c0(), uVar12 != 0)) goto LAB_00f3f807;
    goto LAB_00f3f802;
  case 1:
    pmVar23 = *(mbstate_t **)(this_ptr->__mbstate8 + 0x18);
    pmVar22 = *(mbstate_t **)(this_ptr->__mbstate8 + 0x28);
    if ((pmVar22 <= pmVar23) ||
       (uVar16 = *(uint *)(this_ptr->__mbstate8 + 0x44), (uVar16 & 0x10) != 0))
    ...
    case 0x24:
      if ((((uVar16 & 1) != 0) ||
        ...
        param_2 = (mbstate_t *)((int64_t)&MACH_HEADER.magic + 2);
...
switchD_00f3f70c_caseD_25:
      ...
      if (((local_33c != 0) && (pmVar25 < pmVar22)) &&
        ...
        *(uint *)(this_ptr->__mbstate8 + 0x44) =
             *(uint *)(this_ptr->__mbstate8 + 0x44) & ~local_33c;
        *(char **)(this_ptr->__mbstate8 + 0x18) = pmVar23->__mbstate8 + 8;
        uVar12 = FUN_00f425c0();
        pmVar23 = (mbstate_t *)(uint64_t)uVar12;
        local_33c = 0;
        goto LAB_00f41113;
      }
      uVar12 = *(uint *)(this_ptr->__mbstate8 + 0x44);
...
LAB_00f40fb4:
      ...
      if ((uVar12 & 1) == 0) {
        ...
        pmVar25 = (mbstate_t *)(uint64_t)(uVar40 - 0x3f);
        if (((uVar40 - 0x3f < 0x3e) &&
            ((0x3000000000000001U >> ((uint64_t)pmVar25 & 0x3f) & 1) != 0)) || (uVar40 == 0x2b))
        goto LAB_00f40fb4;
      }
LAB_00f40fe9:
      if ((uVar12 & 2) == 0) {
LAB_00f40fed:
        param_2 = (mbstate_t *)(uint64_t)*(uint *)pmVar23;
        local_308 = (mbstate_t *)FUN_00f33800(*(dword *)(this_ptr->__mbstate8 + 0x38));
        if (local_308 != (mbstate_t *)0x0) {
LAB_00f410ff:
          *(dword *)(this_ptr->__mbstate8 + 0x38) = *(dword *)(this_ptr->__mbstate8 + 0x38) + 1;
          *(uint64_t *)(this_ptr->__mbstate8 + 0x18) =
               *(uint64_t *)(this_ptr->__mbstate8 + 0x18) + 4;
          goto switchD_00f3f6a1_default;
        }
      }
      else {
        if ((uint64_t)*(uint *)pmVar23 < 0x80) {
          pdVar36 = (dword *)PTR___DefaultRuneLocale_0249c238;
          if (-1 < *(short *)(PTR___DefaultRuneLocale_0249c238 +
                             (uint64_t)*(uint *)pmVar23 * 4 + 0x3c)) {
LAB_00f41043:
            if ((uint64_t)**(uint **)pmVar1 < 0x80) {
              pdVar36 = &dylib_command_00000ff0.dylib.current_version;
              uVar12 = *(uint *)(PTR___DefaultRuneLocale_0249c238 +
                                (uint64_t)**(uint **)pmVar1 * 4 + 0x3c) & 0x1000;
            }
            else {
              pdVar36 = (dword *)PTR___DefaultRuneLocale_0249c238;
        ...
        dVar15 = *(dword *)(this_ptr->__mbstate8 + 0x38);
        lVar27 = FUN_00f33800(dVar15,_Var21);
        if (lVar27 == 0) break;
        ___tolower(dVar15);
        _Var21 = ___tolower(dVar15);
        param_2 = (mbstate_t *)FUN_00f33800(*(dword *)(this_ptr->__mbstate8 + 0x38),_Var21);
    ...
    case 0x28:
      if ((uVar16 & 1) == 0) {
        if ((pmVar23 <= *(mbstate_t **)(this_ptr->__mbstate8 + 0x20)) ||
           (*(dword *)((int64_t)pmVar23 + -4) != 0x5c)) goto switchD_00f3f70c_caseD_25;
      }
        ...
        do {
          ...
          default:
            pmVar1->_mbstateL = (int64_t)pcVar39;
            goto LAB_00f42044;
          case 0x29:
            pmVar1->_mbstateL = (int64_t)(pcVar39 + 4);
            goto LAB_00f4154e;
          case 0x2d:
            break;
          case 0x3a:
...
LAB_00f40f05:
      ...
      if ((pmVar22 <= (mbstate_t *)(pmVar23->__mbstate8 + 8)) ||
        ...
        *(char **)(this_ptr->__mbstate8 + 0x18) = pmVar23->__mbstate8 + 4;
        uVar12 = FUN_00f425c0();
        if ((uVar12 != 0) ||
      ...
      pmVar1->_mbstateL = (int64_t)(pmVar23->__mbstate8 + 0xc);
      goto LAB_00f3f802;
    case 0x29:
      if ((((uVar16 & 1) == 0) || (local_334 < 1)) &&
         ((pmVar23 <= *(mbstate_t **)(this_ptr->__mbstate8 + 0x20) ||
          (*(dword *)((int64_t)pmVar23 + -4) != 0x5c)))) goto switchD_00f3f70c_caseD_25;
      param_2 = (mbstate_t *)0xffffffff;
      local_308 = (mbstate_t *)FUN_00f33800(0xffffffff);
      if (local_308 != (mbstate_t *)0x0) {
        if ((*(dword *)(this_ptr->__mbstate8 + 0x44) & 1) == 0) {
          pmVar1->_mbstateL = pmVar1->_mbstateL - 4;
        }
        goto switchD_00f3f6a1_default;
      }
    ...
    case 0x2e:
      if ((uVar16 & 4) == 0) {
        ...
        if (local_308 != (mbstate_t *)0x0) {
          iVar13 = 1;
LAB_00f411de:
          *(dword *)(this_ptr->__mbstate8 + 0x38) =
               *(dword *)(this_ptr->__mbstate8 + 0x38) + iVar13;
          *(uint64_t *)(this_ptr->__mbstate8 + 0x18) =
               *(uint64_t *)(this_ptr->__mbstate8 + 0x18) + 4;
          goto switchD_00f3f6a1_default;
        }
        ...
        lVar27 = FUN_00f33800(*(dword *)(this_ptr->__mbstate8 + 0x38),9);
        if ((lVar27 != 0) &&
           (param_2 = (mbstate_t *)
                      FUN_00f33800(*(dword *)(this_ptr->__mbstate8 + 0x38) + 1,0x7fffffff),
           param_2 != (mbstate_t *)0x0)) {
          local_308 = (mbstate_t *)FUN_00f33950();
          pmVar25 = (mbstate_t *)&MACH_HEADER.filetype;
          if (local_308 != (mbstate_t *)0x0) {
    ...
    case 0x5b:
      ...
      *(mbstate_t **)pmVar1 = local_328;
      ...
      if (dVar15 == 0x5e) {
        ...
        pmVar1->_mbstateL = (int64_t)local_328;
      }
      pmVar25 = (mbstate_t *)((int64_t)&MACH_HEADER.cputype + 3);
      if (local_328 != pmVar22) {
        ...
        do {
          ...
          uVar51 = (uint64_t)uVar16;
          iVar13 = (int)uVar50;
          sVar17 = (size_t)param_3;
          if ((uVar16 == 0x5d) &&
             (puVar33 = (uint *)(uint64_t)uVar12, (mbstate_t *)pmVar1->_mbstateL < local_328)) {
            pmVar1->_mbstateL = (int64_t)(local_328->__mbstate8 + 4);
            if (dVar15 != 0x5e) {
              if (iVar13 < 1) {
          ...
          if ((puVar33 < pmVar22) && (uVar16 == 0x5b)) {
            ...
            if (dVar3 != 0x3a) {
              if ((dVar3 == 0x2e) || (dVar3 == 0x3d)) {
                pmVar25 = (mbstate_t *)((int64_t)&MACH_HEADER.magic + 3);
                pmVar22 = local_328;
              }
              else {
                local_330 = (mbstate_t *)0x0;
                local_308 = (mbstate_t *)((int64_t)&segment_command_00000020.maxprot + 3);
                uVar51 = 0x5b;
                bVar55 = false;
...
LAB_00f413ba:
            ...
            pwVar42 = (wchar_t *)
                      (((int64_t)pmVar23 - (int64_t)local_328) * 0x40000000 + -0x200000000 >> 0x20
                      );
            if (0x107 < (int64_t)pmVar23 - (int64_t)local_328) {
              pwVar42 = (wchar_t *)((int64_t)&segment_command_00000020.vmaddr + 7);
            }
            _wcsncpy((wchar_t *)0xfffffffe00000000,pwVar42,sVar17);
            local_174[(int64_t)pwVar42 + -1] = 0;
            local_1f8 = 0;
            uStack_1f0 = 0;
            local_1e8 = 0;
            uStack_1e0 = 0;
            ...
            param_3 = (uint *)0x0;
            bVar46 = uVar16 != 0;
            param_2 = (mbstate_t *)CONCAT71((int7)((uint64_t)uVar41 >> 8),bVar46);
            bVar56 = *(int *)PTR____mb_cur_max_024a9890 == 1;
            uVar49 = (undefined7)((uint64_t)param_4 >> 8);
            if (bVar56 && bVar46) {
              param_2 = (mbstate_t *)this_ptr->_mbstateL;
              if ((*(dword *)(this_ptr->__mbstate8 + 0x44) & 2) == 0) {
                ...
                do {
                  ...
                  if (uVar31 == 0) {
                    if (_Var21 < 0) {
                      ...
                      *(qword *)((int64_t)pmVar25 + (int64_t)iVar13 * 8) = qVar24;
                      param_3 = (uint *)0x0;
                      if (qVar24 == 0) {
                        param_3 = &MACH_HEADER.filetype;
                      }
                      uVar50 = (uint64_t)(iVar13 + 1);
                      pvVar35 = (void *)0xffffffff;
                      pmVar34 = pmVar25;
                    }
                  }
                  ...
                  param_2 = (mbstate_t *)CONCAT71((int7)((uint64_t)param_2 >> 8),(int)param_3 == 0)
                  ;
...
LAB_00f4055c:
                    ...
                    param_2 = (mbstate_t *)
                              CONCAT71((int7)((uint64_t)param_2 >> 8),(int)param_3 == 0);
                  }
                  else {
...
LAB_00f405e5:
                    ...
                    param_3 = (uint *)0x0;
                    param_2 = (mbstate_t *)CONCAT71((int7)((uint64_t)param_2 >> 8),1);
                  }
                } while ((uVar51 < 0xff) && (uVar51 = uVar51 + 1, (int)param_3 == 0));
              }
              uVar16 = 0;
              ...
              if (((int)pvVar35 < 0) || ((char)param_2 == '\0')) {
                uVar49 = (undefined7)((uint64_t)pmVar22 >> 8);
                pmVar25 = (mbstate_t *)param_3;
                goto LAB_00f406d5;
              }
              iVar13 = (int)uVar50;
...
LAB_00f407df:
              ...
              puVar33 = (uint *)(int64_t)iVar13;
              *(qword *)((int64_t)pmVar34 + (int64_t)puVar33 * 8) = qVar24;
              param_2 = pmVar22;
...
LAB_00f4083f:
              ...
              pmVar25 = (mbstate_t *)((uint64_t)(uVar16 == 0) << 2);
              bVar6 = false;
LAB_00f406d5:
              ...
              if ((uVar16 == 0) || (dVar15 != 0x5e)) {
                local_330 = (mbstate_t *)(uint64_t)uVar16;
                local_308 = (mbstate_t *)0x7fffffff;
                uVar51 = 0;
              ...
              if ((int)local_350 < 0x40) {
                pmVar25 = (mbstate_t *)(int64_t)(int)local_350;
                local_350 = (uint64_t)((int)local_350 + 1);
                *(uint *)((int64_t)&local_2f8 + (int64_t)pmVar25 * 4) = uVar16;
                uVar51 = 0;
                bVar55 = true;
                param_2 = (mbstate_t *)0x0;
                bVar46 = true;
            ...
            if (uVar16 == 0x2d) {
              if (*puVar33 != 0x5d) {
                param_2 = (mbstate_t *)(uint64_t)uVar12;
              ...
              local_308 = (mbstate_t *)(uint64_t)uVar16;
            }
LAB_00f40111:
            local_330 = (mbstate_t *)0x0;
            bVar55 = false;
...
LAB_00f4013e:
            param_2 = local_308;
            qVar24 = FUN_00f33800(0xffffffff);
            *(qword *)((int64_t)pmVar34 + (int64_t)iVar13 * 8) = qVar24;
            if (qVar24 == 0) {
              pmVar25 = (mbstate_t *)&MACH_HEADER.filetype;
              puVar33 = (uint *)(int64_t)iVar13;
              pmVar22 = local_328;
            ...
            uVar50 = (uint64_t)(iVar13 + 1);
            *(void*)(*(int64_t *)(qVar24 + 8) + 0x18) = local_330._0_4_;
            bVar46 = true;
            bVar6 = false;
            param_2 = (mbstate_t *)0x0;
            uVar16 = 0;
          ...
          if ((((bVar6) || ((char)param_2 != '\0')) ||
              (puVar33 = (uint *)(uint64_t)(*(uint *)(this_ptr->__mbstate8 + 0x44) & 2),
              (*(uint *)(this_ptr->__mbstate8 + 0x44) & 2) == 0)) || (uVar31 = uVar16, bVar55)) {
...
LAB_00f402b3:
                      ...
                      param_2 = (mbstate_t *)(uint64_t)uVar16;
                      qVar24 = FUN_00f33800(0xffffffff);
                      puVar33 = (uint *)(int64_t)iVar13;
                      *(qword *)((int64_t)pmVar34 + (int64_t)puVar33 * 8) = qVar24;
...
LAB_00f40390:
                    if (-1 < *(short *)(puVar7 + (uint64_t)uVar31 * 4 + 0x3c)) goto LAB_00f403cc;
                  }
                }
LAB_00f403cc:
                if ((int)uVar12 <= iVar13) {
...
LAB_00f401e0:
              ...
              uVar31 = 0;
              if (uVar16 != 0) {
                pmVar25 = (mbstate_t *)(uint64_t)uVar16;
                puVar33 = (uint *)local_308;
                goto LAB_00f413e8;
              }
            }
...
LAB_00f413e8:
    ...
    case 0x5c:
      ...
      if ((((uVar16 & 1) == 0) && (param_3 < pmVar22)) &&
         (((uint8_t  [128])*(mbstate_t *)param_3 & (uint8_t  [128])0xfffffffe) ==
          (uint8_t  [128])0x28)) {
        *(uint **)pmVar1 = param_3;
        goto LAB_00f3f802;
      }
      ...
      if (param_3 < pmVar22) {
        ...
        pwVar42 = (wchar_t *)(&g_02593c68)[lVar27 * 2];
        param_2 = (mbstate_t *)CONCAT71((int7)((uint64_t)param_2 >> 8),(char)*pwVar42);
        if ((char)*pwVar42 != '\0') {
          uVar50 = 0;
          do {
            uVar51 = uVar50;
            local_174[uVar51 - 1] = (int)(char)param_2;
            bVar2 = *(byte *)((int64_t)pwVar42 + uVar51 + 1);
            param_2 = (mbstate_t *)(uint64_t)bVar2;
            if (bVar2 == 0) break;
            uVar50 = uVar51 + 1;
          } while (uVar51 < 0x3f);
          local_174[uVar51] = 0;
          if (local_178 != 0) {
            local_2f8 = this_ptr->_mbstateL;
            uStack_2f0 = *(uint64_t *)(this_ptr->__mbstate8 + 8);
            local_2e8 = *(mbstate_t **)(this_ptr->__mbstate8 + 0x10);
            local_2d8 = *(uint64_t *)(this_ptr->__mbstate8 + 0x20);
            uStack_2d0 = *(uint64_t *)(this_ptr->__mbstate8 + 0x28);
            local_2c8 = *(uint64_t *)(this_ptr->__mbstate8 + 0x30);
            uStack_2c0 = *(uint64_t *)(this_ptr->__mbstate8 + 0x38);
            local_298 = *(uint64_t *)(this_ptr->__mbstate8 + 0x60);
            uStack_290 = *(uint64_t *)(this_ptr->__mbstate8 + 0x68);
            local_2a8 = *(uint64_t *)(this_ptr->__mbstate8 + 0x50);
            uStack_2a0 = *(uint64_t *)(this_ptr->__mbstate8 + 0x58);
            local_2b8 = *(uint64_t *)(this_ptr->__mbstate8 + 0x40);
            uStack_2b0._0_4_ = ((segment_command *)(this_ptr->__mbstate8 + 0x48))->cmd;
            uStack_2b0._4_4_ = ((segment_command *)(this_ptr->__mbstate8 + 0x48))->cmdsize;
            ...
            if (uVar12 == 0) {
              *(uint64_t *)(this_ptr->__mbstate8 + 0x18) =
                   *(uint64_t *)(this_ptr->__mbstate8 + 0x18) + 8;
              *(dword *)(this_ptr->__mbstate8 + 0x38) = (dword)uStack_2c0;
              local_308 = local_2e8;
              goto switchD_00f3f6a1_default;
            }
            pmVar25 = (mbstate_t *)(uint64_t)uVar12;
            goto LAB_00f4200f;
          }
        }
switchD_00f40dda_caseD_45:
        uVar12 = *param_3;
        if (uVar12 == 0x51) {
          *(uint *)(this_ptr->__mbstate8 + 0x44) = uVar16 | 0x10;
          local_33c = 0x10;
          *(char **)(this_ptr->__mbstate8 + 0x18) = pmVar23->__mbstate8 + 8;
          goto LAB_00f3f802;
        }
        *(uint **)pmVar1 = param_3;
        local_308 = (mbstate_t *)(uint64_t)uVar12;
        switch(uVar12) {
        case 0x3c:
          ...
          if (uVar12 == 0x78) {
            ...
            *(mbstate_t **)pmVar1 = pmVar25;
            ...
            if ((local_308 != (mbstate_t *)(section_00000068.segname + 3)) && (pmVar25 < pmVar22)) {
              ...
              pmVar34 = pmVar1;
              if (uVar12 < 0x100) {
                if ((PTR___DefaultRuneLocale_0249c238[(int64_t)local_308 * 4 + 0x3e] & 1) != 0) {
                  local_178 = CONCAT31(local_178._1_3_,(char)uVar12);
                  pmVar25 = (mbstate_t *)(pmVar23->__mbstate8 + 0xc);
                  pmVar1->_mbstateL = (int64_t)pmVar25;
                  local_308 = (mbstate_t *)(uint64_t)*(uint *)(pmVar23->__mbstate8 + 0xc);
                  if (0xff < *(uint *)(pmVar23->__mbstate8 + 0xc)) goto LAB_00f417ee;
                }
                pmVar34 = local_308;
                if (((PTR___DefaultRuneLocale_0249c238[(int64_t)local_308 * 4 + 0x3e] & 1) != 0) &&
                   (pmVar25 < pmVar22)) {
                  local_178._0_2_ = CONCAT11((char)local_308,(uint8_t)local_178);
                  pmVar1->_mbstateL = (int64_t)(pmVar25->__mbstate8 + 4);
                  pmVar34 = pmVar1;
                }
              }
LAB_00f417ee:
              ...
              local_308 = (mbstate_t *)(uint64_t)uVar12;
              pmVar22 = (mbstate_t *)FUN_00f33800(*(dword *)(this_ptr->__mbstate8 + 0x38));
              *(dword *)(this_ptr->__mbstate8 + 0x38) =
                   *(dword *)(this_ptr->__mbstate8 + 0x38) + 1;
              goto LAB_00f40fcb;
            }
            if (pmVar25 < pmVar22) {
              pmVar23 = (mbstate_t *)(pmVar23->__mbstate8 + 0xc);
              if (((int64_t)pmVar22 - (int64_t)pmVar23 < 0) ||
                 (uVar12 = *(uint *)pmVar23, uVar12 == 0x7d)) {
                pcVar39 = (char *)0x0;
              }
              else {
                pcVar54 = (char *)((uint64_t)((int64_t)pmVar22 - (int64_t)pmVar23) >> 2);
                pcVar38 = (char *)0x0;
                do {
                  pmVar25 = pmVar23;
                  if ((0xff < uVar12) ||
                     ((PTR___DefaultRuneLocale_0249c238[(uint64_t)uVar12 * 4 + 0x3e] & 1) == 0)) {
                    pmVar1->_mbstateL = (int64_t)pmVar25;
                    pmVar25 = (mbstate_t *)((int64_t)&MACH_HEADER.cpusubtype + 1);
                    goto LAB_00f4200f;
                  }
                  *(char *)((int64_t)&local_178 + (int64_t)pcVar38) = (char)uVar12;
                  pcVar39 = pcVar54 + 1;
              ...
              *(char **)(this_ptr->__mbstate8 + 0x18) = pmVar25->__mbstate8 + 8;
              *(void*)((int64_t)local_174 + (((uint64_t)pcVar39 & 0xffffffff) - 4)) = 0;
...
switchD_00f4172f_caseD_3d:
          if (((uint)local_308 < 0x100) &&
             ((PTR___DefaultRuneLocale_0249c238[(int64_t)local_308 * 4 + 0x3d] & 4) != 0)) {
            ...
            if (local_308 != (mbstate_t *)0x0) {
              *(dword *)(this_ptr->__mbstate8 + 0x38) =
                   *(dword *)(this_ptr->__mbstate8 + 0x38) + 1;
              if ((int)uVar12 < (int)*(dword *)(this_ptr->__mbstate8 + 0x3c)) {
                uVar12 = *(dword *)(this_ptr->__mbstate8 + 0x3c);
              }
              *(uint *)(this_ptr->__mbstate8 + 0x3c) = uVar12;
              *(uint64_t *)(this_ptr->__mbstate8 + 0x18) =
                   *(uint64_t *)(this_ptr->__mbstate8 + 0x18) + 4;
              goto switchD_00f3f6a1_default;
            }
...
LAB_00f41af0:
      ...
      pmVar25 = (mbstate_t *)((int64_t)&MACH_HEADER.cputype + 1);
      goto LAB_00f4200f;
    case 0x5e:
      if ((uVar16 & 1) == 0) {
        if (((((mbstate_t *)((int64_t)pmVar23 + -8) < *(mbstate_t **)(this_ptr->__mbstate8 + 0x20)
              ) || (*(dword *)((int64_t)pmVar23 + -8) != 0x5c)) ||
            (*(dword *)((int64_t)pmVar23 + -4) != 0x28)) &&
           (pmVar23 != *(mbstate_t **)(this_ptr->__mbstate8 + 0x20)))
        goto switchD_00f3f70c_caseD_25;
      }
      param_2 = (mbstate_t *)((int64_t)&MACH_HEADER.magic + 1);
      local_308 = (mbstate_t *)FUN_00f33800(0xffffffff);
  ...
  case 2:
    ...
    *(void*)(local_308->__mbstate8 + 0x14) = uVar14;
...
joined_r0x00f3f7f8:
    ...
    goto LAB_00f3f807;
  case 4:
    if ((*(dword *)(this_ptr->__mbstate8 + 0x44) & 0x10) == 0) {
      uVar12 = FUN_00f425c0();
...
LAB_00f3f802:
    ...
    goto LAB_00f3f807;
  case 5:
    puVar33 = *(uint **)(this_ptr->__mbstate8 + 0x18);
    if (*(uint **)(this_ptr->__mbstate8 + 0x28) <= puVar33) break;
    uVar12 = *(uint *)(this_ptr->__mbstate8 + 0x44);
    if ((uVar12 & 0x10) != 0) {
LAB_00f3fa68:
      if ((uVar12 & 0x20) == 0) {
...
joined_r0x00f3fae8:
    ...
    pmVar23 = (mbstate_t *)((uint64_t)(local_334 == 0) << 3);
    local_334 = local_334 + -1;
    pmVar1->_mbstateL = (int64_t)(puVar33 + 2);
    goto LAB_00f41113;
  case 6:
    FUN_00f42780();
    ...
    goto LAB_00f40fcb;
  case 7:
    piVar28 = *(int **)(this_ptr->__mbstate8 + 0x18);
    if ((piVar28 < *(int **)(this_ptr->__mbstate8 + 0x28)) &&
       ((*(dword *)(this_ptr->__mbstate8 + 0x44) & 0x10) == 0)) {
      if (*piVar28 == 0x29) {
        pmVar1->_mbstateL = (int64_t)(piVar28 + 1);
      }
...
LAB_00f3f9c6:
            uVar12 = uVar12 >> 6 & 1;
            param_3 = (uint *)(uint64_t)uVar12;
            param_4 = (mbstate_t *)CONCAT71((int7)((uint64_t)param_4 >> 8),dVar15 == 0x2b);
            pmVar25 = (mbstate_t *)(pmVar23->__mbstate8 + 4);
            if (pmVar25 < pmVar22) {
              if (*(dword *)pmVar25 == 0x3f) {
                param_3 = (uint *)(uint64_t)(uVar12 ^ 1);
                pmVar23 = pmVar25;
              }
              else if (*(dword *)pmVar25 - 0x2a < 2) {
LAB_00f4204b:
                pmVar25 = (mbstate_t *)((int64_t)&MACH_HEADER.filetype + 1);
                goto LAB_00f4200f;
              }
            }
            param_2 = (mbstate_t *)(uint64_t)(dVar15 == 0x2b);
            *(char **)(this_ptr->__mbstate8 + 0x18) = pmVar23->__mbstate8 + 4;
...
LAB_00f3fb39:
            ...
            pmVar23 = (mbstate_t *)((int64_t)param_3 + 4);
            *(mbstate_t **)pmVar1 = pmVar23;
            param_2 = (mbstate_t *)0xffffffff;
            pmVar25 = (mbstate_t *)((int64_t)&MACH_HEADER.magic + 1);
            if ((pmVar23 < pmVar22) && (uVar16 = *(dword *)pmVar23 - 0x30, uVar16 < 10)) {
              pmVar34 = (mbstate_t *)((int64_t)param_3 + 8);
              param_2 = (mbstate_t *)0xffffffff;
              pmVar26 = (mbstate_t *)((int64_t)&MACH_HEADER.magic + 2);
              do {
                pmVar25 = pmVar26;
                iVar13 = (int)param_2;
                if (iVar13 < 0) {
                ...
                param_2 = (mbstate_t *)(uint64_t)(uVar16 + iVar13 * 10);
            ...
            pmVar26 = (mbstate_t *)((int64_t)param_3 + (int64_t)pmVar25 * 4);
            uVar16 = (uint)param_2;
            pmVar34 = pmVar25;
            pmVar48 = param_2;
            if ((pmVar26 < pmVar22) && (*(dword *)pmVar26 == 0x2c)) {
              ...
              if ((mbstate_t *)((int64_t)param_3 + (int64_t)pmVar25 * 4 + 4) < pmVar22) {
                pmVar48 = (mbstate_t *)0xffffffff;
                lVar27 = (int64_t)pmVar25 * 4;
                do {
                  iVar13 = (int)pmVar48;
                  uVar31 = *(dword *)((int64_t)param_3 + (int64_t)pmVar34 * 4) - 0x30;
                  if (9 < uVar31) break;
                  if (iVar13 < 0) {
                    iVar13 = 0;
                  }
                  pmVar48 = (mbstate_t *)(uint64_t)(uVar31 + iVar13 * 10);
                  pmVar34 = (mbstate_t *)((int64_t)pmVar34 + 1);
                  lVar30 = lVar27 + 8;
                  lVar27 = lVar27 + 4;
                } while ((mbstate_t *)((int64_t)param_3 + lVar30) < pmVar22);
              }
            }
            uVar31 = (uint)pmVar48;
            if ((0xff < (int)uVar31) || (-1 < (int)uVar31 && (int)uVar31 < (int)uVar16)) {
LAB_00f42033:
              pmVar25 = (mbstate_t *)((int64_t)&MACH_HEADER.cpusubtype + 2);
              goto LAB_00f4200f;
            }
            ...
            do {
              ...
              else if ((mbstate_t *)((int64_t)param_3 + (int64_t)pmVar25 * 4 + 4) < pmVar22) {
                bVar55 = false;
                do {
                  pmVar34 = (mbstate_t *)(param_4->__mbstate8 + 1);
                  dVar15 = *(dword *)((int64_t)param_3 + (int64_t)param_4 * 4);
                  uVar44 = 0x7fffffff;
                  switch(dVar15) {
                  case 0x20:
                  case 0x2c:
                  ...
                  case 0x23:
                    pmVar26 = (mbstate_t *)((int64_t)param_3 + (int64_t)pmVar34 * 4);
                    uVar18 = 0xffffffff;
                    do {
...
switchD_00f40a4d_caseD_20:
                  param_4 = pmVar34;
                } while ((mbstate_t *)((int64_t)param_3 + (int64_t)param_4 * 4 + 4) < pmVar22);
              }
              else {
                bVar55 = false;
              }
switchD_00f40a4d_caseD_21:
              ...
              else if ((mbstate_t *)((int64_t)param_3 + (int64_t)param_4 * 4 + 4) < pmVar22) {
                bVar46 = false;
                do {
                  pmVar34 = (mbstate_t *)((int64_t)param_4 + 1);
                  pmVar26 = (mbstate_t *)((int64_t)param_3 + (int64_t)param_4 * 4);
                  dVar15 = *(dword *)((int64_t)param_3 + (int64_t)param_4 * 4);
                  switch(dVar15) {
                  case 0x20:
                  case 0x2b:
                  ...
                  default:
                    ...
                    if (pmVar26 < pmVar22) {
                      ...
                      do {
                        ...
                        dVar15 = *(dword *)((int64_t)pmVar23 + (int64_t)param_4 * 4);
                  ...
                  case 0x3c:
                    pmVar8 = (mbstate_t *)((int64_t)param_3 + (int64_t)param_4 * 4 + 8);
                    ...
                    if ((pmVar26 < pmVar22) && (uVar47 = *pdVar36 - 0x30, uVar47 < 10)) {
                      ...
                      local_358 = (mbstate_t *)(uint64_t)(iVar13 - 1);
                    }
                    else {
LAB_00f40d6e:
                  ...
                  param_4 = pmVar34;
                } while ((mbstate_t *)((int64_t)param_3 + (int64_t)pmVar34 * 4 + 4) < pmVar22);
              }
              else {
                bVar46 = false;
              }
switchD_00f40c0d_caseD_2c:
            ...
            pmVar23 = (mbstate_t *)((int64_t)param_3 + (int64_t)pmVar25 * 4);
            if (pmVar22 <= pmVar23) {
              pmVar25 = (mbstate_t *)((int64_t)&MACH_HEADER.cpusubtype + 1);
              goto LAB_00f4200f;
            }
            if (pmVar25 == (mbstate_t *)((int64_t)&MACH_HEADER.magic + 1U)) goto LAB_00f42033;
            pmVar25 = (mbstate_t *)((int64_t)&MACH_HEADER.cpusubtype + 2);
            if ((uVar12 & 1) == 0) {
            ...
            pmVar23 = (mbstate_t *)((int64_t)pmVar23 + lVar27 * 4);
            if (pmVar23 < pmVar22) {
            ...
            if (uVar16 == 0 && uVar31 == 0) {
              ...
              if ((int)(uVar16 & uVar31) < 0) {
                pmVar48 = (mbstate_t *)((int64_t)&MACH_HEADER.magic + 1);
                param_2 = (mbstate_t *)((int64_t)&MACH_HEADER.magic + 1);
              }
              param_3 = (uint *)(uint64_t)local_36c;
              ...
              uVar50 = *(uint64_t *)(local_308->__mbstate8 + 8);
              *(dword *)(this_ptr->__mbstate8 + 0x40) = 1;
...
LAB_00f414ba:
  ...
  case 10:
    dVar15 = FUN_00f42760();
    *(dword *)(this_ptr->__mbstate8 + 0x44) = dVar15;
  }
...
LAB_00f4191b:
    puVar5 = *(uint64_t **)(*(int64_t *)((int64_t)pmVar34 + uVar51 * 8 + -8) + 8);
    puVar33 = (uint *)*puVar5;
    iVar4 = (int)puVar5[1];
    if ((int)puVar33 < iVar13) {
      ...
      *puVar5 = (int64_t)iVar20;
      puVar5[1] = ((int64_t)puVar33 << 0x20) + -0x100000000 >> 0x20;
      *(dword *)(puVar5 + 2) = *(dword *)(this_ptr->__mbstate8 + 0x38);
      param_2 = (mbstate_t *)0x0;
      puVar33 = (uint *)0x0;
      ...
      *(void*)(puVar5[4] + local_350 * 4) = 0;
      iVar13 = iVar20;
      if (local_308 == (mbstate_t *)0x0) {
        local_308 = *(mbstate_t **)((int64_t)pmVar34 + uVar51 * 8 + -8);
        pmVar25 = (mbstate_t *)0x0;
      }
      else {
        param_2 = *(mbstate_t **)((int64_t)pmVar34 + uVar51 * 8 + -8);
...
LAB_00f41cd4:
    puVar33 = *(uint **)(*(int64_t *)((int64_t)pmVar34 + uVar51 * 8 + -8) + 8);
    param_2 = *(mbstate_t **)puVar33;
    dVar3 = (dword)*(qword *)((int64_t)puVar33 + 8);
...
LAB_00f41d71:
      ...
      *(int64_t *)puVar33 = (int64_t)iVar20;
      *(int64_t *)((int64_t)puVar33 + 8) = ((int64_t)param_2 << 0x20) + -0x100000000 >> 0x20;
      iVar20 = dVar3 + 1;
      *(dword *)((int64_t)puVar33 + 0x10) = *(dword *)(this_ptr->__mbstate8 + 0x38);
      *(uint64_t *)((int64_t)puVar33 + 0x20) = 0;
      if (local_308 == (mbstate_t *)0x0) {
        local_308 = *(mbstate_t **)((int64_t)pmVar34 + uVar51 * 8 + -8);
        param_2 = this_ptr;
        goto LAB_00f41d71;
  ...
  while( true ) {
    param_2 = (mbstate_t *)(local_350 * 4);
    _memcpy(puVar33,(mbstate_t *)(local_350 * 4),(size_t)param_3);
    *(void*)(*(int64_t *)(lVar27 + 0x20) + local_350 * 4) = 0;
    if (local_308 == (mbstate_t *)0x0) {
      local_308 = *(mbstate_t **)((int64_t)pmVar34 + uVar51 * 8 + -8);
      pmVar25 = (mbstate_t *)0x0;
    }
...
LAB_00f41b9b:
    lVar27 = *(int64_t *)(*(int64_t *)((int64_t)pmVar34 + uVar51 * 8 + -8) + 8);
    *(dword *)(lVar27 + 0x10) = *(dword *)(this_ptr->__mbstate8 + 0x38);
    param_2 = (mbstate_t *)0x0;
    puVar33 = (uint *)0x0;
    param_3 = (uint *)local_310;
    lVar30 = FUN_00f3f480();
    *(int64_t *)(lVar27 + 0x20) = lVar30;
    if (lVar30 == 0) {
      pmVar25 = (mbstate_t *)&MACH_HEADER.filetype;
      goto LAB_00f413fb;
    }
...
LAB_00f41d95:
    lVar27 = *(int64_t *)(*(int64_t *)((int64_t)pmVar34 + uVar51 * 8 + -8) + 8);
    puVar33 = (uint *)(uint64_t)*(uint *)(this_ptr->__mbstate8 + 0x38);
    *(uint *)(lVar27 + 0x10) = *(uint *)(this_ptr->__mbstate8 + 0x38);
    *(void*)(lVar27 + 0x20) = 0;
    if (local_308 == (mbstate_t *)0x0) {
      local_308 = *(mbstate_t **)((int64_t)pmVar34 + uVar51 * 8 + -8);
      param_2 = this_ptr;
...
LAB_00f41df3:
  if (((int)pmVar25 == 0) && (dVar15 == 0x5e)) {
    ...
    if (pmVar23 != (mbstate_t *)0x0) {
      uVar50 = *(uint64_t *)(pmVar23->__mbstate8 + 8);
      if (bVar55) {
        param_2 = (mbstate_t *)0x0;
        puVar33 = (uint *)0x0;
        lVar27 = FUN_00f3f480();
        *(int64_t *)(uVar50 + 0x20) = lVar27;
        if (lVar27 == 0) {
          pmVar25 = (mbstate_t *)&MACH_HEADER.filetype;
          param_3 = (uint *)local_310;
          goto LAB_00f413fb;
        ...
        *(void*)(*(int64_t *)(uVar50 + 0x20) + local_350 * 4) = 0;
        param_3 = (uint *)local_310;
      }
      else {
        *(void*)(uVar50 + 0x20) = 0;
...
switchD_00f40ed2_caseD_23:
  ...
  do {
    pmVar34 = pmVar23;
    if (pmVar22 <= (mbstate_t *)((int64_t)pmVar34 + -4)) goto LAB_00f42044;
    *(mbstate_t **)pmVar1 = pmVar34;
    pmVar23 = (mbstate_t *)(pmVar34->__mbstate8 + 4);
  } while (*(int *)pmVar34 != 0x29);
  pmVar25 = (mbstate_t *)((int64_t)&MACH_HEADER.magic + 2);
...
LAB_00f3f807:
  ...
  *(uint *)(this_ptr->__mbstate8 + 0x44) = uVar16;
  goto switchD_00f3f6a1_default;
LAB_00f42044:
  pmVar25 = (mbstate_t *)((int64_t)&MACH_HEADER.magic + 2);
  goto LAB_00f4200f;
