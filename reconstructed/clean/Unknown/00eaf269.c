...
uint64_t FUN_00eaf269(int64_t *param_1,uint64_t param_2,uint64_t *param_3,int *param_4)

{
  ...
  if ((int64_t *)(lVar16 + uVar15) <= param_1) {
    ...
    if (*(uint *)(arg1 + 0x2c) < uVar29) {
      ...
      do {
        uVar11 = (uint)uVar15;
        uVar23 = (uint64_t)(*(int64_t *)(lVar16 + uVar15) * -0x30e4432345000000) >>
...
LAB_00eaf436:
    ...
    *(uint *)(arg1 + 0x2c) = (uint)local_70;
    ...
    uVar15 = (uint64_t)(*local_48 * -0x30e4432345000000) >> (-*(char *)(arg1 + 0x108) & 0x3fU)
    ;
    uVar23 = 0;
