...
void FUN_01615660(float param_1,uint64_t param_2,int param_3,uint param_4,int64_t *param_5,
                 char param_6)

{
  ...
  uVar13 = (uint)(g_0241141c / param_1);
  local_128 = FUN_01483610(g_02411408);
  FUN_00c8e690();
  ...
  if (1 < (int)uVar13) {
    uVar14 = 1;
    do {
      fVar18 = (float)_logf((float)(int)uVar14 * param_1 * g_02394204);
      iVar6 = FUN_01483610(fVar18 * g_02394208);
      fVar18 = *(float *)(*(int64_t *)(*local_res18 + 0x10) + (int64_t)iVar6 * 4);
      ...
      *(int *)(*(int64_t *)(local_60 + 0x10) + uVar14 * 4) = iVar17;
  ...
  if ((int)param_4 < 2) {
    ...
    fVar18 = g_02390124 / (float)local_res8;
    local_108 = CONCAT44(local_108._4_4_,param_3 + -2);
    local_f8 = CONCAT44(local_f8._4_4_,in_ECX - 1);
    local_118 = (int64_t)(int)(in_ECX - 1);
    local_100 = (int64_t)(int)uVar13;
    uVar14 = 1;
    iVar6 = 1;
    local_38 = 0;
    bVar4 = false;
    local_110 = (uint64_t)in_ECX;
    do {
      ...
      lVar8 = FUN_015c66c0();
      fVar19 = (float)_logf(*(float *)(lVar8 + uVar14 * 4) * g_02394204);
      local_3c = (float)FUN_014b7610(fVar19 * g_02394208);
      lVar8 = FUN_015c6be0();
      ...
      if (0 < (int)in_ECX) {
        ...
        do {
          ...
          local_3c = local_6c;
          if ((int64_t)uVar16 < local_118) {
            lVar9 = *(int64_t *)(*(int64_t *)(*this_ptr + 0x10) + 8 + uVar16 * 8);
            if (local_38 == lVar9) {
              if ((!bVar5) && (local_38 != 0)) {
                bVar5 = true;
                FUN_00d50b00();
          ...
          lVar9 = FUN_015c66c0();
          fVar21 = (float)_logf(*(float *)(lVar9 + uVar14 * 4) * g_02394204);
          fVar21 = (float)FUN_014b7610(fVar21 * g_02394208);
          lVar9 = FUN_015c6b60();
          ...
          if (0.0 <= local_6c) {
            ...
            if (iVar11 <= (int)local_108) {
              ...
              if ((int64_t)uVar14 < local_100) {
                ...
                *(float *)(*(int64_t *)(local_60 + 0x10) + lVar9 * 4) =
                     fVar22 * (fVar21 - local_6c) + (local_6c - (float)local_120) * fVar20;
                *(float *)(*(int64_t *)(local_60 + 0x10) + lVar9 * 4) = fVar19;
                *(void*)(*(int64_t *)(local_60 + 0x10) + lVar9 * 4) = uVar7;
              }
            }
          }
  ...
  if (4 < (int)in_ECX) {
    local_160 = *(int64_t *)(*local_res20 + 0x10);
    local_158 = *(int64_t *)(*param_5 + 0x10);
    local_150 = (int64_t)param_3;
    local_168 = (uint64_t)(in_ECX - 2);
    local_a8 = (int64_t)(int)uVar13 * 8 + 4;
    uVar14 = 2;
    do {
      uVar16 = uVar14 + 1;
      if (1 < (int)uVar13) {
        ...
        lVar8 = 0;
        do {
          fVar18 = *(float *)(lVar8 + *(int64_t *)(local_60 + 0x10) + local_a8);
          fVar19 = *(float *)(lVar8 + *(int64_t *)(local_60 + 0x10) + local_a8) * fVar18;
          uVar26 = *(void*)(lVar8 + *(int64_t *)(local_60 + 0x10) + local_a8);
          uVar27 = *(void*)(*(int64_t *)(local_60 + 0x10) + 4 + lVar8);
          uVar10 = FUN_00e84250();
          FUN_015c31c0(fVar18 * g_02394214,uVar26,uVar27);
          FUN_015c31c0(fVar19 * g_02394214,uVar26,uVar27);
          fVar20 = fVar18 * g_02391094;
          FUN_015c31c0(fVar20,uVar26,uVar27);
          local_148._0_4_ = fVar19 * g_02391094;
          local_1d0 = uVar10;
          ...
          lVar8 = lVar8 + 4;
        } while ((uint64_t)uVar13 * 4 + -4 != lVar8);
      }
      local_a8 = local_a8 + (int64_t)(int)uVar13 * 4;
      uVar14 = uVar16;
  ...
  if (((param_6 != '\0') && (0 < (int)in_ECX)) && (-10 < (int)local_128)) {
    ...
    lVar8 = *(int64_t *)(*local_res20 + 0x10);
    uVar16 = 0;
    uVar14 = (uint64_t)(iVar6 + 1);
    lVar12 = lVar9;
    do {
      do {
        fVar19 = *(float *)(lVar8 + lVar9);
        if (fVar18 <= fVar19) {
          *(float *)(*(int64_t *)(*param_5 + 0x10) + lVar9) =
               *(float *)(*(int64_t *)(*param_5 + 0x10) + lVar9) / fVar19;
        }
        lVar9 = lVar9 + 4;
        uVar14 = uVar14 - 1;
      } while (uVar14 != 0);
      uVar16 = uVar16 + 1;
      lVar9 = lVar12 + (int64_t)param_3 * 4;
      uVar14 = (uint64_t)(iVar6 + 1);
      lVar12 = lVar9;
    } while (uVar16 != in_ECX);
  }
