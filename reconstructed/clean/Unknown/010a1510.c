...
int64_t FUN_010a1510(EVP_PKEY *param_1,EVP_PKEY *param_2,uint64_t param_3,int *param_4)

{
  ...
  length = (long)param_4;
  uVar10 = (uint32_t)((uint64_t)param_3 >> 0x20);
  len = (long)param_3;
  local_60 = param_2;
  local_48 = param_1;
  local_38 = param_4;
  if (this_ptr == 0) {
    ...
    if (pEVar6 == (ENGINE *)0x0) {
      ...
      local_40 = (EVP_PKEY *)0x0;
      do {
        pcVar7 = _ENGINE_get_pkey_asn1_meths();
        if (pcVar7 != 0x0) {
          ...
          if (0 < (int)uVar2) {
            ...
            do {
              local_58 = 0;
              param_1 = (EVP_PKEY *)(uint64_t)(uint)(&local_50->type)[uVar11];
              local_68 = param_2;
