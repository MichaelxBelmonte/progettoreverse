...

{
  ...
  iVar20 = (**(code **)(*arg1 + 0x30))(0xd,8);
  iVar21 = (**(code **)(*arg1 + 0x90))();
  iVar22 = (**(code **)(*arg1 + 0x38))();
  iVar23 = (**(code **)(*arg1 + 0x30))(0x14,0xf);
  iVar24 = (**(code **)(*arg1 + 0x58))();
  ...
  for (lVar25 = *(int64_t *)(this_ptr + 0x50); lVar25 != *(int64_t *)(this_ptr + 0x58);
      lVar25 = lVar25 + 1) {
  ...
  iVar3 = (**(code **)(*arg1 + 0x30))(0x15,8);
  iVar4 = (**(code **)(*arg1 + 0x90))();
  iVar5 = (**(code **)(*arg1 + 0x38))();
  iVar6 = (**(code **)(*arg1 + 0x30))(0x16,8);
  ...
  *(int *)((int64_t)arg1 + 0x1c) = *(int *)((int64_t)arg1 + 0x1c) + -1;
  return iVar1 + iVar24 + iVar2 + iVar3 + iVar4 + iVar5 + iVar6 + iVar7 + iVar8 + iVar9 + iVar10;
}
