...
int FUN_010b6910(uint64_t param_1,ASN1_ITEM *param_2,size_t param_3,ASN1_ITEM *param_4)

{
  ...
  uVar8 = 0;
  lVar6 = 0;
  if (0xfffff < (int64_t)param_2) {
    param_2 = (ASN1_ITEM *)&LAB_00100000;
  }
  a = (BUF_MEM *)&g_025b71f8;
  lVar7 = lVar4;
  iVar1 = _ASN1_item_ex_d2i((ASN1_VALUE **)&g_025b71f8,(uchar **)param_2,param_3,param_4,0,
