...

{
  ...
  iVar23 = (**(code **)(*arg1 + 0x30))(0x10,0xb);
  ...
  iVar44 = (**(code **)(*arg1 + 0x30))(0x17,0xf);
  iVar45 = (**(code **)(*arg1 + 0x58))();
  iVar45 = iVar2 + iVar1 + iVar3 + iVar4 + iVar5 + iVar6 + iVar7 + iVar8 + iVar9 + iVar10 + iVar11 +
  ...
  for (plVar46 = *(int64_t **)(this_ptr + 0x130); plVar46 != *(int64_t **)(this_ptr + 0x138);
      plVar46 = plVar46 + 4) {
    iVar1 = (**(code **)(*plVar46 + 0x18))();
    iVar45 = iVar45 + iVar1;
  }
  ...
  *(int *)((int64_t)arg1 + 0x1c) = *(int *)((int64_t)arg1 + 0x1c) + -1;
  return iVar1 + iVar45 + iVar2 + iVar3 + iVar4;
}
