...
void FUN_00a2c52c(uint64_t param_1,uint64_t param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a2c5a9:
    if ((plVar16 == plVar4) || ((int64_t)plVar16 - (int64_t)plVar3 == -8)) goto LAB_00a2c5b7;
    lVar17 = (int64_t)plVar16 - (int64_t)plVar3 >> 3;
  }
  else {
    do {
      if (*plVar16 == *(int64_t *)(arg1 + 0x10)) goto LAB_00a2c5a9;
      plVar16 = plVar16 + 1;
...
LAB_00a2c5b7:
  ...
  *(int64_t *)((int64_t)pvVar11 + 0x18) = lVar9 + lVar17 * 8 + ((int64_t)pvVar10 >> 3) * 8;
  lVar14 = lVar17 * 0x130 + *(int64_t *)((int64_t)pvVar8 + 0x48);
  lVar12 = lVar14 + 0x130;
