...
void FUN_00987cb0(uint64_t param_1,void*param_2,uint64_t param_3,uint64_t param_4)

{
  ...
  lVar5 = (uint64_t)(byte)arg1[3] * 10 + 0xc + (uint64_t)(byte)arg1[2] * 4;
  if ((param_2 == (void*)0x0) || (iVar8 = (int)param_2[2], iVar8 == 0)) {
    iVar8 = 0;
  }
  else {
    lVar5 = lVar5 + (uint64_t)(iVar8 * 4 + 4);
  }
  if (lVar5 != 0) {
    uVar9 = FUN_00958ec0();
  }
  MACH_HEADER.magic._0_1_ = *arg1;
  MACH_HEADER.magic._1_1_ = arg1[1];
  MACH_HEADER.magic._2_1_ = arg1[2];
  MACH_HEADER.magic._3_1_ = arg1[3];
  ...
  if (arg1[3] != '\0') {
    ...
    do {
      uVar9 = FUN_0098283e(uVar9,4);
      uVar9 = FUN_0098283e(uVar9,4);
      *(char *)(lVar5 + 8) = arg1[uVar7 + 0x6c];
      *(char *)(lVar5 + 9) = arg1[uVar7 + 0x74];
      uVar7 = uVar7 + 1;
      lVar5 = lVar5 + 10;
    } while (uVar7 < (byte)arg1[3]);
  }
  if (iVar8 != 0) {
    uVar9 = FUN_0098283e(uVar9,4);
    puVar6 = (void*)*param_2;
