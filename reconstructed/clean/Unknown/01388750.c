...

{
  ...
  if (lVar1 != 0) {
    if (0 < *(int *)(lVar1 + 0xc)) {
      ...
      do {
        iVar12 = (int)uVar9;
        lVar14 = *(int64_t *)(*(int64_t *)(lVar1 + 0x10) + uVar9 * 8);
...
LAB_013888e5:
          ...
          FUN_00d50b20();
          local_40 = lVar13;
          if ((cVar6 != '\0') || (local_60 = *(int64_t *)(lVar14 + 0x18), local_60 == 0))
          goto LAB_01388a00;
          FUN_00d50b00();
          bVar4 = false;
...
LAB_01388e2c:
          ...
          uVar9 = CONCAT71((int7)(uVar9 >> 8),1);
          uVar11 = *(uint *)(*(int64_t *)(lVar14 + 0x28) + 0xc);
joined_r0x01388ea6:
          if (0 < (int)uVar11) {
          ...
          FUN_00d50b20();
          local_40 = lVar13;
          if ((cVar6 != '\0') || (local_68 = *(int64_t *)(lVar14 + 0x10), local_68 == 0))
          goto LAB_013888c0;
          FUN_00d50b00();
          bVar5 = false;
          lVar13 = *(int64_t *)(lVar14 + 0x18);
...
LAB_01388990:
          pVar8 = (void*)uVar9;
          if (local_60 != 0) {
            if (*(int64_t *)(lVar14 + 0x10) == 0) goto LAB_01388b20;
...
LAB_01388e92:
        ...
        cVar6 = (char)uVar9;
        if ((cVar6 == '\0') &&
           (uVar11 = *(uint *)(*(int64_t *)(lVar14 + 0x28) + 0xc), 0 < (int)uVar11)) {
          lVar14 = (uint64_t)uVar11 + 1;
          do {
            pvVar7 = _pthread_getspecific((void*)uVar9);
            if (pvVar7 != (void *)0x0) {
              FUN_00e8b990();
