...
uint32_t FUN_010709f0(BIGNUM *param_1,BIGNUM *param_2,BIGNUM *param_3,BN_CTX *param_4)
...
LAB_01070b95:
      ...
      if ((0 < iVar2) && (pBVar4 = _BN_bin2bn((uchar *)a,(int)b,ret), pBVar4 != (BIGNUM *)0x0)) {
        ...
        if (((param_1[4].flags & 2) == 0) ||
          ...
          a = (char *)param_1[1].d;
          iVar2 = (**(code **)(*(int64_t *)&param_1->top + 0x30))(a,uVar1,pmont,param_1[5].d);
          if (iVar2 != 0) {
            uVar3 = _BN_bn2binpad();
            goto LAB_01070ba2;
          }
