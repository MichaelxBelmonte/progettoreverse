...

{
  ...
  if ((double)local_78 / (double)local_70 <= g_024119d8) {
    if ((double)local_78 / (double)local_70 < g_024119e0) {
      local_b8 = FUN_00e7bcc0();
    }
  }
  else {
  ...
  puVar12 = &g_02572358;
  local_f8 = &g_02572358;
  *(void**)pcVar4 = &g_02572358;
  local_100 = g_02572370;
  (*g_02572370)();
  pVar11 = (void*)puVar12;
  local_70 = pcVar4;
  if (0 < *(int *)(*(int64_t *)(this_ptr + 0x60) + 0xc)) {
    lVar15 = 0;
    do {
      pVar11 = (void*)puVar12;
      ...
      lVar15 = lVar15 + 1;
      pVar11 = *(void* *)(*(int64_t *)(this_ptr + 0x60) + 0xc);
      puVar12 = (void*)(int64_t)(int)pVar11;
    } while (lVar15 < (int64_t)puVar12);
  }
  pvVar2 = _pthread_getspecific(pVar11);
  if (pvVar2 != (void *)0x0) {
    FUN_00e8b990();
  ...
  local_90 = local_48;
  pcVar4 = (char *)**(void**)(local_48 + 0x10);
  if (pcVar4 != (char *)0x0) {
    FUN_00d50b00();
  }
  local_80 = pcVar4;
  ...
  FUN_00e7bcc0();
  local_78 = (char *)((double)local_78 + (g_02410f70 / local_98) * local_c0 * g_024119e8);
  ...
  FUN_00e7b820();
  pvVar2 = _pthread_getspecific((void*)pcVar10);
  if ((pvVar2 != (void *)0x0) && (lVar15 = FUN_00e8b990(), lVar15 != 0)) {
    pcVar10 = local_80;
  }
  ...
  local_88 = (char *)**(void**)(*(int64_t *)(this_ptr + 0x60) + 0x10);
...
LAB_016f35bf:
  ...
  local_78 = (char *)((double)local_78 + (g_02410f70 / local_c0) * dVar18 * g_024119e8);
  local_b0 = uVar3;
  while( true ) {
    pvVar2 = _pthread_getspecific((void*)pcVar10);
    if (pvVar2 != (void *)0x0) {
      ...
      if (2 < *(int *)(local_90 + 0xc)) {
        ...
        *pcVar5 = '\0';
        ...
        if (0 < (int)uVar14) {
          ...
          do {
            ...
            lVar7 = *(int64_t *)(lVar8 + (uint64_t)uVar14 * 8);
            if (lVar7 != 0) {
              FUN_00d50b00();
            }
            pVar11 = (void*)lVar8;
          ...
          if (0 < *(int *)(local_70 + 0xc)) {
            lVar15 = 0;
            do {
              lVar8 = *(int64_t *)(*(int64_t *)(local_70 + 0x10) + lVar15 * 8);
              pcVar4 = local_70;
              if (lVar8 != 0) {
                FUN_00d50b00();
              }
        ...
        if (pvVar2 != (void *)0x0) {
          ...
          lVar8 = FUN_00e8b990();
          if (lVar8 != 0) {
            lVar15 = *(int64_t *)(lVar15 + 0x20 + (uint64_t)(*(uint *)(lVar8 + 0x154) & 1) * 8);
          }
        }
        ...
        *puVar9 = local_f8;
        ...
        if (0 < *(int *)(pcVar4 + 0xc)) {
          lVar15 = 0;
          do {
            lVar8 = *(int64_t *)(*(int64_t *)(pcVar4 + 0x10) + lVar15 * 8);
            if (lVar8 != 0) {
              FUN_00d50b00();
            }
            pVar11 = (void*)pcVar4;
        ...
        if (0 < *(int *)((int64_t)puVar9 + 0xc)) {
          lVar15 = 0;
          do {
            local_48 = *(uint64_t *)(puVar9[2] + lVar15 * 8);
            puVar13 = puVar9;
            if (local_48 != 0) {
              FUN_00d50b00();
            }
            pvVar2 = _pthread_getspecific((void*)puVar13);
            if (pvVar2 != (void *)0x0) {
              FUN_00e8b990();
            }
            local_60 = FUN_01909dc0();
            ...
            lVar15 = lVar15 + 1;
          } while (lVar15 < *(int *)((int64_t)puVar9 + 0xc));
        }
        ...
        pcVar4 = local_78;
        iVar16 = *(int *)(*(int64_t *)(this_ptr + 0x60) + 0xc);
        while (iVar16 != 0) {
          uVar3 = FUN_00d23340();
