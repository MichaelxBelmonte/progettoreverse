...
LAB_01d3a99e:
    bVar5 = local_38 == (int64_t *)0x0;
    if ((!bVar5) && (unaff_SIL == '\0')) {
      if (*(int *)((int64_t)local_38 + 0xdc) == 0) {
        FUN_01f45600();
        unaff_SIL = local_38 != (int64_t *)0x0;
  ...
  if (!bVar5) {
    ...
    if (cVar4 != '\0') {
      g_02802f80 = (double)FUN_00e7d6f0();
      FUN_01d3a740();
      (**(code **)(*local_38 + 0x4d8))();
      FUN_01d3a740();
      dVar6 = (double)FUN_00e7d6f0();
      g_02802f78 = (float)((dVar6 - g_02802f80) / g_02422df0);
    }
  }
  if (*this_ptr != 0) {
    uVar2 = *(uint *)(*this_ptr + 0xc);
    if ((uVar2 < 6) && ((0x3aU >> (uVar2 & 0x1f) & 1) != 0)) goto LAB_01d3aaf6;
    if ((unaff_SIL == '\0') && ((g_02802f70 == 0 && (FUN_01d3a740(), !bVar5)))) {
      (**(code **)(*local_38 + 0x698))();
    }
    if (*this_ptr != 0) goto LAB_01d3aaf6;
  }
  if (((unaff_SIL == '\0') && (g_02802f70 == 0)) && (FUN_01d3a740(), !bVar5)) {
    (**(code **)(*local_38 + 0x698))();
  }
