...
int FUN_010a39d0(char *param_1,uint64_t param_2,int64_t param_3,uint64_t param_4)

{
  ...
  uVar10 = (uint32_t)((uint64_t)param_4 >> 0x20);
  iVar9 = (int)param_4;
  iVar2 = (int)unaff_R12;
  if (param_1 == (char *)0x0) {
    func = 0x43;
...
LAB_010a3bf0:
  ...
  *(int64_t *)(piVar4 + 2) = arg1;
  piVar4[0x10] = (uint)(iVar9 != 0);
  piVar4[4] = local_res8;
  *piVar4 = 3;
  *(int64_t *)(piVar4 + 6) = local_res10;
  if (*(int64_t *)((int64_t)this_ptr + 8) == 0) {
    lVar7 = _OPENSSL_sk_new_null();
    *(int64_t *)((int64_t)this_ptr + 8) = lVar7;
    if (lVar7 == 0) {
      if (((*(byte *)(piVar4 + 0x10) & 1) != 0) && (_CRYPTO_free(this_ptr), *piVar4 == 3)) {
        _CRYPTO_free(this_ptr);
        _CRYPTO_free(this_ptr);
        _CRYPTO_free(this_ptr);
      }
      goto LAB_010a3b61;
  ...
  *(void*)(piVar4 + 10) = param_2;
  *(char **)(piVar4 + 0xc) = param_1;
  *(int64_t *)(piVar4 + 0xe) = param_3;
