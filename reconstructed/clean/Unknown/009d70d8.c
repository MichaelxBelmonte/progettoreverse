...

{
  ...
  pcVar6 = local_48;
  if ((local_50[0] & 1) == 0) {
    pcVar6 = (char *)(uint64_t)(local_50[0] >> 1);
  }
  ...
  local_36 = 0x41;
  FUN_009d76b8((int64_t)&local_36 + 1,&local_36);
  pcVar6 = (char *)((int64_t)&local_34 + 1);
  local_34 = 0x3b;
...
LAB_009d72a5:
    ...
    uVar9 = local_40;
    if (bVar12) {
      uVar9 = (uint64_t)local_50 | 1;
    }
    lVar8 = 0;
    do {
      if (((int)uVar7 < lVar8) ||
         (pcVar6 = (char *)CONCAT71((int7)((uint64_t)pcVar6 >> 8),*(char *)(uVar9 + lVar8)),
...
LAB_009d7205:
    ...
    if (iVar3 + -1 == 0) {
LAB_009d7263:
      pcVar6 = (char *)CONCAT71((int7)((uint64_t)pcVar6 >> 8),1);
      if ((local_50[0] & 1) == 0) {
        local_48 = (char *)(uint64_t)(local_50[0] >> 1);
      }
      if ((local_68[0] & 1) == 0) {
        local_60 = (char *)(uint64_t)(local_68[0] >> 1);
      }
      if (local_48 != local_60) goto LAB_009d72a5;
      if ((local_80 & 1) == 0) {
        local_78 = (char *)(uint64_t)(local_80 >> 1);
      }
      uVar11 = 0;
      if (local_48 == local_78) {
        uVar11 = (uint8_t)lVar8;
      }
      cVar10 = (local_48 != local_78) * '\x02' + '\x01';
      pcVar6 = local_78;
    }
    else {
      uVar11 = *(void*)(uVar9 + (int64_t)(iVar3 + -1));
      iVar3 = FUN_009d78a6();
      iVar5 = FUN_009d78a6();
