...
void FUN_00982878(string *param_1,string *param_2,int64_t param_3)

{
  ...
  uVar15 = (uint64_t)param_1 & 0xffffffff;
  psVar8 = param_1;
  lVar14 = param_3;
  ...
  do {
    ...
    if (cVar6 == '\0') {
      if ((char)this_ptr[5] != '\0') {
        ...
        puVar9 = (uint64_t *)std::string::insert(uVar12,pcVar13,(ulong)lVar14);
        uVar2 = *puVar9;
        *puVar9 = 0;
        puVar9[1] = 0;
        puVar9[2] = 0;
      ...
      *(string *)(plVar10 + 1) = *local_58;
      ...
      if (*local_58 == (string)0x3) {
        ...
        psVar16 = psVar16 + 1;
        local_44 = local_44 + 1;
        local_50 = (string *)(uint64_t)((int)local_50 - 1);
      }
      if ((char)this_ptr[5] != '\0') {
        FUN_009824a2();
        if ((local_70 & 1) == 0) {
        ...
        *puVar9 = 0;
        puVar9[1] = 0;
        puVar9[2] = 0;
        psVar8 = (string *)(uint64_t)local_44;
        pcVar13 = (char *)local_58;
        FUN_0098242c();
        if ((uVar3 & 1) != 0) {
          operator_delete(pcVar13);
      ...
      *(string *)(plVar10 + 1) = *local_58;
      if ((int)psVar5 == 0) {
        ...
        lVar14 = param_3;
        (**(code **)(*this_ptr + 0x30))(local_50,psVar16,param_3,local_128);
        if ((local_128[0] & 1) != 0) {
          operator_delete(pcVar13);
        }
