...
uint64_t FUN_00e14140(uint64_t param_1,uint64_t param_2)
...
joined_r0x00e1428a:
      plVar6 = plVar7;
      if (((char)local_98 != '\0') && (plVar5 != (void*)0x0)) {
        FUN_00d50b20();
      }
    }
    else {
...
LAB_00e14465:
  ...
  plVar5 = local_a0;
  if ((char)local_98 == '\0') {
    if (local_a0 == (int64_t *)0x0) goto LAB_00e149c2;
    FUN_00d50b00();
    if (((char)local_98 != '\0') && (local_a0 != (int64_t *)0x0)) {
      FUN_00d50b20();
    }
  }
  else if (local_a0 == (int64_t *)0x0) goto LAB_00e149c2;
  local_58 = '\0';
  local_60 = (void*)0x0;
  local_50 = plVar5[2];
  local_48 = 0;
  if (0 < *(int *)(local_50 + 0xc)) {
    do {
      local_38 = puVar4;
      local_40 = plVar7;
      local_60 = *(void**)(*(int64_t *)(local_50 + 0x10) + (int64_t)local_48 * 8);
      FUN_00e16a80();
      FUN_00e6fcd0();
      local_b0 = local_60;
      local_110 = local_e8;
...
LAB_00e149c2:
  ...
  if (cVar3 == '\0') {
    ...
    if (plVar6 == (int64_t *)0x0) {
      ...
      local_a8 = 1;
      local_b0 = &g_024cc6f0;
      FUN_00d8cb40(&g_024cc6f0,&local_b0);
      puVar2 = local_60;
      if (local_58 == '\0') {
        if (local_60 != (void*)0x0) {
          FUN_00d50b00();
