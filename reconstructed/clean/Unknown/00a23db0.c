...
void FUN_00a23db0(uint64_t param_1,uint64_t param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a23e2d:
    if ((plVar17 == plVar4) || ((int64_t)plVar17 - (int64_t)plVar3 == -8)) goto LAB_00a23e3b;
    lVar18 = (int64_t)plVar17 - (int64_t)plVar3 >> 3;
  }
  else {
    do {
      if (*plVar17 == *(int64_t *)(arg1 + 0x10)) goto LAB_00a23e2d;
      plVar17 = plVar17 + 1;
...
LAB_00a23e3b:
  ...
  *(int64_t *)(lVar11 + 0x18) = lVar5 + lVar18 * 8 + ((int64_t)pvVar12 >> 3) * 8;
  ...
  pvVar13 = (void *)((int64_t)pvVar10 + lVar18 * 0x120);
  pvVar12 = (void *)((int64_t)pvVar10 + lVar18 * 0x120 + 0x120);
  pvVar16 = pvVar13;
  if (pvVar12 != pvVar6) {
    do {
      pvVar16 = (void *)((int64_t)pvVar13 + 0x120);
      FUN_00a66214();
      sVar15 = (size_t)param_3;
      pvVar12 = (void *)((int64_t)pvVar13 + 0x240);
      pvVar13 = pvVar16;
  ...
  do {
    puVar1 = (void*)((int64_t)pvVar12 + -0x120);
    pvVar12 = (void *)((int64_t)pvVar12 + -0x120);
    (**(code **)*puVar1)();
    sVar15 = (size_t)param_3;
