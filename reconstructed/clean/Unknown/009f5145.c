...
int64_t * FUN_009f5145(ulong param_1,uint64_t param_2,uint64_t param_3,ulong param_4)

{
  ...
  do {
    FUN_009f58f0();
    pvVar8 = (void *)CONCAT71((int7)((uint64_t)pbVar7 >> 8),local_98);
    ...
    if (bVar12) {
      ...
      if (cVar2 == '-') {
        ...
        puVar10 = (void*)(lVar5 + -0x7ffffffffffffffe);
        if ((void*)((int64_t)&MACH_HEADER.magic + 2) < puVar10) {
          lVar5 = -lVar5;
        }
        else {
          lVar5 = FUN_009f6358();
...
LAB_009f573b:
      ...
      break;
    case 1:
      local_58 = (uint64_t)local_58._2_6_ << 0x10;
      local_158 = local_80;
      if ((local_90 & 1) == 0) {
        local_158 = local_8f;
      }
    ...
    case 3:
      ...
      if ((int)uVar3 < 6) {
        ...
        local_158 = local_48;
        if ((local_58 & 1) == 0) {
          local_158 = (bad_cast *)((int64_t)&local_58 + 1);
        }
        pbVar9 = local_158;
        cVar2 = FUN_009f5ffe();
        if (cVar2 == '\0') {
