// Function: FUN_01090740
// Address: 01090740
// Size: 5135 bytes
// Class: Unknown

void FUN_01090740(uint64_t param_1,int64_t param_2)

{
  ...
  uint8_t auVar30 [32];
  uint8_t auVar31 [32];
  uint8_t auStack_250 [544];
  
  uVar11 = (uint64_t)auStack_250 & 0xfffffffffffffc00;
  pauVar1 = (uint8_t (*) [32])(arg1 + param_2 * 0x40);
  pauVar12 = (uint8_t (*) [32])(uVar11 + 0x1c0);
  *(int **)(uVar11 + 0x200) = this_ptr;
  *(int64_t *)(uVar11 + 0x208) = arg1;
  *(uint8_t (**) [32])(uVar11 + 0x210) = pauVar1;
  *(BADSPACEBASE **)(uVar11 + 0x218) = register0x00000020;
  auVar4 = g_0108e5c0;
  auVar3 = g_0108e5a0;
  pauVar14 = (uint8_t (*) [32])(arg1 + 0x40);
  iVar6 = *this_ptr;
  uVar10 = this_ptr[1];
  uVar8 = this_ptr[2];
  pauVar20 = pauVar14;
  if (pauVar14 == pauVar1) {
    pauVar20 = (uint8_t (*) [32])(uVar11 + 0x1c0);
  }
  uVar9 = this_ptr[3];
  uVar16 = this_ptr[4];
  uVar17 = this_ptr[5];
  ...
  do {
    auVar21._0_16_ =
         ZEXT116(0) * *(uint8_t (*) [16])*pauVar20 +
         ZEXT116(1) * *(uint8_t (*) [16])pauVar14[-2];
    auVar21._16_16_ =
         ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) +
         ZEXT116(1) * *(uint8_t (*) [16])*pauVar20;
    auVar31._0_16_ =
         ZEXT116(0) * *(uint8_t (*) [16])(*pauVar20 + 0x10) +
         ZEXT116(1) * *(uint8_t (*) [16])(pauVar14[-2] + 0x10);
    auVar31._16_16_ =
         ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) +
         ZEXT116(1) * *(uint8_t (*) [16])(*pauVar20 + 0x10);
    auVar25 = vpshufb_avx2(auVar21,g_0108e580);
    auVar22._0_16_ =
         ZEXT116(0) * *(uint8_t (*) [16])pauVar20[1] +
         ZEXT116(1) * *(uint8_t (*) [16])pauVar14[-1];
    auVar22._16_16_ =
         ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) +
         ZEXT116(1) * *(uint8_t (*) [16])pauVar20[1];
    auVar27 = vpshufb_avx2(auVar31,g_0108e580);
    auVar23._0_16_ =
         ZEXT116(0) * *(uint8_t (*) [16])(pauVar20[1] + 0x10) +
         ZEXT116(1) * *(uint8_t (*) [16])(pauVar14[-1] + 0x10);
    auVar23._16_16_ =
         ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) +
         ZEXT116(1) * *(uint8_t (*) [16])(pauVar20[1] + 0x10);
    auVar28 = vpshufb_avx2(auVar22,g_0108e580);
    auVar21 = vpaddd_avx2(auVar25,g_0108e380);
    auVar29 = vpshufb_avx2(auVar23,g_0108e580);
    auVar31 = vpaddd_avx2(auVar27,g_0108e3a0);
    auVar22 = vpaddd_avx2(auVar28,g_0108e3c0);
    auVar23 = vpaddd_avx2(auVar29,g_0108e3e0);
    *pauVar12 = auVar21;
    uVar5 = 0;
    pauVar12[1] = auVar31;
    *(void*)(pauVar12[-3] + 0x18) = *(void*)(pauVar12[2] + 0x18);
    pauVar12[-2] = auVar22;
    uVar15 = uVar10 ^ uVar8;
    pauVar12[-1] = auVar23;
    pauVar1 = pauVar12 + -2;
    pauVar12 = (uint8_t (*) [32])&g_0108e400;
    do {
      pauVar13 = pauVar1;
      *(void*)(pauVar13[-3] + 0x18) = *(void*)(pauVar13[-1] + 0x18);
      ...
      pauVar13[-1] = auVar21;
      pauVar1 = pauVar13 + -4;
      *(void*)(pauVar13[-5] + 0x18) = *(void*)(pauVar13[-3] + 0x18);
      ...
      *pauVar1 = auVar21;
      ...
      pauVar20 = pauVar12 + 4;
      pauVar12 = pauVar12 + 4;
    } while (*(char *)((int64_t)*pauVar20 + 3) != '\0');
    uVar5 = iVar6 + uVar5;
    iVar6 = uVar19 + *(int *)pauVar13[-2] + (uVar17 & uVar16) + (~uVar16 & uVar18) +
            ((uVar16 >> 0x19 | uVar16 * 0x80) ^ (uVar16 >> 0xb | uVar16 * 0x200000) ^
            (uVar16 >> 6 | uVar16 * 0x4000000));
    ...
    *piVar2 = iVar7;
    ...
    piVar2[6] = uVar18;
    piVar2[7] = uVar19;
    if (pauVar14 == *(uint8_t (**) [32])(pauVar13[0xc] + 0x10)) {
      return;
    }
    uVar5 = 0;
    uVar15 = uVar10 ^ uVar8;
    ...
    uVar18 = uVar18 + piVar2[6];
    uVar19 = uVar19 + piVar2[7];
    pauVar1 = *(uint8_t (**) [32])(pauVar13[0xc] + 0x10);
    *piVar2 = iVar6;
    pauVar20 = pauVar14;
    if (pauVar14 == pauVar1) {
      pauVar20 = pauVar12;
