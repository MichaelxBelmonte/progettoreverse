...
int FUN_01c5faf0(uint64_t param_1)

{
  ...
  if (cVar1 != '\0') {
    ...
    if (cVar1 == '\0') {
      ...
      dVar10 = g_02394dd0 + dVar6;
      iVar4 = 0;
      if (dVar10 <= dVar5) {
        dVar7 = dVar7 + g_0238fee8;
        dVar11 = g_023942d0 + dVar7;
        if (dVar5 <= dVar11) {
          cVar1 = FUN_016bf500();
          iVar4 = 3;
          if ((cVar1 == '\0') && (cVar1 = FUN_016bf530(), cVar1 == '\0')) {
            ...
            dVar8 = (dVar11 - dVar10) * g_023934c8;
            dVar10 = dVar10 + dVar8;
            dVar9 = dVar6 + g_023942d0;
            if (dVar6 + g_023942d0 <= dVar10) {
              dVar9 = dVar10;
            }
            iVar4 = 2;
            if (dVar9 <= dVar5) {
              dVar11 = dVar11 - dVar8;
              dVar7 = dVar7 + g_02394dd0;
              if (dVar11 <= dVar7) {
                dVar7 = dVar11;
              }
