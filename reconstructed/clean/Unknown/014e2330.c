...
uint64_t FUN_014e2330(double param_1,double param_2)

{
  ...
  local_88 = param_1;
  pvVar39 = _pthread_getspecific((void*)in_RCX);
  if (pvVar39 != (void *)0x0) {
    FUN_00e8b990();
  }
  FUN_0132d790();
  ...
  FUN_00d23340();
  plVar52 = local_48;
  pVar45 = (void*)CONCAT71((int7)((uint64_t)in_RCX >> 8),local_40[0]);
  plVar48 = &local_98;
  if (local_40[0] != '\0') {
    plVar48 = (int64_t *)local_40;
  }
  local_98 = CONCAT71(local_98._1_7_,local_40[0]);
  *(char *)plVar48 = '\0';
  if ((local_40[0] != '\0') && (plVar52 != (int64_t *)0x0)) {
    FUN_00d50b20();
  }
  local_78 = (int64_t *)FUN_0134c2c0();
  if ((char)local_98 != '\0') {
    FUN_00d50b20();
  }
  ...
  if ((pvVar39 != (void *)0x0) && (lVar41 = FUN_00e8b990(), plVar52 = plVar48, lVar41 != 0)) {
    plVar52 = (int64_t *)plVar48[(uint64_t)(*(uint *)(lVar41 + 0x154) & 1) + 4];
  }
  local_60 = (int64_t *)(**(code **)(*plVar52 + 0x370))();
  if ((local_40[0] != '\0') && (local_48 != (int64_t *)0x0)) {
    FUN_00d50b20();
  }
  uVar59 = *(uint *)(*this_ptr + 0xc);
  uVar44 = (uint64_t)uVar59;
  FUN_00c8e690();
  plVar52 = local_48;
  if ((((local_40[0] == '\0') && (local_48 != (int64_t *)0x0)) &&
  ...
  if (0 < (int)uVar59) {
    ...
    if (uVar44 - 1 < 3) {
      ...
      uVar43 = 0;
      do {
        *(void*)(lVar54 + uVar43 * 4) =
             *(void*)(*(int64_t *)(lVar41 + uVar43 * 8) + 0x14);
        *(void*)(lVar54 + 4 + uVar43 * 4) =
             *(void*)(*(int64_t *)(lVar41 + 8 + uVar43 * 8) + 0x14);
        *(void*)(lVar54 + 8 + uVar43 * 4) =
             *(void*)(*(int64_t *)(lVar41 + 0x10 + uVar43 * 8) + 0x14);
        *(void*)(lVar54 + 0xc + uVar43 * 4) =
             *(void*)(*(int64_t *)(lVar41 + 0x18 + uVar43 * 8) + 0x14);
        uVar43 = uVar43 + 4;
      } while ((uVar59 & 0xfffffffc) != uVar43);
    }
    plVar52 = local_70;
    if ((uint64_t)(uVar59 & 3) != 0) {
      uVar53 = 0;
      do {
        *(void*)(lVar54 + uVar43 * 4 + uVar53 * 4) =
             *(void*)(*(int64_t *)(lVar41 + uVar43 * 8 + uVar53 * 8) + 0x14);
        uVar53 = uVar53 + 1;
  ...
  *puVar42 = &g_025f0d98;
  ...
  puVar42[7] = 0;
  (*g_025f0db0)();
  local_50 = (int64_t *)CONCAT44(local_50._4_4_,(float)local_80);
  FUN_015c1500(g_0240e348 / (float)local_80,uVar44,1);
  plVar48 = local_68;
  fVar57 = g_0240d3b4 / local_50._0_4_;
  if ((int)uVar59 < 2) {
    puVar47 = (void*)local_68[2];
  }
  else {
    puVar6 = (void*)plVar52[2];
    puVar47 = (void*)local_68[2];
    uVar43 = uVar44 - 1;
    uVar53 = 1;
...
LAB_014e2887:
        uVar49 = lVar41 * 4 | 4;
        pfVar1 = (float *)((int64_t)puVar6 + uVar49);
        fVar10 = pfVar1[1];
        fVar11 = pfVar1[2];
        fVar12 = pfVar1[3];
        pfVar3 = (float *)((int64_t)puVar6 + uVar49 + 0x10);
        fVar13 = *pfVar3;
        fVar14 = pfVar3[1];
        fVar15 = pfVar3[2];
        fVar16 = pfVar3[3];
...
LAB_014e2a36:
  pVar45 = (void*)uVar53;
  FUN_015b3350(g_023908ec,uVar44);
  plVar52 = local_48;
  if ((((local_40[0] == '\0') && (local_48 != (int64_t *)0x0)) &&
      (FUN_00d50b00(), local_40[0] != '\0')) && (local_48 != (int64_t *)0x0)) {
    FUN_00d50b20();
  ...
  pvVar39 = (void *)(uint64_t)*(uint *)((int64_t)local_50 + 0xc);
  if (-1 < (int)*(uint *)((int64_t)local_50 + 0xc)) {
    local_58 = (int64_t *)((double)((int64_t)local_78 - lVar40) / (double)local_60);
    uVar59 = 0xffffffff;
    do {
      bVar9 = 1;
      if (((int)uVar59 < 0) ||
         (lVar41 = *(int64_t *)(local_50[2] + (uint64_t)uVar59 * 8), lVar41 == 0)) {
        bVar36 = true;
        lVar41 = 0;
...
LAB_014e2c08:
        ...
        FUN_00d50b00();
        bVar36 = false;
        if (*(int *)((int64_t)local_50 + 0xc) + -1 <= (int)uVar59) goto LAB_014e2c00;
LAB_014e2bbd:
        lVar54 = *(int64_t *)(local_50[2] + 8 + (int64_t)(int)uVar59 * 8);
...
LAB_014e2be2:
      ...
      uVar59 = uVar59 + 1;
      pvVar39 = (void *)(uint64_t)*(uint *)((int64_t)local_50 + 0xc);
    } while ((int)uVar59 < (int)*(uint *)((int64_t)local_50 + 0xc));
  }
  local_98 = *arg1;
  local_90 = '\0';
  FUN_00c8e4f0();
  ...
  FUN_0161e150(SUB84(g_0238fee8 / local_80,0));
  plVar48 = local_50;
  local_60 = local_48;
  if (local_40[0] == '\0') {
    if (((local_48 != (int64_t *)0x0) && (FUN_00d50b00(), local_40[0] != '\0')) &&
  ...
  FUN_0161e1a0(g_02394288,g_02391090);
  plVar56 = local_48;
  if (local_40[0] == '\0') {
    if (((local_48 != (int64_t *)0x0) && (FUN_00d50b00(), local_40[0] != '\0')) &&
       (local_48 != (int64_t *)0x0)) {
  ...
  local_58 = plVar56;
  if (0 < *(int *)((int64_t)plVar48 + 0xc)) {
    lVar41 = 0;
    do {
      iVar38 = FUN_00e7d850((int)*(void*)(*(int64_t *)(plVar48[2] + lVar41 * 8) + 0x10));
      if (7 < (int)*(uint *)(plVar56 + 3)) {
        pvVar39 = (void *)(uint64_t)(*(uint *)(plVar56 + 3) >> 3);
        pvVar50 = (void *)0x0;
        do {
          iVar46 = *(int *)(plVar56[2] + (int64_t)pvVar50 * 8);
          if ((iVar46 <= iVar38) &&
             (iVar38 < iVar46 + *(int *)(plVar56[2] + 4 + (int64_t)pvVar50 * 8)))
          goto LAB_014e2e30;
          pvVar50 = (void *)((int64_t)pvVar50 + 1);
      ...
      *(int64_t *)((int64_t)pvVar39 + (int64_t)iVar46) =
           (int64_t)iVar38 * (int64_t)(int)lVar37 + lVar40;
      plVar56 = local_58;
LAB_014e2e30:
      lVar41 = lVar41 + 1;
      plVar48 = local_50;
    } while (lVar41 < *(int *)((int64_t)local_50 + 0xc));
  }
  if (7 < (int)plVar52[3]) {
    local_88 = (double)(int64_t)(dVar51 * local_88 + g_023942d0);
    dVar51 = 0.0;
    do {
      lVar37 = *(int64_t *)(plVar52[2] + (int64_t)dVar51 * 8);
      lVar40 = *arg1;
      ...
      if (7 < iVar38) {
        ...
        uVar44 = 0;
        do {
          if (lVar37 < *(int64_t *)((int64_t)pvVar39 + uVar44 * 8)) {
            uVar59 = (uint)uVar44;
            break;
          }
          uVar44 = uVar44 + 1;
      ...
      local_80 = dVar51;
      FUN_00c8e340();
      lVar40 = *(int64_t *)(lVar40 + 0x10);
      _memmove(pvVar39,(void *)(int64_t)(int)(iVar38 + uVar59 * -8),(size_t)uVar43);
      *(int64_t *)(lVar40 + (int64_t)(int)uVar59 * 8) = lVar37;
      iVar38 = *(int *)(*arg1 + 0x18);
      iVar46 = iVar38 + 7;
      if (-1 < iVar38) {
        iVar46 = iVar38;
      }
      if (((int)uVar59 < (iVar46 >> 3) + -1) &&
         (*(int64_t *)(*(int64_t *)(*arg1 + 0x10) + 8 + (int64_t)(int)uVar59 * 8) - lVar37 <
          (int64_t)local_88)) {
        FUN_00e7b4e0();
        FUN_00c921e0();
      }
      plVar52 = local_78;
      if ((0 < (int)uVar59) &&
         (lVar37 - *(int64_t *)(*(int64_t *)(*arg1 + 0x10) + (uint64_t)(uVar59 - 1) * 8) <
          (int64_t)local_88)) {
        FUN_00e7b4e0();
        FUN_00c921e0();
      }
      dVar51 = (double)((int64_t)local_80 + 1);
      iVar38 = (int)plVar52[3];
      iVar46 = iVar38 + 7;
      if (-1 < iVar38) {
        iVar46 = iVar38;
      }
      pvVar39 = (void *)(uint64_t)(uint)(iVar46 >> 3);
    } while ((int64_t)dVar51 < (int64_t)(iVar46 >> 3));
  }
  plVar52 = local_60;
  ...
  if (plVar48 != (int64_t *)0x0) {
    FUN_00d50b20();
  }
  uVar44 = CONCAT71((int7)((uint64_t)plVar48 >> 8),1);
