...

{
  ...
  *pcVar4 = '\0';
  ...
  local_58 = (int64_t *)(this_ptr + 0x38);
  if (lVar14 == lVar12) {
    if ((local_38[0] != '\0') && (lVar12 != 0)) {
      FUN_00d50b20();
    }
...
LAB_0190453c:
    ...
    if (lVar14 != 0) {
      iVar11 = *(int *)(*(int64_t *)(this_ptr + 0x38) + 0xc);
      if ((local_38[0] != '\0') && (lVar12 != 0)) {
        FUN_00d50b20();
      }
      iVar9 = 0;
...
LAB_01904865:
      FUN_00d50b20();
      dVar18 = (double)((uint64_t)dVar18 & 0xffffffff);
    }
  }
  else {
    if (lVar14 != 0) {
      ...
      if (iVar2 == 0) {
        ...
        *pcVar6 = '\0';
        ...
        if (lVar14 == lVar12) {
          dVar18 = (double)(uint64_t)(*(int *)(*(int64_t *)(this_ptr + 0x38) + 0xc) - 1);
        }
        else {
          ...
          if (dVar20 <= dVar19) {
            ...
            if (dVar19 < dVar20) {
              ...
              if (iVar1 == 0) {
                ...
                dVar20 = (double)(uint64_t)uVar17;
                if (SUB84(dVar18,0) < (int)uVar17) {
                  dVar20 = (double)((uint64_t)dVar18 & 0xffffffff);
                }
                ...
                if (dVar18 <= dVar19) {
                  ...
                  if ((int)uVar17 < iVar2 + -1) {
                    dVar21 = (double)(uint64_t)(uVar17 + 1);
                    pcVar4 = *(char **)(*local_58 + 0x10);
                    dVar18 = (double)FUN_01907950();
                    if (dVar19 < dVar18) goto LAB_01904d3c;
                  }
                  dVar21 = (double)(uint64_t)(uVar17 + 2);
                  if ((int)(uVar17 + 2) < iVar2) {
                    pcVar4 = *(char **)(*local_58 + 0x10);
                    dVar18 = (double)FUN_01907950();
                    if (dVar19 < dVar18) goto LAB_01904d3c;
                  }
                  dVar21 = (double)(uint64_t)(uVar17 + 3);
                  dVar20 = local_80;
...
LAB_01904db0:
              do {
                ...
                if (iVar11 == 1) {
                  dVar18 = (double)(uint64_t)uVar17;
                  break;
                }
                uVar10 = iVar11 / 2 + uVar17;
                dVar18 = (double)(uint64_t)uVar10;
                pcVar4 = *(char **)(*local_58 + 0x10);
                dVar21 = (double)FUN_01907950();
                if (dVar19 <= dVar21) {
                  dVar20 = (double)(uint64_t)uVar10;
                  uVar10 = uVar17;
                }
                uVar17 = uVar10;
  ...
  if (0 < (int)uVar17) {
    ...
    do {
      ...
      dVar18 = (double)FUN_01907950();
      *(double *)(*(int64_t *)(lVar12 + 0x10) + uVar15 * 8) = local_80 - dVar18;
      uVar15 = uVar15 + 1;
    } while (uVar17 != uVar15);
    local_a0 = g_0238fee8 / local_a0;
    uVar15 = 0;
    do {
      local_80 = *(double *)(*(int64_t *)(lVar12 + 0x10) + uVar15 * 8) * local_a0;
  ...
  lVar14 = local_78;
  lVar8 = local_b0;
  pvVar5 = _pthread_getspecific((void*)local_b0);
  dVar18 = local_70;
  if (pvVar5 != (void *)0x0) {
    FUN_00e8b990();
  }
  ...
  if (iVar9 < *(int *)(*local_58 + 0xc)) {
    ...
    do {
      ...
      lVar16 = lVar16 + 1;
      lVar8 = (int64_t)*(int *)(*local_58 + 0xc);
    } while (lVar16 < lVar8);
  }
  if (lVar12 != 0) {
    FUN_00d50b20();
