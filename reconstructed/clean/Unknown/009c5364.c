...
void FUN_009c5364(uint64_t param_1,uint64_t param_2,size_t param_3)
...
LAB_009c56fa:
    ...
    puVar4 = puVar10;
    if (puVar10 != (void*)this_ptr[3]) goto LAB_009c56e3;
    ...
    if (puVar13 < puVar8 || lVar3 == 0) {
      ...
      if ((uint64_t)pvVar1 >> 0x3d != 0) goto LAB_009c56fa;
