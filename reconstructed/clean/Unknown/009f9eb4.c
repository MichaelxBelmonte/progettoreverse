...
uint16_t FUN_009f9eb4(byte *param_1,int64_t *param_2,uint64_t param_3,uint64_t param_4)
...
LAB_009f9f89:
  ...
  while( true ) {
    if ((bVar3 & 1) == 0) {
      uVar7 = (uint64_t)(bVar3 >> 1);
      pbVar12 = param_1 + 1;
    }
    else {
      uVar7 = *(uint64_t *)(param_1 + 8);
