...
void FUN_0108f840(uint64_t param_1,int64_t param_2)

{
  ...
  uVar18 = this_ptr[7];
  do {
    auVar2 = vpshufb_avx(*arg1,g_0108e580);
    auVar3 = vpshufb_avx(arg1[1],g_0108e580);
    auVar4 = vpshufb_avx(arg1[2],g_0108e580);
    local_c0 = vpaddd_avx(auVar2,g_0108e380);
    auVar5 = vpshufb_avx(arg1[3],g_0108e580);
    local_b0 = vpaddd_avx(auVar3,g_0108e3a0);
    local_a0 = vpaddd_avx(auVar4,g_0108e3c0);
    local_90 = vpaddd_avx(auVar5,g_0108e3e0);
    uVar14 = uVar12 ^ uVar10;
    pauVar13 = (uint8_t (*) [16])&g_0108e380;
    do {
      ...
      local_a0 = auVar23;
      local_90 = auVar24;
    } while (*(char *)((int64_t)*pauVar6 + 3) != '\0');
    ...
    iVar15 = uVar9 + local_90._12_4_ + ((uVar19 ^ uVar18) & uVar20 ^ uVar18) +
             (uVar21 >> 6 | uVar21 << 0x1a);
    uVar9 = (uVar16 >> 2 | uVar16 << 0x1e) +
            iVar15 + ((uVar10 ^ uVar11) & (uVar12 ^ uVar10) ^ uVar10) + *this_ptr;
    arg1 = arg1 + 4;
    uVar12 = uVar12 + this_ptr[1];
    uVar10 = uVar10 + this_ptr[2];
    uVar11 = uVar11 + this_ptr[3];
    uVar21 = uVar14 + iVar15 + this_ptr[4];
    uVar20 = uVar20 + this_ptr[5];
    uVar19 = uVar19 + this_ptr[6];
    uVar18 = uVar18 + this_ptr[7];
    *this_ptr = uVar9;
    this_ptr[1] = uVar12;
    this_ptr[2] = uVar10;
    this_ptr[3] = uVar11;
