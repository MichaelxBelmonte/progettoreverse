...
int FUN_01024a10(void*param_1,int64_t param_2,size_t param_3,char *param_4)

{
  ...
  if (param_2 == 0) {
    if (*(int *)(lVar3 + 0x2e0) < 1) {
      ...
      if (iVar1 == 0) {
        iVar1 = _CRYPTO_ocb128_decrypt((int64_t)*(int *)(lVar3 + 0x2e0));
      }
      else {
...
LAB_01024b06:
    puVar4 = (void*)(uint64_t)(0x10 - uVar5);
    if (param_1 < puVar4) {
    ...
    param_1 = param_1 + -(int64_t)puVar4;
    *local_48 = 0;
    if (arg1 != 0) {
      arg1 = arg1 + 0x10;
    }
    iVar1 = 0x10;
    if (param_1 <= (void*)((int64_t)&MACH_HEADER.filetype + 3)) goto LAB_01024d5e;
  }
  else {
...
LAB_01024b46:
  ...
  if (arg1 == 0) {
    iVar2 = _CRYPTO_ocb128_aad(local_48,(uint64_t)param_1 & 0xfffffffffffffff0);
  }
  else {
    iVar2 = _EVP_CIPHER_CTX_encrypting();
    if (iVar2 == 0) {
      iVar2 = _CRYPTO_ocb128_decrypt((uint64_t)param_1 & 0xfffffffffffffff0,arg1);
    }
    else {
...
LAB_01024d5e:
  ...
  if ((void *)(uint64_t)uVar5 != (void *)0x0) {
    _memcpy(local_48,(void *)(uint64_t)uVar5,param_3);
    *local_48 = uVar5;
  }
  return iVar1;
}
