...
uint64_t FUN_00eb389a(int64_t *param_1,uint64_t param_2,uint64_t *param_3,int *param_4)

{
  ...
  if ((int64_t *)(lVar6 + uVar19) <= param_1) {
    ...
    if (*(uint *)(arg1 + 0x2c) < uVar8) {
      ...
      lVar9 = local_d8 + 8;
      do {
        uVar16 = (uint64_t)(*(int64_t *)(lVar6 + uVar19) * -0x30e4432340650000) >>
...
LAB_00eb3b65:
    ...
    *(uint *)(arg1 + 0x2c) = (uint)local_c8;
    ...
    uVar19 = (uint64_t)(*param_1 * -0x30e4432340650000) >> (-*(char *)(arg1 + 0x108) & 0x3fU);
