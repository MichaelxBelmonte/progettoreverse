...
BIO * FUN_00f69bc0(uint64_t param_1,uint64_t param_2,int param_3)

{
  ...
  if (pBVar4 != (BIO *)0x0) {
    ...
    do {
      ...
      if (local_450 == 0) {
LAB_00f69c8c:
        bp = (BIO *)((int64_t)&MACH_HEADER.magic + 1);
      }
      else {
        iVar2 = _ossl_ctype_check();
        bp = (BIO *)((int64_t)&MACH_HEADER.magic + 3);
...
LAB_00f69cb1:
      while( true ) {
        ...
        iVar2 = (int)bp;
        if (((uint64_t)bVar1 < 0xe) && ((0x2401UL >> ((uint64_t)bVar1 & 0x3f) & 1) != 0)) break;
        if (iVar2 - 1U < 6) {
...
LAB_00f69ed7:
          ...
          case 3:
            if (bVar1 != 0x28) {
              bp = (BIO *)((int64_t)&MACH_HEADER.magic + 2);
...
LAB_00f6a03a:
            ...
            bp = (BIO *)((int64_t)&MACH_HEADER.cputype + 2);
            lVar6 = lVar6 + 1;
            break;
          case 4:
            bp = (BIO *)((int64_t)&MACH_HEADER.magic + 3);
