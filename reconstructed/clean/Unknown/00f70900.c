...

{
  ...
  uVar12 = *param_2;
  if ((uVar12 & 0x1000) != 0) {
    this_ptr = (int64_t *)&stack0xffffffffffffff70;
  }
  if ((uVar12 & 0x18) == 0) {
    length_01 = 0;
    if ((int)param_1 != -1) {
    ...
    param_1 = (ASN1_VALUE **)(uint64_t)param_2[2];
    length_01 = uVar12 & 0xc0;
  }
  tag = param_3 & 0xffffff3f;
  it_00 = (ASN1_ITEM *)(uint64_t)tag;
  ...
  if ((uVar12 & 6) == 0) {
    if ((uVar12 & 0x10) == 0) {
      iVar2 = _ASN1_item_ex_i2d(param_1,*(uchar ***)(param_2 + 8),
                                (ASN1_ITEM *)(uint64_t)(length_01 | tag),tag,iVar13);
    }
    else {
      iVar2 = 0;
      iVar3 = -1;
      ...
      if (((iVar8 != 0) &&
          (iVar2 = _ASN1_object_size(iVar3,length_00,uVar12), arg1 != (int64_t *)0x0)) &&
         (iVar2 != -1)) {
        _ASN1_put_object((uchar **)((uint64_t)param_1 & 0xffffffff),iVar8,length_01,uVar1,iVar13);
        ppuVar10 = (uchar **)0xffffffff;
        _ASN1_item_ex_i2d((ASN1_VALUE **)0xffffffff,*(uchar ***)(param_2 + 8),
                          (ASN1_ITEM *)(uint64_t)tag,uVar1,iVar13);
        if (bVar15 && bVar14) {
    ...
    if (0 < iVar2) {
      ...
      do {
        ...
        iVar3 = _ASN1_item_ex_i2d((ASN1_VALUE **)0xffffffff,*(uchar ***)(param_2 + 8),
                                  (ASN1_ITEM *)(uint64_t)tag,(int)it_00,
    ...
    if (iVar4 == -1) {
      ...
      if ((uVar12 & 0x10) == 0) {
        ...
        _ASN1_put_object((uchar **)((uint64_t)param_1 & 0xffffffff),iVar4,length_01,(int)it_00,
                         iVar3);
      }
      pp = (uint64_t)uVar1;
      it = (ASN1_ITEM *)(uint64_t)length;
      ...
      if (((uVar12 & 2) == 0) || (iVar13 = _OPENSSL_sk_num(), iVar13 < 2)) {
        ...
        if (0 < iVar13) {
          ...
          do {
            ...
            pp = 0xffffffff;
            _ASN1_item_ex_i2d((ASN1_VALUE **)0xffffffff,ppuVar10,(ASN1_ITEM *)(uint64_t)tag,
                              (int)it_00,iVar8);
            iVar13 = iVar13 + 1;
        ...
        if (puVar5 != (void*)0x0) {
          pvVar6 = _CRYPTO_malloc((int)pp,(char *)((int64_t)&section_00000158.reloff + 3),(int)it);
          if (pvVar6 == (void *)0x0) {
            _CRYPTO_free(pp);
          }
          else {
            ...
            if (0 < iVar13) {
              iVar13 = 0;
              do {
                _memcpy(pp,(void *)(int64_t)*(int *)(puVar5 + 1),(size_t)it);
