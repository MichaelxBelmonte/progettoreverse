...
int FUN_009d561e(uint64_t param_1)

{
  ...
  do {
    FUN_009f58f0();
    pbVar5 = (byte *)CONCAT71((int7)((uint64_t)pbVar5 >> 8),local_60);
...
LAB_009d57bd:
        FUN_009f58f0();
        pbVar5 = (byte *)CONCAT71((int7)((uint64_t)pbVar5 >> 8),local_320);
  ...
  if (local_118 != (int64_t *)0x0) {
    ...
    *(int *)plVar1 = (int)*plVar1 + -1;
    ...
    if ((int)*plVar1 == 0) {
      (**(code **)(*local_118 + 0x10))();
      LOCK();
      piVar2 = (int *)((int64_t)local_118 + 0xc);
      *piVar2 = *piVar2 + -1;
      UNLOCK();
      if (*piVar2 == 0) {
        (**(code **)(*local_118 + 0x18))();
