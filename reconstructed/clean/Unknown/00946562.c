...
uint64_t FUN_00946562(int param_1,int param_2,int64_t param_3,int64_t *param_4)

{
  ...
  local_60 = *(int64_t *)(*param_4 + -8 + param_3 * 8);
  local_3c = param_2;
  local_38 = unaff_ESI;
  local_34 = param_1;
  if (local_60 == 0) {
  ...
  if (cVar1 != '\0') {
    local_48 = param_3 + 1;
    if ((uint64_t)(param_4[1] - *param_4 >> 3) < local_48) {
      FUN_00946536();
    }
    FUN_00a1ce76();
    if (local_58 == 0) {
    ...
    lVar3 = (*(int64_t **)(local_58 + 8))[1] - **(int64_t **)(local_58 + 8);
    if (lVar3 != 0) {
      uVar4 = 1;
      while( true ) {
        FUN_00a5960e();
        ...
        FUN_00a1ba3c();
        *(int64_t **)(*param_4 + param_3 * 8) = local_78;
        if (*(int64_t *)(*param_4 + param_3 * 8) == 0) {
          FUN_00925fd0();
          FUN_00926010();
          local_78 = (int64_t *)(param_3 * 8 + *param_4);
          FUN_00983230();
          FUN_00928ab0("bool pace::AuthorizationVerifier::getChildAuthByAuthCoordinates(int32_t, int32_t, int32_t, size_t, std::vector<LsAuthorizationPtr> &)"
                       ,0x30f9);
          FUN_009bd14b();
        ...
        lVar2 = FUN_008e4ece();
        if ((local_48 < (uint64_t)(int64_t)*(int *)(lVar2 + 0x28)) &&
           (cVar1 = FUN_00946562(local_34,local_3c,local_48,param_4), cVar1 != '\0')) break;
        if ((uint64_t)(lVar3 >> 5) <= uVar4) {
          return 0;
        }
        uVar4 = uVar4 + 1;
      }
