...
void FUN_00a3994c(uint64_t param_1,uint64_t param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a399c9:
    if ((plVar17 == plVar4) || ((int64_t)plVar17 - (int64_t)plVar3 == -8)) goto LAB_00a399d7;
    lVar18 = (int64_t)plVar17 - (int64_t)plVar3 >> 3;
  }
  else {
    do {
      if (*plVar17 == *(int64_t *)(arg1 + 0x10)) goto LAB_00a399c9;
      plVar17 = plVar17 + 1;
...
LAB_00a399d7:
  ...
  *(int64_t *)(lVar11 + 0x18) = lVar5 + lVar18 * 8 + ((int64_t)pvVar12 >> 3) * 8;
  ...
  pvVar13 = (void *)((int64_t)pvVar10 + lVar18 * 0xa0);
  pvVar12 = (void *)((int64_t)pvVar10 + lVar18 * 0xa0 + 0xa0);
  pvVar16 = pvVar13;
  if (pvVar12 != pvVar6) {
    do {
      pvVar16 = (void *)((int64_t)pvVar13 + 0xa0);
      FUN_00aaac2a();
      sVar15 = (size_t)param_3;
      pvVar12 = (void *)((int64_t)pvVar13 + 0x140);
      pvVar13 = pvVar16;
  ...
  do {
    puVar1 = (void*)((int64_t)pvVar12 + -0xa0);
    pvVar12 = (void *)((int64_t)pvVar12 + -0xa0);
    (**(code **)*puVar1)();
    sVar15 = (size_t)param_3;
