...
uint64_t FUN_00f78ae0(uint64_t param_1,uint64_t param_2,uint64_t param_3,uint param_4)
...
LAB_00f78b61:
  ...
  do {
    ...
    pcVar1 = pcVar8 + 1;
    acStack_58[(int64_t)pcVar8] = pcVar7[uVar3 % uVar13];
  } while ((uVar13 <= param_3) &&
          (bVar15 = pcVar8 < (char *)((int64_t)&MACH_HEADER.flags + 1), pcVar8 = pcVar1,
          param_3 = uVar3 / uVar13, bVar15));
  if ((local_res18 & 8) == 0) {
    pcVar11 = "";
  }
  uVar13 = (uint64_t)((int)pcVar1 - 1);
  if ((int)pcVar1 != 0x1a) {
    uVar13 = (uint64_t)pcVar1 & 0xffffffff;
  }
  acStack_58[uVar13] = '\0';
  iVar10 = (int)uVar13;
  iVar6 = iVar10;
