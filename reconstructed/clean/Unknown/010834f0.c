// Function: FUN_010834f0
// Address: 010834f0
// Size: 6367 bytes
// Class: Unknown

void FUN_010834f0(uint64_t param_1,int64_t param_2)

{
  ...
  uint8_t auVar31 [32];
  uint8_t auVar32 [32];
  uint8_t local_300 [32];
  uint8_t local_2e0 [32];
  uint8_t local_2c0 [32];
  ...
  uVar12 = this_ptr[4];
  pauVar14 = arg1 + 4;
  auVar20._0_16_ = ZEXT116(0) * *pauVar16 + ZEXT116(1) * *arg1;
  auVar20._16_16_ = ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) + ZEXT116(1) * *pauVar16;
  auVar25._0_16_ = ZEXT116(0) * pauVar16[1] + ZEXT116(1) * arg1[1];
  auVar25._16_16_ = ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) + ZEXT116(1) * pauVar16[1];
  auVar17 = vpshufb_avx2(auVar20,g_01084ec0);
  auVar24._0_16_ = ZEXT116(0) * pauVar16[2] + ZEXT116(1) * arg1[2];
  auVar24._16_16_ = ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) + ZEXT116(1) * pauVar16[2];
  auVar19 = vpshufb_avx2(auVar25,g_01084ec0);
  auVar23._0_16_ = ZEXT116(0) * pauVar16[3] + ZEXT116(1) * arg1[3];
  auVar23._16_16_ = ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) + ZEXT116(1) * pauVar16[3];
  auVar24 = vpshufb_avx2(auVar24,g_01084ec0);
  auVar25 = vpshufb_avx2(auVar23,g_01084ec0);
  local_300 = vpaddd_avx2(auVar17,g_01084e40);
  local_2e0 = vpaddd_avx2(auVar19,g_01084e40);
  local_2c0 = vpaddd_avx2(auVar24,g_01084e40);
  local_2a0 = vpaddd_avx2(auVar25,g_01084e40);
  ...
  auVar23 = vpslld_avx2(auVar29,2);
  auVar23 = auVar20 ^ auVar27 ^ auVar23;
  local_280 = vpaddd_avx2(auVar23,g_01084e40);
  auVar20 = vpalignr_avx2(auVar24,auVar19,8);
  auVar27 = vpsrldq_avx2(auVar23,4);
  auVar20 = auVar20 ^ auVar19 ^ auVar27 ^ auVar25;
  auVar27 = vpsrld_avx2(auVar20,0x1f);
  auVar30 = vpslldq_avx2(auVar20,0xc);
  auVar20 = vpaddd_avx2(auVar20,auVar20);
  auVar29 = vpsrld_avx2(auVar30,0x1e);
  auVar20 = vpor_avx2(auVar20,auVar27);
  auVar30 = vpslld_avx2(auVar30,2);
  auVar30 = auVar20 ^ auVar29 ^ auVar30;
  local_260 = vpaddd_avx2(auVar30,g_01084e60);
  auVar20 = vpalignr_avx2(auVar25,auVar24,8);
  auVar27 = vpsrldq_avx2(auVar30,4);
  auVar20 = auVar20 ^ auVar24 ^ auVar27 ^ auVar23;
  auVar27 = vpsrld_avx2(auVar20,0x1f);
  auVar29 = vpslldq_avx2(auVar20,0xc);
  auVar20 = vpaddd_avx2(auVar20,auVar20);
  auVar28 = vpsrld_avx2(auVar29,0x1e);
  auVar20 = vpor_avx2(auVar20,auVar27);
  auVar29 = vpslld_avx2(auVar29,2);
  auVar29 = auVar20 ^ auVar28 ^ auVar29;
  local_240 = vpaddd_avx2(auVar29,g_01084e60);
  auVar20 = vpalignr_avx2(auVar23,auVar25,8);
  auVar27 = vpsrldq_avx2(auVar29,4);
  auVar20 = auVar20 ^ auVar25 ^ auVar27 ^ auVar30;
  auVar27 = vpsrld_avx2(auVar20,0x1f);
  ...
  local_220 = vpaddd_avx2(auVar27,g_01084e60);
  auVar20 = g_01084e60;
  do {
    uVar9 = uVar5 >> 2 | uVar5 << 0x1e;
    auVar28 = vpalignr_avx2(auVar27,auVar29,8);
    uVar10 = uVar6 >> 2 | uVar6 << 0x1e;
    auVar28 = auVar17 ^ auVar23 ^ auVar19 ^ auVar28;
    ...
    uVar10 = uVar10 + local_2e0._0_4_ + (uVar6 & uVar13 ^ ~uVar6 & uVar5) +
             (uVar8 >> 0x1b | uVar8 * 0x20);
    auVar17 = vpalignr_avx2(auVar26,auVar27,8);
    uVar9 = uVar10 >> 2 | uVar10 * 0x40000000;
    auVar17 = auVar19 ^ auVar30 ^ auVar24 ^ auVar17;
    ...
    uVar7 = uVar8 >> 2 | uVar8 * 0x40000000;
    auVar20 = auVar24 ^ auVar29 ^ auVar25 ^ auVar20;
    ...
    uVar6 = uVar5 + local_2c0._12_4_ + (uVar8 & uVar12 ^ ~uVar8 & uVar13) +
            (uVar10 >> 0x1b | uVar10 * 0x20);
    auVar32 = vpaddd_avx2(auVar24,g_01084e80);
    uVar11 = uVar6 >> 2 | uVar6 * 0x40000000;
    ...
    auVar20 = vpalignr_avx2(auVar24,auVar19,8);
    uVar12 = uVar6 >> 2 | uVar6 * 0x40000000;
    auVar20 = auVar25 ^ auVar27 ^ auVar23 ^ auVar20;
    ...
    uVar10 = uVar11 + local_280._0_4_ + (uVar6 & uVar13 ^ ~uVar6 & uVar5) +
             (uVar8 >> 0x1b | uVar8 * 0x20);
    auVar1 = vpaddd_avx2(auVar25,g_01084e80);
    uVar9 = uVar10 >> 2 | uVar10 * 0x40000000;
    ...
    auVar20 = vpalignr_avx2(auVar25,auVar24,8);
    uVar13 = uVar8 >> 2 | uVar8 * 0x40000000;
    auVar20 = auVar23 ^ auVar26 ^ auVar30 ^ auVar20;
    ...
    uVar7 = uVar8 >> 2 | uVar8 * 0x40000000;
    auVar23 = vpaddd_avx2(auVar17,g_01084e80);
    ...
    auVar20 = vpalignr_avx2(auVar17,auVar25,8);
    uVar5 = uVar10 >> 2 | uVar10 * 0x40000000;
    auVar20 = auVar30 ^ auVar19 ^ auVar29 ^ auVar20;
    uVar8 = uVar12 + local_240._4_4_ + (uVar6 ^ uVar9 ^ uVar7) + (uVar10 >> 0x1b | uVar10 * 0x20);
    auVar30 = vpsrld_avx2(auVar20,0x1e);
    auVar20 = vpslld_avx2(auVar20,2);
    uVar13 = uVar8 >> 2 | uVar8 * 0x40000000;
    uVar6 = uVar7 + local_240._8_4_ + (uVar10 ^ uVar11 ^ uVar9) + (uVar8 >> 0x1b | uVar8 * 0x20);
    auVar2 = vpor_avx2(auVar20,auVar30);
    uVar12 = uVar6 >> 2 | uVar6 * 0x40000000;
    auVar30 = vpaddd_avx2(auVar2,g_01084e80);
    ...
    auVar20 = vpalignr_avx2(auVar2,auVar17,8);
    uVar11 = uVar6 >> 2 | uVar6 * 0x40000000;
    auVar20 = auVar29 ^ auVar24 ^ auVar27 ^ auVar20;
    ...
    auVar3 = vpor_avx2(auVar20,auVar29);
    local_200 = auVar28._0_4_;
    uVar13 = uVar8 >> 2 | uVar8 * 0x40000000;
    auVar29 = vpaddd_avx2(auVar3,g_01084e80);
    ...
    uVar9 = uVar10 >> 2 | uVar10 * 0x40000000;
    auVar20 = auVar27 ^ auVar25 ^ auVar26 ^ auVar20;
    ...
    auVar4 = vpor_avx2(auVar20,auVar27);
    iStack_1dc = auVar31._4_4_;
    uVar5 = uVar10 >> 2 | uVar10 * 0x40000000;
    auVar27 = vpaddd_avx2(auVar4,g_01084ea0);
    ...
    auVar20 = auVar26 ^ auVar17 ^ auVar19 ^ auVar20;
    uVar7 = uVar8 >> 2 | uVar8 * 0x40000000;
    ...
    uVar9 = uVar10 >> 2 | uVar10 * 0x40000000;
    auVar26 = vpaddd_avx2(auVar18,g_01084ea0);
    ...
    uVar7 = uVar8 >> 2 | uVar8 * 0x40000000;
    auVar2 = vpaddd_avx2(auVar19,g_01084ea0);
    ...
    uVar8 = uVar12 + iStack_94 + (uVar6 ^ uVar9 ^ uVar7) + (uVar5 >> 0x1b | uVar5 * 0x20) +
            *this_ptr;
    uVar5 = uVar5 + this_ptr[1];
    uVar12 = (uVar6 >> 2 | uVar6 * 0x40000000) + this_ptr[2];
    *this_ptr = uVar8;
    ...
    if (pauVar14 + 8 <= pauVar15) {
      ...
      auVar18._16_16_ = ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) + ZEXT116(1) * *pauVar16;
      auVar19._0_16_ = ZEXT116(0) * pauVar16[1] + ZEXT116(1) * pauVar14[5];
      auVar19._16_16_ = ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) + ZEXT116(1) * pauVar16[1];
      auVar21._0_16_ = ZEXT116(0) * pauVar16[2] + ZEXT116(1) * pauVar14[6];
      auVar21._16_16_ = ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) + ZEXT116(1) * pauVar16[2];
      auVar22._0_16_ = ZEXT116(0) * pauVar16[3] + ZEXT116(1) * pauVar14[7];
      auVar22._16_16_ = ZEXT116(0) * SUB4816((uint8_t  [48])0x0,0) + ZEXT116(1) * pauVar16[3];
    }
    ...
    auVar17 = vpshufb_avx2(auVar18,g_01084ec0);
    uVar5 = uVar10 >> 2 | uVar10 * 0x40000000;
    ...
    auVar19 = vpshufb_avx2(auVar19,g_01084ec0);
    local_300 = vpaddd_avx2(auVar17,g_01084e40);
    uVar11 = uVar6 >> 2 | uVar6 * 0x40000000;
    ...
    auVar24 = vpshufb_avx2(auVar21,g_01084ec0);
    local_2e0 = vpaddd_avx2(auVar19,g_01084e40);
    ...
    auVar25 = vpshufb_avx2(auVar22,g_01084ec0);
    local_2c0 = vpaddd_avx2(auVar24,g_01084e40);
    ...
    auVar27 = vpalignr_avx2(auVar25,auVar24,8);
    ...
    auVar27 = auVar27 ^ auVar24 ^ auVar29 ^ auVar23;
    uVar11 = uVar6 >> 2 | uVar6 * 0x40000000;
    ...
    uVar6 = uVar9 + iStack_84 + (uVar7 ^ uVar8 ^ uVar12) + (uVar5 >> 0x1b | uVar5 * 0x20) +
            *this_ptr;
    uVar5 = uVar5 + this_ptr[1];
    uVar7 = (uVar7 >> 2 | uVar7 * 0x40000000) + this_ptr[2];
    *this_ptr = uVar6;
    uVar8 = uVar8 + this_ptr[3];
    this_ptr[1] = uVar5;
