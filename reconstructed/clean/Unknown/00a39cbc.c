...
void FUN_00a39cbc(uint64_t param_1,uint64_t param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a39d61:
    if ((plVar16 == plVar4) || ((int64_t)plVar16 - (int64_t)plVar3 == -8)) goto LAB_00a39d6f;
...
LAB_00a39d6f:
  ...
  *(int64_t *)(lVar10 + 0x18) = lVar5 + lVar17 * 8 + ((int64_t)pvVar11 >> 3) * 8;
  ...
  pvVar12 = (void *)((int64_t)pvVar9 + lVar17 * 0xa0);
  pvVar11 = (void *)((int64_t)pvVar9 + lVar17 * 0xa0 + 0xa0);
  pvVar15 = pvVar12;
  if (pvVar11 != pvVar6) {
    do {
      pvVar15 = (void *)((int64_t)pvVar12 + 0xa0);
      FUN_00aaac2a();
      sVar14 = (size_t)param_3;
      pvVar11 = (void *)((int64_t)pvVar12 + 0x140);
      pvVar12 = pvVar15;
  ...
  do {
    puVar1 = (void*)((int64_t)pvVar11 + -0xa0);
    pvVar11 = (void *)((int64_t)pvVar11 + -0xa0);
    (**(code **)*puVar1)();
    sVar14 = (size_t)param_3;
