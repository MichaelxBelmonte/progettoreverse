...
uint64_t FUN_00f6fde0(uint param_1,int *param_2,int param_3,int *param_4)

{
  ...
  str = (BUF_MEM *)*arg1;
  if ((this_ptr == 0) && (in_EAX = param_1 & 0xffffff01, (param_1 & 1) == 0)) {
    *arg1 = (int64_t)((int64_t)&str->length + (int64_t)param_2);
    return 1;
  }
  local_4c = param_1;
  local_48 = str;
  if (0 < (int64_t)param_2) {
    if (param_3 < 5) {
      local_70 = in_EAX;
      if (this_ptr == 0) {
        in_stack_ffffffffffffff98 = (int *)(uint64_t)in_EAX;
        piVar10 = param_2;
        do {
          if (((piVar10 != (int *)((int64_t)&MACH_HEADER.magic + 1)) && ((char)str->length == '\0')
              ) && (*(char *)((int64_t)&str->length + 1) == '\0')) goto LAB_00f70375;
          local_40 = str;
          ...
          if ((char)bVar8 < '\0') {
            ...
            in_stack_ffffffffffffff98 = (int *)((uint64_t)uVar2 & 0xffffffff00000001);
            param_2 = (int *)local_5c._4_8_;
            if ((uVar2 & 1) != 0) {
              param_2 = (int *)((void*)((int64_t)piVar10 + (int64_t)str) +
                               -(int64_t)local_40);
            }
            local_48 = local_40;
            pBVar9 = local_40;
          ...
          if (bVar1 == 0) {
            if (param_2 != (int *)0x0) {
              local_48 = (BUF_MEM *)((int64_t)&pBVar9->length + (int64_t)param_2);
              pBVar9 = local_48;
            }
          }
          else {
          ...
          piVar10 = (int *)((void*)((int64_t)piVar10 + (int64_t)str) + -(int64_t)pBVar9);
          str = pBVar9;
        } while (0 < (int64_t)piVar10);
      }
      else {
        do {
          if (((param_2 != (int *)((int64_t)&MACH_HEADER.magic + 1)) && ((char)str->length == '\0')
              ) && (*(char *)((int64_t)&str->length + 1) == '\0')) goto LAB_00f70375;
          plVar6 = &local_60;
          piVar10 = param_2;
          local_40 = str;
          ...
          if ((char)bVar8 < '\0') {
            ...
            if (local_70 != 0) {
              in_stack_ffffffffffffff98 =
                   (int *)(((int64_t)param_2 + (int64_t)str) - (int64_t)local_40);
            }
            local_31 = bVar8 & 0x20;
            local_48 = local_40;
            pBVar9 = local_40;
          ...
          if (local_31 == 0) {
            if (in_stack_ffffffffffffff98 != (int *)0x0) {
              ...
              local_48 = (BUF_MEM *)
                         ((int64_t)&pBVar9->length + (int64_t)in_stack_ffffffffffffff98);
              pBVar9 = local_48;
            }
          }
          else {
          ...
          param_2 = (int *)(((int64_t)param_2 + (int64_t)str) - (int64_t)pBVar9);
          str = pBVar9;
        } while (0 < (int64_t)param_2);
      }
    }
    else {
      ...
      if (this_ptr == 0) {
        do {
          ...
          if ((char)bVar8 < '\0') {
            ...
            if ((uVar2 & 1) != 0) {
              unaff_R12 = (int *)((void*)((int64_t)param_2 + (int64_t)str) +
                                 -(int64_t)local_40);
            }
            bVar1 = bVar8 & 0x20;
            local_48 = local_40;
          ...
          if (unaff_R12 != (int *)0x0) {
            pBVar9 = (BUF_MEM *)((int64_t)&pBVar9->length + (int64_t)unaff_R12);
            local_48 = pBVar9;
          }
          param_2 = (int *)((void*)((int64_t)param_2 + (int64_t)str) + -(int64_t)pBVar9);
          str = pBVar9;
        } while (0 < (int64_t)param_2);
      }
      else {
        do {
          ...
          if ((char)bVar8 < '\0') {
            ...
            unaff_R12 = (int *)local_5c._4_8_;
            if ((uVar2 & 1) != 0) {
              unaff_R12 = (int *)(((int64_t)param_2 + (int64_t)str) - (int64_t)local_40);
            }
            bVar1 = bVar8 & 0x20;
            local_48 = local_40;
            pBVar9 = local_40;
...
LAB_00f70375:
  iVar4 = (int)in_stack_ffffffffffffff98;
  if ((local_4c & 1) != 0) {
    str = (BUF_MEM *)((int64_t)&str->length + 2);
LAB_00f7005d:
    *arg1 = (int64_t)str;
    return 1;
  }
