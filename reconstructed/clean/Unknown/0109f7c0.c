...
int * FUN_0109f7c0(char *param_1,uint64_t param_2,uint64_t param_3,char *param_4)

{
  ...
  local_50[0] = 0;
  iVar1 = _strncasecmp(param_1,(char *)((int64_t)&MACH_HEADER.cputype + 1),(size_t)param_3);
  uVar11 = 1;
  if (iVar1 == 0) {
    pcVar4 = (char *)(arg1 + 5);
    iVar1 = _strncmp(param_1,(char *)((int64_t)&MACH_HEADER.magic + 2),(size_t)param_3);
    lVar12 = 1;
    if (iVar1 != 0) {
LAB_0109f888:
    ...
    pcVar4 = (char *)(arg1 + 7);
    iVar1 = _strncasecmp(param_1,(char *)((int64_t)&MACH_HEADER.cpusubtype + 2),(size_t)param_3);
    if (iVar1 == 0) {
      pcVar4 = (char *)(arg1 + 0x10);
LAB_0109f885:
      lVar12 = 0;
      goto LAB_0109f888;
    }
      ...
      if (pBVar7 != (BIO *)0x0) {
        ...
        *(BIO **)(piVar3 + 4) = pBVar7;
        if (pBVar7 != (BIO *)0x0) {
          ...
          *(BIO **)(piVar3 + 4) = pBVar8;
          pBVar8 = local_1058;
          pcVar4 = (char *)((int64_t)&dylib_command_00000ff0.dylib.timestamp + 3);
...
LAB_0109fb4a:
      ...
      else if (*(int64_t *)(piVar3 + 6) != 0) {
        (**(code **)(*(int64_t *)(piVar3 + 6) + 0x18))();
        piVar3[6] = 0;
        piVar3[7] = 0;
        piVar3[8] = 0;
        piVar3[9] = 0;
    ...
    *(void*)(piVar3 + 0xe) = uVar5;
    piVar6 = ___error();
    iVar1 = *piVar6;
    piVar3[0x10] = iVar1;
    if (*(int64_t *)(piVar3 + 0xe) == 0) {
      if (iVar1 == 0) {
        piVar3[6] = 1;
        if (*(int64_t *)PTR____stack_chk_guard_024a9898 == local_38) {
          return piVar3;
