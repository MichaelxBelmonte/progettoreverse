...
AUTHORITY_KEYID * FUN_010bdd90(X509 *param_1,char *param_2,uint64_t param_3,char *param_4)

{
    ...
    do {
      ...
      if (iVar3 == 0) {
        ...
        if (iVar3 != 0) {
          ...
          _ERR_add_error_data(iVar3,*(void*)(lVar4 + 8));
  ...
  if (arg1 != (int *)0x0) {
    if (*(int64_t *)(arg1 + 2) != 0) {
      ...
      a = (char *)CONCAT71((int7)((uint64_t)param_1 >> 8),pAVar6 == (ASN1_OCTET_STRING *)0x0);
