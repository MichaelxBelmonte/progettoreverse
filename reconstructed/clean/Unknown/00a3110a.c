...
void FUN_00a3110a(uint64_t param_1,uint64_t param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a311af:
    if ((plVar16 == plVar4) || ((int64_t)plVar16 - (int64_t)plVar3 == -8)) goto LAB_00a311bd;
...
LAB_00a311bd:
  ...
  *(int64_t *)(lVar10 + 0x18) = lVar5 + lVar17 * 8 + ((int64_t)pvVar11 >> 3) * 8;
  ...
  pvVar12 = (void *)((int64_t)pvVar9 + lVar17 * 0x100);
  pvVar11 = (void *)((int64_t)pvVar9 + lVar17 * 0x100 + 0x100);
  pvVar15 = pvVar12;
  if (pvVar11 != pvVar6) {
    do {
      pvVar15 = (void *)((int64_t)pvVar12 + 0x100);
      FUN_00a9b122();
      sVar14 = (size_t)param_3;
      pvVar11 = (void *)((int64_t)pvVar12 + 0x200);
      pvVar12 = pvVar15;
  ...
  do {
    puVar1 = (void*)((int64_t)pvVar11 + -0x100);
    pvVar11 = (void *)((int64_t)pvVar11 + -0x100);
    (**(code **)*puVar1)();
    sVar14 = (size_t)param_3;
