...
uint64_t FUN_01c5be20(uint64_t param_1,int param_2)

{
  ...
  if (*(int *)(this_ptr + 0x1c8) == 1) {
    ...
    auVar18._12_4_ = (int)((uint64_t)extraout_XMM0_Qb >> 0x20);
    fVar4 = in_XMM1._4_4_;
    auVar7._4_4_ = fVar4;
    auVar7._0_4_ = fVar4;
    ...
    auVar8._0_4_ = fVar4 + g_0241c6e8 + g_02390d00;
  ...
  if (param_2 + 1 < iVar1) {
    if (param_2 == 0) {
      ...
      uStack_44 = (uint)((uint64_t)uVar5 >> 0x20);
      uStack_40 = (uint)extraout_XMM0_Qb_03;
      uStack_3c = (uint)((uint64_t)extraout_XMM0_Qb_03 >> 0x20);
      auVar11._0_4_ = (uint)local_48 & g_023945e0;
      ...
      auVar12._0_4_ = SUB164(auVar11 | g_023945f0,0) + local_48;
    ...
    uStack_3c = (uint)((uint64_t)extraout_XMM0_Qb_00 >> 0x20);
    auVar9._0_4_ = g_023945e0 & (uint)local_48;
    ...
    auVar10._0_4_ = SUB164(auVar9 | g_023945f0,0) + local_48;
    local_78 = (float)uVar6;
    uStack_74 = (uint)((uint64_t)uVar6 >> 0x20);
    uStack_70 = (uint)extraout_XMM0_Qb_01;
    uStack_6c = (uint)((uint64_t)extraout_XMM0_Qb_01 >> 0x20);
    auVar13._0_4_ = (uint)local_78 & g_023945e0;
    ...
    auVar14._0_4_ = SUB164(auVar13 | g_023945f0,0) + local_78;
    ...
    if (param_2 < 1) {
      ...
      uVar5 = FUN_01c82bc0();
      auVar16._0_4_ = g_023945e0 & (uint)(float)uVar5;
      auVar16._4_4_ = _UNK_023945e4 & (uint)((uint64_t)uVar5 >> 0x20);
      auVar16._8_4_ = _UNK_023945e8 & (uint)extraout_XMM0_Qb_02;
      auVar16._12_4_ = _UNK_023945ec & (uint)((uint64_t)extraout_XMM0_Qb_02 >> 0x20);
      in_XMM1._4_12_ = SUB1612(auVar16 | g_023945f0,4);
      in_XMM1._0_4_ = SUB164(auVar16 | g_023945f0,0) + (float)uVar5;
      auVar19 = roundss(ZEXT816(0),in_XMM1,0xb);
    }
    fVar4 = (float)FUN_01e3f820();
    auVar15._4_12_ = in_XMM1._4_12_;
    auVar15._0_4_ = in_XMM1._0_4_ + fVar4 + g_02390d00;
  }
