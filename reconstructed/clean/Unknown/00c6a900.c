...
void FUN_00c6a900(ushort *param_1,uint param_2,uint64_t param_3,char param_4)

{
  ...
  *arg1 = iVar10;
  uVar20 = (uint)param_3;
  if (uVar20 == 0) {
    if ((this_ptr != arg1) && (1 < (int)param_2)) {
    ...
    if (uVar20 == 0x1f) {
      if (1 < (int)param_2) {
        ...
        if (param_2 != 2) {
          lVar29 = 1;
          do {
            iVar10 = (iVar10 + this_ptr[lVar29] << (bVar13 & 0x1f)) >> (bVar13 & 0x1f);
            arg1[lVar29] = iVar10;
            iVar10 = (iVar10 + this_ptr[lVar29 + 1] << (bVar13 & 0x1f)) >> (bVar13 & 0x1f);
            arg1[lVar29 + 1] = iVar10;
            lVar21 = lVar29 - ((uint64_t)param_2 - 1 & 0xfffffffffffffffe);
            lVar29 = lVar29 + 2;
          } while (lVar21 != -1);
        }
        if (((uint64_t)param_2 - 1 & 1) != 0) {
          arg1[lVar29] = (iVar10 + this_ptr[lVar29] << (bVar13 & 0x1f)) >> (bVar13 & 0x1f);
        }
      }
    }
    else {
      ...
      if (0 < (int)uVar20) {
        ...
        if (uVar36 != 2) {
          ...
          do {
            ...
            iVar10 = (iVar10 + this_ptr[lVar29 + 1] << (bVar13 & 0x1f)) >> (bVar13 & 0x1f);
            arg1[lVar29 + 1] = iVar10;
            lVar21 = lVar29 - ((uint64_t)uVar36 - 1 & 0xfffffffffffffffe);
            lVar29 = lVar29 + 2;
          } while (lVar21 != -1);
        }
        if (((uint64_t)uVar36 - 1 & 1) != 0) {
          arg1[lVar29] = (iVar10 + this_ptr[lVar29] << (bVar13 & 0x1f)) >> (bVar13 & 0x1f);
        }
      }
      ...
      if (uVar20 == 4) {
        ...
        if (5 < (int)param_2) {
          ...
          uVar41 = 5;
          do {
            iVar18 = arg1[uVar41 - 5];
            iVar17 = iVar18 - iVar10;
            iVar31 = iVar18 - arg1[uVar41 - 2];
            iVar24 = iVar18 - arg1[uVar41 - 3];
            iVar11 = iVar18 - arg1[uVar41 - 4];
            local_50 = (short)uVar36;
            local_40 = (short)uVar20;
            iVar19 = this_ptr[uVar41];
        ...
        *param_1 = uVar3;
        ...
        if (9 < (int)param_2) {
          ...
          uVar41 = 9;
          do {
            iVar18 = arg1[uVar41 - 9];
            iVar17 = iVar18 - iVar10;
            iVar24 = iVar18 - arg1[uVar41 - 2];
            iVar11 = iVar18 - arg1[uVar41 - 3];
            iVar43 = iVar18 - arg1[uVar41 - 4];
            iVar31 = iVar18 - arg1[uVar41 - 5];
            iVar37 = iVar18 - arg1[uVar41 - 6];
            iVar35 = iVar18 - arg1[uVar41 - 7];
            iVar34 = iVar18 - arg1[uVar41 - 8];
        ...
        *param_1 = uVar3;
        ...
        if ((int)uVar20 < 1) {
          lVar21 = (int64_t)(int)uVar20 + 1;
          lVar29 = 0x100000000 - (uVar41 << 0x20);
          do {
            iVar10 = arg1[lVar21 - (int)uVar36];
            iVar18 = this_ptr[lVar21];
            ...
            if ((int)uVar20 < 1) {
              if ((int)uVar20 < 0) {
                ...
                do {
                  ...
                  iVar11 = iVar10 - *(int *)((int64_t)arg1 + (lVar16 >> 0x1e) + lVar30);
          ...
          lVar21 = (int64_t)(int)uVar36;
          uVar38 = (uint64_t)(uVar20 & 0xfffffff8);
          piVar33 = arg1 + lVar21 + -4;
          piVar42 = arg1 + lVar21 + -1;
          lVar30 = 0x100000000 - (uVar41 << 0x20);
          lVar29 = lVar21;
          do {
            iVar10 = arg1[lVar29 - lVar21];
            if (uVar20 < 8) {
              iVar18 = 0;
              uVar26 = 0;
LAB_00c6b210:
              ...
              puVar22 = param_1 + 4;
              do {
                in_XMM3 = pmovsxwd(in_XMM3,*(void*)(puVar22 + -4));
                in_XMM4 = pmovsxwd(in_XMM4,*(void*)puVar22);
            ...
            *piVar1 = ((iVar18 + iVar9 >> (bVar14 & 0x1f)) + iVar10 + iVar19 << (bVar13 & 0x1f)) >>
            ...
            if ((int)uVar36 < 1) {
              if ((int)uVar36 < 0) {
                ...
                uVar26 = uVar41;
                do {
                  if ((int64_t)uVar26 < 1) break;
                  iVar11 = iVar10 - *(int *)((int64_t)piVar1 + (lVar16 >> 0x1e) + -4);
