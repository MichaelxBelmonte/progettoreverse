...
void FUN_013ea3f0(void* param_1,uint64_t param_2)

{
  ...
  if (lVar6 != 0) {
    ...
    while( true ) {
      ...
      plVar10 = *(int64_t **)(lVar6 + 0x10);
      plVar16 = (int64_t *)plVar10[(int64_t)(int)local_78 + 1];
      if (local_90 == (int64_t *)0x0) {
        ...
        while( true ) {
          ...
          plVar10 = (int64_t *)local_50[2];
          local_60 = (int64_t *)plVar10[lVar5 + 1];
          FUN_013e9070();
          plVar2 = (int64_t *)CONCAT71(uStack_af,local_b0);
          if ((local_a8 != '\0') && (plVar2 != (int64_t *)0x0)) {
            FUN_00d50b20();
          }
      ...
      if (cVar3 == '\0' && !bVar17) {
        ...
        FUN_00d21140();
        local_90 = local_38;
        if ((local_58[0] != '\0') && (plVar16 != (int64_t *)0x0)) {
          FUN_00d50b20();
        }
        uVar13 = ~local_78._4_4_;
        bVar17 = -1 < local_78;
  ...
  if (local_90 != (int64_t *)0x0) {
    if (0 < *(int *)((int64_t)local_90 + 0xc)) {
      uVar13 = 0;
      do {
        plVar16 = *(int64_t **)(local_90[2] + (uint64_t)uVar13 * 8);
        uVar9 = uVar13;
        pvVar4 = _pthread_getspecific(uVar13);
        plVar10 = plVar16;
        if ((pvVar4 != (void *)0x0) && (lVar6 = FUN_00e8b990(), lVar6 != 0)) {
          plVar10 = (int64_t *)plVar16[(uint64_t)(*(uint *)(lVar6 + 0x154) & 1) + 4];
        }
        cVar3 = (**(code **)(*plVar10 + 0x398))();
        if (cVar3 == '\0') {
          if ((int64_t *)this_ptr[0x1e] != (int64_t *)0x0) {
            local_58[0] = '\0';
            local_60 = (int64_t *)0x0;
            local_48 = 0xffffffff;
            local_40 = 0;
            local_50 = (int64_t *)this_ptr[0x1e];
            while( true ) {
              ...
              FUN_013e9070();
              local_90 = (int64_t *)CONCAT71(uStack_af,local_b0);
              if ((local_a8 != '\0') && (local_90 != (int64_t *)0x0)) {
                FUN_00d50b20();
              }
              if (local_90 == plVar16) {
                FUN_013eb3d0();
...
LAB_013eaa75:
            ...
            *pcVar7 = '\0';
            ...
            if (local_60 == (int64_t *)0x0) {
              ...
              uVar15 = (uint32_t)CONCAT71((int7)((uint64_t)local_90 >> 8),1);
              plVar10 = local_60;
              if (local_b0 == '\0') {
                FUN_00d50b00();
              }
            ...
            if (plVar10 == (int64_t *)0x0) goto LAB_013eaa60;
            FUN_00ca13a0();
            local_58[0] = '\0';
            FUN_00d21140();
            ...
            cVar3 = (**(code **)(*this_ptr + 0x648))();
            local_60 = plVar10;
            if (cVar3 != '\0') {
              pvVar4 = _pthread_getspecific(uVar9);
              if ((pvVar4 != (void *)0x0) && (lVar6 = FUN_00e8b990(), lVar6 != 0)) {
                plVar16 = (int64_t *)plVar16[(uint64_t)(*(uint *)(lVar6 + 0x154) & 1) + 4];
              }
              (**(code **)(*plVar16 + 0x378))();
              bVar17 = false;
              goto LAB_013eaa75;
...
LAB_013ea760:
        uVar13 = uVar13 + 1;
        local_90 = local_38;
      } while ((int)uVar13 < *(int *)((int64_t)local_38 + 0xc));
    }
    FUN_007fe1f0();
  }
  FUN_00d242c0();
