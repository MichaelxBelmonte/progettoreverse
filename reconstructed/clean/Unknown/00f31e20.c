...
byte * FUN_00f31e20(char *param_1,void*param_2)

{
  ...
  if ((pbVar4 != (byte *)0x0) && (*pbVar4 != 0)) {
    ...
    if ((uVar5 != 0) &&
      ...
      do {
        ...
        if (((bVar3 < 0x7f) && ((PTR___DefaultRuneLocale_0249c238[uVar5 * 4 + 0x3d] & 5) == 0)) &&
           ((uVar7 = (int)uVar5 - 0x2d, 0x32 < (byte)uVar7 ||
            ((0x4000000002003U >> ((uint64_t)(uVar7 & 0xff) & 0x3f) & 1) == 0))))
        goto LAB_00f31f00;
        pbVar1 = pbVar9 + 1;
      ...
      bVar3 = 0;
LAB_00f31f00:
      if (0 < (int64_t)pbVar9 - (int64_t)pbVar4) {
        FUN_00f2d870();
        bVar3 = *pbVar9;
      }
      if (bVar3 != 0) {
        ...
        if ((pbVar4 == (byte *)0x0) || (*pbVar4 != 0x3d)) {
          ...
          *(void*)(lVar10 + 0x54) = 6;
          _strlen(pcVar6);
          FUN_00f2d870();
          *(void*)(lVar10 + 100) = 0xffffffffffffffff;
        }
        else {
          pbVar4 = (byte *)FUN_00f2fd80();
          if (pbVar4 != (byte *)0x0) {
            ...
            if (bVar3 == 0x27) {
              pcVar6 = "\'";
LAB_00f32107:
              pbVar4 = (byte *)FUN_00f30260(pcVar6,0,0,(uint64_t)param_1 & 0xffffffff);
              return pbVar4;
            }
            if (bVar3 == 0x22) {
              pcVar6 = "\"";
            ...
            if (bVar3 != 0) {
              ...
              do {
                ...
                if ((char)bVar3 < '\0') {
                  ...
                  uVar7 = *(uint *)(puVar2 + (uint64_t)bVar3 * 4 + 0x3c) & 0x4000;
                }
                if (uVar7 != 0) {
                  return pbVar4;
                }
                ...
                uVar7 = *pbVar4 - 0x22;
                pcVar6 = (char *)(uint64_t)uVar7;
                if ((byte)uVar7 < 0x1d) {
                  pcVar6 = (char *)((int64_t)&switchD_00f321d4::switchdataD_00f3224c +
                                   (int64_t)
