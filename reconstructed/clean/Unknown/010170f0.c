...
uint64_t FUN_010170f0(CONF *param_1,char *param_2,char *param_3,long *param_4)
...
LAB_0101734e:
                  ...
                  if (iVar3 == 0) {
                    ...
                    if (local_58.meth != (CONF_METHOD *)((int64_t)&MACH_HEADER.magic + 1)) {
                    ...
                    if (iVar4 == 0) goto LAB_01017540;
                    if (g_028a8ea0 == 0) {
                      g_028a8ea0 = _OPENSSL_sk_new_null();
                      iVar3 = (int)in_stack_ffffffffffffff98;
                      if (g_028a8ea0 != 0) goto LAB_010173c6;
                    }
                    else {
LAB_010173c6:
          ...
          if ((pLVar10 != (LHASH *)0x0) && (local_58.meth == (CONF_METHOD *)0xffffffffffffffff)) {
            ...
            if (iVar2 != 0) {
              if (g_028a8ea0 == 0) {
                g_028a8ea0 = _OPENSSL_sk_new_null();
                iVar3 = (int)in_stack_ffffffffffffff98;
                if (g_028a8ea0 != 0) goto LAB_01017467;
              }
              else {
LAB_01017467:
