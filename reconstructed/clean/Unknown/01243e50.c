...
void* FUN_01243e50(void* param_1,int64_t *param_2)

{
  ...
  local_a8 = param_2;
  if ((g_028ac278 == (int64_t *)0x0) || (g_028ac281 == '\0')) {
    FUN_00e8cb50();
    if (g_028ac278 == (int64_t *)0x0) {
      plVar15 = (int64_t *)FUN_00e8fc40();
      FUN_00d4ff40();
      param_1 = 0x2572358;
      local_e8 = &g_02572358;
      *plVar15 = (int64_t)&g_02572358;
      pcVar2 = g_02572370;
      (*g_02572370)();
      bVar17 = g_028ac278 == (int64_t *)0x0;
      g_028ac278 = plVar15;
      if (((bVar17) || (FUN_00d50b20(), g_028ac278 != (int64_t *)0x0)) && (g_028ac280 == '\0'))
      {
        g_028ac280 = '\x01';
        FUN_00e8cb90();
      }
...
LAB_01243f76:
        ...
        while( true ) {
          ...
          local_88 = CONCAT44(local_88._4_4_,iVar16);
          if (*(int *)((int64_t)local_90 + 0xc) <= iVar16) break;
          lVar14 = local_90[2];
          local_a0 = *(int64_t **)(lVar14 + 8 + lVar11 * 8);
          pvVar9 = _pthread_getspecific((void*)lVar14);
          pVar13 = (void*)lVar14;
          if (pvVar9 != (void *)0x0) {
            FUN_00e8b990();
          }
...
LAB_012441a5:
          ...
          local_208 = plVar15;
          local_200 = '\0';
          cVar4 = (**(code **)(*(int64_t *)plVar10[3] + 0x50))();
          if ((local_200 != '\0') && (local_208 != (int64_t *)0x0)) {
            FUN_00d50b20();
          }
          if ((cVar4 == '\0') && (plVar7 = (int64_t *)plVar10[4], plVar7 != plVar15)) {
            if (plVar15 != (int64_t *)0x0) {
              FUN_00d50b00();
            }
            plVar10[4] = (int64_t)plVar15;
          ...
          if (plVar10[4] == 0) {
            ...
            *puVar6 = local_e8;
            ...
            if ((cVar4 == '\0') && (plVar1 = (int64_t *)plVar10[4], plVar1 != plVar7)) {
              if (plVar7 != (int64_t *)0x0) {
                FUN_00d50b00();
              }
              plVar10[4] = (int64_t)plVar7;
  ...
  if (*local_a8 == 0) {
    ...
    if (local_a0 == (int64_t *)0x0) {
      ...
      local_e8 = (void*)CONCAT71((int7)((uint64_t)uVar8 >> 8),1);
  ...
  plVar7 = (int64_t *)*arg1;
  if (plVar7 == local_a0) {
    if ((*(char *)(arg1 + 1) != '\0') || (local_a0 == (int64_t *)0x0)) goto LAB_01244b11;
    if ((char)local_98 == '\0') {
      FUN_00d50b00();
      goto LAB_01244b0d;
    }
...
LAB_01244b11:
  ...
  plVar7 = local_a0;
  if ((char)local_98 == '\0') {
    if (((local_a0 != (int64_t *)0x0) && (FUN_00d50b00(), (char)local_98 != '\0')) &&
       (local_a0 != (int64_t *)0x0)) {
      FUN_00d50b20();
    }
  }
    ...
    while( true ) {
      ...
      *(void*)(local_a0 + 5) = 0;
      ...
      if (plVar15 == (int64_t *)0x0) {
        ...
        local_1b8 = plVar15;
        uVar3 = FUN_017c0150();
        local_78 = (int64_t *)CONCAT71(local_78._1_7_,uVar3);
      ...
      if ((local_148 != '\0') && ((char)local_78 != '\0')) {
          ...
          while( true ) {
            ...
            if (local_40 != (int64_t *)0x0) {
              ...
              while( true ) {
                ...
                lVar11 = (int64_t)(int)local_b8;
                iVar16 = (int)local_b8 + 1;
                local_b8 = CONCAT44(local_b8._4_4_,iVar16);
                if (*(int *)((int64_t)local_c0 + 0xc) <= iVar16) break;
                local_1a8 = *(int64_t **)(local_c0[2] + 8 + lVar11 * 8);
                local_1a0 = '\0';
                local_d0 = local_1a8;
                cVar4 = FUN_00d90eb0();
                ...
                if (cVar4 != '\0') {
                  ...
                  local_180 = '\0';
                  uVar18 = FUN_00d9c300();
                  local_78 = (int64_t *)CONCAT44(local_78._4_4_,uVar18);
        ...
        local_78 = (int64_t *)local_a0[4];
        if (local_78 == (int64_t *)0x0) {
          if (plVar7 == (int64_t *)0x0) goto LAB_01244c78;
LAB_01244c73:
          FUN_00d50b20();
        }
        else {
...
LAB_0124520f:
          ...
          if (local_a8 != (int64_t *)0x0) {
            ...
            while( true ) {
              ...
              if (local_40 != (int64_t *)0x0) {
                ...
                while( true ) {
                  ...
                  local_b8 = CONCAT44(local_b8._4_4_,iVar16);
                  if (*(int *)((int64_t)local_c0 + 0xc) <= iVar16) break;
                  local_178 = *(int64_t **)(local_c0[2] + 8 + lVar11 * 8);
                  local_170 = '\0';
                  local_d0 = local_178;
                  cVar4 = FUN_00d90eb0();
            ...
            FUN_00018280();
            if (local_a8 != (int64_t *)0x0) goto LAB_01244c73;
          }
        }
      }
LAB_01244c78:
...
joined_r0x0124580e:
  ...
  FUN_00d23310();
  plVar10 = local_a0;
  pVar13 = (void*)CONCAT71((int7)((uint64_t)lVar14 >> 8),(char)local_98);
  pplVar12 = &local_98;
  if ((char)local_98 == '\0') {
    pplVar12 = &local_68;
  }
  local_68 = (int64_t *)CONCAT71(local_68._1_7_,(char)local_98);
  *(void*)pplVar12 = 0;
  if (((char)local_98 != '\0') && (local_a0 != (int64_t *)0x0)) {
    FUN_00d50b20();
  }
  if ((char)local_68 == '\0') {
    if (plVar10 == (int64_t *)0x0) goto LAB_01245770;
    FUN_00d50b00();
  }
  else if (plVar10 == (int64_t *)0x0) {
LAB_01245770:
    *(void*)(this_ptr + 1) = 0;
    *this_ptr = 0;
...
joined_r0x01245782:
  ...
  if (((char)local_e8 != '\0') && (plVar15 != (int64_t *)0x0)) {
    FUN_00d50b20();
  }
  return this_ptr;
}
