...
void FUN_00fcc780(uint64_t param_1,int *param_2)

{
  ...
  lVar48 = (int64_t)*param_2;
  lVar43 = (int64_t)param_2[1];
  lVar39 = (int64_t)param_2[2];
  lVar34 = (int64_t)param_2[3];
  lVar23 = (int64_t)param_2[4];
  lVar36 = (int64_t)param_2[5];
  lVar41 = (int64_t)param_2[6];
  lVar45 = (int64_t)param_2[7];
  lVar2 = (int64_t)param_2[8];
  lVar33 = (int64_t)param_2[9] * 0x13;
  lVar6 = (int64_t)*arg1;
  lVar3 = (int64_t)arg1[1];
  lVar1 = lVar2 * 0x13;
  lVar13 = lVar3 * 2;
  lVar20 = (int64_t)arg1[2];
  lVar46 = (int64_t)arg1[3];
  lVar18 = lVar46 * 2;
  lVar7 = (int64_t)arg1[4];
  lVar24 = (int64_t)arg1[5];
  lVar19 = lVar24 * 2;
  lVar37 = (int64_t)arg1[6];
  lVar42 = (int64_t)arg1[7];
  lVar28 = lVar42 * 2;
  lVar25 = (int64_t)arg1[8];
  lVar21 = (int64_t)arg1[9];
  lVar8 = lVar34 * 0x13;
  lVar10 = lVar23 * 0x13;
  lVar11 = lVar36 * 0x13;
  lVar12 = lVar41 * 0x13;
  ...
  *this_ptr = ((int)lVar1 + (int)lVar26) - ((uint)uVar4 & 0xfc000000);
  this_ptr[1] = (int)(uVar4 >> 0x1a) + (((int)lVar30 + (int)lVar35) - ((uint)lVar14 & 0xfe000000));
  this_ptr[2] = ((int)lVar8 + (int)lVar44) - ((uint)lVar9 & 0xfc000000);
  this_ptr[3] = ((int)lVar40 + (int)lVar17) - ((uint)lVar11 & 0xfe000000);
  this_ptr[4] = ((int)lVar18 + (int)lVar22) - ((uint)uVar5 & 0xfc000000);
  this_ptr[5] = (int)(uVar5 >> 0x1a) + (((int)lVar49 + (int)lVar15) - ((uint)lVar16 & 0xfe000000));
  this_ptr[6] = ((int)lVar47 + (int)lVar31) - ((uint)lVar10 & 0xfc000000);
  this_ptr[7] = ((int)lVar32 + (int)lVar27) - ((uint)lVar12 & 0xfe000000);
  this_ptr[8] = ((int)lVar38 + (int)lVar28) - ((uint)lVar19 & 0xfc000000);
  this_ptr[9] = ((int)lVar13 + (int)lVar29) - ((uint)lVar33 & 0xfe000000);
  return;
}
