...
void FUN_00a26a1e(uint64_t param_1,uint64_t param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a26a9b:
    if ((plVar16 == plVar4) || ((int64_t)plVar16 - (int64_t)plVar3 == -8)) goto LAB_00a26aa9;
    lVar17 = (int64_t)plVar16 - (int64_t)plVar3 >> 3;
  }
  else {
    do {
      if (*plVar16 == *(int64_t *)(arg1 + 0x10)) goto LAB_00a26a9b;
      plVar16 = plVar16 + 1;
...
LAB_00a26aa9:
  ...
  *(int64_t *)((int64_t)pvVar11 + 0x18) = lVar9 + lVar17 * 8 + ((int64_t)pvVar10 >> 3) * 8;
  lVar14 = lVar17 * 0x148 + *(int64_t *)((int64_t)pvVar8 + 0x48);
  lVar12 = lVar14 + 0x148;
