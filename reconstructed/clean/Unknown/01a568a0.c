...
uint64_t FUN_01a568a0(uint64_t param_1,byte param_2)

{
  ...
  if (plVar9 == (int64_t *)0x0) {
LAB_01a56b4e:
    if (g_02802688 != 0) goto LAB_01a56b5f;
LAB_01a56c79:
    FUN_01a58e40();
    FUN_00d23310();
    plVar7 = local_40;
    ...
    *(char *)pplVar6 = '\0';
    ...
    if (local_60 == (int64_t *)0x0) goto LAB_01a56c79;
LAB_01a56b5f:
    FUN_01a58e40();
    FUN_00d23310();
    pVar4 = (void*)CONCAT71((int7)((uint64_t)param_1 >> 8),local_38[0]);
