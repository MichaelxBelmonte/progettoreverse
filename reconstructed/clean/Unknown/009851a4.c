...
void FUN_009851a4(char *param_1,void*param_2)

{
  ...
  local_40 = param_2;
  uVar10 = FUN_0096dfe2();
  (**(code **)(*this_ptr + 0x40))(uVar10,unaff_ESI);
  plVar3 = local_88;
  if (local_88 == (int64_t *)0x0) {
    *local_40 = 0xffffffff;
    ...
    if (pcVar9 != 0x0) {
      LOCK();
      pcVar1 = pcVar9 + 8;
      lVar2 = *(int64_t *)pcVar1;
      *(int64_t *)pcVar1 = *(int64_t *)pcVar1 + -1;
      UNLOCK();
      if (lVar2 == 0) {
        (**(code **)(*(int64_t *)pcVar9 + 0x10))();
    ...
    if (pcStack_80 != 0x0) {
      LOCK();
      pcVar9 = pcStack_80 + 8;
      lVar2 = *(int64_t *)pcVar9;
      *(int64_t *)pcVar9 = *(int64_t *)pcVar9 + -1;
      UNLOCK();
      if (lVar2 == 0) {
        (**(code **)(*(int64_t *)pcStack_80 + 0x10))();
        std::__shared_weak_count::__release_weak();
      }
    }
    ...
    cVar5 = (**(code **)(*this_ptr + 400))(uVar10,&local_68);
    if (cVar5 == '\0') {
      cVar5 = (**(code **)(*this_ptr + 400))(extraout_XMM0_Da,&local_68);
      if (cVar5 == '\0') {
        cVar5 = (**(code **)(*this_ptr + 400))(extraout_XMM0_Da_00,&local_68);
        if (cVar5 == '\0') {
          cVar5 = (**(code **)(*this_ptr + 400))(extraout_XMM0_Da_01,&local_68);
          if (cVar5 == '\0') {
            FUN_00925fd0();
            uVar6 = FUN_00926010();
            uVar10 = FUN_00928ab0("virtual void pace::Asn1ParserCert::GetEccPublicKey(uint32_t, uint32_t &, BIG_PublicKeyECC_Struct &)"
