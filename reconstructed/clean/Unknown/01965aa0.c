...
void* FUN_01965aa0(void* param_1,void*param_2)
    ...
    if (local_40 != (int64_t *)0x0) {
      ...
      if (local_40 != (int64_t *)0x0) {
        ...
        if (fVar18 <= (float)local_68._0_4_) {
          ...
          auVar36._4_12_ = SUB1612(auVar34 | g_023945f0,4);
          auVar36._0_4_ = SUB164(auVar34 | g_023945f0,0) + fVar31;
          auVar34 = roundss(auVar36,auVar36,0xb);
          auVar37._4_12_ = auVar34._4_12_;
          auVar37._0_4_ = auVar34._0_4_ + g_02390124 + fVar19;
          local_68 = blendps(auVar37,local_58,0xe);
          if (fVar3 < fVar18) goto LAB_01965cc0;
LAB_01965daf:
          fVar18 = fVar18 + *(float *)(param_2 + 1) + g_02390d00;
          if (fVar3 <= fVar18) {
            local_88 = ZEXT816(0);
          }
          else {
            local_88 = ZEXT816(0);
            fVar3 = fVar3 - fVar18;
            auVar23._0_4_ = g_023945e0 & (uint)fVar3;
            ...
            auVar24._0_4_ = SUB164(auVar23 | g_023945f0,0) + fVar3;
            auVar8._0_12_ = ZEXT812(0);
            auVar8._12_4_ = 0;
            auVar34 = roundss(auVar8,auVar24,0xb);
            local_58 = blendps(local_58,ZEXT416((uint)(fVar19 + auVar34._0_4_ + g_02390124)),1);
          }
        }
        else {
          auVar32._0_4_ = g_023945e0 & (uint)((float)local_68._0_4_ - fVar18);
          ...
          auVar33._0_4_ = SUB164(auVar32 | g_023945f0,0) + ((float)local_68._0_4_ - fVar18);
          auVar34 = roundss(auVar33,auVar33,0xb);
          auVar35._4_12_ = auVar34._4_12_;
          auVar35._0_4_ = auVar34._0_4_ + g_02390d00;
...
LAB_01965cc0:
          auVar20._0_4_ = g_023945e0 & (uint)(fVar3 - fVar18);
          ...
          auVar21._0_4_ = SUB164(auVar20 | g_023945f0,0) + (fVar3 - fVar18);
          auVar6._0_12_ = ZEXT812(0);
          auVar6._12_4_ = 0;
          auVar34 = roundss(auVar6,auVar21,0xb);
          auVar7._4_12_ = auVar34._4_12_;
          auVar7._0_4_ = auVar34._0_4_ + g_02390d00;
        ...
        auVar10._0_4_ = (float)auVar9._0_8_ + g_0241b664;
        ...
        auVar12._0_4_ = (float)auVar11._0_8_ + g_023908e0;
        uVar5 = FUN_0198a7d0(auVar12._0_8_);
        fVar19 = *(float *)((int64_t)param_2 + 4);
        local_98 = (float)uVar4;
        uStack_94 = (uint)((uint64_t)uVar4 >> 0x20);
        uStack_90 = (uint)extraout_XMM0_Qb_02;
        uStack_8c = (uint)((uint64_t)extraout_XMM0_Qb_02 >> 0x20);
        if (fVar19 <= local_98) {
          fVar3 = *(float *)((int64_t)param_2 + 0xc) + fVar19 + g_02390d00;
          if (fVar3 < local_98) {
            local_98 = local_98 - fVar3;
            auVar41._0_4_ = g_023945e0 & (uint)local_98;
            auVar41._4_4_ = _UNK_023945e4 & uStack_94;
            auVar41._8_4_ = _UNK_023945e8 & uStack_90;
            auVar41._12_4_ = _UNK_023945ec & uStack_8c;
            auVar42._4_12_ = SUB1612(auVar41 | g_023945f0,4);
            auVar42._0_4_ = SUB164(auVar41 | g_023945f0,0) + local_98;
            ...
            auVar44._0_4_ = fVar3 + auVar34._0_4_ + g_02390124;
            auVar34 = insertps(local_68,auVar44,0x10);
            local_68._0_8_ = auVar34._0_8_;
          }
        }
        else {
          auVar38._0_4_ = g_023945e0 & (uint)(local_98 - fVar19);
          ...
          auVar39._0_4_ = SUB164(auVar38 | g_023945f0,0) + (local_98 - fVar19);
          auVar34 = roundss(auVar39,auVar39,0xb);
          auVar40._4_12_ = auVar34._4_12_;
          auVar40._0_4_ = auVar34._0_4_ + g_02390d00;
          insertps(local_a8,auVar40,0x10);
        }
        fVar3 = (float)uVar5;
        uVar16 = (uint)((uint64_t)uVar5 >> 0x20);
        uVar17 = (uint)((uint64_t)extraout_XMM0_Qb_04 >> 0x20);
        if (fVar19 <= fVar3) {
          fVar19 = fVar19 + *(float *)((int64_t)param_2 + 0xc) + g_02390d00;
          if (fVar19 < fVar3) {
            fVar3 = fVar3 - fVar19;
            auVar27._0_4_ = g_023945e0 & (uint)fVar3;
            ...
            auVar28._0_4_ = SUB164(auVar27 | g_023945f0,0) + fVar3;
            ...
            auVar30._0_4_ = fVar19 + auVar34._0_4_ + g_02390124;
            insertps(local_58,auVar30,0x10);
          }
        }
        else {
          auVar25._0_4_ = g_023945e0 & (uint)(fVar3 - fVar19);
