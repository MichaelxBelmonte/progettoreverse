...
void FUN_00a3cb5e(uint64_t param_1,uint64_t param_2,char *param_3)

{
  ...
  if (plVar3 == plVar4) {
LAB_00a3cc03:
    if ((plVar15 == plVar4) || ((int64_t)plVar15 - (int64_t)plVar3 == -8)) goto LAB_00a3cc11;
...
LAB_00a3cc11:
  ...
  *(int64_t *)((int64_t)pvVar10 + 0x18) = lVar8 + lVar16 * 8 + ((int64_t)pvVar9 >> 3) * 8;
  lVar13 = lVar16 * 0x150 + *(int64_t *)((int64_t)pvVar7 + 0x48);
  lVar11 = lVar13 + 0x150;
