...
int64_t FUN_010c5370(ASN1_ITEM *param_1,uint64_t param_2,uint64_t param_3,CONF_VALUE *param_4)
...
LAB_010c558c:
      ...
      local_60 = *(void*)(lVar3 + 0x10);
      pGVar6 = _v2i_GENERAL_NAME_ex(&local_70,arg1,(X509V3_CTX *)0x0,param_4,(int)uVar10);
