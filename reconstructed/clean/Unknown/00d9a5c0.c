      ...
      if (1 < (int)uVar17) {
        ...
        if ((7 < uVar21) && ((psVar2 + uVar26 <= psVar19 + 1 || (psVar19 + uVar26 <= psVar2 + 1))))
        {
          ...
          if (uVar20 - 8 == 0) {
            ...
            lVar24 = 1;
            do {
              auVar39 = *(uint8_t (*) [16])(psVar2 + lVar24);
              ...
              *(uint8_t (*) [16])(psVar19 + lVar24) = auVar39;
              auVar39 = *(uint8_t (*) [16])(psVar2 + lVar24 + 8);
              uVar40 = auVar39._0_2_ + sVar1;
              uVar43 = auVar39._2_2_ + sVar23;
              uVar44 = auVar39._4_2_ + sVar3;
              uVar45 = auVar39._6_2_ + sVar4;
              ...
              *(uint8_t (*) [16])(psVar19 + lVar24 + 8) = auVar39;
              lVar24 = lVar24 + 0x10;
              lVar25 = lVar25 + 2;
            } while (lVar25 != 0);
          }
          if ((uVar22 & 1) != 0) {
            auVar39 = *(uint8_t (*) [16])(psVar2 + lVar24);
            uVar30 = g_023de260 + auVar39._0_2_;
            ...
            auVar29._0_2_ =
                 -(ushort)((ushort)((uVar30 < g_023de270) * uVar30 |
                                   (uVar30 >= g_023de270) * g_023de270) == uVar30);
            auVar29._2_2_ =
            ...
            auVar31._0_2_ = g_023de280 + auVar39._0_2_;
...
LAB_00d9a8a8:
      ...
      if (*(int *)(puVar18 + 4) != -1) {
        FUN_00e83070();
        puVar18[3] = 0;
        *(void*)(puVar18 + 4) = 0xffffffff;
      }
      puVar18[3] = psVar19;
      *(uint *)(puVar18 + 4) = uVar17;
      *(byte *)((int64_t)puVar18 + 0x24) = *(byte *)((int64_t)puVar18 + 0x24) & 0xfe;
      goto LAB_00d9a913;
    }
  }
  *(void*)(this_ptr + 1) = 0;
