...
int64_t * FUN_017921e0(uint64_t param_1,int64_t *param_2,uint32_t param_3)
...
LAB_01792758:
  ...
  do {
    ...
    if ((~(uint)(*(uint64_t *)(lVar17 + 0x18) >> ((char)uVar15 * '\x04' & 0x3fU)) & 0xf) != 0) {
      iVar9 = FUN_01715480();
      iVar11 = FUN_01715480();
      iVar12 = FUN_01715480();
      ...
      if ((~(uint)(uVar1 >> (cVar16 * '\x04' & 0x3fU)) & 0xf) == 0) {
        ...
        if ((~*(uint *)(*arg1 + 0x18) & 0xf0000000) != 0) {
          if (iVar11 == 4) {
...
LAB_01792e24:
        if (!bVar20 && !bVar21) {
          local_74 = (uint)CONCAT71((uint7)(uint3)(~*(uint *)(*arg1 + 0x18) >> 8),1);
...
LAB_01792be0:
  ...
  do {
    ...
    if (((~(uint)(uVar1 >> (bVar4 & 0x3f)) & 0xf) != 0) &&
       ((~(uint)(*(uint64_t *)(*arg1 + 0x18) >> (bVar4 & 0x3f)) & 0xf) == 0)) {
  ...
  if ((char)local_ac != '\0') {
    ...
    if ((iVar9 != -1) &&
       ((~(uint)(*(uint64_t *)(*arg1 + 0x18) >> ((byte)(iVar9 * 4) & 0x3f)) & 0xf) == 0)) {
