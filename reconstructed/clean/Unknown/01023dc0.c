...
uint64_t FUN_01023dc0(void *param_1,void*param_2)
  ...
  if (*(int *)(lVar3 + 0xf8) != 0) {
    if (*(int *)(lVar3 + 0x110) < 0) {
      ...
      if (arg1 == (void*)0x0) {
        ...
        iVar2 = _CRYPTO_ccm128_setiv(param_1,0xf - (int64_t)*(int *)(lVar3 + 0x108));
        pvVar7 = (void *)0xffffffff;
...
LAB_010240b6:
      ...
      if (iVar2 == 0) {
        ...
        pvVar6 = (void *)(int64_t)*(int *)(lVar3 + 0x10c);
...
LAB_0102415d:
    ...
    lVar3 = _EVP_CIPHER_CTX_get_cipher_data();
    if ((arg1 != param_2) || (param_1 < (void *)((int64_t)*(int *)(lVar3 + 0x10c) + 8U)))
    goto LAB_010241a5;
    iVar2 = _EVP_CIPHER_CTX_encrypting();
    if (iVar2 != 0) {
    ...
    *(void*)(lVar5 + 4) = *param_2;
    param_1 = (void *)((int64_t)param_1 + (-8 - (int64_t)*(int *)(lVar3 + 0x10c)));
    _EVP_CIPHER_CTX_iv_noconst();
    iVar2 = _CRYPTO_ccm128_setiv(param_1,0xf - (int64_t)*(int *)(lVar3 + 0x108));
    if (iVar2 != 0) goto LAB_010241a5;
    _EVP_CIPHER_CTX_buf_noconst();
    ...
    if (iVar2 != 0) {
      ...
      if (iVar2 == 0) {
        ...
        pvVar7 = (void *)0xffffffff;
        if (lVar5 != 0) {
          pvVar7 = (void *)(uint64_t)((int)param_1 + *(int *)(lVar3 + 0x10c) + 8);
        }
      }
      goto LAB_010241a5;
    }
    ...
    if (iVar2 == 0) {
      ...
      lVar5 = _CRYPTO_ccm128_tag();
      if (lVar5 != 0) {
        pvVar7 = (void *)(int64_t)*(int *)(lVar3 + 0x10c);
