...
DSA_SIG * FUN_00fc1f70(BN_CTX *param_1,int64_t param_2,uint64_t param_3,BIGNUM *param_4)

{
  ...
  a_02 = (BIGNUM *)0x0;
  iVar1 = 0x65;
  if (((*(int64_t *)(param_2 + 8) != 0) && (*(int64_t *)(param_2 + 0x10) != 0)) &&
     (*(int64_t *)(param_2 + 0x18) != 0)) {
      ...
      if (pDVar3 != (DSA_SIG *)0x0) {
        ...
        if (((pDVar3->r != (BIGNUM *)0x0) && (pBVar4 != (BIGNUM *)0x0)) &&
          ...
          if (pBVar5 != (BIGNUM *)0x0) {
            pBVar5 = pDVar3->r;
            param_4 = (BIGNUM *)(uint64_t)unaff_ESI;
            pBVar6 = this_ptr;
            ...
            if (iVar1 != 0) {
              while( true ) {
                ...
                pBVar5 = pDVar3->r;
                param_4 = (BIGNUM *)(uint64_t)local_34;
                pBVar6 = this_ptr;
                iVar1 = FUN_00fc2650(pBVar5,&stack0xffffffffffffffb8);
                if (iVar1 == 0) break;
              }
