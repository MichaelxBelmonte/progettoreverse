...
void* FUN_0171f300(int64_t *param_1,int64_t *param_2,int64_t *param_3,int64_t *param_4)

{
  ...
  *puVar7 = &g_025683c0;
  ...
  lVar10 = 0;
  do {
    uVar4 = (uint)(*(uint64_t *)(*param_2 + 0x18) >> ((char)lVar10 * '\x04' & 0x3fU)) & 0xf;
    if (uVar4 == 0xf) {
      uVar4 = 0xffffffff;
    }
    if (uVar4 == unaff_ESI) {
      ...
      do {
        if (iVar12 >> 2 <= (int)lVar14) {
          ...
          piVar16 = (int *)((int64_t)iVar1 + puVar7[2]);
          goto LAB_0171f390;
        }
  ...
  if ((*(uint *)(puVar7 + 3) & 0xfffffffc) == 4) {
    ...
    if (iVar3 == iVar1) {
      if ((lVar10 != 0) && (*param_1 != 0)) {
        uVar5 = (uint)(*(uint64_t *)(lVar10 + 0x18) >> ((byte)(iVar3 << 2) & 0x3f)) & 0xf;
        uVar4 = 0xffffffff;
        if (uVar5 != 0xf) {
          uVar4 = uVar5;
        }
    ...
    if ((lVar10 != 0) && (*param_3 != 0)) {
      if ((unaff_ESI < 0xd) && ((0x1500U >> (unaff_ESI & 0x1f) & 1) != 0)) {
        uVar5 = (uint)(*(uint64_t *)(lVar10 + 0x18) >> ((byte)(iVar1 * 4) & 0x3f)) & 0xf;
        uVar4 = 0xffffffff;
        if (uVar5 != 0xf) {
          uVar4 = uVar5;
        }
    ...
    if ((int)uVar5 < iVar6 >> 2) {
      ...
      do {
        if ((*param_2 != 0) && (local_40 != 0)) {
          ...
          uVar5 = (uint)(*(uint64_t *)(*param_2 + 0x18) >> ((byte)iVar12 & 0x3f)) & 0xf;
          uVar4 = 0xffffffff;
          if (uVar5 != 0xf) {
            uVar4 = uVar5;
          }
      ...
      } while ((int64_t)uVar11 < (int64_t)(iVar6 >> 2));
    }
    if (iVar3 == iVar1) {
      if ((*param_2 != 0) && (local_40 != 0)) {
        uVar5 = (uint)(*(uint64_t *)(*param_2 + 0x18) >> ((byte)(*(int *)puVar7[2] * 4) & 0x3f)) &
                0xf;
        uVar4 = 0xffffffff;
        if (uVar5 != 0xf) {
          uVar4 = uVar5;
