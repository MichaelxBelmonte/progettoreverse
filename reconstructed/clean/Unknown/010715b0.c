...

{
  ...
  uVar10 = iVar2 + 7 >> 3;
  pvVar6 = _CRYPTO_malloc((int)rsa,(char *)((int64_t)&section_00000158.size + 5),(int)rsa_00);
  ...
  if ((int)uVar10 < unaff_EDI) {
    ...
    uVar3 = *(uint *)((int64_t)&param_1->_method_mod_n + 4);
    cVar11 = (char)uVar3;
    if (cVar11 < '\0') {
      local_48 = (BIGNUM *)0x0;
...
LAB_01071772:
    ...
    if ((((uVar3 & 0x20) == 0) && (param_1->version != 1)) &&
      ...
      _BN_with_flags();
      if ((((uint64_t)param_1->_method_mod_n & 0x200000000) != 0) &&
         (rsa = (char *)n,
    ...
    uVar8 = (int)param_3 - 1;
    if (uVar8 < 4) {
      to = (uchar *)(uint64_t)uVar3;
      iVar1 = (int)pvVar6;
      switch((int)param_3) {
      case 1:
        uVar3 = _RSA_padding_check_PKCS1_type_2
                          (to,iVar1,(uchar *)(uint64_t)uVar10,(int)param_4,iVar2);
        break;
      case 2:
        uVar3 = _RSA_padding_check_SSLv23(to,iVar1,(uchar *)(uint64_t)uVar10,(int)param_4,iVar2);
        break;
      case 3:
        _memcpy((void *)((int64_t)&switchD_010718fe::switchdataD_01071b1c +
                        (int64_t)(int)(&switchD_010718fe::switchdataD_01071b1c)[uVar8]),
                (void *)(int64_t)(int)uVar3,sVar9);
        break;
      case 4:
        param_4 = (BN_MONT_CTX *)0x0;
        uVar3 = _RSA_padding_check_PKCS1_OAEP
                          (to,iVar1,(uchar *)(uint64_t)uVar10,0,iVar2,(uchar *)param_2,
