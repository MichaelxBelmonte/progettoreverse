...
uint64_t FUN_010c73b0(BIO *param_1,ASN1_INTEGER **param_2,char *param_3,char *param_4)
  ...
  if (iVar3 == 0) {
    if (*arg1 == 0) {
      ...
      *arg1 = (int64_t)pAVar7;
      ...
      if (pAVar7 == (ASN1_OBJECT *)0x0) {
        ...
        _ERR_add_error_data(0x201e68a,*this_ptr,this_ptr[1],",value:");
        uVar13 = 0;
      }
      goto LAB_010c7554;
    }
    ...
    if (iVar3 != 0) {
      ...
      if (iVar3 == 0) {
        ...
        if (lVar8 != 0) {
          pvVar10 = (void *)((int64_t)&section_00000068.addr + 3);
          pcVar11 = _CRYPTO_realloc((void *)((int64_t)&section_00000068.addr + 3),0x201ea51,param_3
                                    ,(int)param_4);
          if (pcVar11 != (char *)0x0) {
            pBVar2 = param_1->method;
            pBVar2->name = pcVar11;
            ...
            pBVar2->type = iVar3;
            pBVar2->name[iVar3] = '\0';
            _CRYPTO_free((void *)(int64_t)iVar3);
            goto LAB_010c7554;
          }
        ...
        pcVar11 = (char *)((int64_t)&MACH_HEADER.cputype + 1);
        iVar3 = _strncmp((char *)b,(char *)((int64_t)&MACH_HEADER.cputype + 1),(size_t)param_3);
        if (iVar3 == 0) {
          ...
          if (pBVar9 == (BIO *)0x0) {
            ...
            do {
              while( true ) {
                ...
                pvVar10 = (void *)((int64_t)&section_00000068.reserved1 + 3);
                local_848 = _CRYPTO_realloc((void *)((int64_t)&section_00000068.reserved1 + 3),
                ...
                _memcpy(pvVar10,(void *)(uint64_t)uVar4,(size_t)param_3);
                pBVar6 = param_1->method;
                b = (BIO *)(int64_t)pBVar6->type;
                lVar8 = (int64_t)&b->method + (int64_t)(int)uVar4;
