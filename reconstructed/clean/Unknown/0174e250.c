...
void FUN_0174e250(void* param_1)
...
LAB_0174e47e:
    ...
    lVar15 = g_027cd590;
    if (local_58 == (void*)0x0) goto LAB_0174e47e;
    if (g_027cd590 != 0) {
      FUN_00d50b00();
    }
    uVar9 = FUN_00d90eb0();
  ...
  if (cVar7 == '\0') {
    ...
    uVar9 = FUN_01736dd0();
    if ((int)uVar9 < *(int *)((int64_t)local_58 + 0xc)) {
      lVar15 = (int64_t)(int)uVar9;
      pVar19 = 0;
      do {
        lVar27 = *(int64_t *)(local_58[2] + lVar15 * 8);
        puVar22 = local_58;
        if (lVar27 != 0) {
          FUN_00d50b00();
        }
...
LAB_0174ea00:
          ...
          cVar7 = FUN_01739960();
          if ((cVar7 != '\0') ||
             (pVar18 = pVar19, *(int *)((int64_t)local_58 + 0xc) <= (int)pVar19))
          goto LAB_0174ea00;
          pvVar14 = _pthread_getspecific(pVar19);
          if (pvVar14 != (void *)0x0) {
            FUN_00e8b990();
          }
          lVar17 = *(int64_t *)(local_58[2] + (int64_t)(int)pVar19 * 8);
          if (lVar17 != 0) {
            FUN_00d50b00();
          }
          FUN_01739510();
        ...
        lVar15 = lVar15 + 1;
      } while (lVar15 < *(int *)((int64_t)local_58 + 0xc));
    }
    if (0 < (int)uVar9) {
      lVar15 = (uint64_t)uVar9 + 1;
      local_68 = 1;
      do {
        uVar9 = uVar9 - 1;
        lVar27 = puVar16[2];
        lVar17 = *(int64_t *)(lVar27 + (uint64_t)uVar9 * 8);
        if (lVar17 != 0) {
          FUN_00d50b00();
        }
        pVar19 = (void*)lVar27;
...
LAB_0174ec80:
          ...
          cVar7 = FUN_01739960();
          if ((cVar7 != '\0') ||
             (pVar19 = local_68, *(int *)((int64_t)puVar16 + 0xc) <= (int)local_68))
          goto LAB_0174ec80;
          pvVar14 = _pthread_getspecific(local_68);
          if (pvVar14 != (void *)0x0) {
            FUN_00e8b990();
          }
          lVar27 = *(int64_t *)(puVar16[2] + (int64_t)(int)local_68 * 8);
          local_50 = '\x01';
          if (lVar27 != 0) {
            FUN_00d50b00();
          }
    ...
    if (unaff_ESI == 3) {
      ...
      puVar3 = (void*)local_58[2];
      puVar4 = (void*)local_58[2];
      puVar5 = (void*)local_58[2];
      *puVar3 = *puVar2;
      uVar11 = *puVar4;
      *puVar5 = uVar11;
      puVar5[0xc] = uVar11;
      ...
      *puVar16 = &g_025683c0;
      ...
      do {
        ...
        if ((int)uVar9 <= (int)uVar28) {
          ...
          if (*(int *)(local_58[2] + lVar17 * 4) == 3) {
            ...
            *(int *)(puVar16[2] + (int64_t)iVar30) = (int)lVar27;
            uVar9 = uVar28;
          }
        }
        lVar27 = lVar27 + 1;
      ...
      if (6 < uVar9 + 3) {
        ...
        uVar23 = (uint64_t)uVar21;
        lVar15 = puVar16[2];
        iVar30 = *(int *)(lVar15 + -4 + (int64_t)(int)uVar21 * 4);
        if (3 < (int)uVar9) {
          ...
          do {
            ...
            iVar12 = 0;
            do {
              pvVar14 = _pthread_getspecific((void*)uVar23);
              if ((pvVar14 != (void *)0x0) && (lVar15 = FUN_00e8b990(), lVar15 != 0)) {
                uVar23 = uVar1;
              }
              FUN_01736e70();
...
LAB_0174f7ec:
      ...
      while( true ) {
        ...
        FUN_01736e70();
        iVar12 = *(int *)((int64_t)local_58 + 0xc);
        if ((local_50 != '\0') && (local_58 != (void*)0x0)) {
          FUN_00d50b20();
        }
        ...
        if (*(int *)(local_58[2] + (int64_t)iVar12 * 4) == 3) {
          uVar23 = 3;
...
LAB_0174fb20:
          ...
          if (local_58 == (void*)0x0) goto LAB_0174fb20;
          bVar8 = true;
          if (local_50 == '\0') {
            FUN_00d50b00();
          }
      ...
      iVar10 = 0;
      fVar31 = (float)(**(code **)(*this_ptr + 0x3a0))();
      while( true ) {
        pvVar14 = _pthread_getspecific((void*)uVar23);
        if ((pvVar14 != (void *)0x0) && (lVar15 = FUN_00e8b990(), lVar15 != 0)) {
          uVar23 = uVar1;
...
LAB_0174e680:
          fVar32 = (float)(**(code **)(*this_ptr + 0x3a0))();
          FUN_00e7d780(((fVar32 - fVar31) + g_02394298) / g_0241c6f4);
          pvVar14 = _pthread_getspecific((void*)uVar23);
          if (pvVar14 != (void *)0x0) {
            FUN_00e8b990();
          }
...
LAB_0174e72d:
      ...
      while( true ) {
        ...
        FUN_01736e70();
        iVar25 = *(int *)((int64_t)local_58 + 0xc);
        if ((local_50 != '\0') && (local_58 != (void*)0x0)) {
          FUN_00d50b20();
        }
    ...
    if (local_58 == (void*)0x0) goto LAB_0174fc21;
  }
  FUN_00d50b20();
LAB_0174fc21:
  if (uVar1 != 0) {
