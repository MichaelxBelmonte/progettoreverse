// ===================================================================
// MUCandidateScale — Complete reconstructed pseudocode
// 2 functions
// ===================================================================
...
// 0187bc30
// ============================================================
// Function: FUN_0187bc30
// Address: 0187bc30
// Size: 2676 bytes
// Class: MUCandidateScale
// === MUCandidateScale properties ===
//                   _degree
//                   _finalWeight
//                   _isNoteStart
//                   _durationWeight
...
void FUN_0187bc30(uint64_t param_1,int param_2)
  ...
  if ((*this_ptr != 0) && (*arg1 != 0)) {
    ...
    if (param_2 == 0) {
      ...
      if (7 < (int)uVar4) {
        ...
        uVar22 = ((int)((uint64_t)(uVar22 - 3) * (uint64_t)(uVar22 - 2) >> 1) + uVar22 * 2) - 3;
      }
      FUN_00c8e690();
      ...
      if (7 < (int)uVar4) {
        ...
        do {
          ...
          if ((int64_t)uVar13 < (int64_t)(int)uVar18) {
            uVar23 = ~uVar11 + uVar15;
            lVar6 = *(int64_t *)(local_b0 + 0x10);
            lVar17 = (int64_t)(int)lVar17;
            uVar20 = uVar16;
            if ((3 < uVar23) &&
              ...
              do {
                ...
                *(uint8_t (*) [16])(uVar2 + uVar20 * 4) = auVar31;
                uVar20 = uVar20 + 4;
            ...
            if ((uVar18 - (int)uVar20 & 1) != 0) {
              uVar25 = _logf((*(float *)(lVar5 + uVar20 * 4) + g_02394254) / fVar41);
              fVar40 = _UNK_0240dfdc;
              fVar39 = _UNK_0240dfd8;
              fVar38 = _UNK_0240dfd4;
              fVar36 = g_0240dfd0;
              *(void*)(lVar6 + lVar17 * 4) = uVar25;
              lVar17 = lVar17 + 1;
              uVar11 = uVar20 + 1;
              fVar24 = g_02394254;
            }
            if (~uVar20 != -uVar15) {
              ...
              lVar14 = 0;
              do {
                uVar25 = _logf((*(float *)(lVar1 + -4 + lVar14 * 4) + g_02394254) / fVar41);
                *(void*)(lVar6 + lVar14 * 4) = uVar25;
                uVar25 = _logf((*(float *)(lVar1 + lVar14 * 4) + g_02394254) / fVar41);
                *(void*)(lVar6 + 4 + lVar14 * 4) = uVar25;
                lVar14 = lVar14 + 2;
