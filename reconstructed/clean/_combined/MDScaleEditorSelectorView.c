// ===================================================================
// MDScaleEditorSelectorView — Complete reconstructed pseudocode
// 3 functions
// ===================================================================
...

{
  ...
  if (lVar1 != local_48) {
    ...
    *(int64_t *)(this_ptr + 0x138) = local_48;
    if (lVar1 != 0) {
      FUN_00d50b20();
    }
  }
  FUN_00d50b00();
  local_118 = g_026fc740;
  if (g_026fc740 != 0) {
    FUN_00d50b00();
  }
  lVar1 = g_026e0f08;
  ...
  if (lVar1 != local_48) {
    ...
    *(int64_t *)(this_ptr + 0x140) = local_48;
    if (lVar1 != 0) {
      FUN_00d50b20();
    }
  }
  ...
  if (lVar1 != local_48) {
    ...
    *(int64_t *)(this_ptr + 0x148) = local_48;
    if (lVar1 != 0) {
      FUN_00d50b20();
    }
  }
  ...
  if (local_40 == '\0') {
    ...
    FUN_00d50b00();
    lVar1 = *(int64_t *)(this_ptr + 0x150);
    *(int64_t *)(this_ptr + 0x150) = local_48;
  }
  else {
    local_40 = '\0';
LAB_002b9e1c:
    *(int64_t *)(this_ptr + 0x150) = lVar3;
  }
  if (lVar1 != 0) {
    FUN_00d50b20();
    lVar3 = local_48;
...
// 002b9220
// ============================================================
// Function: FUN_002b9220
// Address: 002b9220
// Size: 1467 bytes
// Class: MDScaleEditorSelectorView
// String references:
//   "handleSelectDisplayMode"
//   "onEditorViewContentDidChange"
//   "onAudioSourceDescriptionTypeChangeObserver"
//   "onScaleRulerViewChanged"
//   "MDScaleEditorSelectorView"
...

{
  ...
  // [STATIC_INIT: property registration]
      g_02805f10 = "handleSelectDisplayMode";
      g_02805f18 = &g_026fc770;
      g_02805f20 = 0;
      g_02805f28 = &g_026fc838;
      g_02805f30 = FUN_002bd6a0;
      g_02805f38 = 0x921;
      g_02805f40 = 0;
      ram_0000000002805f48 = 0;
      ___cxa_guard_release();
    }
  }
  FUN_00e87c70();
  // [STATIC_INIT: property registration]
      g_02805f58 = "onEditorViewContentDidChange";
      g_02805f60 = &g_026fc770;
      g_02805f68 = 0;
      g_02805f70 = &g_026fc83c;
      g_02805f78 = FUN_002bd730;
      g_02805f80 = 0x929;
      g_02805f88 = 0;
      ram_0000000002805f90 = 0;
      ___cxa_guard_release();
    }
  }
  FUN_00e87c70();
  // [STATIC_INIT: property registration]
      g_02805fa0 = "onAudioSourceDescriptionTypeChangeObserver";
      g_02805fa8 = &g_026fc770;
      g_02805fb0 = 0;
      g_02805fb8 = &g_026fc83c;
      g_02805fc0 = FUN_002bd730;
      g_02805fc8 = 0x931;
      g_02805fd0 = 0;
      ram_0000000002805fd8 = 0;
      ___cxa_guard_release();
    }
  }
  FUN_00e87c70();
  // [STATIC_INIT: property registration]
      g_02805fe8 = "onScaleRulerViewChanged";
      g_02805ff0 = &g_026fc770;
      g_02805ff8 = 0;
      g_02806000 = &g_026fc83c;
      g_02806008 = FUN_002bd730;
      g_02806010 = 0x939;
      g_02806018 = 0;
      ram_0000000002806020 = 0;
      ___cxa_guard_release();
    }
  }
  FUN_00e87c70();
