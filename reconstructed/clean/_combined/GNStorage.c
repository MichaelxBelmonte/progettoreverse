// ===================================================================
// GNStorage — Complete reconstructed pseudocode
// 1 functions
// ===================================================================
...
void FUN_015985f0(uint64_t param_1,int64_t *param_2)
...
LAB_01598705:
      ...
      plVar19 = local_90;
      lVar14 = g_027c7238;
      lVar9 = (int64_t)(int)local_78;
      local_78 = local_78 + 1;
      if ((int)local_78 < *(int *)(lVar16 + 0xc)) {
        local_90 = *(int64_t **)(*(int64_t *)(lVar16 + 0x10) + 8 + lVar9 * 8);
        if (g_027c7238 != 0) {
          uVar25 = FUN_00d50b00();
        }
        local_1d0 = lVar14;
        ...
        plVar19 = *pplVar21;
        uVar23 = (undefined7)((uint64_t)pplVar21 >> 8);
        if (plVar19 == local_40) {
          if (((char)local_48 == '\0') && (plVar19 != (int64_t *)0x0)) {
            plVar19 = local_40;
...
LAB_01598dfd:
        ...
        cVar3 = (char)uVar22;
        if (plVar19 == local_40) {
          if ((cVar3 == '\0') && (plVar19 != (int64_t *)0x0)) {
            plVar19 = local_40;
            if (*(char *)(pplVar21 + 1) != '\0') goto LAB_015989c8;
            local_48 = CONCAT71((int7)((uint64_t)uVar25 >> 8),1);
            FUN_00d50b00();
            plVar19 = local_40;
          }
          else {
...
LAB_015989c8:
        ...
        if ((g_026d5e38 == '\0') &&
          ...
          g_026d5d88 = FUN_00d4fe50();
          g_026d5d70 = "GNStorage";
          g_026d5d78 = 0x30;
          g_026d5d80 = FUN_0005d8e0;
          g_026d5d90 = 0;
          ram_00000000026d5d98 = 0;
          g_026d5da0 = 0;
          ram_00000000026d5da8 = 0;
          g_026d5db0 = 0;
          ram_00000000026d5db8 = 0;
          g_026d5dc0 = 0;
          ram_00000000026d5dc8 = 0;
          g_026d5dd0 = 0;
          ram_00000000026d5dd8 = 0;
          g_026d5de0 = 0;
          ram_00000000026d5de8 = 0;
          g_026d5df0 = 0;
          ram_00000000026d5df8 = 0;
          g_026d5e00 = 0;
          ram_00000000026d5e08 = 0;
          g_026d5e10 = 0;
          ram_00000000026d5e18 = 0;
          g_026d5e20 = 0;
          ram_00000000026d5e28 = 0;
          g_026d5e30 = 0;
...
LAB_01598b50:
        ...
        iVar7 = (int)local_b8;
        if (local_68 == (int64_t *)0x0 || (int)uVar6 <= iVar7) {
      ...
      *puVar10 = &g_02572358;
      ...
      while( true ) {
        ...
        local_90 = *(int64_t **)(pcVar15 + (int64_t)(int)local_78 * 8 + 8);
        if (g_02725a40 != 0) {
          uVar25 = FUN_00d50b00();
        }
        local_1a0 = lVar14;
        ...
        uVar23 = (undefined7)((uint64_t)pplVar21 >> 8);
        if (plVar20 == local_40) {
          if (((char)local_48 == '\0') && (plVar20 != (int64_t *)0x0)) {
            plVar20 = local_40;
...
LAB_01599de5:
        ...
        cVar3 = (char)uVar22;
        if (plVar20 == local_40) {
          if ((cVar3 == '\0') && (plVar20 != (int64_t *)0x0)) {
            plVar20 = local_40;
...
joined_r0x01599448:
          uVar22 = CONCAT71((int7)((uint64_t)pplVar21 >> 8),1);
          local_40 = plVar20;
        }
        if ((local_50 != '\0') && (local_58 != (int64_t *)0x0)) {
          FUN_00d50b20();
        ...
        if (local_40 == (int64_t *)0x0) goto LAB_01599dc7;
        local_48 = uVar22 & 0xffffffff;
        local_31 = cVar4;
        ...
        plVar20 = local_58;
        if ((g_026d5e38 == '\0') && (iVar8 = ___cxa_guard_acquire(), iVar8 != 0)) {
          g_026d5d88 = FUN_00d4fe50();
          g_026d5d70 = "GNStorage";
          g_026d5d78 = 0x30;
...
LAB_01599597:
        ...
        cVar4 = local_31;
        if (local_40 == (int64_t *)0x0) goto LAB_01599dc0;
        local_c8 = (double)FUN_00d45bc0();
        if ((local_d8 != iVar7) || (local_d4 != local_bc)) {
          pvVar11 = _pthread_getspecific((void*)pcVar15);
          if (pvVar11 != (void *)0x0) {
            FUN_00e8b990();
          }
          uVar5 = local_bc;
          plVar20 = (int64_t *)(uint64_t)local_bc;
          pcVar15 = local_d0;
          FUN_016c3060(local_d0,plVar20,0);
          local_d4 = uVar5;
          local_d8 = iVar7;
        }
        if (((local_68 == (int64_t *)0x0) || ((int)local_68[3] < 2)) ||
           (iVar8 = (int)(0x10 / (int64_t)(int)local_b8), iVar8 == 0)) {
          local_108 = iVar7;
          FUN_01907b60(local_c8,0x10 % (int64_t)(int)local_b8 & 0xffffffff);
          plVar24 = local_58;
          if (local_58 == (int64_t *)0x0) {
            uVar18 = (uint32_t)CONCAT71((int7)((uint64_t)plVar20 >> 8),1);
            bVar2 = false;
            plVar24 = (int64_t *)0x0;
          }
          else {
            ...
            if (local_50 == '\0') {
              FUN_00d50b00();
              uVar18 = 0;
              if ((local_50 == '\0') || (local_58 == (int64_t *)0x0)) goto LAB_01599885;
              FUN_00d50b20();
            }
            uVar18 = 0;
          }
LAB_01599885:
          ...
          lVar14 = *(int64_t *)(local_a8 + 0x10);
          plVar20 = *(int64_t **)(lVar14 + (int64_t)(int)(local_78 + 2) * 8);
          local_104 = uVar18;
          if (plVar20 != (int64_t *)0x0) {
            uVar25 = FUN_00d50b00();
          }
...
joined_r0x01599cb1:
          ...
          if ((local_40 == (int64_t *)0x0) || (dVar26 = (double)FUN_00d45bc0(), dVar26 <= local_c8)
             ) {
            *(void*)(this_ptr + 1) = 0;
            *this_ptr = 0;
            bVar1 = false;
            ...
            dVar27 = ((g_023b4df8 / local_100) / (double)(int)local_bc) * g_023b1e98;
            pVar13 = (void*)
                     ((dVar27 * g_023942d0 + (dVar26 - local_c8)) / ((double)local_108 * dVar27));
            local_10c = ((local_108 * (int)local_b8) / (int)local_bc) * pVar13;
            local_58 = local_f0;
            FUN_00e7c2a0(pVar13,(int64_t)(local_108 * (int)local_b8) % (int64_t)(int)local_bc &
                                0xffffffff);
            local_e8 = local_58;
            FUN_00e7b820();
            bVar1 = true;
          ...
          cVar4 = local_31;
          if ((char)local_104 == '\0' && plVar24 != (int64_t *)0x0) {
            FUN_00d50b20();
            cVar4 = local_31;
          }
          goto LAB_01599de5;
        ...
        do {
          ...
          if (local_58 == plVar20) {
            plVar24 = plVar20;
            bVar1 = bVar2;
            if ((bVar2) || (local_58 == (int64_t *)0x0)) goto joined_r0x0159977d;
            bVar1 = true;
            if (local_50 == '\0') {
              FUN_00d50b00();
              goto LAB_01599768;
...
LAB_01599b30:
        if (pVar17 == *(int *)(lVar16 + 0xc) - 1U) {
          ...
          FUN_01907b60(local_c8 + (g_023b4df8 / local_100) * dVar26);
          plVar20 = local_e8;
          if (local_e0 == '\0') {
