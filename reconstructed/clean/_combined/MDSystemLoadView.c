// ===================================================================
// MDSystemLoadView — Complete reconstructed pseudocode
// 3 functions
// ===================================================================
...

{
  ...
  if (lVar1 != local_28) {
    ...
    if (local_20 == '\0') {
      ...
      FUN_00d50b00();
      lVar1 = *(int64_t *)(this_ptr + 0x80);
      *(int64_t *)(this_ptr + 0x80) = local_28;
    }
    else {
      local_20 = '\0';
LAB_000f17cd:
  ...
  if (lVar1 != local_28) {
    ...
    if (local_20 == '\0') {
      ...
      FUN_00d50b00();
      lVar1 = *(int64_t *)(this_ptr + 0x88);
      *(int64_t *)(this_ptr + 0x88) = local_28;
    }
    else {
      local_20 = '\0';
LAB_000f1936:
  ...
  if (lVar1 != local_28) {
    ...
    if (local_20 == '\0') {
      ...
      FUN_00d50b00();
      lVar1 = *(int64_t *)(this_ptr + 0x90);
      *(int64_t *)(this_ptr + 0x90) = local_28;
    }
    else {
      local_20 = '\0';
LAB_000f1a99:
  ...
  if (lVar1 != local_28) {
    ...
    if (local_20 == '\0') {
      ...
      FUN_00d50b00();
      lVar1 = *(int64_t *)(this_ptr + 0x98);
      *(int64_t *)(this_ptr + 0x98) = local_28;
    }
    else {
      local_20 = '\0';
LAB_000f1bfc:
  ...
  if (lVar1 != local_28) {
    ...
    if (local_20 == '\0') {
      ...
      FUN_00d50b00();
      lVar1 = *(int64_t *)(this_ptr + 0xa0);
      *(int64_t *)(this_ptr + 0xa0) = local_28;
    }
    else {
      local_20 = '\0';
LAB_000f1d5f:
