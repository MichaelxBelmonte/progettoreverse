// ===================================================================
// GNDate — Complete reconstructed pseudocode
// 26 functions
// ===================================================================
...
void FUN_01397bb0(int64_t *param_1,void*param_2)

{
  ...
  if (*(int64_t *)(this_ptr + 0x200) != 0) {
    ...
    FUN_01313ad0();
    pvVar6 = _pthread_getspecific((void*)plVar7);
    if (pvVar6 != (void *)0x0) {
      FUN_00e8b990();
    }
    FUN_012cbea0();
  ...
  if (local_50 != (int64_t *)0x0) {
    ...
    bVar3 = false;
    local_60 = local_50;
    if (*(char *)(this_ptr + 0x1a8) == '\0') goto LAB_01397ebc;
LAB_01397cd2:
...
LAB_01397ce6:
    ...
    if (local_c8 != 0) {
      bVar2 = false;
      do {
        (**(code **)(*g_028acd20 + 0x368))();
        lVar12 = *(int64_t *)(this_ptr + 0x48);
        if (lVar12 != 0) {
          FUN_00d50b00();
        }
        cVar4 = FUN_00d7a850();
  ...
  if (*(char *)(this_ptr + 0x1a8) != '\0') goto LAB_01397cd2;
LAB_01397ebc:
...
LAB_01397ef1:
    if ((*(int64_t *)(this_ptr + 0x48) != 0) &&
      ...
      local_58 = (int64_t *)0x0;
LAB_01397f34:
      if (*(int *)(*(int64_t *)(this_ptr + 0x40) + 0xc) < 1) {
        local_64._0_1_ = 1;
      }
      else {
        lVar12 = CONCAT71((int7)((uint64_t)local_40 >> 8),1);
        ...
        do {
          ...
          lVar8 = lVar8 + 1;
          lVar12 = (int64_t)*(int *)(*(int64_t *)(this_ptr + 0x40) + 0xc);
        } while (lVar8 < lVar12);
      }
      goto LAB_01397ce6;
    }
...
LAB_01397ed4:
  ...
  if (iVar5 < 1) {
    ...
    do {
      pVar9 = (void*)plVar7;
      lVar8 = local_60[2];
      plVar11 = *(int64_t **)(lVar8 + lVar12 * 8);
      cVar4 = (char)local_40;
      if (local_58 == plVar11) {
        if ((cVar4 == '\0') && (local_58 != (int64_t *)0x0)) {
          local_40 = (int64_t *)CONCAT71((int7)((uint64_t)lVar8 >> 8),1);
          FUN_00d50b00();
        }
        else if (local_58 == (int64_t *)0x0) goto LAB_013983f0;
LAB_0139846b:
        pvVar6 = _pthread_getspecific(pVar9);
        plVar7 = local_58;
        if ((pvVar6 != (void *)0x0) && (lVar8 = FUN_00e8b990(), lVar8 != 0)) {
          plVar7 = (int64_t *)local_58[(uint64_t)(*(uint *)(lVar8 + 0x154) & 1) + 4];
        }
        ...
        pVar9 = (void*)plVar7;
        local_58 = plVar11;
        if (plVar11 != (int64_t *)0x0) goto LAB_0139846b;
LAB_013983f0:
        local_58 = (int64_t *)0x0;
      }
      local_40 = (int64_t *)((uint64_t)local_40 & 0xffffffff);
      lVar12 = lVar12 + 1;
      iVar5 = *(int *)((int64_t)local_60 + 0xc);
    } while (lVar12 < iVar5);
    if (0 < iVar5) {
      lVar12 = 0;
      do {
        plVar11 = *(int64_t **)(local_60[2] + lVar12 * 8);
        cVar4 = (char)local_40;
        if (local_58 == plVar11) {
          if ((cVar4 == '\0') && (local_58 != (int64_t *)0x0)) {
          ...
          else if (local_58 == (int64_t *)0x0) goto LAB_01398580;
LAB_013985fb:
          pvVar6 = _pthread_getspecific((void*)plVar7);
          plVar11 = local_58;
          if ((pvVar6 != (void *)0x0) && (lVar8 = FUN_00e8b990(), lVar8 != 0)) {
            plVar11 = (int64_t *)local_58[(uint64_t)(*(uint *)(lVar8 + 0x154) & 1) + 4];
          }
          (**(code **)(*plVar11 + 0x480))();
        }
        else {
          ...
          local_58 = plVar11;
          if (plVar11 != (int64_t *)0x0) goto LAB_013985fb;
LAB_01398580:
          local_58 = (int64_t *)0x0;
        }
        lVar12 = lVar12 + 1;
...
LAB_01398187:
  ...
  goto LAB_013980e0;
LAB_01398232:
  if (((bVar2) && (cVar4 = FUN_01396430(), cVar4 != '\0')) && (*(char *)(this_ptr + 0x1a8) == '\0')
     ) {
    if (0 < *(int *)((int64_t)local_60 + 0xc)) {
      lVar12 = 0;
      plVar7 = (int64_t *)((uint64_t)local_40 & 0xffffffff);
      do {
        lVar8 = local_60[2];
        plVar11 = *(int64_t **)(lVar8 + lVar12 * 8);
        plVar10 = local_60;
        if (local_58 == plVar11) {
          plVar11 = local_58;
          if ((char)plVar7 != '\0') {
            local_40 = (int64_t *)((uint64_t)plVar7 & 0xffffffff);
            goto LAB_01398820;
          }
...
LAB_0139882d:
          ...
          local_40 = (int64_t *)CONCAT71((int7)((uint64_t)lVar8 >> 8),1);
          if (((char)plVar7 != '\0') && (local_58 != (int64_t *)0x0)) {
            FUN_00d50b20();
          }
LAB_01398820:
          pVar9 = (void*)plVar10;
          local_58 = plVar11;
          if (plVar11 != (int64_t *)0x0) goto LAB_0139882d;
          local_58 = (int64_t *)0x0;
          plVar7 = (int64_t *)((uint64_t)local_40 & 0xffffffff);
        }
        lVar12 = lVar12 + 1;
      } while (lVar12 < *(int *)((int64_t)local_60 + 0xc));
...
LAB_01398921:
            local_58 = plVar11;
            if (plVar11 != (int64_t *)0x0) goto LAB_0139892e;
            local_58 = (int64_t *)0x0;
          }
          lVar12 = lVar12 + 1;
          plVar7 = local_40;
...
LAB_01398255:
    ...
    FUN_0134a250(&local_f0,&local_100,(uint8_t)local_64,local_68);
  }
  if (local_c8 != 0) {
    (**(code **)(*local_50 + 0x408))();
    (**(code **)(*g_028acd20 + 0x368))();
...
void FUN_00b4c8e0(int param_1,int64_t param_2,size_t param_3)

{
  ...
  if (0 < *(int *)(lVar17 + 0xc)) {
    ...
    bVar9 = false;
LAB_00b4c9e3:
    plVar14 = *(int64_t **)(*(int64_t *)(lVar17 + 0x10) + lVar18 * 8);
    if (local_50 == plVar14) {
...
LAB_00b4cb40:
      ...
      bVar4 = bVar6;
      plVar14 = plVar16;
      if (plVar14 == (int64_t *)0x0) goto LAB_00b4c9c0;
      FUN_00b37f00(0,0);
      if (plVar15 == local_40) {
        if ((!bVar9) && (plVar15 != (int64_t *)0x0)) {
          plVar16 = plVar15;
...
LAB_00b4cee0:
        ...
        if (plVar14 != (int64_t *)0x0) {
          ...
          if (cVar7 == -0x50) {
            cVar7 = FUN_00b51df0();
            iVar10 = *(int *)(this_ptr[0x14] + 0x18);
            iVar13 = iVar10 + 7;
            if (-1 < iVar10) {
              iVar13 = iVar10;
            }
            uVar19 = (uint64_t)(uint)(iVar13 >> 3);
            do {
              if ((int)uVar19 < 1) goto LAB_00b4d020;
              lVar2 = *(int64_t *)(this_ptr[0x14] + 0x10);
              uVar1 = uVar19 - 1;
              lVar18 = uVar19 * 8;
              uVar19 = uVar1;
            ...
            FUN_00b38040(fVar21);
            if (plVar15 == local_40) {
              if ((bVar9) || (plVar15 == (int64_t *)0x0)) goto joined_r0x00b4d206;
              bVar9 = true;
              if (local_38 == '\0') {
                FUN_00d50b00();
                plVar16 = plVar15;
...
joined_r0x00b4d206:
            ...
            else if ((bVar9) && (plVar15 != (int64_t *)0x0)) {
              FUN_00d50b20();
              bVar9 = true;
              plVar15 = local_40;
            }
...
LAB_00b4d128:
      ...
      lVar17 = lVar17 + 1;
    } while (lVar17 < *(int *)(this_ptr[0x12] + 0xc));
  }
  if ((arg1 != 0) && (param_2 != 0)) {
    iVar10 = FUN_00b33130();
    uVar11 = FUN_00b33120();
    if (0 < (int)uVar11) {
      uVar19 = 0;
      pvVar12 = (void *)((int64_t)param_1 << 2);
      do {
        if ((int64_t)uVar19 < (int64_t)iVar10) {
          if (*(int64_t *)(arg1 + uVar19 * 8) != *(int64_t *)(param_2 + uVar19 * 8)) {
            _memcpy(pvVar12,(void *)((int64_t)param_1 << 2),param_3);
          }
        }
        else {
          ___bzero();
...
uint64_t FUN_00b471b0(uint64_t param_1)

{
     ...
     ((uint64_t)(*(int64_t *)(this_ptr + 0x48) + *(int64_t *)(this_ptr + 0x40)) >> 0x20 == 0))
  {
    ...
    if (local_60 == 0) {
      ...
      bVar5 = true;
      if (local_50 == 0) {
        FUN_00ccdf50(param_1,*(void*)(this_ptr + 0x90));
        bVar5 = true;
        if (local_40 == 0) {
...
LAB_00b43c79:
  ...
  *(void**)(this_ptr + 0x38) = puVar6;
  ...
  uVar11 = FUN_00c66860();
  *(void **)(this_ptr + 0x30) = pvVar7;
  iVar3 = FUN_00c668e0(uVar11,*(void*)(*(int64_t *)(this_ptr + 0xa8) + 0x18));
  if (iVar3 != 0) {
  ...
  lVar4 = g_02764880;
  if (0x10 < *(int *)(this_ptr + 0x50) - 0x10U) {
    if (g_02764880 != 0) {
      FUN_00d50b00();
    }
    local_68 = lVar4;
  ...
  iVar3 = *(int *)(this_ptr + 0x50);
  iVar1 = *(int *)(this_ptr + 0x68);
  iVar2 = *(int *)(this_ptr + 0x54);
  FUN_00c8e690();
  lVar4 = local_40;
  if ((local_38 == '\0') && (local_40 != 0)) {
    FUN_00d50b00();
...

{
  ...
  for (uVar5 = *(uint64_t *)(this_ptr + 0x48); uVar5 != 0; uVar5 = uVar5 - uVar4) {
    uVar4 = 0x1000;
    if (uVar5 < 0x1001) {
    ...
    (**(code **)(**(int64_t **)(this_ptr + 0x18) + 0x380))
              (&local_4c,*(void*)(local_38 + 0x10));
    bVar6 = local_48 != 0;
    ...
    (**(code **)(**(int64_t **)(this_ptr + 0x18) + 0x388))
              (local_4c,*(void*)(local_38 + 0x10));
    lVar3 = local_48;
    if ((local_40 != '\0') && (local_48 != 0)) {
      FUN_00d50b20();
  ...
  if (lVar1 == lVar3) {
    ...
    if (lVar1 == 0) {
      uVar5 = *(int64_t *)(this_ptr + 0x48) - local_58;
      local_38 = lVar3;
...
joined_r0x00b4670e:
  if (uVar5 == 0) {
    *(int64_t *)(this_ptr + 0x40) = local_58;
    if (local_38 == 0) {
      return;
    }
  }
...

{
  ...
  if (local_54 == 1) {
    ...
    *(double *)(this_ptr + 0x48) = (double)local_3c;
    *(uint64_t *)(this_ptr + 0x40) = CONCAT44(uStack_44,local_48);
    ...
    *(double *)(this_ptr + 0x48) = (double)local_3c;
    *(uint64_t *)(this_ptr + 0x40) = (uint64_t)local_48;
    uVar2 = (uint64_t)local_50;
  }
  *(uint64_t *)(this_ptr + 0x58) = uVar2;
  return;
}
...
int64_t FUN_00b49e50(uint64_t param_1)

{
  ...
  iVar1 = *(int *)(*(int64_t *)(this_ptr + 0x98) + 0x18);
  if (unaff_ESI != 0) {
    ...
    FUN_00ccdf50(param_1,*(int *)(*(int64_t *)(this_ptr + 0x98) + 0x18) + 0x30);
    bVar4 = true;
    if (local_38 == 0) {
    ...
    if (local_38 == 0) {
      ...
      bVar4 = true;
      if (local_58 == 0) {
        FUN_00ccdf10(param_1,(int)*(short *)(this_ptr + 0x30));
        bVar4 = true;
        if (local_48 == 0) {
          FUN_00ccdf10(param_1,(int)*(short *)(this_ptr + 0xa0));
          bVar4 = true;
          if (local_68 == 0) {
            FUN_00ccdf10(param_1,0);
            bVar4 = true;
    ...
    FUN_00ccdf50(param_1,*(int *)(*(int64_t *)(this_ptr + 0x98) + 0x18) + 0xc);
    bVar4 = true;
    if (local_38 == 0) {
      FUN_00ccdf50(param_1,0x616c6163);
      bVar4 = true;
...
uint64_t FUN_00b49010(uint64_t param_1)
...
// 00b46bd0
// ============================================================
// Function: FUN_00b46bd0
// Address: 00b46bd0
// Size: 775 bytes
// Class: GNDate

uint64_t FUN_00b46bd0(uint64_t param_1)
...

{
  ...
  if (0 < (int)dVar2) {
    lVar7 = 0;
    do {
      lVar3 = *(int64_t *)(*(int64_t *)(lVar5 + 0x10) + lVar7 * 8);
      if (lVar3 != 0) {
        FUN_00d50b00();
      }
      FUN_00b4c6f0();
...
// 00b4e200
// ============================================================
// Function: FUN_00b4e200
// Address: 00b4e200
// Size: 545 bytes
// Class: GNDate

uint32_t FUN_00b4e200(uint16_t param_1,short param_2)
