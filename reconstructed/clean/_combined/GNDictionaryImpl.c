// ===================================================================
// GNDictionaryImpl — Complete reconstructed pseudocode
// 1 functions
// ===================================================================
...
// 00ca2870
// ============================================================
// Function: FUN_00ca2870
// Address: 00ca2870
// Size: 8571 bytes
// Class: GNDictionaryImpl
// String references:
//   "GNList"
//   "GNData"
//   "GNValue"
...
//   "<true/>\n"
//   "<false/>\n"
//   "_GNDictionaryImpl::_addObjectToXMLStream failed 1"
//   ... +2 more

void FUN_00ca2870(int param_1,int64_t *param_2)
...
LAB_00ca28fa:
  ...
  if ((local_75 == '\0') || (local_1d8 == 0)) {
    if (local_1d8 == 0) {
      plVar9 = (int64_t *)*param_2;
      if ((g_027048b0 == '\0') && (iVar11 = ___cxa_guard_acquire(), iVar11 != 0)) {
...
LAB_00ca377d:
            ...
            if ((local_72 == '\0') || (local_b8 == 0)) {
              ...
              plVar9 = (int64_t *)*param_2;
              if ((g_0270c850 == '\0') && (iVar11 = ___cxa_guard_acquire(), iVar11 != 0)) {
...
LAB_00ca3841:
              ...
              plVar12 = (int64_t *)*plVar9;
              local_71 = (char)plVar9[1];
              local_1d0 = plVar12;
              if ((local_71 == '\0') || (plVar12 == (int64_t *)0x0)) {
                local_70 = lVar10;
                if (plVar12 != (int64_t *)0x0) goto LAB_00ca387b;
                ...
                if (0 < param_1) {
                  do {
                    uVar14 = (**(code **)(*(int64_t *)*arg1 + 0x388))(1,"\t");
                ...
                if (0 < *(int *)(local_90 + 0xc)) {
                  ...
                  do {
                    FUN_00d8eb70();
                    lVar13 = *(int64_t *)(*(int64_t *)(local_90 + 0x10) + lVar10 * 8);
                    if (lVar13 != 0) {
                      FUN_00d50b00();
                    }
                    local_270 = 1;
                    ...
                    *(void*)puVar8 = 0;
                    if (((char)local_58 != '\0') && (puVar7 != (void*)0x0)) {
                      FUN_00d50b20();
                    }
                    if (((char)local_a8 == '\0') && (puVar7 != (void*)0x0)) {
                      FUN_00d50b00();
                    }
                    local_238 = puVar7;
                    local_230 = 1;
...
LAB_00ca37ac:
              ...
              case 0x69:
                ...
                local_58 = 1;
                local_60 = &g_024cc6f0;
                uVar14 = FUN_00d94d80(&g_024cc6f0,&local_60);
                break;
              default:
                ...
                local_1c8 = lVar13;
                local_1c0 = '\x01';
                uVar14 = FUN_00cc7b40(uVar14,g_025908a0);
              ...
              case 0x6c:
                ...
                local_58 = 1;
                local_60 = (void*)&g_024da828;
                uVar14 = FUN_00d94d80(&g_024da828,&local_60);
              }
              if (0 < param_1) {
                do {
                  uVar14 = (**(code **)(*(int64_t *)*arg1 + 0x388))(1,"\t");
...
LAB_00ca2f28:
          ...
          if (0 < *(int *)(lVar10 + 0xc)) {
            ...
            do {
              FUN_00d8eb70();
              lVar10 = *(int64_t *)(*(int64_t *)(local_98 + 0x10) + (int64_t)local_40 * 8);
              if (lVar10 != 0) {
                FUN_00d50b00();
              }
              local_360 = 1;
            ...
            } while ((int64_t)local_40 < (int64_t)*(int *)(local_98 + 0xc));
          }
          uVar14 = FUN_00d8dcb0();
          lVar10 = local_98;
          if (0 < param_1) {
...
LAB_00ca2b7c:
        ...
        if (0 < *(int *)(lVar10 + 0xc)) {
          lVar13 = 0;
          do {
            lVar1 = *(int64_t *)(*(int64_t *)(lVar10 + 0x10) + lVar13 * 8);
            if (lVar1 != 0) {
              FUN_00d50b00();
            }
            local_3b0 = 1;
