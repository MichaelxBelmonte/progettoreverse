// ===================================================================
// MDWorkspaceView — Complete reconstructed pseudocode
// 15 functions
// ===================================================================
...
void FUN_008877d0(uint64_t param_1,uint64_t param_2)

{
  ...
  iVar13 = *(int *)((int64_t)local_68 + 0xc);
  if (local_60[0] != '\0') {
    FUN_00d50b20();
  }
  if (iVar13 != 3) {
  ...
  (**(code **)(*(int64_t *)this_ptr[2] + 0x4a0))();
  local_38 = *(int64_t **)(local_68[2] + 0x10);
  ...
  *puVar8 = &g_02572358;
  ...
  if (plVar14 == (int64_t *)0x0) {
    bVar3 = false;
    local_84 = 0.0;
    if ((g_0239424c == 0.0) && (!NAN(g_0239424c))) goto LAB_00887bbe;
  }
  else {
    fVar26 = g_02390d00 + fStack_134;
    local_60[0] = '\0';
    local_68 = (int64_t *)0x0;
    local_58 = plVar14;
    local_50 = 0xffffffff;
    ...
    while( true ) {
      ...
      local_50 = CONCAT44(local_50._4_4_,iVar13);
      if (*(int *)((int64_t)local_58 + 0xc) <= iVar13) break;
    ...
    FUN_00318710();
    if ((local_84 == g_0239424c) && (!NAN(local_84) && !NAN(g_0239424c))) {
LAB_00887bbe:
...
LAB_00887c10:
  FUN_006c6060();
  cVar6 = (**(code **)(*(int64_t *)this_ptr[2] + 0x9f8))();
  ...
  *puVar11 = &g_02572358;
  ...
  FUN_006c6060();
  auVar28._0_4_ = local_98._0_4_ & g_023945e0;
  ...
  auVar21._0_4_ = SUB164(auVar28 | g_023945f0,0) + (float)local_98._0_4_;
  ...
  if ((local_84 != g_0239424c) || (fVar16 = fVar26, NAN(local_84) || NAN(g_0239424c))) {
...
LAB_00888240:
  ...
  fVar26 = fStack_104;
  cVar6 = (**(code **)(*(int64_t *)this_ptr[2] + 0xa18))();
  if (cVar6 != '\0') {
    if (puVar11 != (void*)0x0) {
      FUN_00d50b20();
    }
  ...
  if ((fVar16 != 0.0) || (NAN(fVar16))) {
    ...
    *(void*)pplVar12 = 0;
    if ((local_60[0] != '\0') && (plVar5 != (int64_t *)0x0)) {
      FUN_00d50b20();
    }
    plVar14 = local_40;
    if ((char)local_80 == '\0') {
...
LAB_00888517:
      ...
      if (fStack_154 < extraout_XMM0_Db_08 + auVar28._4_4_) {
        ...
        auVar2._4_4_ = fStack_154 - (float)((uint64_t)uVar20 >> 0x20);
...

{
  ...
  FUN_00e876a0();
  // [STATIC_INIT: property registration]
      g_026da8b0 = "_borderStyle";
      g_026da8b8 = &g_026d9970;
      g_026da8c0 = 0;
      g_026da8c8 = 0x6500;
      g_026da8d0 = "GNBorderStyle";
      g_026da8d8 = &g_026daa28;
      g_026da8e0 = 0;
      ram_00000000026da8e8 = 0;
      ___cxa_guard_release();
    }
  }
  return &g_026da8b0;
