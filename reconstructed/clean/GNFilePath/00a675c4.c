...
int FUN_00a675c4(uint64_t param_1,uint64_t param_2,uint64_t param_3,uint64_t param_4)

{
  ...
  do {
    ...
    case 0x17:
      if (local_3c == 0xf) {
        lVar6 = *(int64_t *)(this_ptr + 0x130);
        uVar8 = extraout_XMM0_Da;
        for (lVar5 = *(int64_t *)(this_ptr + 0x138); lVar5 != lVar6; lVar5 = lVar5 + -0x20) {
          uVar8 = (***(void**)(lVar5 + -0x20))();
        }
        *(int64_t *)(this_ptr + 0x138) = lVar6;
        ...
        if (local_34 != 0) {
          ...
          uVar7 = 0;
          do {
            iVar2 = (**(code **)(*(int64_t *)(*(int64_t *)(this_ptr + 0x130) + lVar6) + 0x10))();
            iVar1 = iVar1 + iVar2;
            uVar7 = uVar7 + 1;
            lVar6 = lVar6 + 0x20;
