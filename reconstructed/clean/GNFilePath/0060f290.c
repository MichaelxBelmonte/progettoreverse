...

{
  ...
  if (*(int64_t **)(this_ptr + 0x200) != (int64_t *)0x0) {
    local_48 = '\0';
    local_50 = plVar1;
    cVar2 = (**(code **)(**(int64_t **)(this_ptr + 0x200) + 0x48))();
    ...
    if (cVar2 != '\0') {
      local_38 = '\0';
      local_40 = plVar1;
      uVar5 = (**(code **)(**(int64_t **)(this_ptr + 0x200) + 0x50))();
