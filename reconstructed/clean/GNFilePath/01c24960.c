...
uint64_t FUN_01c24960(uint64_t param_1,void*param_2)
...
LAB_01c24af7:
    ...
    local_50 = CONCAT44(local_50._4_4_,iVar11);
    if (iVar11 < *(int *)((int64_t)local_58 + 0xc)) {
      plVar12 = *(int64_t **)(local_58[2] + 8 + lVar7 * 8);
      local_68 = plVar12;
      local_c0 = plVar12;
...
LAB_01c24c85:
  ...
  uVar14 = FUN_01ca5d90();
  bVar9 = true;
  if ((puVar8 != (void*)0x0) && (*(int *)((int64_t)puVar8 + 0xc) != 0)) {
    local_100 = local_40;
    local_f8 = '\0';
  ...
  if ((plVar4 == (int64_t *)0x0) || (*(int *)((int64_t)plVar4 + 0xc) == 0)) {
...
LAB_01c24f18:
    ...
    uVar13 = CONCAT71((int7)((uint64_t)uVar1 >> 8),1);
    if (this_ptr != (int64_t *)0x0) {
      FUN_00d50b20();
    }
  }
