...
void FUN_0024b760(uint64_t param_1)
...
LAB_0024b7d5:
  ...
  if ((float)param_1 <= g_02390434) goto LAB_0024b945;
  plVar1 = *(int64_t **)(this_ptr + 0x90);
  (**(code **)(&UNK_00001550 + *plVar1))();
  pcVar3 = local_58;
  if (local_58[0] == '\0') {
...
LAB_0024b8a3:
  ...
  (**(code **)(**(int64_t **)(this_ptr + 0x98) + 0x4d0))(uVar5,uVar6);
  (**(code **)(*plVar4 + 0x928))();
  FUN_00d50b20();
LAB_0024b945:
