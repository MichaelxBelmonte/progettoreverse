...
void FUN_0024dae0(void* param_1,int param_2)
...
LAB_0024dca9:
      ...
      *pcVar3 = '\0';
      ...
      if (local_40 == (int64_t *)0x0) {
        ...
        if (*(int64_t **)(this_ptr + 0x90) == (int64_t *)0x0) goto LAB_0024dca9;
      }
      else {
        plVar4 = local_40;
...
LAB_0024dbc9:
    ...
    *pcVar3 = '\0';
    ...
    if (local_40 == (int64_t *)0x0) {
      plVar4 = *(int64_t **)(this_ptr + 0x90);
      if (*(int64_t **)(this_ptr + 0x90) == (int64_t *)0x0) goto LAB_0024dbc9;
    }
    else {
      plVar4 = local_40;
