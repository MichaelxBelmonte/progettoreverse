...
bool FUN_0060e940(uint64_t param_1,uint64_t param_2)

{
  ...
  fVar8 = (float)param_2;
  iVar1 = *(int *)(*(int64_t *)(this_ptr + 0x188) + 0xc);
  if ((1 < iVar1) && (in_DL != '\0')) {
    ...
    if (*(int64_t *)(this_ptr + 0x188) != 0) {
      ...
      local_68 = 0;
      local_70._4_4_ = 0;
      local_78 = *(int64_t *)(this_ptr + 0x188);
      while( true ) {
        if (local_70._4_4_ != 0) {
          if (local_70._4_4_ < 1) {
        ...
        if (local_88 == *(int64_t *)(this_ptr + 0x198)) {
          FUN_01d5e230();
          FUN_01d66ab0();
          if ((local_38 != '\0') && (local_40 != 0)) {
            FUN_00d50b20();
    ...
    FUN_01e3f820();
    local_90 = 0;
    local_98 = *(int64_t *)(this_ptr + 0x1c8);
    if (local_98 != 0) {
      FUN_00d50b00();
    }
    local_90 = '\x01';
    ...
    fStack_c4 = (float)((uint64_t)uVar5 >> 0x20);
    ...
    (**(code **)(**(int64_t **)(this_ptr + 0x1c8) + 0x918))();
