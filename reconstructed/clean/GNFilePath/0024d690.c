...
uint64_t FUN_0024d690(uint64_t param_1,int param_2)
  ...
  if (*(int64_t **)(this_ptr + 0x90) == (int64_t *)0x0) {
    ...
    *pcVar4 = '\0';
    ...
    if (local_58 == (int64_t *)0x0) {
      ...
      if (*(int64_t **)(this_ptr + 0x90) != (int64_t *)0x0) goto LAB_0024d727;
      plVar6 = (int64_t *)0x0;
    }
    else {
      plVar6 = local_58;
      ...
      if (*(int64_t **)(this_ptr + 0x90) != (int64_t *)0x0) {
        ...
        *pcVar4 = '\0';
        ...
        if (local_58 == (int64_t *)0x0) {
          ...
          if (*(int64_t **)(this_ptr + 0x90) != (int64_t *)0x0) goto LAB_0024d791;
          plVar5 = (int64_t *)0x0;
        }
        else {
          plVar5 = local_58;
...
LAB_0024d7b2:
  FUN_019f2900();
  FUN_019f2910();
  if (!(bool)(bVar1 | plVar5 == (int64_t *)0x0)) {
    FUN_00d50b20();
  }
...
LAB_0024d852:
  ...
  FUN_00505840();
  plVar6 = (int64_t *)CONCAT71(uStack_47,local_50[8]);
  plVar5 = *(int64_t **)(this_ptr + 0x90);
  if (plVar5 == (int64_t *)0x0) {
LAB_0024d93c:
    ...
    *pcVar4 = '\0';
    ...
    if (local_58 == (int64_t *)0x0) {
      local_58 = *(int64_t **)(this_ptr + 0x90);
      if (local_58 == (int64_t *)0x0) goto LAB_0024d93c;
    }
...
LAB_0024d93e:
  FUN_019f2900();
  (**(code **)(*plVar6 + 0x918))();
  if ((plVar5 != (int64_t *)0x0) && (local_58 != (int64_t *)0x0)) {
    FUN_00d50b20();
  }
