...

{
  ...
  if ((*(float *)(this_ptr + 0xa4) == param_1) &&
     (!NAN(*(float *)(this_ptr + 0xa4)) && !NAN(param_1))) {
    return;
  }
  *(float *)(this_ptr + 0xa4) = param_1;
  fVar2 = g_0239011c;
  *(float *)(this_ptr + 0xa8) =
       (param_1 * g_0239011c + g_0239011c) * *(float *)(this_ptr + 0x9c);
  fVar3 = g_02390124;
  *(float *)(this_ptr + 0xac) = (g_02390124 - param_1) * fVar2 * *(float *)(this_ptr + 0x9c);
