...

{
  ...
  if (plVar8 == (int64_t *)0x0) {
    ...
    if (cVar3 == '\0') {
      ...
      plVar8 = local_60;
      uVar5 = CONCAT71((int7)((uint64_t)uVar5 >> 8),g_026fdd40);
      if ((g_026fdd40 == '\0') && (uVar5 = ___cxa_guard_acquire(), (int)uVar5 != 0)) {
    ...
    if (plVar8 != (int64_t *)0x0) {
      ...
      if (0 < *(int *)(local_50 + 0xc)) {
        do {
          local_60 = *(int64_t **)(*(int64_t *)(local_50 + 0x10) + (int64_t)local_48 * 8);
          FUN_01da7840((int64_t)local_48,&local_60);
          plVar6 = local_40;
          if ((((local_38 == '\0') && (local_40 != (int64_t *)0x0)) &&
      ...
      pplVar10 = *(int64_t ***)(this_ptr + 0x10);
      if (pplVar10 != pplVar9) {
        if (pplVar9 != (int64_t **)0x0) {
          FUN_00d50b00();
        }
        *(int64_t ***)(this_ptr + 0x10) = pplVar9;
        ...
        if (local_58 == '\0') {
          if (local_60 == (int64_t *)0x0) {
            *(void*)(this_ptr + 0x18) = 0;
            ...
            FUN_00d50b00();
            plVar6 = *(int64_t **)(this_ptr + 0x18);
            *(int64_t **)(this_ptr + 0x18) = local_60;
          }
        }
        else {
          local_58 = '\0';
        ...
        if (local_58 == '\0') {
          if (local_60 == (int64_t *)0x0) {
            *(void*)(this_ptr + 0x20) = 0;
            ...
            FUN_00d50b00();
            plVar6 = *(int64_t **)(this_ptr + 0x20);
            *(int64_t **)(this_ptr + 0x20) = local_60;
          }
        }
        else {
          local_58 = '\0';
    ...
    uVar7 = CONCAT71((int7)((uint64_t)pplVar9 >> 8),plVar8 != (int64_t *)0x0);
    FUN_00d50b20();
  }
