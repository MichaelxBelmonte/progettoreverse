...
uint64_t FUN_00ed7f48(uint64_t *param_1,uint64_t *param_2)

{
  ...
  if (*(int *)(this_ptr + 300) == 0) {
      ...
      if (uVar14 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(this_ptr + 0x40 + uVar11 * 4) =
               (int)((*(int64_t *)(lVar4 + 8 + uVar9) * -0x30e4432340650000 ^ uVar12) >>
                    (bVar3 & 0x3f));
      ...
      if (uVar22 - 0x20 < uVar14) {
        ...
        do {
          *(int *)(this_ptr + 0x40 + (uint64_t)((uint)uVar12 & 7) * 4) =
               (int)((*(int64_t *)(lVar4 + uVar12) * -0x30e4432340650000 ^ uVar15) >>
                    (bVar13 & 0x3f));
          uVar12 = uVar12 + 1;
        } while (uVar14 != uVar12);
      }
    ...
    if ((uint)uVar9 < uVar22) {
      ...
      do {
        ...
        *(int *)(this_ptr + 0x40 + uVar15 * 4) =
             (int)((*(int64_t *)(lVar1 + 8 + uVar9) * -0x30e4432340650000 ^
    ...
    *(int *)(this_ptr + 0x40 + (uint64_t)(uVar22 & 7) * 4) =
         (int)((*(int64_t *)((uVar23 & 0xffffffff) + 8 + lVar4) * -0x30e4432340650000 ^ uVar8) >>
              (bVar3 & 0x3f));
  }
  else {
    uVar23 = *arg1;
