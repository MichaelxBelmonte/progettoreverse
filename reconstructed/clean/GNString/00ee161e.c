...
uint64_t FUN_00ee161e(uint64_t *param_1,uint64_t *param_2)

{
  ...
  do {
    ...
    uVar20 = (uint64_t)(*(int64_t *)(lVar12 + uVar24) * -0x30e4432345000000) >> (bVar15 & 0x3f);
...
LAB_00ee1a7d:
      ...
      if ((uVar13 < uVar20) &&
         ...
         (uint64_t *)((int64_t)arg1 + uVar20) == param_2)) goto LAB_00ee1776;
    }
    uVar20 = uVar13;
    if ((uVar10 <= uVar9) ||
