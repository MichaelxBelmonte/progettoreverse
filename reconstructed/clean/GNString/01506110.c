...

{
  ...
  if (*(int *)(*(int64_t *)(this_ptr + 0x40) + 0xc) == 0) {
    FUN_012ca6e0();
  ...
  if (*(char **)(this_ptr + 0x40) != (char *)0x0) {
    local_60[0] = '\0';
    local_68 = 0;
    local_50 = 0xffffffff;
    local_48 = 0;
    local_58 = *(char **)(this_ptr + 0x40);
    while( true ) {
      lVar1 = (int64_t)(int)local_50;
      iVar7 = (int)local_50 + 1;
      local_50 = CONCAT44(local_50._4_4_,iVar7);
      if (*(int *)(local_58 + 0xc) <= iVar7) break;
      local_68 = *(int64_t *)(*(int64_t *)(local_58 + 0x10) + 8 + lVar1 * 8);
