...
void FUN_0128a630(int64_t param_1)

{
  ...
  if ((*(int64_t *)(this_ptr + 0x100) != 0) &&
    ...
    if ((*(int64_t *)(this_ptr + 0x48) == 0) &&
       (FUN_0129a3b0(), *(int64_t *)(this_ptr + 0x100) != 0)) {
      pvVar6 = _pthread_getspecific((void*)param_1);
      if (pvVar6 != (void *)0x0) {
        FUN_00e8b990();
      }
...
LAB_0128b456:
          ...
          if ((pvVar6 != (void *)0x0) && (lVar8 = FUN_00e8b990(), lVar8 != 0)) {
            param_1 = local_38;
            lVar7 = *(int64_t *)(local_38 + 0x20 + (uint64_t)(*(uint *)(lVar8 + 0x154) & 1) * 8);
          }
          pVar10 = (void*)param_1;
          FUN_00d64850();
          if (*(int64_t *)(lVar7 + 400) != 0) {
            *(int64_t *)(lVar7 + 400) = 0;
            FUN_00d50b20();
          }
          FUN_00d64910();
...
LAB_0128b052:
      ...
      pVar10 = (void*)param_1;
      if ((*(int64_t *)(lVar7 + 0x48) == 0) && (FUN_0129a3b0(), *(int64_t *)(lVar7 + 0x100) != 0))
      {
        pvVar6 = _pthread_getspecific(pVar10);
        if (pvVar6 != (void *)0x0) {
          FUN_00e8b990();
...
LAB_0128b162:
      ...
      if ((*(int64_t *)(lVar8 + 0x48) == 0) && (FUN_0129a3b0(), *(int64_t *)(lVar8 + 0x100) != 0))
      {
        pvVar6 = _pthread_getspecific(pVar10);
        if (pvVar6 != (void *)0x0) {
          FUN_00e8b990();
...
LAB_0128ac93:
  cVar5 = FUN_00d59e50();
  if ((cVar5 == '\0') || (*(int64_t *)(this_ptr + 200) == 0)) goto LAB_0128ae97;
  pvVar6 = _pthread_getspecific(pVar10);
  if (pvVar6 != (void *)0x0) {
    FUN_00e8b990();
  }
  ...
  pvVar6 = _pthread_getspecific(pVar10);
  if ((pvVar6 == (void *)0x0) || (lVar7 = FUN_00e8b990(), lVar7 == 0)) {
    lVar7 = *(int64_t *)(local_50 + 0x60);
  }
  else {
    lVar7 = *(int64_t *)
             (*(int64_t *)(local_50 + 0x20 + (uint64_t)(*(uint *)(lVar7 + 0x154) & 1) * 8) + 0x60)
    ;
  }
  if (lVar7 != 0) {
    pvVar6 = _pthread_getspecific(pVar10);
