...
uint64_t FUN_00ee2b99(uint64_t *param_1,uint64_t *param_2)

{
  ...
  if (*(uint *)(this_ptr + 0x2c) < (uint)local_d8) {
    do {
      uVar12 = (uint64_t)(*(int64_t *)(lVar5 + uVar26) * -0x30e4432345000000) >> (bVar33 & 0x3f);
  ...
  *(uint *)(this_ptr + 0x2c) = (uint)local_d8;
  lVar7 = *arg1;
  uVar26 = (uint64_t)(lVar7 * -0x30e4432345000000) >> (bVar33 & 0x3f);
...
LAB_00ee3286:
  ...
  uVar10 = *(uint *)(puVar8[0xe] +
                    ((uint64_t)(lVar7 * -0x30e4432345000000) >> (-*(char *)(puVar8 + 0x21) & 0x3fU)
                    ) * 4);
  if (uVar40 < uVar10) {
