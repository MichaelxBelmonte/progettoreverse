...
uint64_t FUN_009a934e(char param_1,uint64_t param_2,int64_t param_3,byte *param_4)

{
  ...
  lVar5 = *(int64_t *)(this_ptr + 0x138);
  if (*(int64_t *)(this_ptr + 0x140) != lVar5) {
    lVar3 = (int64_t)*(int *)(param_3 + 0x18);
    ...
    if ((bVar1 & 1) == 0) {
      ...
      lVar12 = *(int64_t *)(lVar5 + 0x10 + lVar3 * 0x18);
      uVar13 = *(uint64_t *)(lVar5 + 8 + lVar3 * 0x18);
    }
    if ((*param_4 & 1) == 0) {
      pbVar9 = param_4 + 1;
      uVar10 = (uint64_t)(*param_4 >> 1);
    }
    else {
      pbVar9 = *(byte **)(param_4 + 0x10);
      uVar10 = *(uint64_t *)(param_4 + 8);
    }
  ...
  if (*(int64_t *)(this_ptr + 0x128) != lVar5) {
    lVar3 = (int64_t)*(int *)(param_3 + 0x18);
    bVar1 = *(byte *)(lVar5 + lVar3 * 0x18);
    if ((bVar1 & 1) == 0) {
      uVar13 = (uint64_t)(bVar1 >> 1);
  ...
  if (*(int64_t *)(this_ptr + 0x110) != lVar5) {
    lVar3 = (int64_t)*(int *)(param_3 + 0x10);
    bVar1 = *(byte *)(lVar5 + lVar3 * 0x18);
    if ((bVar1 & 1) == 0) {
      uVar13 = (uint64_t)(bVar1 >> 1);
      lVar12 = lVar5 + 1 + lVar3 * 0x18;
  ...
  piVar8 = *(id **)(this_ptr + 0xf0);
  if (*(id **)(this_ptr + 0xf8) != piVar8) {
    lVar5 = (int64_t)*(int *)(param_3 + 0x10);
    if (((byte)piVar8[lVar5 * 0x18] & 1) == 0) {
      uVar13 = (uint64_t)((byte)piVar8[lVar5 * 0x18] >> 1);
      piVar14 = piVar8 + lVar5 * 0x18 + 1;
    }
    else {
      piVar14 = *(id **)(piVar8 + lVar5 * 0x18 + 0x10);
      uVar13 = *(uint64_t *)(piVar8 + lVar5 * 0x18 + 8);
    }
    if ((*param_4 & 1) == 0) {
      pbVar9 = param_4 + 1;
      uVar10 = (uint64_t)(*param_4 >> 1);
  ...
  this = (locale *)(uint64_t)(uint)(int)param_1;
