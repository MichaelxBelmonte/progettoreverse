...
uint64_t FUN_016dbc00(double param_1,double param_2,int param_3,uint64_t param_4)

{
  ...
  if (((*(int *)(*arg1 + 0x10) == 0) && (*(int *)(*arg1 + 0x18) == 0)) && (param_3 == 1))
  {
    param_4 = 0;
    goto LAB_016dc7e4;
  }
  ...
  if ((local_98 == 0.0) && (!NAN(local_98))) {
    if ((local_a0 == g_0238fee8) && (!NAN(local_a0) && !NAN(g_0238fee8))) {
...
LAB_016dbe2b:
    ...
    *(void*)((int64_t)puVar3 + 0xc) = uVar4;
    ...
    if (local_c4 != 0) {
      if (local_88._4_4_ == 0) {
        lVar8 = *arg1;
        uVar6 = *(uint64_t *)(lVar8 + 0xc);
        if (uVar6 >> 0x20 == 0) {
          uVar6 = FUN_00e7bdb0();
          lVar8 = *arg1;
        }
        local_40 = *(uint64_t *)(lVar8 + 0x14);
        pVar9 = (void*)(local_40 >> 0x20);
        if (local_40 >> 0x20 == 0) {
...
LAB_016dc899:
        ...
        local_50 = **(uint64_t **)(local_78 + 0x10);
        if (local_50 == 0) {
          local_80 = 0;
          local_50 = 0;
        }
...
LAB_016dc274:
      ...
      if ((local_a8._4_4_ == 0) || (cVar1 = FUN_00e7c630(), cVar1 == '\0')) {
        FUN_00d23340();
        param_4 = local_40;
        pVar9 = (void*)CONCAT71((int7)(uVar10 >> 8),local_38[0]);
        puVar12 = &local_68;
        if (local_38[0] != '\0') {
          puVar12 = (uint64_t *)local_38;
        }
        ...
        *(char *)puVar12 = '\0';
        ...
        local_60 = *(uint64_t *)(this_ptr + 0x68);
        uVar4 = FUN_00e7b820();
...
LAB_016dbe7d:
  if ((local_a0 != g_0238fee8) || (NAN(local_a0) || NAN(g_0238fee8))) {
    ...
    param_4 = CONCAT71((int7)((uint64_t)lVar8 >> 8),1);
  }
  else {
    param_4 = CONCAT71(uVar14,1);
    if ((local_98 != 0.0) || (NAN(local_98))) {
