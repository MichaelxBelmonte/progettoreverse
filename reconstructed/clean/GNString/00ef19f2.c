...
uint64_t FUN_00ef19f2(uint64_t *param_1,uint64_t *param_2)

{
  ...
  uVar26 = *arg1 * -0x30e4432340650000 >> (0x42U - *(char *)(puVar7 + 0x21) & 0x3f);
  ...
  if (*(int *)(this_ptr + 300) == 0) {
      ...
      if (uVar34 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(this_ptr + 0x40 + uVar14 * 4) =
               (int)((*(int64_t *)(lVar16 + 8 + uVar18) * -0x30e4432340650000 ^ uVar15) >>
                    (bVar30 & 0x3f));
    ...
    if ((uint)uVar18 < uVar35) {
      ...
      do {
        ...
        *(int *)(this_ptr + 0x40 + uVar32 * 4) =
             (int)((*(int64_t *)(lVar19 + 8 + uVar18) * -0x30e4432340650000 ^
    ...
    *(int *)(this_ptr + 0x40 + (uint64_t)(uVar35 & 7) * 4) =
         (int)((*(int64_t *)((uVar37 & 0xffffffff) + 8 + lVar16) * -0x30e4432340650000 ^ uVar27) >>
              (bVar30 & 0x3f));
  }
  else {
    uVar34 = (uint)((*arg1 * -0x30e4432340650000 ^ uVar27) >> (0x38U - cVar38 & 0x3f));
    *(uint *)(this_ptr + 0x2c) = uVar35;
  }
...
LAB_00ef21d3:
        ...
        if ((uVar37 < uVar15) &&
           ...
           (uint64_t *)((int64_t)arg1 + uVar15) == param_2)) goto LAB_00ef2500;
      }
      uVar32 = uVar32 + 1;
    } while (uVar32 != uVar27);
  }
