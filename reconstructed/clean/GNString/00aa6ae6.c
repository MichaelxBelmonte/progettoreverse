...

{
  ...
  iVar41 = (**(code **)(*arg1 + 0x30))(0x16,0xf);
  ...
  iVar42 = iVar2 + iVar1 + iVar3 + iVar4 + iVar5 + iVar6 + iVar7 + iVar8 + iVar9 + iVar10 + iVar11 +
           ...
           iVar42;
  for (plVar43 = *(int64_t **)(this_ptr + 0x110); plVar43 != *(int64_t **)(this_ptr + 0x118);
      plVar43 = plVar43 + 4) {
  ...
  for (plVar43 = *(int64_t **)(this_ptr + 0x128); plVar43 != *(int64_t **)(this_ptr + 0x130);
      plVar43 = plVar43 + 4) {
    iVar1 = (**(code **)(*plVar43 + 0x18))();
    iVar4 = iVar4 + iVar1;
  }
