...
LAB_007e675e:
    while( true ) {
      lVar8 = local_98;
      local_a8 = 0;
      lVar6 = (int64_t)local_b0;
      local_b0 = local_b0 + 1;
      if (*(int *)((int64_t)plVar15 + 0xc) <= local_b0) break;
      lVar10 = plVar15[2];
      local_c8 = *(int64_t **)(lVar10 + 8 + lVar6 * 8);
...
LAB_007e71f4:
        do {
          plVar12 = local_68;
          lVar6 = (int64_t)local_80;
          local_80 = local_80 + 1;
          if (*(int *)(lVar8 + 0xc) <= local_80) goto LAB_007e6740;
          lVar10 = *(int64_t *)(lVar8 + 0x10);
          local_98 = *(int64_t *)(lVar10 + 8 + lVar6 * 8);
          pvVar7 = _pthread_getspecific((void*)lVar10);
          pVar9 = (void*)lVar10;
          if (pvVar7 != (void *)0x0) {
            FUN_00e8b990();
          ...
          if (cVar3 != '\0') {
            ...
            FUN_0124c6e0();
            if (local_60 == '\0') {
              if (local_68 == (int64_t *)0x0) goto LAB_007e71f4;
              FUN_00d50b00();
            }
            else if (local_68 == (int64_t *)0x0) goto LAB_007e71f4;
            local_60 = '\0';
            ...
            while( true ) {
              ...
              local_50 = local_50 + 1;
              if (*(int *)((int64_t)plVar12 + 0xc) <= local_50) break;
              lVar10 = plVar12[2];
  ...
  fVar16 = g_02390124 - *(float *)(this_ptr + 0x38);
  fVar17 = g_02391090 * fVar16;
  iVar1 = *(int *)((int64_t)puVar4 + 0xc);
  if (iVar1 == 0) {
    *(float *)(this_ptr + 0x38) = fVar17 + *(float *)(this_ptr + 0x38);
    if (puVar5 == (void*)0x0) goto LAB_007e7e12;
  }
  else {
    if (*(int *)((int64_t)puVar5 + 0xc) == 0) {
      ...
      *(float *)(this_ptr + 0x3c) = fVar16 * g_02390120;
      local_128 = 0;
      ...
      local_1a0 = '\0';
      local_1a8 = puVar5;
      local_130 = (int64_t *)(this_ptr + 0x10);
      FUN_013206a0();
        ...
        do {
          ...
          if (local_118 != (int64_t *)0x0) {
            ...
            while( true ) {
              ...
              local_50 = local_50 + 1;
              if (*(int *)((int64_t)plVar15 + 0xc) <= local_50) break;
              lVar6 = plVar15[2];
              local_68 = *(int64_t **)(lVar6 + 8 + lVar8 * 8);
              ...
              if (cVar3 != '\0') {
                ...
                if ((pvVar7 != (void *)0x0) && (lVar8 = FUN_00e8b990(), lVar8 != 0)) {
                  plVar12 = (int64_t *)local_68[(uint64_t)(*(uint *)(lVar8 + 0x154) & 1) + 4];
                }
                (**(code **)(*plVar12 + 0x3a8))();
                lVar8 = g_02729550;
                if (g_02729550 != 0) {
                ...
                if (plVar12 != (int64_t *)0x0) {
                  ...
                  while( true ) {
                    local_a8 = 0;
                    lVar8 = (int64_t)local_b0;
                    local_b0 = local_b0 + 1;
                    if (*(int *)((int64_t)plVar12 + 0xc) <= local_b0) break;
                    local_c8 = *(int64_t **)(plVar12[2] + 8 + lVar8 * 8);
                    pvVar7 = _pthread_getspecific((void*)plVar12[2]);
                    if (pvVar7 != (void *)0x0) {
                      FUN_00e8b990();
                    }
                    local_160 = '\0';
                    ...
                    *(float *)(this_ptr + 0x38) =
                         *(float *)(this_ptr + 0x38) + fVar17 / (float)iVar1;
                  }
                  FUN_00115190();
                  FUN_00d50b20();
                }
    ...
    if (((char)uVar13 != '\0') && (plVar15 != (int64_t *)0x0)) {
      FUN_00d50b20();
    }
  }
  FUN_00d50b20();
