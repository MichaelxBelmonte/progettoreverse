...
uint64_t FUN_00254fb0(uint64_t param_1,uint32_t param_2)

{
  ...
  uVar8 = (uint64_t)(dVar24 * g_023907c0);
  dVar24 = dVar24 * g_023907c0 - g_023907c8;
  pplVar16 = (int64_t **)0xaaaaaaaaaaaaaaab;
  FUN_0071a120();
  if ((((local_58[0] == '\0') && (local_60 != (int64_t *)0x0)) &&
      (FUN_00d50b00(), local_58[0] != '\0')) && (local_60 != (int64_t *)0x0)) {
    FUN_00d50b20();
  }
  bVar4 = (byte)(((int64_t)dVar24 & (int64_t)uVar8 >> 0x3f | uVar8) / 3);
  local_88 = plVar9;
  local_80[0] = '\0';
  FUN_000175c0();
  plVar12 = local_60;
  ...
  if ((plVar12 != (int64_t *)0x0 & bVar4) == 0) {
    uVar8 = 0;
    goto LAB_00256cde;
  }
...
LAB_00255177:
    ...
    local_e0 = 0;
    if (local_80[0] == '\0') {
      if (local_88 == (int64_t *)0x0) goto LAB_00255177;
      FUN_00d50b00();
    }
    else {
      local_80[0] = '\0';
  ...
  if (plVar12 == (int64_t *)0x0) {
    (**(code **)(&UNK_00001550 + **(int64_t **)(this_ptr + 0x90)))();
    plVar12 = local_60;
    local_a0 = (int64_t *)CONCAT71(local_a0._1_7_,local_58[0]);
    pplVar10 = &local_a0;
    if (local_58[0] != '\0') {
...
LAB_00255482:
    ...
    FUN_00d50b20();
    local_154 = *(int *)((int64_t)plVar12 + 0xc);
    local_b8 = plVar12;
    if (local_154 == 0) {
      plVar12 = *(int64_t **)(this_ptr + 0x90);
      if (plVar12 == (int64_t *)0x0) {
LAB_002557a3:
        ...
        pplVar16 = (int64_t **)local_58;
        if (local_58[0] == '\0') {
          pplVar16 = &local_88;
        }
        *(char *)pplVar16 = '\0';
        if ((local_58[0] != '\0') && (plVar18 != (int64_t *)0x0)) {
          FUN_00d50b20();
        }
        if (plVar18 == (int64_t *)0x0) {
          plVar18 = *(int64_t **)(this_ptr + 0x90);
          if (plVar18 == (int64_t *)0x0) goto LAB_002557a3;
        }
      ...
      if (plVar1 == (int64_t *)0x0) {
        ...
        *(char *)pplVar16 = '\0';
        ...
        if (plVar19 == (int64_t *)0x0) {
          plVar19 = *(int64_t **)(this_ptr + 0x90);
          if (plVar19 != (int64_t *)0x0) goto LAB_00255865;
          plVar19 = (int64_t *)0x0;
        }
...
LAB_00255865:
      ...
      if (plVar18 != (int64_t *)0x0) {
        ...
        do {
          ...
          lVar21 = (int64_t)(int)local_48;
          iVar6 = (int)local_48 + 1;
          local_48 = CONCAT44(local_48._4_4_,iVar6);
          if (*(int *)((int64_t)local_50 + 0xc) <= iVar6) {
            FUN_000be170();
            plVar19 = local_b0;
            plVar18 = local_c0;
            break;
          }
          local_a0 = *(int64_t **)(local_50[2] + 8 + lVar21 * 8);
          local_98 = '\0';
          local_60 = local_a0;
          FUN_004f9cf0();
          plVar18 = local_88;
      ...
      local_88 = (int64_t *)CONCAT71(local_88._1_7_,local_58[0]);
      *(char *)pplVar16 = '\0';
      if ((local_58[0] != '\0') && (plVar22 != (int64_t *)0x0)) {
        FUN_00d50b20();
      }
      iVar6 = *(int *)((int64_t)plVar22 + 0xc);
      if ((char)local_88 != '\0') {
        FUN_00d50b20();
      }
      bVar2 = true;
      if ((iVar6 < 1) && (plVar19 != (int64_t *)0x0)) {
        local_58[0] = '\0';
        local_60 = (int64_t *)0x0;
        local_40 = 0;
        local_48 = 0;
        local_50 = plVar19;
        if (0 < *(int *)((int64_t)plVar19 + 0xc)) {
          lVar21 = 0;
          local_b0 = plVar19;
          do {
            local_118 = *(int64_t **)(local_b0[2] + lVar21 * 8);
            local_110 = '\0';
            local_60 = local_118;
            FUN_004f9cf0();
            local_d8 = local_88;
            ...
            plVar19 = local_b0;
          } while (lVar21 < *(int *)((int64_t)local_b0 + 0xc));
        }
        FUN_000be170();
        bVar2 = true;
      }
    ...
    if (0 < local_154) {
      lVar21 = 0;
      do {
        local_60 = *(int64_t **)(local_b8[2] + lVar21 * 8);
        pvVar14 = _pthread_getspecific((void*)pplVar16);
        if (pvVar14 != (void *)0x0) {
          FUN_00e8b990();
        }
        FUN_01264240();
        plVar9 = local_88;
        local_208 = (int64_t *)CONCAT71(local_208._1_7_,local_80[0]);
        pplVar16 = &local_208;
        pplVar10 = (int64_t **)local_80;
        if (local_80[0] == '\0') {
          pplVar10 = pplVar16;
        }
        *(char *)pplVar10 = '\0';
        ...
        if (plVar9 != (int64_t *)0x0) {
          ...
          FUN_01266fe0();
          plVar19 = local_88;
          local_118 = (int64_t *)CONCAT71(local_118._1_7_,local_80[0]);
          pplVar16 = &local_118;
          pplVar10 = (int64_t **)local_80;
          if (local_80[0] == '\0') {
            pplVar10 = pplVar16;
        ...
        lVar21 = lVar21 + 1;
        local_48 = CONCAT44(local_48._4_4_,(int)lVar21);
      } while (lVar21 < *(int *)((int64_t)local_b8 + 0xc));
    }
    bVar4 = 0;
    plVar19 = local_b8;
LAB_002556d2:
    ...
    uVar17 = (uint32_t)CONCAT71((int7)((uint64_t)plVar19 >> 8),1);
    bVar3 = false;
    goto LAB_00255e52;
  }
  (**(code **)(&UNK_00001550 + **(int64_t **)(this_ptr + 0x90)))();
  ...
  uVar17 = 0;
LAB_00255e63:
  local_d8 = (int64_t *)CONCAT44(local_d8._4_4_,uVar17);
  FUN_00c9fe20();
  plVar12 = local_60;
  local_88 = (int64_t *)CONCAT71(local_88._1_7_,local_58[0]);
  pplVar16 = (int64_t **)local_58;
...
LAB_00256048:
    local_b0 = (int64_t *)((uint64_t)local_b0 & 0xffffffff00000000);
  }
  else {
    (**(code **)(&UNK_00001550 + **(int64_t **)(this_ptr + 0x90)))();
    plVar12 = local_60;
    ...
    plVar18 = g_026f6f08;
    if (plVar12 == (int64_t *)0x0) goto LAB_00256048;
...
LAB_00256101:
    ...
    do {
      ...
      lVar11 = local_50[2];
      local_60 = *(int64_t **)(lVar11 + 8 + lVar21 * 8);
      pvVar14 = _pthread_getspecific((void*)lVar11);
      pVar15 = (void*)lVar11;
      if (pvVar14 != (void *)0x0) {
        FUN_00e8b990();
      }
      ...
      if (plVar12 != (int64_t *)0x0) {
        ...
        if (plVar12 == (int64_t *)0x0) goto LAB_0025653e;
      }
    } while( true );
  }
  FUN_01caeae0();
  FUN_01d66da0();
  local_1f8 = g_02726cf0;
  if (g_02726cf0 != 0) {
    FUN_00d50b00();
  }
  local_1f0 = '\x01';
...
LAB_002565e0:
    ...
    if ((char)local_d8 == '\0') {
      ...
      *(char *)pplVar16 = '\0';
      ...
      if (((char)local_88 != '\0') && (plVar18 != (int64_t *)0x0)) {
        FUN_00d50b20();
      }
...
LAB_002566fe:
      ...
      FUN_006f3f00();
      if (local_60 == (int64_t *)0x0) goto LAB_002566fe;
      if (*(int64_t *)(this_ptr + 0x1c0) == 0) {
        local_80[0] = '\0';
        local_88 = (int64_t *)0x0;
      }
...
LAB_002567b6:
        ...
        while( true ) {
          ...
          local_60 = *(int64_t **)(local_50[2] + 8 + lVar21 * 8);
          pvVar14 = _pthread_getspecific((void*)local_50[2]);
          if (pvVar14 != (void *)0x0) {
            FUN_00e8b990();
          }
          iVar6 = FUN_01326de0();
          if (iVar6 != 0) {
            ...
            FUN_00d50b20();
            uVar20 = (undefined7)((uint64_t)plVar18 >> 8);
...
LAB_002569c8:
        ...
        if (0 < *(int *)((int64_t)plVar18 + 0xc)) {
          lVar21 = 0;
          do {
            plVar9 = *(int64_t **)(plVar18[2] + lVar21 * 8);
            local_1b0 = '\0';
            local_1b8 = plVar9;
            local_60 = plVar9;
            ...
            plVar1 = local_88;
            if (local_80[0] == '\0') {
              if (((local_88 != (int64_t *)0x0) && (uVar13 = FUN_00d50b00(), local_80[0] != '\0'))
                 && (local_88 != (int64_t *)0x0)) {
                uVar13 = FUN_00d50b20();
              }
            }
            ...
            lVar21 = lVar21 + 1;
            local_48 = CONCAT44(local_48._4_4_,(int)lVar21);
          } while ((int)lVar21 < *(int *)((int64_t)plVar18 + 0xc));
        }
        FUN_00115190();
        FUN_00d50b20();
        plVar9 = local_a8;
LAB_00256ca2:
    ...
    if (plVar18 == (int64_t *)0x0) goto LAB_002565e0;
    pvVar14 = _pthread_getspecific(pVar15);
    if (pvVar14 != (void *)0x0) {
      FUN_00e8b990();
    }
...
LAB_00255d9a:
  ...
  if ((plVar1 != (int64_t *)0x0) && (local_128 != (int64_t *)0x0)) {
    FUN_00d50b20();
  }
  if (plVar18 != (int64_t *)0x0) {
    FUN_00d50b20();
  ...
  if ((plVar12 != (int64_t *)0x0) && (local_120 != (int64_t *)0x0)) {
    FUN_00d50b20();
  }
  if (bVar2) {
LAB_00255e34:
    uVar17 = (uint32_t)CONCAT71((int7)((uint64_t)plVar19 >> 8),local_154 != 0);
    bVar3 = true;
    bVar2 = true;
  }
  else {
