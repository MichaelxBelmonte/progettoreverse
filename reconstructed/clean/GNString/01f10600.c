...
void FUN_01f10600(uint64_t param_1,uint32_t param_2)

{
  ...
  iVar5 = FUN_01d5e2e0();
  lVar7 = this_ptr[0x30];
  lVar12 = *(int64_t *)(this_ptr[0x2d] + 0x10);
  lVar11 = (int64_t)iVar5 * 0x10;
  uVar1 = *(uint64_t *)(lVar12 + lVar11);
  local_a8._8_8_ = 0;
  ...
  if (((lVar7 == 0) || (*(int *)(lVar7 + 0x18) < 8)) ||
     (**(int **)(lVar7 + 0x10) != (int)this_ptr[0x28])) {
    puVar6 = (void*)0x0;
  }
  else {
    ...
    *puVar6 = &g_025683c0;
    ...
    if (7 < *(int *)(lVar7 + 0x18)) {
      ...
      do {
        ...
        *(void*)(puVar6[2] + (int64_t)iVar5) = *(void*)(lVar7 + lVar12 * 4);
        lVar12 = lVar12 + 1;
        lVar7 = this_ptr[0x30];
  ...
  local_a8._4_4_ = (uint32_t)(uVar1 >> 0x20);
  if (*(int *)((int64_t)this_ptr + 0x17c) == 3) {
    auVar3._4_4_ = local_a8._4_4_;
    auVar3._0_4_ = (float)local_a8._4_4_ + fVar14 + g_02390d00;
    auVar3._8_8_ = 0;
    auVar16 = insertps(auVar16,auVar3,0x10);
  }
  else if (*(int *)((int64_t)this_ptr + 0x17c) == 2) {
    local_a8._0_4_ = (uint32_t)uVar1;
  ...
  *puVar8 = &g_02572358;
  ...
  FUN_00d50b00();
  FUN_00d50b00();
  local_130 = this_ptr[0x2b];
  local_128 = '\0';
  local_120 = this_ptr[0x2e];
  local_118 = '\0';
  local_108 = '\0';
  local_100 = 0;
  local_f8 = '\0';
  ...
  local_110 = puVar6;
  local_f0 = puVar8;
  FUN_01d5f100(local_a8._0_4_,local_dc,&local_130,(int)this_ptr[0x2c],&local_f0);
