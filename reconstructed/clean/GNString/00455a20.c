...
void FUN_00455a20(void* param_1)

{
  ...
  lVar5 = *(int64_t *)(this_ptr + 0x60);
  if ((lVar5 != 0) || (lVar5 = *(int64_t *)(this_ptr + 0x30), lVar5 != 0)) {
    FUN_00d50b00();
  }
...
LAB_00455b59:
    if (0 < *(int *)((int64_t)local_60 + 0xc)) {
      ...
      do {
        ...
        iVar4 = iVar4 + 1;
      } while (iVar4 < *(int *)((int64_t)local_60 + 0xc));
    }
    FUN_0015ee90();
    FUN_00d50b20();
  }
