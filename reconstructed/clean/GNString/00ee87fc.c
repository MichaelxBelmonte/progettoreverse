...
uint64_t FUN_00ee87fc(uint64_t *param_1,uint64_t *param_2)

{
  ...
  uVar26 = *arg1 * -0x30e4432340650000 >> (0x38U - *(char *)((int64_t)puVar7 + 0x34) & 0x3f);
  ...
  if (*(int *)(this_ptr + 300) == 0) {
      ...
      if (uVar9 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(this_ptr + 0x40 + uVar13 * 4) =
               (int)((*(int64_t *)(lVar12 + 8 + uVar39) * -0x30e4432340650000 ^ uVar14) >>
                    (bVar15 & 0x3f));
      ...
      if (uVar34 - 0x20 < uVar9) {
        ...
        do {
          *(int *)(this_ptr + 0x40 + (uint64_t)((uint)uVar14 & 7) * 4) =
               (int)((*(int64_t *)(lVar12 + uVar14) * -0x30e4432340650000 ^ uVar27) >>
                    (bVar24 & 0x3f));
          uVar14 = uVar14 + 1;
        } while (uVar9 != uVar14);
      }
    ...
    if ((uint)uVar39 < uVar34) {
      ...
      do {
        ...
        *(int *)(this_ptr + 0x40 + uVar27 * 4) =
             (int)((*(int64_t *)(lVar8 + 8 + uVar39) * -0x30e4432340650000 ^
    ...
    *(int *)(this_ptr + 0x40 + (uint64_t)(uVar34 & 7) * 4) =
         (int)((*(int64_t *)((uVar35 & 0xffffffff) + 8 + lVar12) * -0x30e4432340650000 ^ uVar11) >>
              (bVar15 & 0x3f));
  }
  else {
    uVar9 = (uint)((*arg1 * -0x30e4432340650000 ^ uVar11) >> (0x38U - cVar19 & 0x3f));
    *(uint *)(this_ptr + 0x2c) = uVar34;
  }
