...
uint64_t FUN_00ef0d22(uint64_t *param_1,uint64_t *param_2)

{
  ...
  uVar25 = *arg1 * -0x30e4432340650000 >> (0x42U - *(char *)(puVar7 + 0x21) & 0x3f);
  ...
  if (*(int *)(this_ptr + 300) == 0) {
      ...
      if (uVar34 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(this_ptr + 0x40 + uVar15 * 4) =
               (int)((*(int64_t *)(lVar17 + 8 + uVar41) * -0x30e4432340650000 ^ uVar16) >>
                    (bVar37 & 0x3f));
      ...
      if (uVar33 - 0x20 < uVar34) {
        ...
        do {
          *(int *)(this_ptr + 0x40 + (uint64_t)((uint)uVar16 & 7) * 4) =
               (int)((*(int64_t *)(lVar17 + uVar16) * -0x30e4432340650000 ^ uVar31) >>
                    (bVar9 & 0x3f));
          uVar16 = uVar16 + 1;
        } while (uVar34 != uVar16);
      }
    ...
    if ((uint)uVar41 < uVar33) {
      ...
      do {
        ...
        *(int *)(this_ptr + 0x40 + uVar31 * 4) =
             (int)((*(int64_t *)(lVar20 + 8 + uVar41) * -0x30e4432340650000 ^
    ...
    *(int *)(this_ptr + 0x40 + (uint64_t)(uVar33 & 7) * 4) =
         (int)((*(int64_t *)((uVar35 & 0xffffffff) + 8 + lVar17) * -0x30e4432340650000 ^ uVar19) >>
              (bVar37 & 0x3f));
  }
  else {
    uVar34 = (uint)((*arg1 * -0x30e4432340650000 ^ uVar19) >> (0x38U - cVar30 & 0x3f));
    *(uint *)(this_ptr + 0x2c) = uVar33;
  }
...
LAB_00ef14e4:
        ...
        if ((uVar35 < uVar16) &&
           ...
           (uint64_t *)((int64_t)arg1 + uVar16) == param_2)) goto LAB_00ef1807;
      }
      uVar31 = uVar31 + 1;
    } while (uVar31 != uVar19);
  }
