...
uint64_t FUN_00eddbd8(uint64_t *param_1,uint64_t *param_2)

{
  ...
  if (*(int *)(this_ptr + 300) == 0) {
      ...
      if (uVar18 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(this_ptr + 0x40 + uVar12 * 4) =
               (int)((*(int64_t *)(lVar4 + 8 + uVar11) * -0x30e4432345000000 ^ uVar13) >>
                    (bVar14 & 0x3f));
      ...
      if (uVar32 - 0x20 < uVar18) {
        ...
        do {
          *(int *)(this_ptr + 0x40 + (uint64_t)((uint)uVar13 & 7) * 4) =
               (int)((*(int64_t *)(lVar4 + uVar13) * -0x30e4432345000000 ^ uVar21) >>
                    (bVar22 & 0x3f));
          uVar13 = uVar13 + 1;
        } while (uVar18 != uVar13);
      }
    ...
    if ((uint)uVar11 < uVar32) {
      ...
      do {
        ...
        *(int *)(this_ptr + 0x40 + uVar21 * 4) =
             (int)((*(int64_t *)(lVar16 + 8 + uVar11) * -0x30e4432345000000 ^
    ...
    *(int *)(this_ptr + 0x40 + (uint64_t)(uVar32 & 7) * 4) =
         (int)((*(int64_t *)((uVar33 & 0xffffffff) + 8 + lVar4) * -0x30e4432345000000 ^ uVar15) >>
              (bVar14 & 0x3f));
  }
  else {
    uVar33 = *arg1;
