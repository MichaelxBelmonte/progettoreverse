...

{
  ...
  puVar4 = g_026e1810;
  if (g_026e1810 != (void*)0x0) {
    FUN_00d50b00();
  }
  dVar2 = (double)FUN_00e7d6f0();
  uVar8 = (uint64_t)(dVar2 * g_023907c0);
  ...
  bVar6 = (byte)(((int64_t)dVar2 & (int64_t)uVar8 >> 0x3f | uVar8) / 3);
  local_c8 = puVar4;
  ...
  if (((char)local_c0 != '\0') && (local_c8 != (void*)0x0)) {
    FUN_00d50b20();
  }
  ...
  if (bVar21) {
    ...
    if (*(int *)((int64_t)local_98 + 0xc) != 0) {
      ...
      uVar17 = *(uint *)((int64_t)local_98 + 0xc);
      if ((int)uVar17 < 1) {
        local_d0 = g_0238fee8;
        local_68 = 0.0;
        local_a8 = 0;
        ...
        do {
          while( true ) {
            lVar9 = local_98[2];
            lVar1 = *(int64_t *)(lVar9 + (uint64_t)uVar17 * 8);
            pVar13 = uVar17;
            local_a0 = lVar16;
            if (lVar16 == lVar1) {
              if (((char)local_a8 == '\0') && (lVar16 != 0)) {
                local_a8 = CONCAT71((int7)((uint64_t)lVar9 >> 8),1);
                FUN_00d50b00();
              }
            }
            else {
              ...
              if (((char)local_a8 == '\0') || (local_a0 == 0)) {
                ...
                local_a0 = lVar1;
                uVar10 = FUN_00d50b20();
                local_a8 = CONCAT71((int7)((uint64_t)uVar10 >> 8),1);
              }
            }
            lVar16 = local_a0;
...
LAB_00800782:
      ...
      plVar19 = *(int64_t **)(this_ptr + 0x98);
      if (((double)local_d0 != (double)local_90) || (NAN((double)local_d0) || NAN((double)local_90))
         ) {
        local_4c = (int)((double)local_d0 * g_023934d0);
        pVar13 = (void*)((double)local_90 * g_023934d0);
        local_50 = 2;
        local_58 = (int64_t *)&g_024c3df0;
        local_48 = (int64_t *)CONCAT44(local_48._4_4_,pVar13);
        ...
        local_bc = (int)((local_68 / (double)(int)uVar17) * g_023934d0);
        local_c0 = 1;
        pVar13 = 0x24cc6f0;
        local_c8 = &g_024cc6f0;
        FUN_00d8cb40(&g_024cc6f0,&local_c8);
        local_118 = local_58;
        local_110 = 0;
        if ((char)local_50 == '\0') {
          if (local_58 != (int64_t *)0x0) {
      ...
      if (*(int64_t *)(this_ptr + 0xc0) == 0) {
        (**(code **)(**(int64_t **)(this_ptr + 0x88) + 0xad8))(g_023b84e0);
      }
      *(void*)(this_ptr + 200) = 0;
      FUN_012e74e0();
      plVar19 = local_58;
...
LAB_00800c48:
        ...
        if (plVar12 == (int64_t *)0x0) goto LAB_00800c48;
        if (*(int64_t *)(this_ptr + 0xc0) == 0) {
        ...
        if (*(int *)((int64_t)local_98 + 0xc) == 0) {
          ...
          plVar5 = local_58;
          if ((g_026fd0c0 == '\0') && (iVar18 = ___cxa_guard_acquire(), iVar18 != 0)) {
...
LAB_008013b9:
            ...
            do {
              local_c8 = *(void**)
                          (*(int64_t *)(local_b8 + 0x10) + (int64_t)(int)local_b0 * 8);
              FUN_00801e90(*(int64_t *)(local_b8 + 0x10),&local_c8);
              local_90 = local_58;
              if (((char)local_50 == '\0') && (local_58 != (int64_t *)0x0)) {
                FUN_00d50b00();
                if (((char)local_50 != '\0') && (local_58 != (int64_t *)0x0)) {
...
LAB_008012e3:
                ...
                local_40 = 0xffffffff;
                local_38 = 0;
                local_d0 = (int64_t *)CONCAT44(local_d0._4_4_,0xffffff01);
                local_40._4_4_ = 0;
                iVar18 = 0;
                while( true ) {
                  if (local_40._4_4_ != 0) {
                  ...
                  lVar20 = (int64_t)(int)local_40;
                  iVar15 = (int)local_40 + 1;
                  local_40 = CONCAT44(local_40._4_4_,iVar15);
                  if (*(int *)((int64_t)local_48 + 0xc) <= iVar15) goto LAB_008012ce;
                  lVar9 = local_48[2];
                  local_88 = *(int64_t **)(lVar9 + 8 + lVar20 * 8);
                  local_80 = '\0';
                  local_58 = local_88;
                  cVar7 = FUN_00d23d70();
                  pVar13 = (void*)lVar9;
...
LAB_00801239:
                    ...
                    FUN_012e5ae0();
                    iVar18 = iVar18 + *(int *)((int64_t)local_88 + 0xc);
                    if ((local_80 != '\0') && (local_88 != (int64_t *)0x0)) {
                      FUN_00d50b20();
                    }
                    lVar16 = local_a0;
...
LAB_008012ce:
              ...
              if (((uint64_t)local_d0 & 1) != 0) {
                if (local_74 == 0xffffffff) {
                  uVar8 = (uint64_t)local_b0;
                  local_74 = local_b0;
                }
                local_5c = (uint32_t)CONCAT71((int7)(uVar8 >> 8),1);
                if (local_e0 != (int64_t *)0x0) {
                  local_138 = local_c8;
                  local_130 = '\0';
      ...
      fVar23 = (float)(**(code **)(**(int64_t **)(this_ptr + 0x88) + 0xae0))();
      if (g_023908ec <= fVar23) {
        (**(code **)(**(int64_t **)(this_ptr + 0x88) + 0xb10))(fVar23,9);
