...
uint64_t FUN_00ed726a(uint64_t *param_1,uint64_t *param_2)

{
  ...
  if (*(int *)(this_ptr + 300) == 0) {
      ...
      if (uVar16 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(this_ptr + 0x40 + uVar13 * 4) =
               (int)((*(int64_t *)(lVar4 + 8 + local_158) * -0x30e4432345000000 ^ uVar14) >>
                    (bVar12 & 0x3f));
      ...
      if (uVar21 - 0x20 < uVar16) {
        ...
        do {
          *(int *)(this_ptr + 0x40 + (uint64_t)((uint)uVar14 & 7) * 4) =
               (int)((*(int64_t *)(lVar4 + uVar14) * -0x30e4432345000000 ^ uVar10) >>
                    (bVar15 & 0x3f));
          uVar14 = uVar14 + 1;
        } while (uVar16 != uVar14);
      }
    ...
    if ((uint)local_158 < uVar21) {
      ...
      do {
        ...
        *(int *)(this_ptr + 0x40 + uVar10 * 4) =
             (int)((*(int64_t *)(lVar1 + 8 + local_158) * -0x30e4432345000000 ^
    ...
    *(int *)(this_ptr + 0x40 + (uint64_t)(uVar21 & 7) * 4) =
         (int)((*(int64_t *)((uVar22 & 0xffffffff) + 8 + lVar4) * -0x30e4432345000000 ^ uVar9) >>
              (bVar12 & 0x3f));
  }
  else {
    uVar22 = *arg1;
