...
uint64_t FUN_0190f4e0(void* param_1)

{
  ...
  iVar13 = *(int *)(*(int64_t *)(this_ptr + 0x78) + 0x18);
  uVar10 = (uint64_t)iVar13;
  if ((int64_t)uVar10 < 0x30) {
    uVar12 = 0;
    goto LAB_0190facf;
  }
  if (iVar13 - 0x30U < 0x18) {
    pdVar2 = *(double **)(*(int64_t *)(this_ptr + 0x78) + 0x10);
    uVar12 = 0;
...
LAB_0190f7bf:
    ...
    if (uVar12 != local_40) {
      ...
      if (local_38 == '\0') {
        ...
        FUN_00d50b00();
        uVar10 = *(uint64_t *)(this_ptr + 0x80);
        *(uint64_t *)(this_ptr + 0x80) = local_40;
      }
      else {
        local_38 = '\0';
LAB_0190f80d:
        *(uint64_t *)(this_ptr + 0x80) = uVar8;
        uVar10 = uVar12;
      }
      if (uVar10 != 0) {
        FUN_00d50b20();
    ...
    if ((lVar3 != 0) && (0x17 < *(int *)(lVar3 + 0x18))) {
      ...
      do {
        pVar9 = (void*)uVar10;
        if (*(char *)(*(int64_t *)(lVar3 + 0x10) + lVar11) != '\0') {
          uVar1 = *(void*)(*(int64_t *)(lVar3 + 0x10) + -0x10 + lVar11);
        ...
        iVar13 = iVar13 + 1;
        uVar10 = (uint64_t)(int64_t)*(int *)(lVar3 + 0x18) >> 0x3f;
        lVar11 = lVar11 + 0x18;
    ...
    uVar8 = 2;
    if (2 < iVar13 / 0x18) {
      uVar8 = (uint64_t)(uint)(iVar13 / 0x18);
    }
    uVar12 = 0;
    if ((0.0 < pdVar2[3] - *pdVar2) && (0.0 < pdVar2[4] - pdVar2[1])) {
      ...
      do {
        ...
        uVar10 = *(uint64_t *)(*(int64_t *)(this_ptr + 0x78) + 0x10);
