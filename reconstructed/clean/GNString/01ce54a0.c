...

{
  ...
  *(int64_t *)(this_ptr + 0x38) = *arg1;
  ...
  FUN_01d95060();
  (**(code **)(**(int64_t **)(this_ptr + 0x30) + 0x4d0))(0);
  FUN_01d97870();
  ...
  *(void*)(puVar6 + 0xb) = 0;
  (*g_02692480)();
  FUN_01db96b0(uVar8);
  (**(code **)(**(int64_t **)(this_ptr + 0x38) + 0x920))();
  FUN_00d51d20();
  local_70 = local_40;
  local_68 = 0;
  if (local_38 == '\0') {
  ...
  (**(code **)(**(int64_t **)(this_ptr + 0x38) + 0x928))();
  FUN_01db99b0();
  plVar5 = (int64_t *)FUN_00e8fc40();
  FUN_001932c0();
  (**(code **)(*plVar5 + 0x18))();
  ...
  FUN_01dcbe90();
  (**(code **)(**(int64_t **)(this_ptr + 0x28) + 0x4d0))(0,uVar8);
  ...
  FUN_01de0990();
  FUN_01de09a0();
  if (*(char *)(*(int64_t *)(this_ptr + 0x38) + 0x181) != '\0') {
    FUN_01dcc2e0();
  }
  FUN_01dca0e0();
  FUN_01dcea50();
  ...
  if (*(char *)(*(int64_t *)(this_ptr + 0x38) + 0x18b) == '\0') goto LAB_01ce5c38;
  FUN_01dcc4e0();
  plVar1 = *(int64_t **)(*(int64_t *)(this_ptr + 0x38) + 0x138);
  if (plVar1 == (int64_t *)0x0) goto LAB_01ce5c38;
  (**(code **)(*plVar1 + 0x10))();
  FUN_00d50b00();
  (**(code **)(*plVar1 + 0x10))();
  FUN_00d50b20();
  local_118 = *(int64_t *)(this_ptr + 0x38);
  plVar1 = *(int64_t **)(local_118 + 0x138);
  if (plVar1 != (int64_t *)0x0) {
    (**(code **)(*plVar1 + 0x10))();
    FUN_00d50b00();
    local_118 = *(int64_t *)(this_ptr + 0x38);
...
LAB_01ce5c38:
  if (*(char *)(*arg1 + 0x188) != '\0') {
    ...
    *(void*)((int64_t)puVar6 + 0x199) = 0;
    ...
    puVar6[0x3a] = 0;
    *(void*)(puVar6 + 0x3b) = 0;
    *(void*)((int64_t)puVar6 + 0x1ef) = 0;
    puVar6[0x3d] = 0;
    *puVar6 = &g_02676e38;
    puVar6[2] = &g_02677978;
    puVar6[0x3c] = &g_026779b8;
    puVar6[0x3f] = 0;
    *(void*)(puVar6 + 0x40) = 0;
    FUN_00d500e0();
    local_100 = '\0';
