...

{
  ...
  for (lVar21 = *(int64_t *)(this_ptr + 8); lVar21 != *(int64_t *)(this_ptr + 0x10);
      lVar21 = lVar21 + 1) {
  ...
  for (lVar21 = *(int64_t *)(this_ptr + 0x20); lVar21 != *(int64_t *)(this_ptr + 0x28);
      lVar21 = lVar21 + 1) {
    iVar1 = (**(code **)(*arg1 + 0x80))();
    iVar5 = iVar5 + iVar1;
  }
