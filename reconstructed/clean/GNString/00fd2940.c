...
void FUN_00fd2940(uint64_t param_1,int param_2)

{
  ...
  local_d4 = this_ptr[0x19] + local_54;
  local_d0 = this_ptr[0x1a] + local_50;
  iStack_cc = this_ptr[0x1b] + iStack_4c;
  iStack_c8 = this_ptr[0x1c] + iStack_48;
  iStack_c4 = this_ptr[0x1d] + iStack_44;
  local_c0 = this_ptr[0x1e] + local_40;
  local_bc = this_ptr[0x1f] + local_3c;
  auVar18._4_4_ = iVar1;
  auVar18._0_4_ = iVar1;
  ...
  uVar2 = (this_ptr[0x19] - local_54) + 0x1ffffffe;
  auVar8._0_4_ = (this_ptr[0x1a] - local_50) + g_023fa9d0;
  ...
  uVar4 = (this_ptr[0x1e] - local_40) + 0x1ffffffe;
  ...
  auVar7 = *(uint8_t (*) [16])(this_ptr + 8);
  auVar8 = *(uint8_t (*) [16])(this_ptr + 0xc);
  this_ptr[0x10] = *this_ptr + this_ptr[0x20];
  this_ptr[0x11] = this_ptr[1] + this_ptr[0x21];
  this_ptr[0x12] = this_ptr[2] + this_ptr[0x22];
  this_ptr[0x13] = this_ptr[3] + this_ptr[0x23];
  this_ptr[0x14] = this_ptr[0x24] + this_ptr[4];
  this_ptr[0x15] = this_ptr[0x25] + this_ptr[5];
  this_ptr[0x16] = this_ptr[0x26] + this_ptr[6];
  this_ptr[0x17] = this_ptr[0x27] + this_ptr[7];
  this_ptr[0x18] = this_ptr[0x28] + auVar7._0_4_;
  this_ptr[0x19] = this_ptr[0x29] + auVar7._4_4_;
  this_ptr[0x1a] = this_ptr[0x2a] + auVar7._8_4_;
  this_ptr[0x1b] = this_ptr[0x2b] + auVar7._12_4_;
  this_ptr[0x1c] = this_ptr[0x2c] + auVar8._0_4_;
  this_ptr[0x1d] = this_ptr[0x2d] + auVar8._4_4_;
  this_ptr[0x1e] = this_ptr[0x2e] + auVar8._8_4_;
  this_ptr[0x1f] = this_ptr[0x2f] + auVar8._12_4_;
  uVar6 = FUN_00fd1300();
  uVar6 = _gf_mul(uVar6,this_ptr + 0x10);
