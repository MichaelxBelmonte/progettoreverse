...
uint64_t FUN_00eedae7(uint64_t *param_1,uint64_t *param_2)

{
  ...
  uVar28 = *arg1 * -0x30e4432345000000 >> (0x42U - *(char *)(puVar6 + 0x21) & 0x3f);
  ...
  if (*(int *)(this_ptr + 300) == 0) {
      ...
      if (uVar35 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(this_ptr + 0x40 + uVar14 * 4) =
               (int)((*(int64_t *)(lVar16 + 8 + uVar21) * -0x30e4432345000000 ^ uVar15) >>
                    (bVar26 & 0x3f));
    ...
    if ((uint)uVar21 < uVar36) {
      ...
      do {
        ...
        *(int *)(this_ptr + 0x40 + uVar32 * 4) =
             (int)((*(int64_t *)(lVar19 + 8 + uVar21) * -0x30e4432345000000 ^
    ...
    *(int *)(this_ptr + 0x40 + (uint64_t)(uVar36 & 7) * 4) =
         (int)((*(int64_t *)((uVar38 & 0xffffffff) + 8 + lVar16) * -0x30e4432345000000 ^ uVar11) >>
              (bVar26 & 0x3f));
  }
  else {
    uVar35 = (uint)((*arg1 * -0x30e4432345000000 ^ uVar11) >> (0x38U - cVar39 & 0x3f));
    *(uint *)(this_ptr + 0x2c) = uVar36;
  }
...
LAB_00eee238:
        ...
        if ((uVar38 < uVar15) &&
           ...
           (uint64_t *)((int64_t)arg1 + uVar15) == param_2)) goto LAB_00eee592;
      }
      uVar32 = uVar32 + 1;
    } while (uVar32 != uVar11);
  }
