...

{
  ...
  iVar29 = (**(code **)(*arg1 + 0x30))(0x12,8);
  iVar30 = (**(code **)(*arg1 + 0x90))();
  ...
  iVar38 = (**(code **)(*arg1 + 0x30))(0x15,8);
  iVar39 = (**(code **)(*arg1 + 0x90))();
  iVar40 = (**(code **)(*arg1 + 0x38))();
  iVar41 = (**(code **)(*arg1 + 0x30))(0x16,8);
  iVar42 = (**(code **)(*arg1 + 0x90))();
  ...
  iVar50 = (**(code **)(*arg1 + 0x30))(0x19,0xf);
  iVar51 = (**(code **)(*arg1 + 0x58))();
  ...
  for (plVar52 = *(int64_t **)(this_ptr + 0xd0); plVar52 != *(int64_t **)(this_ptr + 0xd8);
      plVar52 = plVar52 + 4) {
  ...
  iVar3 = (**(code **)(*arg1 + 0x30))(0x1a,0xf);
  iVar4 = (**(code **)(*arg1 + 0x58))();
  iVar4 = iVar1 + iVar51 + iVar2 + iVar3 + iVar4;
  for (plVar52 = *(int64_t **)(this_ptr + 0xe8); plVar52 != *(int64_t **)(this_ptr + 0xf0);
      plVar52 = plVar52 + 4) {
    iVar1 = (**(code **)(*plVar52 + 0x18))();
    iVar4 = iVar4 + iVar1;
  }
