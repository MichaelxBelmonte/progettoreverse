...
uint64_t FUN_00ed7900(uint64_t *param_1,uint64_t *param_2)

{
  ...
  if (*(int *)(this_ptr + 300) == 0) {
      ...
      if (uVar7 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(this_ptr + 0x40 + uVar12 * 4) =
               (int)((*(int64_t *)(lVar2 + 8 + uVar8) * -0x30e4432340650000 ^ uVar13) >>
                    (bVar10 & 0x3f));
      ...
      if (uVar22 - 0x20 < uVar7) {
        ...
        do {
          *(int *)(this_ptr + 0x40 + (uint64_t)((uint)uVar13 & 7) * 4) =
               (int)((*(int64_t *)(lVar2 + uVar13) * -0x30e4432340650000 ^ uVar16) >>
                    (bVar14 & 0x3f));
          uVar13 = uVar13 + 1;
        } while (uVar7 != uVar13);
      }
    ...
    if ((uint)uVar8 < uVar22) {
      ...
      do {
        ...
        *(int *)(this_ptr + 0x40 + uVar16 * 4) =
             (int)((*(int64_t *)(lVar4 + 8 + uVar8) * -0x30e4432340650000 ^
    ...
    *(int *)(this_ptr + 0x40 + (uint64_t)(uVar22 & 7) * 4) =
         (int)((*(int64_t *)((uVar23 & 0xffffffff) + 8 + lVar2) * -0x30e4432340650000 ^ uVar17) >>
              (bVar10 & 0x3f));
  }
  else {
    uVar23 = *arg1;
