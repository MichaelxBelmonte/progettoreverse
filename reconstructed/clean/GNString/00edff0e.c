...
uint64_t FUN_00edff0e(uint64_t *param_1,uint64_t *param_2)

{
  ...
  if (*(int *)(this_ptr + 300) == 0) {
      ...
      if (uVar24 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(this_ptr + 0x40 + uVar14 * 4) =
               (int)((*(int64_t *)(lVar4 + 8 + uVar9) * -0x30e4432340650000 ^ uVar21) >>
                    (bVar10 & 0x3f));
      ...
      if (uVar31 - 0x20 < uVar24) {
        ...
        do {
          *(int *)(this_ptr + 0x40 + (uint64_t)((uint)uVar29 & 7) * 4) =
               (int)((*(int64_t *)(lVar4 + uVar29) * -0x30e4432340650000 ^ uVar21) >>
                    (bVar16 & 0x3f));
          uVar29 = uVar29 + 1;
        } while (uVar24 != uVar29);
      }
    ...
    if ((uint)uVar9 < uVar31) {
      ...
      do {
        ...
        *(int *)(this_ptr + 0x40 + uVar21 * 4) =
             (int)((*(int64_t *)(lVar19 + 8 + uVar9) * -0x30e4432340650000 ^
    ...
    *(int *)(this_ptr + 0x40 + (uint64_t)(uVar31 & 7) * 4) =
         (int)((*(int64_t *)((uVar32 & 0xffffffff) + 8 + lVar4) * -0x30e4432340650000 ^ uVar26) >>
              (bVar10 & 0x3f));
  }
  else {
    uVar32 = *arg1;
