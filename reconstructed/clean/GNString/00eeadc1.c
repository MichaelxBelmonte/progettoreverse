...
uint64_t FUN_00eeadc1(uint64_t *param_1,uint64_t *param_2)

{
  ...
  do {
    ...
    uVar23 = (uint64_t)(*(int64_t *)(lVar17 + uVar25) * -0x30e4432340650000) >> (bVar19 & 0x3f);
...
LAB_00eeb531:
      ...
      if ((uVar25 < uVar35) &&
         ...
         (uint64_t *)((int64_t)arg1 + uVar35) == param_2)) goto LAB_00eeaf73;
    }
    if ((uVar11 <= uVar34) ||
