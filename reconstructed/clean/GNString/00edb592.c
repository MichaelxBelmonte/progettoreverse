...
uint64_t FUN_00edb592(uint64_t *param_1,uint64_t *param_2)

{
  ...
  if (arg1 < (int64_t *)(uVar20 + lVar5)) {
    ...
    if (*(uint *)(this_ptr + 0x2c) < uVar23) {
      do {
        uVar28 = (uint64_t)(*(int64_t *)(lVar5 + uVar20) * -0x30e4432340650000) >> (bVar32 & 0x3f)
        ;
    ...
    *(uint *)(this_ptr + 0x2c) = uVar23;
    uVar20 = (uint64_t)(*arg1 * -0x30e4432340650000) >> (bVar32 & 0x3f);
...
LAB_00edbef4:
        ...
        if (uVar20 < uVar42) {
          ...
          if ((uint64_t *)((int64_t)arg1 + uVar42) == param_2) goto LAB_00edc25d;
        }
