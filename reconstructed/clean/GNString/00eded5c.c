...
uint64_t FUN_00eded5c(uint64_t *param_1,uint64_t *param_2)

{
  ...
  if (*(int *)(this_ptr + 300) == 0) {
      ...
      if (uVar19 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(this_ptr + 0x40 + uVar16 * 4) =
               (int)((*(int64_t *)(lVar4 + 8 + uVar11) * -0x30e4432345000000 ^ uVar23) >>
                    (bVar12 & 0x3f));
      ...
      if (uVar31 - 0x20 < uVar19) {
        ...
        do {
          *(int *)(this_ptr + 0x40 + (uint64_t)((uint)uVar29 & 7) * 4) =
               (int)((*(int64_t *)(lVar4 + uVar29) * -0x30e4432345000000 ^ uVar23) >>
                    (bVar18 & 0x3f));
          uVar29 = uVar29 + 1;
        } while (uVar19 != uVar29);
      }
    ...
    if ((uint)uVar11 < uVar31) {
      ...
      do {
        ...
        *(int *)(this_ptr + 0x40 + uVar23 * 4) =
             (int)((*(int64_t *)(lVar21 + 8 + uVar11) * -0x30e4432345000000 ^
    ...
    *(int *)(this_ptr + 0x40 + (uint64_t)(uVar31 & 7) * 4) =
         (int)((*(int64_t *)((uVar32 & 0xffffffff) + 8 + lVar4) * -0x30e4432345000000 ^ uVar9) >>
              (bVar12 & 0x3f));
  }
  else {
    uVar32 = *arg1;
