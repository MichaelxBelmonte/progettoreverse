...
void FUN_010c8a20(uint64_t param_1,uint64_t param_2,int *param_3,uint *param_4)

{
  ...
  if (*(int *)(this_ptr + 0x158) != 0) {
    return;
  }
  _CRYPTO_THREAD_write_lock();
  if ((*(byte *)(this_ptr + 0xe1) & 1) != 0) {
    _CRYPTO_THREAD_unlock();
    return;
  }
  puVar1 = (uint *)(this_ptr + 0xe0);
  _EVP_sha1();
  iVar4 = _X509_digest((X509 *)0x0,(EVP_MD *)(this_ptr + 0x130),(uchar *)param_3,param_4);
  if (iVar4 == 0) {
  ...
  if (piVar7 == (int *)0x0) {
    ...
    if (*(int64_t *)(piVar7 + 2) == 0) {
      *(void*)(this_ptr + 0xd0) = 0xffffffffffffffff;
    }
    else {
      if (*(int *)(*(int64_t *)(piVar7 + 2) + 4) != 0x102) {
        lVar5 = _ASN1_INTEGER_get(a);
        *(int64_t *)(this_ptr + 0xd0) = CONCAT44(extraout_var,lVar5);
        if ((*piVar7 != 0) || (CONCAT44(extraout_var,lVar5) == 0)) goto LAB_010c8b50;
      }
      *(byte *)(this_ptr + 0xe0) = *(byte *)(this_ptr + 0xe0) | 0x80;
  ...
  if (piVar7 == (int *)0x0) {
    ...
    if (iVar4 < 1) {
      *(void*)(this_ptr + 0xe4) = 0;
      ...
      bVar2 = *pbVar3;
      pAVar14 = (ASN1_BIT_STRING *)(uint64_t)bVar2;
      *(uint *)(this_ptr + 0xe4) = (uint)bVar2;
      if (iVar4 != 1) {
        *(uint *)(this_ptr + 0xe4) = (uint)CONCAT11(pbVar3[1],bVar2);
      }
    }
    ...
    *(byte *)puVar1 = *(byte *)puVar1 | 4;
    ...
    if (0 < iVar4) {
      do {
        ...
        pAVar15 = (ASN1_OBJECT *)(uint64_t)(iVar4 - 0x81U);
        if (0x33 < iVar4 - 0x81U) {
          pAVar16 = pAVar15;
          if (iVar4 == 0x129) {
            uVar12 = 0x80;
        ...
        uVar12 = 1;
        pAVar16 = (ASN1_OBJECT *)
                  ((int64_t)&switchD_010c8cf6::switchdataD_010c9148 +
                  (int64_t)(int)(&switchD_010c8cf6::switchdataD_010c9148)[(int64_t)pAVar15]);
        switch(pAVar15) {
...
switchD_010c8cf6_caseD_81:
        *(uint *)(this_ptr + 0xe8) = *(uint *)(this_ptr + 0xe8) | uVar12;
switchD_010c8cf6_caseD_86:
  ...
  if (piVar7 == (int *)0x0) {
    ...
    *(uint *)(this_ptr + 0xec) = uVar12;
    *(byte *)(this_ptr + 0xe0) = *(byte *)(this_ptr + 0xe0) | 8;
    _ASN1_BIT_STRING_free(pAVar14);
  }
  pvVar10 = _X509_get_ext_d2i((X509 *)0x0,(int)&local_34,param_3,(int *)param_4);
  *(void **)(this_ptr + 0xf0) = pvVar10;
  ...
  *(void **)(this_ptr + 0xf8) = pvVar10;
  ...
  if (iVar4 == 0) {
    *(byte *)(this_ptr + 0xe0) = *(byte *)(this_ptr + 0xe0) | 0x20;
    iVar4 = _X509_check_akid();
    if (iVar4 == 0) {
      _X509_get0_pubkey();
      iVar4 = FUN_010c9b00();
      if (iVar4 == 0) {
        *(byte *)(this_ptr + 0xe1) = *(byte *)(this_ptr + 0xe1) | 0x20;
      }
    }
  }
  pvVar10 = _X509_get_ext_d2i((X509 *)0x0,(int)&local_34,param_3,(int *)param_4);
  *(void **)(this_ptr + 0x110) = pvVar10;
  if ((pvVar10 == (void *)0x0) && (local_34 != -1)) {
    *(byte *)puVar1 = *(byte *)puVar1 | 0x80;
  }
  pvVar10 = _X509_get_ext_d2i((X509 *)0x0,(int)&local_34,param_3,(int *)param_4);
  *(void **)(this_ptr + 0x118) = pvVar10;
  if ((pvVar10 == (void *)0x0) && (local_34 != -1)) {
    *(byte *)puVar1 = *(byte *)puVar1 | 0x80;
  }
  pXVar13 = (X509 *)0x0;
  pvVar10 = _X509_get_ext_d2i((X509 *)0x0,(int)&local_38,param_3,(int *)param_4);
  *(void **)(this_ptr + 0x108) = pvVar10;
      ...
      do {
        ...
        if (piVar7 == (int *)0x0) {
          *(void*)(puVar11 + 3) = 0x807f;
          ...
          pXVar13 = (X509 *)(uint64_t)(uVar12 & 0x807f);
        ...
        if ((piVar7 != (int *)0x0) && (*piVar7 == 1)) {
          ...
          if (0 < iVar4) {
            ...
            do {
              ...
              if (*piVar7 == 4) {
                if (*(int64_t *)(piVar7 + 2) != 0) goto LAB_010c903b;
                break;
              }
              iVar4 = iVar4 + 1;
  ...
  *(void **)(this_ptr + 0x128) = pvVar10;
  ...
  if (0 < iVar4) {
    do {
      ...
      if (iVar4 == 0x359) {
        *(byte *)(this_ptr + 0xe1) = *(byte *)(this_ptr + 0xe1) | 0x10;
      }
...
LAB_010c8f60:
  ...
  _x509_init_sig_info();
  *(byte *)(this_ptr + 0xe1) = *(byte *)(this_ptr + 0xe1) | 1;
  *(void*)(this_ptr + 0x158) = 1;
  _CRYPTO_THREAD_unlock();
  return;
}
