...
int FUN_00ab3c9e(uint64_t param_1,uint64_t param_2,uint64_t param_3,uint64_t param_4)

{
  ...
  do {
    ...
    case 0x12:
      if (local_48 == 0xf) {
        *(void*)(this_ptr + 0x98) = *(void*)(this_ptr + 0x90);
        iVar1 = (**(code **)(*arg1 + 0xf8))(&switchD_00ab3e2e::switchdataD_00ab46f8,&local_34);
    ...
    case 0x1b:
      if (local_48 == 0xf) {
        lVar6 = *(int64_t *)(this_ptr + 0x140);
        uVar9 = extraout_XMM0_Da;
        for (lVar5 = *(int64_t *)(this_ptr + 0x148); lVar5 != lVar6; lVar5 = lVar5 + -0x20) {
          uVar9 = (***(void**)(lVar5 + -0x20))();
        }
        *(int64_t *)(this_ptr + 0x148) = lVar6;
        iVar1 = (**(code **)(*arg1 + 0xf8))(uVar9,&local_34);
        FUN_00a63e90();
        iVar1 = iVar1 + iVar2;
        if (local_34 != 0) {
          ...
          uVar8 = 0;
          do {
            iVar2 = (**(code **)(*(int64_t *)(*(int64_t *)(this_ptr + 0x140) + lVar6) + 0x10))();
            iVar1 = iVar1 + iVar2;
            uVar8 = uVar8 + 1;
            lVar6 = lVar6 + 0x20;
          } while (uVar8 < local_34);
    ...
    case 0x1c:
      if (local_48 == 0xf) {
        lVar6 = *(int64_t *)(this_ptr + 0x158);
        uVar9 = extraout_XMM0_Da;
        for (lVar5 = *(int64_t *)(this_ptr + 0x160); lVar5 != lVar6; lVar5 = lVar5 + -0x20) {
          uVar9 = (***(void**)(lVar5 + -0x20))();
        }
        *(int64_t *)(this_ptr + 0x160) = lVar6;
        iVar1 = (**(code **)(*arg1 + 0xf8))(uVar9,&local_34);
        FUN_00a63e90();
        iVar1 = iVar1 + iVar2;
        if (local_34 != 0) {
          ...
          uVar8 = 0;
          do {
            iVar2 = (**(code **)(*(int64_t *)(*(int64_t *)(this_ptr + 0x158) + lVar6) + 0x10))();
            iVar1 = iVar1 + iVar2;
            uVar8 = uVar8 + 1;
            lVar6 = lVar6 + 0x20;
          } while (uVar8 < local_34);
