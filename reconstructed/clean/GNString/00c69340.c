...
int FUN_00c69340(int param_1,uint64_t param_2,uint64_t param_3,uint64_t param_4)

{
  ...
  auVar28 = g_023dbf10;
  local_88 = *(void*)arg1[1];
  local_98 = *arg1;
  sVar4 = *(short *)(this_ptr + 8);
  uVar17 = (uint)sVar4;
  local_78 = (uint64_t)uVar17;
  ...
  uVar21 = *(uint *)(&g_0000205c + this_ptr);
  ...
  case 0:
    ...
    if (local_34 < 8) {
      ...
      uVar8 = 0;
      if (param_1 == 1) {
        uVar24 = (uint64_t)(local_34 & 0xfffffff8);
        uVar19 = (uVar24 - 8 >> 3) + 1;
        uVar17 = 0;
        if (uVar24 - 8 == 0) {
          uVar8 = 0;
          auVar28 = local_98;
LAB_00c694d2:
          auVar28 = pmovsxwd(auVar28,*(void*)(param_2 + (uVar8 & 0xffffffff) * 2));
          auVar29 = pmovsxwd(in_XMM1,*(void*)(param_2 + 8 + (uVar8 & 0xffffffff) * 2));
          *(uint8_t (*) [16])(lVar9 + uVar8 * 4) = auVar28;
          *(uint8_t (*) [16])(lVar9 + 0x10 + uVar8 * 4) = auVar29;
        }
        else {
          ...
          auVar28 = local_98;
          do {
            auVar28 = pmovsxwd(auVar28,*(void*)(param_2 + (uint64_t)uVar17 * 2));
            auVar29 = pmovsxwd(in_XMM1,*(void*)(param_2 + 8 + (uint64_t)uVar17 * 2));
            *(uint8_t (*) [16])(lVar9 + uVar8 * 4) = auVar28;
            *(uint8_t (*) [16])(lVar9 + 0x10 + uVar8 * 4) = auVar29;
            auVar28 = pmovsxwd(auVar28,*(void*)(param_2 + (uint64_t)(uVar17 + 8) * 2));
            in_XMM1 = pmovsxwd(auVar29,*(void*)(param_2 + 8 + (uint64_t)(uVar17 + 8) * 2));
            *(uint8_t (*) [16])(lVar9 + 0x20 + uVar8 * 4) = auVar28;
            *(uint8_t (*) [16])(lVar9 + 0x30 + uVar8 * 4) = in_XMM1;
            uVar8 = uVar8 + 0x10;
            uVar17 = uVar17 + 0x10;
            lVar25 = lVar25 + 2;
          } while (lVar25 != 0);
        ...
        uVar8 = (uint64_t)(local_34 & 0xfffffff8);
      }
    }
    uVar19 = param_4 & 0xffffffff;
    uVar20 = ~uVar24;
    for (param_4 = param_4 & 3; param_4 != 0; param_4 = param_4 - 1) {
      *(int *)(lVar9 + uVar24 * 4) = (int)*(short *)(param_2 + uVar8 * 2);
      uVar24 = uVar24 + 1;
      uVar8 = (uint64_t)(uint)((int)uVar8 + param_1);
    }
    if (2 < uVar20 + uVar22) {
      do {
        iVar6 = (int)uVar8;
        ...
        *(int *)(lVar9 + 4 + uVar24 * 4) =
             (int)*(short *)(param_2 + (uint64_t)(uint)(iVar6 + param_1) * 2);
        *(int *)(lVar9 + 8 + uVar24 * 4) =
             (int)*(short *)(param_2 + (uint64_t)(uint)(param_1 * 2 + iVar6) * 2);
        *(int *)(lVar9 + 0xc + uVar24 * 4) =
             (int)*(short *)(param_2 + (uint64_t)(uint)(iVar6 + param_1 * 3) * 2);
        uVar24 = uVar24 + 4;
        uVar8 = (uint64_t)(uint)(iVar6 + param_1 + param_1 * 3);
      } while (uVar22 != uVar24);
    }
    break;
  case 1:
    FUN_00c6d730(uVar22,*(void*)(this_ptr + 0x20));
    uVar19 = (uint64_t)local_34;
    break;
  case 2:
    FUN_00c6d7e0(uVar22,*(void*)(this_ptr + 0x20));
    auVar28 = g_023dbf10;
    uVar19 = (uint64_t)local_34;
    if (local_34 == 0) break;
    lVar9 = *(int64_t *)(this_ptr + 0x20);
    lVar25 = *(int64_t *)(this_ptr + 0x40);
    if (local_34 < 8) {
      uVar22 = 0;
    }
    else {
      uVar22 = (uint64_t)(local_34 & 0xfffffff8);
      ...
      if (uVar22 - 8 == 0) {
        lVar15 = 0;
LAB_00c69689:
        auVar28 = *(uint8_t (*) [16])(lVar9 + lVar15 * 4);
        auVar3 = *(uint8_t (*) [16])(lVar9 + 0x10 + lVar15 * 4);
        auVar31 = pshufb(auVar28 & auVar30,g_023dbf10);
        auVar30 = pshufb(auVar30 & auVar3,g_023dbf10);
        puVar1 = (void*)(lVar25 + lVar15 * 2);
        ...
        *piVar2 = auVar3._0_4_ >> auVar29;
        ...
        lVar15 = 0;
        do {
          auVar3 = *(uint8_t (*) [16])(lVar9 + lVar15 * 4);
          auVar31 = *(uint8_t (*) [16])(lVar9 + 0x10 + lVar15 * 4);
          ...
          *piVar2 = auVar31._0_4_ >> auVar29;
          ...
          auVar3 = *(uint8_t (*) [16])(lVar9 + 0x20 + lVar15 * 4);
          auVar31 = *(uint8_t (*) [16])(lVar9 + 0x30 + lVar15 * 4);
          auVar32 = pshufb(auVar3 & auVar30,auVar28);
          auVar33 = pshufb(auVar31 & auVar30,auVar28);
          puVar1 = (void*)(lVar25 + 0x10 + lVar15 * 2);
          *puVar1 = auVar32._0_8_;
          puVar1[1] = auVar33._0_8_;
  ...
  case 4:
    if (local_34 != 0) {
      uVar24 = *(uint64_t *)(this_ptr + 0x20);
      lVar9 = *(int64_t *)(this_ptr + 0x40);
      uVar8 = 0;
      if (local_34 < 8) {
        uVar17 = 0;
      }
        ...
        if (param_1 == 1) {
          if ((uVar24 < param_2 + uVar22 * 4) && (param_2 < uVar24 + uVar22 * 4)) {
            ...
            uVar19 = 0;
            do {
              auVar3 = *(uint8_t (*) [16])(param_2 + (uint64_t)uVar26 * 4);
              auVar31 = *(uint8_t (*) [16])(param_2 + 0x10 + (uint64_t)uVar26 * 4);
              auVar32 = pshufb(auVar3 & auVar29,auVar28);
              auVar33 = pshufb(auVar31 & auVar29,auVar28);
              *(void*)(lVar9 + uVar19) = auVar32._0_8_;
              ((void*)(lVar9 + uVar19))[1] = auVar33._0_8_;
      ...
      uVar20 = ~uVar8;
      if ((param_4 & 1) != 0) {
        iVar6 = *(int *)(param_2 + (uint64_t)uVar17 * 4);
      ...
      if (uVar20 + uVar22 != 0) {
        do {
          ...
          *(ushort *)(lVar9 + uVar8 * 2) = (ushort)iVar6 & uVar11;
          *(int *)(uVar24 + uVar8 * 4) = iVar6 >> sVar10;
          iVar6 = *(int *)(param_2 + (uint64_t)(uVar17 + param_1) * 4);
...
switchD_00c6940e_caseD_3:
  ...
  if (iVar6 == 0) {
    ...
    FUN_00c66620(uVar12,*(void*)(&g_00002060 + this_ptr));
    lVar25 = lVar9 + this_ptr + 0x130;
    ...
    if (iVar6 == 0) {
      ...
      uVar14 = iVar13 + (int)*(short *)(this_ptr + 8) * local_34 + 0x10;
      iVar6 = 0;
      if (iVar7 + iVar13 + uVar5 < uVar14) {
        ...
        uVar17 = local_34;
        uVar27 = FUN_00c6b580(local_80 + lVar9 + this_ptr + 0x50,local_34,uVar26,iVar18);
        FUN_00c65960(uVar27,uVar17);
        pcVar16 = (char *)(uint64_t)uVar17;
        iVar6 = FUN_00c65f80(pcVar16,arg1,iVar18,&local_3c);
        iVar18 = FUN_00c66700();
        iVar7 = FUN_00c66700();
        if ((uint)(iVar18 - iVar7) < uVar14) {
          return iVar6;
        }
        *(void*)arg1[1] = local_88;
        *(void*)*arg1 = local_98._0_8_;
        *(void*)(*arg1 + 8) = local_98._8_8_;
        _printf(pcVar16);
      }
      uVar27 = FUN_00c667a0();
      ...
      case 0:
        ...
        break;
      case 1:
        uVar27 = FUN_00c6d730(local_34,*(void*)(this_ptr + 0x20));
        if (local_34 != 0) {
          uVar19 = (uint64_t)local_34;
          uVar22 = 0;
          do {
        ...
        break;
      case 2:
        uVar27 = FUN_00c6d7e0(local_34,*(void*)(this_ptr + 0x20));
        if (local_34 != 0) {
          uVar19 = (uint64_t)local_34;
          uVar22 = 0;
          do {
