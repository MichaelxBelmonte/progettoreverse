...
void FUN_0191b980(uint64_t param_1)

{
  ...
  if (this_ptr[0x4b] != 0) {
    ...
    if (local_48 == 0) {
      ...
      if (local_40 == '\0') {
        uVar3 = FUN_00d50b00();
        local_34 = (uint)CONCAT71((int7)((uint64_t)uVar3 >> 8),1);
...
LAB_0191ba6a:
    ...
    if (bVar13) {
      local_e4 = (uint32_t)CONCAT71((int7)((uint64_t)param_1 >> 8),1);
      local_58 = 0;
      local_50 = (void*)0x0;
    }
    else {
...
LAB_0191bce3:
    ...
    uVar14 = (**(code **)(*this_ptr + 0xad8))();
    if (local_48 == 0) {
      bVar13 = false;
    }
    else {
      (**(code **)(*this_ptr + 0xad8))();
      uVar3 = (**(code **)((int64_t)&dylib_command_00001220.cmd + *local_188))();
      lVar8 = local_e0;
...
LAB_0191c01d:
        local_d8 = '\0';
        lVar9 = lVar8;
        uVar10 = (int)CONCAT71((int7)((uint64_t)uVar3 >> 8),1);
      }
      local_34 = uVar10;
      bVar13 = lVar9 != 0;
    ...
    lVar7 = local_48;
    uVar5 = (undefined7)((uint64_t)lVar8 >> 8);
    if (local_48 == lVar9) {
      lVar7 = lVar9;
      uVar10 = local_34;
...
LAB_0191c1a3:
    ...
    if (lVar7 != 0) {
      ...
      *(void*)(puVar4 + 0xe) = 0;
      ...
      else if (((char)local_58 != '\0') && (local_50 != (void*)0x0)) {
        FUN_00d50b20();
      }
      FUN_01d65230();
      local_90 = local_48;
    ...
    if (((char)local_58 != '\0') && (puVar4 != (void*)0x0)) {
      FUN_00d50b20();
    }
