...
uint64_t FUN_00ee9272(uint64_t *param_1,uint64_t *param_2)

{
  ...
  uVar10 = *arg1 * -0x30e4432340650000 >> (0x38U - *(char *)((int64_t)puVar6 + 0x34) & 0x3f);
  uVar12 = (uint64_t)((uint)(uVar10 >> 2) & 0x3fffffc0);
  lVar30 = *(int64_t *)(this_ptr + 0x70);
  lVar19 = *(int64_t *)(this_ptr + 0x38);
  uVar16 = *(uint *)(this_ptr + 0x18);
  uVar26 = *(uint64_t *)(this_ptr + 0x60);
  lVar37 = puVar6[7];
  lVar27 = puVar6[0xe];
  cVar8 = (char)*(void*)(this_ptr + 0x34);
  if (*(int *)(this_ptr + 300) == 0) {
    ...
    if (0x180 < uVar35 - uVar9) {
      if (uVar9 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(this_ptr + 0x40 + uVar13 * 4) =
               (int)((*(int64_t *)(lVar11 + 8 + uVar39) * -0x30e4432340650000 ^ uVar14) >>
                    (bVar34 & 0x3f));
          uVar14 = (uint64_t)(uVar9 >> 2) & 0x3fffffc0;
          bVar23 = *(char *)(lVar19 + uVar14) - 1U & 0x3f;
          lVar20 = 0;
          if (bVar23 == 0) {
            lVar20 = 0x3f;
          }
          lVar20 = (uint64_t)bVar23 + lVar20;
        ...
        lVar40 = *(int64_t *)(this_ptr + 0x70);
        bVar23 = 0x38 - (char)*(void*)(this_ptr + 0x34);
      }
      uVar39 = (uint64_t)(uVar35 - 0x20);
      uVar9 = 0;
      if (lVar11 + uVar39 <= (int64_t)arg1 + 1U) {
        uVar9 = ((int)((int64_t)arg1 + 1U) - (int)(lVar11 + uVar39)) + 1;
      }
      uVar18 = 8;
      if (uVar9 < 8) {
        uVar18 = uVar9;
      ...
      if (uVar35 - 0x20 < uVar9) {
        uVar24 = *(uint64_t *)(this_ptr + 0x60);
        uVar14 = uVar39;
        do {
          *(int *)(this_ptr + 0x40 + (uint64_t)((uint)uVar14 & 7) * 4) =
               (int)((*(int64_t *)(lVar11 + uVar14) * -0x30e4432340650000 ^ uVar24) >>
                    (bVar23 & 0x3f));
          uVar14 = uVar14 + 1;
        } while (uVar9 != uVar14);
      }
    ...
    if ((uint)uVar39 < uVar35) {
      ...
      do {
        uVar24 = (uint64_t)((uint)uVar39 & 7);
        uVar9 = *(uint *)(this_ptr + 0x40 + uVar24 * 4);
        *(int *)(this_ptr + 0x40 + uVar24 * 4) =
             (int)((*(int64_t *)(lVar7 + 8 + uVar39) * -0x30e4432340650000 ^
                   *(uint64_t *)(this_ptr + 0x60)) >> (bVar23 & 0x3f));
        uVar24 = (uint64_t)(uVar9 >> 2) & 0x3fffffc0;
        bVar17 = *(char *)(lVar20 + uVar24) - 1U & 0x3f;
        lVar29 = 0;
        if (bVar17 == 0) {
          lVar29 = 0x3f;
        }
        lVar29 = (uint64_t)bVar17 + lVar29;
    ...
    *(uint *)(this_ptr + 0x2c) = uVar35;
    uVar9 = *(uint *)(this_ptr + 0x40 + (uint64_t)(uVar35 & 7) * 4);
    *(int *)(this_ptr + 0x40 + (uint64_t)(uVar35 & 7) * 4) =
         (int)((*(int64_t *)((uVar36 & 0xffffffff) + 8 + lVar11) * -0x30e4432340650000 ^ uVar26) >>
              (bVar34 & 0x3f));
  }
  else {
    uVar9 = (uint)((*arg1 * -0x30e4432340650000 ^ uVar26) >> (0x38U - cVar8 & 0x3f));
    *(uint *)(this_ptr + 0x2c) = uVar35;
  }
  puVar1 = (uint64_t *)(lVar11 + (uint64_t)uVar16);
  pbVar25 = (byte *)(lVar37 + uVar12);
  *(int *)(this_ptr + 0x68) = *(int *)(this_ptr + 0x68) + uVar9;
  uVar36 = (uint64_t)(uVar9 >> 2 & 0xffffffc0);
  bVar23 = *(byte *)(lVar19 + uVar36);
  puVar38 = (void*)(lVar19 + uVar36);
  auVar41 = pshufb(ZEXT416(uVar9),(uint8_t  [16])0x0);
  ...
  if (uVar26 != 0) {
    ...
    do {
      ...
      uVar36 = (uint64_t)((int)lVar20 + (uint)bVar23 & 0x3f);
      if (uVar36 != 0) {
        uVar18 = *(uint *)(lVar30 + uVar36 * 4);
        if (uVar18 < uVar15) goto LAB_00ee9665;
        *(uint *)(local_138[0] + lVar37 * 4) = uVar18;
        lVar37 = lVar37 + 1;
        iVar32 = iVar32 + -1;
      }
      uVar26 = uVar26 & uVar26 - 1;
      if ((uVar26 == 0) || (iVar32 == 0)) goto LAB_00ee9665;
    } while( true );
  }
  lVar37 = 0;
LAB_00ee9665:
  uVar36 = (uint64_t)(bVar23 - 1 & 0x3f);
  if (uVar36 == 0) {
    lVar19 = 0x3f;
  }
  ...
  *(int *)(lVar30 + lVar19 * 4) = iVar5;
  puVar4 = (uint64_t *)((int64_t)param_2 - 7);
  if (lVar37 == 0) {
    uVar36 = 3;
  }
  else {
    ...
    do {
      ...
      puVar21 = (uint64_t *)(lVar11 + (uint64_t)uVar15);
      if (*(int *)((uVar36 - 3) + (int64_t)puVar21) == *(int *)((int64_t)arg1 + (uVar36 - 3))
         ) {
        puVar22 = arg1;
        if (arg1 < puVar4) {
          uVar26 = *arg1 ^ *puVar21;
          if (uVar26 == 0) {
            lVar20 = lVar11 + 8 + (uint64_t)uVar15;
            lVar19 = 0;
            do {
              puVar22 = (uint64_t *)((int64_t)arg1 + lVar19 + 8);
              if (puVar4 <= puVar22) {
                puVar21 = (uint64_t *)(lVar20 + lVar19);
                goto LAB_00ee9722;
              }
              lVar40 = lVar19 + 8;
              uVar26 = *(uint64_t *)((int64_t)arg1 + lVar19 + 8) ^
                       *(uint64_t *)(lVar20 + lVar19);
              lVar19 = lVar40;
            } while (uVar26 == 0);
            uVar39 = 0;
            if (uVar26 != 0) {
...
LAB_00ee9722:
          if ((puVar22 < (uint64_t *)((int64_t)param_2 - 3U)) && ((int)*puVar21 == (int)*puVar22))
          {
          ...
          if (puVar22 < param_2) {
            puVar22 = (uint64_t *)
                      ((int64_t)puVar22 + (uint64_t)((char)*puVar21 == (char)*puVar22));
          }
          uVar39 = (int64_t)puVar22 - (int64_t)arg1;
        }
        if ((uVar36 < uVar39) &&
           (*param_1 = (uint64_t)((uVar35 + 3) - uVar15), uVar36 = uVar39,
           (uint64_t *)((int64_t)arg1 + uVar39) == param_2)) break;
      }
      lVar30 = lVar30 + 1;
    } while (lVar30 != lVar37);
  }
  puVar21 = (uint64_t *)((int64_t)arg1 + 4);
  uVar15 = *(uint *)(puVar6 + 3);
  pcVar2 = (char *)*puVar6;
  lVar30 = puVar6[1];
  bVar23 = *pbVar25;
  local_1c0 = (byte)uVar10;
  auVar41 = pshufb(ZEXT116(local_1c0),(uint8_t  [16])0x0);
  local_138[0] = (uint8_t  [16])0x0;
  lVar19 = 0;
  do {
  ...
  if ((uVar26 != 0) && (iVar32 != 0)) {
    ...
    do {
      ...
      uVar10 = (uint64_t)((int)lVar37 + (uint)bVar23 & 0x3f);
      if (uVar10 != 0) {
        uVar9 = *(uint *)(lVar27 + uVar12 * 4 + uVar10 * 4);
        if (uVar9 < uVar15) goto LAB_00ee9923;
        *(uint *)(local_138[0] + lVar19 * 4) = uVar9;
        lVar19 = lVar19 + 1;
        iVar32 = iVar32 + -1;
      }
      uVar26 = uVar26 & uVar26 - 1;
      if ((uVar26 == 0) || (iVar32 == 0)) goto LAB_00ee9923;
    } while( true );
  }
  goto LAB_00ee9b91;
LAB_00ee9923:
  if (lVar19 != 0) {
    uVar26 = *arg1;
    lVar11 = (uint64_t)uVar16 + lVar11 + 8;
    lVar37 = 0;
    uVar10 = uVar36;
    do {
      uVar36 = (uint64_t)*(uint *)(local_138[0] + lVar37 * 4);
      if (*(int *)(lVar30 + uVar36) == (int)uVar26) {
        puVar33 = (uint64_t *)(lVar30 + uVar36 + 4);
        puVar22 = (uint64_t *)(((int64_t)pcVar2 - (int64_t)puVar33) + (int64_t)puVar21);
        if (param_2 <= puVar22) {
          puVar22 = param_2;
        }
        puVar28 = puVar21;
        puVar31 = puVar33;
        if (puVar21 < (uint64_t *)((int64_t)puVar22 - 7U)) {
          uVar12 = *puVar21 ^ *puVar33;
          if (uVar12 == 0) {
            lVar27 = lVar30 + 0xc + uVar36;
            lVar20 = 0;
            do {
              puVar28 = (uint64_t *)((int64_t)arg1 + lVar20 + 0xc);
              if ((uint64_t *)((int64_t)puVar22 - 7U) <= puVar28) {
                puVar31 = (uint64_t *)(lVar27 + lVar20);
                goto LAB_00ee9a3a;
              }
              lVar40 = lVar20 + 8;
              uVar36 = *(uint64_t *)((int64_t)arg1 + lVar20 + 0xc) ^
                       *(uint64_t *)(lVar27 + lVar20);
              lVar20 = lVar40;
            } while (uVar36 == 0);
            uVar12 = 0;
            if (uVar36 != 0) {
...
LAB_00ee9a3a:
          if ((puVar28 < (uint64_t *)((int64_t)puVar22 - 3U)) && ((int)*puVar31 == (int)*puVar28))
          {
            puVar28 = (uint64_t *)((int64_t)puVar28 + 4);
            puVar31 = (uint64_t *)((int64_t)puVar31 + 4);
          }
          if ((puVar28 < (uint64_t *)((int64_t)puVar22 - 1U)) &&
          ...
          if (puVar28 < puVar22) {
            puVar28 = (uint64_t *)
                      ((int64_t)puVar28 + (uint64_t)((char)*puVar31 == (char)*puVar28));
          }
          uVar36 = (int64_t)puVar28 - (int64_t)puVar21;
        }
        if ((char *)((int64_t)puVar33 + uVar36) == pcVar2) {
          puVar22 = (uint64_t *)((int64_t)puVar21 + uVar36);
          puVar28 = puVar1;
          puVar33 = puVar22;
          if (puVar22 < puVar4) {
            ...
            if (uVar12 == 0) {
              lVar27 = 0;
              do {
                puVar33 = (uint64_t *)((int64_t)arg1 + lVar27 + uVar36 + 0xc);
                if (puVar4 <= puVar33) {
                  puVar28 = (uint64_t *)(lVar27 + lVar11);
                  goto LAB_00ee9b00;
                }
                lVar20 = lVar27 + 8;
                uVar12 = *(uint64_t *)((int64_t)arg1 + lVar27 + uVar36 + 0xc) ^
                         *(uint64_t *)(lVar11 + lVar27);
                lVar27 = lVar20;
              } while (uVar12 == 0);
              uVar39 = 0;
              if (uVar12 != 0) {
...
LAB_00ee9b00:
            ...
            if (puVar33 < param_2) {
              puVar33 = (uint64_t *)
                        ((int64_t)puVar33 + (uint64_t)((char)*puVar28 == (char)*puVar33));
            }
            uVar39 = (int64_t)puVar33 - (int64_t)puVar22;
          }
