...
uint64_t FUN_00ee7366(uint64_t *param_1,uint64_t *param_2)

{
  ...
  uVar10 = *arg1 * -0x30e4432345000000 >> (0x38U - *(char *)((int64_t)puVar6 + 0x34) & 0x3f);
  ...
  if (*(int *)(this_ptr + 300) == 0) {
      ...
      if (uVar9 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(this_ptr + 0x40 + uVar13 * 4) =
               (int)((*(int64_t *)(lVar11 + 8 + uVar39) * -0x30e4432345000000 ^ uVar14) >>
                    (bVar34 & 0x3f));
      ...
      if (uVar35 - 0x20 < uVar9) {
        ...
        do {
          *(int *)(this_ptr + 0x40 + (uint64_t)((uint)uVar14 & 7) * 4) =
               (int)((*(int64_t *)(lVar11 + uVar14) * -0x30e4432345000000 ^ uVar24) >>
                    (bVar23 & 0x3f));
          uVar14 = uVar14 + 1;
        } while (uVar9 != uVar14);
      }
    ...
    if ((uint)uVar39 < uVar35) {
      ...
      do {
        ...
        *(int *)(this_ptr + 0x40 + uVar24 * 4) =
             (int)((*(int64_t *)(lVar7 + 8 + uVar39) * -0x30e4432345000000 ^
    ...
    *(int *)(this_ptr + 0x40 + (uint64_t)(uVar35 & 7) * 4) =
         (int)((*(int64_t *)((uVar36 & 0xffffffff) + 8 + lVar11) * -0x30e4432345000000 ^ uVar26) >>
              (bVar34 & 0x3f));
  }
  else {
    uVar9 = (uint)((*arg1 * -0x30e4432345000000 ^ uVar26) >> (0x38U - cVar8 & 0x3f));
    *(uint *)(this_ptr + 0x2c) = uVar35;
  }
