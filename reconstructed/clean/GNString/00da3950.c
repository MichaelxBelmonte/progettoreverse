...
uint FUN_00da3950(uint param_1,uint32_t param_2)
...
LAB_00da39d4:
        this_ptr = (ushort *)((int64_t)this_ptr + 1);
        *arg1 = uVar41;
        arg1 = arg1 + 1;
        uVar46 = uVar46 + 1;
  ...
  default:
    if (0 < (int)param_1) {
      uVar47 = 0;
      if ((0xe < param_1 - 1) &&
         ((uVar38 = (uint64_t)(param_1 - 1) + 1,
          (ushort *)((int64_t)this_ptr + uVar38) <= arg1 || (arg1 + uVar38 <= this_ptr)
          ))) {
        ...
        if (uVar47 - 0x10 == 0) {
          ...
          do {
            uVar2 = *(uint64_t *)((int64_t)this_ptr + lVar40);
            auVar62._8_8_ = 0;
            auVar62._0_8_ = uVar2;
            uVar3 = *(uint64_t *)((int64_t)this_ptr + lVar40 + 8);
            auVar55._8_8_ = 0;
            auVar55._0_8_ = uVar3;
            ...
            *(uint8_t (*) [16])(arg1 + lVar40) = auVar52;
            *(uint8_t (*) [16])(arg1 + lVar40 + 8) = auVar56;
            uVar2 = *(uint64_t *)((int64_t)this_ptr + lVar40 + 0x10);
            auVar56._8_8_ = 0;
            auVar56._0_8_ = uVar2;
            uVar3 = *(uint64_t *)((int64_t)this_ptr + lVar40 + 0x18);
            auVar57._8_8_ = 0;
            auVar57._0_8_ = uVar3;
            ...
            *(uint8_t (*) [16])(arg1 + lVar40 + 0x10) = auVar52;
            *(uint8_t (*) [16])(arg1 + lVar40 + 0x18) = unaff_XMM6;
            lVar40 = lVar40 + 0x20;
            lVar44 = lVar44 + 2;
          } while (lVar44 != 0);
        }
        if ((uVar43 & 1) != 0) {
          uVar43 = *(uint64_t *)((int64_t)this_ptr + lVar40);
          auVar53._8_8_ = 0;
          auVar53._0_8_ = uVar43;
          uVar2 = *(uint64_t *)((int64_t)this_ptr + lVar40 + 8);
          auVar64._8_8_ = 0;
          auVar64._0_8_ = uVar2;
          auVar56 = pmovzxbw(in_XMM3,auVar53);
          auVar54[0] = (char)uVar43 + g_023def20;
          ...
          auVar59[0] = g_023def20 + (char)uVar2;
          ...
          auVar56 = pblendvb(auVar56,g_023def40,auVar53);
          auVar53 = pblendvb(auVar52,g_023def40,auVar60);
          *(uint8_t (*) [16])(arg1 + lVar40) = auVar56;
          *(uint8_t (*) [16])(arg1 + lVar40 + 8) = auVar53;
        }
        arg1 = arg1 + uVar47;
        if (uVar38 == uVar47) goto LAB_00da3ec1;
        this_ptr = (ushort *)((int64_t)this_ptr + uVar47);
      }
      uVar46 = (uint)uVar47;
      uVar49 = ~uVar46;
      if ((param_1 & 3) != 0) {
      ...
      if (2 < uVar49 + param_1) {
        lVar40 = 0;
        do {
          uVar41 = (ushort)*(byte *)((int64_t)this_ptr + lVar40);
          if (0x5e < (byte)(*(byte *)((int64_t)this_ptr + lVar40) - 0x20)) {
            uVar41 = 0xfffd;
          }
          *arg1 = uVar41;
          bVar39 = *(byte *)((int64_t)this_ptr + lVar40 + 1);
          uVar41 = (ushort)bVar39;
          if (0x5e < (byte)(bVar39 - 0x20)) {
            uVar41 = 0xfffd;
          }
          arg1[1] = uVar41;
          bVar39 = *(byte *)((int64_t)this_ptr + lVar40 + 2);
          uVar41 = (ushort)bVar39;
          if (0x5e < (byte)(bVar39 - 0x20)) {
            uVar41 = 0xfffd;
          }
          arg1[2] = uVar41;
          bVar39 = *(byte *)((int64_t)this_ptr + lVar40 + 3);
          uVar41 = (ushort)bVar39;
          if (0x5e < (byte)(bVar39 - 0x20)) {
            uVar41 = 0xfffd;
          }
  ...
  case 6:
    if (0 < (int)param_1) {
      puVar51 = (ushort *)((int64_t)this_ptr + (int64_t)(int)param_1);
      puVar1 = arg1 + (int)param_1;
      param_1 = 0;
      puVar50 = arg1;
      do {
        bVar39 = (byte)*this_ptr;
        uVar38 = (uint64_t)bVar39;
        bVar37 = (&g_023def80)[uVar38];
        uVar47 = (uint64_t)((int)(char)bVar37 & 0xffff);
        if (puVar51 <= (ushort *)((int64_t)this_ptr + uVar47)) {
          return 0;
        }
        if (3 < bVar37) {
          return 0;
        ...
        case 3:
          bVar5 = (byte)*(ushort *)((int64_t)this_ptr + uVar47);
          if (-1 < (char)bVar5) {
            return 0;
          }
          lVar40 = 3;
        ...
        case 2:
          bVar5 = *(byte *)((int64_t)this_ptr + lVar40 + -1);
          if (-1 < (char)bVar5) {
            return 0;
          }
          if (0xbf < bVar5) {
        ...
        bVar5 = *(byte *)(lVar40 + -1 + (int64_t)this_ptr);
        if (0xbf < bVar5) {
          return 0;
        }
        if (bVar39 == 0xf4) {
...
switchD_00da3bf4_caseD_0:
        ...
        case 3:
          lVar44 = uVar38 << 6;
          uVar38 = (uint64_t)*(byte *)((int64_t)this_ptr + 1);
          this_ptr = (ushort *)((int64_t)this_ptr + 1);
        case 2:
        ...
        puVar45 = (void*)(lVar48 - *(int64_t *)(&g_023df080 + uVar47 * 8));
        if (puVar45 < (void*)0x10000) {
  ...
  case 7:
    ...
    if (uVar46 < 5) {
      if (0 < (int)param_1) {
        pbVar36 = *(byte **)(&g_02579910 + (int64_t)(int)uVar46 * 8);
        uVar46 = param_1;
        param_1 = 0;
        do {
          bVar39 = (byte)*this_ptr;
          puVar51 = (ushort *)((int64_t)this_ptr + 1);
          uVar49 = uVar46 - 1;
          if (bVar39 == 0x25) {
            bVar5 = *(byte *)((int64_t)this_ptr + 1);
            bVar4 = (byte)this_ptr[1];
            bVar37 = bVar5 - 0x30;
            if (bVar37 < 10) {
LAB_00da3f3d:
              bVar34 = bVar4 - 0x30;
              if (9 < bVar34) {
                ...
                if ((0x25 < (byte)(bVar4 + 0xbf)) ||
                   ((0x3f0000003fU >> ((uint64_t)(byte)(bVar4 + 0xbf) & 0x3f) & 1) == 0))
                goto LAB_00da3ee0;
              }
              ...
              puVar51 = (ushort *)((int64_t)this_ptr + 3);
              uVar49 = uVar46 - 3;
              goto LAB_00da3fc6;
            }
            bVar39 = 0x25;
            if (((byte)(bVar5 + 0xbf) < 0x26) &&
               ((0x3f0000003fU >> ((uint64_t)(byte)(bVar5 + 0xbf) & 0x3f) & 1) != 0))
            goto LAB_00da3f3d;
LAB_00da3ee0:
            uVar46 = uVar49;
            uVar41 = (ushort)bVar39;
