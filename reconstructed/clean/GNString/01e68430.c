...
void FUN_01e68430(uint64_t param_1,uint64_t param_2,int param_3,char param_4,uint32_t param_5)

{
  ...
  fStack_1a4 = (float)((uint64_t)param_2 >> 0x20);
  uStack_1a0 = (uint32_t)in_XMM1_Qb;
  uStack_19c = (uint)((uint64_t)in_XMM1_Qb >> 0x20);
...
LAB_01e685e6:
  ...
  local_a8._4_4_ = (uint32_t)((uint64_t)param_1 >> 0x20);
  uStack_a0 = (uint32_t)in_XMM0_Qb;
  uStack_9c = (uint32_t)((uint64_t)in_XMM0_Qb >> 0x20);
  ...
  if (in_RDX != (int64_t *)0x0) {
    ...
    if ((cVar7 != '\0') && (local_res8 == '\0')) {
      fVar20 = fStack_1a4 * g_0239011c + (float)local_a8._4_4_;
      ...
      auVar23 = blendps(auVar23,g_023b1620,0xe);
      (**(code **)(*this_ptr + 0x3c0))(auVar22._0_8_,auVar23._0_8_);
      bVar3 = true;
      goto LAB_01e68aca;
    }
  }
  if (local_res20 == '\0') {
    ...
    uVar11 = (**(code **)(*this_ptr + 0x5c8))();
    auVar24._8_4_ = (int)extraout_XMM0_Qb_00;
    auVar24._0_8_ = uVar11;
    auVar24._12_4_ = (int)((uint64_t)extraout_XMM0_Qb_00 >> 0x20);
    ...
    auVar28._0_4_ = (float)local_a8._4_4_ + g_02390124;
    auVar22 = insertps(auVar14,auVar28,0x10);
    auVar23 = blendps(auVar24,_local_98,0xe);
    (**(code **)(*this_ptr + 0x5f8))(auVar22._0_8_,auVar23._0_8_,local_res10);
    fVar20 = (float)(**(code **)(*this_ptr + 0x5c8))();
    fVar8 = (float)(**(code **)(*this_ptr + 0x5c8))();
    ...
    auVar16._0_4_ = auVar28._0_4_ + g_02390d00;
...
LAB_01e68aca:
  FUN_01d488d0();
  if (!bVar3) {
    fVar19 = (float)local_e8._0_4_ + g_023b5570;
    ...
    if (param_4 != '\0') {
      auVar17._0_4_ = fVar19 + g_023b5de0 + (float)local_98._0_4_;
