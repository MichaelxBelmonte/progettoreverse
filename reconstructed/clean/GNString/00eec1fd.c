...
uint64_t FUN_00eec1fd(uint64_t *param_1,uint64_t *param_2)

{
  ...
  uVar37 = (int64_t)arg1 - lVar17;
  uVar29 = *(uint *)(this_ptr + 0x1c);
  uVar36 = (uint)uVar37;
  ...
  if (*(int *)(this_ptr + 300) == 0) {
    ...
    if (0x180 < uVar36 - uVar35) {
      if (uVar35 < 0xffffffa0) {
        ...
        lVar38 = *(int64_t *)(this_ptr + 0x38);
        lVar14 = *(int64_t *)(this_ptr + 0x70);
        bVar9 = 0x18 - (char)*(void*)(this_ptr + 0x34);
      }
      uVar42 = (uint64_t)(uVar36 - 0x20);
      uVar35 = 0;
      if (lVar17 + uVar42 <= (int64_t)arg1 + 1U) {
        uVar35 = ((int)((int64_t)arg1 + 1U) - (int)(lVar17 + uVar42)) + 1;
      }
      uVar30 = 8;
      if (uVar35 < 8) {
        uVar30 = uVar35;
    ...
    if ((uint)uVar42 < uVar36) {
      ...
      do {
        uVar19 = (uint64_t)((uint)uVar42 & 7);
        uVar35 = *(uint *)(this_ptr + 0x40 + uVar19 * 4);
        *(uint *)(this_ptr + 0x40 + uVar19 * 4) =
             (*(int *)(lVar20 + 8 + uVar42) * -0x61c8864f ^ *(uint *)(this_ptr + 0x60)) >>
             (bVar9 & 0x1f);
        uVar19 = (uint64_t)(uVar35 >> 3 & 0x1fffffe0);
    ...
    *(uint *)(this_ptr + 0x40 + (uint64_t)(uVar36 & 7) * 4) =
  ...
  *(int *)(this_ptr + 0x68) = *(int *)(this_ptr + 0x68) + uVar35;
  uVar37 = (uint64_t)(uVar35 >> 3 & 0xffffffe0);
  bVar9 = *(byte *)(lVar22 + uVar37);
  puVar34 = (void*)(lVar22 + uVar37);
  ...
  if (uVar29 != 0) {
    ...
    do {
      ...
      uVar42 = (uint64_t)((int)lVar14 + (uint)bVar9 & 0x1f);
      if (uVar42 != 0) {
  ...
  *(int *)(lVar13 + lVar22 * 4) = iVar6;
  ...
  if (lVar38 == 0) {
    ...
    do {
      ...
      puVar27 = (uint64_t *)(lVar17 + (uint64_t)uVar29);
      if (*(int *)((uVar42 - 3) + (int64_t)puVar27) == *(int *)((int64_t)arg1 + (uVar42 - 3))
         ) {
        puVar23 = arg1;
        if (arg1 < puVar1) {
          uVar19 = *arg1 ^ *puVar27;
          if (uVar19 == 0) {
            lVar22 = lVar17 + 8 + (uint64_t)uVar29;
            lVar14 = 0;
            do {
              puVar23 = (uint64_t *)((int64_t)arg1 + lVar14 + 8);
              if (puVar1 <= puVar23) {
                puVar27 = (uint64_t *)(lVar22 + lVar14);
                goto LAB_00eec61a;
              }
              lVar20 = lVar14 + 8;
              uVar37 = *(uint64_t *)((int64_t)arg1 + lVar14 + 8) ^
...
LAB_00eec61a:
          ...
          uVar37 = (int64_t)puVar23 - (int64_t)arg1;
        }
        if ((uVar42 < uVar37) &&
           (*param_1 = (uint64_t)((uVar36 + 3) - uVar29), uVar42 = uVar37,
  ...
  puVar27 = (uint64_t *)((int64_t)arg1 + 4);
  pcVar5 = (char *)*puVar7;
  lVar13 = puVar7[1];
  lVar22 = puVar7[0xe];
  lVar38 = 0;
  ...
  if (uVar29 != 0) {
    ...
    do {
      ...
      if (*(int *)(lVar13 + uVar16) == (int)*arg1) {
        puVar39 = (uint64_t *)((int *)(lVar13 + uVar16) + 1);
        puVar23 = (uint64_t *)(((int64_t)pcVar5 - (int64_t)puVar39) + (int64_t)puVar27);
        if (param_2 <= puVar23) {
          puVar23 = param_2;
        }
        puVar28 = puVar27;
        puVar33 = puVar39;
        if (puVar27 < (uint64_t *)((int64_t)puVar23 - 7U)) {
          uVar15 = *puVar27 ^ *puVar39;
          if (uVar15 == 0) {
            lVar20 = lVar13 + 0xc + uVar16;
            lVar26 = 0;
            do {
              puVar28 = (uint64_t *)((int64_t)arg1 + lVar26 + 0xc);
              if ((uint64_t *)((int64_t)puVar23 - 7U) <= puVar28) {
...
LAB_00eec8a1:
          if ((puVar28 < (uint64_t *)((int64_t)puVar23 - 3U)) && ((int)*puVar33 == (int)*puVar28))
          {
            puVar28 = (uint64_t *)((int64_t)puVar28 + 4);
            puVar33 = (uint64_t *)((int64_t)puVar33 + 4);
          }
          if ((puVar28 < (uint64_t *)((int64_t)puVar23 - 1U)) &&
          ...
          uVar16 = (int64_t)puVar28 - (int64_t)puVar27;
        }
        if ((char *)((int64_t)puVar39 + uVar16) == pcVar5) {
          puVar23 = (uint64_t *)((int64_t)puVar27 + uVar16);
          puVar28 = puVar4;
          puVar39 = puVar23;
          if (puVar23 < puVar1) {
            ...
            if (uVar15 == 0) {
              lVar20 = 0;
              do {
                puVar39 = (uint64_t *)((int64_t)arg1 + lVar20 + uVar16 + 0xc);
                if (puVar1 <= puVar39) {
                  puVar28 = (uint64_t *)(lVar20 + lVar14);
                  goto LAB_00eec98f;
                }
                lVar26 = lVar20 + 8;
...
LAB_00eec98f:
            ...
            if (puVar39 < param_2) {
              puVar39 = (uint64_t *)
                        ((int64_t)puVar39 + (uint64_t)((char)*puVar28 == (char)*puVar39));
            }
            uVar24 = (int64_t)puVar39 - (int64_t)puVar23;
          }
          uVar16 = uVar16 + uVar24;
        }
        uVar16 = uVar16 + 4;
        if ((uVar37 < uVar16) &&
           (*param_1 = (uint64_t)(iVar31 - uVar10), uVar37 = uVar16,
           (uint64_t *)((int64_t)arg1 + uVar16) == param_2)) goto LAB_00eeccbc;
      }
      uVar19 = uVar19 + 1;
    } while (uVar19 != uVar29);
  }
  ...
  if (uVar41 != 0) {
    ...
    do {
      ...
      uVar37 = (uint64_t)uVar10;
      if (*(int *)(lVar13 + uVar37) == (int)uVar25) {
        puVar39 = (uint64_t *)(lVar13 + uVar37 + 4);
        puVar23 = (uint64_t *)(((int64_t)pcVar5 - (int64_t)puVar39) + (int64_t)puVar27);
        if (param_2 <= puVar23) {
          puVar23 = param_2;
        }
        ...
        if (puVar27 < (uint64_t *)((int64_t)puVar23 - 7U)) {
          ...
          if (uVar19 == 0) {
            ...
            do {
              ...
              lVar20 = lVar14 + 8;
              uVar37 = *(uint64_t *)((int64_t)arg1 + lVar14 + 0xc) ^
                       *(uint64_t *)(lVar22 + lVar14);
              lVar14 = lVar20;
            } while (uVar37 == 0);
            uVar19 = 0;
...
LAB_00eecb3f:
          ...
          uVar37 = (int64_t)puVar28 - (int64_t)puVar27;
        }
        if ((char *)((int64_t)puVar39 + uVar37) == pcVar5) {
          puVar23 = (uint64_t *)((int64_t)puVar27 + uVar37);
          puVar39 = puVar23;
          puVar28 = puVar4;
          if (puVar23 < puVar1) {
            ...
            if (uVar19 == 0) {
              lVar22 = 0;
              do {
                puVar39 = (uint64_t *)((int64_t)arg1 + lVar22 + uVar37 + 0xc);
                if (puVar1 <= puVar39) {
                  puVar28 = (uint64_t *)(lVar22 + lVar17);
                  goto LAB_00eecc1b;
                }
                lVar14 = lVar22 + 8;
                uVar19 = *(uint64_t *)((int64_t)arg1 + lVar22 + uVar37 + 0xc) ^
...
LAB_00eecc1b:
            ...
            uVar16 = (int64_t)puVar39 - (int64_t)puVar23;
          }
          uVar37 = uVar37 + uVar16;
        }
        uVar37 = uVar37 + 4;
        if ((uVar11 < uVar37) &&
           (*param_1 = (uint64_t)(iVar31 - uVar10), uVar11 = uVar37,
           (uint64_t *)((int64_t)arg1 + uVar37) == param_2)) break;
      }
      uVar37 = uVar11;
      uVar29 = uVar29 + 1;
