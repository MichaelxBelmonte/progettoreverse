...

{
  ...
  if (pBVar4 == (BIGNUM *)0x0) {
    ...
    r = *(char **)(param_2 + 0x20);
    iVar1 = (**(code **)(*this_ptr + 0x108))(r,*(void*)(arg1 + 0x20),param_3);
    if (iVar1 != 0) {
      r = *(char **)(arg1 + 0x20);
      pBVar6 = param_3;
      iVar1 = (**(code **)(*this_ptr + 0x108))(r,*(void*)(param_1 + 0x10));
      if ((iVar1 != 0) && (iVar1 = _BN_GF2m_add((BIGNUM *)r,a,pBVar6), iVar1 != 0)) {
        r = *(char **)(param_2 + 0x20);
        iVar1 = (**(code **)(*this_ptr + 0x108))(r,*(void*)(param_1 + 0x10),param_3);
        if ((((iVar1 != 0) &&
             (((r = (char *)pBVar4, pBVar6 = param_3, a_00 = pBVar4,
               iVar1 = (**(code **)(*this_ptr + 0x108))(pBVar4,*(void*)(arg1 + 0x10)),
               iVar1 != 0 &&
               (iVar1 = _BN_GF2m_add((BIGNUM *)r,*(BIGNUM **)(param_2 + 0x10),pBVar6), iVar1 != 0))
              && (pBVar6 = param_3, iVar1 = (**(code **)(*this_ptr + 0x108))(pBVar4,a),
                 r = (char *)pBVar4, iVar1 != 0)))) &&
            ((((r = (char *)param_3, pBVar4 = a_00,
               iVar1 = (**(code **)(*this_ptr + 0x110))(param_3,*(void*)(param_1 + 0x10)),
               iVar1 != 0 && (iVar1 = _BN_GF2m_add((BIGNUM *)r,a_00,pBVar6), iVar1 != 0)) &&
              (r = (char *)pBVar3, pBVar6 = param_3,
              iVar1 = (**(code **)(*this_ptr + 0x108))(pBVar3,a_00), iVar1 != 0)) &&
             ((iVar1 = _BN_GF2m_add((BIGNUM *)r,a,pBVar6), iVar1 != 0 &&
              (iVar1 = (**(code **)(*this_ptr + 0x108))
                                 (pBVar3,*(void*)(param_1 + 0x10),param_3),
              r = (char *)pBVar3, iVar1 != 0)))))) &&
           ((r = (char *)param_3, iVar1 = (**(code **)(*this_ptr + 0x120))(param_3,pBVar4),
            iVar1 != 0 &&
            (((pBVar3 = pBVar4, iVar1 = (**(code **)(*this_ptr + 0x108))(pBVar4,a,param_3),
              r = (char *)pBVar4, iVar1 != 0 &&
              (r = (char *)pBVar3, pBVar4 = param_3, pBVar6 = pBVar3,
              iVar1 = (**(code **)(*this_ptr + 0x108))(pBVar3,*(void*)(arg1 + 0x20)),
              iVar1 != 0)) &&
             (iVar1 = _BN_GF2m_add((BIGNUM *)r,*(BIGNUM **)(arg1 + 0x10),pBVar4), iVar1 != 0)))
            ))) {
          iVar1 = (**(code **)(*this_ptr + 0x108))(a,pBVar3);
          if (iVar1 != 0) {
