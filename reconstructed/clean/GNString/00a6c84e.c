...

{
  ...
  for (plVar22 = *(int64_t **)(this_ptr + 0x78); plVar22 != *(int64_t **)(this_ptr + 0x80);
      plVar22 = plVar22 + 4) {
  ...
  iVar3 = (**(code **)(*arg1 + 0x30))(0x10,0xf);
  iVar4 = (**(code **)(*arg1 + 0x58))();
  iVar4 = iVar1 + iVar21 + iVar2 + iVar3 + iVar4;
  for (plVar22 = *(int64_t **)(this_ptr + 0x90); plVar22 != *(int64_t **)(this_ptr + 0x98);
      plVar22 = plVar22 + 4) {
    iVar1 = (**(code **)(*plVar22 + 0x18))();
    iVar4 = iVar4 + iVar1;
  }
