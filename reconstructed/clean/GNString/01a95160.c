...
uint64_t FUN_01a95160(uint64_t param_1,int param_2)

{
  ...
  plVar8 = local_40;
  uVar3 = CONCAT71((int7)((uint64_t)uVar3 >> 8),g_026fd0c0);
  if ((g_026fd0c0 == '\0') && (uVar3 = ___cxa_guard_acquire(), (int)uVar3 != 0)) {
...
LAB_01a95218:
  ...
  local_78 = plVar8;
  if (plVar8 == (int64_t *)0x0) {
    local_44 = (uint32_t)CONCAT71((int7)((uint64_t)uVar3 >> 8),1);
    uVar3 = 0;
    plVar4 = (int64_t *)0x0;
  }
  else {
    ...
    *plVar4 = (int64_t)&g_0256ebe0;
    ...
    local_f0 = plVar8;
    (**(code **)(*plVar4 + 0x4d0))();
    uVar3 = CONCAT71((int7)((uint64_t)pplVar7 >> 8),1);
...
LAB_01a9552b:
      ...
      if ((char)local_44 == '\0' && plVar4 != (int64_t *)0x0) {
        FUN_00d50b20();
      }
      goto LAB_01a956d9;
    }
