...
void* FUN_01502670(void*param_1,int64_t *param_2)
...
LAB_01502eff:
  ...
  if ((pvVar7 != (void *)0x0) && (lVar8 = FUN_00e8b990(), lVar8 != 0)) {
    plVar6 = (int64_t *)plVar12[(uint64_t)(*(uint *)(lVar8 + 0x154) & 1) + 4];
  }
  plVar6[7] = *param_2;
  *(void*)(this_ptr + 1) = 0;
