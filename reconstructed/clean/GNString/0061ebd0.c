...
uint32_t FUN_0061ebd0(int64_t *param_1,char param_2)

{
  ...
  local_7c = (uint32_t)
             CONCAT71((int7)((uint64_t)uVar5 >> 8),*(int *)((int64_t)local_68 + 0xc) != 0);
  cVar2 = FUN_00212c70();
  if (cVar2 == '\0') {
    local_60 = '\0';
    ...
    do {
      ...
      local_50 = local_50 + 1;
      param_1 = plVar1;
      if (*(int *)((int64_t)plVar1 + 0xc) <= local_50) goto LAB_0061ee1d;
      param_1 = (int64_t *)plVar1[2];
      local_68 = (int64_t *)param_1[lVar6 + 1];
...
LAB_0061f39f:
        ...
        if (local_68 == (int64_t *)0x0) goto LAB_0061f39f;
        bVar10 = true;
        if (local_60 == '\0') {
          FUN_00d50b00();
        }
...
LAB_0061f5ac:
    if (plVar1 == (int64_t *)0x0) goto LAB_0061f5b9;
  }
  else {
    if (((char)local_7c == '\0') || (plVar1 == (int64_t *)0x0)) goto LAB_0061f5ac;
    if (0 < *(int *)((int64_t)plVar1 + 0xc)) {
      ...
      do {
        ...
        iVar3 = iVar3 + 1;
      } while (iVar3 < *(int *)((int64_t)plVar1 + 0xc));
    }
    FUN_00115190();
  }
  FUN_00d50b20();
