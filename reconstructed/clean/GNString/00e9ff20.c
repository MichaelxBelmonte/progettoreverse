...
void FUN_00e9ff20(uint64_t param_1,uint64_t param_2,byte *param_3)

{
  ...
  iVar8 = *(int *)(this_ptr + 0x6c);
  if (0 < iVar8) {
    uVar11 = ~*(uint *)(this_ptr + 0x288);
    *(uint *)(this_ptr + 0x288) = uVar11;
    uVar19 = (*(int *)(this_ptr + 0x28c) << 1 | (uint)(*(int *)(this_ptr + 0x28c) < 0)) ^ uVar11;
    param_3 = (byte *)(uint64_t)uVar19;
    *(uint *)(this_ptr + 0x28c) = uVar19;
    if (1 < (int)*(uint *)(this_ptr + 0x294)) {
      *(void*)(this_ptr + 0x74) = 0;
    }
    if (1 < *(int *)(this_ptr + 0x290)) {
      _fprintf((FILE *)(uint64_t)uVar11,(char *)(uint64_t)*(uint *)(this_ptr + 0x294));
    }
    FUN_00e9af00();
    iVar8 = *(int *)(this_ptr + 0x6c);
  }
  lVar9 = (int64_t)iVar8 + *(int64_t *)(this_ptr + 0x20);
  *(int64_t *)(this_ptr + 0x50) = lVar9;
  if (*(int *)(this_ptr + 0x294) == 1) {
    *(void*)(this_ptr + 0x280) = 0x842000000;
    *(void*)(lVar9 + *(int *)(this_ptr + 0x74)) = 0x42;
    iVar7 = *(int *)(this_ptr + 0x74) + 1;
    *(int *)(this_ptr + 0x74) = iVar7;
    uVar11 = *(int *)(this_ptr + 0x280) << 8;
    *(uint *)(this_ptr + 0x280) = uVar11;
    iVar8 = *(int *)(this_ptr + 0x284);
    *(int *)(this_ptr + 0x284) = iVar8 + -8;
    while (0xf < iVar8) {
      *(char *)(*(int64_t *)(this_ptr + 0x50) + (int64_t)iVar7) = (char)(uVar11 >> 0x18);
      iVar7 = *(int *)(this_ptr + 0x74) + 1;
      *(int *)(this_ptr + 0x74) = iVar7;
      uVar11 = *(int *)(this_ptr + 0x280) << 8;
      *(uint *)(this_ptr + 0x280) = uVar11;
    ...
    *(uint *)(this_ptr + 0x280) = uVar11;
    *(uint *)(this_ptr + 0x284) = uVar19;
    iVar3 = *(int *)(this_ptr + 0x298);
    if (-1 < iVar8) {
      do {
        *(char *)(*(int64_t *)(this_ptr + 0x50) + (int64_t)iVar7) = (char)(uVar11 >> 0x18);
        iVar7 = *(int *)(this_ptr + 0x74) + 1;
    ...
    param_3 = (byte *)(uint64_t)uVar19;
    *(uint *)(this_ptr + 0x280) = (iVar3 + 0x30U & 0xff) << (0x18U - (char)uVar19 & 0x1f) | uVar11;
    *(uint *)(this_ptr + 0x284) = uVar19 + 8;
    iVar8 = *(int *)(this_ptr + 0x6c);
  }
  if (iVar8 < 1) goto LAB_00ea094b;
  uVar11 = *(uint *)(this_ptr + 0x280);
  iVar8 = *(int *)(this_ptr + 0x284);
  if (7 < iVar8) {
    iVar7 = *(int *)(this_ptr + 0x74);
    do {
      *(char *)(*(int64_t *)(this_ptr + 0x50) + (int64_t)iVar7) = (char)(uVar11 >> 0x18);
      iVar7 = *(int *)(this_ptr + 0x74) + 1;
      *(int *)(this_ptr + 0x74) = iVar7;
  ...
  *(uint *)(this_ptr + 0x280) = uVar11;
  *(int *)(this_ptr + 0x284) = iVar7;
  if (-1 < iVar8) {
    iVar8 = *(int *)(this_ptr + 0x74);
    do {
      *(char *)(*(int64_t *)(this_ptr + 0x50) + (int64_t)iVar8) = (char)(uVar11 >> 0x18);
      iVar8 = *(int *)(this_ptr + 0x74) + 1;
      *(int *)(this_ptr + 0x74) = iVar8;
      uVar11 = *(int *)(this_ptr + 0x280) << 8;
      *(uint *)(this_ptr + 0x280) = uVar11;
      iVar3 = *(int *)(this_ptr + 0x284);
      iVar7 = iVar3 + -8;
  ...
  *(int *)(this_ptr + 0x284) = iVar7;
  ...
  param_3 = (byte *)CONCAT71((int7)((uint64_t)param_3 >> 8),bVar18);
  *(uint *)(this_ptr + 0x280) = 0x59 << (bVar18 & 0x1f) | uVar11;
  *(int *)(this_ptr + 0x284) = iVar7 + 8;
  FUN_00ea0cc0();
  uVar11 = *(uint *)(this_ptr + 0x280);
  iVar8 = *(int *)(this_ptr + 0x284);
  if (7 < iVar8) {
  ...
  if (6 < iVar8) {
    ...
    do {
      ...
      *(int *)(this_ptr + 0x74) = iVar8;
      uVar11 = *(int *)(this_ptr + 0x280) << 8;
      *(uint *)(this_ptr + 0x280) = uVar11;
      iVar4 = *(int *)(this_ptr + 0x284);
      iVar7 = iVar4 + -8;
      *(int *)(this_ptr + 0x284) = iVar7;
    } while (0xf < iVar4);
  }
  *(uint *)(this_ptr + 0x280) = iVar3 << (8U - (char)iVar7 & 0x1f) | uVar11;
  *(int *)(this_ptr + 0x284) = iVar7 + 0x18;
  lVar9 = *(int64_t *)(this_ptr + 0x38);
  ...
  *(void*)(this_ptr + 0x7c) = 0;
  ...
  lVar10 = 0x181;
  do {
    if (*(char *)(this_ptr + -0x101 + lVar10) != '\0') {
      *(char *)(this_ptr + -1 + lVar10) = (char)uVar11;
      uVar11 = uVar11 + 1;
      *(uint *)(this_ptr + 0x7c) = uVar11;
    }
    if (*(char *)(this_ptr + -0x100 + lVar10) != '\0') {
      *(char *)(this_ptr + lVar10) = (char)uVar11;
      uVar11 = uVar11 + 1;
      *(uint *)(this_ptr + 0x7c) = uVar11;
    }
    lVar10 = lVar10 + 2;
  ...
  if ((-2 < (int)uVar11) && (___bzero(), 0 < (int)uVar11)) {
    if (uVar11 < 0x20) {
      ...
      uVar12 = (uint64_t)(uVar11 & 0xffffffe0);
      uVar16 = (uVar12 - 0x20 >> 5) + 1;
      uVar14 = (uint64_t)((uint)uVar16 & 3);
      bVar18 = g_023e2040;
      bVar20 = UNK_023e2041;
      bVar21 = UNK_023e2042;
      bVar22 = UNK_023e2043;
      ...
      if (uVar12 - 0x20 < 0x60) {
        ...
        do {
          ...
          local_138[lVar17 + 0x10] = bVar18 + g_023e2050;
          ...
          local_138[lVar17 + 0x20] = bVar18 + g_02410fa0;
  ...
  if ((int)uVar19 < 1) {
    ...
    do {
      ...
      if (0 < iVar7) {
        ...
        iVar8 = iVar8 + 1;
        puVar15 = (void*)(lVar6 + lVar17 * 2);
        if ((uVar19 & 1) != 0) goto LAB_00ea0820;
        do {
          *(int *)(this_ptr + 0x2a0) = *(int *)(this_ptr + 0x2a0) + 1;
          *puVar15 = 0;
          while( true ) {
            if ((int)uVar19 < 2) {
              iVar7 = 0;
            ...
            if ((uVar19 & 1) == 0) break;
LAB_00ea0820:
            *(int *)(this_ptr + 0x2a4) = *(int *)(this_ptr + 0x2a4) + 1;
            *puVar15 = 1;
          }
        } while( true );
      }
joined_r0x00ea086c:
      ...
      *(short *)(lVar6 + (int64_t)iVar8 * 2) = (short)((int64_t)pbVar1 - (int64_t)param_3) + 1;
      iVar8 = iVar8 + 1;
      piVar2 = (int *)(this_ptr + 0x2a4 + (int64_t)(int)((int64_t)pbVar1 - (int64_t)param_3) * 4
                      );
      *piVar2 = *piVar2 + 1;
      uVar19 = *(uint *)(this_ptr + 0x6c);
      lVar10 = lVar10 + 1;
...
LAB_00ea0920:
  *(short *)(lVar6 + (int64_t)iVar8 * 2) = (short)(uVar11 + 1);
  piVar2 = (int *)(this_ptr + 0x2a0 + (int64_t)(int)(uVar11 + 1) * 4);
  *piVar2 = *piVar2 + 1;
  *(int *)(this_ptr + 0x29c) = iVar8 + 1;
  FUN_00ea0e90();
LAB_00ea094b:
  if (unaff_SIL != '\0') {
    uVar11 = *(uint *)(this_ptr + 0x280);
    ...
    *(int *)(this_ptr + 0x284) = iVar7;
    ...
    pFVar13 = (FILE *)(CONCAT71((int7)((uint64_t)param_3 >> 8),'\x18' - (char)iVar7) & 0xffffffff);
    *(uint *)(this_ptr + 0x280) = 0x90 << ((byte)pFVar13 & 0x1f) | uVar11;
    *(int *)(this_ptr + 0x284) = iVar7 + 8;
    FUN_00ea0cc0();
    if (1 < *(int *)(this_ptr + 0x290)) {
      _fprintf(pFVar13,(char *)(uint64_t)*(uint *)(this_ptr + 0x28c));
    }
    if (0 < *(int *)(this_ptr + 0x284)) {
      iVar8 = *(int *)(this_ptr + 0x280);
      iVar7 = *(int *)(this_ptr + 0x74);
      do {
        *(char *)(*(int64_t *)(this_ptr + 0x50) + (int64_t)iVar7) = (char)((uint)iVar8 >> 0x18);
        iVar7 = *(int *)(this_ptr + 0x74) + 1;
        *(int *)(this_ptr + 0x74) = iVar7;
        iVar8 = *(int *)(this_ptr + 0x280) << 8;
        *(int *)(this_ptr + 0x280) = iVar8;
        iVar3 = *(int *)(this_ptr + 0x284);
        *(int *)(this_ptr + 0x284) = iVar3 + -8;
      } while (8 < iVar3);
    }
  }
