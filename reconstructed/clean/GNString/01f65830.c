...
bool FUN_01f65830(uint64_t param_1,uint32_t param_2)
...
LAB_01f65915:
    ...
    while( true ) {
      ...
      local_a8 = CONCAT44(local_a8._4_4_,iVar9);
      if (*(int *)((int64_t)local_b0 + 0xc) <= iVar9) break;
      plVar7 = *(int64_t **)(local_b0[2] + 8 + lVar5 * 8);
      local_68 = plVar7;
      local_c0 = plVar7;
      if ((g_026fdd40 == '\0') &&
      ...
      if (*pplVar6 != (int64_t *)0x0) {
        if (local_a0 + (int)local_a8 == 0) {
          ...
          plVar7 = local_68;
          if (local_60 == '\0') {
            if (((local_68 != (int64_t *)0x0) && (uVar13 = FUN_00d50b00(), local_60 != '\0')) &&
               (local_68 != (int64_t *)0x0)) {
              uVar13 = FUN_00d50b20();
            }
          }
  ...
  if (*(int *)((int64_t)local_c8 + 0xc) == 0) {
    ...
    if (local_68 == (int64_t *)0x0) {
      ...
      if (local_60 == '\0') {
        FUN_00d50b00();
        plVar7 = (int64_t *)CONCAT71(uVar8,1);
        if ((local_60 != '\0') && (local_68 != (int64_t *)0x0)) {
          FUN_00d50b20();
        }
      }
  ...
  local_70 = plVar7;
  if (*(int *)((int64_t)local_88 + 0xc) < 2) {
    plVar11 = (int64_t *)this_ptr[0x12];
    ...
    local_d0 = '\x01';
    (**(code **)(*this_ptr + 0x5c8))(&local_d8,&local_108);
    plVar7 = local_68;
    if ((local_60 != '\0') && (local_68 != (int64_t *)0x0)) {
      FUN_00d50b20();
    }
    ...
    if (plVar7 == (int64_t *)0x0) {
      FUN_01ce9490();
      plVar11 = *(int64_t **)
                 (local_88[2] + -0x10 + (int64_t)*(int *)((int64_t)local_68 + 0xc) * 8);
      bVar12 = plVar11 == (int64_t *)0x0;
      if (bVar12) {
        plVar11 = (int64_t *)0x0;
      }
      else {
      ...
      bVar1 = !bVar12;
      if ((local_60 != '\0') && (bVar1 = !bVar12, local_68 != (int64_t *)0x0)) {
        FUN_00d50b20();
      }
    }
    else {
  ...
  local_150 = plVar11;
  local_f8 = lVar5;
  (**(code **)(*this_ptr + 0x5d8))(&local_150,&local_f8);
  plVar10 = local_68;
  if (local_68 == (int64_t *)0x0) {
    plVar10 = (int64_t *)0x0;
    plVar7 = local_70;
joined_r0x01f66406:
    ...
    uVar8 = (undefined7)((uint64_t)local_70 >> 8);
    if (local_60 == '\0') {
      FUN_00d50b00();
      plVar7 = (int64_t *)CONCAT71(uVar8,1);
...
LAB_01f6645c:
  if ((plVar10 != (int64_t *)0x0) && ((char)local_11c != '\0')) {
    local_70 = plVar7;
    FUN_01ca6970();
    plVar2 = local_68;
    if ((local_60 == '\0') &&
       (((local_68 != (int64_t *)0x0 && (FUN_00d50b00(), local_60 != '\0')) &&
        (local_68 != (int64_t *)0x0)))) {
      FUN_00d50b20();
    }
    uVar13 = FUN_01ca5d90();
    local_130 = g_026fceb8;
    local_138 = '\0';
    local_140 = plVar10;
    if (g_026fceb8 != 0) {
      uVar13 = FUN_00d50b00();
  ...
  FUN_00d50b20();
  if (((char)plVar7 != '\0') && (plVar10 != (int64_t *)0x0)) {
    FUN_00d50b20();
  }
