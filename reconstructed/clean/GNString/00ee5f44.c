...
uint64_t FUN_00ee5f44(uint64_t *param_1,uint64_t *param_2)

{
  ...
  uVar34 = *arg1 * -0x30e4432345000000 >> (0x38U - *(char *)((int64_t)puVar5 + 0x34) & 0x3f);
  ...
  if (*(int *)(this_ptr + 300) == 0) {
      ...
      if (uVar8 < 0xffffffa0) {
        ...
        while( true ) {
          ...
          *(int *)(this_ptr + 0x40 + uVar15 * 4) =
               (int)((*(int64_t *)(lVar11 + 8 + uVar10) * -0x30e4432345000000 ^ uVar16) >>
                    (bVar22 & 0x3f));
      ...
      if (uVar36 - 0x20 < uVar8) {
        ...
        do {
          *(int *)(this_ptr + 0x40 + (uint64_t)((uint)uVar16 & 7) * 4) =
               (int)((*(int64_t *)(lVar11 + uVar16) * -0x30e4432345000000 ^ uVar19) >>
                    (bVar17 & 0x3f));
          uVar16 = uVar16 + 1;
        } while (uVar8 != uVar16);
      }
    ...
    if ((uint)uVar10 < uVar36) {
      ...
      do {
        ...
        *(int *)(this_ptr + 0x40 + uVar19 * 4) =
             (int)((*(int64_t *)(lVar6 + 8 + uVar10) * -0x30e4432345000000 ^
    ...
    *(int *)(this_ptr + 0x40 + (uint64_t)(uVar36 & 7) * 4) =
         (int)((*(int64_t *)((uVar37 & 0xffffffff) + 8 + lVar11) * -0x30e4432345000000 ^ uVar9) >>
              (bVar22 & 0x3f));
  }
  else {
    uVar8 = (uint)((*arg1 * -0x30e4432345000000 ^ uVar9) >> (0x38U - cVar28 & 0x3f));
    *(uint *)(this_ptr + 0x2c) = uVar36;
  }
