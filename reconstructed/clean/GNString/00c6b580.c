...
void FUN_00c6b580(ushort *param_1,uint param_2,uint64_t param_3,int param_4)

{
  ...
  *arg1 = *this_ptr;
  ...
  if (uVar17 == 0) {
    ...
    _memcpy((void *)(uint64_t)(local_res8 - 1U),(void *)((uint64_t)(param_2 - 1) << 2),0);
    return;
  }
  uVar27 = 0x20 - param_4;
  bVar14 = (byte)uVar27;
  if (uVar17 == 0x1f) {
    ...
    uVar25 = (uint64_t)param_2;
    uVar13 = uVar25 - 1;
    uVar23 = 1;
    if ((7 < uVar13) && ((this_ptr + uVar25 <= arg1 + 1 || (arg1 + uVar25 <= this_ptr)))
       ) {
      ...
      do {
        piVar1 = this_ptr + uVar29;
        iVar12 = piVar1[1];
        iVar46 = piVar1[2];
        iVar22 = piVar1[3];
        piVar2 = this_ptr + uVar29 + 1;
        iVar24 = piVar2[1];
        iVar26 = piVar2[2];
        iVar30 = piVar2[3];
        piVar3 = this_ptr + uVar29 + 4;
        iVar38 = *piVar3;
        iVar41 = piVar3[1];
        iVar43 = piVar3[2];
        iVar45 = piVar3[3];
        piVar3 = this_ptr + uVar29 + 5;
        iVar47 = *piVar3;
        iVar8 = piVar3[1];
        iVar9 = piVar3[2];
        iVar10 = piVar3[3];
        piVar3 = arg1 + uVar29 + 1;
    ...
    if ((param_2 & 1) == 0) {
      arg1[uVar23] =
           (int)(this_ptr[uVar23] - this_ptr[uVar23 - 1] << (bVar14 & 0x1f)) >> (bVar14 & 0x1f);
      uVar23 = uVar23 + 1;
    }
    if (uVar13 + uVar25 == 0) {
      return;
    ...
    do {
      arg1[uVar23] =
           (int)(this_ptr[uVar23] - this_ptr[uVar23 - 1] << (bVar14 & 0x1f)) >> (bVar14 & 0x1f);
      arg1[uVar23 + 1] =
           (int)(this_ptr[uVar23 + 1] - this_ptr[uVar23] << (bVar14 & 0x1f)) >> (bVar14 & 0x1f);
      uVar23 = uVar23 + 2;
    } while (uVar25 != uVar23);
    return;
  }
  ...
  if (0 < (int)uVar17) {
    ...
    if ((7 < uVar13) && ((this_ptr + uVar25 <= arg1 + 1 || (arg1 + uVar25 <= this_ptr)))
      ...
      do {
        ...
        *(uint8_t (*) [16])(arg1 + uVar29 + 5) = in_XMM3;
        uVar29 = uVar29 + 8;
      } while (uVar18 != uVar29);
...
LAB_00c6b81c:
  ...
  if (uVar17 == 4) {
    ...
    if (5 < (int)param_2) {
      uVar13 = 5;
      do {
        iVar46 = this_ptr[uVar13 - 5];
        iVar30 = iVar46 - this_ptr[uVar13 - 1];
        iVar26 = iVar46 - this_ptr[uVar13 - 2];
        iVar24 = iVar46 - this_ptr[uVar13 - 3];
        iVar22 = iVar46 - this_ptr[uVar13 - 4];
        local_40 = (short)uVar17;
        iVar46 = (this_ptr[uVar13] -
    ...
    *param_1 = uVar5;
    ...
    if (9 < (int)param_2) {
      uVar13 = 9;
      do {
        iVar46 = this_ptr[uVar13 - 9];
        iVar24 = iVar46 - this_ptr[uVar13 - 1];
        iVar22 = iVar46 - this_ptr[uVar13 - 2];
        iVar45 = iVar46 - this_ptr[uVar13 - 3];
        iVar26 = iVar46 - this_ptr[uVar13 - 4];
        iVar41 = iVar46 - this_ptr[uVar13 - 5];
        iVar30 = iVar46 - this_ptr[uVar13 - 6];
        iVar43 = iVar46 - this_ptr[uVar13 - 7];
        iVar38 = iVar46 - this_ptr[uVar13 - 8];
    ...
    *param_1 = (ushort)local_5c;
    ...
    if ((int)uVar17 < 1) {
      lVar31 = (int64_t)(int)uVar17 + 1;
      lVar19 = 0x100000000 - (uVar13 << 0x20);
      do {
        iVar46 = this_ptr[lVar31 - (int)uVar42];
        iVar22 = (this_ptr[lVar31] - ((iVar12 >> (bVar15 & 0x1f)) + iVar46) << (bVar14 & 0x1f)) >>
                 (bVar14 & 0x1f);
        lVar40 = lVar31 * 4 + -4;
        arg1[lVar31] = iVar22;
        ...
        if ((int)uVar17 < 1) {
          if ((int)uVar17 < 0) {
            ...
            do {
              ...
              iVar26 = iVar46 - *(int *)((int64_t)this_ptr + (lVar21 >> 0x1e) + lVar40);
      ...
      lVar19 = (int64_t)(int)uVar42;
      uVar23 = (uint64_t)(uVar17 & 0xfffffff8);
      puVar44 = this_ptr + lVar19 + -4;
      puVar48 = this_ptr + lVar19 + -1;
      lVar40 = 0x100000000 - (uVar13 << 0x20);
      lVar31 = lVar19;
      do {
        iVar46 = this_ptr[lVar31 - lVar19];
        if (uVar17 < 8) {
          iVar22 = 0;
          uVar25 = 0;
LAB_00c6bfd1:
          ...
          puVar20 = param_1 + 4;
          do {
            in_XMM3 = pmovsxwd(in_XMM3,*(void*)(puVar20 + -4));
            in_XMM4 = pmovsxwd(in_XMM4,*(void*)puVar20);
        ...
        if ((int)uVar27 < 1) {
          if ((int)uVar27 < 0) {
            ...
            lVar21 = lVar40;
            do {
              if ((int64_t)uVar25 < 1) break;
              iVar26 = iVar46 - *(int *)((int64_t)piVar1 + (lVar21 >> 0x1e) + -4);
