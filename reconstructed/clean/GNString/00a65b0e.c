...

{
  ...
  for (lVar22 = *(int64_t *)(this_ptr + 0x90); lVar22 != *(int64_t *)(this_ptr + 0x98);
      lVar22 = lVar22 + 1) {
  ...
  for (plVar23 = *(int64_t **)(this_ptr + 0xf8); plVar23 != *(int64_t **)(this_ptr + 0x100);
      plVar23 = plVar23 + 4) {
    iVar1 = (**(code **)(*plVar23 + 0x18))();
    iVar4 = iVar4 + iVar1;
  }
