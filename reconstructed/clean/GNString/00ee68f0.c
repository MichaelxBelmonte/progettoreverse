...
uint64_t FUN_00ee68f0(uint64_t *param_1,uint64_t *param_2)

{
  ...
  uVar35 = (int64_t)arg1 - lVar12;
  uVar17 = *(uint *)(this_ptr + 0x1c);
  uVar34 = (uint)uVar35;
  uVar6 = uVar34 - uVar9;
  ...
  if (*(uint *)(this_ptr + 0x10c) < 5) {
    uVar17 = *(uint *)(this_ptr + 0x10c);
  }
  iVar37 = 1 << ((byte)uVar17 & 0x1f);
  puVar7 = *(void**)(this_ptr + 0xf8);
  uVar26 = *arg1 * -0x30e4432345000000 >> (0x38U - *(char *)((int64_t)puVar7 + 0x34) & 0x3f);
  uVar18 = (uint64_t)((uint)(uVar26 >> 3) & 0x1fffffe0);
  lVar32 = *(int64_t *)(this_ptr + 0x70);
  lVar21 = *(int64_t *)(this_ptr + 0x38);
  uVar17 = *(uint *)(this_ptr + 0x18);
  uVar11 = *(uint64_t *)(this_ptr + 0x60);
  lVar40 = puVar7[7];
  lVar29 = puVar7[0xe];
  cVar19 = (char)*(void*)(this_ptr + 0x34);
  if (*(int *)(this_ptr + 300) == 0) {
    uVar9 = *(uint *)(this_ptr + 0x2c);
    uVar39 = (uint64_t)uVar9;
    bVar15 = 0x38 - cVar19;
    lVar31 = lVar21;
    lVar41 = lVar32;
    bVar24 = bVar15;
    if (0x180 < uVar34 - uVar9) {
      if (uVar9 < 0xffffffa0) {
        ...
        uVar14 = uVar11;
        while( true ) {
          uVar13 = (uint64_t)((uint)uVar39 & 7);
          uVar9 = *(uint *)(this_ptr + 0x40 + uVar13 * 4);
          *(int *)(this_ptr + 0x40 + uVar13 * 4) =
               (int)((*(int64_t *)(lVar12 + 8 + uVar39) * -0x30e4432345000000 ^ uVar14) >>
                    (bVar15 & 0x3f));
          uVar14 = (uint64_t)(uVar9 >> 3) & 0x1fffffe0;
          bVar24 = *(char *)(lVar21 + uVar14) - 1U & 0x1f;
          lVar31 = 0;
          if (bVar24 == 0) {
            lVar31 = 0x1f;
          }
          lVar31 = (uint64_t)bVar24 + lVar31;
        ...
        lVar31 = *(int64_t *)(this_ptr + 0x38);
        lVar41 = *(int64_t *)(this_ptr + 0x70);
        bVar24 = 0x38 - (char)*(void*)(this_ptr + 0x34);
      }
      uVar39 = (uint64_t)(uVar34 - 0x20);
      uVar9 = 0;
      if (uVar39 + lVar12 <= (int64_t)arg1 + 1U) {
        uVar9 = ((int)((int64_t)arg1 + 1U) - (int)(uVar39 + lVar12)) + 1;
      }
      uVar25 = 8;
      if (uVar9 < 8) {
        uVar25 = uVar9;
      ...
      if (uVar34 - 0x20 < uVar9) {
        ...
        do {
          *(int *)(this_ptr + 0x40 + (uint64_t)((uint)uVar14 & 7) * 4) =
               (int)((*(int64_t *)(lVar12 + uVar14) * -0x30e4432345000000 ^ uVar27) >>
                    (bVar24 & 0x3f));
          uVar14 = uVar14 + 1;
        } while (uVar9 != uVar14);
      }
    ...
    if ((uint)uVar39 < uVar34) {
      ...
      do {
        uVar27 = (uint64_t)((uint)uVar39 & 7);
        uVar9 = *(uint *)(this_ptr + 0x40 + uVar27 * 4);
        *(int *)(this_ptr + 0x40 + uVar27 * 4) =
             (int)((*(int64_t *)(lVar8 + 8 + uVar39) * -0x30e4432345000000 ^
                   *(uint64_t *)(this_ptr + 0x60)) >> (bVar24 & 0x3f));
        uVar27 = (uint64_t)(uVar9 >> 3) & 0x1fffffe0;
    ...
    *(uint *)(this_ptr + 0x2c) = uVar34;
    uVar9 = *(uint *)(this_ptr + 0x40 + (uint64_t)(uVar34 & 7) * 4);
    *(int *)(this_ptr + 0x40 + (uint64_t)(uVar34 & 7) * 4) =
         (int)((*(int64_t *)((uVar35 & 0xffffffff) + 8 + lVar12) * -0x30e4432345000000 ^ uVar11) >>
              (bVar15 & 0x3f));
  }
  else {
    uVar9 = (uint)((*arg1 * -0x30e4432345000000 ^ uVar11) >> (0x38U - cVar19 & 0x3f));
    *(uint *)(this_ptr + 0x2c) = uVar34;
  }
  puVar2 = (uint64_t *)(lVar12 + (uint64_t)uVar17);
  pbVar28 = (byte *)(lVar40 + uVar18);
  *(int *)(this_ptr + 0x68) = *(int *)(this_ptr + 0x68) + uVar9;
  uVar35 = (uint64_t)(uVar9 >> 3 & 0xffffffe0);
  bVar24 = *(byte *)(lVar21 + uVar35);
  puVar36 = (void*)(lVar21 + uVar35);
  auVar42 = pshufb(ZEXT416(uVar9),(uint8_t  [16])0x0);
  ...
  if (uVar25 != 0) {
    ...
    do {
      ...
      uVar35 = (uint64_t)((int)lVar31 + (uint)bVar24 & 0x1f);
      if (uVar35 != 0) {
        uVar25 = *(uint *)(lVar32 + uVar35 * 4);
        if (uVar25 < uVar6) goto LAB_00ee6c97;
        *(uint *)(local_138[0] + lVar40 * 4) = uVar25;
        lVar40 = lVar40 + 1;
        iVar37 = iVar37 + -1;
      }
      uVar11 = uVar11 & uVar11 - 1;
      if ((uVar11 == 0) || (iVar37 == 0)) goto LAB_00ee6c97;
    } while( true );
  }
  lVar40 = 0;
LAB_00ee6c97:
  uVar35 = (uint64_t)(bVar24 - 1 & 0x1f);
  if (uVar35 == 0) {
    lVar21 = 0x1f;
  }
  ...
  *(int *)(lVar32 + lVar21 * 4) = iVar5;
  ...
  if (lVar40 == 0) {
    ...
    do {
      ...
      puVar22 = (uint64_t *)(lVar12 + (uint64_t)uVar6);
      if (*(int *)((uVar35 - 3) + (int64_t)puVar22) == *(int *)((int64_t)arg1 + (uVar35 - 3))
         ) {
        puVar23 = arg1;
        if (arg1 < puVar1) {
          uVar11 = *arg1 ^ *puVar22;
          if (uVar11 == 0) {
            lVar21 = lVar12 + 8 + (uint64_t)uVar6;
            lVar31 = 0;
            do {
              puVar23 = (uint64_t *)((int64_t)arg1 + lVar31 + 8);
              if (puVar1 <= puVar23) {
                puVar22 = (uint64_t *)(lVar21 + lVar31);
                goto LAB_00ee6d46;
              }
              lVar41 = lVar31 + 8;
              uVar11 = *(uint64_t *)((int64_t)arg1 + lVar31 + 8) ^
                       *(uint64_t *)(lVar21 + lVar31);
              lVar31 = lVar41;
            } while (uVar11 == 0);
            uVar39 = 0;
            if (uVar11 != 0) {
...
LAB_00ee6d46:
          if ((puVar23 < (uint64_t *)((int64_t)param_2 - 3U)) && ((int)*puVar22 == (int)*puVar23))
          {
            puVar23 = (uint64_t *)((int64_t)puVar23 + 4);
            puVar22 = (uint64_t *)((int64_t)puVar22 + 4);
          }
          if ((puVar23 < (uint64_t *)((int64_t)param_2 - 1U)) &&
          ...
          if (puVar23 < param_2) {
            puVar23 = (uint64_t *)
                      ((int64_t)puVar23 + (uint64_t)((char)*puVar22 == (char)*puVar23));
          }
          uVar39 = (int64_t)puVar23 - (int64_t)arg1;
        }
        if ((uVar35 < uVar39) &&
           (*param_1 = (uint64_t)((uVar34 + 3) - uVar6), uVar35 = uVar39,
           (uint64_t *)((int64_t)arg1 + uVar39) == param_2)) break;
      }
      lVar32 = lVar32 + 1;
    } while (lVar32 != lVar40);
  }
  puVar22 = (uint64_t *)((int64_t)arg1 + 4);
  uVar6 = *(uint *)(puVar7 + 3);
  pcVar3 = (char *)*puVar7;
  lVar32 = puVar7[1];
  uVar9 = *pbVar28 & 0x1f;
  ...
  if ((uVar25 != 0) && (iVar37 != 0)) {
    ...
    do {
      ...
      uVar26 = (uint64_t)((int)lVar40 + uVar9 & 0x1f);
      if (uVar26 != 0) {
        uVar25 = *(uint *)(lVar29 + uVar18 * 4 + uVar26 * 4);
        if (uVar25 < uVar6) goto LAB_00ee6f28;
        *(uint *)(local_138[0] + lVar21 * 4) = uVar25;
        lVar21 = lVar21 + 1;
        iVar37 = iVar37 + -1;
      }
      uVar11 = uVar11 & uVar11 - 1;
      if ((uVar11 == 0) || (iVar37 == 0)) goto LAB_00ee6f28;
    } while( true );
  }
  goto LAB_00ee719f;
LAB_00ee6f28:
  if (lVar21 != 0) {
    uVar11 = *arg1;
    lVar12 = (uint64_t)uVar17 + lVar12 + 8;
    lVar40 = 0;
    uVar18 = uVar35;
    do {
      uVar35 = (uint64_t)*(uint *)(local_138[0] + lVar40 * 4);
      if (*(int *)(lVar32 + uVar35) == (int)uVar11) {
        puVar38 = (uint64_t *)(lVar32 + uVar35 + 4);
        puVar23 = (uint64_t *)(((int64_t)pcVar3 - (int64_t)puVar38) + (int64_t)puVar22);
        if (param_2 <= puVar23) {
          puVar23 = param_2;
        }
        puVar30 = puVar22;
        puVar33 = puVar38;
        if (puVar22 < (uint64_t *)((int64_t)puVar23 - 7U)) {
          uVar26 = *puVar22 ^ *puVar38;
          if (uVar26 == 0) {
            lVar29 = lVar32 + 0xc + uVar35;
            lVar31 = 0;
            do {
              puVar30 = (uint64_t *)((int64_t)arg1 + lVar31 + 0xc);
              if ((uint64_t *)((int64_t)puVar23 - 7U) <= puVar30) {
                puVar33 = (uint64_t *)(lVar29 + lVar31);
                goto LAB_00ee703d;
              }
              lVar41 = lVar31 + 8;
              uVar35 = *(uint64_t *)((int64_t)arg1 + lVar31 + 0xc) ^
                       *(uint64_t *)(lVar29 + lVar31);
              lVar31 = lVar41;
            } while (uVar35 == 0);
            uVar26 = 0;
            if (uVar35 != 0) {
...
LAB_00ee703d:
          if ((puVar30 < (uint64_t *)((int64_t)puVar23 - 3U)) && ((int)*puVar33 == (int)*puVar30))
          {
            puVar30 = (uint64_t *)((int64_t)puVar30 + 4);
            puVar33 = (uint64_t *)((int64_t)puVar33 + 4);
          }
          if ((puVar30 < (uint64_t *)((int64_t)puVar23 - 1U)) &&
          ...
          if (puVar30 < puVar23) {
            puVar30 = (uint64_t *)
                      ((int64_t)puVar30 + (uint64_t)((char)*puVar33 == (char)*puVar30));
          }
          uVar35 = (int64_t)puVar30 - (int64_t)puVar22;
        }
        if ((char *)((int64_t)puVar38 + uVar35) == pcVar3) {
          puVar23 = (uint64_t *)((int64_t)puVar22 + uVar35);
          puVar30 = puVar2;
          puVar38 = puVar23;
          if (puVar23 < puVar1) {
            ...
            if (uVar26 == 0) {
              lVar29 = 0;
              do {
                puVar38 = (uint64_t *)((int64_t)arg1 + lVar29 + uVar35 + 0xc);
                if (puVar1 <= puVar38) {
                  puVar30 = (uint64_t *)(lVar29 + lVar12);
                  goto LAB_00ee70fa;
                }
                lVar31 = lVar29 + 8;
                uVar26 = *(uint64_t *)((int64_t)arg1 + lVar29 + uVar35 + 0xc) ^
                         *(uint64_t *)(lVar12 + lVar29);
                lVar29 = lVar31;
              } while (uVar26 == 0);
              uVar39 = 0;
              if (uVar26 != 0) {
...
LAB_00ee70fa:
            if ((puVar38 < (uint64_t *)((int64_t)param_2 - 3U)) &&
               ((int)*puVar30 == (int)*puVar38)) {
              puVar38 = (uint64_t *)((int64_t)puVar38 + 4);
              puVar30 = (uint64_t *)((int64_t)puVar30 + 4);
            }
            if ((puVar38 < (uint64_t *)((int64_t)param_2 - 1U)) &&
            ...
            if (puVar38 < param_2) {
              puVar38 = (uint64_t *)
                        ((int64_t)puVar38 + (uint64_t)((char)*puVar30 == (char)*puVar38));
            }
            uVar39 = (int64_t)puVar38 - (int64_t)puVar23;
          }
