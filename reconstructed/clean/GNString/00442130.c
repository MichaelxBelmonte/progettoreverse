...
void FUN_00442130(void* param_1)
...
LAB_00442324:
      (**(code **)(**(int64_t **)(this_ptr + 0x28) + 0x9e0))();
      if ((local_58 != '\0') && (local_60 != 0)) {
        FUN_00d50b20();
      }
    }
...
LAB_0044245f:
      local_78 = g_026f6de0;
      local_38 = local_60;
      if (g_026f6de0 != (int64_t *)0x0) {
        FUN_00d50b00();
      }
      dVar11 = (double)FUN_00e7d6f0();
      uVar6 = (uint64_t)(dVar11 * g_023907c0);
      dVar11 = dVar11 * g_023907c0 - g_023907c8;
      FUN_0071a120();
      if ((local_58 == '\0') && (local_60 != 0)) {
        FUN_00d50b00();
      }
      bVar3 = (byte)(((int64_t)dVar11 & (int64_t)uVar6 >> 0x3f | uVar6) / 3);
      local_70 = '\0';
      FUN_000175c0();
      if (local_58 == '\0') {
        if (local_60 != 0) {
      ...
      if ((local_60 != 0 & bVar3) == 0) {
        (**(code **)(**(int64_t **)(this_ptr + 0x28) + 0x9d0))();
...
LAB_0044299b:
    while( true ) {
      ...
      local_60 = *(int64_t *)(*(int64_t *)(local_68 + 0x10) + 8 + lVar7 * 8);
      pvVar5 = _pthread_getspecific((void*)*(int64_t *)(local_68 + 0x10));
      if (pvVar5 != (void *)0x0) {
        FUN_00e8b990();
      }
      FUN_012f4d60();
      if (local_70 == '\0') goto LAB_00442a40;
      if (local_78 != (int64_t *)0x0) goto LAB_00442a70;
    }
    FUN_000be170();
  }
  FUN_006f4810();
