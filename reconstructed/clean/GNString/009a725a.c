...
void FUN_009a725a(int64_t param_1,int64_t *param_2,char param_3)

{
  ...
  if (uVar7 == 0) {
    ...
    uVar6 = *(int64_t *)(param_1 + 0x80) - *(int64_t *)(param_1 + 0x78);
    if (uVar6 < uVar9) {
      FUN_009a8930(uVar6,&local_278);
    }
    else if (uVar9 < uVar6) {
      *(uint64_t *)(param_1 + 0x80) = *(int64_t *)(param_1 + 0x78) + uVar9;
    }
  }
  *(uint *)((int64_t)param_2 + 0x14) = uVar7;
  ...
  if (iVar8 != 0) {
    ...
    if (iVar8 == 1) {
      *(void*)(this_ptr + 0x3fc) = 0;
      FUN_0098ef68();
      *(void*)(this_ptr + 0x3fc) = 1;
    }
  }
  FUN_0092ca9c();
  uVar5 = 0;
  FUN_0098ce6c(0,1,this_ptr + 0x438);
  (**(code **)(local_278 + 0x10))();
  if (uVar7 != 0) {
    if (param_3 != '\0') {
      uVar5 = 0;
    ...
    if (*(int *)(this_ptr + 0x3fc) == 1) {
      *(void*)(this_ptr + 0x3fc) = 0;
      (**(code **)(*(int64_t *)(this_ptr + 0x270) + 0x28))();
      *(void*)(this_ptr + 0x3fc) = 1;
    }
    (**(code **)(local_278 + 0x10))();
  }
  ...
  *(int64_t **)(this_ptr + 8) = plVar4;
  *(int64_t *)(this_ptr + 0x18) = *(int64_t *)(this_ptr + 0x18) + 1;
  *(int *)(this_ptr + 0x418) = *(int *)(this_ptr + 0x418) + 1;
  FUN_0098ce7c();
