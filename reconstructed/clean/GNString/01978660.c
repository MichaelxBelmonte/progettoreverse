...
void FUN_01978660(void* param_1)

{
  ...
  plVar3 = local_40;
  if (local_38 == '\0') {
    if (local_40 == (int64_t *)0x0) goto LAB_01978f2b;
    FUN_00d50b00();
    if ((local_38 != '\0') && (local_40 != (int64_t *)0x0)) {
      FUN_00d50b20();
    }
  }
  else if (local_40 == (int64_t *)0x0) goto LAB_01978f2b;
  pvVar6 = _pthread_getspecific(param_1);
  if (pvVar6 != (void *)0x0) {
    FUN_00e8b990();
  }
  ...
  fStack_94 = (float)((uint64_t)dVar10 >> 0x20);
  pvVar6 = _pthread_getspecific(param_1);
  if (pvVar6 != (void *)0x0) {
    FUN_00e8b990();
  }
  ...
  if (cVar5 == '\0') {
    ...
    if (bVar7) {
      ...
      if (dVar10 < dVar11) {
        ...
        fStack_94 = (float)((uint64_t)uVar9 >> 0x20);
        if ((local_38 != '\0') && (local_40 != (int64_t *)0x0)) {
          FUN_00d50b20();
        }
        if ((local_48 != '\0') && (local_50 != 0)) {
  ...
  auVar14._0_4_ = (float)auVar15._0_8_ + g_02394240;
  ...
  uStack_f4 = (uint32_t)((uint64_t)uVar12 >> 0x20);
  uStack_f0 = (uint32_t)extraout_XMM0_Qb_01;
  uStack_ec = (uint32_t)((uint64_t)extraout_XMM0_Qb_01 >> 0x20);
  auVar16._4_12_ = local_88._4_12_;
  auVar16._0_4_ = SUB84(local_88,0) - local_98;
  auVar1._4_4_ = uStack_f4;
  auVar1._0_4_ = local_f8 * g_023908e0;
