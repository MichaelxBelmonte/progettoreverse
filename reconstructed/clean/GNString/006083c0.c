...
void FUN_006083c0(uint64_t param_1,uint64_t param_2)

{
  ...
  switch((int)this_ptr[0x3e]) {
  case 0:
    uVar11 = (**(code **)(*this_ptr + 0x938))();
    local_98 = (float)uVar11;
    fStack_94 = (float)((uint64_t)uVar11 >> 0x20);
    fStack_90 = (float)extraout_XMM0_Qb;
    fStack_8c = (float)((uint64_t)extraout_XMM0_Qb >> 0x20);
    (**(code **)(*this_ptr + 0x938))();
    auVar15 = _local_88;
    local_a8 = (uint8_t  [8])(**(code **)(*this_ptr + 0x938))();
  ...
  case 1:
    ...
    fStack_8c = (float)((uint64_t)extraout_XMM0_Qb_01 >> 0x20);
    (**(code **)(*this_ptr + 0x938))();
    auVar15 = _local_88;
    local_a8 = (uint8_t  [8])(**(code **)(*this_ptr + 0x938))();
  ...
  case 2:
    ...
    fStack_8c = (float)((uint64_t)extraout_XMM0_Qb_03 >> 0x20);
    (**(code **)(*this_ptr + 0x938))();
    auVar15 = _local_88;
    local_a8 = (uint8_t  [8])(**(code **)(*this_ptr + 0x938))();
  ...
  case 3:
    ...
    fStack_8c = (float)((uint64_t)extraout_XMM0_Qb_05 >> 0x20);
    (**(code **)(*this_ptr + 0x938))();
    auVar15 = _local_88;
    local_a8 = (uint8_t  [8])(**(code **)(*this_ptr + 0x938))();
...
LAB_0060879a:
  ...
  if (lVar7 != 0) {
    ...
    if (bVar4) {
      ...
      while( true ) {
        ...
        auVar15._12_4_ = 0;
        *(uint8_t (*) [16])(lVar7 + 0x28) = auVar15 << 0x20;
  ...
  if (bVar4) {
    ...
    *pcVar8 = '\0';
    ...
    if (((fVar14 == 0.0) && (!NAN(fVar14))) || (lVar7 = this_ptr[0x32], lVar7 == 0))
    goto LAB_00608c8b;
    local_68 = 0;
...
LAB_00608b2c:
      ...
      if (uVar1 - 1 < 3) {
        ...
        uVar10 = 0;
        do {
          lVar2 = *(int64_t *)(lVar7 + uVar10 * 8);
          *(float *)(lVar2 + 0x28) = *(float *)(lVar2 + 0x28) - fVar14;
          lVar2 = *(int64_t *)(lVar7 + 8 + uVar10 * 8);
          *(float *)(lVar2 + 0x28) = *(float *)(lVar2 + 0x28) - fVar14;
          lVar2 = *(int64_t *)(lVar7 + 0x10 + uVar10 * 8);
          *(float *)(lVar2 + 0x28) = *(float *)(lVar2 + 0x28) - fVar14;
          local_68 = *(int64_t *)(lVar7 + 0x18 + uVar10 * 8);
      ...
      if (uVar9 != 0) {
        ...
        do {
          local_68 = *(int64_t *)(lVar7 + uVar10 * 8);
          *(float *)(local_68 + 0x28) = *(float *)(local_68 + 0x28) - fVar14;
          uVar10 = uVar10 + 1;
          uVar9 = uVar9 - 1;
        } while (uVar9 != 0);
...
LAB_00608c8b:
  ...
  if (this_ptr[0x39] != 0) {
    if (*(int *)(this_ptr[0x32] + 0xc) == *(int *)(this_ptr[0x31] + 0xc)) {
      FUN_01e40eb0();
      if ((local_60[0] != '\0') && (local_68 != 0)) {
        FUN_00d50b20();
      }
      if (local_68 != 0) {
        (**(code **)(*(int64_t *)this_ptr[0x39] + 0x478))();
      }
    }
    else {
      FUN_01e40eb0();
