...
void FUN_0190a380(double param_1,double param_2,uint64_t param_3)
...
LAB_0190abd2:
    ...
    local_c0 = dVar13;
    cVar3 = FUN_00e7b6e0(*(void*)(this_ptr + 0x20));
    if (cVar3 != '\0') {
      return;
    }
    bVar2 = false;
...
LAB_0190a5b4:
  ...
  if (lVar10 != 0) {
    ...
    if (bVar2) {
      while( true ) {
        ...
        local_70 = *(int64_t *)(*(int64_t *)(lVar10 + 0x10) + 8 + lVar6 * 8);
        FUN_01677ae0();
        uVar7 = ~uStack_54;
        if (uVar7 != 0) {
          if ((int)uStack_54 < 0) {
      ...
      while( true ) {
        ...
        local_70 = *(int64_t *)(lVar9 + 8 + lVar6 * 8);
        FUN_01677b00();
  ...
  if (NAN(*(double *)(this_ptr + 0x20)) || uVar4 != uVar1) {
    local_38 = 0.0;
    local_d0 = (double)FUN_00e7b500(g_023908c8);
  }
  else {
    local_38 = *(double *)(this_ptr + 0x28);
    local_d0 = (double)FUN_00e7b600(*(double *)(this_ptr + 0x20),local_38,local_a0,local_c0);
  }
  lVar10 = local_70;
  if (NAN(local_d0)) {
    ...
    if (local_70 == 0) {
      ...
      local_98 = CONCAT71((int7)((uint64_t)local_70 >> 8),1);
      if (local_68 == '\0') {
        FUN_00d50b00();
      }
    }
...
LAB_0190a97e:
  ...
  if (0 < *(int *)(lVar10 + 0xc)) {
    if (NAN(local_d0)) {
      ...
      dVar13 = local_d0;
      do {
        lVar9 = *(int64_t *)(*(int64_t *)(lVar10 + 0x10) + lVar6 * 8);
        local_d8 = 0;
        local_e0 = lVar9;
      ...
      lVar6 = 0;
      do {
        local_b8 = *(int64_t *)(*(int64_t *)(lVar10 + 0x10) + lVar6 * 8);
        local_b0 = '\0';
        FUN_016779b0();
        if ((local_40 == '\0') && (local_48 != 0)) {
          FUN_00d50b00();
...
LAB_0190adea:
  *(double *)(this_ptr + 0x20) = local_a0;
  *(double *)(this_ptr + 0x28) = local_c0;
  return;
}
