...
uint FUN_00d92950(uint64_t param_1,int64_t *param_2)

{
  ...
  if ((param_1 & 8) != 0) {
    ...
    uVar5 = _CFStringCompareWithOptionsAndLocale(lVar20,(int64_t)iVar19,uVar18,uVar6);
    _CFRelease();
    _CFRelease();
    return uVar5;
  }
  ...
  if (iVar1 != -1) {
    if (*(int *)(lVar16 + 0x20) != -1) {
      ...
      if (arg1 >> 0x20 == 0) {
        ...
        lVar16 = (int64_t)iVar19 * 2 + *(int64_t *)(this_ptr + 0x18);
        if ((param_1 & 1) == 0) {
          uVar12 = *puVar15;
          if (uVar12 == 0) {
            uVar5 = 1;
            ...
            do {
              ...
              uVar12 = *(ushort *)((int64_t)puVar15 + lVar10 + 2);
              lVar13 = lVar10 + 2;
            } while (uVar12 != 0);
            uVar5 = 1;
LAB_00d92d8a:
            puVar15 = (ushort *)((int64_t)puVar15 + lVar10 + 2);
          }
        }
        else {
          lVar13 = 0;
          do {
            uVar12 = *(ushort *)((int64_t)puVar15 + lVar13);
            if (uVar12 == 0) break;
          ...
          puVar15 = (ushort *)((int64_t)puVar15 + lVar13);
          uVar5 = (uint)(uVar12 == 0);
        }
      }
      bVar21 = *puVar15 == 0;
    ...
    if (*(int64_t *)(this_ptr + 0x10) == 0) {
      ...
      *(void*)(lVar16 + *(int *)(this_ptr + 0x20)) = 0;
      cVar3 = FUN_00e31450(3);
      if ((cVar3 == '\0') && (lVar16 != this_ptr + 0x28)) {
        FUN_00e83070();
      }
    }
  }
  pcVar14 = *(char **)(this_ptr + 0x10);
  if (pcVar14 == (char *)0x0) {
    pcVar14 = "";
  }
  lVar16 = *param_2;
  if ((*(int64_t *)(lVar16 + 0x10) == 0) && (iVar1 = *(int *)(lVar16 + 0x20), iVar1 != -1)) {
    if (iVar1 < 0x18) {
      lVar13 = lVar16 + 0x28;
    }
    else {
