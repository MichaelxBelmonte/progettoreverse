...
void FUN_01966600(uint32_t param_1,uint32_t param_2)

{
  ...
  local_160 = '\x01';
  local_168 = lVar8;
  cVar4 = (**(code **)(*this_ptr + 0x9d8))();
  if (cVar4 == '\0') {
    bVar11 = 0;
  }
  else {
    bVar11 = *(byte *)((int64_t)this_ptr + 0x1c4) ^ 1;
  }
  if ((local_160 != '\0') && (local_168 != 0)) {
    FUN_00d50b20();
  }
  cVar4 = (**(code **)(*this_ptr + 0x9c8))();
  pVar10 = (void*)bVar11;
  bVar12 = 0;
  if (cVar4 == '\0') {
    bVar12 = bVar11;
  }
  if ((lVar13 == 0) && (lVar8 = this_ptr[0x3c], lVar8 != 0)) {
    pVar10 = (uint)bVar11;
    FUN_00d50b00();
    lVar13 = lVar8;
  }
  ...
  if (cVar4 == '\0') {
    ...
    if (cVar4 == '\0') {
      ...
      if (cVar4 == '\0') {
        ...
        uVar17 = 0;
        uVar18 = 0;
        fVar16 = local_6c * g_0241b63c + g_0239011c;
        local_6c = 0.0;
        if (0.0 <= fVar16) {
          local_6c = fVar16;
        }
        if ((local_78._0_4_ != g_02390124) || (NAN(local_78._0_4_) || NAN(g_02390124))) {
          FUN_01989f80();
          cVar4 = FUN_019f7810();
          local_114 = g_02390124;
          if (cVar4 == '\0') {
            local_114 = 0.0;
          }
          if ((local_38 != '\0') && (local_40 != (int64_t *)0x0)) {
...
LAB_019670b5:
              ...
              if (cVar4 == '\0') {
                ...
                if (cVar4 != '\0') {
                  ...
                  local_90 = (int64_t *)CONCAT44(local_90._4_4_,uVar15);
                  if ((local_58 != '\0') && (local_60 != (int64_t *)0x0)) {
                    FUN_00d50b20();
                  }
                  if ((local_38 != '\0') && (local_40 != (int64_t *)0x0)) {
...
LAB_019678e4:
            ...
            if (local_40 != (int64_t *)0x0) goto LAB_01967a2b;
          }
          else {
            pvVar7 = _pthread_getspecific(pVar10);
            if (pvVar7 != (void *)0x0) {
...
LAB_01967a2b:
          ...
          if (cVar4 == '\0') {
            if ((char)this_ptr[0x3e] != '\0') {
              ...
              if (g_02390124 < fVar16) {
                fVar16 = (float)_log10f();
                fVar16 = fVar16 + g_02390124;
              }
              FUN_01968ab0();
              local_198 = *arg1;
              local_190 = '\0';
            ...
            if (iVar6 == 2) {
              ...
              local_1b8 = *arg1;
              local_1b0 = '\0';
              FUN_01969230((int)this_ptr[0x38],&local_1b8,1);
              ...
              local_1a8 = *arg1;
              local_1a0 = '\0';
              FUN_01969230(g_02390124,&local_1a8,0);
