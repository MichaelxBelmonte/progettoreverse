...

{
  ...
  pbVar14 = *(byte **)(this_ptr + 0x80);
  pbVar10 = *(byte **)(this_ptr + 0x88);
  if (pbVar10 == pbVar14) {
    lVar6 = *(int64_t *)(this_ptr + 0x78);
    pbVar14 = &local_48;
    FUN_009d5ed0();
    FUN_009d8cfc(pbVar14,(int64_t)pbVar10 - lVar6);
    goto LAB_009dd4a4;
  }
  plVar1 = (int64_t *)(this_ptr + 0x88);
  plVar11 = *(int64_t **)(this_ptr + 8);
  lVar6 = *plVar11;
  cVar2 = *(char *)(lVar6 + 0x20 + (uint64_t)*pbVar10);
  uVar7 = 7;
  switch(cVar2) {
  case '\x11':
    ...
    if (lVar6 == 0) {
      lVar6 = 4;
      if ((int64_t)pbVar14 - (int64_t)pbVar10 < 5) {
        lVar6 = (int64_t)pbVar14 - (int64_t)pbVar10;
      }
      uVar7 = FUN_009dcab0(8,lVar6 + *(int64_t *)(this_ptr + 0x88));
      if (uVar7 < 0x80) {
LAB_009dd7bd:
        bVar12 = (byte)uVar7;
        goto LAB_009dd6ff;
      ...
      pbVar10 = (byte *)(*(int64_t *)(this_ptr + 0x88) + -1);
      do {
        *plVar1 = (int64_t)pbVar10;
        bVar12 = *pbVar10;
        pbVar10 = pbVar10 + -1;
      } while (*(char *)(lVar6 + 0x20 + (uint64_t)bVar12) != '\f');
      lVar6 = *(int64_t *)(this_ptr + 0x78);
      pbVar14 = &local_48;
      FUN_009d5ed0();
  ...
  case '\"':
    ...
    *plVar1 = (int64_t)pbVar9;
    ...
    else if (*(char *)(lVar6 + 0x20 + (uint64_t)*pbVar9) == '\x0f') {
      *plVar1 = (int64_t)(pbVar10 + 2);
      if (pbVar10 + 2 == pbVar14) {
        ...
        pbVar10 = *(byte **)(this_ptr + 0x88);
        if ((uVar7 < 0x80) && (pbVar10 != *(byte **)(this_ptr + 0x80))) {
          lVar6 = **(int64_t **)(this_ptr + 8);
          if (*(char *)(lVar6 + 0x20 + (uint64_t)*pbVar10) == '\x10') break;
        }
        else {
          lVar6 = **(int64_t **)(this_ptr + 8);
        }
      ...
      lVar6 = 2;
      if ((int64_t)pbVar14 - (int64_t)pbVar9 < 3) {
        lVar6 = (int64_t)pbVar14 - (int64_t)pbVar9;
      }
  ...
  case '#':
    ...
    *plVar1 = (int64_t)pbVar9;
    if (pbVar9 != pbVar14) {
      ...
      uVar7 = (uint64_t)(uVar13 - (uVar5 & 0xe0));
      pbVar10 = pbVar9;
      break;
    }
    do {
...
LAB_009dd4b3:
  ...
  default:
    if (cVar2 == '8') {
      ...
      *plVar1 = (int64_t)pbVar9;
      if (pbVar9 != pbVar14) {
        if (*(char *)(lVar6 + 0x20 + (uint64_t)*pbVar9) == '\x0f') {
          pbVar9 = pbVar10 + 2;
LAB_009dd4e2:
          pbVar8 = pbVar9;
          *plVar1 = (int64_t)pbVar8;
          ...
          pbVar14 = pbVar14 + -1;
          do {
            *plVar1 = (int64_t)pbVar14;
            uVar7 = (uint64_t)*pbVar14;
            pbVar14 = pbVar14 + -1;
          } while (*(char *)(lVar6 + 0x20 + uVar7) != '\f');
          pbVar9 = pbVar14 + (1 - *(int64_t *)(this_ptr + 0x78));
          goto LAB_009dd940;
        }
        goto LAB_009dd91b;
      }
      do {
        *plVar1 = (int64_t)pbVar10;
        uVar7 = (uint64_t)*pbVar10;
        pbVar10 = pbVar10 + -1;
      } while (*(char *)(lVar6 + 0x20 + uVar7) != '\f');
      pbVar9 = pbVar10 + (1 - *(int64_t *)(this_ptr + 0x78));
      goto LAB_009dd940;
    }
    goto switchD_009dd40a_caseD_13;
  }
switchD_009dd40a_caseD_1c:
  bVar12 = (byte)uVar7;
  *plVar1 = (int64_t)(pbVar10 + 1);
LAB_009dd6ff:
  return (int)(char)bVar12;
code_r0x009dd4ee:
  pbVar9 = pbVar8 + 1;
  if (*(char *)(lVar6 + 0x20 + (uint64_t)*pbVar8) == '\x10') goto code_r0x009dd4fb;
  goto LAB_009dd4e2;
code_r0x009dd4fb:
  *plVar1 = (int64_t)(pbVar8 + 1);
  bVar12 = (byte)&local_48;
  FUN_009df20a(pbVar8,pbVar10 + 2);
  bVar4 = local_48 & 1;
  if (bVar4 == 0) {
    local_40 = (byte *)(uint64_t)(local_48 >> 1);
  }
  if (local_40 == (byte *)((int64_t)&MACH_HEADER.magic + 1)) {
    local_40 = local_38;
    if (bVar4 == 0) {
      local_40 = local_47;
    }
    ...
    lVar6 = **(int64_t **)(this_ptr + 8);
    local_40 = (byte *)(*(int64_t *)(this_ptr + 0x88) + -1);
    do {
      *plVar1 = (int64_t)local_40;
      bVar12 = *local_40;
      local_40 = local_40 + -1;
    } while (*(char *)(lVar6 + 0x20 + (uint64_t)bVar12) != '\f');
    local_40 = local_40 + (1 - *(int64_t *)(this_ptr + 0x78));
  ...
  plVar11 = *(int64_t **)(this_ptr + 8);
  pbVar9 = *(byte **)(this_ptr + 0x88);
LAB_009dd91b:
  lVar6 = *plVar11;
  pbVar9 = pbVar9 + -1;
  do {
    *plVar1 = (int64_t)pbVar9;
    uVar7 = (uint64_t)*pbVar9;
    pbVar9 = pbVar9 + -1;
  } while (*(char *)(lVar6 + 0x20 + uVar7) != '\f');
  pbVar9 = pbVar9 + (1 - *(int64_t *)(this_ptr + 0x78));
LAB_009dd940:
