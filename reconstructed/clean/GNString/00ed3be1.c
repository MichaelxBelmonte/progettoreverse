...
uint64_t FUN_00ed3be1(uint64_t *param_1,uint64_t *param_2)

{
  ...
  do {
    ...
    uVar20 = (uint64_t)(*(int64_t *)(lVar4 + uVar9) * -0x30e4432340650000) >> (bVar12 & 0x3f);
  ...
  *(uint *)(this_ptr + 0x2c) = uVar17;
  uVar8 = *(uint *)(lVar6 + (*arg1 * -0x30e4432340650000 >> (bVar12 & 0x3f)) * 4);
  if (uVar8 < uVar13) {
    return 3;
  }
  uVar9 = 3;
