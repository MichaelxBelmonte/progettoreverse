...
uint64_t FUN_00ed458f(uint64_t *param_1,uint64_t *param_2)

{
  ...
  if (arg1 < (int64_t *)(lVar6 + uVar20)) {
    ...
    if (*(uint *)(this_ptr + 0x2c) < (uint)local_90) {
      do {
        uVar10 = (uint64_t)(*(int64_t *)(lVar6 + uVar20) * -0x30e4432345000000) >> (bVar24 & 0x3f)
        ;
    ...
    *(uint *)(this_ptr + 0x2c) = (uint)local_90;
    uVar20 = (uint64_t)(*arg1 * -0x30e4432345000000) >> (bVar24 & 0x3f);
...
LAB_00ed4af3:
        ...
        if (local_38 < uVar22) {
          ...
          if ((uint64_t *)((int64_t)arg1 + uVar22) == local_68) goto LAB_00ed4c95;
        }
