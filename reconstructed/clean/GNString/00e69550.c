...
void* FUN_00e69550(uint64_t param_1,int64_t *param_2,int64_t *param_3)

{
  ...
  *(void*)pplVar8 = 0;
  ...
  iVar2 = *(int *)((int64_t)local_a0 + 0xc);
  if (((char)local_68 != '\0') && (local_a0 != (void*)0x0)) {
    FUN_00d50b20();
  }
  unaff_R13 = param_2;
  if (iVar2 == 0) goto LAB_00e6973c;
  local_f8 = *(int64_t *)(arg1 + 0x10);
  local_188 = *param_2;
...
LAB_00e696e1:
    ...
    unaff_R13 = (int64_t *)CONCAT71((int7)((uint64_t)param_2 >> 8),cVar1);
    if (local_60 == '\0') {
      if (local_68 != (int64_t *)0x0) {
        FUN_00d50b00();
      }
      *local_118 = (int64_t)plVar6;
...
LAB_00e6973c:
  ...
  if (local_90 == (int64_t *)0x0) {
    ...
    plVar9 = (int64_t *)0x0;
    local_38 = (int64_t *)((uint64_t)local_38._4_4_ << 0x20);
    local_70 = 0;
    uVar5 = 0;
    do {
      local_100 = 0;
      ...
      if (*local_178 != 0) {
        local_148 = (int64_t *)(*local_178 + 0x10);
        local_140 = '\0';
        FUN_00e92280();
      ...
      plVar6 = local_40;
      plVar9 = local_68;
      uVar7 = (undefined7)((uint64_t)local_68 >> 8);
      if (local_40 == local_68) {
        ...
        if (((char)local_38 == '\0') && (local_40 != (int64_t *)0x0)) {
          ...
          local_48 = (uint64_t)local_38 & 0xffffffff;
          uVar5 = local_48;
        }
joined_r0x00e69b99:
        if ((local_60 != '\0') && (local_68 != (int64_t *)0x0)) {
...
LAB_00e69c57:
        plVar6 = (int64_t *)(local_a8 & 0xffffffff);
      }
      else {
        plVar6 = (int64_t *)CONCAT71((int7)(uVar5 >> 8),(char)local_98);
        if (local_a0 == (void*)local_70) {
          if (((char)local_98 == '\0') || ((char)local_a8 != '\0')) goto LAB_00e69c57;
          plVar6 = (int64_t *)CONCAT71((int7)((uint64_t)unaff_R13 >> 8),1);
          FUN_00d50b00();
        }
        else {
          if ((char)local_98 != '\0') {
            local_38 = (int64_t *)CONCAT44(local_38._4_4_,(int)local_48);
            local_40 = plVar9;
            FUN_00d50b00();
          }
          if (((char)local_a8 == '\0') || (local_70 == 0)) {
            local_70 = (int64_t)puVar4;
          }
          else {
            FUN_00d50b20();
            local_70 = (int64_t)puVar4;
      ...
      local_88 = '\0';
      local_38 = (int64_t *)CONCAT44(local_38._4_4_,(int)local_48);
      uVar5 = (uint64_t)plVar6 & 0xffffffff;
      unaff_R13 = plVar6;
  ...
  if (local_70 != 0) {
    ...
    puVar4 = local_a0;
    if ((char)local_98 == '\0') {
      if (((local_a0 != (void*)0x0) && (FUN_00d50b00(), (char)local_98 != '\0')) &&
         (local_a0 != (void*)0x0)) {
        FUN_00d50b20();
      }
    }
    ...
    local_a0 = (void*)*plVar9;
    local_98._0_1_ = '\0';
    FUN_00d21140();
    if (((char)local_98 != '\0') && (local_a0 != (void*)0x0)) {
      FUN_00d50b20();
    }
    local_128 = (int64_t)puVar4;
    local_120 = '\0';
    uVar10 = FUN_00d92220();
    local_b8 = local_68;
    local_b0 = 0;
