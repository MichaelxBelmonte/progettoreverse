...
int64_t * FUN_01900ad0(uint *param_1,int64_t *param_2)
...
LAB_01900e5b:
    ...
    lVar5 = (int64_t)(int)uVar4;
    if (uVar4 == *(int *)(lVar3 + 0xc) - 2U) {
      lVar3 = *(int64_t *)(*(int64_t *)(lVar3 + 0x10) + 8 + lVar5 * 8);
      dVar10 = (double)FUN_01907950();
      if (dVar9 <= dVar10) {
        lVar3 = *(int64_t *)(arg1 + 0x38);
        goto LAB_01900ce1;
...
LAB_01900ce1:
      lVar3 = *(int64_t *)(*(int64_t *)(lVar3 + 0x10) + lVar5 * 8);
      dVar10 = (double)FUN_01907950();
      if (uVar4 != 0) {
        if ((dVar10 == dVar9) && (!NAN(dVar10) && !NAN(dVar9))) {
          lVar3 = *(int64_t *)
                   (*(int64_t *)(*(int64_t *)(arg1 + 0x38) + 0x10) + -8 + lVar5 * 8);
          FUN_01907950();
        }
        goto LAB_01900d1e;
      }
    ...
    uVar4 = *param_1;
    if ((((int)uVar4 < 0) || (*(int *)(*(int64_t *)(arg1 + 0x38) + 0xc) <= (int)uVar4)) ||
       (lVar3 = *(int64_t *)(*(int64_t *)(arg1 + 0x38) + 0x10),
       *(int64_t *)(lVar3 + (uint64_t)uVar4 * 8) != *param_2)) goto LAB_01900b19;
    if ((uint64_t)uVar4 == 0) goto LAB_01900d63;
    *param_1 = uVar4 - 1;
    lVar3 = *(int64_t *)(lVar3 + (uint64_t)(uVar4 - 1) * 8);
    *(void*)(this_ptr + 1) = 0;
