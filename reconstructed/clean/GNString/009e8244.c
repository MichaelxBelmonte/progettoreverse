...
switchD_009e8284_caseD_6f:
    if ((*(byte *)(this_ptr + 0x2b) & 1) == 0) {
      if ((int)uVar6 < 0x55) {
        if (uVar6 == 0x45) {
          *(int64_t *)(this_ptr + 0x18) = lVar11 + 2;
          *(void*)(this_ptr + 0x2c) = 0;
          return;
        }
        if (uVar6 == 0x4c) {
          *(int64_t *)(this_ptr + 0x18) = lVar11 + 2;
          *(void*)(this_ptr + 0x2c) = 3;
          return;
        }
      }
      else {
        if (uVar6 == 0x55) {
          *(int64_t *)(this_ptr + 0x18) = lVar11 + 2;
          *(void*)(this_ptr + 0x2c) = 4;
          return;
        }
        if (uVar6 == 0x75) {
          *(int64_t *)(this_ptr + 0x18) = lVar11 + 2;
          *(void*)(this_ptr + 0x30) = *(void*)(this_ptr + 0x2c);
          *(void*)(this_ptr + 0x2c) = 2;
          return;
        }
        if (uVar6 == 0x6c) {
          *(int64_t *)(this_ptr + 0x18) = lVar11 + 2;
    ...
    lVar11 = 1;
    if ((int64_t)pcVar2 - (int64_t)pcVar5 < 2) {
      lVar11 = (int64_t)pcVar2 - (int64_t)pcVar5;
    }
    if (lVar11 != 0) {
      FUN_009e8d30(pcVar5 + lVar11,pcVar5 + lVar11);
      pvVar9 = (void *)((int64_t)&MACH_HEADER.cpusubtype + 2);
...
LAB_009e8576:
      ...
      if (iVar3 == 0) {
        if ((*(byte *)(this_ptr + 0x2b) & 1) != 0) goto LAB_009e8576;
        lVar7 = *(int64_t *)(this_ptr + 0x18);
        lVar11 = lVar7 + -1;
        *(int64_t *)(this_ptr + 0x18) = lVar11;
        lVar11 = *(int64_t *)(this_ptr + 0x20) - lVar11;
        lVar10 = 4;
        if (lVar11 < 5) {
          lVar10 = lVar11;
        }
      ...
      pcVar5 = *(char **)(this_ptr + 0x18);
    }
    *(char **)(this_ptr + 0x18) = pcVar5 + 1;
LAB_009e865a:
    FUN_009e818c();
    return;
  case 0x72:
  ...
  case 0x78:
    ...
    *(char **)(this_ptr + 0x18) = pcVar5;
    ...
    if (*pcVar5 == '{') {
      *(char **)(this_ptr + 0x18) = (char *)(lVar11 + 3);
      if ((char *)(lVar11 + 3) != pcVar2) {
        ...
        *(void*)(this_ptr + 0x18) = *(void*)(this_ptr + 0x18);
        ...
        if (-1 < iVar3) {
          pcVar5 = *(char **)(this_ptr + 0x18);
          if ((pcVar5 == *(char **)(this_ptr + 0x20)) || (*pcVar5 != '}')) {
            do {
              pcVar2 = pcVar5;
              pcVar5 = pcVar2 + -1;
              *(char **)(this_ptr + 0x18) = pcVar5;
      ...
      lVar7 = 2;
      if ((int64_t)pcVar2 - (int64_t)pcVar5 < 3) {
        lVar7 = (int64_t)pcVar2 - (int64_t)pcVar5;
      }
      if (lVar7 != 0) {
  ...
  default:
    ...
    case 99:
      ...
      *(char **)(this_ptr + 0x18) = param_1;
      if (param_1 == pcVar2) {
        *(char **)(this_ptr + 0x18) = pcVar2;
      }
      else {
        *(int64_t *)(this_ptr + 0x18) = lVar11 + 3;
        cVar1 = *(char *)(lVar11 + 2);
        uVar6 = (int)cVar1 + 0x1f;
        if (-1 < cVar1) {
          uVar6 = (int)cVar1;
        }
        param_1 = (char *)(uint64_t)(uVar6 & 0xe0);
      }
      goto LAB_009e829b;
    case 0x65:
      break;
