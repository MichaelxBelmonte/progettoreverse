...

{
  ...
  std::locale::~locale((locale *)this);
  std::istream::operator>>((istream *)this,(uint64_t *)plVar5);
  if ((*(uint *)((int64_t)auStack_190 + *(int64_t *)(local_1b0 + -0x18)) & 3) != 2) {
