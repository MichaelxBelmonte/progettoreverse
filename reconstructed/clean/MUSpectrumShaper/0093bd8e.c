...
void FUN_0093bd8e(uint64_t param_1,string *param_2,string *param_3,uint64_t param_4,
...

{
  ...
  psVar17 = (string *)(*(int64_t *)(this_ptr + 0x10) - *(int64_t *)(this_ptr + 8) >> 4);
  if ((uint64_t)((int64_t)psVar17 * -0x7dc11f7047dc11f7) < param_1 ||
      (int64_t)psVar17 * -0x7dc11f7047dc11f7 - param_1 == 0) {
    FUN_008f8528();
  }
  else {
    lVar28 = param_1 * 0x390;
    iVar8 = *(int *)(*(int64_t *)(this_ptr + 8) + 8 + lVar28);
    FUN_00a1c9ba();
    FUN_009bafbc();
    lVar10 = FUN_00a1c9ba();
...
LAB_0093c146:
  ...
  *(void*)(psVar2 + 8 + (int64_t)psVar29) = *(void*)(lVar10 + 0x30);
  FUN_00a1c9ba();
  FUN_009bafbc();
  lVar10 = FUN_00a1c9ba();
  *(void*)(psVar2 + 0xc + (int64_t)psVar29) = *(void*)(lVar10 + 0xa0);
  FUN_00a1c9ba();
  FUN_009bafbc();
  lVar10 = FUN_00a1c9ba();
  *(void*)(psVar2 + 0x10 + (int64_t)psVar29) = *(void*)(lVar10 + 0x34);
  FUN_00a1c9ba();
  FUN_009bafbc();
  lVar10 = FUN_00a1c9ba();
  *(void*)(psVar2 + 0x14 + (int64_t)psVar29) = *(void*)(lVar10 + 0xa4);
  FUN_00a1c9ba();
  pcVar21 = "authType";
  FUN_009bafbc();
  FUN_00a1c9ba();
  ...
  pvVar25 = local_c0;
  if ((local_c8 & 1) == 0) {
    pvVar25 = (void *)(uint64_t)(local_c8 >> 1);
  }
  pvVar22 = pvVar25;
  if (pvVar12 < pvVar25) {
    pvVar22 = pvVar12;
...
LAB_0093c2e7:
    ...
    param_3 = (string *)CONCAT71((int7)((uint64_t)param_3 >> 8),1);
    iVar8 = _memcmp((void *)(uint64_t)bVar7,pvVar22,(size_t)param_3);
...
LAB_0093c4a3:
    ...
    lVar10 = FUN_008e4ece();
    uVar11 = *(void*)(lVar10 + 0x38);
  }
LAB_0093c4b6:
  *(void*)(psVar2 + 0x30 + (int64_t)psVar29) = uVar11;
  psVar17 = psVar29;
  FUN_00a1c9ba();
  pcVar21 = "subtype";
  FUN_009bafbc();
  ...
  if ((bVar7 & 1) == 0) {
    psVar17 = (string *)(uint64_t)(bVar7 >> 1);
  }
  else {
  ...
  psVar26 = local_58;
  if ((local_60 & 1) == 0) {
    psVar26 = (string *)(uint64_t)(local_60 >> 1);
  }
  psVar23 = psVar26;
  if (psVar17 < psVar26) {
    psVar23 = psVar17;
...
LAB_0093cc81:
    ...
    param_3 = (string *)CONCAT71((int7)((uint64_t)param_3 >> 8),1);
    iVar8 = _memcmp((void *)(uint64_t)bVar7,psVar23,(size_t)param_3);
...
LAB_0093cbde:
      ...
      if ((local_60 & 1) == 0) {
        local_58 = (string *)(uint64_t)(local_60 >> 1);
      }
      psVar23 = local_58;
      if (psVar17 < local_58) {
        psVar23 = psVar17;
...
LAB_0093cc88:
  *(void*)(psVar2 + 0x38 + (int64_t)psVar29) = uVar11;
  psVar17 = psVar29;
  (**(code **)(**(int64_t **)arg1 + 0x48))();
  std::string::string(psVar17,psVar23);
  if ((local_118 & 1) == 0) {
    local_110 = (void *)(uint64_t)(local_118 >> 1);
  }
  pvVar12 = (void *)(*(int64_t *)(psVar2 + 0x20 + (int64_t)psVar29) -
                    *(int64_t *)(psVar2 + 0x18 + (int64_t)psVar29));
  psVar17 = psVar29;
  if (pvVar12 < local_110) {
    FUN_0088d550();
  }
  else if (local_110 < pvVar12) {
    psVar17 = (string *)(*(int64_t *)(psVar2 + 0x18 + (int64_t)psVar29) + (int64_t)local_110);
    *(string **)(psVar2 + 0x20 + (int64_t)psVar29) = psVar17;
  }
  ...
  psVar17 = psVar2 + 0x59 + (int64_t)psVar29;
  psVar17[-1] = sVar3;
  *psVar17 = (string)0x0;
  *(void*)(psVar17 + 0x324) = 0;
  if (sVar3 != (string)0x0) {
    FUN_00a1e028();
    if (local_b0 == 0) {
      FUN_00925fd0();
    ...
    lVar10 = (*(int64_t **)(local_b0 + 8))[1] - **(int64_t **)(local_b0 + 8);
    if (lVar10 != 0) {
      local_a0 = (string *)(lVar10 >> 5);
      psVar26 = psVar2 + 0x60 + (int64_t)psVar29;
      psVar23 = psVar2 + 0x160 + (int64_t)psVar29;
      psVar27 = (string *)((int64_t)&MACH_HEADER.magic + 1);
      bVar5 = true;
      bVar4 = true;
      local_88 = 0;
      uVar30 = 0;
      ...
      do {
        ...
        if (local_1a8 != (string *)0x0) {
            ...
            if (*(int *)(lVar10 + 0xd0) == -0x80000000) {
              ...
              if (psVar26[0x83] == (string)0x0) {
                if (*(int64_t *)(psVar26 + 0x58) == 0) {
                  ...
                  local_88 = CONCAT71((int7)((uint64_t)psVar13 >> 8),1);
                  if (local_res8 != 0) {
                    FUN_00925fd0();
                    FUN_00926010();
                    pcVar21 = 
              ...
              if (((byte)psVar26[0x40] & 1) == 0) {
                uVar16 = (uint64_t)((byte)psVar26[0x40] >> 1);
              }
              else {
                uVar16 = *(uint64_t *)(psVar26 + 0x48);
              }
          ...
          if (*(int *)(lVar10 + 0xd0) == -0x7ffffffe) {
            ...
            FUN_009bafbc();
            lVar10 = FUN_00a609be();
            *(void*)(psVar26 + 0xf8) = *(void*)(lVar10 + 0xd0);
            (**(code **)(*(int64_t *)local_1a8 + 0x48))();
            std::string::string((string *)pcVar21,(string *)pcVar24);
            psVar13 = local_1a0;
            if (((uint64_t)local_1a8 & 1) == 0) {
              psVar13 = (string *)(uint64_t)((byte)local_1a8 >> 1);
            }
            psVar14 = (string *)(*(int64_t *)(psVar26 + 0x108) - *(int64_t *)psVar23);
            psVar18 = psVar23;
            if (psVar14 < psVar13) {
              FUN_0088d550();
            }
            else if (psVar13 < psVar14) {
              *(string **)(psVar26 + 0x108) = psVar13 + *(int64_t *)psVar23;
            }
...
LAB_0093d29c:
                ...
                if (((byte)(psVar2 + 0x178)[(int64_t)psVar29] & 1) == 0) {
                  uVar16 = (uint64_t)((byte)(psVar2 + 0x178)[(int64_t)psVar29] >> 1);
                }
                else {
                  uVar16 = *(uint64_t *)(psVar26 + 0x120);
                }
                pcVar21 = (char *)CONCAT71((int7)((uint64_t)psVar18 >> 8),uVar16 == 0);
              }
            }
            else {
              if (((byte)(psVar2 + 400)[(int64_t)psVar29] & 1) == 0) {
                uVar16 = (uint64_t)((byte)(psVar2 + 400)[(int64_t)psVar29] >> 1);
              }
              else {
                uVar16 = *(uint64_t *)(psVar26 + 0x138);
              }
              if (uVar16 == 0) {
                pcVar21 = (char *)CONCAT71((int7)((uint64_t)psVar18 >> 8),1);
              }
              else {
                uVar16 = FUN_009585b8();
                if (local_a8 == uVar16) goto LAB_0093d29c;
                pcVar21 = (char *)CONCAT71((int7)(local_a8 >> 8),local_90 < (int64_t)local_a8);
              }
            }
            ...
            if (param_5 != 0) {
              ...
              *(void*)(psVar13 + 0x10) = local_1f0;
              *(string **)(psVar13 + 8) = local_1f8;
              *(uint64_t *)psVar13 = local_200;
...
LAB_0093d50f:
    ...
    bVar4 = true;
    local_98 = (int64_t *)((uint64_t)local_98._4_4_ << 0x20);
    local_88 = 0;
    bVar5 = true;
    goto LAB_0093d581;
  }
  ...
  bVar5 = true;
LAB_0093d977:
  psVar26 = psVar2 + 0x48 + (int64_t)psVar29;
  *(uint64_t *)psVar26 = 0;
  if (local_res20 == '\0') {
    uVar16 = 0;
  }
    ...
    lVar10 = (*(int64_t **)(local_b0 + 8))[1];
    if ((lVar10 != **(int64_t **)(local_b0 + 8)) &&
      ...
      if (iVar8 == *(int *)(lVar10 + 0x74)) {
        ...
        if (7 < (uint64_t)((int64_t)local_1a0 - (int64_t)local_1a8)) {
          uVar9 = (uint)(byte)local_1a8[7];
          pdVar19 = (dword *)((uint64_t)((char)local_1a8[7] < '\0') * 0x1000 + 0x1000 |
                              *(uint64_t *)psVar26 |
                             (uint64_t)((uVar9 & 0x10) >> 4) * 0x40000 + 0x40000 |
                             (uint64_t)((uVar9 & 0x20) >> 5) * 0x10000 + 0x10000 |
                             (uint64_t)((uVar9 & 0x40) >> 6) * 0x4000 + 0x4000);
    ...
    if (*(uint64_t *)psVar26 == 0) {
      *(uint64_t *)psVar26 = 0x55000;
    }
    uVar16 = *(uint64_t *)psVar26;
  }
  sVar3 = psVar17[0x325];
  if (psVar17[0x324] == (string)0x0) {
    uVar20 = (uint64_t)(byte)sVar3 + 1;
    iVar8 = 0x5a;
    if (sVar3 != (string)0x0) {
      iVar8 = 0x32;
    }
LAB_0093db8b:
    *(uint64_t *)psVar26 = uVar16 | uVar20;
    psVar23 = psVar2 + 0x50 + (int64_t)psVar29;
    *(int *)psVar23 = iVar8;
  ...
  *(uint64_t *)psVar26 =
       *(uint64_t *)psVar26 | (uint64_t)((uVar9 & 8) >> 3) * 0x100000 + 0x100000;
  FUN_00a1c9ba();
  pcVar21 = "termsStrict";
  FUN_009bafbc();
  lVar28 = FUN_00a1c9ba();
...
LAB_0093dd39:
  ...
  *(uint64_t *)psVar26 = *(uint64_t *)psVar26 | uVar16;
  FUN_00a1c9ba();
  FUN_009bafbc();
  lVar10 = FUN_00a1c9ba();
  *(uint64_t *)psVar26 = *(uint64_t *)psVar26 | (uint64_t)*(byte *)(lVar10 + 0xc0) * 0x40 + 0x40;
  bVar7 = FUN_00a1de8c();
  *(uint64_t *)psVar26 = *(uint64_t *)psVar26 | (uint64_t)bVar7 * 0x100 + 0x100;
  FUN_00a1c9ba();
  FUN_009bafbc();
  lVar10 = FUN_00a1c9ba();
  *(uint64_t *)psVar26 =
       *(uint64_t *)psVar26 |
       (uint64_t)((*(uint *)(lVar10 + 0x60) >> 0xb & 1) == 0) * 0x400 + 0x400;
  FUN_00a521fe();
  FUN_009bafbc();
  lVar10 = FUN_00a521fe();
  *(void*)(psVar2 + 0x54 + (int64_t)psVar29) = *(void*)(lVar10 + 0xb8);
  psVar27 = psVar2;
  FUN_00a521fe();
  pcVar21 = "state";
  FUN_009bafbc();
  ...
  if ((bVar7 & 1) == 0) {
    psVar27 = (string *)(uint64_t)(bVar7 >> 1);
  }
  else {
  ...
  psVar18 = psVar2 + 0x58 + (int64_t)psVar29;
  psVar14 = psVar13;
  if (psVar27 < psVar13) {
    psVar14 = psVar27;
  }
...
LAB_0093df8f:
    if (bVar5) {
      *(void*)(psVar2 + 0x40 + (int64_t)psVar29) = 1;
      psVar27 = psVar29;
      FUN_008911e2();
      ...
      if ((((*(char *)(lVar10 + 0xc0) != '\0') &&
           (*(int *)(psVar2 + 8 + (int64_t)psVar29) != 0x4801f777)) ||
          ((*local_d0 == (string)0x0 && (*psVar18 != (string)0x0)))) &&
         (iVar8 = *(int *)psVar23, iVar8 < *(int *)(this_ptr + 0x24))) goto LAB_0093e2c5;
    }
    else {
      if (!bVar4) {
        *(void*)(psVar2 + 0x40 + (int64_t)psVar29) = 4;
        psVar27 = psVar29;
        FUN_008911e2();
        std::string::operator=(psVar27,psVar14);
        goto LAB_0093e11f;
      }
      *(void*)(psVar2 + 0x40 + (int64_t)psVar29) = 8;
      psVar27 = psVar29;
      FUN_008911e2();
      std::string::operator=(psVar27,psVar14);
      *(int *)psVar23 = 1;
...
LAB_0093e1d1:
      ...
      if ((*(char *)(lVar10 + 0xc0) != '\0') ||
         ((*local_d0 == (string)0x0 && (*psVar18 != (string)0x0)))) {
        if (*(int *)psVar23 < *(int *)(this_ptr + 0x24)) {
          *(int *)(this_ptr + 0x24) = *(int *)psVar23;
        }
    ...
    param_3 = (string *)CONCAT71((int7)((uint64_t)param_3 >> 8),1);
    iVar8 = _memcmp((void *)(uint64_t)bVar7,psVar14,(size_t)param_3);
...
LAB_0093e11f:
    ...
    if (((uint64_t)local_1a8 & 1) == 0) {
      local_1a0 = (string *)(uint64_t)((byte)local_1a8 >> 1);
    }
    psVar13 = local_1a0;
...
LAB_0093e29b:
      psVar13 = psVar2 + 0x40 + (int64_t)psVar29;
LAB_0093e2a8:
      *(void*)psVar13 = 2;
    }
    else {
      iVar8 = _memcmp((void *)(uint64_t)bVar7,psVar13,
                      (size_t)CONCAT71((int7)((uint64_t)param_3 >> 8),1));
...
LAB_0093e280:
    ...
    *(void*)(this_ptr + 0x20) = 0;
LAB_0093e2c5:
    *(int *)(this_ptr + 0x24) = iVar8;
  }
  sVar3 = *psVar18;
  psVar27 = psVar29;
  if (*(int64_t *)(psVar2 + 0x30 + (int64_t)psVar29) == 2) {
    if (((sVar3 == (string)0x0) || ((char)*psVar26 < '\0')) ||
       ((local_d8 != 0 && (psVar27 = local_d0, *local_d0 == (string)0x0)))) {
      *(void*)(psVar2 + 0x40 + (int64_t)psVar29) = 0x20;
      psVar27 = (string *)0x0;
      *(int *)psVar23 = 0;
      *psVar17 = (string)0x0;
      *(void*)(this_ptr + 0x20) = 0;
...
LAB_0093e334:
  ...
  return;
LAB_0093d53b:
  local_98 = (int64_t *)CONCAT44(local_98._4_4_,uVar30);
LAB_0093d581:
  FUN_00a1c9ba();
  FUN_009bafbc();
  lVar10 = FUN_00a1c9ba();
  if (*(char *)(lVar10 + 0x50) != '\0') {
    ...
    lVar10 = (*(int64_t **)(local_90 + 8))[1] - **(int64_t **)(local_90 + 8);
    if (lVar10 != 0) {
      local_e8 = CONCAT71(local_e8._1_7_,local_res10 & local_res8);
      local_a0 = psVar2 + 0xf0 + (int64_t)psVar29;
      uVar16 = 1;
      do {
        FUN_00a59e2e();
        if (local_1a8 != (string *)0x0) {
          ...
          if (*(int *)(lVar28 + 0x88) == -0x80000000) {
            ...
            param_3 = (string *)(uint64_t)param_6;
...
LAB_0093d8b2:
        ...
        if ((uint64_t)(lVar10 >> 5) <= uVar16) break;
        uVar16 = uVar16 + 1;
      } while( true );
    }
  }
