...

{
  ...
  bVar1 = *(byte *)(*(int64_t *)(lVar2 + 8) + 0x18);
  if (*(char *)(lVar2 + 0x135) == '\0') {
    puVar9 = (uint64_t *)(lVar2 + 0x120);
    bVar5 = false;
  }
  else if (((*(byte *)(this_ptr + 0x61) & 4) == 0) ||
          (puVar9 = (uint64_t *)(lVar2 + 0x120), *(char *)(this_ptr + 0x7b) != '\0')) {
    puVar9 = (uint64_t *)(lVar2 + 0x128);
    bVar5 = true;
  }
  else {
    bVar5 = false;
  }
  local_40 = (uint64_t *)(lVar2 + 0x128);
  local_50 = (uint64_t *)(lVar2 + 0x120);
  uVar12 = *puVar9;
  ...
  if (uVar13 < uVar12) {
    ...
    *(void*)(this_ptr + 0x58) = *(void*)(lVar2 + 0x10);
    if (pbVar14 == *(byte **)(this_ptr + 0x20)) {
      ...
      uVar8 = *(byte *)(lVar2 + 0x18 + (uint64_t)*pbVar14) >> 1 & 1;
    }
