...
uint64_t FUN_01c3d0f0(int64_t *param_1,uint32_t param_2)
...
LAB_01c3d2c4:
    FUN_01d3abf0();
    local_a8 = (int64_t *)FUN_01e466c0();
    plVar11 = (int64_t *)CONCAT71((int7)((uint64_t)unaff_R12 >> 8),1);
    if (*local_68 == 0) {
      local_d8 = 0;
LAB_01c3d3bc:
...
LAB_01c3d379:
        ...
        local_58 = '\0';
        local_d8 = CONCAT71((int7)((uint64_t)local_60 >> 8),1);
        bVar13 = false;
      }
      ...
      uVar14 = FUN_019765b0();
      cVar2 = FUN_00d05410((uint32_t)local_148,uVar14,param_2);
      ...
      if (cVar2 == '\0') {
        ...
        local_148 = uVar5;
        uVar15 = FUN_019765d0();
        local_c0 = FUN_00d05410((uint32_t)local_148,uVar15,uVar14);
        if ((local_250 != '\0') && (local_258 != (int64_t *)0x0)) {
          FUN_00d50b20();
        }
        plVar11 = (int64_t *)(local_c0 & 0xffffffff ^ 1);
        goto LAB_01c3d3ce;
      }
      plVar11 = (int64_t *)CONCAT71((int7)((uint64_t)plVar1 >> 8),1);
      local_c0 = 0;
      bVar13 = true;
      local_ac = 1;
    }
    ...
    local_c8 = local_60;
    if (local_58 == '\0') {
      if (local_60 == (int64_t *)0x0) goto LAB_01c3d516;
      uVar5 = FUN_00d50b00();
      if ((local_58 != '\0') && (local_60 != (int64_t *)0x0)) {
        uVar5 = FUN_00d50b20();
      }
      local_148._0_4_ = (uint32_t)CONCAT71((int7)((uint64_t)uVar5 >> 8),1);
      if (*(int *)((int64_t)plVar1 + 0xc) != 0) goto LAB_01c3d423;
LAB_01c3d4f9:
      local_d0 = 0;
LAB_01c3d502:
...
LAB_01c3d783:
      ...
      if (local_60 != (int64_t *)0x0) {
        local_148._0_4_ = (uint32_t)CONCAT71((int7)((uint64_t)uVar5 >> 8),1);
        if (*(int *)((int64_t)local_60 + 0xc) == 0) goto LAB_01c3d4f9;
LAB_01c3d423:
        lVar10 = *(int64_t *)plVar1[2];
        local_150 = 0;
        if (lVar10 != 0) {
          FUN_00d50b00();
        }
        ...
        local_90 = *(int64_t **)local_c8[2];
        if (local_90 == (int64_t *)0x0) goto LAB_01c3d502;
        uVar5 = FUN_00d50b00();
        plVar11 = (int64_t *)((uint64_t)plVar11 ^ 1);
        if (bVar13 || (char)plVar11 != '\0') {
          ...
          (**(code **)(*local_90 + 0x928))();
          plVar1 = local_60;
          plVar11 = (int64_t *)*local_68;
          if (plVar11 == local_60) {
            if (((char)local_68[1] == '\0') && (local_60 != (int64_t *)0x0)) {
              local_a8 = local_68 + 1;
...
LAB_01c3d6c2:
          ...
          cVar2 = FUN_019801b0();
          uVar8 = (undefined7)((uint64_t)param_1 >> 8);
          param_1 = (int64_t *)(local_c0 & 0xff);
          uVar7 = 1;
          if (cVar2 == '\0') {
            uVar7 = local_c0 & 0xff;
          }
...
LAB_01c3d78c:
    ...
    if ((iVar4 == 1) && (iVar4 = FUN_01d3b630(), uVar14 = extraout_XMM0_Da_00, iVar4 == 1)) {
      iVar4 = FUN_01d3b620();
      pVar9 = (void*)param_1;
      uVar8 = (undefined7)((uint64_t)plVar11 >> 8);
      if (iVar4 != 2) {
        if ((char)local_ac == '\0') {
      ...
      if ((uVar7 & 8) == 0) {
        if ((char)local_ac == '\0') {
          if ((char)local_c0 == '\0') {
            ...
            uVar7 = CONCAT71(uVar8,1);
            if (((int)local_d0 == 1) && (local_a8 != (int64_t *)0x0)) {
              pvVar6 = _pthread_getspecific(pVar9);
              if (pvVar6 != (void *)0x0) {
                FUN_00e8b990();
              }
...
LAB_01c3e739:
              ...
              plVar11 = local_60;
              if (local_58 == '\0') {
                if (((local_60 != (int64_t *)0x0) && (uVar14 = FUN_00d50b00(), local_58 != '\0'))
                   && (local_60 != (int64_t *)0x0)) {
                  uVar14 = FUN_00d50b20();
                }
              }
...
LAB_01c3dfa0:
            pVar9 = (void*)param_1;
            if (*(int *)((int64_t)plVar11 + 0xc) != 0) {
              if (((char)local_98 == '\0') && (*(int *)((int64_t)local_c8 + 0xc) != 0)) {
                if (0 < *(int *)((int64_t)local_c8 + 0xc)) {
                  lVar10 = 0;
                  do {
                    plVar1 = *(int64_t **)(local_c8[2] + lVar10 * 8);
                    if (plVar1 != (int64_t *)0x0) {
                      FUN_00d50b00();
                    }
                    cVar2 = FUN_019801a0();
                    if (cVar2 != '\0') {
                      ...
                      if (cVar2 != '\0') {
                        ...
                        if (local_60 == (int64_t *)0x0) {
                          ...
                          uVar5 = FUN_00d50b00();
                          local_68 = (int64_t *)CONCAT71((int7)((uint64_t)uVar5 >> 8),1);
                          if ((local_58 != '\0') && (local_60 != (int64_t *)0x0)) {
                            FUN_00d50b20();
                          }
                        }
                    ...
                    lVar10 = lVar10 + 1;
                  } while (lVar10 < *(int *)((int64_t)local_c8 + 0xc));
                }
              }
              else if (local_a8 != (int64_t *)0x0) {
                pvVar6 = _pthread_getspecific(pVar9);
...
LAB_01c3def2:
    if (((char)local_e0 != '\0') && (local_a8 != (int64_t *)0x0)) {
      FUN_00d50b20();
    }
    if ((char)local_98 == '\0') {
      FUN_00d50b20();
    ...
    bVar13 = false;
    if (((char)local_d8 != '\0') && (local_b8 != (int64_t *)0x0)) {
      FUN_00d50b20();
      bVar13 = false;
    }
    goto LAB_01c3df59;
