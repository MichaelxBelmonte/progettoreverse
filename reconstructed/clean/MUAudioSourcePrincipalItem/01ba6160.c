...
uint64_t FUN_01ba6160(int64_t *param_1,int64_t *param_2)

{
  ...
  if (*param_2 != 0) {
    FUN_01a58dc0();
    if ((local_50 == (int64_t *)0x0) || (iVar6 = FUN_01d3a5a0(), iVar6 != 1)) {
      bVar19 = false;
    }
    else {
      iVar6 = FUN_01d3b630();
    ...
    if (bVar19) {
      ...
      if (local_50 == (int64_t *)0x0) {
        ...
        if (local_48 == '\0') {
          FUN_00d50b00();
          pVar12 = 0;
          if ((local_48 == '\0') || (local_50 == (int64_t *)0x0)) goto LAB_01ba637f;
          FUN_00d50b20();
        }
        pVar12 = 0;
      }
LAB_01ba637f:
      ...
      uVar9 = FUN_0125e7c0();
      plVar11 = local_50;
      local_6c = (float)CONCAT71((int7)((uint64_t)uVar9 >> 8),local_50 == (int64_t *)0x0);
      if (local_50 == (int64_t *)0x0) {
        local_b0 = (int64_t *)0x0;
        local_88 = 0;
        uVar21 = extraout_XMM0_Da;
LAB_01ba652b:
        bVar19 = local_58 == (int64_t *)0x0;
        bVar20 = true;
        local_90 = 0;
...
LAB_01ba6504:
        ...
        if (plVar11 == (int64_t *)0x0) {
          ...
          local_90 = CONCAT71((int7)((uint64_t)plVar11 >> 8),1);
          plVar11 = plVar13;
        }
        if ((local_48 != '\0') && (local_50 != (int64_t *)0x0)) {
          uVar21 = FUN_00d50b20();
        ...
        plVar13 = local_38;
        bVar19 = local_58 == (int64_t *)0x0;
        plVar11 = (int64_t *)CONCAT71((int7)((uint64_t)plVar11 >> 8),bVar19);
        bVar20 = local_40 == (int64_t *)0x0;
        if ((bVar20) || (local_58 == (int64_t *)0x0)) {
          local_38._1_7_ = (undefined7)((uint64_t)local_58 >> 8);
        }
        else {
          ...
          if ((char)uVar9 != '\0') {
            ...
            if (cVar5 != '\0') {
              ...
              plVar14 = (int64_t *)(uint64_t)((float)local_88 < fVar22 + g_02390d2c);
            }
            pvVar8 = _pthread_getspecific((void*)plVar11);
            plVar17 = local_40;
            if ((pvVar8 != (void *)0x0) &&
              ...
              plVar11 = local_40;
              plVar17 = (int64_t *)local_40[(uint64_t)(*(uint *)(lVar10 + 0x154) & 1) + 4];
            }
            ...
            if (cVar5 != '\0') {
              ...
              if (fVar22 + g_023b1614 < (float)local_88) {
                plVar14 = (int64_t *)((int64_t)&MACH_HEADER.magic + 2);
              }
            }
            uVar9 = FUN_01d3b620();
            pVar12 = (void*)plVar11;
...
LAB_01ba6b21:
              ...
              if (iVar6 != 0) {
                local_88 = CONCAT44(local_88._4_4_,(int)CONCAT71((int7)((uint64_t)uVar9 >> 8),1));
                local_c8 = iVar6;
LAB_01ba6b50:
                lVar15 = *plVar13;
...
LAB_01ba6c88:
                    ...
                    if (local_48 == '\0') {
                      ...
                      *arg1 = (int64_t)plVar17;
                      if (((char)lVar10 != '\0') && (plVar14 != (int64_t *)0x0)) {
                        uVar9 = FUN_00d50b20();
                      }
                      goto LAB_01ba6c7b;
                    }
...
LAB_01ba6c2b:
                    *(void*)(arg1 + 1) = 1;
                    local_48 = '\0';
LAB_01ba6c34:
                    if (*arg1 == 0) goto LAB_01ba6c88;
LAB_01ba6c3c:
                    uVar9 = FUN_01d3a5a0();
                    plVar14 = (int64_t *)CONCAT71((int7)((uint64_t)plVar17 >> 8),(int)uVar9 != 6);
                  }
                  if ((local_48 != '\0') && (local_50 != (int64_t *)0x0)) {
                    uVar9 = FUN_00d50b20();
                  }
                ...
                if (iVar6 == 5) {
                  ...
                  plVar11 = (int64_t *)FUN_01ba7720((float)local_88 - local_6c);
                  pvVar8 = _pthread_getspecific(pVar12);
                  if (pvVar8 != (void *)0x0) {
                    FUN_00e8b990();
                  }
          ...
          bVar19 = false;
          bVar20 = false;
          local_38._1_7_ = (undefined7)((uint64_t)uVar9 >> 8);
...
LAB_01ba6ee6:
  ...
  local_38._0_1_ = '\x01';
  bVar1 = false;
  uVar16 = CONCAT71((int7)((uint64_t)plVar14 >> 8),1);
  bVar3 = false;
  if ((char)local_c4 == '\0') {
LAB_01ba6714:
    bVar20 = bVar3;
