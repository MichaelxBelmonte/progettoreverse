...

{
  ...
  do {
    ...
    plVar6 = local_60;
    if (local_60 == plVar10) {
      if (((local_80 == '\0') && (local_60 != (int64_t *)0x0)) && (local_58[0] != '\0')) {
        local_80 = '\x01';
        goto LAB_002ecdd7;
      }
    }
...
LAB_002ecdd7:
    ...
    if (plVar10 != (int64_t *)0x0) {
      (**(code **)(*plVar10 + 0x360))();
      cVar2 = FUN_00e85ea0();
      plVar6 = (int64_t *)&stack0xffffffffffffff60;
      if (cVar2 == '\0') {
        plVar6 = &g_02802688;
      }
    }
    if (*plVar6 != 0) {
      plVar6 = plVar10;
      if ((local_80 == '\0') && (plVar10 != (int64_t *)0x0)) {
        FUN_00d50b00();
      }
...
joined_r0x002ecf53:
  ...
  if (plVar6 == (int64_t *)0x0) goto LAB_002ed6ce;
  uVar4 = FUN_0063f230();
  plVar8 = local_60;
  if (local_58[0] == '\0') {
...
LAB_002ed13f:
    ...
    if (local_60 == (int64_t *)0x0) goto LAB_002ed13f;
LAB_002ed069:
    cVar2 = FUN_00212c70();
    lVar5 = g_027259a0;
    if (cVar2 == '\0') {
...
LAB_002ed344:
    ...
    if (local_60 == (int64_t *)0x0) goto LAB_002ed344;
LAB_002ed248:
    local_58[0] = '\0';
    local_60 = (int64_t *)0x0;
    local_50 = plVar8;
    ...
    while( true ) {
      ...
      local_130 = *(int64_t **)(local_50[2] + 8 + lVar5 * 8);
      local_128 = '\0';
      local_60 = local_130;
  ...
  if ((local_98 != '\0') && (plVar10 != (int64_t *)0x0)) {
    FUN_00d50b20();
  }
