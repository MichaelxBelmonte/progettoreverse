...
void FUN_004a8be0(uint64_t param_1,uint64_t param_2)

{
  ...
  bVar6 = (byte)(((int64_t)dVar11 & (int64_t)uVar8 >> 0x3f | uVar8) / 3);
  local_50 = lVar9;
  local_48 = '\0';
  FUN_000175c0(uVar10,&local_50);
  plVar5 = local_40;
  ...
  bVar7 = plVar4 != (int64_t *)0x0 & local_78;
  if ((plVar5 != (int64_t *)0x0 & bVar6) == 0) {
    FUN_01e53c20();
    ...
    local_68 = (uint8_t  [8])(**(code **)(*(int64_t *)this_ptr[0xf] + 0x4d8))();
    uStack_60 = extraout_XMM0_Qb_01;
    auVar25 = _local_68;
    uVar12 = (**(code **)(*(int64_t *)this_ptr[0x10] + 0x4d8))();
    fStack_a0 = (float)extraout_XMM0_Qb_02;
    fStack_9c = (float)((uint64_t)extraout_XMM0_Qb_02 >> 0x20);
    fVar16 = fVar15;
    fVar19 = fVar18;
    fVar21 = fVar20;
    fVar23 = fVar22;
    uVar13 = (**(code **)(*(int64_t *)this_ptr[0xe] + 0x4d8))();
    ...
    uStack_60._4_4_ = (float)((uint64_t)extraout_XMM0_Qb_01 >> 0x20);
    if (bVar7 == 0) {
      (**(code **)(*(int64_t *)this_ptr[0x10] + 0x478))();
      this_ptr[0x10] = 0;
      ...
      (**(code **)(*(int64_t *)this_ptr[0x10] + 0x4d0))(auVar25._0_8_,fVar15);
    ...
    (**(code **)(*(int64_t *)this_ptr[0xf] + 0x478))();
    this_ptr[0xf] = 0;
    lVar9 = *(int64_t *)this_ptr[2];
    ...
    uVar12 = (**(code **)(*(int64_t *)this_ptr[0xf] + 0x4d8))();
    local_b8 = (float)uVar12;
    fStack_b4 = (float)((uint64_t)uVar12 >> 0x20);
