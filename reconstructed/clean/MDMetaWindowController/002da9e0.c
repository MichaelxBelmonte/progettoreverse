...
void FUN_002da9e0(uint64_t param_1,uint64_t param_2)
...
LAB_002daa1b:
  ...
  if ((local_28 != '\0') && (plVar6 != (int64_t *)0x0)) {
    FUN_00d50b20();
  }
  FUN_002d9a60();
    ...
    if (*(int64_t *)(*(int64_t *)(this_ptr + 0x78) + 0x308) == 0) {
      ...
      if (*(int64_t *)(this_ptr + 0xa8) == 0) {
        ...
        *puVar5 = &g_02683800;
        ...
        (**(code **)(**(int64_t **)(this_ptr + 0xa8) + 0x4d0))(fVar9 + g_023b1608);
        lVar7 = g_026fdec8;
        ...
        (**(code **)(**(int64_t **)(this_ptr + 0xa8) + 0x9c8))();
      ...
      if (*(int64_t *)(this_ptr + 0x98) != 0) {
        ...
        if (local_30 != (int64_t *)0x0) {
          ...
          (**(code **)(**(int64_t **)(this_ptr + 0xa0) + 0x4d8))();
          uVar10 = param_2;
          uVar12 = in_XMM1_Qb;
          (**(code **)(**(int64_t **)(this_ptr + 0xa0) + 0x4d8))();
          FUN_01e40eb0();
