...

{
  ...
  FUN_006cb500();
  if (local_d0 == '\0') {
    if (local_d8 == (int64_t *)0x0) goto LAB_006d57f9;
    FUN_00d50b00();
LAB_006d4d61:
    local_d0 = '\0';
    ...
    do {
      do {
        lVar11 = (int64_t)local_c0;
        local_c0 = local_c0 + 1;
        if (*(int *)((int64_t)plVar7 + 0xc) <= local_c0) goto LAB_006d57ce;
        lVar15 = plVar7[2];
        local_d8 = *(int64_t **)(lVar15 + 8 + lVar11 * 8);
        ...
        FUN_012e6160();
        iVar19 = *(int *)((int64_t)local_70 + 0xc);
      ...
      plVar9 = local_70;
      if ((char)local_68 == '\0') {
        if (local_70 == (int64_t *)0x0) goto LAB_006d5338;
        FUN_00d50b00();
        if (((char)local_68 != '\0') && (local_70 != (int64_t *)0x0)) {
          FUN_00d50b20();
        }
LAB_006d4fcd:
        ...
        while( true ) {
          ...
          plVar9 = (int64_t *)local_60[2];
          local_70 = (int64_t *)plVar9[lVar11 + 1];
          pvVar10 = _pthread_getspecific((void*)plVar9);
          if (pvVar10 != (void *)0x0) {
            FUN_00e8b990();
          }
          FUN_01264240();
          if (local_a0 == '\0') {
            if (local_a8 == (int64_t *)0x0) goto LAB_006d5010;
            FUN_00d50b00();
LAB_006d5100:
            lVar11 = g_02726d10;
            if (local_48 == (int64_t *)0x0) {
              ...
              if (plVar16 == local_a8) {
                plVar20 = plVar16;
                if (((char)local_40 == '\0') && (plVar16 != (int64_t *)0x0)) {
...
LAB_006d52f1:
            ...
            if (local_a8 != (int64_t *)0x0) goto LAB_006d5100;
LAB_006d5010:
            unaff_R15 = local_40 & 0xffffffff;
          }
...
LAB_006d530e:
        ...
        if (local_70 != (int64_t *)0x0) goto LAB_006d4fcd;
LAB_006d5338:
        local_48 = (int64_t *)0x0;
        unaff_R15 = local_40 & 0xffffffff;
        bVar5 = false;
...
LAB_006d556f:
          ...
          if (plVar9 == (int64_t *)0x0) goto LAB_006d53f1;
          pvVar10 = _pthread_getspecific(pVar14);
          if (pvVar10 != (void *)0x0) {
            FUN_00e8b990();
          }
          ...
          {
            plVar9 = (int64_t *)plVar20[(uint64_t)(*(uint *)(lVar11 + 0x154) & 1) + 4];
          }
...
LAB_006d55cd:
          ...
          plVar20 = (int64_t *)(local_110 - lVar11);
          plVar9 = (int64_t *)-(int64_t)plVar20;
          if (0 < (int64_t)plVar20) {
            plVar9 = plVar20;
          }
          lVar11 = local_110;
          if (plVar9 < (int64_t *)((int64_t)&MACH_HEADER.magic + 2)) goto LAB_006d55cd;
          local_68 = 1;
          local_70 = (int64_t *)&g_024da828;
          local_60 = plVar9;
          FUN_00d8cb40(&g_024da828,&local_70);
          if (local_80 == '\0') {
...
LAB_006d57ce:
    ...
    if (local_d8 != (int64_t *)0x0) goto LAB_006d4d61;
LAB_006d57f9:
    bVar18 = true;
    local_110 = 0;
    local_b0 = (int64_t *)0x0;
  ...
  plVar7 = local_d8;
  pVar14 = (void*)
           CONCAT71((int7)((uint64_t)local_b0 >> 8),local_b0 != (int64_t *)0x0 && 0 < local_110);
  if (!bVar18 || (local_b0 == (int64_t *)0x0 || 0 >= local_110)) {
    cVar8 = (char)local_40;
    goto LAB_006d6ae8;
  }
...
LAB_006d59e6:
    lVar11 = (int64_t)local_c0;
    local_c0 = local_c0 + 1;
    if (local_c0 < *(int *)((int64_t)plVar7 + 0xc)) {
      lVar15 = plVar7[2];
      local_d8 = *(int64_t **)(lVar15 + 8 + lVar11 * 8);
      pvVar10 = _pthread_getspecific((void*)lVar15);
      pVar14 = (void*)lVar15;
      ...
      if (iVar19 < 1) {
        ...
        if (0 < iVar19) {
          ...
          plVar20 = local_70;
          if ((char)local_68 == '\0') {
            if (local_70 == (int64_t *)0x0) goto LAB_006d59e6;
            FUN_00d50b00();
            if (((char)local_68 != '\0') && (local_70 != (int64_t *)0x0)) {
              FUN_00d50b20();
            }
          }
          else if (local_70 == (int64_t *)0x0) goto LAB_006d59e6;
          local_68 = local_68 & 0xffffff00;
          local_70 = (int64_t *)0x0;
          local_60 = plVar20;
          local_58 = 0xffffffff;
          ...
          while( true ) {
            ...
            plVar16 = local_60;
            if (*(int *)((int64_t)local_60 + 0xc) <= iVar19) break;
            plVar16 = (int64_t *)local_60[2];
            local_70 = (int64_t *)plVar16[lVar11 + 1];
            pvVar10 = _pthread_getspecific((void*)plVar16);
            if (pvVar10 != (void *)0x0) {
              FUN_00e8b990();
            }
            FUN_01264240();
...
LAB_006d5cd0:
                if (plVar20 == (int64_t *)0x0) {
                  ...
                  FUN_006db950();
                  plVar21 = local_48;
                  uVar22 = (undefined7)((uint64_t)local_f8 >> 8);
          ...
          if (plVar20 != (int64_t *)0x0) {
            ...
            if (plVar20 != (int64_t *)0x0) {
              ...
              if ((pvVar10 != (void *)0x0) &&
                ...
                plVar16 = (int64_t *)plVar20[(uint64_t)(*(uint *)(lVar11 + 0x154) & 1) + 4];
              }
              ...
              if (uVar17 < 2) {
                ...
                FUN_01327a50();
                iVar1 = *(int *)((int64_t)local_a8 + 0xc);
                if ((bVar18) && (local_a8 != (int64_t *)0x0)) {
                  FUN_00d50b20();
                }
                if (((char)local_68 != '\0') && (local_70 != (int64_t *)0x0)) {
                  FUN_00d50b20();
                ...
                FUN_012e7210();
                uVar2 = *(void*)(local_130 + 0xc);
                pvVar10 = _pthread_getspecific(pVar14);
                if (pvVar10 != (void *)0x0) {
                  FUN_00e8b990();
                }
                FUN_01327a50();
                uVar3 = *(void*)(local_280 + 0xc);
                local_68 = 3;
                local_70 = &g_024c5048;
                ...
                uVar13 = FUN_006db950();
                uVar22 = (undefined7)((uint64_t)plVar16 >> 8);
                if (plVar16 == local_a8) {
                  if (((char)local_40 == '\0') && (plVar16 != (int64_t *)0x0)) {
                    plVar20 = plVar16;
...
LAB_006d6ae8:
  (**(code **)(**(int64_t **)(this_ptr + 0x198) + 0x998))();
  (**(code **)(**(int64_t **)(this_ptr + 0x198) + 0x6a8))();
  if ((cVar8 != '\0') && (plVar16 != (int64_t *)0x0)) {
    FUN_00d50b20();
  }
  if ((bVar6) && (local_b0 != (int64_t *)0x0)) {
    FUN_00d50b20();
  }
  return;
}
