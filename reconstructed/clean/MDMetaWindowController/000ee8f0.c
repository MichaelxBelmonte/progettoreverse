...

{
  ...
  if (((this_ptr[0x10] != 0) && (this_ptr[0xe] != 0)) && (this_ptr[0xf] != 0)) {
    FUN_00d50b00();
    local_38[0] = '\0';
    plVar5 = this_ptr;
    do {
...
LAB_000eeb1b:
    ...
    if (plVar5 != (int64_t *)0x0) {
      ...
      (**(code **)(*(int64_t *)this_ptr[0xf] + 0x918))();
      (**(code **)(*(int64_t *)this_ptr[0xe] + 0x918))();
      if (iVar2 == 2) {
        if (*(int64_t *)(this_ptr[0x10] + 0x80) != 0) {
          FUN_01cef410();
          if (local_40[0] == '\0') {
        ...
        if (*(int64_t *)(this_ptr[0x10] + 0x78) != 0) {
          FUN_01cef410();
          if (local_40[0] == '\0') {
            if (local_48 != (int64_t *)0x0) {
              FUN_00d50b00();
      ...
      else if ((iVar2 == 0) && (*(int64_t *)(this_ptr[0x10] + 0x70) != 0)) {
        FUN_01cef410();
        if (local_40[0] == '\0') {
          if (local_48 != (int64_t *)0x0) {
            FUN_00d50b00();
