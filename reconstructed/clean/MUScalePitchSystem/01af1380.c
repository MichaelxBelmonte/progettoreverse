...
void FUN_01af1380(int64_t *param_1)

{
  ...
  if (plVar8 == (int64_t *)0x0) goto LAB_01af1e04;
  FUN_01a1d6e0();
  ...
  if ((plVar8 == (int64_t *)0x0) || (*(int *)((int64_t)plVar8 + 0xc) == 0)) {
    FUN_01a1d6e0();
    (**(code **)(*local_50 + 0xe70))();
    plVar1 = local_40;
    if (plVar8 == local_40) {
LAB_01af1512:
  ...
  if (*(int *)((int64_t)plVar8 + 0xc) != 0) {
    plVar4 = (int64_t *)FUN_00e8fc40();
    FUN_00022d50();
    (**(code **)(*plVar4 + 0x18))();
    plVar1 = *(int64_t **)(this_ptr + 0x2a8);
    if (plVar1 == plVar4) {
      FUN_00d50b20();
    }
    else {
      *(int64_t **)(this_ptr + 0x2a8) = plVar4;
    ...
    if (0 < *(int *)((int64_t)plVar8 + 0xc)) {
      lVar9 = 0;
      do {
        plVar1 = *(int64_t **)(plVar8[2] + lVar9 * 8);
        if (plVar1 != (int64_t *)0x0) {
          FUN_00d50b00();
        }
        ...
        if (plVar4 == (int64_t *)0x0) {
          ...
          if ((pvVar5 != (void *)0x0) && (lVar6 = FUN_00e8b990(), lVar6 != 0)) {
            param_1 = plVar2;
            plVar7 = (int64_t *)plVar2[(uint64_t)(*(uint *)(lVar6 + 0x154) & 1) + 4];
          }
          pvVar5 = _pthread_getspecific((void*)param_1);
          if (pvVar5 != (void *)0x0) {
            FUN_00e8b990();
        ...
        lVar9 = lVar9 + 1;
      } while (lVar9 < *(int *)((int64_t)plVar8 + 0xc));
    }
  }
  FUN_00d50b20();
LAB_01af1e04:
