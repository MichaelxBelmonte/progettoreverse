...
uint64_t FUN_01750eb0(void* param_1)
    ...
    if (cVar28 != '\0') {
      ...
      if (iVar29 < 0xd) {
        ...
        if (pvVar30 != (void *)0x0) {
          ...
          lVar31 = FUN_00e8b990();
          if (lVar31 != 0) {
            lVar32 = *(int64_t *)(lVar32 + 0x20 + (uint64_t)(*(uint *)(lVar31 + 0x154) & 1) * 8);
          }
        }
        lVar32 = *(int64_t *)(lVar32 + 0x60);
        if (lVar32 != 0) {
          FUN_00d50b00();
        }
        pvVar30 = _pthread_getspecific(param_1);
      ...
      if (!bVar5) {
        ...
        if (pvVar30 != (void *)0x0) {
          ...
          lVar32 = FUN_00e8b990();
          if (lVar32 != 0) {
            lVar33 = *(int64_t *)(lVar33 + 0x20 + (uint64_t)(*(uint *)(lVar32 + 0x154) & 1) * 8);
          }
        }
        FUN_0174c730();
        ...
        *puVar1 = uVar21;
        ...
        puVar3 = *(void**)(local_40 + 0x10);
        uVar21 = *(void*)(puVar3 + 0x16);
        *(void*)(lVar32 + 0xb0) = *(void*)(puVar3 + 0x14);
        *(void*)(lVar32 + 0xb8) = uVar21;
        uVar21 = *(void*)(puVar3 + 0x12);
        *(void*)(lVar32 + 0xa0) = *(void*)(puVar3 + 0x10);
        *(void*)(lVar32 + 0xa8) = uVar21;
        uVar6 = *puVar3;
        uVar7 = puVar3[1];
        uVar8 = puVar3[2];
        uVar9 = puVar3[3];
        ...
        uVar19 = puVar3[0xe];
        uVar20 = puVar3[0xf];
        *(void*)(lVar32 + 0x90) = puVar3[0xc];
        *(void*)(lVar32 + 0x94) = uVar18;
        *(void*)(lVar32 + 0x98) = uVar19;
        *(void*)(lVar32 + 0x9c) = uVar20;
        *(void*)(lVar32 + 0x80) = uVar14;
        *(void*)(lVar32 + 0x84) = uVar15;
        *(void*)(lVar32 + 0x88) = uVar16;
        *(void*)(lVar32 + 0x8c) = uVar17;
        *(void*)(lVar32 + 0x70) = uVar10;
        *(void*)(lVar32 + 0x74) = uVar11;
        *(void*)(lVar32 + 0x78) = uVar12;
        *(void*)(lVar32 + 0x7c) = uVar13;
        *(void*)(lVar32 + 0x60) = uVar6;
        *(void*)(lVar32 + 100) = uVar7;
        *(void*)(lVar32 + 0x68) = uVar8;
        *(void*)(lVar32 + 0x6c) = uVar9;
        lVar32 = *(int64_t *)(local_40 + 0x10);
        lVar31 = 0;
        do {
...
LAB_01751190:
        ...
        uVar34 = CONCAT71((int7)((uint64_t)lVar33 >> 8),1);
        if (local_40 != 0) {
LAB_01751406:
          FUN_00d50b20();
        }
