...
void FUN_01cdf840(uint8_t param_1 [8],uint64_t param_2,float param_3,uint param_4)

{
  ...
  fStack_b4 = (float)((uint64_t)param_2 >> 0x20);
  local_b8 = (float)param_2;
  if (in_EDX == 9) {
    return;
  }
  local_c8 = SUB84(param_1,0);
  uStack_c4 = (uint32_t)((uint64_t)param_1 >> 0x20);
  uStack_c0 = (uint32_t)in_XMM0_Qb;
  uStack_bc = (uint32_t)((uint64_t)in_XMM0_Qb >> 0x20);
  lVar7 = this_ptr[0xf];
  local_e8 = param_3;
  if ((lVar7 == 0) || (*(int *)(lVar7 + 0xc) <= in_EDX)) {
    local_98 = CONCAT44(local_98._4_4_,(int)CONCAT71((int7)((uint64_t)lVar7 >> 8),1));
    local_38 = 0;
    lVar7 = 0;
    uVar4 = local_4c;
    local_4c = param_4;
    ...
    local_68 = param_1;
    lVar7 = *(int64_t *)(*(int64_t *)(lVar7 + 0x10) + (int64_t)in_EDX * 8);
    local_4c = param_4;
    uVar5 = FUN_00d50b00();
    if (*(char *)(lVar7 + 0x50) != '\0') {
      do {
        if ((local_res8 == 0) || (lVar10 = *(int64_t *)(lVar7 + 0x28), lVar10 == 0)) {
          if ((local_e8 == 1.4013e-45) && (lVar10 = *(int64_t *)(lVar7 + 0x18), lVar10 != 0)) {
            local_148 = *arg1;
            local_140 = 0;
            FUN_00d50b00();
            local_130 = 1;
            local_98 = *(uint64_t *)(lVar7 + 0x30);
            uStack_90 = 0;
            uStack_60 = 0;
            local_68 = (uint8_t  [8])*(uint64_t *)(lVar7 + 0x38);
            lVar1 = *(int64_t *)(lVar7 + 0x58);
            local_138 = lVar10;
            if (lVar1 != 0) {
              FUN_00d50b00();
            }
  ...
  if (in_EDX == 0xf) {
    ...
    local_b8 = (float)((int)fStack_b4 / 2) + g_023b1608;
    local_c8 = local_c8 + fStack_b4 * g_0239011c;
    local_e8 = (float)local_68._4_4_ + fStack_b4 * g_0239011c;
    ...
    (**(code **)(*(int64_t *)*arg1 + 0x3c0))((int)fStack_b4 / 2,g_02390124 + local_b8);
    (**(code **)(*this_ptr + 0x3a0))();
    local_78 = local_48;
    local_70 = 0;
    if (local_40 == '\0') {
    ...
    auVar2._0_4_ = local_e8 + g_02390d00;
    auVar2._8_4_ = uStack_e0;
    auVar2._12_4_ = uStack_dc;
    auVar9 = insertps(auVar3,auVar2,0x10);
    (**(code **)(*(int64_t *)*arg1 + 0x3c0))(auVar9._0_8_,local_b8);
    (**(code **)(*this_ptr + 0x488))((uint8_t)local_4c,0xf,local_res8);
    local_a8 = local_48;
    local_a0 = 0;
    if (local_40 == '\0') {
      if (local_48 != 0) {
