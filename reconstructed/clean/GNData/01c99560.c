...
void* FUN_01c99560(int64_t *param_1,uint64_t param_2,uint32_t param_3)

{
  ...
  if (cVar1 == '\0') {
    ...
    FUN_00d23310();
    plVar11 = local_58;
    pVar17 = (void*)CONCAT71((int7)((uint64_t)plVar10 >> 8),local_50[0]);
    pcVar19 = &local_d0;
    if (local_50[0] != '\0') {
      pcVar19 = local_50;
    }
    ...
    *pcVar19 = '\0';
    ...
    FUN_012f8680();
    local_130 = CONCAT71((int7)((uint64_t)pcVar19 >> 8),local_80);
    local_c0 = local_88;
    if (local_88 == 0) {
      local_c0 = 0;
      local_130 = 0;
joined_r0x01c997e6:
  ...
  plVar11 = param_1;
  FUN_00d23310();
  pVar17 = (void*)CONCAT71((int7)((uint64_t)plVar11 >> 8),local_50[0]);
  pcVar19 = &local_d0;
  if (local_50[0] != '\0') {
    pcVar19 = local_50;
  }
  ...
  *pcVar19 = '\0';
  ...
  if (local_88 == 0) {
    ...
    uVar12 = FUN_00d50b00();
    local_f8 = CONCAT71((int7)((uint64_t)uVar12 >> 8),1);
  }
  else {
    local_80 = '\0';
  ...
  pVar17 = (void*)lVar13;
  if ((local_d0 != '\0') && (local_58 != (int64_t *)0x0)) {
    FUN_00d50b20();
  }
  if (local_98 == 0) {
    *(void*)(this_ptr + 1) = 0;
...
LAB_01c99ccf:
    ...
    *this_ptr = 0;
    ...
    lVar13 = g_027ed460;
    if (cVar3 == '\0') {
      uVar16 = (uint)CONCAT71((int7)((uint64_t)unaff_R13 >> 8),1);
      if (*(char *)(arg1 + 0x2e) == '\0') goto LAB_01c99ccf;
    }
    else {
      uVar16 = 0;
    }
...
LAB_01c9a1d2:
            ...
            lVar13 = *(int64_t *)(plVar11[2] + uVar14 * 8);
            local_50[0] = '\0';
            local_58 = (int64_t *)0x0;
            local_40 = 0xffffffff;
            local_38 = 0;
            local_48 = (int64_t *)*param_1;
            while( true ) {
              lVar8 = (int64_t)(int)local_40;
              iVar18 = (int)local_40 + 1;
              local_40 = CONCAT44(local_40._4_4_,iVar18);
              if (*(int *)((int64_t)local_48 + 0xc) <= iVar18) {
                FUN_000be170();
                goto LAB_01c9a1d2;
              }
    ...
    if (cVar3 == '\0') {
      local_b4 = uVar16;
      if (*(char *)(arg1 + 0x2c) == '\0') {
        local_a8 = (int64_t *)FUN_00e8fc40();
        FUN_00d4ff40();
        pVar17 = 0x2572358;
        *local_a8 = (int64_t)&g_02572358;
        (*g_02572370)();
        pvVar7 = _pthread_getspecific(pVar17);
        if (pvVar7 != (void *)0x0) {
          FUN_00e8b990();
        ...
        plVar11 = local_58;
        if (local_50[0] == '\0') {
          if (local_58 == (int64_t *)0x0) goto LAB_01c9a3e5;
          FUN_00d50b00();
          if ((local_50[0] != '\0') && (local_58 != (int64_t *)0x0)) {
            FUN_00d50b20();
          }
...
LAB_01c9a3e5:
        ...
        while( true ) {
          ...
          iVar18 = (int)local_40 + 1;
          local_40 = CONCAT44(local_40._4_4_,iVar18);
          if (*(int *)((int64_t)local_48 + 0xc) <= iVar18) break;
          lVar8 = local_48[2];
          local_58 = *(int64_t **)(lVar8 + 8 + lVar13 * 8);
...
LAB_01c9a3ee:
      ...
      plVar11 = local_58;
      if (local_50[0] == '\0') {
        if (((local_58 != (int64_t *)0x0) && (uVar23 = FUN_00d50b00(), local_50[0] != '\0')) &&
           (local_58 != (int64_t *)0x0)) {
          uVar23 = FUN_00d50b20();
        }
      }
      ...
      plVar10 = local_58;
      uVar12 = CONCAT71((int7)((uint64_t)uVar12 >> 8),g_026d0220);
      if ((g_026d0220 == '\0') && (uVar12 = ___cxa_guard_acquire(), (int)uVar12 != 0)) {
      ...
      local_e4 = (uint32_t)CONCAT71((int7)((uint64_t)uVar12 >> 8),1);
      if (plVar11 == (int64_t *)0x0) {
LAB_01c9a8bf:
        cVar3 = (char)local_b4;
      }
        ...
        do {
          ...
          if (local_a8 == (int64_t *)0x0) break;
          lVar13 = *(int64_t *)(plVar11[2] + (int64_t)(int)pVar17 * 8);
          local_50[0] = '\0';
          local_58 = (int64_t *)0x0;
          local_40 = 0xffffffff;
          local_38 = 0;
...
LAB_01c9a710:
              ...
              do {
                do {
                  do {
                    ...
                    local_88 = *(int64_t *)(*(int64_t *)(lVar8 + 0x10) + 8 + lVar9 * 8);
                  } while ((lVar13 != local_88) || (plVar10 == (int64_t *)0x0));
                ...
                iVar18 = *(int *)(plVar10[2] + (int64_t)(int)pVar17 * 4);
                pvVar7 = _pthread_getspecific(pVar17);
                if (pvVar7 != (void *)0x0) {
                  FUN_00e8b990();
                }
              ...
              local_e8 = (uint)CONCAT71((int7)((uint64_t)uVar12 >> 8),1);
LAB_01c9a850:
              FUN_00115190();
              FUN_00d50b20();
            }
...
LAB_01c9a599:
        ...
        local_e4 = (uint32_t)CONCAT71((int7)(uVar14 >> 8),1);
        cVar3 = '\x01';
        if (*(char *)(arg1 + 0x2c) == '\0') {
          *(void*)(this_ptr + 1) = 0;
          *this_ptr = 0;
...
LAB_01c99bb2:
      ...
      if ((char)local_148 == '\0') {
        ...
        *(void*)(this_ptr + 1) = 1;
        ...
        if (cVar3 == '\0') {
          local_138 = 0;
          (**(code **)(*(int64_t *)(arg1 + 0x20) + 0x10))();
          FUN_00d50b00();
          local_138 = '\x01';
          local_140 = (int64_t *)(arg1 + 0x20);
          uVar23 = FUN_00d1fc70();
          ...
          plVar11 = local_58;
          if ((g_027ed610 == '\0') && (iVar18 = ___cxa_guard_acquire(), iVar18 != 0)) {
            g_027ed560 = FUN_00d4fe50();
            g_027ed548 = "MUPasteboardElementsItem";
            g_027ed550 = 0x30;
            g_027ed558 = FUN_01ca39e0;
            g_027ed568 = 0;
            ram_00000000027ed570 = 0;
            g_027ed578 = 0;
            ram_00000000027ed580 = 0;
            g_027ed588 = 0;
            ram_00000000027ed590 = 0;
            g_027ed598 = 0;
            ram_00000000027ed5a0 = 0;
            g_027ed5a8 = 0;
            ram_00000000027ed5b0 = 0;
            g_027ed5b8 = 0;
            ram_00000000027ed5c0 = 0;
            g_027ed5c8 = 0;
            ram_00000000027ed5d0 = 0;
            g_027ed5d8 = 0;
            ram_00000000027ed5e0 = 0;
            g_027ed5e8 = 0;
            ram_00000000027ed5f0 = 0;
            g_027ed5f8 = 0;
            ram_00000000027ed600 = 0;
            g_027ed608 = 0;
...
LAB_01c99ce1:
  ...
  if (cVar1 == '\0' && local_d8 != (int64_t *)0x0) {
    FUN_00d50b20();
  }
LAB_01c99d17:
