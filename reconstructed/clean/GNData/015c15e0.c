...
void FUN_015c15e0(float param_1,uint param_2,char param_3,void*param_4)

{
  ...
  uVar32 = (int)(g_02411068 + param_1) * 2 + 1;
  iVar21 = ((int)(g_02411068 + param_1) * 2 - ((int)uVar32 >> 0x1f)) + 1 >> 1;
  if (*(int *)(this_ptr + 0x20) < (int)uVar32) {
    if (*(int64_t *)(this_ptr + 0x10) != 0) {
      FUN_00e83070();
      *(void*)(this_ptr + 0x10) = 0;
    }
    lVar22 = FUN_00e83010();
    *(int64_t *)(this_ptr + 0x10) = lVar22;
    *(uint *)(this_ptr + 0x20) = uVar32;
    *(void*)(lVar22 + (int64_t)iVar21 * 4) = 0x3f800000;
    fVar35 = g_02394294;
  }
  else {
  ...
  g_02394294 = fVar35;
  if (1 < (int)uVar32) {
    lVar31 = (int64_t)iVar21;
    param_1 = fVar35 / param_1;
    uVar23 = (uint64_t)(iVar21 + 1U) - 1;
    lVar30 = 1;
    if (iVar21 + 1U != 2) {
      lVar29 = lVar22 + lVar31 * 4;
      puVar33 = (void*)(lVar29 + -4);
      lVar30 = 1;
      do {
        uVar34 = _sinf((float)(int)lVar30 * param_1 + fVar35);
        *(void*)(lVar29 + lVar30 * 4) = uVar34;
        *puVar33 = uVar34;
        uVar34 = _sinf((float)((int)lVar30 + 1) * param_1 + g_02394294);
        fVar35 = g_02394294;
        *(void*)(lVar29 + 4 + lVar30 * 4) = uVar34;
        puVar33[-1] = uVar34;
        puVar33 = puVar33 + -2;
    ...
    if ((uVar23 & 1) != 0) {
      uVar34 = _sinf(param_1 * (float)(int)lVar30 + g_02394294);
      *(void*)(lVar22 + (lVar30 + lVar31) * 4) = uVar34;
      *(void*)(lVar22 + (lVar31 - lVar30) * 4) = uVar34;
    }
  }
  if (0 < (int)param_2) {
    ___bzero();
  ...
  if (*(int *)(lVar30 + 0xc) < 1) {
    ...
    bVar20 = false;
    do {
      lVar31 = *(int64_t *)(*(int64_t *)(lVar30 + 0x10) + lVar29 * 8);
      if (lVar22 == lVar31) {
        lVar31 = lVar22;
        bVar19 = bVar20;
        if ((!bVar20) && (lVar22 != 0)) {
    ...
    lVar29 = 0;
    do {
      lVar31 = *(int64_t *)(*(int64_t *)(lVar30 + 0x10) + lVar26 * 8);
      if (lVar29 == lVar31) {
        lVar31 = lVar29;
        bVar20 = bVar19;
        if ((!bVar19) && (lVar29 != 0)) {
      ...
      dVar4 = *(double *)(lVar31 + 0x10) + g_023942d0;
      uVar23 = 0;
      do {
        ...
        if ((-1 < iVar24) && (iVar24 < (int)param_2)) {
          ...
          *(float *)(*arg1 + uVar27 * 4) =
               *(float *)(lVar22 + uVar23 * 4) * (float)dVar3 + *(float *)(*arg1 + uVar27 * 4);
        }
        uVar23 = uVar23 + 1;
      } while (uVar32 != uVar23);
      lVar26 = lVar26 + 1;
  ...
  if ((param_3 != '\0') || (param_4 != (void*)0x0)) {
    ...
    if (((param_3 != '\0') && (0.0 < fVar35)) && (0 < (int)param_2)) {
      fVar35 = g_02390124 / fVar35;
      lVar22 = *arg1;
      if (param_2 < 8) {
        uVar23 = 0;
      }
      else {
        uVar23 = (uint64_t)(param_2 & 0xfffffff8);
        uVar27 = (uVar23 - 8 >> 3) + 1;
        if (uVar23 - 8 == 0) {
          lVar30 = 0;
        }
