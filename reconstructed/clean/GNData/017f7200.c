...
void FUN_017f7200(void*param_1,int64_t *param_2)

{
  ...
  FUN_00d4efa0();
  plVar34 = local_b0;
  if ((((local_a8 == '\0') && (local_b0 != (int64_t *)0x0)) && (FUN_00d50b00(), local_a8 != '\0'))
...
LAB_017f72d7:
    ...
    while( true ) {
      ...
      lVar26 = (int64_t)(int)local_98;
      iVar25 = (int)local_98 + 1;
      local_98 = CONCAT44(local_98._4_4_,iVar25);
      if (*(int *)((int64_t)local_a0 + 0xc) <= iVar25) break;
      local_b0 = *(int64_t **)(local_a0[2] + 8 + lVar26 * 8);
      FUN_00d74120();
      plVar34 = local_60;
      lVar26 = g_027d4cb0;
      if (g_027d4cb0 != 0) {
      ...
      if (cVar21 == '\0') {
        ...
        if (*pplVar35 != (int64_t *)0x0) {
          ...
          case 0x40:
            ...
            plVar34 = local_60;
            if ((g_026d0220 == '\0') && (iVar25 = ___cxa_guard_acquire(), iVar25 != 0)) {
            ...
            if (plVar34 != (int64_t *)0x0) {
              ...
              if (plVar34 == local_80) {
LAB_017f8505:
                if (local_80 != (int64_t *)0x0) goto LAB_017f850a;
              }
              else {
                if (local_80 == (int64_t *)0x0) {
LAB_017f81ac:
                  if (*this_ptr != 0) {
                    ...
                    while( true ) {
                      ...
                      lVar26 = (int64_t)(int)local_48;
                      iVar25 = (int)local_48 + 1;
                      local_48 = CONCAT44(local_48._4_4_,iVar25);
                      if (*(int *)(local_50 + 0xc) <= iVar25) break;
                      local_60 = *(int64_t **)(*(int64_t *)(local_50 + 0x10) + 8 + lVar26 * 8);
                      ...
                      (**(code **)(**(int64_t **)
                                     (*(int64_t *)(*arg1 + 0x10) +
                                     ((int64_t)local_40 + (int64_t)(int)local_48) * 8) + 0x210))
                                ((int64_t)local_40 + (int64_t)(int)local_48,local_b0);
                      plVar4 = local_70;
                      if (((local_68 == '\0') && (local_70 != (int64_t *)0x0)) &&
                         ((FUN_00d50b00(), local_68 != '\0' && (local_70 != (int64_t *)0x0)))) {
                        FUN_00d50b20();
                        ...
                        if (uVar39 < 4) {
                          ...
                          if ((uVar9 < uVar6 + uVar38 * 4 && uVar6 < uVar36) ||
                            ...
                            if (uVar8 + uVar38 * 4 <= uVar9 || uVar36 <= uVar8) {
                              uVar37 = (uint64_t)(uVar39 & 0xfffffffc);
                              uVar36 = 0;
                              do {
...
LAB_017f850a:
            ...
            break;
          case 0x62:
            puVar29 = (void*)(**(code **)(*(int64_t *)*param_2 + 0x218))();
            local_70 = (int64_t *)CONCAT71(local_70._1_7_,*puVar29);
            if (*this_ptr != 0) {
              local_58 = '\0';
              local_60 = (int64_t *)0x0;
              local_48 = 0xffffffff;
...
LAB_017f8071:
          ...
          case 0x65:
          case 0x69:
            puVar27 = (void*)(**(code **)(*(int64_t *)*param_2 + 0x218))();
            local_70 = (int64_t *)CONCAT44(local_70._4_4_,*puVar27);
            piVar28 = (int *)(**(code **)(*(int64_t *)*param_1 + 0x218))();
            if (((int)local_70 != *piVar28) && (*this_ptr != 0)) {
              local_58 = '\0';
              local_60 = (int64_t *)0x0;
              local_48 = 0xffffffff;
              local_40 = 0;
          ...
          case 0x66:
            ...
            local_78 = (int64_t *)CONCAT44(local_78._4_4_,uVar44);
            uVar44 = g_02416648;
            if (bVar43) {
              uVar44 = 0;
            }
            local_80 = (int64_t *)CONCAT44(local_80._4_4_,uVar44);
            ...
            if (cVar24 == '\0') {
              ...
              local_78 = (int64_t *)CONCAT44(local_78._4_4_,local_80._0_4_);
            }
            FUN_00d74120();
            plVar34 = local_60;
            lVar26 = g_027d4cd8;
            ...
            local_78 = (int64_t *)CONCAT71(local_78._1_7_,cVar21);
            FUN_00d74120();
            plVar34 = local_60;
            lVar26 = g_027d4ce0;
            if (g_027d4ce0 != 0) {
            ...
            local_80 = (int64_t *)CONCAT71(local_80._1_7_,uVar22);
            ...
            puVar27 = (void*)(**(code **)(*(int64_t *)*param_2 + 0x218))();
            local_80 = (int64_t *)CONCAT44(local_80._4_4_,*puVar27);
            pfVar31 = (float *)(**(code **)(*(int64_t *)*param_1 + 0x218))();
            fVar45 = *pfVar31;
            if (((local_80._0_4_ != fVar45) || (NAN(local_80._0_4_) || NAN(fVar45))) &&
              ...
              while( true ) {
                ...
                puVar27 = (void*)
                          (**(code **)(**(int64_t **)
                                         (*(int64_t *)(*arg1 + 0x10) +
                                         ((int64_t)iVar25 + (int64_t)local_40) * 8) + 0x218))();
                uVar44 = (*pcVar40)(*puVar27,fVar45);
                local_70 = (int64_t *)CONCAT44(local_70._4_4_,uVar44);
                (**(code **)(*local_60 + 0x208))(1,local_b0);
                if (local_48._4_4_ != 0) {
                  if (local_48._4_4_ < 1) {
                    iVar25 = -local_48._4_4_;
            ...
            break;
          case 0x6c:
            puVar32 = (void*)(**(code **)(*(int64_t *)*param_2 + 0x218))();
            local_70 = (int64_t *)*puVar32;
            puVar32 = (void*)(**(code **)(*(int64_t *)*param_1 + 0x218))();
            if ((local_70 != (int64_t *)*puVar32) && (*this_ptr != 0)) {
              local_58 = '\0';
              local_60 = (int64_t *)0x0;
              local_48 = 0xffffffff;
              local_40 = 0;
        ...
        if (((cVar24 != '\0') && (FUN_00d77bd0(), extraout_var == 1)) &&
          ...
          *puVar32 = &g_02572358;
          ...
          if (*this_ptr != 0) {
            ...
            while( true ) {
              ...
              if (*(int *)(local_50 + 0xc) <= iVar25) break;
              local_60 = *(int64_t **)(*(int64_t *)(local_50 + 0x10) + 8 + lVar26 * 8);
              (**(code **)(*local_60 + 0x210))(*(int64_t *)(local_50 + 0x10),local_b0);
              plVar34 = local_70;
              local_f8 = 0;
              if (local_68 == '\0') {
          ...
          *puVar33 = &g_02572358;
          ...
          uVar44 = (**(code **)(*(int64_t *)*param_2 + 0x210))(uVar44,local_b0);
          plVar34 = local_60;
          if (local_58 == '\0') {
          ...
          local_290 = 1;
          local_298 = plVar34;
          (**(code **)(*(int64_t *)*param_1 + 0x210))(uVar44,local_b0);
          plVar3 = local_70;
          if (local_68 == '\0') {
            if (local_70 != (int64_t *)0x0) {
              FUN_00d50b00();
...
LAB_017f8b43:
  ...
  local_158 = '\0';
  pplVar35 = &local_b0;
  uVar44 = (**(code **)(*(int64_t *)*param_2 + 0x88))(uVar44,&local_160);
  plVar34 = local_b0;
  if ((g_026d0220 == '\0') &&
...
LAB_017f8bd7:
  ...
  pplVar35 = &local_b0;
  local_150 = lVar26;
  (**(code **)(*(int64_t *)*param_1 + 0x88))(uVar44,&local_150);
  plVar3 = local_b0;
  if ((g_026d0220 == '\0') && (iVar25 = ___cxa_guard_acquire(), iVar25 != 0)) {
    g_02789148 = FUN_00d4fe50();
    g_02789130 = "GNData";
...
LAB_017f8ca8:
  ...
  if (plVar34 == plVar3) {
LAB_017f913e:
    if (plVar3 != (int64_t *)0x0) goto LAB_017f9143;
  }
  else {
    if ((plVar34 == (int64_t *)0x0) || (plVar3 == (int64_t *)0x0)) {
LAB_017f8d61:
      ...
      if (plVar4 != (int64_t *)0x0) {
        ...
        if (0 < *(int *)((int64_t)plVar4 + 0xc)) {
          uVar39 = 0;
          do {
            plVar5 = *(int64_t **)(plVar4[2] + (uint64_t)uVar39 * 8);
            iVar25 = (int)plVar34[3];
            iVar42 = iVar25 + 3;
            if (-1 < iVar25) {
              iVar42 = iVar25;
            ...
            local_130 = local_88;
            local_128 = '\0';
            fVar45 = (float)(**(code **)(**(int64_t **)
                                           (*(int64_t *)(*arg1 + 0x10) + (uint64_t)uVar39 * 8
...
LAB_017f8efa:
                ...
                uVar37 = 0;
                if (uVar8 + uVar38 * 4 <= uVar9 || uVar36 <= uVar8) {
                  uVar37 = (uint64_t)(uVar41 & 0xfffffffc);
                  uVar36 = 0;
                  do {
                    pfVar31 = (float *)(uVar6 + uVar36);
                    fVar50 = pfVar31[1];
...
LAB_017f8f45:
          ...
          } while ((int)uVar39 < *(int *)((int64_t)plVar4 + 0xc));
        }
        FUN_00083b20();
        lVar26 = local_88;
      }
