...
void FUN_015b6740(double param_1,uint64_t param_2,int param_3)
...
LAB_015b6923:
  ...
  uVar7 = FUN_00b82410(~-(uint64_t)(local_98 == 0.0) & (uint64_t)local_98 |
                       g_02410f78 & -(uint64_t)(local_98 == 0.0),local_54,uVar1,0);
  if ((local_38 == '\0') && (local_40 != 0)) {
    uVar7 = FUN_00d50b00();
  }
  if (local_68 != 0) {
