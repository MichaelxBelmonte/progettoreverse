...

{
  ...
  *puVar2 = &g_02572358;
  ...
  if (*(int *)(lVar3 + 0xc) < 1) {
    ...
    plVar7 = (int64_t *)0x0;
    do {
      (**(code **)(**(int64_t **)(*(int64_t *)(lVar3 + 0x10) + lVar6 * 8) + 0x980))();
      plVar5 = local_50;
      if (local_50 == plVar7) {
        plVar5 = plVar7;
        bVar8 = bVar9;
...
LAB_01eb213b:
  ...
  if (cVar1 == '\0') {
    ...
    lVar3 = FUN_00cafdf0();
    local_40 = (int64_t *)
               CONCAT44(local_40._4_4_,(int)CONCAT71((int7)((uint64_t)lVar3 >> 8),lVar3 != 0));
  }
  if ((local_48[0] != '\0') && (local_50 != (int64_t *)0x0)) {
    FUN_00d50b20();
  }
  if (*(int *)(this_ptr[7] + 0xc) != 0) {
    do {
      if ((char)local_40 == '\0') {
        (**(code **)(*this_ptr + 0x4a0))();
        FUN_00d23340();
  ...
  if (0 < *(int *)((int64_t)puVar2 + 0xc)) {
    ...
    local_40 = plVar5;
    do {
      plVar5 = *(int64_t **)(puVar2[2] + lVar3 * 8);
      if (local_40 == plVar5) {
        if ((!bVar9) && (local_40 != (int64_t *)0x0)) {
          bVar9 = true;
          FUN_00d50b00();
        }
      }
      ...
      plVar5 = *(int64_t **)(*(int64_t *)(this_ptr[7] + 0x10) + lVar3 * 8);
      FUN_00d43000();
      plVar7 = local_40;
