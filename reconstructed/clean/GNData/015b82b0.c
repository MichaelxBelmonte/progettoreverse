...

{
  ...
  FUN_00c92170();
  FUN_00c92160();
  uVar4 = *(uint *)(arg1 + 0x44);
  uVar27 = (uint64_t)uVar4;
  if ((int)uVar4 < 1) goto LAB_015b84cf;
  uVar5 = *(uint64_t *)(*(int64_t *)(arg1 + 0x70) + 0x10);
  uVar6 = *(uint64_t *)(*(int64_t *)(arg1 + 0x58) + 0x10);
  uVar7 = *(uint64_t *)(local_30 + 0x10);
  if (uVar4 < 8) {
    uVar26 = 0;
  }
  else {
    ...
    if ((uVar5 + uVar27 * 4 <= uVar7 || uVar22 <= uVar5) &&
      ...
      uVar26 = (uint64_t)(uVar4 & 0xfffffff8);
      uVar22 = (uVar26 - 8 >> 3) + 1;
      if (uVar26 - 8 == 0) {
        lVar25 = 0;
LAB_015b84a5:
