...

{
  ...
  if ((this_ptr != (uint8_t (*) [16])0x0) && (unaff_ESI != 0)) {
    if (((uint64_t)this_ptr & 0xf) == 0) {
      auVar20 = ZEXT816(0);
      uVar15 = 0;
    }
    else {
      uVar10 = 4 - (int)(((uint64_t)this_ptr & 0xf) >> 2);
      ...
      if ((uVar10 & 3) == 0) {
        ...
        do {
          puVar4 = *pauVar6;
          pauVar6 = (uint8_t (*) [16])(*pauVar6 + 4);
          fVar11 = (float)(*(uint *)puVar4 & g_02390140);
      ...
      if (2 < uVar10 - 1) {
        lVar9 = 0;
        do {
          fVar11 = (float)(*(uint *)(*pauVar6 + lVar9 * 4) & g_02390140);
          if (fVar11 <= auVar18._0_4_) {
            fVar11 = auVar18._0_4_;
          }
          fVar19 = (float)(*(uint *)(*pauVar6 + lVar9 * 4 + 4) & g_02390140);
          if (fVar19 <= fVar11) {
            fVar19 = fVar11;
          }
          fVar11 = (float)(*(uint *)(*pauVar6 + lVar9 * 4 + 8) & g_02390140);
          if (fVar11 <= fVar19) {
            fVar11 = fVar19;
          }
          fVar19 = (float)(*(uint *)(*pauVar6 + lVar9 * 4 + 0xc) & g_02390140);
          if (fVar19 <= fVar11) {
            fVar19 = fVar11;
          }
      ...
      this_ptr = (uint8_t (*) [16])(*this_ptr + (uint64_t)(uVar10 - 1) * 4 + 4);
    }
    if (3 < unaff_ESI) {
      ...
      auVar17._0_4_ = auVar20._0_4_ ^ g_023945e0;
    ...
    puVar5 = (uint *)(*this_ptr + (int64_t)(int)(unaff_ESI - uVar10) * 4);
    uVar7 = uVar10 - 1;
    if ((uVar10 & 3) != 0) {
      uVar8 = 0;
      do {
        uVar2 = *puVar5;
        puVar5 = puVar5 + 1;
        fVar11 = (float)(uVar2 & g_02390140);
        if ((float)(uVar2 & g_02390140) <= auVar20._0_4_) {
    ...
    if (2 < uVar7) {
      lVar9 = 0;
      do {
        fVar11 = (float)(puVar5[lVar9] & g_02390140);
        if ((float)(puVar5[lVar9] & g_02390140) <= auVar20._0_4_) {
          fVar11 = auVar20._0_4_;
        }
        fVar19 = (float)(puVar5[lVar9 + 1] & g_02390140);
        if ((float)(puVar5[lVar9 + 1] & g_02390140) <= fVar11) {
          fVar19 = fVar11;
        }
        fVar11 = (float)(puVar5[lVar9 + 2] & g_02390140);
        if ((float)(puVar5[lVar9 + 2] & g_02390140) <= fVar19) {
          fVar11 = fVar19;
        }
        fVar19 = (float)(puVar5[lVar9 + 3] & g_02390140);
        if ((float)(puVar5[lVar9 + 3] & g_02390140) <= fVar11) {
          fVar19 = fVar11;
        }
