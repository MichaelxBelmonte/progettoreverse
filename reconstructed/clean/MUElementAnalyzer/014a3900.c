...

{
  ...
  if (1 < *(int *)(lVar15 + 0xc)) {
    ...
    local_70 = 0;
    do {
      lVar15 = *(int64_t *)(*(int64_t *)(lVar15 + 0x10) + lVar14 * 8);
      if (lVar13 == lVar15) {
        if ((cVar5 == '\0') && (lVar13 != 0)) {
          cVar6 = '\x01';
          cVar5 = '\x01';
      ...
      lVar15 = *(int64_t *)(*(int64_t *)(*arg1 + 0x10) + 8 + lVar14 * 8);
      if (local_40 == lVar15) {
      ...
      if (lVar14 < (int64_t)*(int *)(*arg1 + 0xc) + -2) {
        lVar15 = *(int64_t *)(*(int64_t *)(*arg1 + 0x10) + 0x10 + lVar14 * 8);
        if (local_78 == lVar15) {
          if ((!bVar1) && (local_78 != 0)) {
            bVar1 = true;
            FUN_00d50b00();
...
LAB_014a3c27:
        auVar19 = insertps(ZEXT416(*(uint *)(lVar13 + 0x2c)),*(void*)(local_40 + 0x2c),0x10);
        auVar17 = insertps(ZEXT416(*(uint *)(lVar13 + 0x20)),*(void*)(local_40 + 0x20),0x10);
        auVar21 = insertps(ZEXT416(*(uint *)(lVar13 + 0x28)),*(void*)(local_40 + 0x28),0x10);
        fVar18 = g_023b5570 - auVar21._0_4_;
        ...
        if ((*(int *)(lVar13 + 0x3c) == 2) && (lVar13 != lVar12)) {
          *(void*)(lVar12 + 0x18) = *(void*)(lVar13 + 0x10);
          *(void*)(lVar12 + 0x24) = *(void*)(lVar13 + 0x20);
        }
...
LAB_014a40af:
      ...
      lVar14 = lVar14 + 1;
      lVar15 = *arg1;
    } while (lVar14 < (int64_t)*(int *)(lVar15 + 0xc) + -1);
    if ((cVar3 != '\0') && (local_70 != 0)) {
      FUN_00d50b20();
    }
