...
void FUN_0078e820(void* param_1)

{
  ...
  if (!bVar16) {
    ...
    if (cVar2 != '\0') {
      ...
      uVar6 = (uint64_t)(dVar17 * g_023907c0);
      ...
      bVar3 = (byte)(((int64_t)dVar17 & (int64_t)uVar6 >> 0x3f | uVar6) / 3);
      local_b0 = plVar1;
      local_a8 = '\0';
      FUN_000175c0();
      plVar13 = local_78;
      ...
      if ((plVar13 != (int64_t *)0x0 & bVar3) != 0) {
        ...
        *puVar7 = &g_02572358;
        local_b8 = puVar7;
        (*g_02572370)();
        if ((void*)this_ptr[0x24] != (void*)0x0) {
          local_70[0] = '\0';
          local_78 = (int64_t *)0x0;
          local_68 = (void*)this_ptr[0x24];
          local_60 = 0xffffffff;
          local_58 = 0;
          local_60._4_4_ = 0;
          while( true ) {
            ...
            local_60 = CONCAT44(local_60._4_4_,iVar4);
            if (*(int *)((int64_t)local_68 + 0xc) <= iVar4) break;
            plVar1 = *(int64_t **)(local_68[2] + 8 + lVar8 * 8);
            local_78 = plVar1;
            local_b0 = plVar1;
        ...
        if (*(int *)((int64_t)local_b8 + 0xc) != 0) {
          ...
          if (plVar1 != (int64_t *)0x0) {
            ...
            if (0 < *(int *)((int64_t)plVar1 + 0xc)) {
              uVar15 = 0;
              do {
                local_b0 = *(int64_t **)(plVar1[2] + (uint64_t)uVar15 * 8);
                uVar11 = uVar15;
                ...
                FUN_012e7210();
                iVar4 = *(int *)((int64_t)local_78 + 0xc);
                if ((local_70[0] != '\0') && (local_78 != (int64_t *)0x0)) {
                  FUN_00d50b20();
                }
                if (iVar4 == 1) {
                  ...
                  FUN_00d23310();
                  plVar13 = local_78;
                  local_d0 = (int64_t *)CONCAT71(local_d0._1_7_,local_70[0]);
                  pplVar12 = &local_d0;
                  ...
                  *(char *)pplVar9 = '\0';
                  ...
                  local_80 = plVar13;
                  if (((char)local_d0 == '\0') && (plVar13 != (int64_t *)0x0)) {
                    FUN_00d50b00();
                  }
                  if ((local_40 != '\0') && (local_48 != (int64_t *)0x0)) {
                    FUN_00d50b20();
                  ...
                  if (cVar2 == '\0') {
                    ...
                    while( true ) {
                      ...
                      pvVar5 = _pthread_getspecific((void*)local_68[2]);
                      if (pvVar5 != (void *)0x0) {
                        FUN_00e8b990();
                      }
                      FUN_01264240();
...
LAB_0078f4a6:
              ...
              } while ((int)uVar15 < *(int *)((int64_t)plVar1 + 0xc));
            }
            FUN_000be170();
            FUN_00d50b20();
