...
uint64_t FUN_014b5bc0(double param_1,double param_2,float param_3,float param_4,char param_5)

{
  ...
  dVar45 = ((double)local_54 * g_023907c0) / param_2;
  auVar4._4_8_ = (uint64_t)dVar45 >> 0x20;
  auVar4._0_4_ = (float)dVar45 * g_023941f4;
  fVar42 = (float)_exp2f(auVar4._0_8_);
  fVar44 = g_02390124;
  if (local_res10 != '\0') {
    in_XMM4_Da = in_XMM4_Da * g_0239011c;
    fVar44 = g_0239011c;
  }
  uVar26 = (uint)(param_2 * (double)local_60);
  iVar37 = (int)(param_2 * local_70);
  lVar19 = (int64_t)(local_70 * param_1);
  if (in_RDX < (int64_t)(local_70 * param_1)) {
    lVar19 = in_RDX;
  }
  if (in_XMM4_Da <= 0.0) {
    pfVar36 = (float *)0x0;
    ...
    pfVar36 = (float *)(int64_t)((double)local_60 * param_1);
    local_34 = (float)(param_1 / (double)in_XMM4_Da);
    fVar47 = local_34 / (float)(int)(g_0240e360 / local_74);
    if (fVar47 <= g_02390124) {
      fVar51 = 0.0;
      fVar47 = g_02390124 / (float)(int)(g_02390124 / fVar47 + g_0239011c);
    }
    else {
      fVar47 = (float)(int)(fVar47 + g_0239011c);
      fVar51 = (float)(int)(float)((uint64_t)(param_1 / (double)in_XMM4_Da) >> 0x20);
    }
    local_e8 = CONCAT44(fVar51,fVar47);
    uStack_e0 = 0;
    uVar39 = (uint64_t)((float)(lVar19 - (int64_t)pfVar36) / fVar47);
    local_bc = fVar44;
    ...
    if (this_ptr == 0) {
      ...
      in_RCX = pfVar36;
            ...
            ((uVar26 = (uint)((float)(~-(uint)((float)local_e8 < g_02390124) &
                                      (uint)(float)local_e8 |
                                     (uint)(g_02390124 / (float)local_e8) &
                                     -(uint)((float)local_e8 < g_02390124)) + g_0239011c),
             (int)uVar26 <= (int)uVar16 || ((float)local_e8 < g_02390124)))) {
      if (uVar26 == 1) {
        in_R8 = (uint64_t)(uVar16 - 1);
        pfVar35 = (float *)(uVar39 & 0xffffffff);
        pfVar20 = local_68;
        if ((6 < uVar16 - 1) &&
           (((float *)(this_ptr + (in_R8 + (int64_t)pfVar36) * 4 + 4) <= local_68 ||
            (pfVar35 = (float *)(uVar39 & 0xffffffff),
            local_68 + in_R8 + 1 <= (float *)(this_ptr + (int64_t)pfVar36 * 4))))) {
          in_R8 = in_R8 + 1;
          uVar18 = in_R8 & 0xfffffffffffffff8;
          uVar30 = (uVar18 - 8 >> 3) + 1;
          uVar25 = (uint64_t)((uint)uVar30 & 3);
          if (uVar18 - 8 < 0x18) {
            lVar31 = 0;
          }
          else {
            lVar19 = this_ptr + (int64_t)pfVar36 * 4;
            lVar28 = -(uVar30 & 0xfffffffffffffffc);
            lVar31 = 0;
            do {
              puVar2 = (void*)(lVar19 + lVar31 * 4);
              uVar9 = puVar2[1];
              puVar3 = (void*)(lVar19 + 0x10 + lVar31 * 4);
              uVar10 = *puVar3;
              uVar11 = puVar3[1];
              *(void*)(local_68 + lVar31) = *puVar2;
              *(void*)(local_68 + lVar31 + 2) = uVar9;
              *(void*)(local_68 + lVar31 + 4) = uVar10;
              *(void*)(local_68 + lVar31 + 4 + 2) = uVar11;
              puVar2 = (void*)(lVar19 + 0x20 + lVar31 * 4);
              uVar9 = puVar2[1];
              puVar3 = (void*)(lVar19 + 0x30 + lVar31 * 4);
              uVar10 = *puVar3;
              uVar11 = puVar3[1];
              *(void*)(local_68 + lVar31 + 8) = *puVar2;
              *(void*)(local_68 + lVar31 + 8 + 2) = uVar9;
              *(void*)(local_68 + lVar31 + 0xc) = uVar10;
              *(void*)(local_68 + lVar31 + 0xc + 2) = uVar11;
              puVar2 = (void*)(lVar19 + 0x40 + lVar31 * 4);
              uVar9 = puVar2[1];
              puVar3 = (void*)(lVar19 + 0x50 + lVar31 * 4);
              uVar10 = *puVar3;
              uVar11 = puVar3[1];
              *(void*)(local_68 + lVar31 + 0x10) = *puVar2;
              *(void*)(local_68 + lVar31 + 0x10 + 2) = uVar9;
              *(void*)(local_68 + lVar31 + 0x14) = uVar10;
              *(void*)(local_68 + lVar31 + 0x14 + 2) = uVar11;
              puVar2 = (void*)(lVar19 + 0x60 + lVar31 * 4);
              uVar9 = puVar2[1];
              ...
              fVar51 = pfVar20[2];
              fVar43 = pfVar20[3];
              *(void*)(local_68 + lVar31 + 0x18) = *puVar2;
              *(void*)(local_68 + lVar31 + 0x18 + 2) = uVar9;
          ...
          if (uVar25 != 0) {
            lVar19 = this_ptr + (lVar31 + (int64_t)pfVar36) * 4;
            lVar28 = 0;
            do {
              puVar2 = (void*)(lVar19 + lVar28);
              uVar9 = puVar2[1];
              puVar1 = (void*)(lVar19 + 0x10 + lVar28);
              uVar5 = *puVar1;
              uVar6 = puVar1[1];
              uVar7 = puVar1[2];
              uVar8 = puVar1[3];
              puVar3 = (void*)((int64_t)local_68 + lVar28 + lVar31 * 4);
              *puVar3 = *puVar2;
              puVar3[1] = uVar9;
              puVar1 = (void*)((int64_t)local_68 + lVar28 + lVar31 * 4 + 0x10);
              *puVar1 = uVar5;
              puVar1[1] = uVar6;
              puVar1[2] = uVar7;
              puVar1[3] = uVar8;
          ...
          pfVar35 = (float *)(uint64_t)(uVar16 - (int)uVar18);
          pfVar20 = local_68 + uVar18;
          pfVar36 = (float *)(uVar18 + (int64_t)pfVar36);
        }
        uVar26 = (uint)pfVar35;
        if (((uint64_t)pfVar35 & 3) != 0) {
          uVar27 = 0;
          do {
            *pfVar20 = *(float *)(this_ptr + (int64_t)pfVar36 * 4);
            pfVar20 = pfVar20 + 1;
            pfVar36 = (float *)((int64_t)pfVar36 + 1);
            uVar27 = uVar27 + 1;
          } while ((uVar26 & 3) != uVar27);
          pfVar35 = (float *)(uint64_t)(uVar26 - uVar27);
        }
        in_RCX = (float *)(uint64_t)(uVar26 - 1);
        if (2 < uVar26 - 1) {
          lVar19 = this_ptr + (int64_t)pfVar36 * 4;
          lVar28 = 0;
          do {
      ...
      else if (g_02390124 <= (float)local_e8) {
        uVar25 = (uint64_t)(uVar26 - 1);
        local_70 = (double)(uVar25 + 1);
        lVar28 = -(int64_t)pfVar36;
        lVar19 = this_ptr + (int64_t)pfVar36 * 4;
        ...
        do {
          ...
          if (2 < uVar26 - 1) {
            ...
            in_RCX = (float *)(this_ptr + 0xc + (int64_t)in_RCX * 4);
            in_R8 = 0;
            do {
          ...
          pfVar36 = (float *)((int64_t)pfVar36 + (int64_t)local_70);
          *pfVar20 = fVar44;
          pfVar20 = pfVar20 + 1;
        ...
        fVar44 = *(float *)(this_ptr + (int64_t)pfVar36 * 4);
        pfVar20 = local_68;
        fVar47 = fVar44;
        if (uVar16 == 1) {
          in_RCX = (float *)0x0;
          ...
          do {
            ...
            fVar43 = fVar47;
            if ((uint)in_RCX == 0) {
              fVar43 = *(float *)(this_ptr + lVar19 * 4);
            ...
            *pfVar20 = fVar44;
            if (uVar27 - 1 == 0) {
              fVar47 = *(float *)(this_ptr + lVar19 * 4);
            ...
            in_RCX = (float *)(uint64_t)(uVar27 - 1);
            pfVar20[1] = fVar44;
            pfVar20 = pfVar20 + 2;
            fVar44 = fVar44 + fVar51;
            iVar37 = iVar37 + 2;
...
LAB_014b5f0e:
    ...
    if (param_5 != '\0') {
      ...
      fVar44 = g_0239011c;
      if (0 < (int64_t)uVar39) {
        iVar15 = (int)((double)(local_34 / (float)local_e8) + g_023942d0);
        uVar24 = 0;
        do {
          ...
          lVar28 = (int64_t)(iVar15 + (int)uVar24);
          if (lVar28 < (int64_t)uVar39) {
...
LAB_014b6190:
        do {
          ...
          fVar46 = (local_70._0_4_ / fVar43) / fVar44 + g_0239011c;
          uVar27 = (uint)((float)(int)fVar46 * g_02394298);
          pfVar20 = (float *)(uint64_t)uVar27;
          if ((int)uVar27 < 3) {
            pfVar20 = (float *)((int64_t)&MACH_HEADER.magic + 2);
          }
          uVar27 = (int)(((double)iVar29 * param_2 - dVar45) / dVar56) -
                   (int)((uint64_t)pfVar20 >> 1);
          if ((int)uVar27 < 0) {
            uVar27 = 0;
          }
          ...
          uVar24 = (uint64_t)(uVar27 + (int)pfVar20);
          if ((int64_t)uVar24 <= (int64_t)uVar39) {
            uVar21 = uVar27;
          }
          ...
          if ((int)uVar27 < 1) {
            ...
            if (pfVar35 == (float *)((int64_t)&MACH_HEADER.magic + 1)) {
              auVar53 = ZEXT816(0);
              pfVar20 = (float *)0x0;
LAB_014b6398:
              fVar48 = pfVar33[(int64_t)pfVar20] - fVar48;
              auVar53._0_4_ =
                   auVar53._0_4_ +
                   (float)(~-(uint)(0.0 < fVar48) & ((uint)fVar48 ^ g_023945e0) |
              ...
              pfVar20 = (float *)0x0;
              do {
                fVar54 = local_110[(int64_t)pfVar20 + (uVar18 - 1)] - fVar48;
                fVar50 = auVar53._0_4_;
                fVar55 = local_110[uVar18 + (int64_t)pfVar20] - fVar48;
                auVar52._0_4_ = ~-(uint)(0.0 < fVar55) & ((uint)fVar55 ^ g_023945e0);
                ...
                auVar53._0_4_ =
                     auVar52._0_4_ +
                     (float)(~-(uint)(0.0 < fVar54) & ((uint)fVar54 ^ g_023945e0) |
                            (uint)fVar54 & -(uint)(0.0 < fVar54)) + fVar50;
                pfVar20 = (float *)((int64_t)pfVar20 + 2);
              } while ((float *)(uint64_t)(uVar27 & 0xfffffffe) != pfVar20);
              if (((uint64_t)pfVar35 & 1) != 0) goto LAB_014b6398;
            }
          ...
          local_78 = 0.3333;
          if ((g_023d59b4 < fVar48 / (float)(int)uVar27) &&
             (pfVar20 = (float *)(uint64_t)(uVar21 * 2), (int)(uVar21 * 2) < (int)uVar27)) {
            uVar23 = (uint)((fVar43 * local_70._0_4_) / fVar44 + g_0239011c);
            fVar43 = g_02390124 / (fVar48 / (float)(int)uVar27);
            ...
            if (iVar34 == 0 || (int)uVar27 < (int)uVar21) {
              ...
              if ((uVar27 - uVar21 & 1) != 0) {
                ...
                pfVar20 = pfVar20 + 1;
                fVar46 = (float)(~-(uint)(0.0 < fVar46) & ((uint)fVar46 ^ g_023945e0) |
              ...
              if (uVar27 != uVar21 + 1) {
                ...
                do {
                  ...
                  fVar46 = (float)(~-(uint)(0.0 < fVar50) & ((uint)fVar50 ^ g_023945e0) |
            ...
            fVar46 = g_02390124 - (fVar46 / (float)(iVar34 * 2)) * fVar43;
            uVar38 = uVar23 * 2;
            local_78 = fVar46;
            if (((int)uVar38 < (int)uVar27) && (uVar22 = uVar27 - uVar23, 0 < (int)uVar22)) {
              ...
              do {
                ...
                if ((uVar22 & 1) != 0) {
                  ...
                  pfVar36 = pfVar36 + 1;
                  fVar48 = (float)(~-(uint)(0.0 < fVar48) & ((uint)fVar48 ^ g_023945e0) |
                ...
                if (uVar22 != 1) {
                  ...
                  do {
                    ...
                    fVar48 = (float)(~-(uint)(0.0 < fVar54) & ((uint)fVar54 ^ g_023945e0) |
                                    (uint)fVar54 & -(uint)(0.0 < fVar54)) +
                             (float)(~-(uint)(0.0 < fVar50) & ((uint)fVar50 ^ g_023945e0) |
                                    (uint)fVar50 & -(uint)(0.0 < fVar50)) + fVar48;
                    lVar19 = lVar19 + 2;
                  } while (uVar38 != (uint)lVar19);
                }
                fVar48 = g_02390124 - (fVar48 / (float)(int)(uVar22 * 2)) * fVar43;
                if (fVar46 < fVar48) {
                  iVar34 = -iVar34;
                ...
                if ((int)uVar21 < 2) {
                  ...
                  if ((((local_res18 & 1) == 0) && (3 < (int)uVar38)) &&
                    ...
                    uVar18 = (uint64_t)(uVar38 - 2);
                    lVar19 = (int64_t)(int)uVar27;
                    uVar24 = lVar19 - uVar18;
                    iVar34 = (int)uVar24;
                    if (uVar24 == 0 || lVar19 < (int64_t)uVar18) {
                      fVar44 = 0.0;
                    }
                    else {
                      ...
                      if ((uVar24 & 1) != 0) {
                        ...
                        pfVar36 = pfVar36 + 1;
                        fVar44 = (float)(~-(uint)(0.0 < fVar44) & ((uint)fVar44 ^ g_023945e0) |
                      ...
                      if (uVar27 + 1 != uVar38) {
                        ...
                        do {
                          ...
                          fVar44 = (float)(~-(uint)(0.0 < fVar48) & ((uint)fVar48 ^ g_023945e0) |
                                          (uint)fVar48 & -(uint)(0.0 < fVar48)) +
                                   (float)(~-(uint)(0.0 < fVar46) & ((uint)fVar46 ^ g_023945e0) |
                                          (uint)fVar46 & -(uint)(0.0 < fVar46)) + fVar44;
                          lVar28 = lVar28 + 2;
                        } while (iVar12 != (int)lVar28);
                      }
                    }
                    *pfVar17 = g_02390124 - (fVar44 / (float)(iVar34 * 2)) * fVar43;
                    lVar28 = uVar18 + 1;
...
joined_r0x014b6d6c:
          ...
          if ((local_res18 & 1) != 0) {
            ...
            if ((((int)local_60 != 0) && (iVar34 == iVar15)) ||
               ((3 < (int)local_60 &&
                (pfVar20 = (float *)(uint64_t)(uint)(iVar34 - iVar15),
                (iVar15 - local_c0) * (iVar34 - iVar15) < 0)))) {
              local_54 = (float)CONCAT71((int7)((uint64_t)pfVar20 >> 8),1);
              local_res18 = 0;
            }
            uVar26 = (int)local_60 + 1;
            bVar14 = 6 < (int)local_60;
            local_c0 = iVar15;
            local_60 = (float *)(uint64_t)uVar26;
          ...
          if (((local_res18 & 1) == 0) && (((uint)local_54 & 1) != 0)) {
            ...
            if ((-1 < (int)uVar26) && ((int)uVar26 < local_res8)) {
              ...
              *(float *)(local_d0 + (uint64_t)uVar26 * 4) = fVar43;
            }
  ...
  if (iVar37 - uVar26 != 0 && (int)uVar26 <= iVar37) {
    ...
    if ((iVar37 - uVar26 & 1) != 0) {
      ...
      if ((-1 < (int)uVar27) && ((int)uVar27 < local_res8)) {
        ...
        *(void*)(local_d0 + (uint64_t)uVar27 * 4) = 0x358637bd;
      }
      uVar26 = uVar26 + 1;
    }
    if (uVar16 + iVar37 != 0) {
      ...
      do {
        if ((-1 < (int)uVar26) && ((int)uVar26 < local_res8)) {
          ...
          *(void*)(local_d0 + (uint64_t)uVar26 * 4) = 0x358637bd;
        }
        uVar16 = uVar26 + 1;
        if ((-1 < (int)uVar16) && ((int)uVar16 < local_res8)) {
          local_c8[uVar16] = fVar44;
          *(void*)(local_d0 + (uint64_t)uVar16 * 4) = 0x358637bd;
        }
        uVar26 = uVar26 + 2;
        iVar37 = iVar37 + -2;
      } while (iVar37 != 0);
