...

{
  ...
  if (iVar2 < 1) {
    ...
    bVar4 = false;
    do {
      lVar13 = *(int64_t *)(*(int64_t *)(lVar13 + 0x10) + lVar12 * 8);
      if (local_40 == lVar13) {
        if ((!bVar3) && (local_40 != 0)) {
          bVar3 = true;
          FUN_00d50b00();
      ...
      if (lVar12 < (int64_t)*(int *)(*arg1 + 0xc) + -1) {
        lVar13 = *(int64_t *)(*(int64_t *)(*arg1 + 0x10) + 8 + lVar12 * 8);
        if (local_38 == lVar13) {
          lVar13 = local_38;
          if (bVar4) {
            bVar5 = true;
...
LAB_014a5868:
      ...
      if ((int)uVar15 < 1) {
        ...
        uVar16 = 0;
        do {
          lVar13 = (int64_t)(iVar9 + (int)uVar10);
  ...
  fVar20 = ((g_02390124 - fVar21) + g_0240e340) / g_02394250;
  fVar21 = 0.0;
  if (0.0 <= fVar20) {
    fVar21 = fVar20;
  }
  fVar21 = (float)_powf(fVar21,g_02390128);
  if (0 < iVar2) {
    local_74 = g_02390124 - local_58 / local_5c;
  }
  FUN_00e83070();
  if ((bVar4) && (local_38 != 0)) {
    FUN_00d50b20();
  ...
  return (fVar20 + fVar21 + local_74) * g_0240e344;
}
