...
void* FUN_014a08f0(float param_1,float param_2,float param_3)
  ...
  *puVar3 = &g_02572358;
  ...
  if (*(int *)(lVar4 + 0xc) < 1) {
    ...
    do {
      ...
      if (g_02390124 <= (float)((uint)(fVar7 - local_68) & g_02390140)) {
        if (lVar6 == 0) {
          if (local_40 != 0) {
            lVar4 = 0;
...
LAB_014a0b0a:
          ...
          lVar4 = *(int64_t *)(*(int64_t *)(*in_RDX + 0x10) + -8 + lVar6 * 8);
          if (local_40 == lVar4) {
...
joined_r0x014a0aff:
          ...
          dVar8 = (*(double *)(local_40 + 0x18) + *(double *)(lVar5 + 0x10)) * g_023942d0;
        }
