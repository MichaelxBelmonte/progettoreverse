...
void FUN_01e3fdf0(uint64_t param_1)

{
  ...
  fVar24 = (float)((uint64_t)param_1 >> 0x20);
  fVar15 = (float)param_1;
  if ((*(float *)((int64_t)this_ptr + 0xfc) == fVar15) &&
     (!NAN(*(float *)((int64_t)this_ptr + 0xfc)) && !NAN(fVar15))) {
    if ((*(float *)(this_ptr + 0x20) == fVar24) &&
       (!NAN(*(float *)(this_ptr + 0x20)) && !NAN(fVar24))) {
      return;
    }
  }
  fVar1 = *(float *)((int64_t)this_ptr + 0x104);
  if ((!NAN(fVar1)) && (fVar1 = *(float *)(this_ptr + 0x21), !NAN(fVar1))) {
    return;
  }
  ...
  *(float *)((int64_t)this_ptr + 0xfc) = fVar15;
  *(float *)(this_ptr + 0x20) = fVar24;
  if ((g_028b9dc0 == (void*)0x0) || (g_028b9dc9 == '\0')) {
    FUN_00e8cb50();
    if (g_028b9dc0 == (void*)0x0) {
      puVar9 = (void*)FUN_00e8fc40();
      FUN_00d4ff40();
      *puVar9 = &g_02572358;
      (*g_02572370)();
      bVar14 = g_028b9dc0 == (void*)0x0;
      g_028b9dc0 = puVar9;
      if (((bVar14) || (FUN_00d50b20(), g_028b9dc0 != (void*)0x0)) &&
         (g_028b9dc8 == '\0')) {
        g_028b9dc8 = '\x01';
        FUN_00e8cb90();
      }
  ...
  if ((char)this_ptr[0x1e] != '\0') {
    in_stack_ffffffffffffff88 = (int64_t *)FUN_00e8fc40();
    FUN_00022d50();
    (**(code **)(*in_stack_ffffffffffffff88 + 0x18))();
    local_70._0_1_ = '\0';
    FUN_00d21140();
    if (((char)local_70 != '\0') && (in_stack_ffffffffffffff88 != (int64_t *)0x0)) {
      FUN_00d50b20();
    }
    FUN_00d50b20();
  }
  ...
  *(void*)plVar29 = 0;
  ...
  if (((char)local_f0 == '\0') && (local_50 != (int64_t *)0x0)) {
    FUN_00d50b00();
  }
  if ((((NAN(*(float *)(this_ptr + 0x1b))) || (NAN(*(float *)(this_ptr + 0x1c)))) ||
      (NAN(*(float *)((int64_t)this_ptr + 0xdc)))) ||
     (NAN(*(float *)((int64_t)this_ptr + 0xe4)))) {
    local_a8 = (uint8_t  [8])(**(code **)(*this_ptr + 0x600))();
    uStack_a0 = extraout_XMM0_Qb_01;
    fVar15 = *(float *)(this_ptr + 0x1b);
    if (NAN(fVar15) || NAN(fVar15)) {
      auVar17 = ZEXT416(*(uint *)((int64_t)this_ptr + 0xdc));
      auVar19 = ZEXT416((uint)*(float *)(this_ptr + 0x1c));
      if (!NAN(*(float *)(this_ptr + 0x1c))) goto LAB_01e40aeb;
LAB_01e40a3c:
      _local_c8 = auVar18;
      if (!NAN(auVar17._0_4_)) goto LAB_01e40b08;
LAB_01e40a45:
      fVar15 = *(float *)((int64_t)this_ptr + 0xe4);
      auVar18 = auVar19;
    }
    else {
      ...
      auVar17 = ZEXT416(*(uint *)((int64_t)this_ptr + 0xdc));
      auVar19 = ZEXT416((uint)*(float *)(this_ptr + 0x1c));
      if (NAN(*(float *)(this_ptr + 0x1c))) goto LAB_01e40a3c;
LAB_01e40aeb:
...
LAB_01e40b08:
    ...
    uStack_a0 = 0;
    local_a8 = (uint8_t  [8])this_ptr[0x1b];
    _fStack_c0 = 0;
    local_c8 = (uint8_t  [8])this_ptr[0x1c];
  }
  ...
  if (((NAN(*(float *)(this_ptr + 0x19))) || (NAN(*(float *)(this_ptr + 0x1a)))) ||
     ((NAN(*(float *)((int64_t)this_ptr + 0xcc)) || (NAN(*(float *)((int64_t)this_ptr + 0xd4))))
     )) {
    local_98 = (uint8_t  [8])(**(code **)(*this_ptr + 0x5f8))();
    uStack_90 = extraout_XMM0_Qb_02;
    fVar15 = *(float *)(this_ptr + 0x19);
    if (NAN(fVar15) || NAN(fVar15)) {
      auVar17 = ZEXT416(*(uint *)((int64_t)this_ptr + 0xcc));
      fVar15 = *(float *)(this_ptr + 0x1a);
      if (!NAN(fVar15)) goto LAB_01e40b73;
LAB_01e40a9f:
      _local_b8 = auVar18;
      if (!NAN(auVar17._0_4_)) goto LAB_01e40b90;
LAB_01e40aa8:
      fVar15 = *(float *)((int64_t)this_ptr + 0xd4);
    }
    else {
...
LAB_01e40b90:
    ...
    uStack_90 = 0;
    local_98 = (uint8_t  [8])this_ptr[0x19];
    _fStack_b0 = 0;
    local_b8 = (uint8_t  [8])this_ptr[0x1a];
  }
  ...
  fVar15 = *(float *)((int64_t)this_ptr + 0xc4);
  _local_88 = auVar18;
  ...
  auVar17._0_8_ = (**(code **)(*this_ptr + 0x5d0))();
  ...
  if ((char)this_ptr[0x1e] != '\0') {
    ...
    *(void*)plVar29 = 0;
    ...
    if ((char)local_f0 == '\0') {
      if (in_stack_ffffffffffffff88 != (int64_t *)0x0) {
        FUN_00d50b00();
        goto LAB_01e402bc;
      }
    }
    else if (in_stack_ffffffffffffff88 != (int64_t *)0x0) {
LAB_01e402bc:
      local_70._0_1_ = '\0';
      plVar29 = (int64_t *)0x0;
      local_60 = 0xffffffff;
      ...
      while( true ) {
        ...
        lVar10 = (int64_t)(int)local_60;
        iVar13 = (int)local_60 + 1;
        local_60 = CONCAT44(local_60._4_4_,iVar13);
        if (*(int *)((int64_t)local_68 + 0xc) <= iVar13) break;
        plVar29 = *(int64_t **)(local_68[2] + 8 + lVar10 * 8);
        if (1 < *(int *)((int64_t)plVar29 + 0xc)) {
          local_e8 = '\0';
          local_f0 = 0;
          local_d4 = 0;
          uVar2 = *(uint *)((int64_t)plVar29 + 0xc);
          if ((int)uVar2 < 1) {
            uVar12 = 0;
            local_48._0_4_ = 0.0;
            fStack_40 = 0.0;
...
LAB_01e4042e:
            ...
            if (uVar2 - 1 < 3) {
              ...
              uVar12 = 0;
              do {
                fVar24 = *(float *)(*(int64_t *)(lVar10 + uVar12 * 8) + 0xf4);
                if (fVar15 <= fVar24) {
                  fVar15 = fVar24;
                }
                fVar24 = *(float *)(*(int64_t *)(lVar10 + 8 + uVar12 * 8) + 0xf4);
                if (fVar15 <= fVar24) {
                  fVar15 = fVar24;
                }
                fVar24 = *(float *)(*(int64_t *)(lVar10 + 0x10 + uVar12 * 8) + 0xf4);
                if (fVar15 <= fVar24) {
                  fVar15 = fVar24;
                }
                local_f0 = *(int64_t *)(lVar10 + 0x18 + uVar12 * 8);
            ...
            if (uVar11 != 0) {
              ...
              do {
                local_f0 = *(int64_t *)(lVar10 + uVar12 * 8);
          ...
          if (plVar29 != (int64_t *)0x0) {
            ...
            local_f0 = 0;
            local_d4 = 0;
            if (*(int *)((int64_t)plVar29 + 0xc) < 1) {
              local_d8 = 0;
            }
            else {
              uVar12 = 0;
              do {
                local_f0 = *(int64_t *)(plVar29[2] + uVar12 * 8);
                if (g_0239424c < local_48._0_4_ - *(float *)(local_f0 + 0xf4)) {
                  plVar8 = *(int64_t **)(local_f0 + 0x30);
                  while ((plVar3 = plVar8, plVar3 != (int64_t *)0x0 && (plVar3 != this_ptr))) {
                    *(void*)((int64_t)plVar3 + 0xf4) = 0x7fc000007fc00000;
                    *(void*)((int64_t)plVar3 + 0xfc) = 0x7fc000007fc00000;
                    *(void*)((int64_t)plVar3 + 0x104) = 0x7fc000007fc00000;
                    plVar8 = (int64_t *)plVar3[6];
                    if ((int64_t *)plVar3[6] == plVar3) {
                      plVar8 = plVar3;
                    }
                  }
                }
                auVar18 = insertps(_local_48,*(void*)(local_f0 + 0xf8),0x10);
                *(int64_t *)(local_f0 + 0x104) = auVar18._0_8_;
                local_d8 = (int)uVar12 + 1;
                uVar12 = (uint64_t)local_d8;
              } while ((int)local_d8 < *(int *)((int64_t)plVar29 + 0xc));
            }
            local_e0 = plVar29;
            FUN_000a9680();
          }
    ...
    *(void*)plVar29 = 0;
    ...
    if (local_50 == in_stack_ffffffffffffff88) {
      plVar29 = local_50;
      if (((char)local_f0 != '\0') && (in_stack_ffffffffffffff88 != (int64_t *)0x0)) {
        FUN_00d50b20();
        plVar29 = local_50;
      }
    }
...
LAB_01e4061d:
    ...
    auVar25 = ZEXT416((uint)*(float *)(this_ptr + 0x17));
    auVar19 = auVar17;
    if (auVar18._0_4_ < *(float *)(this_ptr + 0x17)) {
LAB_01e40681:
...
LAB_01e40667:
    ...
    auVar25 = ZEXT416((uint)*(float *)(this_ptr + 0x17));
    auVar19 = auVar17;
    if (auVar21._0_4_ < *(float *)(this_ptr + 0x17)) goto LAB_01e40681;
  }
  fVar15 = *(float *)((int64_t)this_ptr + 0xbc);
...
LAB_01e406c6:
    auVar18 = auVar17;
    auVar19 = ZEXT416((uint)*(float *)((int64_t)this_ptr + 0xc4));
    auVar17 = auVar18;
    if (auVar18._4_4_ <= *(float *)((int64_t)this_ptr + 0xc4)) goto LAB_01e40728;
  }
  else {
...
LAB_01e40728:
  ...
  *(int64_t *)((int64_t)this_ptr + 0xf4) = auVar18._0_8_;
  lVar10 = this_ptr[0x1d];
  if (lVar10 != 0) {
    uVar16 = FUN_00d50b00();
    if (local_50 == (int64_t *)0x0) {
      FUN_00d8b910();
      ...
      *(char *)plVar29 = '\0';
      ...
      local_70._0_1_ = '\0';
      FUN_00d21140();
      if (((char)local_70 != '\0') && (this_ptr != (int64_t *)0x0)) {
        FUN_00d50b20();
      }
      FUN_00d50b20();
      if ((local_38[0] != '\0') && (in_stack_ffffffffffffff88 != (int64_t *)0x0)) {
        FUN_00d50b20();
      }
    }
    FUN_00d50b20();
