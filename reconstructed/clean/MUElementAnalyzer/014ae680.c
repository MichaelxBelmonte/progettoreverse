...
void FUN_014ae680(double param_1,uint64_t param_2,uint32_t param_3,float param_4)

{
  ...
  pvVar2 = (void *)((int64_t)(int)local_res8 * 4);
  ...
  fVar31 = g_023b294c;
  dVar16 = g_0238fee8;
  uVar28 = (uint64_t)local_res8;
  if (0 < (int64_t)(int)local_res8) {
    if (local_res8 < 8) {
      uVar21 = 0;
    }
    else {
      uVar21 = (uint64_t)(local_res8 & 0xfffffff8);
      uVar24 = 0;
      do {
...
LAB_014ae8f1:
  ...
  if (local_res8 < 8) {
    ...
    uVar24 = 0;
    do {
      piVar1 = (int *)((int64_t)in_R9 + uVar24);
      iVar25 = piVar1[1];
      iVar29 = piVar1[2];
      iVar30 = piVar1[3];
      piVar4 = (int *)((int64_t)in_R9 + uVar24 + 0x10);
      iVar12 = *piVar4;
      iVar13 = piVar4[1];
      iVar14 = piVar4[2];
      iVar15 = piVar4[3];
      if (*piVar1 == 0) {
        *(void*)((int64_t)pfVar20 + uVar24) = 0;
      }
      if (iVar25 == 0) {
        *(void*)((int64_t)pfVar20 + uVar24 + 4) = 0;
      }
      if (iVar29 == 0) {
        *(void*)((int64_t)pfVar20 + uVar24 + 8) = 0;
      }
      if (iVar30 == 0) {
        *(void*)((int64_t)pfVar20 + uVar24 + 0xc) = 0;
      }
      if (iVar12 == 0) {
        *(void*)((int64_t)pfVar20 + uVar24 + 0x10) = 0;
      }
      if (iVar13 == 0) {
        *(void*)((int64_t)pfVar20 + uVar24 + 0x14) = 0;
      }
      if (iVar14 == 0) {
        *(void*)((int64_t)pfVar20 + uVar24 + 0x18) = 0;
      }
      if (iVar15 == 0) {
        *(void*)((int64_t)pfVar20 + uVar24 + 0x1c) = 0;
      }
      uVar24 = uVar24 + 0x20;
...
LAB_014aed67:
  ...
  if (1 < (int)local_res8) {
    ...
    do {
      ...
      iVar29 = iVar30;
      if ((bVar18) && (fVar33 < g_02394228)) {
        fVar32 = 0.0;
        uVar22 = iVar29 - iVar25;
        if (uVar22 != 0 && iVar25 <= iVar29) {
          uVar24 = (uint64_t)iVar25;
          uVar26 = ~uVar24;
          fVar32 = 0.0;
          uVar27 = (uint64_t)uVar22 & 3;
          if ((uVar22 & 3) != 0) {
            do {
