...
float FUN_0149f6a0(double param_1,int64_t param_2)

{
  ...
  lVar17 = FUN_00e83010();
  lVar18 = FUN_00e83010();
  fVar32 = (float)(param_1 / g_0240e370);
  if (fVar32 <= g_02390124) {
    fVar32 = g_02390124 / (float)(int)(g_02390124 / fVar32 + g_0239011c);
  }
  else {
    fVar32 = (float)(int)(fVar32 + g_0239011c);
  }
  ___bzero();
  bVar5 = fVar32 < g_02390124;
  fVar34 = fVar32;
  if (fVar32 < g_02390124) {
    fVar34 = g_02390124 / fVar32;
  }
  uVar31 = (uint)(fVar34 + g_0239011c);
  lVar28 = *in_RCX;
  if (*(int *)(lVar28 + 0xc) < 1) {
    bVar13 = false;
    local_38 = 0;
    ...
    if ((lVar18 + 4U < lVar17 + 0x1000U) && (lVar17 + 8U < lVar18 + 0x800U)) {
      ...
      bVar5 = false;
      do {
        lVar28 = *(int64_t *)(*(int64_t *)(lVar28 + 0x10) + lVar26 * 8);
        if (local_38 == lVar28) {
          lVar28 = local_38;
          bVar13 = bVar5;
          if ((!bVar5) && (local_38 != 0)) {
    ...
    param_2 = param_2 - (int)(g_0240e33c * fVar32);
    uVar24 = uVar31 - 1;
    ...
    do {
      ...
      bVar13 = bVar15;
      local_38 = lVar28;
      lVar28 = (int64_t)(*(double *)(local_38 + 0x10) * param_1);
      if (lVar28 < 0) {
        lVar28 = 0;
      }
      if (param_2 < lVar28) {
      ...
      if ((int)uVar31 < 0x401 || bVar5) {
        if (uVar31 == 1) {
          if ((pfVar16 < (float *)(arg1 + lVar28 * 4 + 0x1000U)) &&
            ...
            lVar20 = 0;
            do {
              puVar1 = (void*)(lVar28 + -0x70 + lVar20 * 4);
              uVar10 = puVar1[1];
              puVar2 = (void*)(lVar28 + -0x60 + lVar20 * 4);
              uVar11 = *puVar2;
              uVar12 = puVar2[1];
              *(void*)(pfVar16 + lVar20) = *puVar1;
              *(void*)(pfVar16 + lVar20 + 2) = uVar10;
              *(void*)(pfVar16 + lVar20 + 4) = uVar11;
              *(void*)(pfVar16 + lVar20 + 4 + 2) = uVar12;
              puVar1 = (void*)(lVar28 + -0x50 + lVar20 * 4);
              uVar10 = puVar1[1];
              puVar2 = (void*)(lVar28 + -0x40 + lVar20 * 4);
              uVar11 = *puVar2;
              uVar12 = puVar2[1];
              *(void*)(pfVar16 + lVar20 + 8) = *puVar1;
              *(void*)(pfVar16 + lVar20 + 8 + 2) = uVar10;
              *(void*)(pfVar16 + lVar20 + 0xc) = uVar11;
              *(void*)(pfVar16 + lVar20 + 0xc + 2) = uVar12;
              puVar1 = (void*)(lVar28 + -0x30 + lVar20 * 4);
              uVar10 = puVar1[1];
              puVar2 = (void*)(lVar28 + -0x20 + lVar20 * 4);
              uVar11 = *puVar2;
              uVar12 = puVar2[1];
              *(void*)(pfVar16 + lVar20 + 0x10) = *puVar1;
              *(void*)(pfVar16 + lVar20 + 0x10 + 2) = uVar10;
              *(void*)(pfVar16 + lVar20 + 0x14) = uVar11;
              *(void*)(pfVar16 + lVar20 + 0x14 + 2) = uVar12;
              puVar2 = (void*)(lVar28 + -0x10 + lVar20 * 4);
              uVar10 = puVar2[1];
              puVar1 = (void*)(lVar28 + lVar20 * 4);
              uVar11 = *puVar1;
              uVar12 = puVar1[1];
              *(void*)(pfVar16 + lVar20 + 0x18) = *puVar2;
              *(void*)(pfVar16 + lVar20 + 0x18 + 2) = uVar10;
              *(void*)(pfVar16 + lVar20 + 0x1c) = uVar11;
              *(void*)(pfVar16 + lVar20 + 0x1c + 2) = uVar12;
              lVar20 = lVar20 + 0x20;
            } while (lVar20 != 0x400);
          }
        }
        else if (g_02390124 <= fVar32) {
          lVar30 = -lVar28;
...
LAB_0149fb07:
  ...
  lVar17 = 0;
  do {
    auVar35 = *(uint8_t (*) [16])(lVar18 + lVar17 * 4);
    auVar35 = sqrtps(auVar35,auVar35);
    *(uint8_t (*) [16])(lVar18 + lVar17 * 4) = auVar35;
    lVar17 = lVar17 + 4;
  } while (lVar17 != 0x200);
  auVar35 = ZEXT816(0);
  lVar17 = 7;
  ...
  fVar34 = auVar35._0_4_ * g_0239011c;
  fVar37 = 0.0;
  lVar17 = 3;
  do {
...
LAB_0149ffdb:
  ...
  return fVar33 * (float)((param_1 * g_0241d650) / (double)fVar32);
}
