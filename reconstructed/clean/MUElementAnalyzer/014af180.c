...

{
  ...
  if (0 < *(int *)(lVar12 + 0xc)) {
    ...
    bVar7 = false;
    do {
      lVar12 = *(int64_t *)(*(int64_t *)(lVar12 + 0x10) + lVar11 * 8);
      if (local_68 == lVar12) {
        if ((!bVar3) && (local_68 != 0)) {
          bVar3 = true;
          FUN_00d50b00();
...
LAB_014af300:
      ...
      if (iVar2 == in_ECX) {
        bVar6 = bVar5;
        if (lVar11 < (int64_t)*(int *)(*arg1 + 0xc) + -1) {
          lVar12 = *(int64_t *)(*(int64_t *)(*arg1 + 0x10) + 8 + lVar11 * 8);
          if (local_78 == lVar12) {
            lVar10 = local_78;
            bVar9 = bVar4;
            if ((!bVar4) && (lVar12 != 0)) {
...
LAB_014af4d0:
        ...
        if ((lVar12 != 0) &&
           (dVar16 = (*(double *)(lVar12 + 0x10) + dVar1) * g_023942d0, local_60 < dVar16)) {
          local_60 = dVar16;
        }
        dVar16 = (*(double *)(local_68 + 0x18) + dVar1) * g_023942d0;
        if (local_40 != 0) {
          if (bVar8) {
            bVar8 = false;
            FUN_00d50b20();
        ...
        if ((int)lVar13 < *(int *)(lVar10 + 0xc)) {
          ...
          if (in_ECX == 1) {
            ...
            bVar6 = bVar8;
            do {
              lVar12 = *(int64_t *)(*(int64_t *)(lVar10 + 0x10) + lVar13 * 8);
              if (lVar14 == lVar12) {
                if ((!bVar7) && (lVar14 != 0)) {
                  bVar7 = true;
                  FUN_00d50b00();
              ...
              if (((local_60 < dVar17) && (param_1 < *(float *)(lVar14 + 0x20))) &&
                 (dVar17 = (g_0238fee8 -
                           (double)((uint64_t)(dVar1 - dVar17) & g_023908f0) * dVar15) *
          ...
          lVar12 = *(int64_t *)(local_68 + 0x40);
          if (lVar12 != local_40) {
            if (local_40 != 0) {
              FUN_00d50b00();
            }
            *(int64_t *)(local_68 + 0x40) = local_40;
            if (lVar12 != 0) goto LAB_014af257;
          }
        }
        else if (*(int64_t *)(local_68 + 0x40) == 0) {
          local_40 = 0;
        }
        else {
          *(void*)(local_68 + 0x40) = 0;
          local_40 = 0;
LAB_014af257:
          FUN_00d50b20();
        }
