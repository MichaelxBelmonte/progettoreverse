...

{
  ...
  if (((((lVar1 != 0) && ((*(byte *)(lVar1 + 0x28) & 5) != 0)) && (0 < (int)unaff_ESI)) &&
      (((int)unaff_ESI < (int)uVar3 && (*(int64_t *)(this_ptr + 0xe8) != 0)))) &&
     (((*(byte *)(*(int64_t *)(this_ptr + 0xe8) + 0x28) & 5) != 0 &&
      (pXVar6 = (X509 *)_OPENSSL_sk_value(), pXVar6 != (X509 *)0x0)))) {
    param_1 = (X509 *)(uint64_t)unaff_ESI;
    iVar4 = FUN_010b2220();
    if (iVar4 < 0) {
      return 2;
    }
    param_2 = pXVar6;
    if (iVar4 != 0) {
      *(uint *)(this_ptr + 0x94) = unaff_ESI - 1;
      return 1;
    }
  }
  uVar9 = unaff_ESI;
...
LAB_010b2012:
      ...
      *(int64_t *)(this_ptr + 0xb8) = lVar7;
      *(void*)(this_ptr + 0xb0) = 0x1c;
      iVar4 = (**(code **)(this_ptr + 0x38))();
      return 3 - (iVar4 == 0);
    }
    uVar9 = uVar9 + 1;
  } while (uVar3 != uVar9);
  bVar10 = (*(byte *)(*(int64_t *)(this_ptr + 0x20) + 0x1a) & 8) == 0;
