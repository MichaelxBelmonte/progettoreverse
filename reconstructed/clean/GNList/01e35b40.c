...

{
  ...
  if (cVar2 != '\0') {
    ...
    *plVar3 = (int64_t)&g_02572358;
    ...
    FUN_00c9fe20();
    plVar7 = local_70;
    pplVar5 = (int64_t **)local_68;
    if (local_68[0] == '\0') {
      pplVar5 = &local_98;
    }
    local_98 = (int64_t *)CONCAT71(local_98._1_7_,local_68[0]);
    *(void*)pplVar5 = 0;
    if ((local_68[0] != '\0') && (local_70 != (int64_t *)0x0)) {
      FUN_00d50b20();
    }
    ...
    if (0 < *(int *)((int64_t)plVar3 + 0xc)) {
      lVar8 = 0;
      do {
        local_70 = *(int64_t **)(plVar3[2] + lVar8 * 8);
        FUN_00c9fe40();
        plVar7 = local_98;
        local_48 = local_90[0];
        pcVar4 = local_90;
      ...
      } while ((int)lVar8 < *(int *)((int64_t)plVar3 + 0xc));
    }
    FUN_00083b20();
    FUN_00d50b20();
...
LAB_01e369c0:
    ...
    local_88 = (int64_t *)plVar3[2];
    local_80 = local_80 & 0xffffffff00000000;
    if (0 < *(int *)((int64_t)local_88 + 0xc)) {
      iVar6 = 0;
      do {
        plVar9 = *(int64_t **)(local_88[2] + (int64_t)iVar6 * 8);
        local_98 = plVar9;
        FUN_00204df0();
        ...
        plVar9 = *pplVar5;
        if (*(char *)(pplVar5 + 1) == '\0') {
          if (plVar9 == (int64_t *)0x0) goto LAB_01e36b00;
          FUN_00d50b00();
LAB_01e36abd:
          FUN_01e37eb0();
          plVar7 = local_70;
...
LAB_01e36cce:
                ...
                while( true ) {
                  ...
                  local_120 = *(int64_t **)(local_60[2] + 8 + lVar8 * 8);
                  local_118 = '\0';
                  local_70 = local_120;
                  ...
                  if (lVar8 != 0) {
                    ...
                    local_110 = plVar7;
                    local_108 = '\0';
                    cVar2 = (**(code **)(*(int64_t *)CONCAT71(uStack_47,local_48) + 0x50))();
          ...
          *(void*)(pplVar5 + 1) = 0;
          if (plVar9 != (int64_t *)0x0) goto LAB_01e36abd;
LAB_01e36b00:
          local_f0 = local_c8;
          local_e8 = '\0';
          (**(code **)(*local_98 + 0x378))();
      ...
      } while (iVar6 < *(int *)((int64_t)local_88 + 0xc));
      if ((local_90[0] != '\0') && (local_98 != (int64_t *)0x0)) {
        FUN_00d50b20();
      }
    }
    ...
    local_50 = 0;
    local_58._4_4_ = 0;
    local_60 = *(int64_t **)(this_ptr + 0x28);
    while( true ) {
      if (local_58._4_4_ != 0) {
        if (local_58._4_4_ < 1) {
          iVar6 = -local_58._4_4_;
      ...
      local_58 = CONCAT44(local_58._4_4_,iVar6);
      if (*(int *)((int64_t)local_60 + 0xc) <= iVar6) break;
      plVar9 = *(int64_t **)(local_60[2] + 8 + lVar8 * 8);
      local_70 = plVar9;
      FUN_00204df0();
      pplVar5 = (int64_t **)&g_02802688;
      if (plVar9 != (int64_t *)0x0) {
      ...
      plVar9 = *pplVar5;
      if (*(char *)(pplVar5 + 1) == '\0') {
        if (plVar9 == (int64_t *)0x0) goto LAB_01e360f0;
        FUN_00d50b00();
LAB_01e360b4:
        local_d0 = plVar9;
        (**(code **)(*plVar9 + 0x3b8))();
...
LAB_01e36270:
            ...
            while( true ) {
              ...
              iVar6 = (int)local_80 + 1;
              local_80 = CONCAT44(local_80._4_4_,iVar6);
              if (*(int *)((int64_t)local_88 + 0xc) <= iVar6) break;
              local_1c0 = *(int64_t **)(local_88[2] + 8 + lVar8 * 8);
              local_1b8 = '\0';
              local_98 = local_1c0;
              ...
              local_1a8 = '\0';
              FUN_01ccab60();
              plVar9 = (int64_t *)CONCAT71(uStack_47,local_48);
              if (local_40 == '\0') {
                if (((plVar9 != (int64_t *)0x0) && (FUN_00d50b00(), local_40 != '\0')) &&
                   (CONCAT71(uStack_47,local_48) != 0)) {
                  FUN_00d50b20();
                }
              }
        ...
        *(void*)(pplVar5 + 1) = 0;
        if (plVar9 != (int64_t *)0x0) goto LAB_01e360b4;
LAB_01e360f0:
        (**(code **)(*local_70 + 0x380))();
        plVar9 = local_98;
        if ((local_90[0] != '\0') && (local_98 != (int64_t *)0x0)) {
    ...
    plVar7 = local_c0;
    plVar9 = local_c8;
    if (plVar3 != (int64_t *)0x0) goto LAB_01e369c0;
  }
  if (plVar7 != (int64_t *)0x0) {
    FUN_00d50b20();
  }
