...
LAB_00d3fdb0:
    ...
    if ((*(int *)(lVar3 + 0xc) == 0) || (*(int64_t *)(this_ptr + 0x18) == 0)) goto LAB_00d40002;
    local_78 = 0;
    FUN_00d50b00();
    local_78 = '\x01';
    local_80 = lVar3;
    ...
    if ((local_34 & 1) == 0) {
      ...
      uVar4 = FUN_00d50b20();
      local_34 = (uint)CONCAT71((int7)((uint64_t)uVar4 >> 8),1);
      if (lVar3 != 0) {
        FUN_00d50b20();
      }
    }
    if (local_70 != 0) {
      ...
      while( true ) {
        ...
        local_c0 = *(int64_t *)(*(int64_t *)(local_50 + 0x10) + 8 + lVar3 * 8);
        local_b8 = 0;
        local_60 = local_c0;
        FUN_00d40820();
        if (local_48._4_4_ != 0) {
