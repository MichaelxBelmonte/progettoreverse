  ...
  if (*in_RCX == 0) {
    if (((local_40 == local_b0) && (!NAN(local_40) && !NAN(local_b0))) || (*in_RDX == 0)) {
      ...
      while( true ) {
        ...
        lVar8 = *(int64_t *)(local_58 + 0x10);
        local_68 = *(double *)(lVar8 + 8 + lVar6 * 8);
        pvVar3 = _pthread_getspecific((void*)lVar8);
        pVar7 = (void*)lVar8;
        if (pvVar3 != (void *)0x0) {
          FUN_00e8b990();
        }
...
LAB_00113a11:
  ...
  *pcVar4 = '\0';
  ...
  local_120 = '\0';
  dVar11 = local_68;
  FUN_012910e0(g_0238fee8,&local_138,&local_128);
