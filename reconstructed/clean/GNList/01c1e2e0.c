...
void FUN_01c1e2e0(uint64_t param_1,uint32_t param_2)

{
  ...
  if ((int)this_ptr[0x2c] == 1) {
    ...
    FUN_00d50b00();
    FUN_01ce86a0();
    if (this_ptr + 0x29 != (int64_t *)0x0) {
      (**(code **)(this_ptr[0x29] + 0x10))();
      FUN_00d50b20();
    }
    (**(code **)(*(int64_t *)this_ptr[0x31] + 0x558))();
    FUN_01cec040();
    plVar2 = (int64_t *)this_ptr[0x31];
    lVar1 = this_ptr[0x33];
    if (lVar1 != 0) {
    ...
    (**(code **)(*plVar2 + 0x4d0))();
    (**(code **)(*plVar2 + 0x558))();
    if (*(char *)((int64_t)this_ptr + 0x1cc) == '\0') {
      FUN_01d9aec0();
      FUN_01d97870();
      FUN_01cf3e00();
    ...
    lVar1 = this_ptr[0x34];
    if ((*(int *)(lVar1 + 0xc) == 0) || ((int)this_ptr[0x2c] == 0)) {
    ...
    (**(code **)(*(int64_t *)this_ptr[0x30] + 0x920))();
    (**(code **)(*(int64_t *)this_ptr[0x30] + 0x540))();
    (**(code **)(*this_ptr + 0x450))();
    if (plVar2 != (int64_t *)0x0) {
      FUN_00d50b20();
    }
