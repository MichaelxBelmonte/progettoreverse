...
void FUN_00d1b5a0(uint64_t param_1,int *param_2,uint64_t param_3,uint64_t param_4)

{
  ...
  if ((*arg1 != 0) && (lVar1 = *(int64_t *)(*arg1 + 0x10), 0 < *(int *)(lVar1 + 0xc))) {
    ...
    do {
      lVar7 = g_02781680;
      plVar2 = *(int64_t **)(*(int64_t *)(lVar1 + 0x10) + lVar10 * 8);
      if (g_02781680 != 0) {
        FUN_00d50b00();
      }
      cVar5 = FUN_00d90870();
              ...
              if (plVar2 == (int64_t *)0x0) {
                ...
                if (*pplVar8 != (int64_t *)0x0) {
                  ...
                  while( true ) {
                    ...
                    plVar2 = *(int64_t **)(local_50[2] + 8 + lVar7 * 8);
                    local_60 = plVar2;
                    local_70 = plVar2;
                    if ((g_026fdd40 == '\0') && (iVar9 = ___cxa_guard_acquire(), iVar9 != 0)) {
                      g_026cd0e8 = FUN_00d4fe50();
