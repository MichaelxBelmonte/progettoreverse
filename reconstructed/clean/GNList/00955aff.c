...
bool FUN_00955aff(int64_t param_1,uint64_t param_2,uint64_t param_3,int64_t param_4)

{
  ...
  *(void*)(param_1 + 8) = 0;
  ...
  if (param_4 != 0) {
    lVar16 = *(int64_t *)(param_4 + 8);
    for (lVar11 = *(int64_t *)(param_4 + 0x10); lVar11 != lVar16; lVar11 = lVar11 + -0x90) {
      (***(void**)(lVar11 + -0x90))();
    }
    *(int64_t *)(param_4 + 0x10) = lVar16;
    lVar16 = *(int64_t *)(param_4 + 0x20);
    for (lVar11 = *(int64_t *)(param_4 + 0x28); lVar11 != lVar16; lVar11 = lVar11 + -0x60) {
      (***(void**)(lVar11 + -0x60))();
    }
    *(int64_t *)(param_4 + 0x28) = lVar16;
    lVar16 = *(int64_t *)(param_4 + 0x38);
    for (lVar11 = *(int64_t *)(param_4 + 0x40); lVar11 != lVar16; lVar11 = lVar11 + -0x58) {
      (***(void**)(lVar11 + -0x58))();
    }
    *(int64_t *)(param_4 + 0x40) = lVar16;
    lVar16 = *(int64_t *)(param_4 + 0x50);
    for (lVar11 = *(int64_t *)(param_4 + 0x58); lVar11 != lVar16; lVar11 = lVar11 + -0x88) {
      (***(void**)(lVar11 + -0x88))();
    }
    *(int64_t *)(param_4 + 0x58) = lVar16;
  }
  if (local_res8 != 0) {
    *(void*)(local_res8 + 0xd8) = 0;
  }
  FUN_00956db8();
  FUN_00952958();
  if (local_1b5 == '\0') {
  ...
  if (local_9b8 != local_9b0) {
    do {
      if ((*(int *)(local_9b8 + 0x10) == *(int *)(*(int64_t *)(this_ptr + 8) + 8)) &&
         ((iVar5 = *(int *)(*(int64_t *)(this_ptr + 8) + 0xc), *(int *)(local_9b8 + 0x14) == iVar5
  ...
  local_9b8 = 0;
LAB_00955d53:
  *(void*)(arg1 + 8) = *(void*)(local_9b8 + 0x19);
  if (((*(uint64_t *)(this_ptr + 0x58) & 1) == 0) &&
     ((*(uint64_t *)(this_ptr + 0x1a0) & 1) == 0)) {
    if ((char)((byte)*(uint64_t *)(this_ptr + 0x1a0) | (byte)*(uint64_t *)(this_ptr + 0x58)) <
        '\0') {
      if ((*(char *)(local_9b8 + 0x443) != '\0') &&
         (*(int64_t *)(local_9b8 + 0x1d8) != *(int64_t *)(local_9b8 + 0x1d0))) {
        FUN_009532c0();
      }
    }
    else if ((*(char *)(local_9b8 + 0x441) != '\0') &&
            (*(int64_t *)(local_9b8 + 0xb8) != *(int64_t *)(local_9b8 + 0xb0))) {
      FUN_009532c0();
    }
  }
  else if ((*(char *)(local_9b8 + 0x442) != '\0') &&
          (*(int64_t *)(local_9b8 + 0x148) != *(int64_t *)(local_9b8 + 0x140))) {
    FUN_009532c0();
  }
  ...
  if (((local_res8 == 0) || (*(char *)(local_9b8 + 0x444) == '\0')) ||
    ...
    plVar14 = (int64_t *)0x0;
    lVar16 = 0;
    if (*(int64_t *)(local_9b8 + 0x430) != *(int64_t *)(local_9b8 + 0x428)) {
      plVar14 = (int64_t *)(local_9b8 + 0x428);
      lVar16 = local_9b8 + 0x1f0;
    }
  }
  if ((*(int64_t *)(arg1 + 0x18) == 0) && (local_756 != '\0')) {
    *(void*)(arg1 + 0x18) = local_798;
  }
  FUN_0095583c();
  uVar7 = FUN_0092e2c6(0,0,1);
  if ((*(uint64_t *)(this_ptr + 0x58) & uVar7) == 0) {
    FUN_00925fd0();
    uVar6 = FUN_00926010();
    uVar17 = FUN_00928ab0("bool pace::eden::verifyAuth(pace::eden::thrift::pub::AuthChain &, pace::eden::thrift::pub::VerifyAuthOptions &, const unsigned char *, pace::eden::thrift::pub::ErrorInfo &, const std::vector<uint32_t> *, pace::eden::thrift::pub::AuthStorage *, pace::eden::thrift::pub::ContentSymmetricKeys *, std::vector<pace::eden::thrift::pub::AuthSituation> *)"
                          ,0x8ef);
  ...
  if ((*(byte *)(this_ptr + 0x28) & 1) == 0) {
    uVar7 = (uint64_t)(*(byte *)(this_ptr + 0x28) >> 1);
  }
  else {
    uVar7 = *(uint64_t *)(this_ptr + 0x30);
  }
  if (uVar7 != 0) {
    if ((*(byte *)(this_ptr + 0x40) & 1) == 0) {
      uVar7 = (uint64_t)(*(byte *)(this_ptr + 0x40) >> 1);
    }
    else {
      uVar7 = *(uint64_t *)(this_ptr + 0x48);
    }
    if (uVar7 != 0) {
  ...
  if ((plVar14 != (int64_t *)0x0) && (plVar14[1] != *plVar14)) {
    pcStack_70 = &g_0251b588;
    FUN_00952c7d();
    FUN_008d88a4();
    FUN_008d82b0();
  }
  ...
  if ((*(byte *)(param_1 + 0x10) & 1) == 0) {
    uVar7 = (uint64_t)(*(byte *)(param_1 + 0x10) >> 1);
  }
  else {
    uVar7 = *(uint64_t *)(param_1 + 0x18);
  }
...
LAB_009567d1:
  ...
  if (0x17 < (int64_t)uVar7) {
    ...
    do {
      ...
      pcVar10 = (char *)(uint64_t)uVar3;
      if (uVar3 == 0xffff) {
        if ((pcVar9 != pcVar1) && ((int64_t)pcVar9 - lVar11 != -1)) goto LAB_009567d1;
        break;
      }
      uVar7 = (int64_t)pcVar1 - (int64_t)(pcVar9 + 1);
    } while (0x17 < (int64_t)uVar7);
  }
  bVar15 = *(byte *)(param_1 + 0x10);
  uVar8 = (uint64_t)(bVar15 >> 1);
  uVar4 = CONCAT71((int7)((uint64_t)pcVar10 >> 8),bVar15);
  uVar7 = *(uint64_t *)(param_1 + 0x18);
  uVar12 = uVar7;
  if ((bVar15 & 1) == 0) {
    uVar12 = uVar8;
  ...
  if (uVar12 == 0x17) {
    ...
    iVar5 = std::string::compare
                      (0x1fc60e9,0xffffffff,(char *)((int64_t)&MACH_HEADER.sizeofcmds + 3),
                       (ulong)lVar16);
    if (iVar5 != 0) {
      uVar7 = *(uint64_t *)(param_1 + 0x18);
      uVar4 = CONCAT71((int7)((uint64_t)param_1 >> 8),*(byte *)(param_1 + 0x10));
      uVar8 = (uint64_t)(*(byte *)(param_1 + 0x10) >> 1);
      goto LAB_00956533;
    }
LAB_00956819:
    FUN_00954838();
...
LAB_00956533:
    ...
    if (uVar8 == 0x1e) {
      ...
      param_4 = 0x1e;
      iVar5 = std::string::compare
                        (0x1fc6008,0xffffffff,(char *)((int64_t)&MACH_HEADER.reserved + 2),
                         (ulong)lVar16);
    ...
    if ((bVar15 & 1) == 0) {
      lVar11 = param_1 + 0x41;
      uVar7 = (uint64_t)(bVar15 >> 1);
    }
    else {
      uVar7 = *(uint64_t *)(param_1 + 0x48);
      lVar11 = *(int64_t *)(param_1 + 0x50);
    }
    if (0x16 < (int64_t)uVar7) {
      pcVar1 = (char *)(lVar11 + uVar7);
      do {
        if ((uVar7 - 0x16 == 0) ||
           (pcVar9 = _memchr(pcVar10,(int)(uVar7 - 0x16),(size_t)param_4), pcVar9 == (char *)0x0))
        break;
        auVar19[0] = -(*pcVar9 == g_023d4cb0);
        ...
        pcVar10 = (char *)(uint64_t)uVar3;
        if (uVar3 == 0xffff) {
          if ((pcVar9 != pcVar1) && ((int64_t)pcVar9 - lVar11 != -1)) goto LAB_00956819;
          break;
        }
        uVar7 = (int64_t)pcVar1 - (int64_t)(pcVar9 + 1);
      } while (0x16 < (int64_t)uVar7);
    }
    uVar13 = (ulong)lVar16;
    if ((bVar15 & 1) == 0) {
      lVar11 = param_1 + 0x41;
    ...
    if (0x1d < (int64_t)uVar7) {
      ...
      while( true ) {
        ...
        auVar24[0] = -(pcVar9[0xe] == g_023d4cc0);
...
LAB_0095683e:
    ...
    if ((bVar15 & 1) == 0) {
      ...
      uVar7 = *(uint64_t *)(param_1 + 0x48);
      lVar16 = *(int64_t *)(param_1 + 0x50);
    }
    if (0x1c < (int64_t)uVar7) {
      ...
      do {
        ...
        pcVar10 = (char *)(uint64_t)uVar3;
        if (uVar3 == 0xffff) {
          if ((pcVar9 != pcVar1) && ((int64_t)pcVar9 - lVar16 != -1)) goto LAB_0095683e;
          break;
        }
        uVar7 = (int64_t)pcVar1 - (int64_t)(pcVar9 + 1);
      } while (0x1c < (int64_t)uVar7);
    }
  }
LAB_0095684f:
