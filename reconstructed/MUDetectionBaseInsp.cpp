// Reconstructed implementation of MUDetectionBaseInsp
// From MikeCore binary — reverse-engineered pseudocode

#include "MUDetectionBaseInsp.h"

// ============================================================
// @01bfdce0 — 741 bytes
// str: ""handlePatchTempo""
// str: ""handleBlendSpectrum""
// str: ""MUDetectionBaseInsp""
// ============================================================
...
void FUN_01bfebb0(pthread_key_t param_1)

{
  ...
  if ((local_30 != 0) && (*(longlong *)(unaff_RDI + 0xe8) != 0)) {
    FUN_01bfe010();
    ...
    if (local_30 != 0) {
      ...
      (**(code **)(**(longlong **)(unaff_RDI + 0xe8) + 0x928))(fVar5 - fVar3 * fVar6);
...
/* WARNING: Removing unreachable block (ram,0x0080c067) */
/* WARNING: Removing unreachable block (ram,0x0080c078) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
