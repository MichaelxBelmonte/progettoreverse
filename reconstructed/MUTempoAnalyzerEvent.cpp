// Reconstructed implementation of MUTempoAnalyzerEvent
// From MikeCore binary — reverse-engineered pseudocode

#include "MUTempoAnalyzerEvent.h"

// ============================================================
// @01604f80 — 3317 bytes
// str: ""filterMatrixUsingVectors : filterIndex >= fineStepHannWindowsCount !""
// ============================================================
...
// ============================================================
// @016039b0 — 2672 bytes
// str: ""filter2DimensionalMatrixHorizontallyWithFIRWithConstantSizeHannWindow: filterSize too big!""
// ============================================================
...
/* WARNING: Removing unreachable block (ram,0x01602eee) */
/* WARNING: Removing unreachable block (ram,0x01602efa) */
/* WARNING: Removing unreachable block (ram,0x016038b3) */

void FUN_01602e90(longlong *param_1,uint param_2,int param_3)
    ...
    if ((int)unaff_ESI < 1) {
      ...
      do {
        ...
        if (7 < (int)uVar9) {
          ...
          uVar60 = uVar42 >> 1;
          ___bzero();
          lVar55 = *(longlong *)(*unaff_RDI + 0x10);
...
void FUN_015f9150(undefined8 param_1,longlong *param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  local_48 = plVar3;
  (**(code **)(*plVar3 + 0x18))();
  if ((*(int *)(*(longlong *)(*unaff_RSI + 0x10) + 0xc) != 0) &&
