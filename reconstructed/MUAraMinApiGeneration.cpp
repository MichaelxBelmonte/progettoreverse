// Reconstructed implementation of MUAraMinApiGeneration
// From MikeCore binary — reverse-engineered pseudocode

#include "MUAraMinApiGeneration.h"

// ============================================================
// @016acf90 — 2524 bytes
// str: ""config != NULL""
// str: ""config->structSize >= ARA::kARAInterfaceConfigurationMinSize""
// str: ""config->desiredApiGeneration >= MUAraMinApiGeneration""
// str: ""config->desiredApiGeneration <= MUAraMaxApiGeneration""
// str: ""config->desiredApiGeneration >= ARA::kARAAPIGeneration_2_0_Final""
// ============================================================

/* WARNING: Removing unreachable block (ram,0x016ad1fa) */
/* WARNING: Removing unreachable block (ram,0x016ad20a) */

void FUN_016acf90(undefined8 param_1,undefined8 param_2,size_t param_3)

{
  ...
  else if (*unaff_RDI < 0x14) {
    if ((DAT_02802f60 != (undefined8 *)0x0) && ((code *)*DAT_02802f60 != (code *)0x0)) {
      (*(code *)*DAT_02802f60)();
    }
  }
  else {
    DAT_02802f60 = *(undefined8 **)((longlong)unaff_RDI + 0xc);
    iVar12 = (int)unaff_RDI[1];
    if (iVar12 < 2) {
      if ((DAT_02802f60 != (undefined8 *)0x0) && ((code *)*DAT_02802f60 != (code *)0x0)) {
      ...
      lVar7 = FUN_00bce6e0();
      lVar3 = DAT_027cb140;
      if ((lVar7 == 0) || (3 < (int)unaff_RDI[1])) {
        if (DAT_027cb0f0 == -1) {
          DAT_027cb0f0 = (int)unaff_RDI[1];
          if (DAT_027cb0f0 < 1) {
            if (DAT_027cb140 != 0) {
              FUN_00d50b00();
            }
