// ===== GNAudioHALDevice — Annotated small functions =====
// 1 readable functions

// ==================================================
// @007c7bc0 (2403 bytes) — calculation

{
  ...
  FUN_007c71c0();
  *this = &DAT_0252f870;
  *(undefined1 *)((longlong)this + 0xcc) = 0;
  if (DAT_0272ec30 == '\0') {
  ...
  *(undefined4 *)((longlong)this + 0xd4) = 0;
  ...
  uVar2 = *(undefined4 *)(arg1 + 0xe0);
  uVar3 = *(undefined4 *)(arg1 + 0xe4);
  *(undefined4 *)(this + 0x1b) = *(undefined4 *)(arg1 + 0xd8);
  *(undefined4 *)((longlong)this + 0xdc) = uVar1;
  ...
  *(undefined4 *)((longlong)this + 0x104) = 0;
  if (DAT_0272ec30 == '\0') {
    iVar5 = ___cxa_guard_acquire();
    if (iVar5 != 0) {
      _DAT_0275dd38 = FUN_00370d10();
  ...
  *(undefined4 *)((longlong)this + 0x114) = 0;
  if (DAT_0272ec30 == '\0') {
    iVar5 = ___cxa_guard_acquire();
    if (iVar5 != 0) {
      _DAT_0275dd38 = FUN_00370d10();
  ...
  uVar4 = *(undefined8 *)(arg1 + 0x120);
  this[0x23] = *(undefined8 *)(arg1 + 0x118);
  this[0x24] = uVar4;
  return;
}
