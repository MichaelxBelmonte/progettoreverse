// ===== EnergyClaimSystem — Annotated small functions =====
...
// ==================================================
// @0059ba40 (2643 bytes) — calculation
// Known properties of EnergyClaimSystem:
// _drawingBounds, _needsUpdateFrame, _pixelPerCent, _playingAnimation, _notOnTrack, _showsPitchCurve, _time, _displayPitchCenterTransition, _envelopeParamsLastUpdateTime, _feedsbackEnergyClaimFactor, _energyClaimFactor

{
  ...
  *this = &DAT_02620818;
  this[2] = &DAT_02621210;
  this[0x27] = &DAT_02621250;
  this[0x2d] = &DAT_02621280;
  this[0x2e] = &DAT_026212d0;
  this[0x2f] = 0;
  lVar2 = FUN_0034cf20();
  ...
  *(undefined1 *)((longlong)this + 0x1c4) = 0;
  lVar2 = FUN_0034cf20();
  if (*(char *)(lVar2 + 0xbb) == '\0') {
    if (DAT_027147d0 == '\0') {
      iVar1 = ___cxa_guard_acquire();
  ...
  *(undefined1 *)((longlong)this + 0x1c5) = 0;
  lVar2 = FUN_0034cf20();
  if (*(char *)(lVar2 + 0xbb) == '\0') {
    if (DAT_02733ea0 == '\0') {
      iVar1 = ___cxa_guard_acquire();
  ...
  *(undefined4 *)((longlong)this + 500) = 0;
  lVar2 = FUN_0034cf20();
  if (*(char *)(lVar2 + 0xbb) == '\0') {
    if (DAT_02714910 == '\0') {
      iVar1 = ___cxa_guard_acquire();
