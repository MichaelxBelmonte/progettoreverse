// ===== MUBeatSelection — Annotated small functions =====
// 9 readable functions

// ==================================================
// @01704df0 (2918 bytes) — math_loop

{
  ...
  while( true ) {
    ...
    if (local_40 != 0) {
      lVar2 = **(longlong **)(*(longlong *)(this + 0x60) + 0x10);
      if (lVar2 != 0) {
        FUN_00d50b00();
      }
      FUN_016d7fb0();
  ...
  FUN_00d64850();
  lVar10 = *(longlong *)(this + 0x58);
  if (lVar10 != local_40) {
    if (local_40 != 0) {
      FUN_00d50b00();
    }
    *(longlong *)(this + 0x58) = local_40;
    if (lVar10 != 0) {
      FUN_00d50b20();
    }
  }
...
// ==================================================
// @01c70ce0 (2020 bytes) — calculation
...

{
  ...
  iVar5 = *(int *)(*(longlong *)(this + 0x38) + 0xc);
  piVar4 = in_RCX;
  ...
  if ((in_RCX != (int *)0x0) && (iVar8 = *in_RCX, iVar8 != -1)) {
    ...
    piVar4 = *(int **)(*(longlong *)(this + 0x38) + 0x10);
    dVar9 = (double)FUN_01907950();
    if (dVar9 <= param_1) {
      iVar1 = iVar6;
      if (iVar6 < iVar5 + -1) {
...
// ==================================================
// @01c71b80 (1086 bytes) — calculation
...
// ==================================================
// @01c707d0 (869 bytes) — calculation
...
LAB_01c70930:
  ...
  if (plVar1 == (longlong *)0x0) {
    ...
    if (((byte)local_58 & (byte)uVar4) != 0) {
      ...
      local_58 = (**(code **)(*plVar2 + 0x388))(*(undefined4 *)(this + 0x254));
      FUN_00d50b20();
      local_90 = 0;
...
// ==================================================
// @01704aa0 (696 bytes) — calculation
...
// ==================================================
// @01704680 (541 bytes) — calculation
    ...
    if ((int)param_2 < (iVar18 >> 3) + -2) {
      ...
      if ((dVar2 <= dVar3) ||
        ...
        iVar17 = (uint)((double)((ulonglong)
                                 ((*(double *)(*(longlong *)(*arg1 + 0x10) + uVar19 * 8) -
                                  (dVar15 - dVar16) * ((dVar5 - dVar6) / (dVar13 - dVar14))) -
                                 *(double *)(*(longlong *)(*arg1 + 0x10) + uVar20 * 8)) &
                                _DAT_023908f0) <
                       (double)((ulonglong)
...
// ==================================================
// @01706530 (516 bytes) — calculation
