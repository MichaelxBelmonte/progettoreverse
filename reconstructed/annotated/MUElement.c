// ===== MUElement — Annotated small functions =====
...
// ==================================================
// @01181260 (1771 bytes) — calculation
// Known properties of MUElement:
// _showsLeftSeparator, _feedbacksEditing, _showsLeftDisjoinArrows, _showsRightDisjoinArrows, _selected, _feedbackDisconnected, _flagsDirty, _intervalPreviewStartDelay, _referencePitchIndex, _selectedPitchIndex, _startTime, _stopTime, _toolMode, _inRegionCheck, _originalAnchorTime, _timeQuantization, _originalPitchDeviation, _pitchQuantization, _pitchWasSetManually, _timeWasSetManually
// ... and more
...
// ==================================================
// @0082db10 (1738 bytes) — calculation
// Known properties of MUElement:
// _showsLeftSeparator, _feedbacksEditing, _showsLeftDisjoinArrows, _showsRightDisjoinArrows, _selected, _feedbackDisconnected, _flagsDirty, _intervalPreviewStartDelay, _referencePitchIndex, _selectedPitchIndex, _startTime, _stopTime, _toolMode, _inRegionCheck, _originalAnchorTime, _timeQuantization, _originalPitchDeviation, _pitchQuantization, _pitchWasSetManually, _timeWasSetManually
// ... and more

{
  ...
  *this = &DAT_026251e0;
  this[2] = &DAT_02625b68;
  this[0x27] = &DAT_02625ba8;
  this[0x2d] = &DAT_02625bd8;
  this[0x2e] = 0;
  lVar2 = FUN_0082d880();
  ...
  *(undefined1 *)((longlong)this + 0x18a) = 0;
  lVar2 = FUN_0082d880();
  if (*(char *)(lVar2 + 0xbb) == '\0') {
    if (DAT_027345f8 == '\0') {
      iVar1 = ___cxa_guard_acquire();
  ...
  *(undefined1 *)((longlong)this + 0x18b) = 0;
  lVar2 = FUN_0082d880();
  if (*(char *)(lVar2 + 0xbb) == '\0') {
    if (DAT_02734640 == '\0') {
      iVar1 = ___cxa_guard_acquire();
  ...
  *(undefined1 *)((longlong)this + 0x18c) = 0;
  lVar2 = FUN_0082d880();
  if (*(char *)(lVar2 + 0xbb) == '\0') {
    if (DAT_02734688 == '\0') {
      iVar1 = ___cxa_guard_acquire();
...
// ==================================================
// @0084d700 (1572 bytes) — calculation
// Known properties of MUElement:
// _showsLeftSeparator, _feedbacksEditing, _showsLeftDisjoinArrows, _showsRightDisjoinArrows, _selected, _feedbackDisconnected, _flagsDirty, _intervalPreviewStartDelay, _referencePitchIndex, _selectedPitchIndex, _startTime, _stopTime, _toolMode, _inRegionCheck, _originalAnchorTime, _timeQuantization, _originalPitchDeviation, _pitchQuantization, _pitchWasSetManually, _timeWasSetManually
// ... and more

{
  ...
  *(undefined4 *)((longlong)this + 0x7c) = 0;
  lVar2 = FUN_0084c260();
  if (*(char *)(lVar2 + 0xbb) == '\0') {
    if (DAT_02739608 == '\0') {
      iVar1 = ___cxa_guard_acquire();
...
// ==================================================
// @0086a790 (933 bytes) — calculation
// Known properties of MUElement:
// _showsLeftSeparator, _feedbacksEditing, _showsLeftDisjoinArrows, _showsRightDisjoinArrows, _selected, _feedbackDisconnected, _flagsDirty, _intervalPreviewStartDelay, _referencePitchIndex, _selectedPitchIndex, _startTime, _stopTime, _toolMode, _inRegionCheck, _originalAnchorTime, _timeQuantization, _originalPitchDeviation, _pitchQuantization, _pitchWasSetManually, _timeWasSetManually
// ... and more

{
  ...
  *this = &DAT_02637f18;
  this[2] = &DAT_026388a8;
  this[0x27] = &DAT_026388e8;
  this[0x2d] = &DAT_02638918;
  this[0x2e] = 0;
  lVar2 = FUN_0086a390();
  if (*(char *)(lVar2 + 0xbb) == '\0') {
    FUN_0086ac60();
...
// ==================================================
// @00869410 (594 bytes) — calculation
// Known properties of MUElement:
// _showsLeftSeparator, _feedbacksEditing, _showsLeftDisjoinArrows, _showsRightDisjoinArrows, _selected, _feedbackDisconnected, _flagsDirty, _intervalPreviewStartDelay, _referencePitchIndex, _selectedPitchIndex, _startTime, _stopTime, _toolMode, _inRegionCheck, _originalAnchorTime, _timeQuantization, _originalPitchDeviation, _pitchQuantization, _pitchWasSetManually, _timeWasSetManually
// ... and more
