// ===== GNAudioProcessor — Annotated small functions =====
// 27 readable functions

// ==================================================
// @00b38fc0 (2182 bytes) — math_loop

{
  ...
  if ((iVar8 == 1) && (iVar8 = FUN_00b33590(), iVar8 == 1)) {
    ...
    if ((*(float *)(this + 0x90) != 0.0) || (NAN(*(float *)(this + 0x90)))) {
      uVar18 = *(ulonglong *)(this + 0xb0);
      auVar29._8_8_ = 0;
      auVar29._0_8_ = uVar18;
      uVar15 = *(ulonglong *)(this + 0xb8);
      auVar37._8_8_ = 0;
      ...
      *(float *)(this + 0xb0) = fVar24;
      *(float *)(this + 0xb8) = fVar38;
      *(float *)(this + 0xb4) = fVar23;
      *(float *)(this + 0xbc) = fVar26;
      return;
    }
    if (uVar10 == uVar19) {
      return;
  ...
  fVar24 = *(float *)(this + 0x90);
  if ((fVar24 != 0.0) || (NAN(fVar24))) {
    fVar23 = *(float *)(this + 0x9c);
    fVar26 = *(float *)(this + 0xa0);
    fVar38 = *(float *)(this + 0xa4);
    fVar3 = *(float *)(this + 0xa8);
    fVar4 = *(float *)(this + 0xac);
    fVar25 = *(float *)(this + 0xb0);
    fVar34 = *(float *)(this + 0xb8);
    fVar27 = *(float *)(this + 0xb4);
    fVar31 = *(float *)(this + 0xbc);
    fVar35 = fVar25;
    fVar32 = fVar31;
    if (0 < (int)param_1) {
      fVar39 = fVar25;
    ...
    *(float *)(this + 0xb0) = fVar35;
    *(float *)(this + 0xb8) = fVar34;
    *(float *)(this + 0xb4) = fVar27;
    *(float *)(this + 0xbc) = fVar32;
    fVar24 = *(float *)(this + 0xc0);
    fVar25 = *(float *)(this + 0xc4);
    fVar34 = *(float *)(this + 200);
    ...
    *(float *)(this + 0xc0) = fVar28;
    *(float *)(this + 200) = fVar33;
    *(float *)(this + 0xc4) = fVar32;
    *(float *)(this + 0xcc) = fVar39;
    return;
  }
...
// ==================================================
// @011f03e0 (1534 bytes) — logic_branch
...
// ==================================================
// @00b3d310 (1369 bytes) — calculation

{
  ...
  local_f0 = 0;
  local_e8 = '\0';
  (**(code **)(*this + 0x508))(param_1,&local_f0);
  if ((local_e8 != '\0') && (local_f0 != 0)) {
    FUN_00d50b20();
  }
  if (lVar2 != 0) {
...
LAB_00b3d410:
  ...
  if (plVar1 != (longlong *)0x0) {
    local_34 = (uint)uVar5;
    (**(code **)(*plVar6 + 0x478))(param_1,(int)this[0xe]);
    local_50 = 1;
  ...
  if (plVar1 != (longlong *)0x0) {
    (**(code **)(*plVar6 + 0x4a0))(param_1,(int)this[0xe]);
    plVar3 = local_58;
    if ((char)local_50 == '\0') {
      if (local_58 != (longlong *)0x0) {
        FUN_00d50b00();
  ...
  (**(code **)(*plVar6 + 0x468))();
  (**(code **)(*plVar1 + 0xac8))();
  (**(code **)(*plVar6 + 0x470))(param_1,(int)this[0xe]);
  plVar1 = local_58;
  if ((char)local_50 == '\0') {
    if (local_58 != (longlong *)0x0) {
      FUN_00d50b00();
...

{
  ...
  local_50 = plVar6;
  (**(code **)(*plVar7 + 0x570))();
  iVar5 = (**(code **)(*(longlong *)this[0xf] + 0x448))();
  local_68 = (undefined1  [8])(**(code **)(*this + 0x618))();
  fStack_60 = (float)extraout_XMM0_Dc;
  fStack_5c = (float)extraout_XMM0_Dd;
  (**(code **)(*this + 0x620))();
  local_48 = (**(code **)(*this + 0x620))();
  local_78._0_8_ = (**(code **)(*this + 0x628))();
...
LAB_00b3beec:
  ...
  if (0 < iVar5) {
    ...
    do {
      local_80 = '\0';
      local_88 = plVar6;
      local_68 = (undefined1  [8])(**(code **)(*this + 0x638))(auVar13._0_4_,&local_88);
    ...
    case 0x14:
      if (local_44 == 0xf) {
        *(undefined8 *)(this + 0x58) = *(undefined8 *)(this + 0x50);
        ...
        uVar5 = *(longlong *)(this + 0x58) - *(longlong *)(this + 0x50);
        if (uVar5 < uVar6) {
          FUN_0088d550();
        }
        else if (uVar6 < uVar5) {
          *(ulonglong *)(this + 0x58) = *(longlong *)(this + 0x50) + uVar6;
        }
        iVar1 = iVar1 + iVar2;
        if (local_34 != 0) {
          uVar5 = 0;
...
// ==================================================
// @00b3df40 (1000 bytes) — calculation

{
  ...
  if ((char)uVar5 != '\0') {
    ...
    if (param_2 != '\0') {
      ...
      uVar5 = (**(code **)(**(longlong **)(this + 0x88) + 0x930))();
...
LAB_00b3e0ec:
  ...
  if (plVar2 != (longlong *)0x0) {
    local_58 = plVar2;
    uVar5 = (**(code **)(**(longlong **)(this + 0x90) + 0x970))();
    local_50 = local_40;
    local_48 = 0;
    if (local_38 == '\0') {
      if (local_40 != (longlong *)0x0) {
    ...
    local_48 = '\x01';
    uVar5 = FUN_00bf87d0(uVar5,*(undefined4 *)(this + 0x70));
...

{
  ...
  iVar5 = (**(code **)(*this + 0x4b0))();
  if (iVar5 != 1) {
    if (iVar5 == 2) {
      (**(code **)(*this + 0x4b8))(extraout_XMM0_Da,param_2);
      if (local_40 == '\0') {
        if (local_48 != 0) {
          FUN_00d50b00();
          goto LAB_00b34d9e;
...
LAB_00b3505c:
    *arg1 = fVar10;
    ...
    (**(code **)(*this + 0x490))(DAT_02390124,param_2);
    if (local_48 == lVar6) {
...
// ==================================================
// @00b324d0 (948 bytes) — calculation

{
  ...
  if (((*param_3 != 0) && (local_c4 != 3)) && (local_c4 != 2)) {
    local_108 = *param_2;
    local_100 = '\0';
    (**(code **)(*this + 0x88))(param_1,&local_108);
    puVar1 = local_b0;
    if ((char)local_a8 == '\0') {
...

{
  ...
  if ((ulonglong)bVar1 != 0) {
    ...
    if ((ulonglong)bVar1 - 1 < 3) {
      ...
      uVar2 = 0;
      do {
        if (*(longlong *)(arg1 + uVar2 * 8) == 0) {
          cVar8 = '\x02';
        }
        if (*(longlong *)(arg1 + 8 + uVar2 * 8) == 0) {
          cVar8 = '\x02';
        }
        if (*(longlong *)(arg1 + 0x10 + uVar2 * 8) == 0) {
          cVar8 = '\x02';
        }
        if (*(longlong *)(arg1 + 0x18 + uVar2 * 8) == 0) {
          cVar8 = '\x02';
        }
        uVar2 = uVar2 + 4;
    ...
    if (uVar3 != 0) {
      uVar4 = 0;
      do {
        if (*(longlong *)(arg1 + uVar2 * 8 + uVar4 * 8) == 0) {
          cVar8 = '\x02';
        }
        uVar4 = uVar4 + 1;
      } while (uVar3 != uVar4);
...
// ==================================================
// @00b3ca40 (888 bytes) — logic_branch
...

{
  ...
  iVar24 = *(int *)(this + 0x98);
  uVar9 = 0;
  param_1 = piVar11;
  if ((iVar5 - 1U < 3) ||
     ((uVar10 = (ulonglong)(iVar5 - 1U) + 1, piVar11 < (int *)(this + 0x98U) &&
      (param_1 = piVar11 + uVar10, (int *)(this + 0x90U) < param_1)))) {
LAB_00b38902:
    lVar8 = 0;
    do {
      dVar17 = (double)(iVar24 + (int)lVar8);
      fVar2 = *(float *)(this + 0x94);
      dVar17 = (double)_sin((double)*(float *)(this + 0x90) *
...
// ==================================================
// @00b3ee10 (734 bytes) — calculation

{
  ...
  local_a0 = 0;
  local_98 = '\0';
  (**(code **)(*this + 0x508))(param_1,&local_a0);
  if ((local_98 != '\0') && (local_a0 != 0)) {
    FUN_00d50b20();
  }
  if (lVar3 != 0) {
  ...
  if (plVar1 != (longlong *)0x0) {
    (**(code **)(*plVar4 + 0x478))(param_1,(int)this[0xe]);
    local_68 = 1;
...
// ==================================================
// @00b3e5a0 (703 bytes) — calculation
...
// ==================================================
// @00b31190 (685 bytes) — logic_branch
...
// ==================================================
// @00b32070 (672 bytes) — calculation

{
  ...
  if (((*in_RCX != 0) && (param_2 != 3)) && (param_2 != 2)) {
    ...
    uVar3 = (**(code **)(*this + 0x478))(uVar2,uVar3);
    local_70 = 1;
...
// ==================================================
// @00b2f6b0 (658 bytes) — calculation
...
// ==================================================
// @00b3ce60 (629 bytes) — calculation

{
  ...
  if (local_30 == '\0') {
    ...
    FUN_00d50b00();
    plVar3 = (longlong *)this[0x28];
    this[0x28] = (longlong)local_38;
  }
  else {
    local_30 = '\0';
LAB_00b3cf25:
    this[0x28] = (longlong)plVar4;
  }
  if (plVar3 != (longlong *)0x0) {
    FUN_00d50b20();
    plVar4 = local_38;
...
LAB_00b3cf70:
  ...
  if (local_38 == (longlong *)0x0) {
    (**(code **)(*(longlong *)this[0x28] + 0x4c0))();
  }
  FUN_01e53c20();
  (**(code **)(*local_38 + 0x4d8))();
  (**(code **)(*this + 0x4e8))(param_2);
  if ((local_30 != '\0') && (local_38 != (longlong *)0x0)) {
    FUN_00d50b20();
  }
  plVar3 = (longlong *)this[0x28];
...
// ==================================================
// @00b38c20 (623 bytes) — logic_branch
...
// ==================================================
// @00b2fa60 (567 bytes) — calculation
...

{
  ...
  cVar3 = (**(code **)(*(longlong *)*arg1 + 0x418))();
  if ((cVar3 != '\0') && (iVar5 = (**(code **)(*(longlong *)*arg1 + 0x428))(), 0 < iVar5)) {
    iVar6 = 0;
    do {
      (**(code **)(*(longlong *)*arg1 + 0x430))();
      (**(code **)(*this + 0x450))();
      iVar6 = iVar6 + 1;
    } while (iVar5 != iVar6);
  }
  if (((iVar4 == 3) && ((**(code **)(*(longlong *)*arg1 + 0x470))(), local_68 != '\0')) &&
     (local_70 != 0)) {
    FUN_00d50b20();
  }
  return;
...
// ==================================================
// @00b38500 (549 bytes) — calculation
  ...
  *(undefined4 *)(this + 0xc) = 0;
  ...
  if (unaff_ESI == 2) {
    ...
    *(char *)(this + 0x10) =
    ...
    if (iVar4 < 0x708) {
      *(char *)(this + 0x11) = cVar8 * '\n';
      uVar7 = ((uint)((short)iVar4 * -0x7777) >> 0x10) + iVar4;
      cVar8 = (char)((short)uVar7 >> 4) + (char)((uVar7 & 0xffff) >> 0xf);
      *(char *)(this + 0x12) = cVar8;
      *(char *)(this + 0x13) = cVar8 * -0x1e + (char)iVar4;
    }
    else {
      uVar7 = iVar4 - 0x708U & 0xffff;
      uVar5 = uVar7 % 0x706;
      *(char *)(this + 0x11) = (char)(uVar7 / 0x706) + cVar8 * '\n' + '\x01';
      if ((ushort)uVar5 < 0x1c) {
        *(undefined1 *)(this + 0x12) = 0;
        *(char *)(this + 0x13) = (char)uVar5 + '\x02';
      }
      else {
        uVar7 = (uVar5 - 0x1c & 0xffff) / 0x1e;
        cVar8 = (char)uVar7;
        *(char *)(this + 0x12) = cVar8 + '\x01';
        *(char *)(this + 0x13) = (char)uVar5 + (cVar8 * '\x02' - (char)(uVar7 << 5)) + -0x1c;
      }
    }
  }
  else {
    iVar6 = FUN_00e7d850(dVar10);
    *(char *)(this + 0x13) = (char)(iVar3 % iVar6);
    iVar4 = (int)((longlong)iVar3 / (longlong)iVar6);
    iVar2 = iVar4 / 0x3c;
    cVar8 = (char)iVar2;
    *(char *)(this + 0x12) = (char)((longlong)iVar3 / (longlong)iVar6) + cVar8 * -0x3c;
...
// ==================================================
// @00b30e80 (509 bytes) — calculation
...
// ==================================================
// @00b37610 (506 bytes) — calculation

{
  ...
  plVar1 = *(longlong **)(arg1 + 0x90);
  if ((plVar1 == (longlong *)0x0) || (*(longlong *)(arg1 + 0x78) == 0)) {
    *(undefined1 *)(this + 1) = 0;
    *this = 0;
    return;
  }
  FUN_00d50b00();
  local_38 = *(longlong *)(arg1 + 0x78);
  local_30 = 0;
  if (local_38 != 0) {
    FUN_00d50b00();
  }
...

{
  ...
  (**(code **)(*this + 0x558))();
  (**(code **)(*plVar1 + 0x3a8))();
  cVar3 = (**(code **)(*this + 0x558))();
  if (cVar3 != '\0') {
    iVar4 = (**(code **)(*this + 0x448))();
    (**(code **)(*(longlong *)*arg1 + 0x3b8))();
    if (0 < iVar4) {
      iVar5 = 0;
      do {
