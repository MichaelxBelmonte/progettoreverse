// ===== MUTestValue — Annotated small functions =====
// 1 readable functions

// ==================================================
// @018b6570 (2201 bytes) — calculation
...
LAB_018b65bf:
  ...
  if ((*(longlong **)(this + 0x1d0) != (longlong *)0x0) &&
     (plVar1 != *(longlong **)(this + 0x1d0))) {
    FUN_00d403d0();
    FUN_00d50b00();
  ...
  if (plVar1 == (longlong *)0x0) {
    if (*(longlong **)(this + 0x1c8) == (longlong *)0x0) {
      return;
    }
    (**(code **)(**(longlong **)(this + 0x1c8) + 0x4d0))();
    FUN_00d50130();
    if (*(longlong *)(this + 0x1c8) == 0) {
      return;
    }
  ...
  plVar3 = *(longlong **)(this + 0x1d0);
  if (plVar3 != plVar1) {
    FUN_00d50b00();
    *(longlong **)(this + 0x1d0) = plVar1;
    if (plVar3 != (longlong *)0x0) {
      FUN_00d50b20();
    }
  }
  if (*(longlong *)(this + 0x1c8) != 0) {
    plVar3 = *(longlong **)(this + 0x1d8);
    (**(code **)(*plVar1 + 0x368))();
    plVar7 = local_48;
    if (local_40 == '\0') {
