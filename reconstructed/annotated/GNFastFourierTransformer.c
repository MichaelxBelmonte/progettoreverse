// ===== GNFastFourierTransformer — Annotated small functions =====
// 8 readable functions

// ==================================================
// @00e84290 (1725 bytes) — math_loop
    ...
    if ((((int)param_2 < 2) || (iVar5 = unaff_ESI + -3, iVar5 < (int)param_2)) ||
      ...
      if (unaff_ESI < 1) {
        ...
        if ((int)uVar6 < 0) {
          ...
          if (uVar6 == 0) {
            ...
            if (iVar5 < (int)uVar6) {
              ...
              pfVar4 = this + (ulonglong)uVar6 + 1;
            }
          }
          auVar13 = insertps(ZEXT416((uint)fVar12),this[uVar7],0x10);
        ...
        if ((int)uVar6 < 0) {
          ...
          auVar13 = insertps(ZEXT416((uint)fVar15),this[uVar7],0x10);
          ...
          if (unaff_ESI < 1) {
            ...
            do {
              ...
              if ((int)uVar6 < 0) {
                ...
                auVar18 = insertps(ZEXT416((uint)fVar12),this[uVar7],0x10);
...
// ==================================================
// @00e83120 (956 bytes) — vDSP_operation
...

{
  ...
  *(undefined4 *)((longlong)this + 0x14) = 0;
  ...
  this[5] = *(undefined8 *)(arg1 + 0x28);
  uVar1 = *(undefined8 *)(arg1 + 0x20);
  this[3] = *(undefined8 *)(arg1 + 0x18);
  this[4] = uVar1;
  return;
}
...
// ==================================================
// @00e85330 (753 bytes) — calculation

{
  ...
  *puVar2 = &DAT_02566f40;
  ...
  FUN_00d73c80();
  *(undefined4 *)((longlong)puVar2 + 0x24) = *(undefined4 *)(this + 0x10);
  if (*(char *)(this + 0x19) == 'e') {
    FUN_00d7e190();
    if (local_40 == '\0') {
      if (local_48 != 0) {
...
// ==================================================
// @0003cc30 (538 bytes) — calculation
