// ===== MUAudioEffectRenderProcessorIdentifier — Annotated small functions =====
// 10 readable functions

// ==================================================
// @0123b3d0 (1658 bytes) — math_loop

{
  ...
  cVar3 = FUN_0124d450();
  if (((cVar3 != '\0') && (param_3 != '\0')) && (local_58 = this[7], local_58 != 0)) {
    local_60 = 0;
    local_68 = 0;
    local_50._0_4_ = -1;
    local_50._4_4_ = 0;
...

{
  ...
  if (*(longlong **)(this + 0xf8) == (longlong *)0x0) goto LAB_0123860e;
  (**(code **)(**(longlong **)(this + 0xf8) + 0x5c0))();
  plVar1 = local_40;
  local_50 = local_40;
  if (local_38[0] == '\0') {
...
LAB_0123811e:
    ...
    (**(code **)(**(longlong **)(this + 0xf8) + 0x388))();
    plVar1 = *(longlong **)(this + 0xf8);
    if (plVar1 != (longlong *)0x0) {
      FUN_00d50b00();
    }
    local_38[0] = '\0';
...
// ==================================================
// @0123e220 (1258 bytes) — calculation

{
  ...
  if (*(longlong *)(arg1 + 0xb0) != 0) goto LAB_0123e6cd;
  plVar8 = *(longlong **)(arg1 + 0xa0);
...
// ==================================================
// @0123cbf0 (1200 bytes) — calculation
...
// ==================================================
// @0123dab0 (1069 bytes) — calculation

{
  ...
  cVar1 = FUN_0124d450();
  if ((cVar1 == '\0') && (cVar1 = (**(code **)(*this + 0x498))(), cVar1 != '\0')) {
    (**(code **)(*this + 0x478))();
    if (local_48 == 0) {
      cVar1 = '\0';
    }
...
// ==================================================
// @01239760 (942 bytes) — calculation
...
// ==================================================
// @0123a4e0 (932 bytes) — calculation

{
  ...
  uVar2 = (**(code **)(*(longlong *)*arg1 + 0x3a0))();
  if ((char)uVar2 == '\0') {
    uVar2 = (**(code **)(*(longlong *)*arg1 + 0x3f0))();
    plVar4 = local_50;
    if (local_50 == (longlong *)0x0) {
      plVar4 = (longlong *)0x0;
      local_58 = 0;
    ...
    if (plVar4 == (longlong *)0x0) {
      ...
      local_58 = CONCAT71((int7)((ulonglong)uVar2 >> 8),*(char *)(arg1 + 1));
      if (*(char *)(arg1 + 1) != '\0') {
        FUN_00d50b00();
      }
    }
...
// ==================================================
// @01237b00 (873 bytes) — calculation
  ...
  if (local_40 != (longlong *)0x0) {
    ...
    if (plVar1 != local_40) {
      ...
      if (local_38 == '\0') {
        ...
        FUN_00d50b00();
        plVar1 = *(longlong **)(this + 0xf8);
        *(longlong **)(this + 0xf8) = local_40;
      }
      else {
        local_38 = '\0';
LAB_01237ca8:
        *(longlong **)(this + 0xf8) = plVar3;
      }
      if (plVar1 != (longlong *)0x0) {
        FUN_00d50b20();
        plVar3 = local_40;
...
// ==================================================
// @0123ac80 (636 bytes) — calculation
...
// ==================================================
// @0123d700 (520 bytes) — calculation
