// ===== MURenderSliceTimeContext — Annotated small functions =====
// 6 readable functions
// Known properties: 1
//   MUTimeContextCreationType _type

// ==================================================
// @00542660 (2794 bytes) — math_loop
// Known properties of MURenderSliceTimeContext:
// _type
...
LAB_005426b5:
  ...
  uVar28 = (**(code **)(*(longlong *)this[0x32] + 0x4d8))();
  ...
  uVar40 = param_2;
  uVar29 = (**(code **)(*(longlong *)this[0x33] + 0x4d8))();
  ...
  uVar31 = (**(code **)(*(longlong *)this[0x32] + 0x528))();
  uVar32 = (**(code **)(*(longlong *)this[0x33] + 0x528))();
  (**(code **)(*(longlong *)this[0x32] + 0x530))();
  (**(code **)(*(longlong *)this[0x33] + 0x530))();
  local_88._4_4_ = extraout_XMM0_Db;
  if ((char)this[0x31] == '\0') {
    if ((extraout_XMM0_Db <= 0.0) ||
       (cVar20 = (**(code **)(*(longlong *)this[0x32] + 0x978))(), cVar20 != '\0')) {
      local_88._4_4_ = (undefined4)((ulonglong)_DAT_023b5300 >> 0x20);
    }
    uVar41 = 0;
    uVar43 = 0;
    if (0.0 < extraout_XMM0_Db_00) {
      cVar20 = (**(code **)(*(longlong *)this[0x33] + 0x978))();
      goto LAB_005428d9;
    }
  }
  else {
    if ((extraout_XMM0_Db <= 0.0) ||
       (cVar20 = (**(code **)(*(longlong *)this[0x32] + 0x980))(), cVar20 != '\0')) {
      local_88._4_4_ = (undefined4)((ulonglong)_DAT_023b5300 >> 0x20);
    }
    uVar41 = 0;
    uVar43 = 0;
    if (0.0 < extraout_XMM0_Db_00) {
      cVar20 = (**(code **)(*(longlong *)this[0x33] + 0x980))();
LAB_005428d9:
...
LAB_005428e8:
  ...
  do {
    (**(code **)(*this + 0x658))();
    plVar23 = (longlong *)*arg1;
    if (plVar23 == this) {
      if (((char)arg1[1] == '\0') && (this != (longlong *)0x0)) {
        FUN_00d50b00();
        goto LAB_00542c2c;
      }
      lVar24 = *arg1;
...
LAB_00542c2c:
    ...
    (**(code **)(*(longlong *)this[0x32] + 0x4d0))();
    (**(code **)(*(longlong *)this[0x33] + 0x4d0))();
    (**(code **)(*this + 0x4d0))();
    (**(code **)(*plVar2 + 0xa10))();
  } while( true );
...
// ==================================================
// @00542220 (925 bytes) — calculation
// Known properties of MURenderSliceTimeContext:
// _type
...
LAB_00542277:
  ...
  uVar14 = param_2;
  (**(code **)(*(longlong *)this[0x32] + 0x4d8))();
  local_48 = (undefined1  [8])uVar14;
  uStack_40 = in_XMM1_Qb;
  local_78._0_8_ = (**(code **)(*(longlong *)this[0x33] + 0x4d8))();
  local_78._8_8_ = extraout_XMM0_Qb;
  auVar5 = _local_48;
  uVar15 = local_48;
  local_58._0_8_ = (**(code **)(*this + 0x4d8))();
  local_58._8_8_ = extraout_XMM0_Qb_00;
  uVar12 = (**(code **)(*(longlong *)this[0x32] + 0x528))();
  uVar13 = (**(code **)(*(longlong *)this[0x33] + 0x528))();
...
// ==================================================
// @00543a00 (909 bytes) — calculation
// Known properties of MURenderSliceTimeContext:
// _type
...
// ==================================================
// @0053fd80 (810 bytes) — calculation
// Known properties of MURenderSliceTimeContext:
// _type
...
// ==================================================
// @00543570 (616 bytes) — calculation
// Known properties of MURenderSliceTimeContext:
// _type

{
  ...
  if (cVar4 != '\0') {
    ...
    fVar11 = *(float *)(this + 0x35);
    local_b8 = local_98;
    uVar5 = *(byte *)(this + 0x31) ^ 1;
...
// ==================================================
// @00540740 (560 bytes) — logic_branch
// Known properties of MURenderSliceTimeContext:
// _type
