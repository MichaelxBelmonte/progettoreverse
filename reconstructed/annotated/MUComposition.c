// ===== MUComposition — Annotated small functions =====
...
// ==================================================
// @01182110 (1862 bytes) — calculation
// Known properties of MUComposition:
// _didRequestCacheValidation, _isPitchSystemCacheValid, _isDerivedKeySequenceCacheValid
