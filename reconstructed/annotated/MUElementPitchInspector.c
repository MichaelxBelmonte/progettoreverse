// ===== MUElementPitchInspector — Annotated small functions =====
// 6 readable functions

// ==================================================
// @01ba9e60 (2369 bytes) — math_loop
...
// ==================================================
// @01ba8330 (1324 bytes) — calculation

{
  ...
  *(undefined8 *)((longlong)puVar3 + 0x1a) = 0;
  ...
  puVar3[9] = 0;
  (*DAT_02576128)();
  lVar1 = *(longlong *)(this + 0xf8);
  *(undefined8 **)(this + 0xf8) = puVar3;
  if (lVar1 != 0) {
    FUN_00d50b20();
  }
  FUN_00d48ac0();
...
// ==================================================
// @01ba7eb0 (1110 bytes) — logic_branch
...
// ==================================================
// @01baae50 (509 bytes) — calculation

{
  ...
  local_60 = 1;
  uVar6 = (**(code **)(*this + 0x688))();
  local_31 = (**(code **)(*this + 0x698))();
  local_b8 = this[0x1b];
  if (local_b8 != 0) {
    FUN_00d50b00();
  }
