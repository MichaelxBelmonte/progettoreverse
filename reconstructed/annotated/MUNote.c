// ===== MUNote — Annotated small functions =====
...
// ==================================================
// @01180ab0 (964 bytes) — calculation
// Known properties of MUNote:
// _relatesToChord, _relatesToKey, _relatesToNextNote, _role

{
  ...
  *(undefined1 *)((longlong)this + 0x3a) = 0;
  lVar9 = FUN_01180840();
  if (*(char *)(lVar9 + 0xbb) == '\0') {
    if (DAT_027a9090 == '\0') {
      iVar8 = ___cxa_guard_acquire();
