// ===== MUDetectionActivationSlider — Annotated small functions =====
// 6 readable functions

// ==================================================
// @01b8eb50 (1993 bytes) — logic_branch
...
// ==================================================
// @01b8e0e0 (1176 bytes) — calculation

{
  ...
  if ((cVar2 == '\0') || (!NAN(*(float *)(this + 0x3c)))) goto LAB_01b8e164;
  plVar4 = (longlong *)this[6];
...
LAB_01b8e227:
  ...
  if (*plVar4 == 0) {
    ...
    *(undefined8 *)((longlong)plVar4 + 0x1dc) = 0;
    ...
    (**(code **)(*this + 0xad0))();
    (**(code **)(*plVar4 + 0xac8))();
    (**(code **)(*plVar4 + 0x928))(*(undefined4 *)((longlong)this + 0x1dc));
    uVar5 = (**(code **)(*this + 0xad0))();
    ...
    *(undefined4 *)((longlong)this + 0x1dc) = uVar5;
    (**(code **)(*this + 0x620))();
    *(undefined4 *)(this + 0x3c) = 0x7fc00000;
    FUN_00d50b20();
    return;
  }
LAB_01b8e164:
  uVar7 = (**(code **)(*this + 0xaf8))();
...
// ==================================================
// @01b8f350 (986 bytes) — calculation

{
  ...
  FUN_01b68670();
  *(undefined1 *)(this + 0x1a0) = 1;
  *(undefined1 *)(this + 0x1b4) = 0;
  *(undefined1 *)(this + 0x1b6) = 1;
  *(undefined1 *)(this + 0x200) = 1;
...
// ==================================================
// @01b8db70 (812 bytes) — calculation
...
LAB_01b8dbd3:
  ...
  if (plVar2 == (longlong *)0x0) {
    ...
    fVar1 = *(float *)((longlong)this + 0x1dc);
    fVar7 = (float)(**(code **)(*this + 0xac0))();
    fVar8 = (float)(**(code **)(*this + 0xad0))();
    fVar9 = (float)(**(code **)(*this + 0xac0))();
    cVar3 = (**(code **)(*this + 0xaf0))();
    if (cVar3 != '\0') {
...
// ==================================================
// @0080a190 (601 bytes) — logic_branch
...
// ==================================================
// @00826580 (538 bytes) — calculation

{
  ...
  *this = &DAT_0264fd20;
  this[2] = &DAT_02650850;
  *(undefined4 *)((longlong)this + 0x1dc) = 0;
  if (DAT_02732250 == '\0') {
    iVar1 = ___cxa_guard_acquire();
    if (iVar1 != 0) {
      _DAT_027321a0 = FUN_001b37d0();
