// ===== MUTagOptionAttribute — Annotated small functions =====
// 6 readable functions

// ==================================================
// @018c18e0 (884 bytes) — calculation
...
// ==================================================
// @011bbe70 (878 bytes) — calculation

{
  ...
  *(undefined1 *)((longlong)this + 0xc4) = 0;
  if (DAT_027b5198 == '\0') {
    iVar1 = ___cxa_guard_acquire();
    if (iVar1 != 0) {
      _DAT_027b50e8 = FUN_011b5ca0();
...
// ==================================================
// @018c1400 (866 bytes) — calculation
...

{
  ...
  if (*(int *)(*(longlong *)(arg1 + 0x48) + 0xc) == 0) {
    *(undefined1 *)(this + 1) = 0;
    *this = 0;
  }
  else if (*(longlong *)(arg1 + 0x50) == 0) {
    puVar2 = (undefined8 *)FUN_00e8fc40();
    FUN_00d4ff40();
    *puVar2 = &DAT_0258a670;
    (*DAT_0258a688)();
    lVar1 = *(longlong *)(arg1 + 0x50);
    *(undefined8 **)(arg1 + 0x50) = puVar2;
    if (lVar1 != 0) {
      FUN_00d50b20();
    }
    uVar4 = 1;
...
// ==================================================
// @018c1dd0 (641 bytes) — calculation
