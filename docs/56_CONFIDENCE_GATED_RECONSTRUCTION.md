...
- `Raw Note Families / Matcher Locali`
  ...
  - post-match helper `01484bc0`: propagation class `2` e relativo loop su span, claim class `1`, predicato cleanup `flags & 0x70`, piano vector-backed di insert sintetico/cleanup class `1` e sequencer con cursore `uVar51`
