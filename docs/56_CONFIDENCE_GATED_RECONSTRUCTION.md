...
4. `Raw Note Families / Matcher Locali`
   ...
   - subset clean-room `014a3900 / 014a42b0`: test class-gap `1/2`, controllo del terzo vicino, costo pair-arbitration, merge max/OR dei campi chiusi e predicato peak-gate; esclusi ranking gap completo e mutazioni lista
   Guardrail:
...
- `Raw Note Families / Matcher Locali`
  ...
  - interval-gate subset di `014a3900 / 014a42b0`, limitato a class-gap, third-neighbour guard, cost/predicate/field merge verificati
