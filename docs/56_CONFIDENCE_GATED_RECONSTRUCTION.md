...
4. `Raw Note Families / Matcher Locali`
   ...
   - subset clean-room `014a3900 / 014a42b0`: test class-gap `1/2`, controllo del terzo vicino, costo pair-arbitration, merge max/OR dei campi chiusi, predicato peak-gate, predicato candidato primario, helper scalari del ranking span/score e planner one-pass; esclusi loop `GNList`, refcount e mutazioni lista
   Guardrail:
...
- `Raw Note Families / Matcher Locali`
  ...
  - interval-gate subset di `014a3900 / 014a42b0`, limitato a class-gap, third-neighbour guard, cost/predicate/field merge verificati, primary candidate gate, helper scalari gap-ranking e planner one-pass
