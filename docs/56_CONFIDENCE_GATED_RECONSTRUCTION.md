...
- `Raw Note Families / Matcher Locali`
  ...
  - post-match helper non mutanti `01484bc0`: propagation class `2`, claim class `1`, predicato cleanup `flags & 0x70`, piano vector-backed di insert sintetico/cleanup class `1`
