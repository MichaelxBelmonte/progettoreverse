...
- raw-note interval gate subset aperto per `014a3900 / 014a42b0`: costo pair-arbitration, merge max/OR dei campi chiusi, predicato peak-gate, predicato candidato primario, helper scalari ranking span/score e planner one-pass; loop `GNList`, refcount e mutazioni lista restano fuori
