...
- pitch matrix bridge `014b3ce0` aperto per la coda scalare: floor `peak+0x1c > 0.4f`, pitch bin diretto/medio, conversione `exp2(pitchBin/60)*21.533203125`, output anchor/frequency e failure `-1`; costruzione chain `GNList` e smoothing restano fuori
