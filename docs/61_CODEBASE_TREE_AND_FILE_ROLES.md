...
| `rawnotes/pitch_matrix_bridge.*` | Subset lattice `0149d5b0 / 0149ded0 / 0149e4a0 / 0149ebe0 / 014b3460 / 014b3ce0`: histogram qualita' first-peak con range/focus selector, primary value `+0x18`, attenuazione distanza centro, envelope row da mean-abs, interpolazione output, reset/link nearest-neighbour, conversione pitch-bin/Hz e bridge anchor/frequency; esclusi builder chain e smoothing. |
