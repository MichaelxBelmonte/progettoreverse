...
| `rawnotes/pitch_matrix_bridge.*` | Coda scalare `014b3ce0`: selezione peak da chain `MUPitchMatrixPeak`, floor `0.4f`, conversione `exp2(pitchBin/60)*21.533203125` e output anchor/frequency; esclusi builder chain e smoothing. |
