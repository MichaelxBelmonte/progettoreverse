...
| `rawnotes/interval_gate.*` | Subset `014a3900 / 014a42b0`: class-gap `1/2`, third-neighbour guard, costo pair-arbitration, merge max/OR, predicato peak-gate e helper scalari ranking span/score; esclusi loop `GNList`, refcount e mutazioni lista. |
