...
| `rawnotes/pitch_matrix_bridge.*` | Subset lattice `014b3460 / 014b3ce0`: reset/link nearest-neighbour delle righe `MUPitchMatrixPeak`, floor `0.4f`, conversione `exp2(pitchBin/60)*21.533203125` e output anchor/frequency; esclusi builder chain e smoothing. |
